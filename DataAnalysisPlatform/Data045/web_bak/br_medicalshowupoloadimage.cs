/*
       ...
       Generated on: 2/27/2020 9:37:32.11
...
namespace GeneXus.Programs {
   public class br_medicalshowupoloadimage : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlCloseForm6S2( )
      {
         ...
         {
            context.AddJavascriptSource("br_medicalshowupoloadimage.js", "?20202279373223", false);
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?20202279373254", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("br_medicalshowupoloadimage.js", "?20202279373254", false);
         context.AddJavascriptSource("CKEditor/ckeditor/ckeditor.js", "", false);
         context.AddJavascriptSource("CKEditor/CKEditorRender.js", "", false);
