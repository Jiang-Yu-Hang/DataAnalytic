/*
               File: BR_Pathology_OtherUpdate
        Description:
             Author: GeneXus C# Generator version 16_0_0-127771
       Generated on: 2/27/2020 9:47:52.53
...
namespace GeneXus.Programs {
   public class br_pathology_otherupdate : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public br_pathology_otherupdate( )
      {
      ...
      public br_pathology_otherupdate( IGxContext context )
      {
      ...
      {
         this.AV17BR_Pathology_OtherID = aP0_BR_Pathology_OtherID;
         executePrivate();
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxCallCrl"+"_"+"vZLNAME") == 0 )
            {
               ...
               GXDLVvZLNAME962( AV16tCurrentCode) ;
               return  ;
            }
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxCallCrl"+"_"+"BR_PATHOLOGY_OTHER_BR_PATHOLOGY_OTHER_BIONUMUNIT") == 0 )
            {
               ...
               GXDLVBR_PATHOLOGY_OTHER_BR_PATHOLOGY_OTHER_BIONUMUNIT962( AV16tCurrentCode) ;
               return  ;
            }
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxCallCrl"+"_"+"vVNAME") == 0 )
            {
               ...
               GXDLVvVNAME962( AV16tCurrentCode) ;
               return  ;
            }
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxCallCrl"+"_"+"BR_PATHOLOGY_OTHER_BR_PATHOLOGY_OTHER_BIO") == 0 )
            {
               ...
               GXDLVBR_PATHOLOGY_OTHER_BR_PATHOLOGY_OTHER_BIO962( AV16tCurrentCode) ;
               return  ;
            }
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxCallCrl"+"_"+"BR_PATHOLOGY_OTHER_BR_PATHOLOGY_OTHER_BIOQUAL") == 0 )
            {
               ...
               GXDLVBR_PATHOLOGY_OTHER_BR_PATHOLOGY_OTHER_BIOQUAL962( AV16tCurrentCode) ;
               return  ;
            }
            ...
            {
               AV17BR_Pathology_OtherID = (long)(NumberUtil.Val( gxfirstwebparm, "."));
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV17BR_Pathology_OtherID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV17BR_Pathology_OtherID), 18, 0)));
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "gxhash_vBR_PATHOLOGY_OTHERID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV17BR_Pathology_OtherID), "ZZZZZZZZZZZZZZZZZZ"), context));
            }
            if ( context.isSpaRequest( ) )
            {
               enableJsOutput();
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20202279475262", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("br_pathology_otherupdate.aspx") + "?" + UrlEncode("" +AV17BR_Pathology_OtherID)+"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vBR_PATHOLOGY_OTHERID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV17BR_Pathology_OtherID), 18, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vBR_PATHOLOGY_OTHERID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV17BR_Pathology_OtherID), "ZZZZZZZZZZZZZZZZZZ"), context));
      ...
      {
         return formatLink("br_pathology_otherupdate.aspx") + "?" + UrlEncode("" +AV17BR_Pathology_OtherID) ;
      }

      public override String GetPgmname( )
      {
         return "BR_Pathology_OtherUpdate" ;
      }
      ...
      protected void WB960( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockzlname_Internalname, "肿瘤标志物", "", "", lblTextblockzlname_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, "HLP_BR_Pathology_OtherUpdate.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-8", "left", "top", "", "", "div");
            wb_table1_25_962( true) ;
         }
         else
         {
            wb_table1_25_962( false) ;
         }
         return  ;
      }

      protected void wb_table1_25_962e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-4 MergeLabelCell", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockbr_pathology_other_br_pathology_other_bionum_Internalname, "定量结果", "", "", lblTextblockbr_pathology_other_br_pathology_other_bionum_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, "HLP_BR_Pathology_OtherUpdate.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-8", "left", "top", "", "", "div");
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtavBr_pathology_other_br_pathology_other_bionum_Internalname, StringUtil.LTrim( StringUtil.NToC( AV10BR_Pathology_Other.gxTpr_Br_pathology_other_bionum, 15, 5, ".", "")), ((edtavBr_pathology_other_br_pathology_other_bionum_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( AV10BR_Pathology_Other.gxTpr_Br_pathology_other_bionum, "ZZZZZZZZZ.ZZZZZ")) : context.localUtil.Format( AV10BR_Pathology_Other.gxTpr_Br_pathology_other_bionum, "ZZZZZZZZZ.ZZZZZ")), TempTags+" onchange=\""+"gx.num.valid_decimal( this, ',','.','5');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,40);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavBr_pathology_other_br_pathology_other_bionum_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavBr_pathology_other_br_pathology_other_bionum_Enabled, 0, "text", "", 15, "chr", 1, "row", 15, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_BR_Pathology_OtherUpdate.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-4 MergeLabelCell", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockbr_pathology_other_br_pathology_other_bionumunit_Internalname, "定量结果单位", "", "", lblTextblockbr_pathology_other_br_pathology_other_bionumunit_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, "HLP_BR_Pathology_OtherUpdate.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-8", "left", "top", "", "", "div");
            /* Div Control */
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, dynavBr_pathology_other_br_pathology_other_bionumunit, dynavBr_pathology_other_br_pathology_other_bionumunit_Internalname, StringUtil.RTrim( AV10BR_Pathology_Other.gxTpr_Br_pathology_other_bionumunit), 1, dynavBr_pathology_other_br_pathology_other_bionumunit_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "svchar", "", 1, dynavBr_pathology_other_br_pathology_other_bionumunit.Enabled, 0, 0, 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,49);\"", "", true, "HLP_BR_Pathology_OtherUpdate.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-4 MergeLabelCell", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockbr_pathology_other_br_pathology_other_low_Internalname, "参考上限", "", "", lblTextblockbr_pathology_other_br_pathology_other_low_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, "HLP_BR_Pathology_OtherUpdate.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-8", "left", "top", "", "", "div");
            /* Div Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-4 MergeLabelCell", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockbr_pathology_other_br_pathology_other_high_Internalname, "参考下限", "", "", lblTextblockbr_pathology_other_br_pathology_other_high_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, "HLP_BR_Pathology_OtherUpdate.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-8", "left", "top", "", "", "div");
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtavBr_pathology_other_br_pathology_other_high_Internalname, StringUtil.LTrim( StringUtil.NToC( AV10BR_Pathology_Other.gxTpr_Br_pathology_other_high, 15, 5, ".", "")), ((edtavBr_pathology_other_br_pathology_other_high_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( AV10BR_Pathology_Other.gxTpr_Br_pathology_other_high, "ZZZZZZZZZ.ZZZZZ")) : context.localUtil.Format( AV10BR_Pathology_Other.gxTpr_Br_pathology_other_high, "ZZZZZZZZZ.ZZZZZ")), TempTags+" onchange=\""+"gx.num.valid_decimal( this, ',','.','5');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,66);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavBr_pathology_other_br_pathology_other_high_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavBr_pathology_other_br_pathology_other_high_Enabled, 0, "text", "", 15, "chr", 1, "row", 15, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_BR_Pathology_OtherUpdate.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-4 MergeLabelCell", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockbr_pathology_other_br_pathology_other_abnind_Internalname, "结果提示", "", "", lblTextblockbr_pathology_other_br_pathology_other_abnind_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, "HLP_BR_Pathology_OtherUpdate.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-8", "left", "top", "", "", "div");
            /* Div Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-4 MergeLabelCell", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockvname_Internalname, "定性结果", "", "", lblTextblockvname_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, "HLP_BR_Pathology_OtherUpdate.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-8", "left", "top", "", "", "div");
            wb_table2_82_962( true) ;
         }
         else
         {
            wb_table2_82_962( false) ;
         }
         return  ;
      }

      protected void wb_table2_82_962e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnenter_Internalname, "", "保存", bttBtnenter_Jsonclick, 5, "确认", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"EENTER."+"'", TempTags, "", context.GetButtonType( ), "HLP_BR_Pathology_OtherUpdate.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtncancel_Internalname, "", "取消", bttBtncancel_Jsonclick, 1, "取消", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", context.GetButtonType( ), "HLP_BR_Pathology_OtherUpdate.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void GXDLVvZLNAME962( String AV16tCurrentCode )
      {
         if ( ! context.isAjaxRequest( ) )
         {
            context.GX_webresponse.AppendHeader("Cache-Control", "no-store");
         ...
         GXDLVvZLNAME_data962( AV16tCurrentCode) ;
         gxdynajaxindex = 1;
      ...
      protected void GXVvZLNAME_html962( String AV16tCurrentCode )
      {
      ...
      protected void GXDLVvZLNAME_data962( String AV16tCurrentCode )
      {
         ...
         {
            gxdynajaxctrlcodr.Add(H00962_A168XT_DefineCodeName[0]);
            gxdynajaxctrldescr.Add(H00962_A168XT_DefineCodeName[0]);
            pr_default.readNext(0);
         }
         pr_default.close(0);
      }

      protected void GXDLVBR_PATHOLOGY_OTHER_BR_PATHOLOGY_OTHER_BIONUMUNIT962( String AV16tCurrentCode )
      {
         if ( ! context.isAjaxRequest( ) )
         {
            context.GX_webresponse.AppendHeader("Cache-Control", "no-store");
         ...
         context.GX_webresponse.AddString("[[");
         GXDLVBR_PATHOLOGY_OTHER_BR_PATHOLOGY_OTHER_BIONUMUNIT_data962( AV16tCurrentCode) ;
         gxdynajaxindex = 1;
         while ( gxdynajaxindex <= gxdynajaxctrlcodr.Count )
         {
            context.GX_webresponse.AddString(gxwrpcisep+"{\"c\":\""+GXUtil.EncodeJSConstant( ((String)gxdynajaxctrlcodr.Item(gxdynajaxindex)))+"\",\"d\":\""+GXUtil.EncodeJSConstant( ((String)gxdynajaxctrldescr.Item(gxdynajaxindex)))+"\"}");
      ...
      protected void GXVBR_PATHOLOGY_OTHER_BR_PATHOLOGY_OTHER_BIONUMUNIT_html962( String AV16tCurrentCode )
      {
         String gxdynajaxvalue ;
         GXDLVBR_PATHOLOGY_OTHER_BR_PATHOLOGY_OTHER_BIONUMUNIT_data962( AV16tCurrentCode) ;
         gxdynajaxindex = 1;
      ...
      protected void GXDLVBR_PATHOLOGY_OTHER_BR_PATHOLOGY_OTHER_BIONUMUNIT_data962( String AV16tCurrentCode )
      {
         gxdynajaxctrlcodr.Clear();
         gxdynajaxctrldescr.Clear();
         ...
         {
            gxdynajaxctrlcodr.Add(H00963_A168XT_DefineCodeName[0]);
            gxdynajaxctrldescr.Add(H00963_A168XT_DefineCodeName[0]);
            pr_default.readNext(1);
         }
         pr_default.close(1);
      }

      protected void GXDLVvVNAME962( String AV16tCurrentCode )
      {
         if ( ! context.isAjaxRequest( ) )
         {
            context.GX_webresponse.AppendHeader("Cache-Control", "no-store");
         ...
         context.GX_webresponse.AddString("[[");
         GXDLVvVNAME_data962( AV16tCurrentCode) ;
         gxdynajaxindex = 1;
         while ( gxdynajaxindex <= gxdynajaxctrlcodr.Count )
         {
            context.GX_webresponse.AddString(gxwrpcisep+"{\"c\":\""+GXUtil.EncodeJSConstant( ((String)gxdynajaxctrlcodr.Item(gxdynajaxindex)))+"\",\"d\":\""+GXUtil.EncodeJSConstant( ((String)gxdynajaxctrldescr.Item(gxdynajaxindex)))+"\"}");
      ...
      protected void GXVvVNAME_html962( String AV16tCurrentCode )
      {
         String gxdynajaxvalue ;
         GXDLVvVNAME_data962( AV16tCurrentCode) ;
         gxdynajaxindex = 1;
      ...
      protected void GXDLVvVNAME_data962( String AV16tCurrentCode )
      {
         gxdynajaxctrlcodr.Clear();
         gxdynajaxctrldescr.Clear();
         /* Using cursor H00964 */
         ...
         {
            gxdynajaxctrlcodr.Add(H00964_A168XT_DefineCodeName[0]);
            gxdynajaxctrldescr.Add(H00964_A168XT_DefineCodeName[0]);
            pr_default.readNext(2);
         }
         pr_default.close(2);
      }

      protected void GXDLVBR_PATHOLOGY_OTHER_BR_PATHOLOGY_OTHER_BIO962( String AV16tCurrentCode )
      {
         if ( ! context.isAjaxRequest( ) )
         {
            context.GX_webresponse.AppendHeader("Cache-Control", "no-store");
         ...
         context.GX_webresponse.AddString("[[");
         GXDLVBR_PATHOLOGY_OTHER_BR_PATHOLOGY_OTHER_BIO_data962( AV16tCurrentCode) ;
         gxdynajaxindex = 1;
         while ( gxdynajaxindex <= gxdynajaxctrlcodr.Count )
         {
            context.GX_webresponse.AddString(gxwrpcisep+"{\"c\":\""+GXUtil.EncodeJSConstant( ((String)gxdynajaxctrlcodr.Item(gxdynajaxindex)))+"\",\"d\":\""+GXUtil.EncodeJSConstant( ((String)gxdynajaxctrldescr.Item(gxdynajaxindex)))+"\"}");
      ...
      protected void GXVBR_PATHOLOGY_OTHER_BR_PATHOLOGY_OTHER_BIO_html962( String AV16tCurrentCode )
      {
         String gxdynajaxvalue ;
         GXDLVBR_PATHOLOGY_OTHER_BR_PATHOLOGY_OTHER_BIO_data962( AV16tCurrentCode) ;
         gxdynajaxindex = 1;
      ...
      protected void GXDLVBR_PATHOLOGY_OTHER_BR_PATHOLOGY_OTHER_BIO_data962( String AV16tCurrentCode )
      {
         gxdynajaxctrlcodr.Clear();
         gxdynajaxctrldescr.Clear();
         /* Using cursor H00965 */
         ...
         {
            gxdynajaxctrlcodr.Add(H00965_A168XT_DefineCodeName[0]);
            gxdynajaxctrldescr.Add(H00965_A168XT_DefineCodeName[0]);
            pr_default.readNext(3);
         }
         pr_default.close(3);
      }

      protected void GXDLVBR_PATHOLOGY_OTHER_BR_PATHOLOGY_OTHER_BIOQUAL962( String AV16tCurrentCode )
      {
         if ( ! context.isAjaxRequest( ) )
         {
            context.GX_webresponse.AppendHeader("Cache-Control", "no-store");
         ...
         context.GX_webresponse.AddString("[[");
         GXDLVBR_PATHOLOGY_OTHER_BR_PATHOLOGY_OTHER_BIOQUAL_data962( AV16tCurrentCode) ;
         gxdynajaxindex = 1;
         while ( gxdynajaxindex <= gxdynajaxctrlcodr.Count )
         {
            context.GX_webresponse.AddString(gxwrpcisep+"{\"c\":\""+GXUtil.EncodeJSConstant( ((String)gxdynajaxctrlcodr.Item(gxdynajaxindex)))+"\",\"d\":\""+GXUtil.EncodeJSConstant( ((String)gxdynajaxctrldescr.Item(gxdynajaxindex)))+"\"}");
      ...
      protected void GXVBR_PATHOLOGY_OTHER_BR_PATHOLOGY_OTHER_BIOQUAL_html962( String AV16tCurrentCode )
      {
         String gxdynajaxvalue ;
         GXDLVBR_PATHOLOGY_OTHER_BR_PATHOLOGY_OTHER_BIOQUAL_data962( AV16tCurrentCode) ;
         gxdynajaxindex = 1;
      ...
      protected void GXDLVBR_PATHOLOGY_OTHER_BR_PATHOLOGY_OTHER_BIOQUAL_data962( String AV16tCurrentCode )
      {
         gxdynajaxctrlcodr.Clear();
         gxdynajaxctrldescr.Clear();
         /* Using cursor H00966 */
         ...
         {
            gxdynajaxctrlcodr.Add(H00966_A168XT_DefineCodeName[0]);
            gxdynajaxctrldescr.Add(H00966_A168XT_DefineCodeName[0]);
      ...
      protected void STRUP960( )
      {
         ...
         GXVvZLNAME_html962( AV16tCurrentCode) ;
         GXVBR_PATHOLOGY_OTHER_BR_PATHOLOGY_OTHER_BIONUMUNIT_html962( AV16tCurrentCode) ;
         GXVvVNAME_html962( AV16tCurrentCode) ;
         GXVBR_PATHOLOGY_OTHER_BR_PATHOLOGY_OTHER_BIO_html962( AV16tCurrentCode) ;
         GXVBR_PATHOLOGY_OTHER_BR_PATHOLOGY_OTHER_BIOQUAL_html962( AV16tCurrentCode) ;
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
      ...
      protected void E11962( )
      {
         ...
         AV10BR_Pathology_Other.Load(AV17BR_Pathology_OtherID);
      ...
      protected void S132( )
      {
         ...
         AV32GXV10 = 1;
         while ( AV32GXV10 <= AV8Messages.Count )
         {
            AV7Message = ((SdtMessages_Message)AV8Messages.Item(AV32GXV10));
      ...
      protected void E13962( )
      {
         ...
         {
            AV18tFlag = true;
            if ( ( StringUtil.StrCmp(AV13vName, "其它") == 0 ) && ( AV18tFlag ) )
            {
            ...
            if ( ( StringUtil.StrCmp(AV11zlName, "其它") == 0 ) && ( AV18tFlag ) )
            {
            ...
            if ( AV18tFlag )
            {
               ...
               {
                  context.CommitDataStores("br_pathology_otherupdate",pr_default);
               ...
               else
               {
                  AV19ErrorMsg = "";
                  AV34GXV12 = 1;
                  AV33GXV11 = AV10BR_Pathology_Other.GetMessages();
                  while ( AV34GXV12 <= AV33GXV11.Count )
                  {
                     AV7Message = ((SdtMessages_Message)AV33GXV11.Item(AV34GXV12));
      ...
      protected void wb_table2_82_962( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, dynavVname, dynavVname_Internalname, StringUtil.RTrim( AV13vName), 1, dynavVname_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "svchar", "", 1, dynavVname.Enabled, 0, 0, 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,86);\"", "", true, "HLP_BR_Pathology_OtherUpdate.htm");
            dynavVname.CurrentValue = StringUtil.RTrim( AV13vName);
            ...
            GxWebStd.gx_single_line_edit( context, edtavVothername_Internalname, AV14vOtherName, StringUtil.RTrim( context.localUtil.Format( AV14vOtherName, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,89);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "请填写其它定性结果", edtavVothername_Jsonclick, 0, "Attribute", "", "", "", "", edtavVothername_Visible, edtavVothername_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 1, -1, -1, true, "", "left", true, "HLP_BR_Pathology_OtherUpdate.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            ...
            ClassString = "bangzhu";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnbeizhu_Internalname, "", "帮助", bttBtnbeizhu_Jsonclick, 7, "帮助", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e15961_client"+"'", TempTags, "", 2, "HLP_BR_Pathology_OtherUpdate.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_82_962e( true) ;
         }
         else
         {
            wb_table2_82_962e( false) ;
         }
      }

      protected void wb_table1_25_962( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, dynavZlname, dynavZlname_Internalname, StringUtil.RTrim( AV11zlName), 1, dynavZlname_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "svchar", "", 1, dynavZlname.Enabled, 0, 0, 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,29);\"", "", true, "HLP_BR_Pathology_OtherUpdate.htm");
            dynavZlname.CurrentValue = StringUtil.RTrim( AV11zlName);
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV17BR_Pathology_OtherID = Convert.ToInt64(getParm(obj,0));
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV17BR_Pathology_OtherID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV17BR_Pathology_OtherID), 18, 0)));
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "gxhash_vBR_PATHOLOGY_OTHERID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV17BR_Pathology_OtherID), "ZZZZZZZZZZZZZZZZZZ"), context));
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?20202279475515", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("br_pathology_otherupdate.js", "?20202279475516", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV17BR_Pathology_OtherID',fld:'vBR_PATHOLOGY_OTHERID',pic:'ZZZZZZZZZZZZZZZZZZ',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("'DOBEIZHU'","{handler:'E15961',iparms:[]");
         setEventMetadata("'DOBEIZHU'",",oparms:[]}");
         setEventMetadata("ENTER","{handler:'E13962',iparms:[{av:'dynavVname'},{av:'AV13vName',fld:'vVNAME',pic:''},{av:'AV14vOtherName',fld:'vVOTHERNAME',pic:''},{av:'AV10BR_Pathology_Other',fld:'vBR_PATHOLOGY_OTHER',pic:''},{av:'dynavZlname'},{av:'AV11zlName',fld:'vZLNAME',pic:''},{av:'AV12bzName',fld:'vBZNAME',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         gxwrpcisep = "";
         scmdbuf = "";
         H00962_A167XT_DefineCodeID = new long[1] ;
         H00962_A168XT_DefineCodeName = new String[] {""} ;
         H00962_n168XT_DefineCodeName = new bool[] {false} ;
         H00962_A165XT_DefindcodeTypeID = new long[1] ;
         H00962_A432XT_TenantCode = new String[] {""} ;
         H00962_n432XT_TenantCode = new bool[] {false} ;
         H00963_A167XT_DefineCodeID = new long[1] ;
         H00963_A168XT_DefineCodeName = new String[] {""} ;
         H00963_n168XT_DefineCodeName = new bool[] {false} ;
         H00963_A165XT_DefindcodeTypeID = new long[1] ;
         H00963_A432XT_TenantCode = new String[] {""} ;
         H00963_n432XT_TenantCode = new bool[] {false} ;
         H00964_A167XT_DefineCodeID = new long[1] ;
         H00964_A168XT_DefineCodeName = new String[] {""} ;
         H00964_n168XT_DefineCodeName = new bool[] {false} ;
         H00964_A165XT_DefindcodeTypeID = new long[1] ;
         H00964_A432XT_TenantCode = new String[] {""} ;
         H00964_n432XT_TenantCode = new bool[] {false} ;
         H00965_A167XT_DefineCodeID = new long[1] ;
         H00965_A168XT_DefineCodeName = new String[] {""} ;
         H00965_n168XT_DefineCodeName = new bool[] {false} ;
         H00965_A165XT_DefindcodeTypeID = new long[1] ;
         H00965_A432XT_TenantCode = new String[] {""} ;
         H00965_n432XT_TenantCode = new bool[] {false} ;
         H00966_A167XT_DefineCodeID = new long[1] ;
         H00966_A168XT_DefineCodeName = new String[] {""} ;
         H00966_n168XT_DefineCodeName = new bool[] {false} ;
         H00966_A165XT_DefindcodeTypeID = new long[1] ;
         H00966_A432XT_TenantCode = new String[] {""} ;
         H00966_n432XT_TenantCode = new bool[] {false} ;
         AV11zlName = "";
         AV13vName = "";
         AV12bzName = "";
         AV14vOtherName = "";
         ...
         AV19ErrorMsg = "";
         AV33GXV11 = new GXBaseCollection<SdtMessages_Message>( context, "Message", "GeneXus");
         sStyleString = "";
         bttBtnbeizhu_Jsonclick = "";
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_datastore1 = new DataStoreProvider(context, new GeneXus.Programs.br_pathology_otherupdate__datastore1(),
            new Object[][] {
            }
         );
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.br_pathology_otherupdate__default(),
            new Object[][] {
                new Object[] {
               H00962_A167XT_DefineCodeID, H00962_A168XT_DefineCodeName, H00962_n168XT_DefineCodeName, H00962_A165XT_DefindcodeTypeID, H00962_A432XT_TenantCode, H00962_n432XT_TenantCode
               }
               , new Object[] {
               H00963_A167XT_DefineCodeID, H00963_A168XT_DefineCodeName, H00963_n168XT_DefineCodeName, H00963_A165XT_DefindcodeTypeID, H00963_A432XT_TenantCode, H00963_n432XT_TenantCode
               }
               , new Object[] {
               H00964_A167XT_DefineCodeID, H00964_A168XT_DefineCodeName, H00964_n168XT_DefineCodeName, H00964_A165XT_DefindcodeTypeID, H00964_A432XT_TenantCode, H00964_n432XT_TenantCode
               }
               , new Object[] {
               H00965_A167XT_DefineCodeID, H00965_A168XT_DefineCodeName, H00965_n168XT_DefineCodeName, H00965_A165XT_DefindcodeTypeID, H00965_A432XT_TenantCode, H00965_n432XT_TenantCode
               }
               , new Object[] {
               H00966_A167XT_DefineCodeID, H00966_A168XT_DefineCodeName, H00966_n168XT_DefineCodeName, H00966_A165XT_DefindcodeTypeID, H00966_A432XT_TenantCode, H00966_n432XT_TenantCode
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private int idxLst ;
      private long AV17BR_Pathology_OtherID ;
      private long wcpOAV17BR_Pathology_OtherID ;
      ...
      private long[] H00962_A167XT_DefineCodeID ;
      private String[] H00962_A168XT_DefineCodeName ;
      private bool[] H00962_n168XT_DefineCodeName ;
      private long[] H00962_A165XT_DefindcodeTypeID ;
      private String[] H00962_A432XT_TenantCode ;
      private bool[] H00962_n432XT_TenantCode ;
      private long[] H00963_A167XT_DefineCodeID ;
      private String[] H00963_A168XT_DefineCodeName ;
      private bool[] H00963_n168XT_DefineCodeName ;
      private long[] H00963_A165XT_DefindcodeTypeID ;
      private String[] H00963_A432XT_TenantCode ;
      private bool[] H00963_n432XT_TenantCode ;
      private long[] H00964_A167XT_DefineCodeID ;
      private String[] H00964_A168XT_DefineCodeName ;
      private bool[] H00964_n168XT_DefineCodeName ;
      private long[] H00964_A165XT_DefindcodeTypeID ;
      private String[] H00964_A432XT_TenantCode ;
      private bool[] H00964_n432XT_TenantCode ;
      private long[] H00965_A167XT_DefineCodeID ;
      private String[] H00965_A168XT_DefineCodeName ;
      private bool[] H00965_n168XT_DefineCodeName ;
      private long[] H00965_A165XT_DefindcodeTypeID ;
      private String[] H00965_A432XT_TenantCode ;
      private bool[] H00965_n432XT_TenantCode ;
      private long[] H00966_A167XT_DefineCodeID ;
      private String[] H00966_A168XT_DefineCodeName ;
      private bool[] H00966_n168XT_DefineCodeName ;
      private long[] H00966_A165XT_DefindcodeTypeID ;
      private String[] H00966_A432XT_TenantCode ;
      private bool[] H00966_n432XT_TenantCode ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private IDataStoreProvider pr_datastore1 ;
      private GXBaseCollection<SdtMessages_Message> AV8Messages ;
      private GXBaseCollection<SdtMessages_Message> AV33GXV11 ;
   ...
   public class br_pathology_otherupdate__datastore1 : DataStoreHelperBase, IDataStoreHelper
   {
 ...
 public class br_pathology_otherupdate__default : DataStoreHelperBase, IDataStoreHelper
 {
    public ICursor[] getCursors( )
    {
       cursorDefinitions();
  ...
  private void cursorDefinitions( )
  {
     if ( def == null )
     {
        ...
        def= new CursorDef[] {
            new CursorDef("H00962", "SELECT [XT_DefineCodeID], [XT_DefineCodeName], [XT_DefindcodeTypeID], [XT_TenantCode] FROM [XT_DefineCode] WITH (NOLOCK) WHERE ([XT_DefindcodeTypeID] = 35) AND ([XT_TenantCode] = @AV16tCurrentCode) ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00962,0,0,true,false )
           ,new CursorDef("H00963", "SELECT [XT_DefineCodeID], [XT_DefineCodeName], [XT_DefindcodeTypeID], [XT_TenantCode] FROM [XT_DefineCode] WITH (NOLOCK) WHERE ([XT_DefindcodeTypeID] = 28) AND ([XT_TenantCode] = @AV16tCurrentCode) ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00963,0,0,true,false )
           ,new CursorDef("H00964", "SELECT [XT_DefineCodeID], [XT_DefineCodeName], [XT_DefindcodeTypeID], [XT_TenantCode] FROM [XT_DefineCode] WITH (NOLOCK) WHERE ([XT_DefindcodeTypeID] = 36) AND ([XT_TenantCode] = @AV16tCurrentCode) ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00964,0,0,true,false )
           ,new CursorDef("H00965", "SELECT [XT_DefineCodeID], [XT_DefineCodeName], [XT_DefindcodeTypeID], [XT_TenantCode] FROM [XT_DefineCode] WITH (NOLOCK) WHERE ([XT_DefindcodeTypeID] = 35) AND ([XT_TenantCode] = @AV16tCurrentCode) ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00965,0,0,true,false )
           ,new CursorDef("H00966", "SELECT [XT_DefineCodeID], [XT_DefineCodeName], [XT_DefindcodeTypeID], [XT_TenantCode] FROM [XT_DefineCode] WITH (NOLOCK) WHERE ([XT_DefindcodeTypeID] = 36) AND ([XT_TenantCode] = @AV16tCurrentCode) ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00966,0,0,true,false )
        };
     }
  }
