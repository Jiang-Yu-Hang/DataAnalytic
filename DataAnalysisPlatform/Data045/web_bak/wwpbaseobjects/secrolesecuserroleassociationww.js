/*!   GeneXus C# 16_0_0-127771 on 2/27/2020 9:41:38.45
*/
...
gx.define('wwpbaseobjects.secrolesecuserroleassociationww', false, function () {
   ...
   this.GridContainer = new gx.grid.grid(this, 2,"WbpLvl2",25,"Grid","Grid","GridContainer",this.CmpContext,this.IsMasterPage,"wwpbaseobjects.secrolesecuserroleassociationww",[],false,1,false,true,0,false,false,false,"",0,"px",0,"px","澧炲姞绌虹櫧琛?,true,false,false,null,null,false,"",false,[1,1,1,1],false,0,true,false);
   ...
   GridContainer.addSingleLineEdit(6,28,"SECUSERID","缂栧彿","","SecUserId","int",0,"px",4,4,"right",null,[],6,"SecUserId",false,0,false,false,"Attribute",1,"WWColumn hidden-xs");
   ...
   GridContainer.addSingleLineEdit(15,30,"SECUSERPASSWORD","瀵嗙爜","","SecUserPassword","svchar",0,"px",100,80,"left",null,[],15,"SecUserPassword",false,0,false,true,"Attribute",1,"WWColumn hidden-xs");
