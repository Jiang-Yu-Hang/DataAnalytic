/*
       ...
       Generated on: 2/27/2020 9:47:6.34
...
namespace GeneXus.Programs.wwpbaseobjects {
   public class workwithplusmasterpageap : GXMasterPage, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlCloseForm802( )
      {
         ...
         context.AddJavascriptSource("wwpbaseobjects/workwithplusmasterpageap.js", "?2020227947635", false);
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)(getDataAreaObject() == null ? Form : getDataAreaObject().GetForm()).Jscriptsrc.Item(idxLst))), "?2020227947647", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("wwpbaseobjects/workwithplusmasterpageap.js", "?2020227947648", false);
         }
