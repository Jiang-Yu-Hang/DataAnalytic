/*
               File: WWPBaseObjects.SecUserPrompt
        Description: Select User
             Author: GeneXus C# Generator version 16_0_0-127771
       Generated on: 2/27/2020 9:39:24.25
...
namespace GeneXus.Programs.wwpbaseobjects {
   public class secuserprompt : GXHttpHandler, System.Web.SessionState.IRequiresSessionState
   {
      public secuserprompt( )
      {
      ...
      public secuserprompt( IGxContext context )
      {
      ...
      public void execute( ref short aP0_InOutSecUserId ,
                           ref String aP1_InOutSecUserName )
      {
         this.AV7InOutSecUserId = aP0_InOutSecUserId;
         this.AV8InOutSecUserName = aP1_InOutSecUserName;
         executePrivate();
         aP0_InOutSecUserId=this.AV7InOutSecUserId;
         aP1_InOutSecUserName=this.AV8InOutSecUserName;
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               AV49SecUserName = GetNextPar( );
               AV13OrderedBy = (short)(NumberUtil.Val( GetNextPar( ), "."));
               AV14OrderedDsc = StringUtil.StrToBool( GetNextPar( ));
               AV37ddo_SecUserNameTitleControlIdToReplace = GetNextPar( );
               setAjaxCallMode();
               if ( ! IsValidAjaxCall( true) )
               {
                  GxWebError = 1;
               ...
               gxgrGrid_refresh( subGrid_Rows, AV49SecUserName, AV13OrderedBy, AV14OrderedDsc, AV37ddo_SecUserNameTitleControlIdToReplace) ;
            ...
            {
               AV7InOutSecUserId = (short)(NumberUtil.Val( gxfirstwebparm, "."));
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV7InOutSecUserId", StringUtil.LTrim( StringUtil.Str( (decimal)(AV7InOutSecUserId), 4, 0)));
               if ( StringUtil.StrCmp(gxfirstwebparm, "viewer") != 0 )
               {
                  AV8InOutSecUserName = GetNextPar( );
                  context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV8InOutSecUserName", AV8InOutSecUserName);
               }
            }
            if ( context.isSpaRequest( ) )
            {
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV52Pgmname = "WWPBaseObjects.SecUserPrompt";
               context.Gx_err = 0;
               WS0Y2( ) ;
               if ( ! isAjaxCallMode( ) )
               {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20202279392433", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wwpbaseobjects.secuserprompt.aspx") + "?" + UrlEncode("" +AV7InOutSecUserId) + "," + UrlEncode(StringUtil.RTrim(AV8InOutSecUserName))+"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vSECUSERNAME", AV49SecUserName);
         ...
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "vSECUSERNAMETITLEFILTERDATA", AV34SecUserNameTitleFilterData);
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt("vSECUSERNAMETITLEFILTERDATA", AV34SecUserNameTitleFilterData);
         }
         GxWebStd.gx_hidden_field( context, "vINOUTSECUSERID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV7InOutSecUserId), 4, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "vINOUTSECUSERNAME", AV8InOutSecUserName);
      ...
      {
         return "WWPBaseObjects.SecUserPrompt" ;
      }
      ...
      protected void wb_table1_14_0Y2e( bool wbgen )
      {
         if ( wbgen )
         {
         ...
         if ( wbEnd == 25 )
         {
            ...
            ucDdo_secusername.SetProperty("DropDownOptionsTitleSettingsIcons", AV42DDO_TitleSettingsIcons);
            ucDdo_secusername.SetProperty("DropDownOptionsData", AV34SecUserNameTitleFilterData);
            ...
            /* Multiple line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 42,'',false,'" + sGXsfl_25_idx + "',0)\"";
            ClassString = "Attribute";
            StyleString = "";
            ClassString = "Attribute";
            StyleString = "";
            GxWebStd.gx_html_textarea( context, edtavDdo_secusernametitlecontrolidtoreplace_Internalname, AV37ddo_SecUserNameTitleControlIdToReplace, "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,42);\"", 0, edtavDdo_secusernametitlecontrolidtoreplace_Visible, 1, 0, 80, "chr", 4, "row", StyleString, ClassString, "", "", "300", -1, 0, "", "", -1, true, "", "'"+""+"'"+",false,"+"'"+""+"'", 0, "HLP_WWPBaseObjects\\SecUserPrompt.htm");
            /* User Defined Control */
            ucWorkwithplusutilities1.Render(context, "dvelop.workwithplusutilities", Workwithplusutilities1_Internalname, "WORKWITHPLUSUTILITIES1Container");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 44,'',false,'" + sGXsfl_25_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavOrderedby_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV13OrderedBy), 4, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV13OrderedBy), "ZZZ9")), TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,44);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavOrderedby_Jsonclick, 0, "Attribute", "", "", "", "", edtavOrderedby_Visible, 1, 0, "number", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_WWPBaseObjects\\SecUserPrompt.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 45,'',false,'" + sGXsfl_25_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavOrdereddsc_Internalname, StringUtil.BoolToStr( AV14OrderedDsc), StringUtil.BoolToStr( AV14OrderedDsc), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,45);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavOrdereddsc_Jsonclick, 0, "Attribute", "", "", "", "", edtavOrdereddsc_Visible, 1, 0, "text", "", 4, "chr", 1, "row", 4, 0, 0, 0, 1, 0, 0, true, "", "right", false, "HLP_WWPBaseObjects\\SecUserPrompt.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START0Y2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Select User", 0) ;
         }
         context.wjLoc = "";
                  ...
                  if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                  {
                     ...
                     else
                     {
                        ...
                        if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) )
                        {
                           ...
                           context.httpAjaxContext.ajax_rsp_assign_prop("", false, edtavSelect_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV28Select)) ? AV53Select_GXI : context.convertURL( context.PathToRelativeUrl( AV28Select))), !bGXsfl_25_Refreshing);
                           ...
                           if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                           {
                              ...
                              else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                              {
                                 ...
                                 if ( ! wbErr )
                                 {
                                    ...
                                    if ( StringUtil.StrCmp(cgiGet( "GXH_vSECUSERNAME"), AV49SecUserName) != 0 )
                                    {
                                       Rfr0gs = true;
                                    }
      ...
      protected void gxgrGrid_refresh( int subGrid_Rows ,
                                       String AV49SecUserName ,
                                       short AV13OrderedBy ,
                                       bool AV14OrderedDsc ,
                                       String AV37ddo_SecUserNameTitleControlIdToReplace )
      {
         initialize_formulas( ) ;
         GxWebStd.set_html_headers( context, 0, "", "");
         GxWebStd.gx_hidden_field( context, "GRID_Rows", StringUtil.LTrim( StringUtil.NToC( (decimal)(subGrid_Rows), 6, 0, ".", "")));
      ...
      protected void send_integrity_hashes( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "gxhash_SECUSERNAME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( A14SecUserName, "")), context));
      ...
      protected void RF0Y2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV49SecUserName = StringUtil.Concat( StringUtil.RTrim( AV49SecUserName), "%", "");
            /* Using cursor H000Y2 */
            pr_default.execute(0, new Object[] {lV49SecUserName, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_25_idx = 1;
            sGXsfl_25_idx = StringUtil.PadL( StringUtil.LTrim( StringUtil.Str( (decimal)(nGXsfl_25_idx), 4, 0)), 4, "0");
            SubsflControlProps_252( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_Recordsperpage( ) ) ) ) )
            {
               A181SecUserUpdDate = H000Y2_A181SecUserUpdDate[0];
               n181SecUserUpdDate = H000Y2_n181SecUserUpdDate[0];
               A180SecUserCrtDate = H000Y2_A180SecUserCrtDate[0];
               n180SecUserCrtDate = H000Y2_n180SecUserCrtDate[0];
               A179SecUserUpdUser = H000Y2_A179SecUserUpdUser[0];
               n179SecUserUpdUser = H000Y2_n179SecUserUpdUser[0];
               A178SecUserCrtUser = H000Y2_A178SecUserCrtUser[0];
               n178SecUserCrtUser = H000Y2_n178SecUserCrtUser[0];
               A15SecUserPassword = H000Y2_A15SecUserPassword[0];
               A14SecUserName = H000Y2_A14SecUserName[0];
               A6SecUserId = H000Y2_A6SecUserId[0];
               E160Y2 ();
      ...
      protected void send_integrity_lvl_hashes0Y2( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "gxhash_SECUSERNAME"+"_"+sGXsfl_25_idx, GetSecureSignedToken( sGXsfl_25_idx, StringUtil.RTrim( context.localUtil.Format( A14SecUserName, "")), context));
      }
      ...
      protected int subGrid_Recordcount( )
      {
         ...
         lV49SecUserName = StringUtil.Concat( StringUtil.RTrim( AV49SecUserName), "%", "");
         /* Using cursor H000Y3 */
         pr_default.execute(1, new Object[] {lV49SecUserName});
      ...
      protected void STRUP0Y0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            ajax_req_read_hidden_sdt(cgiGet( "vSECUSERNAMETITLEFILTERDATA"), AV34SecUserNameTitleFilterData);
            /* Read variables values. */
            AV49SecUserName = cgiGet( edtavSecusername_Internalname);
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV49SecUserName", AV49SecUserName);
            AV37ddo_SecUserNameTitleControlIdToReplace = cgiGet( edtavDdo_secusernametitlecontrolidtoreplace_Internalname);
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV37ddo_SecUserNameTitleControlIdToReplace", AV37ddo_SecUserNameTitleControlIdToReplace);
      ...
      protected void E140Y2( )
      {
         ...
         AV37ddo_SecUserNameTitleControlIdToReplace = Ddo_secusername_Titlecontrolidtoreplace;
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV37ddo_SecUserNameTitleControlIdToReplace", AV37ddo_SecUserNameTitleControlIdToReplace);
      ...
      protected void E150Y2( )
      {
         ...
         /* Refresh Routine */
         AV34SecUserNameTitleFilterData = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTDropDownOptionsData_Item>( context, "Item", "");
         new GeneXus.Programs.wwpbaseobjects.loadwwpcontext(context ).execute( out  AV43WWPContext) ;
         edtSecUserName_Titleformat = 2;
         edtSecUserName_Title = StringUtil.Format( "<div class='ColumnSettingsContainer''><span>%1</span><div id='%2'></div>", "姓名", AV37ddo_SecUserNameTitleControlIdToReplace, "", "", "", "", "", "", "");
         ...
         context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "AV34SecUserNameTitleFilterData", AV34SecUserNameTitleFilterData);
      }
      ...
      {
         /* Enter Routine */
         AV7InOutSecUserId = A6SecUserId;
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV7InOutSecUserId", StringUtil.LTrim( StringUtil.Str( (decimal)(AV7InOutSecUserId), 4, 0)));
         AV8InOutSecUserName = A14SecUserName;
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV8InOutSecUserName", AV8InOutSecUserName);
         context.setWebReturnParms(new Object[] {(short)AV7InOutSecUserId,(String)AV8InOutSecUserName});
         context.setWebReturnParmsMetadata(new Object[] {"AV7InOutSecUserId","AV8InOutSecUserName"});
         context.wjLocDisableFrm = 1;
      ...
      protected void wb_table1_14_0Y2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            GxWebStd.gx_single_line_edit( context, edtavSecusername_Internalname, AV49SecUserName, StringUtil.RTrim( context.localUtil.Format( AV49SecUserName, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,19);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavSecusername_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavSecusername_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 1, -1, -1, true, "", "left", true, "HLP_WWPBaseObjects\\SecUserPrompt.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV7InOutSecUserId = Convert.ToInt16(getParm(obj,0));
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV7InOutSecUserId", StringUtil.LTrim( StringUtil.Str( (decimal)(AV7InOutSecUserId), 4, 0)));
         AV8InOutSecUserName = (String)getParm(obj,1);
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV8InOutSecUserName", AV8InOutSecUserName);
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?20202279392819", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wwpbaseobjects/secuserprompt.js", "?20202279392820", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
      ...
      protected void SubsflControlProps_252( )
      {
         ...
         edtSecUserCrtUser_Internalname = "SECUSERCRTUSER_"+sGXsfl_25_idx;
         edtSecUserUpdUser_Internalname = "SECUSERUPDUSER_"+sGXsfl_25_idx;
         edtSecUserCrtDate_Internalname = "SECUSERCRTDATE_"+sGXsfl_25_idx;
         edtSecUserUpdDate_Internalname = "SECUSERUPDDATE_"+sGXsfl_25_idx;
      }
      ...
      protected void SubsflControlProps_fel_252( )
      {
         ...
         edtSecUserCrtUser_Internalname = "SECUSERCRTUSER_"+sGXsfl_25_fel_idx;
         edtSecUserUpdUser_Internalname = "SECUSERUPDUSER_"+sGXsfl_25_fel_idx;
         edtSecUserCrtDate_Internalname = "SECUSERCRTDATE_"+sGXsfl_25_fel_idx;
         edtSecUserUpdDate_Internalname = "SECUSERUPDDATE_"+sGXsfl_25_fel_idx;
      }
      ...
      protected void sendrow_252( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_25_idx <= subGrid_Recordsperpage( ) * 1 ) )
         {
            ...
            StyleString = "";
            AV28Select_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV28Select))&&String.IsNullOrEmpty(StringUtil.RTrim( AV53Select_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV28Select)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV28Select)) ? AV53Select_GXI : context.PathToRelativeUrl( AV28Select));
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'AV49SecUserName',fld:'vSECUSERNAME',pic:''},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV37ddo_SecUserNameTitleControlIdToReplace',fld:'vDDO_SECUSERNAMETITLECONTROLIDTOREPLACE',pic:''},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'}]");
         setEventMetadata("REFRESH",",oparms:[{av:'AV34SecUserNameTitleFilterData',fld:'vSECUSERNAMETITLEFILTERDATA',pic:''},{av:'edtSecUserName_Titleformat',ctrl:'SECUSERNAME',prop:'Titleformat'},{av:'edtSecUserName_Title',ctrl:'SECUSERNAME',prop:'Title'},{av:'AV45GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV47GridPageSize',fld:'vGRIDPAGESIZE',pic:'ZZZZZZZZZ9'},{av:'AV48GridRecordCount',fld:'vGRIDRECORDCOUNT',pic:'ZZZZZZZZZ9'}]}");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'E110Y2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV49SecUserName',fld:'vSECUSERNAME',pic:''},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV37ddo_SecUserNameTitleControlIdToReplace',fld:'vDDO_SECUSERNAMETITLECONTROLIDTOREPLACE',pic:''},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE",",oparms:[]}");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","{handler:'E120Y2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV49SecUserName',fld:'vSECUSERNAME',pic:''},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV37ddo_SecUserNameTitleControlIdToReplace',fld:'vDDO_SECUSERNAMETITLECONTROLIDTOREPLACE',pic:''},{av:'Gridpaginationbar_Rowsperpageselectedvalue',ctrl:'GRIDPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}]");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",",oparms:[{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'}]}");
         setEventMetadata("DDO_SECUSERNAME.ONOPTIONCLICKED","{handler:'E130Y2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV49SecUserName',fld:'vSECUSERNAME',pic:''},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV37ddo_SecUserNameTitleControlIdToReplace',fld:'vDDO_SECUSERNAMETITLECONTROLIDTOREPLACE',pic:''},{av:'Ddo_secusername_Activeeventkey',ctrl:'DDO_SECUSERNAME',prop:'ActiveEventKey'}]");
         setEventMetadata("DDO_SECUSERNAME.ONOPTIONCLICKED",",oparms:[{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'Ddo_secusername_Sortedstatus',ctrl:'DDO_SECUSERNAME',prop:'SortedStatus'},{av:'AV34SecUserNameTitleFilterData',fld:'vSECUSERNAMETITLEFILTERDATA',pic:''},{av:'edtSecUserName_Titleformat',ctrl:'SECUSERNAME',prop:'Titleformat'},{av:'edtSecUserName_Title',ctrl:'SECUSERNAME',prop:'Title'},{av:'AV45GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV47GridPageSize',fld:'vGRIDPAGESIZE',pic:'ZZZZZZZZZ9'},{av:'AV48GridRecordCount',fld:'vGRIDRECORDCOUNT',pic:'ZZZZZZZZZ9'}]}");
         setEventMetadata("GRID.LOAD","{handler:'E160Y2',iparms:[]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'AV28Select',fld:'vSELECT',pic:''},{av:'edtavSelect_Tooltiptext',ctrl:'vSELECT',prop:'Tooltiptext'}]}");
         setEventMetadata("ENTER","{handler:'E170Y2',iparms:[{av:'A6SecUserId',fld:'SECUSERID',pic:'ZZZ9',hsh:true},{av:'A14SecUserName',fld:'SECUSERNAME',pic:'',hsh:true}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV7InOutSecUserId',fld:'vINOUTSECUSERID',pic:'ZZZ9'},{av:'AV8InOutSecUserName',fld:'vINOUTSECUSERNAME',pic:''}]}");
         return  ;
      }
      ...
      {
         wcpOAV8InOutSecUserName = "";
         Gridpaginationbar_Selectedpage = "";
         Ddo_secusername_Activeeventkey = "";
         gxfirstwebparm = "";
         gxfirstwebparm_bkp = "";
         AV49SecUserName = "";
         AV37ddo_SecUserNameTitleControlIdToReplace = "";
         GXKey = "";
         AV52Pgmname = "";
         sDynURL = "";
         FormProcess = "";
         ...
         scmdbuf = "";
         lV49SecUserName = "";
         H000Y2_A181SecUserUpdDate = new DateTime[] {DateTime.MinValue} ;
         H000Y2_n181SecUserUpdDate = new bool[] {false} ;
         H000Y2_A180SecUserCrtDate = new DateTime[] {DateTime.MinValue} ;
         H000Y2_n180SecUserCrtDate = new bool[] {false} ;
         H000Y2_A179SecUserUpdUser = new String[] {""} ;
         H000Y2_n179SecUserUpdUser = new bool[] {false} ;
         H000Y2_A178SecUserCrtUser = new String[] {""} ;
         H000Y2_n178SecUserCrtUser = new bool[] {false} ;
         H000Y2_A15SecUserPassword = new String[] {""} ;
         H000Y2_A14SecUserName = new String[] {""} ;
         H000Y2_A6SecUserId = new short[1] ;
         ...
         sImgUrl = "";
         ROClassString = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwpbaseobjects.secuserprompt__default(),
            new Object[][] {
                new Object[] {
               H000Y2_A181SecUserUpdDate, H000Y2_n181SecUserUpdDate, H000Y2_A180SecUserCrtDate, H000Y2_n180SecUserCrtDate, H000Y2_A179SecUserUpdUser, H000Y2_n179SecUserUpdUser, H000Y2_A178SecUserCrtUser, H000Y2_n178SecUserCrtUser, H000Y2_A15SecUserPassword, H000Y2_A14SecUserName,
               H000Y2_A6SecUserId
               }
               , new Object[] {
      ...
      private short AV7InOutSecUserId ;
      private short wcpOAV7InOutSecUserId ;
      ...
      private String AV8InOutSecUserName ;
      private String wcpOAV8InOutSecUserName ;
      private String AV49SecUserName ;
      private String AV37ddo_SecUserNameTitleControlIdToReplace ;
      ...
      private String lV49SecUserName ;
      ...
      private short aP0_InOutSecUserId ;
      private String aP1_InOutSecUserName ;
      private IDataStoreProvider pr_default ;
      private DateTime[] H000Y2_A181SecUserUpdDate ;
      private bool[] H000Y2_n181SecUserUpdDate ;
      private DateTime[] H000Y2_A180SecUserCrtDate ;
      private bool[] H000Y2_n180SecUserCrtDate ;
      private String[] H000Y2_A179SecUserUpdUser ;
      private bool[] H000Y2_n179SecUserUpdUser ;
      private String[] H000Y2_A178SecUserCrtUser ;
      private bool[] H000Y2_n178SecUserCrtUser ;
      private String[] H000Y2_A15SecUserPassword ;
      private String[] H000Y2_A14SecUserName ;
      private short[] H000Y2_A6SecUserId ;
      private long[] H000Y3_AGRID_nRecordCount ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTDropDownOptionsData_Item> AV34SecUserNameTitleFilterData ;
   ...
   public class secuserprompt__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             bool AV14OrderedDsc )
      {
         ...
         String sFromString ;
         String sOrderString ;
         sSelectString = " [SecUserUpdDate], [SecUserCrtDate], [SecUserUpdUser], [SecUserCrtUser], [SecUserPassword], [SecUserName], [SecUserId]";
         sFromString = " FROM [SecUser] WITH (NOLOCK)";
         sOrderString = "";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV49SecUserName)) )
         {
            if ( StringUtil.StrCmp("", sWhereString) != 0 )
            {
               sWhereString = sWhereString + " and ([SecUserName] like '%' + @lV49SecUserName + '%')";
            }
            else
            {
               sWhereString = sWhereString + " ([SecUserName] like '%' + @lV49SecUserName + '%')";
            }
         }
         else
         {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H000Y2(context, (String)dynConstraints[0] , (String)dynConstraints[1] , (short)dynConstraints[2] , (bool)dynConstraints[3] );
               case 1 :
                     return conditional_H000Y3(context, (String)dynConstraints[0] , (String)dynConstraints[1] , (short)dynConstraints[2] , (bool)dynConstraints[3] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@lV49SecUserName",SqlDbType.NVarChar,100,0} ,
