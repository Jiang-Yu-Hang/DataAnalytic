/*
       ...
       Generated on: 2/27/2020 9:47:45.74
...
namespace GeneXus.Programs {
   public class br_encounterinsert : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20202279474596", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void wb_table2_47_8V2e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtavBr_encounter_br_encounter_admitdate_Internalname, context.localUtil.Format(AV5BR_Encounter.gxTpr_Br_encounter_admitdate, "9999/99/99"), context.localUtil.Format( AV5BR_Encounter.gxTpr_Br_encounter_admitdate, "9999/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'YMD',0,24,'chs',false,1);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,58);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavBr_encounter_br_encounter_admitdate_Jsonclick, 0, "AttributeDate", "", "", "", "", 1, edtavBr_encounter_br_encounter_admitdate_Enabled, 0, "text", "", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_BR_EncounterInsert.htm");
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-9", "left", "top", "", "", "div");
            wb_table3_66_8V2( true) ;
         }
         else
         {
            wb_table3_66_8V2( false) ;
         }
         return  ;
      }

      protected void wb_table3_66_8V2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, dynavVdischargestatus, dynavVdischargestatus_Internalname, StringUtil.RTrim( AV19vDischargeStatus), 1, dynavVdischargestatus_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "svchar", "", 1, dynavVdischargestatus.Enabled, 0, 0, 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,82);\"", "", true, "HLP_BR_EncounterInsert.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtavVinformationid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV30vInformationID), 18, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV30vInformationID), "ZZZZZZZZZZZZZZZZZ9")), TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,93);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavVinformationid_Jsonclick, 0, "Attribute", "", "", "", "", edtavVinformationid_Visible, 1, 0, "number", "1", 18, "chr", 1, "row", 18, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_BR_EncounterInsert.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 94,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavBr_encounter_br_encounterid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV5BR_Encounter.gxTpr_Br_encounterid), 18, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV5BR_Encounter.gxTpr_Br_encounterid), "ZZZZZZZZZZZZZZZZZZ")), TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,94);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavBr_encounter_br_encounterid_Jsonclick, 0, "Attribute", "", "", "", "", edtavBr_encounter_br_encounterid_Visible, 1, 0, "number", "1", 18, "chr", 1, "row", 18, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_BR_EncounterInsert.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 95,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavBr_encounter_br_encounter_encid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV5BR_Encounter.gxTpr_Br_encounter_encid), 10, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV5BR_Encounter.gxTpr_Br_encounter_encid), "ZZZZZZZZZZ")), TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,95);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavBr_encounter_br_encounter_encid_Jsonclick, 0, "Attribute", "", "", "", "", edtavBr_encounter_br_encounter_encid_Visible, 1, 0, "number", "1", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_BR_EncounterInsert.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void S112( )
      {
         ...
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV24vOtherDepartment)) )
         {
            GX_msglist.addItem("其它就诊科室是必填的");
      ...
      protected void S122( )
      {
         ...
         AV38GXV5 = 1;
         while ( AV38GXV5 <= AV13Messages.Count )
         {
            AV12Message = ((SdtMessages_Message)AV13Messages.Item(AV38GXV5));
      ...
      protected void E138V2( )
      {
         /* Load Routine */
         AV7BR_Information.Load(AV8BR_Information_ID);
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV5BR_Encounter.gxTpr_Br_encounter_department)) )
         {
            dynavVdepartment.addItem(AV5BR_Encounter.gxTpr_Br_encounter_department, AV5BR_Encounter.gxTpr_Br_encounter_department, 0);
            AV18vDepartment = AV5BR_Encounter.gxTpr_Br_encounter_department;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV18vDepartment", AV18vDepartment);
         }
      ...
      protected void E148V2( )
      {
         /* Enter Routine */
         AV23tFlag = true;
         if ( ( StringUtil.StrCmp(AV18vDepartment, "其它") == 0 ) && ( AV23tFlag ) )
         {
            if ( String.IsNullOrEmpty(StringUtil.RTrim( AV24vOtherDepartment)) )
            {
            ...
            {
               AV5BR_Encounter.gxTpr_Br_encounter_department = AV24vOtherDepartment;
            }
         }
         else
         {
            AV5BR_Encounter.gxTpr_Br_encounter_department = AV18vDepartment;
         }
         ...
         if ( AV23tFlag )
         {
            ...
            else
            {
               AV27ErrorMsg = "";
               AV40GXV7 = 1;
               AV39GXV6 = AV5BR_Encounter.GetMessages();
               while ( AV40GXV7 <= AV39GXV6.Count )
               {
                  AV12Message = ((SdtMessages_Message)AV39GXV6.Item(AV40GXV7));
      ...
      protected void wb_table3_66_8V2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, dynavVadminsource, dynavVadminsource_Internalname, StringUtil.RTrim( AV17vAdminSource), 1, dynavVadminsource_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "svchar", "", 1, dynavVadminsource.Enabled, 0, 0, 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,70);\"", "", true, "HLP_BR_EncounterInsert.htm");
            dynavVadminsource.CurrentValue = StringUtil.RTrim( AV17vAdminSource);
            ...
            GxWebStd.gx_single_line_edit( context, edtavVotherreason_Internalname, AV28vOtherReason, StringUtil.RTrim( context.localUtil.Format( AV28vOtherReason, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,73);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "请填写其他入院原因", edtavVotherreason_Jsonclick, 0, "Attribute", "", "", "", "", edtavVotherreason_Visible, edtavVotherreason_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 1, -1, -1, true, "", "left", true, "HLP_BR_EncounterInsert.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table3_66_8V2e( true) ;
         }
         else
         {
            wb_table3_66_8V2e( false) ;
         }
      }
      ...
      protected void wb_table2_47_8V2( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, dynavVenctype, dynavVenctype_Internalname, StringUtil.RTrim( AV20vENCType), 1, dynavVenctype_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "svchar", "", 1, dynavVenctype.Enabled, 0, 0, 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,51);\"", "", true, "HLP_BR_EncounterInsert.htm");
            dynavVenctype.CurrentValue = StringUtil.RTrim( AV20vENCType);
            ...
            GxWebStd.gx_single_line_edit( context, edtavVotherenctype_Internalname, AV25vOtherENCType, StringUtil.RTrim( context.localUtil.Format( AV25vOtherENCType, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,54);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavVotherenctype_Jsonclick, 0, "Attribute", "", "", "", "", edtavVotherenctype_Visible, edtavVotherenctype_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 1, -1, -1, true, "", "left", true, "HLP_BR_EncounterInsert.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
      ...
      protected void wb_table1_32_8V2( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, dynavVdepartment, dynavVdepartment_Internalname, StringUtil.RTrim( AV18vDepartment), 1, dynavVdepartment_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "svchar", "", 1, dynavVdepartment.Enabled, 0, 0, 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,36);\"", "", true, "HLP_BR_EncounterInsert.htm");
            dynavVdepartment.CurrentValue = StringUtil.RTrim( AV18vDepartment);
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?20202279474830", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("br_encounterinsert.js", "?20202279474830", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV8BR_Information_ID',fld:'vBR_INFORMATION_ID',pic:'ZZZZZZZZZZZZZZZZZZ',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("ENTER","{handler:'E148V2',iparms:[{av:'dynavVdepartment'},{av:'AV18vDepartment',fld:'vVDEPARTMENT',pic:''},{av:'AV24vOtherDepartment',fld:'vVOTHERDEPARTMENT',pic:''},{av:'AV5BR_Encounter',fld:'vBR_ENCOUNTER',pic:''},{av:'dynavVenctype'},{av:'AV20vENCType',fld:'vVENCTYPE',pic:''},{av:'AV25vOtherENCType',fld:'vVOTHERENCTYPE',pic:''},{av:'dynavVadminsource'},{av:'AV17vAdminSource',fld:'vVADMINSOURCE',pic:''},{av:'AV28vOtherReason',fld:'vVOTHERREASON',pic:''},{av:'AV7BR_Information',fld:'vBR_INFORMATION',pic:''},{av:'AV8BR_Information_ID',fld:'vBR_INFORMATION_ID',pic:'ZZZZZZZZZZZZZZZZZZ',hsh:true},{av:'dynavVdischargestatus'},{av:'AV19vDischargeStatus',fld:'vVDISCHARGESTATUS',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         AV27ErrorMsg = "";
         AV39GXV6 = new GXBaseCollection<SdtMessages_Message>( context, "Message", "GeneXus");
         sStyleString = "";
      ...
      private GXBaseCollection<SdtMessages_Message> AV39GXV6 ;
  ...
  private void cursorDefinitions( )
  {
     if ( def == null )
     {
        ...
        def= new CursorDef[] {
           ...
           ,new CursorDef("H008V3", "SELECT [XT_DefineCodeID], [XT_DefineCodeName], [XT_DefindcodeTypeID], [XT_TenantCode] FROM [XT_DefineCode] WITH (NOLOCK) WHERE ([XT_DefindcodeTypeID] = 4) AND ([XT_TenantCode] = @AV16tCurrentCode) ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH008V3,0,0,true,false )
           ,new CursorDef("H008V4", "SELECT [XT_DefineCodeID], [XT_DefineCodeName], [XT_DefindcodeTypeID], [XT_TenantCode] FROM [XT_DefineCode] WITH (NOLOCK) WHERE ([XT_DefindcodeTypeID] = 5) AND ([XT_TenantCode] = @AV16tCurrentCode) ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH008V4,0,0,true,false )
           ,new CursorDef("H008V5", "SELECT [XT_DefineCodeID], [XT_DefineCodeName], [XT_DefindcodeTypeID], [XT_TenantCode] FROM [XT_DefineCode] WITH (NOLOCK) WHERE ([XT_DefindcodeTypeID] = 6) AND ([XT_TenantCode] = @AV16tCurrentCode) ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH008V5,0,0,true,false )
        };
     }
  }
