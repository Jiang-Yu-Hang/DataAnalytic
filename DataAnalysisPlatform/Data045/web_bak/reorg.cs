/*
       ...
       Generated on: 6/13/2019 17:44:8.57
   ...
   public class reorg : GXReorganization
   {
      ...
      private void TablesCount( )
      {
         if ( ! IsResumeMode( ) )
         {
            ...
            BR_EncounterCount = P00012_ABR_EncounterCount[0];
            pr_default.close(0);
            PrintRecordCount ( "BR_Encounter" ,  BR_EncounterCount );
         }
      }
      ...
      private bool PreviousCheck( )
      {
         ...
         if ( ColumnExist("BR_Encounter",sSchemaVar,"EncounterIDEncrypt") )
         {
            SetCheckError ( GXResourceManager.GetMessage("GXM_column_exist", new   object[]  {"EncounterIDEncrypt", "BR_Encounter"}) ) ;
            return false ;
         }
         return true ;
      }
      ...
      {
         ReorgExecute.RegisterBlockForSubmit( 1 ,  "ReorganizeBR_Encounter" , new Object[]{ });
      }
      ...
      {
         GXReorganization.SetMsg( 1 ,  GXResourceManager.GetMessage("GXM_fileupdate", new   object[]  {"BR_Encounter", ""}) );
      }
      ...
      {
         scmdbuf = "";
         P00012_ABR_EncounterCount = new int[1] ;
         sSchemaVar = "";
         nsSchemaVar = false;
      ...
      protected int BR_EncounterCount ;
      ...
      protected int[] P00012_ABR_EncounterCount ;
   ...
   public class reorg__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P00012", "SELECT COUNT(*) FROM [BR_Encounter] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00012,100,0,true,false )
