...
namespace GeneXus.Programs{
	...
	[XmlType(TypeName="QueryViewerItemCollapseData" , Namespace="DataAnalysisPlatform" )]
	[Serializable]
	...
	[DataContract(Name=@"QueryViewerItemCollapseData", Namespace="DataAnalysisPlatform")]
