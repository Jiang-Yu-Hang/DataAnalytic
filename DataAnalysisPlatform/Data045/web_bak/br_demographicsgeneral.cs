/*
       ...
       Generated on: 2/27/2020 9:36:13.39
...
namespace GeneXus.Programs {
   public class br_demographicsgeneral : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20202279361345", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void RenderHtmlCloseForm2N2( )
      {
         ...
         {
            context.AddJavascriptSource("br_demographicsgeneral.js", "?20202279361349", false);
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?20202279361470", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("br_demographicsgeneral.js", "?20202279361470", false);
