/*
       ...
       Generated on: 2/27/2020 9:34:24.30
...
namespace GeneXus.Programs {
   public class br_procedure_surgerygeneral : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20202279342438", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void RenderHtmlCloseForm6A2( )
      {
         ...
         {
            context.AddJavascriptSource("br_procedure_surgerygeneral.js", "?20202279342441", false);
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?2020227934255", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("br_procedure_surgerygeneral.js", "?2020227934255", false);
         }
