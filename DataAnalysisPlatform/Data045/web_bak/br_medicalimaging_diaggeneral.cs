/*
       ...
       Generated on: 2/27/2020 9:34:34.25
...
namespace GeneXus.Programs {
   public class br_medicalimaging_diaggeneral : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20202279343429", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void RenderHtmlCloseForm4Q2( )
      {
         ...
         {
            context.AddJavascriptSource("br_medicalimaging_diaggeneral.js", "?20202279343435", false);
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?2020227934358", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("br_medicalimaging_diaggeneral.js", "?2020227934358", false);
         }
