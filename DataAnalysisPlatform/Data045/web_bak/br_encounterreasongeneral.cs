/*
       ...
       Generated on: 2/27/2020 9:38:45.4
...
namespace GeneXus.Programs {
   public class br_encounterreasongeneral : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2020227938457", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void RenderHtmlCloseForm772( )
      {
         ...
         {
            context.AddJavascriptSource("br_encounterreasongeneral.js", "?2020227938458", false);
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?20202279384547", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("br_encounterreasongeneral.js", "?20202279384547", false);
