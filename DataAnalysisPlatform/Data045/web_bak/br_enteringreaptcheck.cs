/*
       ...
       Generated on: 2/27/2020 9:46:47.52
...
namespace GeneXus.Programs {
   public class br_enteringreaptcheck : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20202279464777", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void wb_table1_25_7G2e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtavBr_encounter_refusereason_br_encounter_refusereason_fapprovedate_Internalname, context.localUtil.TToC( AV7BR_Encounter_RefuseReason.gxTpr_Br_encounter_refusereason_fapprovedate, 10, 8, 0, 0, "/", ":", " "), context.localUtil.Format( AV7BR_Encounter_RefuseReason.gxTpr_Br_encounter_refusereason_fapprovedate, "9999/99/99 99:99:99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'YMD',8,24,'chs',false,1);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,34);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavBr_encounter_refusereason_br_encounter_refusereason_fapprovedate_Jsonclick, 0, "Attribute", "", "", "", "", edtavBr_encounter_refusereason_br_encounter_refusereason_fapprovedate_Visible, 1, 0, "text", "", 19, "chr", 1, "row", 19, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_BR_EnteringReaptCheck.htm");
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?20202279464856", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("br_enteringreaptcheck.js", "?20202279464856", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false);
