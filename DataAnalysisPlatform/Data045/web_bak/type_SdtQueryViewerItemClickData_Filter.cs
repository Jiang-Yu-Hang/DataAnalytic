...
namespace GeneXus.Programs{
	...
	[XmlType(TypeName="QueryViewerItemClickData.Filter" , Namespace="DataAnalysisPlatform" )]
	[Serializable]
	...
	[DataContract(Name=@"QueryViewerItemClickData.Filter", Namespace="DataAnalysisPlatform")]
