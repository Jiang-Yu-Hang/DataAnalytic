/*
       ...
       Generated on: 2/27/2020 9:35:59.77
...
namespace GeneXus.Programs {
   public class br_encounterupdatecomorbidity : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202022793606", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void RenderHtmlCloseForm2U2( )
      {
         ...
         {
            context.AddJavascriptSource("br_encounterupdatecomorbidity.js", "?2020227936011", false);
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202022793628", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("br_encounterupdatecomorbidity.js", "?202022793629", false);
