/*
       ...
       Generated on: 2/27/2020 9:36:38.41
   ...
   public class br_lab : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void wb_table1_62_0G17e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtBR_Lab_SpecimenDate_Internalname, context.localUtil.TToC( A105BR_Lab_SpecimenDate, 10, 8, 0, 0, "/", ":", " "), context.localUtil.Format( A105BR_Lab_SpecimenDate, "9999/99/99 99:99:99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'YMD',8,24,'chs',false,1);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,77);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtBR_Lab_SpecimenDate_Jsonclick, 0, "AttributeDateTime", "", "", "", "", 1, edtBR_Lab_SpecimenDate_Enabled, 0, "text", "", 19, "chr", 1, "row", 19, 0, 0, 0, 1, -1, 0, true, "DM_DataTime", "right", false, "HLP_BR_Lab.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtBR_Lab_ReceivingTime_Internalname, context.localUtil.TToC( A264BR_Lab_ReceivingTime, 10, 8, 0, 0, "/", ":", " "), context.localUtil.Format( A264BR_Lab_ReceivingTime, "9999/99/99 99:99:99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'YMD',8,24,'chs',false,1);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,86);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtBR_Lab_ReceivingTime_Jsonclick, 0, "AttributeDateTime", "", "", "", "", 1, edtBR_Lab_ReceivingTime_Enabled, 0, "text", "", 19, "chr", 1, "row", 19, 0, 0, 0, 1, -1, 0, true, "DM_DataTime", "right", false, "HLP_BR_Lab.htm");
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20202279364716", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?20202279364788", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("br_lab.js", "?20202279364788", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false);
