/*
       ...
       Generated on: 2/27/2020 9:36:13.78
...
namespace GeneXus.Programs {
   public class br_encounterupdatedemographics : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2020227936144", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void RenderHtmlCloseForm2K2( )
      {
         ...
         {
            context.AddJavascriptSource("br_encounterupdatedemographics.js", "?2020227936148", false);
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?20202279361626", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("br_encounterupdatedemographics.js", "?20202279361626", false);
