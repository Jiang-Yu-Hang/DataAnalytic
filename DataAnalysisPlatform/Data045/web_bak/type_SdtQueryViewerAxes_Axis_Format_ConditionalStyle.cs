...
namespace GeneXus.Programs{
	...
	[XmlType(TypeName="QueryViewerAxes.Axis.Format.ConditionalStyle" , Namespace="DataAnalysisPlatform" )]
	[Serializable]
	...
	[DataContract(Name=@"QueryViewerAxes.Axis.Format.ConditionalStyle", Namespace="DataAnalysisPlatform")]
