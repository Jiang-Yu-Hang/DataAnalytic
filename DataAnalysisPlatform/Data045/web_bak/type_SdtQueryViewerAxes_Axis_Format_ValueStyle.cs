...
namespace GeneXus.Programs{
	...
	[XmlType(TypeName="QueryViewerAxes.Axis.Format.ValueStyle" , Namespace="DataAnalysisPlatform" )]
	[Serializable]
	...
	[DataContract(Name=@"QueryViewerAxes.Axis.Format.ValueStyle", Namespace="DataAnalysisPlatform")]
