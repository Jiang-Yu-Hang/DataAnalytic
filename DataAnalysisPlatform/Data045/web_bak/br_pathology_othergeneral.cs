/*
       ...
       Generated on: 2/27/2020 9:34:29.57
...
namespace GeneXus.Programs {
   public class br_pathology_othergeneral : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20202279342962", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void RenderHtmlCloseForm5A2( )
      {
         ...
         {
            context.AddJavascriptSource("br_pathology_othergeneral.js", "?20202279342965", false);
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?2020227934312", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("br_pathology_othergeneral.js", "?2020227934312", false);
