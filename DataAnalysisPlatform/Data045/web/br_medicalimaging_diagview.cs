/*
               File: BR_MedicalImaging_DiagView
        Description: BR_Medical Imaging_Diag View
             Author: GeneXus C# Generator version 16_0_0-127771
       Generated on: 2/28/2020 15:11:44.48
...
namespace GeneXus.Programs {
   public class br_medicalimaging_diagview : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public br_medicalimaging_diagview( )
      {
      ...
      public br_medicalimaging_diagview( IGxContext context )
      {
      ...
      public void execute( long aP0_BR_MedicalImaging_DiagID ,
                           String aP1_TabCode )
      {
         this.AV10BR_MedicalImaging_DiagID = aP0_BR_MedicalImaging_DiagID;
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV10BR_MedicalImaging_DiagID = (long)(NumberUtil.Val( gxfirstwebparm, "."));
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV10BR_MedicalImaging_DiagID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV10BR_MedicalImaging_DiagID), 18, 0)));
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "gxhash_vBR_MEDICALIMAGING_DIAGID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10BR_MedicalImaging_DiagID), "ZZZZZZZZZZZZZZZZZZ"), context));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202022815114450", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("br_medicalimaging_diagview.aspx") + "?" + UrlEncode("" +AV10BR_MedicalImaging_DiagID) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode))+"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vBR_MEDICALIMAGING_DIAGID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10BR_MedicalImaging_DiagID), 18, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vBR_MEDICALIMAGING_DIAGID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10BR_MedicalImaging_DiagID), "ZZZZZZZZZZZZZZZZZZ"), context));
      ...
      {
         return formatLink("br_medicalimaging_diagview.aspx") + "?" + UrlEncode("" +AV10BR_MedicalImaging_DiagID) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode)) ;
      }

      public override String GetPgmname( )
      {
         return "BR_MedicalImaging_DiagView" ;
      }

      public override String GetPgmdesc( )
      {
         return "BR_Medical Imaging_Diag View" ;
      }
      ...
      protected void WB4O0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnback_Internalname, "", "返回", bttBtnback_Jsonclick, 5, "返回", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOBACK\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_BR_MedicalImaging_DiagView.htm");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTxttabtitle_Internalname, lblTxttabtitle_Caption, "", "", lblTxttabtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockTitleWWPTab", 0, "", 1, 1, 0, "HLP_BR_MedicalImaging_DiagView.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "影像学诊断意见", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, "HLP_BR_MedicalImaging_DiagView.htm");
            /* Div Control */
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtngeneral_Internalname, "", "影像学诊断意见", bttBtngeneral_Jsonclick, 5, "影像学诊断意见", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'GENERAL\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_BR_MedicalImaging_DiagView.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START4O2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "BR_Medical Imaging_Diag View", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void E124O2( )
      {
         ...
         AV18GXLvl9 = 0;
         /* Using cursor H004O2 */
         pr_default.execute(0, new Object[] {AV10BR_MedicalImaging_DiagID});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A270BR_MedicalImaging_DiagID = H004O2_A270BR_MedicalImaging_DiagID[0];
            AV18GXLvl9 = 1;
      ...
      protected void S112( )
      {
         /* 'LOADTABS' Routine */
         /* Using cursor H004O3 */
         pr_default.execute(1, new Object[] {AV10BR_MedicalImaging_DiagID});
         while ( (pr_default.getStatus(1) != 101) )
         {
            A270BR_MedicalImaging_DiagID = H004O3_A270BR_MedicalImaging_DiagID[0];
            ...
            if ( AV13TempBoolean )
            {
               ...
               {
                  /* Object Property */
                  if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "BR_MedicalImaging_DiagGeneral")) != 0 )
                  {
                     WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "br_medicalimaging_diaggeneral", new Object[] {context} );
                     WebComp_Generalwc.ComponentInit();
                     WebComp_Generalwc.Name = "BR_MedicalImaging_DiagGeneral";
                     WebComp_Generalwc_Component = "BR_MedicalImaging_DiagGeneral";
                  }
                  if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
                  {
                     WebComp_Generalwc.setjustcreated();
                     WebComp_Generalwc.componentprepare(new Object[] {(String)"W0026",(String)"",(long)AV10BR_MedicalImaging_DiagID});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV10BR_MedicalImaging_DiagID = Convert.ToInt64(getParm(obj,0));
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV10BR_MedicalImaging_DiagID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV10BR_MedicalImaging_DiagID), 18, 0)));
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "gxhash_vBR_MEDICALIMAGING_DIAGID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10BR_MedicalImaging_DiagID), "ZZZZZZZZZZZZZZZZZZ"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202022815114483", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("br_medicalimaging_diagview.js", "?202022815114484", false);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "BR_Medical Imaging_Diag View";
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV10BR_MedicalImaging_DiagID',fld:'vBR_MEDICALIMAGING_DIAGID',pic:'ZZZZZZZZZZZZZZZZZZ',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("'DOBACK'","{handler:'E144O2',iparms:[]");
         setEventMetadata("'DOBACK'",",oparms:[]}");
         setEventMetadata("TABS.TABCHANGED","{handler:'E114O2',iparms:[{av:'Tabs_Activepagecontrolname',ctrl:'TABS',prop:'ActivePageControlName'},{av:'A270BR_MedicalImaging_DiagID',fld:'BR_MEDICALIMAGING_DIAGID',pic:'ZZZZZZZZZZZZZZZZZZ'},{av:'AV10BR_MedicalImaging_DiagID',fld:'vBR_MEDICALIMAGING_DIAGID',pic:'ZZZZZZZZZZZZZZZZZZ',hsh:true},{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''}]");
         setEventMetadata("TABS.TABCHANGED",",oparms:[{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'divCell_general_Visible',ctrl:'CELL_GENERAL',prop:'Visible'},{ctrl:'GENERALWC'},{av:'lblTxttabtitle_Caption',ctrl:'TXTTABTITLE',prop:'Caption'}]}");
         setEventMetadata("'GENERAL'","{handler:'E154O2',iparms:[{av:'A270BR_MedicalImaging_DiagID',fld:'BR_MEDICALIMAGING_DIAGID',pic:'ZZZZZZZZZZZZZZZZZZ'},{av:'AV10BR_MedicalImaging_DiagID',fld:'vBR_MEDICALIMAGING_DIAGID',pic:'ZZZZZZZZZZZZZZZZZZ',hsh:true},{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''}]");
         setEventMetadata("'GENERAL'",",oparms:[{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'divCell_general_Visible',ctrl:'CELL_GENERAL',prop:'Visible'},{ctrl:'GENERALWC'},{av:'lblTxttabtitle_Caption',ctrl:'TXTTABTITLE',prop:'Caption'}]}");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H004O2_A270BR_MedicalImaging_DiagID = new long[1] ;
         H004O3_A270BR_MedicalImaging_DiagID = new long[1] ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.br_medicalimaging_diagview__default(),
            new Object[][] {
                new Object[] {
               H004O2_A270BR_MedicalImaging_DiagID
               }
               , new Object[] {
               H004O3_A270BR_MedicalImaging_DiagID
               }
            }
         );
      ...
      private int idxLst ;
      private long AV10BR_MedicalImaging_DiagID ;
      private long wcpOAV10BR_MedicalImaging_DiagID ;
      ...
      private long[] H004O2_A270BR_MedicalImaging_DiagID ;
      private long[] H004O3_A270BR_MedicalImaging_DiagID ;
   ...
   public class br_medicalimaging_diagview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@AV10BR_MedicalImaging_DiagID",SqlDbType.Decimal,18,0}
          } ;
          Object[] prmH004O3 ;
          ...
          def= new CursorDef[] {
              new CursorDef("H004O2", "SELECT [BR_MedicalImaging_DiagID] FROM [BR_MedicalImaging_Diag] WITH (NOLOCK) WHERE [BR_MedicalImaging_DiagID] = @AV10BR_MedicalImaging_DiagID ORDER BY [BR_MedicalImaging_DiagID] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH004O2,1,0,false,true )
             ,new CursorDef("H004O3", "SELECT [BR_MedicalImaging_DiagID] FROM [BR_MedicalImaging_Diag] WITH (NOLOCK) WHERE [BR_MedicalImaging_DiagID] = @AV10BR_MedicalImaging_DiagID ORDER BY [BR_MedicalImaging_DiagID] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH004O3,1,0,true,true )
          };
       }
    }
