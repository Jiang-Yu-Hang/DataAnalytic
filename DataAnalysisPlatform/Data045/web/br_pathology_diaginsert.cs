/*
               File: BR_Pathology_DiagInsert
        Description:
             Author: GeneXus C# Generator version 16_0_0-127771
       Generated on: 2/28/2020 15:17:0.42
...
namespace GeneXus.Programs {
   public class br_pathology_diaginsert : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public br_pathology_diaginsert( )
      {
      ...
      public br_pathology_diaginsert( IGxContext context )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20202281517045", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("br_pathology_diaginsert.aspx") + "?" + UrlEncode("" +AV13BR_PathologyID)+"\">") ;
      ...
      {
         return formatLink("br_pathology_diaginsert.aspx") + "?" + UrlEncode("" +AV13BR_PathologyID) ;
      }

      public override String GetPgmname( )
      {
         return "BR_Pathology_DiagInsert" ;
      }
      ...
      protected void WB920( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockbr_pathology_diag_br_pathology_diag_loc_Internalname, "病理诊断(部位)", "", "", lblTextblockbr_pathology_diag_br_pathology_diag_loc_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, "HLP_BR_Pathology_DiagInsert.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_label_element( context, edtavBr_pathology_diag_br_pathology_diag_loc_Internalname, "病理诊断(部位)", "col-sm-3 AttributeLabel", 0, true);
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 29,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavBr_pathology_diag_br_pathology_diag_loc_Internalname, AV10BR_Pathology_Diag.gxTpr_Br_pathology_diag_loc, StringUtil.RTrim( context.localUtil.Format( AV10BR_Pathology_Diag.gxTpr_Br_pathology_diag_loc, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,29);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavBr_pathology_diag_br_pathology_diag_loc_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavBr_pathology_diag_br_pathology_diag_loc_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 1, -1, -1, true, "", "left", true, "HLP_BR_Pathology_DiagInsert.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-4 MergeLabelCell", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockbr_pathology_diag_br_pathology_diag_organ_Internalname, "病理诊断(器官)", "", "", lblTextblockbr_pathology_diag_br_pathology_diag_organ_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, "HLP_BR_Pathology_DiagInsert.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-8", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "left", "top", "", "", "div");
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavBr_pathology_diag_br_pathology_diag_organ_Internalname, "病理诊断(器官)", "col-sm-3 AttributeLabel", 0, true);
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 37,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavBr_pathology_diag_br_pathology_diag_organ_Internalname, AV10BR_Pathology_Diag.gxTpr_Br_pathology_diag_organ, StringUtil.RTrim( context.localUtil.Format( AV10BR_Pathology_Diag.gxTpr_Br_pathology_diag_organ, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,37);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavBr_pathology_diag_br_pathology_diag_organ_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavBr_pathology_diag_br_pathology_diag_organ_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 1, -1, -1, true, "", "left", true, "HLP_BR_Pathology_DiagInsert.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-4 MergeLabelCell", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockbr_pathology_diag_br_pathology_diag_tumortype_Internalname, "肿瘤类型", "", "", lblTextblockbr_pathology_diag_br_pathology_diag_tumortype_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, "HLP_BR_Pathology_DiagInsert.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-8", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "left", "top", "", "", "div");
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavBr_pathology_diag_br_pathology_diag_tumortype_Internalname, "肿瘤类型", "col-sm-3 AttributeLabel", 0, true);
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 46,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavBr_pathology_diag_br_pathology_diag_tumortype_Internalname, AV10BR_Pathology_Diag.gxTpr_Br_pathology_diag_tumortype, StringUtil.RTrim( context.localUtil.Format( AV10BR_Pathology_Diag.gxTpr_Br_pathology_diag_tumortype, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,46);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavBr_pathology_diag_br_pathology_diag_tumortype_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavBr_pathology_diag_br_pathology_diag_tumortype_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 1, -1, -1, true, "", "left", true, "HLP_BR_Pathology_DiagInsert.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-4 MergeLabelCell", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockbr_pathology_diag_br_pathology_diag_tumorstage_Internalname, "肿瘤分期", "", "", lblTextblockbr_pathology_diag_br_pathology_diag_tumorstage_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, "HLP_BR_Pathology_DiagInsert.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-8", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "left", "top", "", "", "div");
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavBr_pathology_diag_br_pathology_diag_tumorstage_Internalname, "肿瘤分期", "col-sm-3 AttributeLabel", 0, true);
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 54,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavBr_pathology_diag_br_pathology_diag_tumorstage_Internalname, AV10BR_Pathology_Diag.gxTpr_Br_pathology_diag_tumorstage, StringUtil.RTrim( context.localUtil.Format( AV10BR_Pathology_Diag.gxTpr_Br_pathology_diag_tumorstage, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,54);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavBr_pathology_diag_br_pathology_diag_tumorstage_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavBr_pathology_diag_br_pathology_diag_tumorstage_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 1, -1, -1, true, "", "left", true, "HLP_BR_Pathology_DiagInsert.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-4 MergeLabelCell", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockbr_pathology_diag_br_pathology_diag_tumorgrade_Internalname, "肿瘤分级", "", "", lblTextblockbr_pathology_diag_br_pathology_diag_tumorgrade_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, "HLP_BR_Pathology_DiagInsert.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-8", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "left", "top", "", "", "div");
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavBr_pathology_diag_br_pathology_diag_tumorgrade_Internalname, "肿瘤分级", "col-sm-3 AttributeLabel", 0, true);
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 63,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavBr_pathology_diag_br_pathology_diag_tumorgrade_Internalname, AV10BR_Pathology_Diag.gxTpr_Br_pathology_diag_tumorgrade, StringUtil.RTrim( context.localUtil.Format( AV10BR_Pathology_Diag.gxTpr_Br_pathology_diag_tumorgrade, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,63);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavBr_pathology_diag_br_pathology_diag_tumorgrade_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavBr_pathology_diag_br_pathology_diag_tumorgrade_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 1, -1, -1, true, "", "left", true, "HLP_BR_Pathology_DiagInsert.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnenter_Internalname, "", "保存", bttBtnenter_Jsonclick, 5, "确认", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"EENTER."+"'", TempTags, "", context.GetButtonType( ), "HLP_BR_Pathology_DiagInsert.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtncancel_Internalname, "", "取消", bttBtncancel_Jsonclick, 1, "取消", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", context.GetButtonType( ), "HLP_BR_Pathology_DiagInsert.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavBr_pathology_diag_br_pathology_diagid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10BR_Pathology_Diag.gxTpr_Br_pathology_diagid), 18, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV10BR_Pathology_Diag.gxTpr_Br_pathology_diagid), "ZZZZZZZZZZZZZZZZZZ")), TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,74);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavBr_pathology_diag_br_pathology_diagid_Jsonclick, 0, "Attribute", "", "", "", "", edtavBr_pathology_diag_br_pathology_diagid_Visible, 1, 0, "number", "1", 18, "chr", 1, "row", 18, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_BR_Pathology_DiagInsert.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 75,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavBr_pathology_diag_br_pathologyid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10BR_Pathology_Diag.gxTpr_Br_pathologyid), 18, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV10BR_Pathology_Diag.gxTpr_Br_pathologyid), "ZZZZZZZZZZZZZZZZZZ")), TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,75);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavBr_pathology_diag_br_pathologyid_Jsonclick, 0, "Attribute", "", "", "", "", edtavBr_pathology_diag_br_pathologyid_Visible, 1, 0, "number", "1", 18, "chr", 1, "row", 18, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_BR_Pathology_DiagInsert.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void S112( )
      {
         ...
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV10BR_Pathology_Diag.gxTpr_Br_pathology_diag_loc)) )
         {
            GX_msglist.addItem("病理诊断(部位)是必须填写的。");
            AV11CheckRequiredFieldsResult = false;
         }
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV10BR_Pathology_Diag.gxTpr_Br_pathology_diag_organ)) )
         {
            GX_msglist.addItem("病理诊断(器官)是必须填写的。");
            AV11CheckRequiredFieldsResult = false;
         }
      }
      ...
      protected void S122( )
      {
         ...
         AV26GXV8 = 1;
         while ( AV26GXV8 <= AV8Messages.Count )
         {
            AV7Message = ((SdtMessages_Message)AV8Messages.Item(AV26GXV8));
            GX_msglist.addItem(AV7Message.gxTpr_Description);
            AV26GXV8 = (int)(AV26GXV8+1);
         }
      }
      ...
      protected void E13922( )
      {
         ...
         {
            AV15tFlag = true;
            if ( ( AV15tFlag ) && String.IsNullOrEmpty(StringUtil.RTrim( AV10BR_Pathology_Diag.gxTpr_Br_pathology_diag_loc)) )
            {
               GX_msglist.addItem("病理诊断(部位)是必须填写的");
               AV15tFlag = false;
            }
            if ( ( AV15tFlag ) && String.IsNullOrEmpty(StringUtil.RTrim( AV10BR_Pathology_Diag.gxTpr_Br_pathology_diag_organ)) )
            {
               GX_msglist.addItem("病理诊断(器官)是必须填写的");
               AV15tFlag = false;
            }
            AV10BR_Pathology_Diag.gxTpr_Br_pathologyid = AV13BR_PathologyID;
            AV10BR_Pathology_Diag.Save();
            if ( AV10BR_Pathology_Diag.Success() )
            {
               context.CommitDataStores("br_pathology_diaginsert",pr_default);
            ...
            else
            {
               AV14ErrorMsg = "";
               AV28GXV10 = 1;
               AV27GXV9 = AV10BR_Pathology_Diag.GetMessages();
               while ( AV28GXV10 <= AV27GXV9.Count )
               {
                  AV7Message = ((SdtMessages_Message)AV27GXV9.Item(AV28GXV10));
         ...
         context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "AV10BR_Pathology_Diag", AV10BR_Pathology_Diag);
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?20202281517168", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("br_pathology_diaginsert.js", "?20202281517168", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("ENTER","{handler:'E13922',iparms:[{av:'AV10BR_Pathology_Diag',fld:'vBR_PATHOLOGY_DIAG',pic:''},{av:'AV13BR_PathologyID',fld:'vBR_PATHOLOGYID',pic:'ZZZZZZZZZZZZZZZZZZ',hsh:true}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV10BR_Pathology_Diag',fld:'vBR_PATHOLOGY_DIAG',pic:''}]}");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         AV14ErrorMsg = "";
         AV27GXV9 = new GXBaseCollection<SdtMessages_Message>( context, "Message", "GeneXus");
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_datastore1 = new DataStoreProvider(context, new GeneXus.Programs.br_pathology_diaginsert__datastore1(),
            new Object[][] {
            }
         );
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.br_pathology_diaginsert__default(),
            new Object[][] {
            }
         );
         /* GeneXus formulas. */
      ...
      private GXBaseCollection<SdtMessages_Message> AV27GXV9 ;
   ...
   public class br_pathology_diaginsert__datastore1 : DataStoreHelperBase, IDataStoreHelper
   {
 ...
 public class br_pathology_diaginsert__default : DataStoreHelperBase, IDataStoreHelper
 {
    public ICursor[] getCursors( )
    {
       cursorDefinitions();
