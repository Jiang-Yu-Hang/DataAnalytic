/*
               File: XT_ConfigView
        Description: XT_Config View
             Author: GeneXus C# Generator version 16_0_0-127771
       Generated on: 2/28/2020 15:15:49.35
...
namespace GeneXus.Programs {
   public class xt_configview : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public xt_configview( )
      {
      ...
      public xt_configview( IGxContext context )
      {
      ...
      public void execute( long aP0_XT_ConfigID ,
                           String aP1_TabCode )
      {
         this.AV10XT_ConfigID = aP0_XT_ConfigID;
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV10XT_ConfigID = (long)(NumberUtil.Val( gxfirstwebparm, "."));
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV10XT_ConfigID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV10XT_ConfigID), 18, 0)));
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "gxhash_vXT_CONFIGID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10XT_ConfigID), "ZZZZZZZZZZZZZZZZZZ"), context));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202022815154940", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("xt_configview.aspx") + "?" + UrlEncode("" +AV10XT_ConfigID) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode))+"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vXT_CONFIGID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10XT_ConfigID), 18, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vXT_CONFIGID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10XT_ConfigID), "ZZZZZZZZZZZZZZZZZZ"), context));
      ...
      {
         return formatLink("xt_configview.aspx") + "?" + UrlEncode("" +AV10XT_ConfigID) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode)) ;
      }

      public override String GetPgmname( )
      {
         return "XT_ConfigView" ;
      }

      public override String GetPgmdesc( )
      {
         return "XT_Config View" ;
      }
      ...
      protected void WB6W0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, "返回系统配置表", lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, "HLP_XT_ConfigView.htm");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTxttabtitle_Internalname, lblTxttabtitle_Caption, "", "", lblTxttabtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockTitleWWPTab", 0, "", 1, 1, 0, "HLP_XT_ConfigView.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, "HLP_XT_ConfigView.htm");
            /* Div Control */
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtngeneral_Internalname, "", "General", bttBtngeneral_Jsonclick, 7, "General", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e116w1_client"+"'", TempTags, "", 2, "HLP_XT_ConfigView.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START6W2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "XT_Config View", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void STRUP6W0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            /* Read saved values. */
            AV10XT_ConfigID = (long)(context.localUtil.CToN( cgiGet( "vXT_CONFIGID"), ".", ","));
      ...
      protected void E126W2( )
      {
         ...
         lblWorkwithlink_Link = formatLink("xt_configww.aspx") ;
         context.httpAjaxContext.ajax_rsp_assign_prop("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
         AV16GXLvl11 = 0;
         /* Using cursor H006W2 */
         pr_default.execute(0, new Object[] {AV10XT_ConfigID});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A195XT_ConfigID = H006W2_A195XT_ConfigID[0];
            A196XT_ConfigKey = H006W2_A196XT_ConfigKey[0];
            n196XT_ConfigKey = H006W2_n196XT_ConfigKey[0];
            AV16GXLvl11 = 1;
            Form.Caption = A196XT_ConfigKey;
      ...
      protected void S112( )
      {
         ...
         {
            /* Object Property */
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "XT_ConfigGeneral")) != 0 )
            {
               WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "xt_configgeneral", new Object[] {context} );
               WebComp_Generalwc.ComponentInit();
               WebComp_Generalwc.Name = "XT_ConfigGeneral";
               WebComp_Generalwc_Component = "XT_ConfigGeneral";
            }
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               WebComp_Generalwc.setjustcreated();
               WebComp_Generalwc.componentprepare(new Object[] {(String)"W0026",(String)"",(long)AV10XT_ConfigID});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV10XT_ConfigID = Convert.ToInt64(getParm(obj,0));
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV10XT_ConfigID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV10XT_ConfigID), 18, 0)));
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "gxhash_vXT_CONFIGID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10XT_ConfigID), "ZZZZZZZZZZZZZZZZZZ"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202022815154975", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("xt_configview.js", "?202022815154975", false);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV10XT_ConfigID',fld:'vXT_CONFIGID',pic:'ZZZZZZZZZZZZZZZZZZ',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("'GENERAL'","{handler:'E116W1',iparms:[{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV10XT_ConfigID',fld:'vXT_CONFIGID',pic:'ZZZZZZZZZZZZZZZZZZ',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H006W2_A195XT_ConfigID = new long[1] ;
         H006W2_A196XT_ConfigKey = new String[] {""} ;
         H006W2_n196XT_ConfigKey = new bool[] {false} ;
         A196XT_ConfigKey = "";
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.xt_configview__default(),
            new Object[][] {
                new Object[] {
               H006W2_A195XT_ConfigID, H006W2_A196XT_ConfigKey, H006W2_n196XT_ConfigKey
               }
            }
         );
      ...
      private int idxLst ;
      private long AV10XT_ConfigID ;
      private long wcpOAV10XT_ConfigID ;
      ...
      private long[] H006W2_A195XT_ConfigID ;
      private String[] H006W2_A196XT_ConfigKey ;
      private bool[] H006W2_n196XT_ConfigKey ;
   ...
   public class xt_configview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@AV10XT_ConfigID",SqlDbType.Decimal,18,0}
          } ;
          def= new CursorDef[] {
              new CursorDef("H006W2", "SELECT [XT_ConfigID], [XT_ConfigKey] FROM [XT_Config] WITH (NOLOCK) WHERE [XT_ConfigID] = @AV10XT_ConfigID ORDER BY [XT_ConfigID] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH006W2,1,0,false,true )
          };
       }
    }
