/*
       ...
       Generated on: 2/28/2020 15:17:9.0
...
namespace GeneXus.Programs {
   public class br_vitalinsert : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public br_vitalinsert( )
      {
      ...
      public br_vitalinsert( IGxContext context )
      {
      ...
      {
         this.AV19BR_EncounterID = aP0_BR_EncounterID;
         executePrivate();
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV19BR_EncounterID = (long)(NumberUtil.Val( gxfirstwebparm, "."));
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV19BR_EncounterID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV19BR_EncounterID), 18, 0)));
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "gxhash_vBR_ENCOUNTERID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV19BR_EncounterID), "ZZZZZZZZZZZZZZZZZZ"), context));
            }
            if ( context.isSpaRequest( ) )
            {
               enableJsOutput();
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2020228151795", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("br_vitalinsert.aspx") + "?" + UrlEncode("" +AV19BR_EncounterID)+"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vBR_ENCOUNTERID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV19BR_EncounterID), 18, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vBR_ENCOUNTERID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV19BR_EncounterID), "ZZZZZZZZZZZZZZZZZZ"), context));
      ...
      {
         return formatLink("br_vitalinsert.aspx") + "?" + UrlEncode("" +AV19BR_EncounterID) ;
      }

      public override String GetPgmname( )
      {
         return "BR_VitalInsert" ;
      }
      ...
      protected void WB9B0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockbr_vital_br_vital_measuredate_Internalname, "测量日期", "", "", lblTextblockbr_vital_br_vital_measuredate_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, "HLP_BR_VitalInsert.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtavBr_vital_br_vital_measuredate_Internalname, context.localUtil.Format(AV10BR_Vital.gxTpr_Br_vital_measuredate, "9999/99/99"), context.localUtil.Format( AV10BR_Vital.gxTpr_Br_vital_measuredate, "9999/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'YMD',0,24,'chs',false,1);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,29);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavBr_vital_br_vital_measuredate_Jsonclick, 0, "AttributeDate", "", "", "", "", 1, edtavBr_vital_br_vital_measuredate_Enabled, 0, "text", "", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_BR_VitalInsert.htm");
            GxWebStd.gx_bitmap( context, edtavBr_vital_br_vital_measuredate_Internalname+"_dp_trigger", context.GetImagePath( "61b9b5d3-dff6-4d59-9b00-da61bc2cbe93", "", context.GetTheme( )), "", "", "", "", ((1==0)||(edtavBr_vital_br_vital_measuredate_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_BR_VitalInsert.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-4 MergeLabelCell", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockbr_vital_br_vital_temperature_Internalname, "体温(℃)", "", "", lblTextblockbr_vital_br_vital_temperature_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, "HLP_BR_VitalInsert.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-8", "left", "top", "", "", "div");
            /* Div Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-4 MergeLabelCell", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockbr_vital_br_vital_pulse_Internalname, "脉搏(次/分钟)", "", "", lblTextblockbr_vital_br_vital_pulse_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, "HLP_BR_VitalInsert.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-8", "left", "top", "", "", "div");
            /* Div Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-4 MergeLabelCell", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockbr_vital_br_vital_respiration_Internalname, "呼吸频率(次/分钟)", "", "", lblTextblockbr_vital_br_vital_respiration_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, "HLP_BR_VitalInsert.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-8", "left", "top", "", "", "div");
            /* Div Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-4 MergeLabelCell", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockbr_vital_br_vital_systolic_Internalname, "收缩压(mmHg)", "", "", lblTextblockbr_vital_br_vital_systolic_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, "HLP_BR_VitalInsert.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-8", "left", "top", "", "", "div");
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtavBr_vital_br_vital_systolic_Internalname, StringUtil.LTrim( StringUtil.NToC( AV10BR_Vital.gxTpr_Br_vital_systolic, 15, 5, ".", "")), ((edtavBr_vital_br_vital_systolic_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( AV10BR_Vital.gxTpr_Br_vital_systolic, "ZZZZZZZZZ.ZZZZZ")) : context.localUtil.Format( AV10BR_Vital.gxTpr_Br_vital_systolic, "ZZZZZZZZZ.ZZZZZ")), TempTags+" onchange=\""+"gx.num.valid_decimal( this, ',','.','5');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,63);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavBr_vital_br_vital_systolic_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavBr_vital_br_vital_systolic_Enabled, 0, "text", "", 15, "chr", 1, "row", 15, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_BR_VitalInsert.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-4 MergeLabelCell", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockbr_vital_br_vital_diastolic_Internalname, "舒张压(mmHg)", "", "", lblTextblockbr_vital_br_vital_diastolic_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, "HLP_BR_VitalInsert.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-8", "left", "top", "", "", "div");
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtavBr_vital_br_vital_diastolic_Internalname, StringUtil.LTrim( StringUtil.NToC( AV10BR_Vital.gxTpr_Br_vital_diastolic, 15, 5, ".", "")), ((edtavBr_vital_br_vital_diastolic_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( AV10BR_Vital.gxTpr_Br_vital_diastolic, "ZZZZZZZZZ.ZZZZZ")) : context.localUtil.Format( AV10BR_Vital.gxTpr_Br_vital_diastolic, "ZZZZZZZZZ.ZZZZZ")), TempTags+" onchange=\""+"gx.num.valid_decimal( this, ',','.','5');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,71);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavBr_vital_br_vital_diastolic_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavBr_vital_br_vital_diastolic_Enabled, 0, "text", "", 15, "chr", 1, "row", 15, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_BR_VitalInsert.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-4 MergeLabelCell", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockbr_vital_br_vital_height_Internalname, "身高(cm)", "", "", lblTextblockbr_vital_br_vital_height_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, "HLP_BR_VitalInsert.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-8", "left", "top", "", "", "div");
            /* Div Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-4 MergeLabelCell", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockbr_vital_br_vital_weight_Internalname, "体重(kg)", "", "", lblTextblockbr_vital_br_vital_weight_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, "HLP_BR_VitalInsert.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-8", "left", "top", "", "", "div");
            /* Div Control */
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnenter_Internalname, "", "保存", bttBtnenter_Jsonclick, 5, "确认", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"EENTER."+"'", TempTags, "", context.GetButtonType( ), "HLP_BR_VitalInsert.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtncancel_Internalname, "", "取消", bttBtncancel_Jsonclick, 1, "取消", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", context.GetButtonType( ), "HLP_BR_VitalInsert.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavBr_vital_br_vitalid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10BR_Vital.gxTpr_Br_vitalid), 18, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV10BR_Vital.gxTpr_Br_vitalid), "ZZZZZZZZZZZZZZZZZZ")), TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,99);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavBr_vital_br_vitalid_Jsonclick, 0, "Attribute", "", "", "", "", edtavBr_vital_br_vitalid_Visible, 1, 0, "number", "1", 18, "chr", 1, "row", 18, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_BR_VitalInsert.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 100,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavBr_vital_br_encounterid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10BR_Vital.gxTpr_Br_encounterid), 18, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV10BR_Vital.gxTpr_Br_encounterid), "ZZZZZZZZZZZZZZZZZZ")), TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,100);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavBr_vital_br_encounterid_Jsonclick, 0, "Attribute", "", "", "", "", edtavBr_vital_br_encounterid_Visible, 1, 0, "number", "1", 18, "chr", 1, "row", 18, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_BR_VitalInsert.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 101,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavBr_vital_br_information_patientno_Internalname, AV10BR_Vital.gxTpr_Br_information_patientno, StringUtil.RTrim( context.localUtil.Format( AV10BR_Vital.gxTpr_Br_information_patientno, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,101);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavBr_vital_br_information_patientno_Jsonclick, 0, "Attribute", "", "", "", "", edtavBr_vital_br_information_patientno_Visible, 1, 0, "text", "", 80, "chr", 1, "row", 2000, 0, 0, 0, 1, -1, -1, true, "", "left", true, "HLP_BR_VitalInsert.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 102,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavBr_vital_br_vital_vitalid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10BR_Vital.gxTpr_Br_vital_vitalid), 10, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV10BR_Vital.gxTpr_Br_vital_vitalid), "ZZZZZZZZZZ")), TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,102);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavBr_vital_br_vital_vitalid_Jsonclick, 0, "Attribute", "", "", "", "", edtavBr_vital_br_vital_vitalid_Visible, 1, 0, "number", "1", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_BR_VitalInsert.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void S122( )
      {
         ...
         AV34GXV13 = 1;
         while ( AV34GXV13 <= AV8Messages.Count )
         {
            AV7Message = ((SdtMessages_Message)AV8Messages.Item(AV34GXV13));
            GX_msglist.addItem(AV7Message.gxTpr_Description);
            AV34GXV13 = (int)(AV34GXV13+1);
         }
      }
      ...
      protected void E139B2( )
      {
         /* Enter Routine */
         AV11tFlag = true;
         if ( ( AV11tFlag ) && (DateTime.MinValue==AV10BR_Vital.gxTpr_Br_vital_measuredate) )
         {
            GX_msglist.addItem("测量日期是必填的");
            AV11tFlag = false;
         }
         AV10BR_Vital.gxTpr_Br_encounterid = AV19BR_EncounterID;
         AV10BR_Vital.Save();
         if ( AV10BR_Vital.Success() )
         {
            context.CommitDataStores("br_vitalinsert",pr_default);
         ...
         else
         {
            AV12ErrorMsg = "";
            AV36GXV15 = 1;
            AV35GXV14 = AV10BR_Vital.GetMessages();
            while ( AV36GXV15 <= AV35GXV14.Count )
            {
               AV7Message = ((SdtMessages_Message)AV35GXV14.Item(AV36GXV15));
               AV12ErrorMsg = AV12ErrorMsg + StringUtil.Trim( AV7Message.gxTpr_Description);
               AV36GXV15 = (int)(AV36GXV15+1);
            }
         }
         /*  Sending Event outputs  */
         context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "AV10BR_Vital", AV10BR_Vital);
      }
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV19BR_EncounterID = Convert.ToInt64(getParm(obj,0));
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV19BR_EncounterID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV19BR_EncounterID), 18, 0)));
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "gxhash_vBR_ENCOUNTERID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV19BR_EncounterID), "ZZZZZZZZZZZZZZZZZZ"), context));
      }
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("br_vitalinsert.js", "?202022815171076", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV19BR_EncounterID',fld:'vBR_ENCOUNTERID',pic:'ZZZZZZZZZZZZZZZZZZ',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("ENTER","{handler:'E139B2',iparms:[{av:'AV10BR_Vital',fld:'vBR_VITAL',pic:''},{av:'AV19BR_EncounterID',fld:'vBR_ENCOUNTERID',pic:'ZZZZZZZZZZZZZZZZZZ',hsh:true}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV10BR_Vital',fld:'vBR_VITAL',pic:''}]}");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         AV12ErrorMsg = "";
         AV35GXV14 = new GXBaseCollection<SdtMessages_Message>( context, "Message", "GeneXus");
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_datastore1 = new DataStoreProvider(context, new GeneXus.Programs.br_vitalinsert__datastore1(),
            new Object[][] {
            }
         );
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.br_vitalinsert__default(),
            new Object[][] {
            }
         );
         /* GeneXus formulas. */
      ...
      private int AV34GXV13 ;
      private int AV36GXV15 ;
      private int idxLst ;
      private long AV19BR_EncounterID ;
      private long wcpOAV19BR_EncounterID ;
      ...
      private bool AV11tFlag ;
      private String AV12ErrorMsg ;
      ...
      private GXBaseCollection<SdtMessages_Message> AV35GXV14 ;
   ...
   public class br_vitalinsert__datastore1 : DataStoreHelperBase, IDataStoreHelper
   {
 ...
 public class br_vitalinsert__default : DataStoreHelperBase, IDataStoreHelper
 {
    public ICursor[] getCursors( )
    {
       cursorDefinitions();
