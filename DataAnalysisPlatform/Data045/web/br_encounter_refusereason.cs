/*
       ...
       Generated on: 2/28/2020 15:8:46.54
...
namespace GeneXus.Programs {
   public class br_encounter_refusereason : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void CheckExtendedTable1542( )
      {
         ...
         {
            GX_msglist.addItem("域复审不通过时间超界", "OutOfRange", 1, "BR_ENCOUNTER_REFUSEREASON_FAPPROVEDATE");
            AnyError = 1;
            GX_FocusControl = edtBR_Encounter_RefuseReason_FApproveDate_Internalname;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "GX_FocusControl", GX_FocusControl);
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20202281584828", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?20202281584856", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("br_encounter_refusereason.js", "?20202281584856", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false);
