/*
       ...
       Generated on: 2/28/2020 15:8:25.64
...
namespace GeneXus.Programs {
   public class br_pathology : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void CheckExtendedTable0Z36( )
      {
         ...
         {
            GX_msglist.addItem("域病理检查日期超界", "OutOfRange", 1, "BR_PATHOLOGYID_PADATE");
            AnyError = 1;
            GX_FocusControl = edtBR_PathologyID_PADate_Internalname;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "GX_FocusControl", GX_FocusControl);
         }
         ...
         {
            GX_msglist.addItem("域是否淋巴结转移超界", "OutOfRange", 1, "BR_PATHOLOGY_N");
            AnyError = 1;
         ...
         {
            GX_msglist.addItem("域是否远端转移超界", "OutOfRange", 1, "BR_PATHOLOGY_M");
            AnyError = 1;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20202281582930", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?20202281582959", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("br_pathology.js", "?20202281582960", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false);
