/*
       ...
       Generated on: 2/28/2020 15:7:31.97
...
namespace GeneXus.Programs {
   public class jc_providergeneral : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2020228157321", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void RenderHtmlCloseForm8K2( )
      {
         ...
         {
            context.AddJavascriptSource("jc_providergeneral.js", "?2020228157324", false);
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?20202281573276", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("jc_providergeneral.js", "?20202281573276", false);
