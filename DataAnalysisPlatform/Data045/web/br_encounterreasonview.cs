/*
               File: BR_EncounterReasonView
        Description: BR_Encounter Reason View
             Author: GeneXus C# Generator version 16_0_0-127771
       Generated on: 2/28/2020 15:15:49.52
...
namespace GeneXus.Programs {
   public class br_encounterreasonview : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public br_encounterreasonview( )
      {
      ...
      public br_encounterreasonview( IGxContext context )
      {
      ...
      public void execute( long aP0_BR_Encounter_ID ,
                           String aP1_TabCode )
      {
         this.AV10BR_Encounter_ID = aP0_BR_Encounter_ID;
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV10BR_Encounter_ID = (long)(NumberUtil.Val( gxfirstwebparm, "."));
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV10BR_Encounter_ID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV10BR_Encounter_ID), 15, 0)));
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "gxhash_vBR_ENCOUNTER_ID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10BR_Encounter_ID), "ZZZZZZZZZZZZZZ9"), context));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202022815154954", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("br_encounterreasonview.aspx") + "?" + UrlEncode("" +AV10BR_Encounter_ID) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode))+"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vBR_ENCOUNTER_ID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10BR_Encounter_ID), 15, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vBR_ENCOUNTER_ID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10BR_Encounter_ID), "ZZZZZZZZZZZZZZ9"), context));
      ...
      {
         return formatLink("br_encounterreasonview.aspx") + "?" + UrlEncode("" +AV10BR_Encounter_ID) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode)) ;
      }

      public override String GetPgmname( )
      {
         return "BR_EncounterReasonView" ;
      }

      public override String GetPgmdesc( )
      {
         return "BR_Encounter Reason View" ;
      }
      ...
      protected void WB750( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, "返回初审不通过原因", lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, "HLP_BR_EncounterReasonView.htm");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTxttabtitle_Internalname, lblTxttabtitle_Caption, "", "", lblTxttabtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockTitleWWPTab", 0, "", 1, 1, 0, "HLP_BR_EncounterReasonView.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, "HLP_BR_EncounterReasonView.htm");
            /* Div Control */
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtngeneral_Internalname, "", "General", bttBtngeneral_Jsonclick, 7, "General", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e11751_client"+"'", TempTags, "", 2, "HLP_BR_EncounterReasonView.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START752( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "BR_Encounter Reason View", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void STRUP750( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            /* Read saved values. */
            AV10BR_Encounter_ID = (long)(context.localUtil.CToN( cgiGet( "vBR_ENCOUNTER_ID"), ".", ","));
      ...
      protected void E12752( )
      {
         ...
         lblWorkwithlink_Link = formatLink("br_encounterreasonww.aspx") ;
         context.httpAjaxContext.ajax_rsp_assign_prop("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
         AV16GXLvl11 = 0;
         /* Using cursor H00752 */
         pr_default.execute(0, new Object[] {AV10BR_Encounter_ID});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A347BR_Encounter_ID = H00752_A347BR_Encounter_ID[0];
            A340BR_EncounterReason_Reason = H00752_A340BR_EncounterReason_Reason[0];
            n340BR_EncounterReason_Reason = H00752_n340BR_EncounterReason_Reason[0];
            AV16GXLvl11 = 1;
            Form.Caption = A340BR_EncounterReason_Reason;
      ...
      protected void S112( )
      {
         ...
         {
            /* Object Property */
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "BR_EncounterReasonGeneral")) != 0 )
            {
               WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "br_encounterreasongeneral", new Object[] {context} );
               WebComp_Generalwc.ComponentInit();
               WebComp_Generalwc.Name = "BR_EncounterReasonGeneral";
               WebComp_Generalwc_Component = "BR_EncounterReasonGeneral";
            }
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               WebComp_Generalwc.setjustcreated();
               WebComp_Generalwc.componentprepare(new Object[] {(String)"W0026",(String)"",(long)AV10BR_Encounter_ID});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV10BR_Encounter_ID = Convert.ToInt64(getParm(obj,0));
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV10BR_Encounter_ID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV10BR_Encounter_ID), 15, 0)));
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "gxhash_vBR_ENCOUNTER_ID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10BR_Encounter_ID), "ZZZZZZZZZZZZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202022815154985", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("br_encounterreasonview.js", "?202022815154986", false);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "BR_Encounter Reason View";
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV10BR_Encounter_ID',fld:'vBR_ENCOUNTER_ID',pic:'ZZZZZZZZZZZZZZ9',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("'GENERAL'","{handler:'E11751',iparms:[{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV10BR_Encounter_ID',fld:'vBR_ENCOUNTER_ID',pic:'ZZZZZZZZZZZZZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H00752_A347BR_Encounter_ID = new long[1] ;
         H00752_A340BR_EncounterReason_Reason = new String[] {""} ;
         H00752_n340BR_EncounterReason_Reason = new bool[] {false} ;
         A340BR_EncounterReason_Reason = "";
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.br_encounterreasonview__default(),
            new Object[][] {
                new Object[] {
               H00752_A347BR_Encounter_ID, H00752_A340BR_EncounterReason_Reason, H00752_n340BR_EncounterReason_Reason
               }
            }
         );
      ...
      private int idxLst ;
      private long AV10BR_Encounter_ID ;
      private long wcpOAV10BR_Encounter_ID ;
      ...
      private long[] H00752_A347BR_Encounter_ID ;
      private String[] H00752_A340BR_EncounterReason_Reason ;
      private bool[] H00752_n340BR_EncounterReason_Reason ;
   ...
   public class br_encounterreasonview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@AV10BR_Encounter_ID",SqlDbType.Decimal,15,0}
          } ;
          def= new CursorDef[] {
              new CursorDef("H00752", "SELECT [BR_Encounter_ID], [BR_EncounterReason_Reason] FROM [BR_EncounterReason] WITH (NOLOCK) WHERE [BR_Encounter_ID] = @AV10BR_Encounter_ID ORDER BY [BR_Encounter_ID] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00752,1,0,false,true )
          };
       }
    }
