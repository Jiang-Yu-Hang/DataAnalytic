/*
               File: BR_MedicationPrompt
        Description: 选择药物治疗
             Author: GeneXus C# Generator version 16_0_0-127771
       Generated on: 2/28/2020 15:10:23.99
...
namespace GeneXus.Programs {
   public class br_medicationprompt : GXHttpHandler, System.Web.SessionState.IRequiresSessionState
   {
      public br_medicationprompt( )
      {
      ...
      public br_medicationprompt( IGxContext context )
      {
      ...
      public void execute( ref long aP0_InOutBR_MedicationID ,
                           ref String aP1_InOutBR_Medication_RXName ,
                           ref decimal aP2_InOutBR_Medication_RXDose ,
                           ref String aP3_InOutBR_Medication_RXUnit )
      {
         this.AV8InOutBR_MedicationID = aP0_InOutBR_MedicationID;
         this.AV65InOutBR_Medication_RXName = aP1_InOutBR_Medication_RXName;
         this.AV66InOutBR_Medication_RXDose = aP2_InOutBR_Medication_RXDose;
         this.AV67InOutBR_Medication_RXUnit = aP3_InOutBR_Medication_RXUnit;
         executePrivate();
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV74Pgmname = "BR_MedicationPrompt";
               context.Gx_err = 0;
               WS3L2( ) ;
               if ( ! isAjaxCallMode( ) )
               {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202022815102419", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("br_medicationprompt.aspx") + "?" + UrlEncode("" +AV8InOutBR_MedicationID) + "," + UrlEncode(StringUtil.RTrim(AV65InOutBR_Medication_RXName)) + "," + UrlEncode(StringUtil.Str(AV66InOutBR_Medication_RXDose,15,5)) + "," + UrlEncode(StringUtil.RTrim(AV67InOutBR_Medication_RXUnit))+"\">") ;
      ...
      protected void WB3L0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblFiltertextbr_medication_rxname_Internalname, "药物名称", "", "", lblFiltertextbr_medication_rxname_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, "HLP_BR_MedicationPrompt.htm");
         ...
         if ( wbEnd == 32 )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtavOrderedby_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10OrderedBy), 4, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV10OrderedBy), "ZZZ9")), TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,65);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavOrderedby_Jsonclick, 0, "Attribute", "", "", "", "", edtavOrderedby_Visible, 1, 0, "number", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_BR_MedicationPrompt.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 66,'',false,'" + sGXsfl_32_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavOrdereddsc_Internalname, StringUtil.BoolToStr( AV11OrderedDsc), StringUtil.BoolToStr( AV11OrderedDsc), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,66);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavOrdereddsc_Jsonclick, 0, "Attribute", "", "", "", "", edtavOrdereddsc_Visible, 1, 0, "text", "", 4, "chr", 1, "row", 4, 0, 0, 0, 1, 0, 0, true, "", "right", false, "HLP_BR_MedicationPrompt.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 67,'',false,'" + sGXsfl_32_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavTfbr_medication_rxunit_Internalname, AV70TFBR_Medication_RXUnit, StringUtil.RTrim( context.localUtil.Format( AV70TFBR_Medication_RXUnit, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,67);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavTfbr_medication_rxunit_Jsonclick, 0, "Attribute", "", "", "", "", edtavTfbr_medication_rxunit_Visible, 1, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 1, -1, -1, true, "", "left", true, "HLP_BR_MedicationPrompt.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 68,'',false,'" + sGXsfl_32_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavTfbr_medication_rxunit_sel_Internalname, AV71TFBR_Medication_RXUnit_Sel, StringUtil.RTrim( context.localUtil.Format( AV71TFBR_Medication_RXUnit_Sel, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,68);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavTfbr_medication_rxunit_sel_Jsonclick, 0, "Attribute", "", "", "", "", edtavTfbr_medication_rxunit_sel_Visible, 1, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 1, -1, -1, true, "", "left", true, "HLP_BR_MedicationPrompt.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START3L2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "选择药物治疗", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void RF3L2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A132BR_Medication_AdmitStartDate = H003L2_A132BR_Medication_AdmitStartDate[0];
               n132BR_Medication_AdmitStartDate = H003L2_n132BR_Medication_AdmitStartDate[0];
               A128BR_Medication_RXDaysSupply = H003L2_A128BR_Medication_RXDaysSupply[0];
               n128BR_Medication_RXDaysSupply = H003L2_n128BR_Medication_RXDaysSupply[0];
               A127BR_Medication_RXQuantity = H003L2_A127BR_Medication_RXQuantity[0];
               n127BR_Medication_RXQuantity = H003L2_n127BR_Medication_RXQuantity[0];
               A126BR_Medication_RXFrequency = H003L2_A126BR_Medication_RXFrequency[0];
               n126BR_Medication_RXFrequency = H003L2_n126BR_Medication_RXFrequency[0];
               A125BR_Medication_RXUnit = H003L2_A125BR_Medication_RXUnit[0];
               n125BR_Medication_RXUnit = H003L2_n125BR_Medication_RXUnit[0];
               A124BR_Medication_RXDose = H003L2_A124BR_Medication_RXDose[0];
               n124BR_Medication_RXDose = H003L2_n124BR_Medication_RXDose[0];
               A121BR_Medication_RXName = H003L2_A121BR_Medication_RXName[0];
               n121BR_Medication_RXName = H003L2_n121BR_Medication_RXName[0];
               A19BR_EncounterID = H003L2_A19BR_EncounterID[0];
               A119BR_MedicationID = H003L2_A119BR_MedicationID[0];
               E223L2 ();
      ...
      protected void E233L2( )
      {
         ...
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV67InOutBR_Medication_RXUnit", AV67InOutBR_Medication_RXUnit);
         context.setWebReturnParms(new Object[] {(long)AV8InOutBR_MedicationID,(String)AV65InOutBR_Medication_RXName,(decimal)AV66InOutBR_Medication_RXDose,(String)AV67InOutBR_Medication_RXUnit});
         context.setWebReturnParmsMetadata(new Object[] {"AV8InOutBR_MedicationID","AV65InOutBR_Medication_RXName","AV66InOutBR_Medication_RXDose","AV67InOutBR_Medication_RXUnit"});
         context.wjLocDisableFrm = 1;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202022815103832", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("br_medicationprompt.js", "?202022815103832", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
      ...
      {
         wcpOAV65InOutBR_Medication_RXName = "";
         wcpOAV67InOutBR_Medication_RXUnit = "";
         ...
         H003L2_A132BR_Medication_AdmitStartDate = new DateTime[] {DateTime.MinValue} ;
         H003L2_n132BR_Medication_AdmitStartDate = new bool[] {false} ;
         H003L2_A128BR_Medication_RXDaysSupply = new decimal[1] ;
         H003L2_n128BR_Medication_RXDaysSupply = new bool[] {false} ;
         H003L2_A127BR_Medication_RXQuantity = new String[] {""} ;
         H003L2_n127BR_Medication_RXQuantity = new bool[] {false} ;
         H003L2_A126BR_Medication_RXFrequency = new String[] {""} ;
         H003L2_n126BR_Medication_RXFrequency = new bool[] {false} ;
         H003L2_A125BR_Medication_RXUnit = new String[] {""} ;
         H003L2_n125BR_Medication_RXUnit = new bool[] {false} ;
         H003L2_A124BR_Medication_RXDose = new decimal[1] ;
         H003L2_n124BR_Medication_RXDose = new bool[] {false} ;
         H003L2_A121BR_Medication_RXName = new String[] {""} ;
         H003L2_n121BR_Medication_RXName = new bool[] {false} ;
         H003L2_A19BR_EncounterID = new long[1] ;
         H003L2_A119BR_MedicationID = new long[1] ;
         ...
         sImgUrl = "";
         ROClassString = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.br_medicationprompt__default(),
            new Object[][] {
                new Object[] {
               H003L2_A132BR_Medication_AdmitStartDate, H003L2_n132BR_Medication_AdmitStartDate, H003L2_A128BR_Medication_RXDaysSupply, H003L2_n128BR_Medication_RXDaysSupply, H003L2_A127BR_Medication_RXQuantity, H003L2_n127BR_Medication_RXQuantity, H003L2_A126BR_Medication_RXFrequency, H003L2_n126BR_Medication_RXFrequency, H003L2_A125BR_Medication_RXUnit, H003L2_n125BR_Medication_RXUnit,
               H003L2_A124BR_Medication_RXDose, H003L2_n124BR_Medication_RXDose, H003L2_A121BR_Medication_RXName, H003L2_n121BR_Medication_RXName, H003L2_A19BR_EncounterID, H003L2_A119BR_MedicationID
               }
               , new Object[] {
      ...
      private long wcpOAV8InOutBR_MedicationID ;
      ...
      private decimal wcpOAV66InOutBR_Medication_RXDose ;
      ...
      private String wcpOAV65InOutBR_Medication_RXName ;
      private String wcpOAV67InOutBR_Medication_RXUnit ;
      ...
      private DateTime[] H003L2_A132BR_Medication_AdmitStartDate ;
      private bool[] H003L2_n132BR_Medication_AdmitStartDate ;
      private decimal[] H003L2_A128BR_Medication_RXDaysSupply ;
      private bool[] H003L2_n128BR_Medication_RXDaysSupply ;
      private String[] H003L2_A127BR_Medication_RXQuantity ;
      private bool[] H003L2_n127BR_Medication_RXQuantity ;
      private String[] H003L2_A126BR_Medication_RXFrequency ;
      private bool[] H003L2_n126BR_Medication_RXFrequency ;
      private String[] H003L2_A125BR_Medication_RXUnit ;
      private bool[] H003L2_n125BR_Medication_RXUnit ;
      private decimal[] H003L2_A124BR_Medication_RXDose ;
      private bool[] H003L2_n124BR_Medication_RXDose ;
      private String[] H003L2_A121BR_Medication_RXName ;
      private bool[] H003L2_n121BR_Medication_RXName ;
      private long[] H003L2_A19BR_EncounterID ;
      private long[] H003L2_A119BR_MedicationID ;
   ...
   public class br_medicationprompt__default : DataStoreHelperBase, IDataStoreHelper
   {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H003L2(context, (String)dynConstraints[0] , (String)dynConstraints[1] , (String)dynConstraints[2] , (String)dynConstraints[3] , (String)dynConstraints[4] , (short)dynConstraints[5] , (bool)dynConstraints[6] , (long)dynConstraints[7] , (long)dynConstraints[8] );
               case 1 :
                     return conditional_H003L3(context, (String)dynConstraints[0] , (String)dynConstraints[1] , (String)dynConstraints[2] , (String)dynConstraints[3] , (String)dynConstraints[4] , (short)dynConstraints[5] , (bool)dynConstraints[6] , (long)dynConstraints[7] , (long)dynConstraints[8] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H003L2", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH003L2,11,0,true,false )
             ,new CursorDef("H003L3", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH003L3,1,0,true,false )
          };
       }
    }
