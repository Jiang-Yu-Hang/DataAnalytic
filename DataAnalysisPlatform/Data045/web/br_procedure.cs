/*
       ...
       Generated on: 2/28/2020 15:8:36.32
   ...
   public class br_procedure : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void Draw( )
      {
         ...
         if ( ! GxWebStd.gx_redirect( context) )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtBR_Procedure_Date_Internalname, context.localUtil.Format(A266BR_Procedure_Date, "9999/99/99"), context.localUtil.Format( A266BR_Procedure_Date, "9999/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'YMD',0,24,'chs',false,1);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,40);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtBR_Procedure_Date_Jsonclick, 0, "AttributeDate", "", "", "", "", 1, edtBR_Procedure_Date_Enabled, 0, "text", "", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, 0, true, "DM_Date", "right", false, "HLP_BR_Procedure.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtBR_Procedure_RadioDate_Internalname, context.localUtil.Format(A268BR_Procedure_RadioDate, "9999/99/99"), context.localUtil.Format( A268BR_Procedure_RadioDate, "9999/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'YMD',0,24,'chs',false,1);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,60);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtBR_Procedure_RadioDate_Jsonclick, 0, "AttributeDate", "", "", "", "", 1, edtBR_Procedure_RadioDate_Enabled, 0, "text", "", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, 0, true, "DM_Date", "right", false, "HLP_BR_Procedure.htm");
      ...
      protected void CheckExtendedTable0I19( )
      {
         ...
         {
            GX_msglist.addItem("域是否手术超界", "OutOfRange", 1, "BR_PROCEDURE_PXSURGERY");
            AnyError = 1;
            GX_FocusControl = cmbBR_Procedure_PXSurgery_Internalname;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "GX_FocusControl", GX_FocusControl);
         }
         ...
         {
            GX_msglist.addItem("域手术日期超界", "OutOfRange", 1, "BR_PROCEDURE_DATE");
            AnyError = 1;
            GX_FocusControl = edtBR_Procedure_Date_Internalname;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "GX_FocusControl", GX_FocusControl);
         }
         ...
         {
            GX_msglist.addItem("域是否接受放射疗法超界", "OutOfRange", 1, "BR_PROCEDURE_PXRADIOTHERAPY");
            AnyError = 1;
         ...
         {
            GX_msglist.addItem("域放疗日期超界", "OutOfRange", 1, "BR_PROCEDURE_RADIODATE");
            AnyError = 1;
            GX_FocusControl = edtBR_Procedure_RadioDate_Internalname;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "GX_FocusControl", GX_FocusControl);
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20202281583880", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?2020228158397", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("br_procedure.js", "?2020228158398", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false);
