/*
       ...
       Generated on: 2/28/2020 15:5:29.78
...
namespace GeneXus.Programs {
   public class br_encountercheckgeneral : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20202281552983", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void RenderHtmlCloseForm3T2( )
      {
         ...
         {
            context.AddJavascriptSource("br_encountercheckgeneral.js", "?20202281553028", false);
         }
      ...
      protected void wb_table2_25_3T2e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-md-6 DataContentCell", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "form-group gx-form-group", "left", "top", ""+" data-gx-for=\""+edtBR_Encounter_Departmentadm_Internalname+"\"", "", "div");
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtBR_Encounter_Departmentadm_Internalname, "就诊入院科室", "col-sm-3 ReadonlyAttributeLabel", 1, true);
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
            /* Single line edit */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-md-6 DataContentCell", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "form-group gx-form-group", "left", "top", ""+" data-gx-for=\""+edtBR_Encounter_Departmentdisch_Internalname+"\"", "", "div");
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtBR_Encounter_Departmentdisch_Internalname, "就诊出院科室", "col-sm-3 ReadonlyAttributeLabel", 1, true);
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
            /* Single line edit */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-md-6 DataContentCell", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "form-group gx-form-group", "left", "top", ""+" data-gx-for=\""+edtBR_Encounter_Insurance_Internalname+"\"", "", "div");
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtBR_Encounter_Insurance_Internalname, "就诊保险类型", "col-sm-3 ReadonlyAttributeLabel", 1, true);
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtBR_Encounter_Insurance_Internalname, A574BR_Encounter_Insurance, StringUtil.RTrim( context.localUtil.Format( A574BR_Encounter_Insurance, "")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtBR_Encounter_Insurance_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtBR_Encounter_Insurance_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 1, -1, -1, true, "", "left", true, "HLP_BR_EncounterCheckGeneral.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtBR_Encounter_Department_Internalname, A84BR_Encounter_Department, StringUtil.RTrim( context.localUtil.Format( A84BR_Encounter_Department, "")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtBR_Encounter_Department_Jsonclick, 0, "Attribute", "", "", "", "", edtBR_Encounter_Department_Visible, 0, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 1, -1, -1, true, "", "left", true, "HLP_BR_EncounterCheckGeneral.htm");
            /* ComboBox */
      ...
      protected void RF3T2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            while ( (pr_default.getStatus(0) != 101) )
            {
               ...
               A574BR_Encounter_Insurance = H003T2_A574BR_Encounter_Insurance[0];
               context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "A574BR_Encounter_Insurance", A574BR_Encounter_Insurance);
               n574BR_Encounter_Insurance = H003T2_n574BR_Encounter_Insurance[0];
               ...
               A572BR_Encounter_Departmentdisch = H003T2_A572BR_Encounter_Departmentdisch[0];
               ...
               n572BR_Encounter_Departmentdisch = H003T2_n572BR_Encounter_Departmentdisch[0];
               A570BR_Encounter_Departmentadm = H003T2_A570BR_Encounter_Departmentadm[0];
               ...
               n570BR_Encounter_Departmentadm = H003T2_n570BR_Encounter_Departmentadm[0];
      ...
      protected void E123T2( )
      {
         ...
         edtBR_Encounter_Department_Visible = 0;
         context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtBR_Encounter_Department_Internalname, "Visible", StringUtil.LTrim( StringUtil.Str( (decimal)(edtBR_Encounter_Department_Visible), 5, 0)), true);
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?20202281553250", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("br_encountercheckgeneral.js", "?20202281553250", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false);
      ...
      public override void initialize_properties( )
      {
         ...
         edtBR_Encounter_Department_Visible = 1;
      ...
      public override void initialize( )
      {
         ...
         H003T2_A574BR_Encounter_Insurance = new String[] {""} ;
         H003T2_n574BR_Encounter_Insurance = new bool[] {false} ;
         H003T2_A90BR_Encounter_ENCType = new String[] {""} ;
         H003T2_n90BR_Encounter_ENCType = new bool[] {false} ;
         H003T2_A572BR_Encounter_Departmentdisch = new String[] {""} ;
         H003T2_n572BR_Encounter_Departmentdisch = new bool[] {false} ;
         H003T2_A570BR_Encounter_Departmentadm = new String[] {""} ;
         H003T2_n570BR_Encounter_Departmentadm = new bool[] {false} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.br_encountercheckgeneral__default(),
            new Object[][] {
                new Object[] {
               H003T2_A19BR_EncounterID, H003T2_A172BR_Encounter_Status, H003T2_n172BR_Encounter_Status, H003T2_A84BR_Encounter_Department, H003T2_n84BR_Encounter_Department, H003T2_A85BR_Information_ID, H003T2_n85BR_Information_ID, H003T2_A94BR_Encounter_DischargeStatus, H003T2_n94BR_Encounter_DischargeStatus, H003T2_A93BR_Encounter_DischargeDate,
               H003T2_n93BR_Encounter_DischargeDate, H003T2_A91BR_Encounter_AdmitDate, H003T2_n91BR_Encounter_AdmitDate, H003T2_A92BR_Encounter_AdmitSource, H003T2_n92BR_Encounter_AdmitSource, H003T2_A574BR_Encounter_Insurance, H003T2_n574BR_Encounter_Insurance, H003T2_A90BR_Encounter_ENCType, H003T2_n90BR_Encounter_ENCType, H003T2_A572BR_Encounter_Departmentdisch,
               H003T2_n572BR_Encounter_Departmentdisch, H003T2_A570BR_Encounter_Departmentadm, H003T2_n570BR_Encounter_Departmentadm, H003T2_A35BR_Encounter_EncID, H003T2_n35BR_Encounter_EncID, H003T2_A36BR_Information_PatientNo, H003T2_n36BR_Information_PatientNo
               }
            }
         );
         AV19Pgmname = "BR_EncounterCheckGeneral";
      ...
      private int edtBR_Encounter_Department_Visible ;
      ...
      private String[] H003T2_A574BR_Encounter_Insurance ;
      private bool[] H003T2_n574BR_Encounter_Insurance ;
      private String[] H003T2_A90BR_Encounter_ENCType ;
      private bool[] H003T2_n90BR_Encounter_ENCType ;
      private String[] H003T2_A572BR_Encounter_Departmentdisch ;
      private bool[] H003T2_n572BR_Encounter_Departmentdisch ;
      private String[] H003T2_A570BR_Encounter_Departmentadm ;
      private bool[] H003T2_n570BR_Encounter_Departmentadm ;
   ...
   public class br_encountercheckgeneral__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H003T2", "SELECT T1.[BR_EncounterID], T1.[BR_Encounter_Status], T1.[BR_Encounter_Department], T1.[BR_Information_ID], T1.[BR_Encounter_DischargeStatus], T1.[BR_Encounter_DischargeDate], T1.[BR_Encounter_AdmitDate], T1.[BR_Encounter_AdmitSource], T1.[BR_Encounter_Insurance], T1.[BR_Encounter_ENCType], T1.[BR_Encounter_Departmentdisch], T1.[BR_Encounter_Departmentadm], T1.[BR_Encounter_EncID], T2.[BR_Information_PatientNo] FROM ([BR_Encounter] T1 WITH (NOLOCK) LEFT JOIN [BR_Information] T2 WITH (NOLOCK) ON T2.[BR_Information_ID] = T1.[BR_Information_ID]) WHERE T1.[BR_EncounterID] = @BR_EncounterID ORDER BY T1.[BR_EncounterID] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH003T2,1,0,true,true )
          };
       }
    }
