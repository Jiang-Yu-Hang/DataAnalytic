/*
               File: BR_Encounter_RefuseReasonView
        Description: BR_Encounter_Refuse Reason View
             Author: GeneXus C# Generator version 16_0_0-127771
       Generated on: 2/28/2020 15:15:55.94
...
namespace GeneXus.Programs {
   public class br_encounter_refusereasonview : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public br_encounter_refusereasonview( )
      {
      ...
      public br_encounter_refusereasonview( IGxContext context )
      {
      ...
      public void execute( long aP0_BR_Encounter_RefuseReasonID ,
                           String aP1_TabCode )
      {
         this.AV10BR_Encounter_RefuseReasonID = aP0_BR_Encounter_RefuseReasonID;
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV10BR_Encounter_RefuseReasonID = (long)(NumberUtil.Val( gxfirstwebparm, "."));
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV10BR_Encounter_RefuseReasonID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV10BR_Encounter_RefuseReasonID), 18, 0)));
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "gxhash_vBR_ENCOUNTER_REFUSEREASONID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10BR_Encounter_RefuseReasonID), "ZZZZZZZZZZZZZZZZZZ"), context));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202022815155597", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("br_encounter_refusereasonview.aspx") + "?" + UrlEncode("" +AV10BR_Encounter_RefuseReasonID) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode))+"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vBR_ENCOUNTER_REFUSEREASONID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10BR_Encounter_RefuseReasonID), 18, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vBR_ENCOUNTER_REFUSEREASONID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10BR_Encounter_RefuseReasonID), "ZZZZZZZZZZZZZZZZZZ"), context));
      ...
      {
         return formatLink("br_encounter_refusereasonview.aspx") + "?" + UrlEncode("" +AV10BR_Encounter_RefuseReasonID) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode)) ;
      }

      public override String GetPgmname( )
      {
         return "BR_Encounter_RefuseReasonView" ;
      }

      public override String GetPgmdesc( )
      {
         return "BR_Encounter_Refuse Reason View" ;
      }
      ...
      protected void WB7B0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWorkwithlink_Internalname, "返回就诊信息驳回原因", lblWorkwithlink_Link, "", lblWorkwithlink_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockLink", 0, "", 1, 1, 0, "HLP_BR_Encounter_RefuseReasonView.htm");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTxttabtitle_Internalname, lblTxttabtitle_Caption, "", "", lblTxttabtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockTitleWWPTab", 0, "", 1, 1, 0, "HLP_BR_Encounter_RefuseReasonView.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, "HLP_BR_Encounter_RefuseReasonView.htm");
            /* Div Control */
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtngeneral_Internalname, "", "General", bttBtngeneral_Jsonclick, 7, "General", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e117b1_client"+"'", TempTags, "", 2, "HLP_BR_Encounter_RefuseReasonView.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START7B2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "BR_Encounter_Refuse Reason View", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void STRUP7B0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            /* Read saved values. */
            AV10BR_Encounter_RefuseReasonID = (long)(context.localUtil.CToN( cgiGet( "vBR_ENCOUNTER_REFUSEREASONID"), ".", ","));
      ...
      protected void E127B2( )
      {
         ...
         lblWorkwithlink_Link = formatLink("br_encounter_refusereasonww.aspx") ;
         context.httpAjaxContext.ajax_rsp_assign_prop("", false, lblWorkwithlink_Internalname, "Link", lblWorkwithlink_Link, true);
         AV16GXLvl11 = 0;
         /* Using cursor H007B2 */
         pr_default.execute(0, new Object[] {AV10BR_Encounter_RefuseReasonID});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A348BR_Encounter_RefuseReasonID = H007B2_A348BR_Encounter_RefuseReasonID[0];
            A349BR_Encounter_RefuseReason_Reason = H007B2_A349BR_Encounter_RefuseReason_Reason[0];
            n349BR_Encounter_RefuseReason_Reason = H007B2_n349BR_Encounter_RefuseReason_Reason[0];
            AV16GXLvl11 = 1;
            Form.Caption = A349BR_Encounter_RefuseReason_Reason;
      ...
      protected void S112( )
      {
         ...
         {
            /* Object Property */
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "BR_Encounter_RefuseReasonGeneral")) != 0 )
            {
               WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "br_encounter_refusereasongeneral", new Object[] {context} );
               WebComp_Generalwc.ComponentInit();
               WebComp_Generalwc.Name = "BR_Encounter_RefuseReasonGeneral";
               WebComp_Generalwc_Component = "BR_Encounter_RefuseReasonGeneral";
            }
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               WebComp_Generalwc.setjustcreated();
               WebComp_Generalwc.componentprepare(new Object[] {(String)"W0026",(String)"",(long)AV10BR_Encounter_RefuseReasonID});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV10BR_Encounter_RefuseReasonID = Convert.ToInt64(getParm(obj,0));
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV10BR_Encounter_RefuseReasonID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV10BR_Encounter_RefuseReasonID), 18, 0)));
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "gxhash_vBR_ENCOUNTER_REFUSEREASONID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10BR_Encounter_RefuseReasonID), "ZZZZZZZZZZZZZZZZZZ"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202022815155625", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("br_encounter_refusereasonview.js", "?202022815155625", false);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "BR_Encounter_Refuse Reason View";
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV10BR_Encounter_RefuseReasonID',fld:'vBR_ENCOUNTER_REFUSEREASONID',pic:'ZZZZZZZZZZZZZZZZZZ',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("'GENERAL'","{handler:'E117B1',iparms:[{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV10BR_Encounter_RefuseReasonID',fld:'vBR_ENCOUNTER_REFUSEREASONID',pic:'ZZZZZZZZZZZZZZZZZZ',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H007B2_A348BR_Encounter_RefuseReasonID = new long[1] ;
         H007B2_A349BR_Encounter_RefuseReason_Reason = new String[] {""} ;
         H007B2_n349BR_Encounter_RefuseReason_Reason = new bool[] {false} ;
         A349BR_Encounter_RefuseReason_Reason = "";
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.br_encounter_refusereasonview__default(),
            new Object[][] {
                new Object[] {
               H007B2_A348BR_Encounter_RefuseReasonID, H007B2_A349BR_Encounter_RefuseReason_Reason, H007B2_n349BR_Encounter_RefuseReason_Reason
               }
            }
         );
      ...
      private int idxLst ;
      private long AV10BR_Encounter_RefuseReasonID ;
      private long wcpOAV10BR_Encounter_RefuseReasonID ;
      ...
      private long[] H007B2_A348BR_Encounter_RefuseReasonID ;
      private String[] H007B2_A349BR_Encounter_RefuseReason_Reason ;
      private bool[] H007B2_n349BR_Encounter_RefuseReason_Reason ;
   ...
   public class br_encounter_refusereasonview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@AV10BR_Encounter_RefuseReasonID",SqlDbType.Decimal,18,0}
          } ;
          def= new CursorDef[] {
              new CursorDef("H007B2", "SELECT [BR_Encounter_RefuseReasonID], [BR_Encounter_RefuseReason_Reason] FROM [BR_Encounter_RefuseReason] WITH (NOLOCK) WHERE [BR_Encounter_RefuseReasonID] = @AV10BR_Encounter_RefuseReasonID ORDER BY [BR_Encounter_RefuseReasonID] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH007B2,1,0,false,true )
          };
       }
    }
