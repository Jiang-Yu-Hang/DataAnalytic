/*
       ...
       Generated on: 2/28/2020 15:5:3.33
...
namespace GeneXus.Programs {
   public class br_pathology_othergeneral : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2020228155338", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void RenderHtmlCloseForm5A2( )
      {
         ...
         {
            context.AddJavascriptSource("br_pathology_othergeneral.js", "?2020228155341", false);
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?2020228155439", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("br_pathology_othergeneral.js", "?2020228155439", false);
