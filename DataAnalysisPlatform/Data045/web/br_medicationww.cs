/*
       ...
       Generated on: 2/28/2020 15:10:45.17
...
namespace GeneXus.Programs {
   public class br_medicationww : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202022815104543", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void WB3K0( )
      {
         ...
         if ( wbEnd == 12 )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtavTfbr_medication_admitstartdate_Internalname, context.localUtil.Format(AV77TFBR_Medication_AdmitStartDate, "9999/99/99"), context.localUtil.Format( AV77TFBR_Medication_AdmitStartDate, "9999/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'YMD',0,24,'chs',false,1);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,55);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavTfbr_medication_admitstartdate_Jsonclick, 0, "Attribute", "", "", "", "", edtavTfbr_medication_admitstartdate_Visible, 1, 0, "text", "", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_BR_MedicationWW.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtavTfbr_medication_admitstartdate_to_Internalname, context.localUtil.Format(AV78TFBR_Medication_AdmitStartDate_To, "9999/99/99"), context.localUtil.Format( AV78TFBR_Medication_AdmitStartDate_To, "9999/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'YMD',0,24,'chs',false,1);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,56);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavTfbr_medication_admitstartdate_to_Jsonclick, 0, "Attribute", "", "", "", "", edtavTfbr_medication_admitstartdate_to_Visible, 1, 0, "text", "", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_BR_MedicationWW.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtavDdo_br_medication_admitstartdateauxdate_Internalname, context.localUtil.Format(AV79DDO_BR_Medication_AdmitStartDateAuxDate, "9999/99/99"), context.localUtil.Format( AV79DDO_BR_Medication_AdmitStartDateAuxDate, "9999/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'YMD',0,24,'chs',false,1);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,58);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavDdo_br_medication_admitstartdateauxdate_Jsonclick, 0, "Attribute", "", "", "", "", 1, 1, 0, "text", "", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_BR_MedicationWW.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtavDdo_br_medication_admitstartdateauxdateto_Internalname, context.localUtil.Format(AV80DDO_BR_Medication_AdmitStartDateAuxDateTo, "9999/99/99"), context.localUtil.Format( AV80DDO_BR_Medication_AdmitStartDateAuxDateTo, "9999/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'YMD',0,24,'chs',false,1);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,59);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavDdo_br_medication_admitstartdateauxdateto_Jsonclick, 0, "Attribute", "", "", "", "", 1, 1, 0, "text", "", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_BR_MedicationWW.htm");
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202022815105923", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("br_medicationww.js", "?202022815105923", false);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
