/*
               File: BR_EncounterUpdateBR_SchemeWC
        Description: Data Mgmt Portal - RAAP
             Author: GeneXus C# Generator version 16_0_0-127771
       Generated on: 2/28/2020 15:8:42.12
...
namespace GeneXus.Programs {
   public class br_encounterupdatebr_schemewc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      public br_encounterupdatebr_schemewc( )
      {
      ...
      public br_encounterupdatebr_schemewc( IGxContext context )
      {
         ...
         if ( StringUtil.Len( (String)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
               {
                  ...
                  AV36IsAuthorized_Display = StringUtil.StrToBool( GetNextPar( ));
                  sPrefix = GetNextPar( );
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV48Pgmname = "BR_EncounterUpdateBR_SchemeWC";
               context.Gx_err = 0;
               WS6L2( ) ;
               if ( ! isAjaxCallMode( ) )
               {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20202281584228", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.skipLines(1);
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("br_encounterupdatebr_schemewc.aspx") + "?" + UrlEncode("" +AV8BR_EncounterID)+"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vISAUTHORIZED_DISPLAY", AV36IsAuthorized_Display);
      ...
      protected void RenderHtmlCloseForm6L2( )
      {
         ...
         {
            context.AddJavascriptSource("br_encounterupdatebr_schemewc.js", "?20202281584399", false);
         }
      ...
      {
         return "BR_EncounterUpdateBR_SchemeWC" ;
      }
      ...
      protected void WB6L0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "br_encounterupdatebr_schemewc.aspx");
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
               context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false);
               context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false);
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(28), 2, 0)+","+"null"+");", "新增", bttBtninsert_Jsonclick, 5, "插入", "", StyleString, ClassString, bttBtninsert_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_BR_EncounterUpdateBR_SchemeWC.htm");
            ...
            else
            {
               ...
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", context.convertURL( AV32myedit));
               ...
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", context.convertURL( AV33mydel));
         ...
         if ( wbEnd == 28 )
         {
            ...
            ClassString = "Attribute";
            StyleString = "";
            GxWebStd.gx_html_textarea( context, edtavDdo_br_scheme_chem_regimenstitlecontrolidtoreplace_Internalname, AV18ddo_BR_Scheme_Chem_RegimensTitleControlIdToReplace, "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,45);\"", 0, edtavDdo_br_scheme_chem_regimenstitlecontrolidtoreplace_Visible, 1, 0, 80, "chr", 4, "row", StyleString, ClassString, "", "", "300", -1, 0, "", "", -1, true, "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", 0, "HLP_BR_EncounterUpdateBR_SchemeWC.htm");
            /* User Defined Control */
            ...
            ClassString = "Attribute";
            StyleString = "";
            GxWebStd.gx_html_textarea( context, edtavDdo_br_scheme_therapy_linetitlecontrolidtoreplace_Internalname, AV20ddo_BR_Scheme_Therapy_LineTitleControlIdToReplace, "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,47);\"", 0, edtavDdo_br_scheme_therapy_linetitlecontrolidtoreplace_Visible, 1, 0, 80, "chr", 4, "row", StyleString, ClassString, "", "", "300", -1, 0, "", "", -1, true, "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", 0, "HLP_BR_EncounterUpdateBR_SchemeWC.htm");
            /* User Defined Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtavBr_schemeid_selected_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV35BR_SchemeID_Selected), 18, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV35BR_SchemeID_Selected), "ZZZZZZZZZZZZZZZZZZ")), TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,54);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavBr_schemeid_selected_Jsonclick, 0, "Attribute", "", "", "", "", edtavBr_schemeid_selected_Visible, 1, 0, "number", "1", 18, "chr", 1, "row", 18, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_BR_EncounterUpdateBR_SchemeWC.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 55,'" + sPrefix + "',false,'" + sGXsfl_28_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavOrderedby_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV14OrderedBy), 4, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV14OrderedBy), "ZZZ9")), TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,55);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavOrderedby_Jsonclick, 0, "Attribute", "", "", "", "", edtavOrderedby_Visible, 1, 0, "number", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_BR_EncounterUpdateBR_SchemeWC.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 56,'" + sPrefix + "',false,'" + sGXsfl_28_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavOrdereddsc_Internalname, StringUtil.BoolToStr( AV15OrderedDsc), StringUtil.BoolToStr( AV15OrderedDsc), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,56);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavOrdereddsc_Jsonclick, 0, "Attribute", "", "", "", "", edtavOrdereddsc_Visible, 1, 0, "text", "", 4, "chr", 1, "row", 4, 0, 0, 0, 1, 0, 0, true, "", "right", false, "HLP_BR_EncounterUpdateBR_SchemeWC.htm");
            wb_table1_57_6L2( true) ;
         }
         else
         {
            wb_table1_57_6L2( false) ;
         }
         return  ;
      }

      protected void wb_table1_57_6L2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
                  ...
                  if ( StringUtil.Len( sEvt) > 0 )
                  {
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 13), "VMYEDIT.CLICK") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 13), "VMYEDIT.CLICK") == 0 ) )
                           {
                              if ( ( StringUtil.Len( sPrefix) != 0 ) && ( nDoneStart == 0 ) )
                              {
                                 STRUP6L0( ) ;
                              ...
                              context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtavDisplay_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV31Display)) ? AV45Display_GXI : context.convertURL( context.PathToRelativeUrl( AV31Display))), !bGXsfl_28_Refreshing);
                              ...
                              AV32myedit = cgiGet( edtavMyedit_Internalname);
                              context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtavMyedit_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV32myedit)) ? AV46Myedit_GXI : context.convertURL( context.PathToRelativeUrl( AV32myedit))), !bGXsfl_28_Refreshing);
                              context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtavMyedit_Internalname, "SrcSet", context.GetImageSrcSet( AV32myedit), true);
                              AV33mydel = cgiGet( edtavMydel_Internalname);
                              context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtavMydel_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV33mydel)) ? AV47Mydel_GXI : context.convertURL( context.PathToRelativeUrl( AV33mydel))), !bGXsfl_28_Refreshing);
                              context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtavMydel_Internalname, "SrcSet", context.GetImageSrcSet( AV33mydel), true);
                              ...
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "VMYEDIT.CLICK") == 0 )
                                 {
                                    if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
                                    {
                                       context.wbHandled = 1;
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_BR_SCHEMEID", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(A327BR_SchemeID), "ZZZZZZZZZZZZZZZZZZ"), context));
         GxWebStd.gx_hidden_field( context, sPrefix+"BR_SCHEMEID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A327BR_SchemeID), 18, 0, ".", "")));
      }
      ...
      protected void RF6L2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A19BR_EncounterID = H006L2_A19BR_EncounterID[0];
               ...
               A331BR_Scheme_Chem_Detail = H006L2_A331BR_Scheme_Chem_Detail[0];
               n331BR_Scheme_Chem_Detail = H006L2_n331BR_Scheme_Chem_Detail[0];
               A330BR_Scheme_Chem_Cycle = H006L2_A330BR_Scheme_Chem_Cycle[0];
               n330BR_Scheme_Chem_Cycle = H006L2_n330BR_Scheme_Chem_Cycle[0];
               A329BR_Scheme_Therapy_Line = H006L2_A329BR_Scheme_Therapy_Line[0];
               n329BR_Scheme_Therapy_Line = H006L2_n329BR_Scheme_Therapy_Line[0];
               A328BR_Scheme_Chem_Regimens = H006L2_A328BR_Scheme_Chem_Regimens[0];
               n328BR_Scheme_Chem_Regimens = H006L2_n328BR_Scheme_Chem_Regimens[0];
               A327BR_SchemeID = H006L2_A327BR_SchemeID[0];
               E216L2 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_BR_SCHEMEID"+"_"+sGXsfl_28_idx, GetSecureSignedToken( sPrefix+sGXsfl_28_idx, context.localUtil.Format( (decimal)(A327BR_SchemeID), "ZZZZZZZZZZZZZZZZZZ"), context));
      }
      ...
      protected void STRUP6L0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "A19BR_EncounterID", StringUtil.LTrim( StringUtil.Str( (decimal)(A19BR_EncounterID), 18, 0)));
            if ( ( ( context.localUtil.CToN( cgiGet( edtavBr_schemeid_selected_Internalname), ".", ",") < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtavBr_schemeid_selected_Internalname), ".", ",") > Convert.ToDecimal( 999999999999999999L )) ) )
            {
               GX_msglist.addItem(context.GetMessage( "GXM_badnum", ""), 1, "vBR_SCHEMEID_SELECTED");
               GX_FocusControl = edtavBr_schemeid_selected_Internalname;
               context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "GX_FocusControl", GX_FocusControl);
               wbErr = true;
               AV35BR_SchemeID_Selected = 0;
               context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "AV35BR_SchemeID_Selected", StringUtil.LTrim( StringUtil.Str( (decimal)(AV35BR_SchemeID_Selected), 18, 0)));
            }
            else
            {
               AV35BR_SchemeID_Selected = (long)(context.localUtil.CToN( cgiGet( edtavBr_schemeid_selected_Internalname), ".", ","));
               context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "AV35BR_SchemeID_Selected", StringUtil.LTrim( StringUtil.Str( (decimal)(AV35BR_SchemeID_Selected), 18, 0)));
            }
      ...
      {
         /* Start Routine */
         edtavBr_schemeid_selected_Visible = 0;
         context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtavBr_schemeid_selected_Internalname, "Visible", StringUtil.LTrim( StringUtil.Str( (decimal)(edtavBr_schemeid_selected_Visible), 5, 0)), true);
         subGrid_Rows = 9;
         GxWebStd.gx_hidden_field( context, sPrefix+"GRID_Rows", StringUtil.LTrim( StringUtil.NToC( (decimal)(subGrid_Rows), 6, 0, ".", "")));
      ...
      protected void E206L2( )
      {
         ...
         context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtBR_Scheme_Therapy_Line_Internalname, "Title", edtBR_Scheme_Therapy_Line_Title, !bGXsfl_28_Refreshing);
         ...
         context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtBR_Scheme_Chem_Cycle_Internalname, "Title", edtBR_Scheme_Chem_Cycle_Title, !bGXsfl_28_Refreshing);
         ...
         context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtBR_Scheme_Chem_Detail_Internalname, "Title", edtBR_Scheme_Chem_Detail_Title, !bGXsfl_28_Refreshing);
      ...
      private void E216L2( )
      {
         ...
         AV45Display_GXI = GXDbFile.PathToUrl( context.GetImagePath( "f11923b6-6acd-4a79-bfc0-0cfc6f3bced5", "", context.GetTheme( )));
         ...
         AV32myedit = context.GetImagePath( "7c63c2b9-483e-4035-b512-febf9186a274", "", context.GetTheme( ));
         context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, edtavMyedit_Internalname, AV32myedit);
         AV46Myedit_GXI = GXDbFile.PathToUrl( context.GetImagePath( "7c63c2b9-483e-4035-b512-febf9186a274", "", context.GetTheme( )));
         edtavMyedit_Tooltiptext = "";
         AV33mydel = context.GetImagePath( "7695fe89-52c9-4b7e-871e-0e11548f823e", "", context.GetTheme( ));
         context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, edtavMydel_Internalname, AV33mydel);
         AV47Mydel_GXI = GXDbFile.PathToUrl( context.GetImagePath( "7695fe89-52c9-4b7e-871e-0e11548f823e", "", context.GetTheme( )));
      ...
      protected void E176L2( )
      {
         ...
         new zutil_checksession(context ).execute( out  AV41tCheckFlag) ;
         if ( ! AV41tCheckFlag )
         {
      ...
      protected void E186L2( )
      {
         ...
         CallWebObject(formatLink("br_scheminsert.aspx") + "?" + UrlEncode("" +AV8BR_EncounterID));
         context.wjLocDisableFrm = 1;
      }
      ...
      protected void S132( )
      {
         ...
         GXt_boolean2 = AV36IsAuthorized_Display;
         new GeneXus.Programs.wwpbaseobjects.secisauthbyfunctionalitykey(context ).execute(  "Manage_Scheme", out  GXt_boolean2) ;
         AV36IsAuthorized_Display = GXt_boolean2;
         context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "AV36IsAuthorized_Display", AV36IsAuthorized_Display);
         if ( ! ( AV36IsAuthorized_Display ) )
         {
         ...
         GXt_boolean2 = AV37IsAuthorized_myedit;
         new GeneXus.Programs.wwpbaseobjects.secisauthbyfunctionalitykey(context ).execute(  "Manage_Scheme", out  GXt_boolean2) ;
         AV37IsAuthorized_myedit = GXt_boolean2;
         if ( ! ( AV37IsAuthorized_myedit ) )
         {
         ...
         GXt_boolean2 = AV38IsAuthorized_mydel;
         new GeneXus.Programs.wwpbaseobjects.secisauthbyfunctionalitykey(context ).execute(  "Manage_Scheme", out  GXt_boolean2) ;
         AV38IsAuthorized_mydel = GXt_boolean2;
         if ( ! ( AV38IsAuthorized_mydel ) )
         {
      ...
      {
         /* 'DO MYDEL' Routine */
         new zbr_deletescheme(context ).execute(  AV8BR_EncounterID,  A327BR_SchemeID) ;
         context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "AV8BR_EncounterID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV8BR_EncounterID), 18, 0)));
         context.DoAjaxRefreshCmp(sPrefix);
      }
      ...
      protected void S122( )
      {
         ...
         if ( StringUtil.StrCmp(AV16Session.Get(AV48Pgmname+"GridState"), "") == 0 )
         {
            AV12GridState.FromXml(new GeneXus.Programs.wwpbaseobjects.loadgridstate(context).executeUdp(  AV48Pgmname+"GridState"), null, "WWPGridState", "DataAnalysisPlatform");
         }
         else
         {
            AV12GridState.FromXml(AV16Session.Get(AV48Pgmname+"GridState"), null, "WWPGridState", "DataAnalysisPlatform");
         }
      ...
      protected void S142( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.savegridstate(context ).execute(  AV48Pgmname+"GridState",  AV12GridState.ToXml(false, true, "WWPGridState", "DataAnalysisPlatform")) ;
      }
      ...
      protected void S112( )
      {
         ...
         AV10TrnContext.gxTpr_Callerobject = AV48Pgmname;
      ...
      {
         /* Myedit_Click Routine */
         new zutil_checksession(context ).execute( out  AV41tCheckFlag) ;
         if ( ! AV41tCheckFlag )
         {
            CallWebObject(formatLink("br_schemeupdate.aspx") + "?" + UrlEncode("" +A327BR_SchemeID));
            context.wjLocDisableFrm = 1;
         }
      }

      protected void wb_table1_57_6L2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_57_6L2e( true) ;
         }
         else
         {
            wb_table1_57_6L2e( false) ;
         }
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "br_encounterupdatebr_schemewc", GetJustCreated( ));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?20202281585190", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("br_encounterupdatebr_schemewc.js", "?20202281585191", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
      ...
      protected void SubsflControlProps_282( )
      {
         ...
         edtBR_SchemeID_Internalname = sPrefix+"BR_SCHEMEID_"+sGXsfl_28_idx;
         edtBR_Scheme_Chem_Regimens_Internalname = sPrefix+"BR_SCHEME_CHEM_REGIMENS_"+sGXsfl_28_idx;
         edtBR_Scheme_Therapy_Line_Internalname = sPrefix+"BR_SCHEME_THERAPY_LINE_"+sGXsfl_28_idx;
         edtBR_Scheme_Chem_Cycle_Internalname = sPrefix+"BR_SCHEME_CHEM_CYCLE_"+sGXsfl_28_idx;
         edtBR_Scheme_Chem_Detail_Internalname = sPrefix+"BR_SCHEME_CHEM_DETAIL_"+sGXsfl_28_idx;
      }
      ...
      protected void SubsflControlProps_fel_282( )
      {
         ...
         edtBR_SchemeID_Internalname = sPrefix+"BR_SCHEMEID_"+sGXsfl_28_fel_idx;
         edtBR_Scheme_Chem_Regimens_Internalname = sPrefix+"BR_SCHEME_CHEM_REGIMENS_"+sGXsfl_28_fel_idx;
         edtBR_Scheme_Therapy_Line_Internalname = sPrefix+"BR_SCHEME_THERAPY_LINE_"+sGXsfl_28_fel_idx;
         edtBR_Scheme_Chem_Cycle_Internalname = sPrefix+"BR_SCHEME_CHEM_CYCLE_"+sGXsfl_28_fel_idx;
         edtBR_Scheme_Chem_Detail_Internalname = sPrefix+"BR_SCHEME_CHEM_DETAIL_"+sGXsfl_28_fel_idx;
      }
      ...
      protected void sendrow_282( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_28_idx <= subGrid_Recordsperpage( ) * 1 ) )
         {
            ...
            StyleString = "";
            AV31Display_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV31Display))&&String.IsNullOrEmpty(StringUtil.RTrim( AV45Display_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV31Display)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV31Display)) ? AV45Display_GXI : context.PathToRelativeUrl( AV31Display));
            ...
            ClassString = "ActionBaseColorAttribute";
            StyleString = "";
            AV32myedit_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV32myedit))&&String.IsNullOrEmpty(StringUtil.RTrim( AV46Myedit_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV32myedit)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV32myedit)) ? AV46Myedit_GXI : context.PathToRelativeUrl( AV32myedit));
            GridRow.AddColumnProperties("bitmap", 1, isAjaxCallMode( ), new Object[] {(String)edtavMyedit_Internalname,(String)sImgUrl,(String)"",(String)"",(String)"",context.GetTheme( ),(int)edtavMyedit_Visible,(short)1,(String)"",(String)edtavMyedit_Tooltiptext,(short)0,(short)-1,(short)0,(String)"px",(short)0,(String)"px",(short)0,(short)0,(short)5,(String)edtavMyedit_Jsonclick,"'"+sPrefix+"'"+",false,"+"'"+sPrefix+"EVMYEDIT.CLICK."+sGXsfl_28_idx+"'",(String)StyleString,(String)ClassString,(String)"WWActionColumn",(String)"",(String)"",(String)"",(String)""+TempTags,(String)"",(String)"",(short)1,(bool)AV32myedit_IsBlob,(bool)false,context.GetImageSrcSet( sImgUrl)});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
            ...
            ClassString = "ActionBaseColorAttribute";
            StyleString = "";
            AV33mydel_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV33mydel))&&String.IsNullOrEmpty(StringUtil.RTrim( AV47Mydel_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV33mydel)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV33mydel)) ? AV47Mydel_GXI : context.PathToRelativeUrl( AV33mydel));
            GridRow.AddColumnProperties("bitmap", 1, isAjaxCallMode( ), new Object[] {(String)edtavMydel_Internalname,(String)sImgUrl,(String)"",(String)"",(String)"",context.GetTheme( ),(int)edtavMydel_Visible,(short)1,(String)"",(String)edtavMydel_Tooltiptext,(short)0,(short)-1,(short)0,(String)"px",(short)0,(String)"px",(short)0,(short)0,(short)7,(String)edtavMydel_Jsonclick,(String)"'"+sPrefix+"'"+",false,"+"'"+"e236l2_client"+"'",(String)StyleString,(String)ClassString,(String)"WWActionColumn",(String)"",(String)"",(String)"",(String)""+TempTags,(String)"",(String)"",(short)1,(bool)AV33mydel_IsBlob,(bool)false,context.GetImageSrcSet( sImgUrl)});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
      ...
      protected void init_default_properties( )
      {
         ...
         edtavBr_schemeid_selected_Internalname = sPrefix+"vBR_SCHEMEID_SELECTED";
      ...
      public override void initialize_properties( )
      {
         ...
         edtavBr_schemeid_selected_Jsonclick = "";
         edtavBr_schemeid_selected_Visible = 1;
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("DDO_BR_SCHEME_THERAPY_LINE.ONOPTIONCLICKED","{handler:'E146L2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV8BR_EncounterID',fld:'vBR_ENCOUNTERID',pic:'ZZZZZZZZZZZZZZZZZZ'},{av:'AV18ddo_BR_Scheme_Chem_RegimensTitleControlIdToReplace',fld:'vDDO_BR_SCHEME_CHEM_REGIMENSTITLECONTROLIDTOREPLACE',pic:''},{av:'AV20ddo_BR_Scheme_Therapy_LineTitleControlIdToReplace',fld:'vDDO_BR_SCHEME_THERAPY_LINETITLECONTROLIDTOREPLACE',pic:''},{av:'AV22ddo_BR_Scheme_Chem_CycleTitleControlIdToReplace',fld:'vDDO_BR_SCHEME_CHEM_CYCLETITLECONTROLIDTOREPLACE',pic:''},{av:'AV24ddo_BR_Scheme_Chem_DetailTitleControlIdToReplace',fld:'vDDO_BR_SCHEME_CHEM_DETAILTITLECONTROLIDTOREPLACE',pic:''},{av:'AV48Pgmname',fld:'vPGMNAME',pic:''},{av:'AV36IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:''},{av:'sPrefix'},{av:'Ddo_br_scheme_therapy_line_Activeeventkey',ctrl:'DDO_BR_SCHEME_THERAPY_LINE',prop:'ActiveEventKey'}]");
         ...
         setEventMetadata("DDO_BR_SCHEME_CHEM_CYCLE.ONOPTIONCLICKED","{handler:'E156L2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV8BR_EncounterID',fld:'vBR_ENCOUNTERID',pic:'ZZZZZZZZZZZZZZZZZZ'},{av:'AV18ddo_BR_Scheme_Chem_RegimensTitleControlIdToReplace',fld:'vDDO_BR_SCHEME_CHEM_REGIMENSTITLECONTROLIDTOREPLACE',pic:''},{av:'AV20ddo_BR_Scheme_Therapy_LineTitleControlIdToReplace',fld:'vDDO_BR_SCHEME_THERAPY_LINETITLECONTROLIDTOREPLACE',pic:''},{av:'AV22ddo_BR_Scheme_Chem_CycleTitleControlIdToReplace',fld:'vDDO_BR_SCHEME_CHEM_CYCLETITLECONTROLIDTOREPLACE',pic:''},{av:'AV24ddo_BR_Scheme_Chem_DetailTitleControlIdToReplace',fld:'vDDO_BR_SCHEME_CHEM_DETAILTITLECONTROLIDTOREPLACE',pic:''},{av:'AV48Pgmname',fld:'vPGMNAME',pic:''},{av:'AV36IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:''},{av:'sPrefix'},{av:'Ddo_br_scheme_chem_cycle_Activeeventkey',ctrl:'DDO_BR_SCHEME_CHEM_CYCLE',prop:'ActiveEventKey'}]");
         ...
         setEventMetadata("DDO_BR_SCHEME_CHEM_DETAIL.ONOPTIONCLICKED","{handler:'E166L2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV8BR_EncounterID',fld:'vBR_ENCOUNTERID',pic:'ZZZZZZZZZZZZZZZZZZ'},{av:'AV18ddo_BR_Scheme_Chem_RegimensTitleControlIdToReplace',fld:'vDDO_BR_SCHEME_CHEM_REGIMENSTITLECONTROLIDTOREPLACE',pic:''},{av:'AV20ddo_BR_Scheme_Therapy_LineTitleControlIdToReplace',fld:'vDDO_BR_SCHEME_THERAPY_LINETITLECONTROLIDTOREPLACE',pic:''},{av:'AV22ddo_BR_Scheme_Chem_CycleTitleControlIdToReplace',fld:'vDDO_BR_SCHEME_CHEM_CYCLETITLECONTROLIDTOREPLACE',pic:''},{av:'AV24ddo_BR_Scheme_Chem_DetailTitleControlIdToReplace',fld:'vDDO_BR_SCHEME_CHEM_DETAILTITLECONTROLIDTOREPLACE',pic:''},{av:'AV48Pgmname',fld:'vPGMNAME',pic:''},{av:'AV36IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:''},{av:'sPrefix'},{av:'Ddo_br_scheme_chem_detail_Activeeventkey',ctrl:'DDO_BR_SCHEME_CHEM_DETAIL',prop:'ActiveEventKey'}]");
         ...
         setEventMetadata("GRID.LOAD","{handler:'E216L2',iparms:[{av:'AV36IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:''},{av:'A327BR_SchemeID',fld:'BR_SCHEMEID',pic:'ZZZZZZZZZZZZZZZZZZ',hsh:true}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'AV31Display',fld:'vDISPLAY',pic:''},{av:'edtavDisplay_Tooltiptext',ctrl:'vDISPLAY',prop:'Tooltiptext'},{av:'edtavDisplay_Link',ctrl:'vDISPLAY',prop:'Link'},{av:'AV32myedit',fld:'vMYEDIT',pic:''},{av:'edtavMyedit_Tooltiptext',ctrl:'vMYEDIT',prop:'Tooltiptext'},{av:'AV33mydel',fld:'vMYDEL',pic:''},{av:'edtavMydel_Tooltiptext',ctrl:'vMYDEL',prop:'Tooltiptext'}]}");
         setEventMetadata("'DOMYDEL'","{handler:'E236L2',iparms:[{av:'A327BR_SchemeID',fld:'BR_SCHEMEID',pic:'ZZZZZZZZZZZZZZZZZZ',hsh:true}]");
         setEventMetadata("'DOMYDEL'",",oparms:[{av:'AV35BR_SchemeID_Selected',fld:'vBR_SCHEMEID_SELECTED',pic:'ZZZZZZZZZZZZZZZZZZ'}]}");
         setEventMetadata("DVELOP_CONFIRMPANEL_MYDEL.CLOSE","{handler:'E176L2',iparms:[{av:'Dvelop_confirmpanel_mydel_Result',ctrl:'DVELOP_CONFIRMPANEL_MYDEL',prop:'Result'},{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV8BR_EncounterID',fld:'vBR_ENCOUNTERID',pic:'ZZZZZZZZZZZZZZZZZZ'},{av:'AV18ddo_BR_Scheme_Chem_RegimensTitleControlIdToReplace',fld:'vDDO_BR_SCHEME_CHEM_REGIMENSTITLECONTROLIDTOREPLACE',pic:''},{av:'AV20ddo_BR_Scheme_Therapy_LineTitleControlIdToReplace',fld:'vDDO_BR_SCHEME_THERAPY_LINETITLECONTROLIDTOREPLACE',pic:''},{av:'AV22ddo_BR_Scheme_Chem_CycleTitleControlIdToReplace',fld:'vDDO_BR_SCHEME_CHEM_CYCLETITLECONTROLIDTOREPLACE',pic:''},{av:'AV24ddo_BR_Scheme_Chem_DetailTitleControlIdToReplace',fld:'vDDO_BR_SCHEME_CHEM_DETAILTITLECONTROLIDTOREPLACE',pic:''},{av:'AV48Pgmname',fld:'vPGMNAME',pic:''},{av:'AV36IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:''},{av:'sPrefix'},{av:'A327BR_SchemeID',fld:'BR_SCHEMEID',pic:'ZZZZZZZZZZZZZZZZZZ',hsh:true}]");
         setEventMetadata("DVELOP_CONFIRMPANEL_MYDEL.CLOSE",",oparms:[{av:'AV17BR_Scheme_Chem_RegimensTitleFilterData',fld:'vBR_SCHEME_CHEM_REGIMENSTITLEFILTERDATA',pic:''},{av:'AV19BR_Scheme_Therapy_LineTitleFilterData',fld:'vBR_SCHEME_THERAPY_LINETITLEFILTERDATA',pic:''},{av:'AV21BR_Scheme_Chem_CycleTitleFilterData',fld:'vBR_SCHEME_CHEM_CYCLETITLEFILTERDATA',pic:''},{av:'AV23BR_Scheme_Chem_DetailTitleFilterData',fld:'vBR_SCHEME_CHEM_DETAILTITLEFILTERDATA',pic:''},{av:'edtBR_Scheme_Chem_Regimens_Titleformat',ctrl:'BR_SCHEME_CHEM_REGIMENS',prop:'Titleformat'},{av:'edtBR_Scheme_Chem_Regimens_Title',ctrl:'BR_SCHEME_CHEM_REGIMENS',prop:'Title'},{av:'edtBR_Scheme_Therapy_Line_Titleformat',ctrl:'BR_SCHEME_THERAPY_LINE',prop:'Titleformat'},{av:'edtBR_Scheme_Therapy_Line_Title',ctrl:'BR_SCHEME_THERAPY_LINE',prop:'Title'},{av:'edtBR_Scheme_Chem_Cycle_Titleformat',ctrl:'BR_SCHEME_CHEM_CYCLE',prop:'Titleformat'},{av:'edtBR_Scheme_Chem_Cycle_Title',ctrl:'BR_SCHEME_CHEM_CYCLE',prop:'Title'},{av:'edtBR_Scheme_Chem_Detail_Titleformat',ctrl:'BR_SCHEME_CHEM_DETAIL',prop:'Titleformat'},{av:'edtBR_Scheme_Chem_Detail_Title',ctrl:'BR_SCHEME_CHEM_DETAIL',prop:'Title'},{av:'AV28GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV42GridPageCount',fld:'vGRIDPAGECOUNT',pic:'ZZZZZZZZZ9'},{av:'AV36IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:''},{av:'edtavDisplay_Visible',ctrl:'vDISPLAY',prop:'Visible'},{av:'edtavMyedit_Visible',ctrl:'vMYEDIT',prop:'Visible'},{av:'edtavMydel_Visible',ctrl:'vMYDEL',prop:'Visible'},{ctrl:'BTNINSERT',prop:'Visible'}]}");
         setEventMetadata("'DOINSERT'","{handler:'E186L2',iparms:[{av:'A327BR_SchemeID',fld:'BR_SCHEMEID',pic:'ZZZZZZZZZZZZZZZZZZ',hsh:true},{av:'AV8BR_EncounterID',fld:'vBR_ENCOUNTERID',pic:'ZZZZZZZZZZZZZZZZZZ'}]");
         setEventMetadata("'DOINSERT'",",oparms:[]}");
         setEventMetadata("VMYEDIT.CLICK","{handler:'E226L2',iparms:[{av:'A327BR_SchemeID',fld:'BR_SCHEMEID',pic:'ZZZZZZZZZZZZZZZZZZ',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         AV47Mydel_GXI = "";
         scmdbuf = "";
         H006L2_A19BR_EncounterID = new long[1] ;
         H006L2_A331BR_Scheme_Chem_Detail = new String[] {""} ;
         H006L2_n331BR_Scheme_Chem_Detail = new bool[] {false} ;
         H006L2_A330BR_Scheme_Chem_Cycle = new decimal[1] ;
         H006L2_n330BR_Scheme_Chem_Cycle = new bool[] {false} ;
         H006L2_A329BR_Scheme_Therapy_Line = new String[] {""} ;
         H006L2_n329BR_Scheme_Therapy_Line = new bool[] {false} ;
         H006L2_A328BR_Scheme_Chem_Regimens = new String[] {""} ;
         H006L2_n328BR_Scheme_Chem_Regimens = new bool[] {false} ;
         H006L2_A327BR_SchemeID = new long[1] ;
         ...
         sImgUrl = "";
         ROClassString = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.br_encounterupdatebr_schemewc__default(),
            new Object[][] {
                new Object[] {
               H006L2_A19BR_EncounterID, H006L2_A331BR_Scheme_Chem_Detail, H006L2_n331BR_Scheme_Chem_Detail, H006L2_A330BR_Scheme_Chem_Cycle, H006L2_n330BR_Scheme_Chem_Cycle, H006L2_A329BR_Scheme_Therapy_Line, H006L2_n329BR_Scheme_Therapy_Line, H006L2_A328BR_Scheme_Chem_Regimens, H006L2_n328BR_Scheme_Chem_Regimens, H006L2_A327BR_SchemeID
               }
               , new Object[] {
      ...
      private int edtavBr_schemeid_selected_Visible ;
      ...
      private long AV35BR_SchemeID_Selected ;
      ...
      private String edtavBr_schemeid_selected_Internalname ;
      private String edtavBr_schemeid_selected_Jsonclick ;
      ...
      private bool AV41tCheckFlag ;
      private bool AV37IsAuthorized_myedit ;
      private bool AV38IsAuthorized_mydel ;
      private bool AV34TempBoolean ;
      private bool GXt_boolean2 ;
      private bool AV31Display_IsBlob ;
      private bool AV32myedit_IsBlob ;
      private bool AV33mydel_IsBlob ;
      ...
      private String AV45Display_GXI ;
      private String AV46Myedit_GXI ;
      private String AV47Mydel_GXI ;
      private String AV31Display ;
      private String AV32myedit ;
      private String AV33mydel ;
      ...
      private long[] H006L2_A19BR_EncounterID ;
      private String[] H006L2_A331BR_Scheme_Chem_Detail ;
      private bool[] H006L2_n331BR_Scheme_Chem_Detail ;
      private decimal[] H006L2_A330BR_Scheme_Chem_Cycle ;
      private bool[] H006L2_n330BR_Scheme_Chem_Cycle ;
      private String[] H006L2_A329BR_Scheme_Therapy_Line ;
      private bool[] H006L2_n329BR_Scheme_Therapy_Line ;
      private String[] H006L2_A328BR_Scheme_Chem_Regimens ;
      private bool[] H006L2_n328BR_Scheme_Chem_Regimens ;
      private long[] H006L2_A327BR_SchemeID ;
   ...
   public class br_encounterupdatebr_schemewc__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             long AV8BR_EncounterID )
      {
         ...
         {
            sOrderString = sOrderString + " ORDER BY [BR_EncounterID], [BR_Scheme_Chem_Regimens]";
         }
         else if ( ( AV14OrderedBy == 2 ) && ( AV15OrderedDsc ) )
         {
            sOrderString = sOrderString + " ORDER BY [BR_EncounterID] DESC, [BR_Scheme_Chem_Regimens] DESC";
         }
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H006L2(context, (short)dynConstraints[0] , (bool)dynConstraints[1] , (long)dynConstraints[2] , (long)dynConstraints[3] );
               case 1 :
                     return conditional_H006L3(context, (short)dynConstraints[0] , (bool)dynConstraints[1] , (long)dynConstraints[2] , (long)dynConstraints[3] );
         }
