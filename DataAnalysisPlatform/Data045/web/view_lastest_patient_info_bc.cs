/*
       ...
       Generated on: 2/28/2020 15:9:4.22
...
namespace GeneXus.Programs {
   public class view_lastest_patient_info_bc : GXHttpHandler, IGxSilentTrn
   {
      ...
      protected void CheckExtendedTable1O71( )
      {
         ...
         {
            GX_msglist.addItem("”ÚVIEW_LPI_BR_Encounter_Admit Date≥¨ΩÁ", "OutOfRange", 1, "");
            AnyError = 1;
         }
         ...
         {
            GX_msglist.addItem("”ÚVIEW_LPI_BR_Demographics_Birth Date≥¨ΩÁ", "OutOfRange", 1, "");
            AnyError = 1;
         }
      }
