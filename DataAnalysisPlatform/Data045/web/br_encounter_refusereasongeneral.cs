/*
       ...
       Generated on: 2/28/2020 15:8:43.88
...
namespace GeneXus.Programs {
   public class br_encounter_refusereasongeneral : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20202281584391", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void RenderHtmlCloseForm7F2( )
      {
         ...
         {
            context.AddJavascriptSource("br_encounter_refusereasongeneral.js", "?20202281584393", false);
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?20202281584445", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("br_encounter_refusereasongeneral.js", "?20202281584445", false);
