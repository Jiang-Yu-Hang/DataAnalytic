function InNewWindow()
{
	...
	{	
		...
		specs+=addAttribute("toolbar", this.ToolBar, true);
		specs+=addAttribute("location", this.Location, true);
		specs+=addAttribute("directories", this.directories, true);
		specs+=addAttribute("status", this.status, true);
		specs+=addAttribute("menubar", this.MenuBar, true);
		specs+=addAttribute("scrollbars", this.Scrollbars);
		specs+=addAttribute("resizable", this.Resizable, true);
		specs+=addAttribute("titlebar", this.TitleBar, true);
		specs+=addAttribute("fullscreen", this.Fullscreen, false);
		specs+=addAttribute("copyhistory", this.copyhistory, false);
