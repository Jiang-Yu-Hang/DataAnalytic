/*
       ...
       Generated on: 2/28/2020 15:9:5.99
...
namespace GeneXus.Programs {
   ...
   public class SdtView_New_Encounter : GxSilentTrnSdt, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public override GXProperties GetMetadata( )
      {
         ...
         metadata.Set("BT", "View_New_Encounter1");
      ...
      public override void ToJSON( bool includeState )
      {
         ...
         datetime_STZ = gxTv_SdtView_New_Encounter_View_ne_admitdate;
         sDateCnv = "";
         ...
         if ( includeState )
         {
            ...
            datetime_STZ = gxTv_SdtView_New_Encounter_View_ne_admitdate_Z;
            sDateCnv = "";
            sNumToPad = StringUtil.Trim( StringUtil.Str( (decimal)(DateTimeUtil.Year( datetime_STZ)), 10, 0));
            sDateCnv = sDateCnv + StringUtil.Substring( "0000", 1, 4-StringUtil.Len( sNumToPad)) + sNumToPad;
            sDateCnv = sDateCnv + "-";
      ...
      public string gxTpr_View_ne_admitdate_Nullable
      {
         get {
            if ( gxTv_SdtView_New_Encounter_View_ne_admitdate == DateTime.MinValue)
               return null;
            return new GxDatetimeString(gxTv_SdtView_New_Encounter_View_ne_admitdate).value ;
         }
      ...
      public short gxTpr_View_ne_israndrecheck
      {
         get {
      ...
      public void gxTv_SdtView_New_Encounter_View_ne_israndrecheck_SetNull( )
      {
         ...
         gxTv_SdtView_New_Encounter_View_ne_israndrecheck = 0;
         return  ;
      }
      ...
      public short gxTpr_View_ne_israndapprove
      {
         get {
      ...
      public void gxTv_SdtView_New_Encounter_View_ne_israndapprove_SetNull( )
      {
         ...
         gxTv_SdtView_New_Encounter_View_ne_israndapprove = 0;
         return  ;
      }
      ...
      public short gxTpr_View_ne_isupdate
      {
         get {
      ...
      public void gxTv_SdtView_New_Encounter_View_ne_isupdate_SetNull( )
      {
         ...
         gxTv_SdtView_New_Encounter_View_ne_isupdate = 0;
         return  ;
      }
      ...
      public string gxTpr_View_ne_admitdate_Z_Nullable
      {
         get {
            if ( gxTv_SdtView_New_Encounter_View_ne_admitdate_Z == DateTime.MinValue)
               return null;
            return new GxDatetimeString(gxTv_SdtView_New_Encounter_View_ne_admitdate_Z).value ;
         }
      ...
      public short gxTpr_View_ne_israndrecheck_Z
      {
         get {
      ...
      {
         gxTv_SdtView_New_Encounter_View_ne_israndrecheck_Z = 0;
         return  ;
      }
      ...
      public short gxTpr_View_ne_israndapprove_Z
      {
         get {
      ...
      {
         gxTv_SdtView_New_Encounter_View_ne_israndapprove_Z = 0;
         return  ;
      }
      ...
      public short gxTpr_View_ne_isupdate_Z
      {
         get {
      ...
      {
         gxTv_SdtView_New_Encounter_View_ne_isupdate_Z = 0;
         return  ;
      }
      ...
      private short gxTv_SdtView_New_Encounter_View_ne_israndrecheck ;
      private short gxTv_SdtView_New_Encounter_View_ne_israndapprove ;
      private short gxTv_SdtView_New_Encounter_View_ne_isupdate ;
      private short gxTv_SdtView_New_Encounter_Initialized ;
      private short gxTv_SdtView_New_Encounter_View_ne_status_Z ;
      private short gxTv_SdtView_New_Encounter_View_ne_israndrecheck_Z ;
      private short gxTv_SdtView_New_Encounter_View_ne_israndapprove_Z ;
      private short gxTv_SdtView_New_Encounter_View_ne_isupdate_Z ;
   ...
   public class SdtView_New_Encounter_RESTInterface : GxGenericCollectionItem<SdtView_New_Encounter>, System.Web.SessionState.IRequiresSessionState
   {
      ...
      {
         get {
            return DateTimeUtil.TToC2( sdt.gxTpr_View_ne_admitdate) ;
         }

         set {
            sdt.gxTpr_View_ne_admitdate = DateTimeUtil.CToT2( value);
         }
      ...
      [GxSeudo()]
      public Nullable<short> gxTpr_View_ne_israndrecheck
      {
         get {
         ...
         set {
            sdt.gxTpr_View_ne_israndrecheck = (short)(value.HasValue ? value.Value : 0);
         }
      ...
      [GxSeudo()]
      public Nullable<short> gxTpr_View_ne_israndapprove
      {
         get {
         ...
         set {
            sdt.gxTpr_View_ne_israndapprove = (short)(value.HasValue ? value.Value : 0);
         }
      ...
      [GxSeudo()]
      public Nullable<short> gxTpr_View_ne_isupdate
      {
         get {
         ...
         set {
            sdt.gxTpr_View_ne_isupdate = (short)(value.HasValue ? value.Value : 0);
         }
