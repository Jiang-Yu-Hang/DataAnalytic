/*
       ...
       Generated on: 2/28/2020 15:7:12.29
   ...
   public class br_encounterupdatebr_medicationwc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV80Pgmname = "BR_EncounterUpdateBR_MedicationWC";
               context.Gx_err = 0;
               WS272( ) ;
               if ( ! isAjaxCallMode( ) )
               {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20202281571257", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void RenderHtmlCloseForm272( )
      {
         ...
         {
            context.AddJavascriptSource("br_encounterupdatebr_medicationwc.js", "?20202281571615", false);
         }
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 13), "VUPDATE.CLICK") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 13), "VUPDATE.CLICK") == 0 ) )
                           {
                              ...
                              context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtavDisplay_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV67Display)) ? AV77Display_GXI : context.convertURL( context.PathToRelativeUrl( AV67Display))), !bGXsfl_28_Refreshing);
                              ...
                              context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtavUpdate_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV63Update)) ? AV78Update_GXI : context.convertURL( context.PathToRelativeUrl( AV63Update))), !bGXsfl_28_Refreshing);
                              ...
                              context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtavGotodelete_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV70gotodelete)) ? AV79Gotodelete_GXI : context.convertURL( context.PathToRelativeUrl( AV70gotodelete))), !bGXsfl_28_Refreshing);
      ...
      private void E23272( )
      {
         ...
         AV77Display_GXI = GXDbFile.PathToUrl( context.GetImagePath( "f11923b6-6acd-4a79-bfc0-0cfc6f3bced5", "", context.GetTheme( )));
         ...
         AV78Update_GXI = GXDbFile.PathToUrl( context.GetImagePath( "7c63c2b9-483e-4035-b512-febf9186a274", "", context.GetTheme( )));
         ...
         AV79Gotodelete_GXI = GXDbFile.PathToUrl( context.GetImagePath( "7695fe89-52c9-4b7e-871e-0e11548f823e", "", context.GetTheme( )));
      ...
      protected void S122( )
      {
         ...
         {
            AV12GridState.FromXml(new GeneXus.Programs.wwpbaseobjects.loadgridstate(context).executeUdp(  AV80Pgmname+"GridState"), null, "WWPGridState", "DataAnalysisPlatform");
         }
         else
         {
            AV12GridState.FromXml(AV16Session.Get(AV80Pgmname+"GridState"), null, "WWPGridState", "DataAnalysisPlatform");
         }
      ...
      protected void S142( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.savegridstate(context ).execute(  AV80Pgmname+"GridState",  AV12GridState.ToXml(false, true, "WWPGridState", "DataAnalysisPlatform")) ;
      }
      ...
      protected void S112( )
      {
         ...
         AV10TrnContext.gxTpr_Callerobject = AV80Pgmname;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?2020228157329", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("br_encounterupdatebr_medicationwc.js", "?2020228157329", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
      ...
      protected void sendrow_282( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_28_idx <= subGrid_Recordsperpage( ) * 1 ) )
         {
            ...
            StyleString = "";
            AV67Display_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV67Display))&&String.IsNullOrEmpty(StringUtil.RTrim( AV77Display_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV67Display)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV67Display)) ? AV77Display_GXI : context.PathToRelativeUrl( AV67Display));
            ...
            ClassString = "ActionBaseColorAttribute";
            StyleString = "";
            AV63Update_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV63Update))&&String.IsNullOrEmpty(StringUtil.RTrim( AV78Update_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV63Update)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV63Update)) ? AV78Update_GXI : context.PathToRelativeUrl( AV63Update));
            ...
            ClassString = "ActionBaseColorAttribute";
            StyleString = "";
            AV70gotodelete_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV70gotodelete))&&String.IsNullOrEmpty(StringUtil.RTrim( AV79Gotodelete_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV70gotodelete)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV70gotodelete)) ? AV79Gotodelete_GXI : context.PathToRelativeUrl( AV70gotodelete));
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("DDO_BR_MEDICATION_RXNAME.ONOPTIONCLICKED","{handler:'E14272',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV8BR_EncounterID',fld:'vBR_ENCOUNTERID',pic:'ZZZZZZZZZZZZZZZZZZ'},{av:'AV18ddo_BR_MedicationIDTitleControlIdToReplace',fld:'vDDO_BR_MEDICATIONIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV22ddo_BR_Medication_RXNameTitleControlIdToReplace',fld:'vDDO_BR_MEDICATION_RXNAMETITLECONTROLIDTOREPLACE',pic:''},{av:'AV44ddo_BR_Medication_AdmitStartDateTitleControlIdToReplace',fld:'vDDO_BR_MEDICATION_ADMITSTARTDATETITLECONTROLIDTOREPLACE',pic:''},{av:'AV46ddo_BR_Medication_AdmitEndDateTitleControlIdToReplace',fld:'vDDO_BR_MEDICATION_ADMITENDDATETITLECONTROLIDTOREPLACE',pic:''},{av:'AV28ddo_BR_Medication_RXDoseTitleControlIdToReplace',fld:'vDDO_BR_MEDICATION_RXDOSETITLECONTROLIDTOREPLACE',pic:''},{av:'AV24ddo_BR_Medication_RXCodeTitleControlIdToReplace',fld:'vDDO_BR_MEDICATION_RXCODETITLECONTROLIDTOREPLACE',pic:''},{av:'AV80Pgmname',fld:'vPGMNAME',pic:''},{av:'AV68IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:''},{av:'sPrefix'},{av:'Ddo_br_medication_rxname_Activeeventkey',ctrl:'DDO_BR_MEDICATION_RXNAME',prop:'ActiveEventKey'}]");
         ...
         setEventMetadata("DDO_BR_MEDICATION_ADMITENDDATE.ONOPTIONCLICKED","{handler:'E16272',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV8BR_EncounterID',fld:'vBR_ENCOUNTERID',pic:'ZZZZZZZZZZZZZZZZZZ'},{av:'AV18ddo_BR_MedicationIDTitleControlIdToReplace',fld:'vDDO_BR_MEDICATIONIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV22ddo_BR_Medication_RXNameTitleControlIdToReplace',fld:'vDDO_BR_MEDICATION_RXNAMETITLECONTROLIDTOREPLACE',pic:''},{av:'AV44ddo_BR_Medication_AdmitStartDateTitleControlIdToReplace',fld:'vDDO_BR_MEDICATION_ADMITSTARTDATETITLECONTROLIDTOREPLACE',pic:''},{av:'AV46ddo_BR_Medication_AdmitEndDateTitleControlIdToReplace',fld:'vDDO_BR_MEDICATION_ADMITENDDATETITLECONTROLIDTOREPLACE',pic:''},{av:'AV28ddo_BR_Medication_RXDoseTitleControlIdToReplace',fld:'vDDO_BR_MEDICATION_RXDOSETITLECONTROLIDTOREPLACE',pic:''},{av:'AV24ddo_BR_Medication_RXCodeTitleControlIdToReplace',fld:'vDDO_BR_MEDICATION_RXCODETITLECONTROLIDTOREPLACE',pic:''},{av:'AV80Pgmname',fld:'vPGMNAME',pic:''},{av:'AV68IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:''},{av:'sPrefix'},{av:'Ddo_br_medication_admitenddate_Activeeventkey',ctrl:'DDO_BR_MEDICATION_ADMITENDDATE',prop:'ActiveEventKey'}]");
         ...
         setEventMetadata("DDO_BR_MEDICATION_RXCODE.ONOPTIONCLICKED","{handler:'E18272',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV8BR_EncounterID',fld:'vBR_ENCOUNTERID',pic:'ZZZZZZZZZZZZZZZZZZ'},{av:'AV18ddo_BR_MedicationIDTitleControlIdToReplace',fld:'vDDO_BR_MEDICATIONIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV22ddo_BR_Medication_RXNameTitleControlIdToReplace',fld:'vDDO_BR_MEDICATION_RXNAMETITLECONTROLIDTOREPLACE',pic:''},{av:'AV44ddo_BR_Medication_AdmitStartDateTitleControlIdToReplace',fld:'vDDO_BR_MEDICATION_ADMITSTARTDATETITLECONTROLIDTOREPLACE',pic:''},{av:'AV46ddo_BR_Medication_AdmitEndDateTitleControlIdToReplace',fld:'vDDO_BR_MEDICATION_ADMITENDDATETITLECONTROLIDTOREPLACE',pic:''},{av:'AV28ddo_BR_Medication_RXDoseTitleControlIdToReplace',fld:'vDDO_BR_MEDICATION_RXDOSETITLECONTROLIDTOREPLACE',pic:''},{av:'AV24ddo_BR_Medication_RXCodeTitleControlIdToReplace',fld:'vDDO_BR_MEDICATION_RXCODETITLECONTROLIDTOREPLACE',pic:''},{av:'AV80Pgmname',fld:'vPGMNAME',pic:''},{av:'AV68IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:''},{av:'sPrefix'},{av:'Ddo_br_medication_rxcode_Activeeventkey',ctrl:'DDO_BR_MEDICATION_RXCODE',prop:'ActiveEventKey'}]");
      ...
      private String AV77Display_GXI ;
      private String AV78Update_GXI ;
      private String AV79Gotodelete_GXI ;
