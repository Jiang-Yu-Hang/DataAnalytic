/*
       ...
       Generated on: 2/28/2020 15:8:2.98
...
namespace GeneXus.Programs {
   public class br_medicalimaging_bc : GXHttpHandler, IGxSilentTrn
   {
      ...
      protected void CheckExtendedTable0T30( )
      {
         ...
         {
            GX_msglist.addItem("域检查日期超界", "OutOfRange", 1, "");
            AnyError = 1;
         }
