/*
       ...
       Generated on: 2/28/2020 15:7:23.61
...
namespace GeneXus.Programs {
   public class br_encounter_bc : GXHttpHandler, IGxSilentTrn
   {
      ...
      protected void E120E2( )
      {
         ...
         if ( ! AV16IsAuthorized )
         {
            CallWebObject(formatLink("wwpbaseobjects.notauthorized.aspx") + "?" + UrlEncode(StringUtil.RTrim(AV34Pgmname)));
         ...
         if ( ( StringUtil.StrCmp(AV11TrnContext.gxTpr_Transactionname, AV34Pgmname) == 0 ) && ( StringUtil.StrCmp(Gx_mode, "INS") == 0 ) )
         {
            ...
            {
               AV12TrnContextAtt = ((GeneXus.Programs.wwpbaseobjects.SdtWWPTransactionContext_Attribute)AV11TrnContext.gxTpr_Attributes.Item(AV35GXV1));
      ...
      protected void CheckExtendedTable0E15( )
      {
         ...
         {
            GX_msglist.addItem("域审批状态超界", "OutOfRange", 1, "");
            AnyError = 1;
         }
         ...
         {
            GX_msglist.addItem("域复审通过时间超界", "OutOfRange", 1, "");
            AnyError = 1;
         }
         ...
         {
            GX_msglist.addItem("域初审通过操作/提交复审时间超界", "OutOfRange", 1, "");
            AnyError = 1;
         }
         ...
         {
            GX_msglist.addItem("域初审抽查通过时间超界", "OutOfRange", 1, "");
            AnyError = 1;
         }
         ...
         {
            GX_msglist.addItem("域初审抽查不通过时间超界", "OutOfRange", 1, "");
            AnyError = 1;
         }
         ...
         {
            GX_msglist.addItem("域复审抽查通过时间超界", "OutOfRange", 1, "");
            AnyError = 1;
         }
         ...
         {
            GX_msglist.addItem("域复审抽查不通过时间超界", "OutOfRange", 1, "");
            AnyError = 1;
         }
         if ( ! ( ( A537BR_Encounter_Datasource == 1 ) || (0==A537BR_Encounter_Datasource) ) )
         {
            GX_msglist.addItem("域数据类型超界", "OutOfRange", 1, "");
            AnyError = 1;
         }
      }
      ...
      public void ScanKeyStart0E15( )
      {
         ...
         {
            RcdFound15 = 1;
            A19BR_EncounterID = BC000E28_A19BR_EncounterID[0];
            n19BR_EncounterID = BC000E28_n19BR_EncounterID[0];
            A35BR_Encounter_EncID = BC000E28_A35BR_Encounter_EncID[0];
            n35BR_Encounter_EncID = BC000E28_n35BR_Encounter_EncID[0];
            A172BR_Encounter_Status = BC000E28_A172BR_Encounter_Status[0];
            n172BR_Encounter_Status = BC000E28_n172BR_Encounter_Status[0];
            A183BR_Encounter_CrtUser = BC000E28_A183BR_Encounter_CrtUser[0];
            n183BR_Encounter_CrtUser = BC000E28_n183BR_Encounter_CrtUser[0];
            A512BR_Encounter_CrtDisplayName = BC000E28_A512BR_Encounter_CrtDisplayName[0];
            n512BR_Encounter_CrtDisplayName = BC000E28_n512BR_Encounter_CrtDisplayName[0];
            A182BR_Encounter_CrtDate = BC000E28_A182BR_Encounter_CrtDate[0];
            n182BR_Encounter_CrtDate = BC000E28_n182BR_Encounter_CrtDate[0];
            A470BR_Encounter_Department_Code = BC000E28_A470BR_Encounter_Department_Code[0];
            n470BR_Encounter_Department_Code = BC000E28_n470BR_Encounter_Department_Code[0];
            A471BR_Encounter_ENCType_Code = BC000E28_A471BR_Encounter_ENCType_Code[0];
            n471BR_Encounter_ENCType_Code = BC000E28_n471BR_Encounter_ENCType_Code[0];
            A472BR_Encounter_AdmitSource_Code = BC000E28_A472BR_Encounter_AdmitSource_Code[0];
            n472BR_Encounter_AdmitSource_Code = BC000E28_n472BR_Encounter_AdmitSource_Code[0];
            A473BR_Encounter_DischargeStatus_Code = BC000E28_A473BR_Encounter_DischargeStatus_Code[0];
            n473BR_Encounter_DischargeStatus_Code = BC000E28_n473BR_Encounter_DischargeStatus_Code[0];
            A84BR_Encounter_Department = BC000E28_A84BR_Encounter_Department[0];
            n84BR_Encounter_Department = BC000E28_n84BR_Encounter_Department[0];
            A570BR_Encounter_Departmentadm = BC000E28_A570BR_Encounter_Departmentadm[0];
            n570BR_Encounter_Departmentadm = BC000E28_n570BR_Encounter_Departmentadm[0];
            A571BR_Encounter_Departmentadm_Code = BC000E28_A571BR_Encounter_Departmentadm_Code[0];
            n571BR_Encounter_Departmentadm_Code = BC000E28_n571BR_Encounter_Departmentadm_Code[0];
            A572BR_Encounter_Departmentdisch = BC000E28_A572BR_Encounter_Departmentdisch[0];
            n572BR_Encounter_Departmentdisch = BC000E28_n572BR_Encounter_Departmentdisch[0];
            A573BR_Encounter_Departmentdisch_Code = BC000E28_A573BR_Encounter_Departmentdisch_Code[0];
            n573BR_Encounter_Departmentdisch_Code = BC000E28_n573BR_Encounter_Departmentdisch_Code[0];
            A90BR_Encounter_ENCType = BC000E28_A90BR_Encounter_ENCType[0];
            n90BR_Encounter_ENCType = BC000E28_n90BR_Encounter_ENCType[0];
            A91BR_Encounter_AdmitDate = BC000E28_A91BR_Encounter_AdmitDate[0];
            n91BR_Encounter_AdmitDate = BC000E28_n91BR_Encounter_AdmitDate[0];
            A92BR_Encounter_AdmitSource = BC000E28_A92BR_Encounter_AdmitSource[0];
            n92BR_Encounter_AdmitSource = BC000E28_n92BR_Encounter_AdmitSource[0];
            A93BR_Encounter_DischargeDate = BC000E28_A93BR_Encounter_DischargeDate[0];
            n93BR_Encounter_DischargeDate = BC000E28_n93BR_Encounter_DischargeDate[0];
            A94BR_Encounter_DischargeStatus = BC000E28_A94BR_Encounter_DischargeStatus[0];
            n94BR_Encounter_DischargeStatus = BC000E28_n94BR_Encounter_DischargeStatus[0];
            A574BR_Encounter_Insurance = BC000E28_A574BR_Encounter_Insurance[0];
            n574BR_Encounter_Insurance = BC000E28_n574BR_Encounter_Insurance[0];
            A575BR_Encounter_Insurance_Code = BC000E28_A575BR_Encounter_Insurance_Code[0];
            n575BR_Encounter_Insurance_Code = BC000E28_n575BR_Encounter_Insurance_Code[0];
            A36BR_Information_PatientNo = BC000E28_A36BR_Information_PatientNo[0];
            n36BR_Information_PatientNo = BC000E28_n36BR_Information_PatientNo[0];
            A187BR_Encounter_UpdDate = BC000E28_A187BR_Encounter_UpdDate[0];
            n187BR_Encounter_UpdDate = BC000E28_n187BR_Encounter_UpdDate[0];
            A186BR_Encounter_UpdUser = BC000E28_A186BR_Encounter_UpdUser[0];
            n186BR_Encounter_UpdUser = BC000E28_n186BR_Encounter_UpdUser[0];
            A333BR_Encounter_IsDLT = BC000E28_A333BR_Encounter_IsDLT[0];
            n333BR_Encounter_IsDLT = BC000E28_n333BR_Encounter_IsDLT[0];
            A184BR_Encounter_SubmitUser = BC000E28_A184BR_Encounter_SubmitUser[0];
            n184BR_Encounter_SubmitUser = BC000E28_n184BR_Encounter_SubmitUser[0];
            A335BR_Encounter_Reason = BC000E28_A335BR_Encounter_Reason[0];
            n335BR_Encounter_Reason = BC000E28_n335BR_Encounter_Reason[0];
            A185BR_Encounter_SubmitDate = BC000E28_A185BR_Encounter_SubmitDate[0];
            n185BR_Encounter_SubmitDate = BC000E28_n185BR_Encounter_SubmitDate[0];
            A188BR_Encounter_RecheckUser = BC000E28_A188BR_Encounter_RecheckUser[0];
            n188BR_Encounter_RecheckUser = BC000E28_n188BR_Encounter_RecheckUser[0];
            A336BR_Encounter_FReason = BC000E28_A336BR_Encounter_FReason[0];
            n336BR_Encounter_FReason = BC000E28_n336BR_Encounter_FReason[0];
            A189BR_Encounter_RecheckDate = BC000E28_A189BR_Encounter_RecheckDate[0];
            n189BR_Encounter_RecheckDate = BC000E28_n189BR_Encounter_RecheckDate[0];
            A190BR_Encounter_Approver = BC000E28_A190BR_Encounter_Approver[0];
            n190BR_Encounter_Approver = BC000E28_n190BR_Encounter_Approver[0];
            A191BR_Encounter_ApproveDate = BC000E28_A191BR_Encounter_ApproveDate[0];
            n191BR_Encounter_ApproveDate = BC000E28_n191BR_Encounter_ApproveDate[0];
            A192BR_Encounter_IsRandApprove = BC000E28_A192BR_Encounter_IsRandApprove[0];
            n192BR_Encounter_IsRandApprove = BC000E28_n192BR_Encounter_IsRandApprove[0];
            A203BR_Encounter_IsRandApprover = BC000E28_A203BR_Encounter_IsRandApprover[0];
            n203BR_Encounter_IsRandApprover = BC000E28_n203BR_Encounter_IsRandApprover[0];
            A204BR_Encounter_IsRandNoApprover = BC000E28_A204BR_Encounter_IsRandNoApprover[0];
            n204BR_Encounter_IsRandNoApprover = BC000E28_n204BR_Encounter_IsRandNoApprover[0];
            A205BR_Encounter_IsRandApproveDate = BC000E28_A205BR_Encounter_IsRandApproveDate[0];
            n205BR_Encounter_IsRandApproveDate = BC000E28_n205BR_Encounter_IsRandApproveDate[0];
            A206BR_Encounter_IsRandNoApproveDate = BC000E28_A206BR_Encounter_IsRandNoApproveDate[0];
            n206BR_Encounter_IsRandNoApproveDate = BC000E28_n206BR_Encounter_IsRandNoApproveDate[0];
            A193BR_Encounter_IsRandRecheck = BC000E28_A193BR_Encounter_IsRandRecheck[0];
            n193BR_Encounter_IsRandRecheck = BC000E28_n193BR_Encounter_IsRandRecheck[0];
            A207BR_Encounter_IsRandRecheckr = BC000E28_A207BR_Encounter_IsRandRecheckr[0];
            n207BR_Encounter_IsRandRecheckr = BC000E28_n207BR_Encounter_IsRandRecheckr[0];
            A208BR_Encounter_IsRandNoRecheckr = BC000E28_A208BR_Encounter_IsRandNoRecheckr[0];
            n208BR_Encounter_IsRandNoRecheckr = BC000E28_n208BR_Encounter_IsRandNoRecheckr[0];
            A209BR_Encounter_IsRandRecheckDate = BC000E28_A209BR_Encounter_IsRandRecheckDate[0];
            n209BR_Encounter_IsRandRecheckDate = BC000E28_n209BR_Encounter_IsRandRecheckDate[0];
            A210BR_Encounter_IsRandNoRecheckDate = BC000E28_A210BR_Encounter_IsRandNoRecheckDate[0];
            n210BR_Encounter_IsRandNoRecheckDate = BC000E28_n210BR_Encounter_IsRandNoRecheckDate[0];
            A202BR_Encounter_IsUpdate = BC000E28_A202BR_Encounter_IsUpdate[0];
            n202BR_Encounter_IsUpdate = BC000E28_n202BR_Encounter_IsUpdate[0];
            A537BR_Encounter_Datasource = BC000E28_A537BR_Encounter_Datasource[0];
            n537BR_Encounter_Datasource = BC000E28_n537BR_Encounter_Datasource[0];
            A560EncounterIDEncrypt = BC000E28_A560EncounterIDEncrypt[0];
            n560EncounterIDEncrypt = BC000E28_n560EncounterIDEncrypt[0];
            A85BR_Information_ID = BC000E28_A85BR_Information_ID[0];
            n85BR_Information_ID = BC000E28_n85BR_Information_ID[0];
            A360BAS_TenantTenantCode = BC000E28_A360BAS_TenantTenantCode[0];
            n360BAS_TenantTenantCode = BC000E28_n360BAS_TenantTenantCode[0];
         }
      ...
      public override void initialize( )
      {
         ...
         BC000E13_A576BR_FamilyhistoryID = new long[1] ;
         BC000E14_A348BR_Encounter_RefuseReasonID = new long[1] ;
         BC000E15_A347BR_Encounter_ID = new long[1] ;
         BC000E16_A327BR_SchemeID = new long[1] ;
         BC000E17_A226BR_PathologyID = new long[1] ;
         BC000E18_A225BR_MedicalImagingID = new long[1] ;
         BC000E19_A150BR_VitalID = new long[1] ;
         BC000E20_A139BR_ProcedureID = new long[1] ;
         BC000E21_A119BR_MedicationID = new long[1] ;
         BC000E22_A101BR_LabID = new long[1] ;
         BC000E23_A64BR_DiagnosisID = new long[1] ;
         BC000E24_A61BR_Demographics_ID = new long[1] ;
         BC000E25_A48BR_DeathID = new long[1] ;
         BC000E26_A37BR_ComorbidityID = new long[1] ;
         BC000E27_A20BR_BehaviorID = new long[1] ;
         BC000E28_A19BR_EncounterID = new long[1] ;
         BC000E28_n19BR_EncounterID = new bool[] {false} ;
         BC000E28_A35BR_Encounter_EncID = new long[1] ;
         BC000E28_n35BR_Encounter_EncID = new bool[] {false} ;
         BC000E28_A172BR_Encounter_Status = new short[1] ;
         BC000E28_n172BR_Encounter_Status = new bool[] {false} ;
         BC000E28_A183BR_Encounter_CrtUser = new String[] {""} ;
         BC000E28_n183BR_Encounter_CrtUser = new bool[] {false} ;
         BC000E28_A512BR_Encounter_CrtDisplayName = new String[] {""} ;
         BC000E28_n512BR_Encounter_CrtDisplayName = new bool[] {false} ;
         BC000E28_A182BR_Encounter_CrtDate = new DateTime[] {DateTime.MinValue} ;
         BC000E28_n182BR_Encounter_CrtDate = new bool[] {false} ;
         BC000E28_A470BR_Encounter_Department_Code = new String[] {""} ;
         BC000E28_n470BR_Encounter_Department_Code = new bool[] {false} ;
         BC000E28_A471BR_Encounter_ENCType_Code = new String[] {""} ;
         BC000E28_n471BR_Encounter_ENCType_Code = new bool[] {false} ;
         BC000E28_A472BR_Encounter_AdmitSource_Code = new String[] {""} ;
         BC000E28_n472BR_Encounter_AdmitSource_Code = new bool[] {false} ;
         BC000E28_A473BR_Encounter_DischargeStatus_Code = new String[] {""} ;
         BC000E28_n473BR_Encounter_DischargeStatus_Code = new bool[] {false} ;
         BC000E28_A84BR_Encounter_Department = new String[] {""} ;
         BC000E28_n84BR_Encounter_Department = new bool[] {false} ;
         BC000E28_A570BR_Encounter_Departmentadm = new String[] {""} ;
         BC000E28_n570BR_Encounter_Departmentadm = new bool[] {false} ;
         BC000E28_A571BR_Encounter_Departmentadm_Code = new String[] {""} ;
         BC000E28_n571BR_Encounter_Departmentadm_Code = new bool[] {false} ;
         BC000E28_A572BR_Encounter_Departmentdisch = new String[] {""} ;
         BC000E28_n572BR_Encounter_Departmentdisch = new bool[] {false} ;
         BC000E28_A573BR_Encounter_Departmentdisch_Code = new String[] {""} ;
         BC000E28_n573BR_Encounter_Departmentdisch_Code = new bool[] {false} ;
         BC000E28_A90BR_Encounter_ENCType = new String[] {""} ;
         BC000E28_n90BR_Encounter_ENCType = new bool[] {false} ;
         BC000E28_A91BR_Encounter_AdmitDate = new DateTime[] {DateTime.MinValue} ;
         BC000E28_n91BR_Encounter_AdmitDate = new bool[] {false} ;
         BC000E28_A92BR_Encounter_AdmitSource = new String[] {""} ;
         BC000E28_n92BR_Encounter_AdmitSource = new bool[] {false} ;
         BC000E28_A93BR_Encounter_DischargeDate = new DateTime[] {DateTime.MinValue} ;
         BC000E28_n93BR_Encounter_DischargeDate = new bool[] {false} ;
         BC000E28_A94BR_Encounter_DischargeStatus = new String[] {""} ;
         BC000E28_n94BR_Encounter_DischargeStatus = new bool[] {false} ;
         BC000E28_A574BR_Encounter_Insurance = new String[] {""} ;
         BC000E28_n574BR_Encounter_Insurance = new bool[] {false} ;
         BC000E28_A575BR_Encounter_Insurance_Code = new String[] {""} ;
         BC000E28_n575BR_Encounter_Insurance_Code = new bool[] {false} ;
         BC000E28_A36BR_Information_PatientNo = new String[] {""} ;
         BC000E28_n36BR_Information_PatientNo = new bool[] {false} ;
         BC000E28_A187BR_Encounter_UpdDate = new DateTime[] {DateTime.MinValue} ;
         BC000E28_n187BR_Encounter_UpdDate = new bool[] {false} ;
         BC000E28_A186BR_Encounter_UpdUser = new String[] {""} ;
         BC000E28_n186BR_Encounter_UpdUser = new bool[] {false} ;
         BC000E28_A333BR_Encounter_IsDLT = new bool[] {false} ;
         BC000E28_n333BR_Encounter_IsDLT = new bool[] {false} ;
         BC000E28_A184BR_Encounter_SubmitUser = new String[] {""} ;
         BC000E28_n184BR_Encounter_SubmitUser = new bool[] {false} ;
         BC000E28_A335BR_Encounter_Reason = new String[] {""} ;
         BC000E28_n335BR_Encounter_Reason = new bool[] {false} ;
         BC000E28_A185BR_Encounter_SubmitDate = new DateTime[] {DateTime.MinValue} ;
         BC000E28_n185BR_Encounter_SubmitDate = new bool[] {false} ;
         BC000E28_A188BR_Encounter_RecheckUser = new String[] {""} ;
         BC000E28_n188BR_Encounter_RecheckUser = new bool[] {false} ;
         BC000E28_A336BR_Encounter_FReason = new String[] {""} ;
         BC000E28_n336BR_Encounter_FReason = new bool[] {false} ;
         BC000E28_A189BR_Encounter_RecheckDate = new DateTime[] {DateTime.MinValue} ;
         BC000E28_n189BR_Encounter_RecheckDate = new bool[] {false} ;
         BC000E28_A190BR_Encounter_Approver = new String[] {""} ;
         BC000E28_n190BR_Encounter_Approver = new bool[] {false} ;
         BC000E28_A191BR_Encounter_ApproveDate = new DateTime[] {DateTime.MinValue} ;
         BC000E28_n191BR_Encounter_ApproveDate = new bool[] {false} ;
         BC000E28_A192BR_Encounter_IsRandApprove = new bool[] {false} ;
         BC000E28_n192BR_Encounter_IsRandApprove = new bool[] {false} ;
         BC000E28_A203BR_Encounter_IsRandApprover = new String[] {""} ;
         BC000E28_n203BR_Encounter_IsRandApprover = new bool[] {false} ;
         BC000E28_A204BR_Encounter_IsRandNoApprover = new String[] {""} ;
         BC000E28_n204BR_Encounter_IsRandNoApprover = new bool[] {false} ;
         BC000E28_A205BR_Encounter_IsRandApproveDate = new DateTime[] {DateTime.MinValue} ;
         BC000E28_n205BR_Encounter_IsRandApproveDate = new bool[] {false} ;
         BC000E28_A206BR_Encounter_IsRandNoApproveDate = new DateTime[] {DateTime.MinValue} ;
         BC000E28_n206BR_Encounter_IsRandNoApproveDate = new bool[] {false} ;
         BC000E28_A193BR_Encounter_IsRandRecheck = new bool[] {false} ;
         BC000E28_n193BR_Encounter_IsRandRecheck = new bool[] {false} ;
         BC000E28_A207BR_Encounter_IsRandRecheckr = new String[] {""} ;
         BC000E28_n207BR_Encounter_IsRandRecheckr = new bool[] {false} ;
         BC000E28_A208BR_Encounter_IsRandNoRecheckr = new String[] {""} ;
         BC000E28_n208BR_Encounter_IsRandNoRecheckr = new bool[] {false} ;
         BC000E28_A209BR_Encounter_IsRandRecheckDate = new DateTime[] {DateTime.MinValue} ;
         BC000E28_n209BR_Encounter_IsRandRecheckDate = new bool[] {false} ;
         BC000E28_A210BR_Encounter_IsRandNoRecheckDate = new DateTime[] {DateTime.MinValue} ;
         BC000E28_n210BR_Encounter_IsRandNoRecheckDate = new bool[] {false} ;
         BC000E28_A202BR_Encounter_IsUpdate = new bool[] {false} ;
         BC000E28_n202BR_Encounter_IsUpdate = new bool[] {false} ;
         BC000E28_A537BR_Encounter_Datasource = new short[1] ;
         BC000E28_n537BR_Encounter_Datasource = new bool[] {false} ;
         BC000E28_A560EncounterIDEncrypt = new String[] {""} ;
         BC000E28_n560EncounterIDEncrypt = new bool[] {false} ;
         BC000E28_A85BR_Information_ID = new long[1] ;
         BC000E28_n85BR_Information_ID = new bool[] {false} ;
         BC000E28_A360BAS_TenantTenantCode = new String[] {""} ;
         BC000E28_n360BAS_TenantTenantCode = new bool[] {false} ;
         GXt_char2 = "";
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.br_encounter_bc__default(),
            new Object[][] {
               ...
               , new Object[] {
               BC000E13_A576BR_FamilyhistoryID
               }
               , new Object[] {
               BC000E14_A348BR_Encounter_RefuseReasonID
               }
               , new Object[] {
               BC000E15_A347BR_Encounter_ID
               }
               , new Object[] {
               BC000E16_A327BR_SchemeID
               }
               , new Object[] {
               BC000E17_A226BR_PathologyID
               }
               , new Object[] {
               BC000E18_A225BR_MedicalImagingID
               }
               , new Object[] {
               BC000E19_A150BR_VitalID
               }
               , new Object[] {
               BC000E20_A139BR_ProcedureID
               }
               , new Object[] {
               BC000E21_A119BR_MedicationID
               }
               , new Object[] {
               BC000E22_A101BR_LabID
               }
               , new Object[] {
               BC000E23_A64BR_DiagnosisID
               }
               , new Object[] {
               BC000E24_A61BR_Demographics_ID
               }
               , new Object[] {
               BC000E25_A48BR_DeathID
               }
               , new Object[] {
               BC000E26_A37BR_ComorbidityID
               }
               , new Object[] {
               BC000E27_A20BR_BehaviorID
               }
               , new Object[] {
               BC000E28_A19BR_EncounterID, BC000E28_A35BR_Encounter_EncID, BC000E28_n35BR_Encounter_EncID, BC000E28_A172BR_Encounter_Status, BC000E28_n172BR_Encounter_Status, BC000E28_A183BR_Encounter_CrtUser, BC000E28_n183BR_Encounter_CrtUser, BC000E28_A512BR_Encounter_CrtDisplayName, BC000E28_n512BR_Encounter_CrtDisplayName, BC000E28_A182BR_Encounter_CrtDate,
               BC000E28_n182BR_Encounter_CrtDate, BC000E28_A470BR_Encounter_Department_Code, BC000E28_n470BR_Encounter_Department_Code, BC000E28_A471BR_Encounter_ENCType_Code, BC000E28_n471BR_Encounter_ENCType_Code, BC000E28_A472BR_Encounter_AdmitSource_Code, BC000E28_n472BR_Encounter_AdmitSource_Code, BC000E28_A473BR_Encounter_DischargeStatus_Code, BC000E28_n473BR_Encounter_DischargeStatus_Code, BC000E28_A84BR_Encounter_Department,
               BC000E28_n84BR_Encounter_Department, BC000E28_A570BR_Encounter_Departmentadm, BC000E28_n570BR_Encounter_Departmentadm, BC000E28_A571BR_Encounter_Departmentadm_Code, BC000E28_n571BR_Encounter_Departmentadm_Code, BC000E28_A572BR_Encounter_Departmentdisch, BC000E28_n572BR_Encounter_Departmentdisch, BC000E28_A573BR_Encounter_Departmentdisch_Code, BC000E28_n573BR_Encounter_Departmentdisch_Code, BC000E28_A90BR_Encounter_ENCType,
               BC000E28_n90BR_Encounter_ENCType, BC000E28_A91BR_Encounter_AdmitDate, BC000E28_n91BR_Encounter_AdmitDate, BC000E28_A92BR_Encounter_AdmitSource, BC000E28_n92BR_Encounter_AdmitSource, BC000E28_A93BR_Encounter_DischargeDate, BC000E28_n93BR_Encounter_DischargeDate, BC000E28_A94BR_Encounter_DischargeStatus, BC000E28_n94BR_Encounter_DischargeStatus, BC000E28_A574BR_Encounter_Insurance,
               BC000E28_n574BR_Encounter_Insurance, BC000E28_A575BR_Encounter_Insurance_Code, BC000E28_n575BR_Encounter_Insurance_Code, BC000E28_A36BR_Information_PatientNo, BC000E28_n36BR_Information_PatientNo, BC000E28_A187BR_Encounter_UpdDate, BC000E28_n187BR_Encounter_UpdDate, BC000E28_A186BR_Encounter_UpdUser, BC000E28_n186BR_Encounter_UpdUser, BC000E28_A333BR_Encounter_IsDLT,
               BC000E28_n333BR_Encounter_IsDLT, BC000E28_A184BR_Encounter_SubmitUser, BC000E28_n184BR_Encounter_SubmitUser, BC000E28_A335BR_Encounter_Reason, BC000E28_n335BR_Encounter_Reason, BC000E28_A185BR_Encounter_SubmitDate, BC000E28_n185BR_Encounter_SubmitDate, BC000E28_A188BR_Encounter_RecheckUser, BC000E28_n188BR_Encounter_RecheckUser, BC000E28_A336BR_Encounter_FReason,
               BC000E28_n336BR_Encounter_FReason, BC000E28_A189BR_Encounter_RecheckDate, BC000E28_n189BR_Encounter_RecheckDate, BC000E28_A190BR_Encounter_Approver, BC000E28_n190BR_Encounter_Approver, BC000E28_A191BR_Encounter_ApproveDate, BC000E28_n191BR_Encounter_ApproveDate, BC000E28_A192BR_Encounter_IsRandApprove, BC000E28_n192BR_Encounter_IsRandApprove, BC000E28_A203BR_Encounter_IsRandApprover,
               BC000E28_n203BR_Encounter_IsRandApprover, BC000E28_A204BR_Encounter_IsRandNoApprover, BC000E28_n204BR_Encounter_IsRandNoApprover, BC000E28_A205BR_Encounter_IsRandApproveDate, BC000E28_n205BR_Encounter_IsRandApproveDate, BC000E28_A206BR_Encounter_IsRandNoApproveDate, BC000E28_n206BR_Encounter_IsRandNoApproveDate, BC000E28_A193BR_Encounter_IsRandRecheck, BC000E28_n193BR_Encounter_IsRandRecheck, BC000E28_A207BR_Encounter_IsRandRecheckr,
               BC000E28_n207BR_Encounter_IsRandRecheckr, BC000E28_A208BR_Encounter_IsRandNoRecheckr, BC000E28_n208BR_Encounter_IsRandNoRecheckr, BC000E28_A209BR_Encounter_IsRandRecheckDate, BC000E28_n209BR_Encounter_IsRandRecheckDate, BC000E28_A210BR_Encounter_IsRandNoRecheckDate, BC000E28_n210BR_Encounter_IsRandNoRecheckDate, BC000E28_A202BR_Encounter_IsUpdate, BC000E28_n202BR_Encounter_IsUpdate, BC000E28_A537BR_Encounter_Datasource,
               BC000E28_n537BR_Encounter_Datasource, BC000E28_A560EncounterIDEncrypt, BC000E28_n560EncounterIDEncrypt, BC000E28_A85BR_Information_ID, BC000E28_n85BR_Information_ID, BC000E28_A360BAS_TenantTenantCode, BC000E28_n360BAS_TenantTenantCode
               }
            }
         );
         AV34Pgmname = "BR_Encounter_BC";
      ...
      private long[] BC000E13_A576BR_FamilyhistoryID ;
      private long[] BC000E14_A348BR_Encounter_RefuseReasonID ;
      private long[] BC000E15_A347BR_Encounter_ID ;
      private long[] BC000E16_A327BR_SchemeID ;
      private long[] BC000E17_A226BR_PathologyID ;
      private long[] BC000E18_A225BR_MedicalImagingID ;
      private long[] BC000E19_A150BR_VitalID ;
      private long[] BC000E20_A139BR_ProcedureID ;
      private long[] BC000E21_A119BR_MedicationID ;
      private long[] BC000E22_A101BR_LabID ;
      private long[] BC000E23_A64BR_DiagnosisID ;
      private long[] BC000E24_A61BR_Demographics_ID ;
      private long[] BC000E25_A48BR_DeathID ;
      private long[] BC000E26_A37BR_ComorbidityID ;
      private long[] BC000E27_A20BR_BehaviorID ;
      private long[] BC000E28_A19BR_EncounterID ;
      private bool[] BC000E28_n19BR_EncounterID ;
      private long[] BC000E28_A35BR_Encounter_EncID ;
      private bool[] BC000E28_n35BR_Encounter_EncID ;
      private short[] BC000E28_A172BR_Encounter_Status ;
      private bool[] BC000E28_n172BR_Encounter_Status ;
      private String[] BC000E28_A183BR_Encounter_CrtUser ;
      private bool[] BC000E28_n183BR_Encounter_CrtUser ;
      private String[] BC000E28_A512BR_Encounter_CrtDisplayName ;
      private bool[] BC000E28_n512BR_Encounter_CrtDisplayName ;
      private DateTime[] BC000E28_A182BR_Encounter_CrtDate ;
      private bool[] BC000E28_n182BR_Encounter_CrtDate ;
      private String[] BC000E28_A470BR_Encounter_Department_Code ;
      private bool[] BC000E28_n470BR_Encounter_Department_Code ;
      private String[] BC000E28_A471BR_Encounter_ENCType_Code ;
      private bool[] BC000E28_n471BR_Encounter_ENCType_Code ;
      private String[] BC000E28_A472BR_Encounter_AdmitSource_Code ;
      private bool[] BC000E28_n472BR_Encounter_AdmitSource_Code ;
      private String[] BC000E28_A473BR_Encounter_DischargeStatus_Code ;
      private bool[] BC000E28_n473BR_Encounter_DischargeStatus_Code ;
      private String[] BC000E28_A84BR_Encounter_Department ;
      private bool[] BC000E28_n84BR_Encounter_Department ;
      private String[] BC000E28_A570BR_Encounter_Departmentadm ;
      private bool[] BC000E28_n570BR_Encounter_Departmentadm ;
      private String[] BC000E28_A571BR_Encounter_Departmentadm_Code ;
      private bool[] BC000E28_n571BR_Encounter_Departmentadm_Code ;
      private String[] BC000E28_A572BR_Encounter_Departmentdisch ;
      private bool[] BC000E28_n572BR_Encounter_Departmentdisch ;
      private String[] BC000E28_A573BR_Encounter_Departmentdisch_Code ;
      private bool[] BC000E28_n573BR_Encounter_Departmentdisch_Code ;
      private String[] BC000E28_A90BR_Encounter_ENCType ;
      private bool[] BC000E28_n90BR_Encounter_ENCType ;
      private DateTime[] BC000E28_A91BR_Encounter_AdmitDate ;
      private bool[] BC000E28_n91BR_Encounter_AdmitDate ;
      private String[] BC000E28_A92BR_Encounter_AdmitSource ;
      private bool[] BC000E28_n92BR_Encounter_AdmitSource ;
      private DateTime[] BC000E28_A93BR_Encounter_DischargeDate ;
      private bool[] BC000E28_n93BR_Encounter_DischargeDate ;
      private String[] BC000E28_A94BR_Encounter_DischargeStatus ;
      private bool[] BC000E28_n94BR_Encounter_DischargeStatus ;
      private String[] BC000E28_A574BR_Encounter_Insurance ;
      private bool[] BC000E28_n574BR_Encounter_Insurance ;
      private String[] BC000E28_A575BR_Encounter_Insurance_Code ;
      private bool[] BC000E28_n575BR_Encounter_Insurance_Code ;
      private String[] BC000E28_A36BR_Information_PatientNo ;
      private bool[] BC000E28_n36BR_Information_PatientNo ;
      private DateTime[] BC000E28_A187BR_Encounter_UpdDate ;
      private bool[] BC000E28_n187BR_Encounter_UpdDate ;
      private String[] BC000E28_A186BR_Encounter_UpdUser ;
      private bool[] BC000E28_n186BR_Encounter_UpdUser ;
      private bool[] BC000E28_A333BR_Encounter_IsDLT ;
      private bool[] BC000E28_n333BR_Encounter_IsDLT ;
      private String[] BC000E28_A184BR_Encounter_SubmitUser ;
      private bool[] BC000E28_n184BR_Encounter_SubmitUser ;
      private String[] BC000E28_A335BR_Encounter_Reason ;
      private bool[] BC000E28_n335BR_Encounter_Reason ;
      private DateTime[] BC000E28_A185BR_Encounter_SubmitDate ;
      private bool[] BC000E28_n185BR_Encounter_SubmitDate ;
      private String[] BC000E28_A188BR_Encounter_RecheckUser ;
      private bool[] BC000E28_n188BR_Encounter_RecheckUser ;
      private String[] BC000E28_A336BR_Encounter_FReason ;
      private bool[] BC000E28_n336BR_Encounter_FReason ;
      private DateTime[] BC000E28_A189BR_Encounter_RecheckDate ;
      private bool[] BC000E28_n189BR_Encounter_RecheckDate ;
      private String[] BC000E28_A190BR_Encounter_Approver ;
      private bool[] BC000E28_n190BR_Encounter_Approver ;
      private DateTime[] BC000E28_A191BR_Encounter_ApproveDate ;
      private bool[] BC000E28_n191BR_Encounter_ApproveDate ;
      private bool[] BC000E28_A192BR_Encounter_IsRandApprove ;
      private bool[] BC000E28_n192BR_Encounter_IsRandApprove ;
      private String[] BC000E28_A203BR_Encounter_IsRandApprover ;
      private bool[] BC000E28_n203BR_Encounter_IsRandApprover ;
      private String[] BC000E28_A204BR_Encounter_IsRandNoApprover ;
      private bool[] BC000E28_n204BR_Encounter_IsRandNoApprover ;
      private DateTime[] BC000E28_A205BR_Encounter_IsRandApproveDate ;
      private bool[] BC000E28_n205BR_Encounter_IsRandApproveDate ;
      private DateTime[] BC000E28_A206BR_Encounter_IsRandNoApproveDate ;
      private bool[] BC000E28_n206BR_Encounter_IsRandNoApproveDate ;
      private bool[] BC000E28_A193BR_Encounter_IsRandRecheck ;
      private bool[] BC000E28_n193BR_Encounter_IsRandRecheck ;
      private String[] BC000E28_A207BR_Encounter_IsRandRecheckr ;
      private bool[] BC000E28_n207BR_Encounter_IsRandRecheckr ;
      private String[] BC000E28_A208BR_Encounter_IsRandNoRecheckr ;
      private bool[] BC000E28_n208BR_Encounter_IsRandNoRecheckr ;
      private DateTime[] BC000E28_A209BR_Encounter_IsRandRecheckDate ;
      private bool[] BC000E28_n209BR_Encounter_IsRandRecheckDate ;
      private DateTime[] BC000E28_A210BR_Encounter_IsRandNoRecheckDate ;
      private bool[] BC000E28_n210BR_Encounter_IsRandNoRecheckDate ;
      private bool[] BC000E28_A202BR_Encounter_IsUpdate ;
      private bool[] BC000E28_n202BR_Encounter_IsUpdate ;
      private short[] BC000E28_A537BR_Encounter_Datasource ;
      private bool[] BC000E28_n537BR_Encounter_Datasource ;
      private String[] BC000E28_A560EncounterIDEncrypt ;
      private bool[] BC000E28_n560EncounterIDEncrypt ;
      private long[] BC000E28_A85BR_Information_ID ;
      private bool[] BC000E28_n85BR_Information_ID ;
      private String[] BC000E28_A360BAS_TenantTenantCode ;
      private bool[] BC000E28_n360BAS_TenantTenantCode ;
 ...
 public class br_encounter_bc__default : DataStoreHelperBase, IDataStoreHelper
 {
  ...
  private void cursorDefinitions( )
  {
     if ( def == null )
     {
        ...
        Object[] prmBC000E28 ;
        prmBC000E28 = new Object[] {
        new Object[] {"@BR_EncounterID",SqlDbType.Decimal,18,0}
        } ;
        String cmdBufferBC000E28 ;
        cmdBufferBC000E28=" SELECT TM1.[BR_EncounterID], TM1.[BR_Encounter_EncID], TM1.[BR_Encounter_Status], TM1.[BR_Encounter_CrtUser], TM1.[BR_Encounter_CrtDisplayName], TM1.[BR_Encounter_CrtDate], TM1.[BR_Encounter_Department_Code], TM1.[BR_Encounter_ENCType_Code], TM1.[BR_Encounter_AdmitSource_Code], TM1.[BR_Encounter_DischargeStatus_Code], TM1.[BR_Encounter_Department], TM1.[BR_Encounter_Departmentadm], TM1.[BR_Encounter_Departmentadm_Code], TM1.[BR_Encounter_Departmentdisch], TM1.[BR_Encounter_Departmentdisch_Code], TM1.[BR_Encounter_ENCType], TM1.[BR_Encounter_AdmitDate], TM1.[BR_Encounter_AdmitSource], TM1.[BR_Encounter_DischargeDate], TM1.[BR_Encounter_DischargeStatus], TM1.[BR_Encounter_Insurance], TM1.[BR_Encounter_Insurance_Code], T2.[BR_Information_PatientNo], TM1.[BR_Encounter_UpdDate], TM1.[BR_Encounter_UpdUser], TM1.[BR_Encounter_IsDLT], TM1.[BR_Encounter_SubmitUser], TM1.[BR_Encounter_Reason], TM1.[BR_Encounter_SubmitDate], TM1.[BR_Encounter_RecheckUser], TM1.[BR_Encounter_FReason], TM1.[BR_Encounter_RecheckDate], TM1.[BR_Encounter_Approver], TM1.[BR_Encounter_ApproveDate], TM1.[BR_Encounter_IsRandApprove], TM1.[BR_Encounter_IsRandApprover], TM1.[BR_Encounter_IsRandNoApprover], TM1.[BR_Encounter_IsRandApproveDate], TM1.[BR_Encounter_IsRandNoApproveDate], TM1.[BR_Encounter_IsRandRecheck], TM1.[BR_Encounter_IsRandRecheckr], TM1.[BR_Encounter_IsRandNoRecheckr], TM1.[BR_Encounter_IsRandRecheckDate], TM1.[BR_Encounter_IsRandNoRecheckDate], TM1.[BR_Encounter_IsUpdate], TM1.[BR_Encounter_Datasource], TM1.[EncounterIDEncrypt], TM1.[BR_Information_ID], TM1.[BAS_TenantTenantCode] FROM ([BR_Encounter] TM1 WITH (NOLOCK) LEFT JOIN [BR_Information] T2 WITH (NOLOCK) ON T2.[BR_Information_ID] = TM1.[BR_Information_ID]) WHERE TM1.[BR_EncounterID] = @BR_EncounterID ORDER BY TM1.[BR_EncounterID]  OPTION "
        + " (FAST 100)" ;
        def= new CursorDef[] {
           ...
           ,new CursorDef("BC000E13", "SELECT TOP 1 [BR_FamilyhistoryID] FROM [BR_Familyhistory] WITH (NOLOCK) WHERE [BR_EncounterID] = @BR_EncounterID ",true, GxErrorMask.GX_NOMASK, false, this,prmBC000E13,1,0,true,true )
           ,new CursorDef("BC000E14", "SELECT TOP 1 [BR_Encounter_RefuseReasonID] FROM [BR_Encounter_RefuseReason] WITH (NOLOCK) WHERE [BR_EncounterID] = @BR_EncounterID ",true, GxErrorMask.GX_NOMASK, false, this,prmBC000E14,1,0,true,true )
           ,new CursorDef("BC000E15", "SELECT TOP 1 [BR_Encounter_ID] FROM [BR_EncounterReason] WITH (NOLOCK) WHERE [BR_EncounterID] = @BR_EncounterID ",true, GxErrorMask.GX_NOMASK, false, this,prmBC000E15,1,0,true,true )
           ,new CursorDef("BC000E16", "SELECT TOP 1 [BR_SchemeID] FROM [BR_Scheme] WITH (NOLOCK) WHERE [BR_EncounterID] = @BR_EncounterID ",true, GxErrorMask.GX_NOMASK, false, this,prmBC000E16,1,0,true,true )
           ,new CursorDef("BC000E17", "SELECT TOP 1 [BR_PathologyID] FROM [BR_Pathology] WITH (NOLOCK) WHERE [BR_EncounterID] = @BR_EncounterID ",true, GxErrorMask.GX_NOMASK, false, this,prmBC000E17,1,0,true,true )
           ,new CursorDef("BC000E18", "SELECT TOP 1 [BR_MedicalImagingID] FROM [BR_MedicalImaging] WITH (NOLOCK) WHERE [BR_EncounterID] = @BR_EncounterID ",true, GxErrorMask.GX_NOMASK, false, this,prmBC000E18,1,0,true,true )
           ,new CursorDef("BC000E19", "SELECT TOP 1 [BR_VitalID] FROM [BR_Vital] WITH (NOLOCK) WHERE [BR_EncounterID] = @BR_EncounterID ",true, GxErrorMask.GX_NOMASK, false, this,prmBC000E19,1,0,true,true )
           ,new CursorDef("BC000E20", "SELECT TOP 1 [BR_ProcedureID] FROM [BR_Procedure] WITH (NOLOCK) WHERE [BR_EncounterID] = @BR_EncounterID ",true, GxErrorMask.GX_NOMASK, false, this,prmBC000E20,1,0,true,true )
           ,new CursorDef("BC000E21", "SELECT TOP 1 [BR_MedicationID] FROM [BR_Medication] WITH (NOLOCK) WHERE [BR_EncounterID] = @BR_EncounterID ",true, GxErrorMask.GX_NOMASK, false, this,prmBC000E21,1,0,true,true )
           ,new CursorDef("BC000E22", "SELECT TOP 1 [BR_LabID] FROM [BR_Lab] WITH (NOLOCK) WHERE [BR_EncounterID] = @BR_EncounterID ",true, GxErrorMask.GX_NOMASK, false, this,prmBC000E22,1,0,true,true )
           ,new CursorDef("BC000E23", "SELECT TOP 1 [BR_DiagnosisID] FROM [BR_Diagnosis] WITH (NOLOCK) WHERE [BR_EncounterID] = @BR_EncounterID ",true, GxErrorMask.GX_NOMASK, false, this,prmBC000E23,1,0,true,true )
           ,new CursorDef("BC000E24", "SELECT TOP 1 [BR_Demographics_ID] FROM [BR_Demographics] WITH (NOLOCK) WHERE [BR_EncounterID] = @BR_EncounterID ",true, GxErrorMask.GX_NOMASK, false, this,prmBC000E24,1,0,true,true )
           ,new CursorDef("BC000E25", "SELECT TOP 1 [BR_DeathID] FROM [BR_Death] WITH (NOLOCK) WHERE [BR_EncounterID] = @BR_EncounterID ",true, GxErrorMask.GX_NOMASK, false, this,prmBC000E25,1,0,true,true )
           ,new CursorDef("BC000E26", "SELECT TOP 1 [BR_ComorbidityID] FROM [BR_Comorbidity] WITH (NOLOCK) WHERE [BR_EncounterID] = @BR_EncounterID ",true, GxErrorMask.GX_NOMASK, false, this,prmBC000E26,1,0,true,true )
           ,new CursorDef("BC000E27", "SELECT TOP 1 [BR_BehaviorID] FROM [BR_Behavior] WITH (NOLOCK) WHERE [BR_EncounterID] = @BR_EncounterID ",true, GxErrorMask.GX_NOMASK, false, this,prmBC000E27,1,0,true,true )
           ,new CursorDef("BC000E28", cmdBufferBC000E28,true, GxErrorMask.GX_NOMASK, false, this,prmBC000E28,100,0,true,false )
        };
     }
  }
