/*
               File: BR_PathologyUpdate
        Description:
             Author: GeneXus C# Generator version 16_0_0-127771
       Generated on: 2/28/2020 15:17:7.75
...
namespace GeneXus.Programs {
   public class br_pathologyupdate : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public br_pathologyupdate( )
      {
      ...
      public br_pathologyupdate( IGxContext context )
      {
      ...
      {
         this.AV15BR_PathologyID = aP0_BR_PathologyID;
         executePrivate();
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxCallCrl"+"_"+"BR_PATHOLOGY_BR_PATHOLOGYID_PAHOSP") == 0 )
            {
               ...
               GXDLVBR_PATHOLOGY_BR_PATHOLOGYID_PAHOSP9A2( AV14tCurrentCode) ;
               return  ;
            }
            ...
            {
               AV15BR_PathologyID = (long)(NumberUtil.Val( gxfirstwebparm, "."));
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV15BR_PathologyID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV15BR_PathologyID), 18, 0)));
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "gxhash_vBR_PATHOLOGYID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV15BR_PathologyID), "ZZZZZZZZZZZZZZZZZZ"), context));
            }
            if ( context.isSpaRequest( ) )
            {
               enableJsOutput();
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20202281517783", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("br_pathologyupdate.aspx") + "?" + UrlEncode("" +AV15BR_PathologyID)+"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vBR_PATHOLOGYID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV15BR_PathologyID), 18, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vBR_PATHOLOGYID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV15BR_PathologyID), "ZZZZZZZZZZZZZZZZZZ"), context));
      ...
      {
         return formatLink("br_pathologyupdate.aspx") + "?" + UrlEncode("" +AV15BR_PathologyID) ;
      }

      public override String GetPgmname( )
      {
         return "BR_PathologyUpdate" ;
      }
      ...
      protected void WB9A0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockbr_pathology_br_pathologyid_padate_Internalname, "病理检查日期", "", "", lblTextblockbr_pathology_br_pathologyid_padate_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, "HLP_BR_PathologyUpdate.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtavBr_pathology_br_pathologyid_padate_Internalname, context.localUtil.Format(AV10BR_Pathology.gxTpr_Br_pathologyid_padate, "9999/99/99"), context.localUtil.Format( AV10BR_Pathology.gxTpr_Br_pathologyid_padate, "9999/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'YMD',0,24,'chs',false,1);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,29);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavBr_pathology_br_pathologyid_padate_Jsonclick, 0, "AttributeDate", "", "", "", "", 1, edtavBr_pathology_br_pathologyid_padate_Enabled, 0, "text", "", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_BR_PathologyUpdate.htm");
            GxWebStd.gx_bitmap( context, edtavBr_pathology_br_pathologyid_padate_Internalname+"_dp_trigger", context.GetImagePath( "61b9b5d3-dff6-4d59-9b00-da61bc2cbe93", "", context.GetTheme( )), "", "", "", "", ((1==0)||(edtavBr_pathology_br_pathologyid_padate_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_BR_PathologyUpdate.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-4 MergeLabelCell", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockbr_pathology_br_pathologyid_paage_Internalname, "年龄", "", "", lblTextblockbr_pathology_br_pathologyid_paage_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, "HLP_BR_PathologyUpdate.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-8", "left", "top", "", "", "div");
            /* Div Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-4 MergeLabelCell", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockbr_pathology_br_pathologyid_pahosp_Internalname, "检查医院", "", "", lblTextblockbr_pathology_br_pathologyid_pahosp_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, "HLP_BR_PathologyUpdate.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-8", "left", "top", "", "", "div");
            /* Div Control */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockbr_pathology_br_pathology_dia_name_Internalname, "病理诊断名称", "", "", lblTextblockbr_pathology_br_pathology_dia_name_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, "HLP_BR_PathologyUpdate.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-2 MergeLabelCell", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockbr_pathology_br_pathologyid_paresult_Internalname, "病理描述", "", "", lblTextblockbr_pathology_br_pathologyid_paresult_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, "HLP_BR_PathologyUpdate.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-10", "left", "top", "", "", "div");
            /* Div Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-2 MergeLabelCell", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockbr_pathology_br_pathologyid_prepadia_Internalname, "病理前诊断", "", "", lblTextblockbr_pathology_br_pathologyid_prepadia_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, "HLP_BR_PathologyUpdate.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-10", "left", "top", "", "", "div");
            /* Div Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-4 MergeLabelCell", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockbr_pathology_br_pathology_t_Internalname, "原发肿瘤分级", "", "", lblTextblockbr_pathology_br_pathology_t_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, "HLP_BR_PathologyUpdate.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-8", "left", "top", "", "", "div");
            /* Div Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-4 MergeLabelCell", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockbr_pathology_br_pathology_n_Internalname, "是否淋巴结转移", "", "", lblTextblockbr_pathology_br_pathology_n_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, "HLP_BR_PathologyUpdate.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-8", "left", "top", "", "", "div");
            /* Div Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-4 MergeLabelCell", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockbr_pathology_br_pathology_lymphrate_Internalname, "淋巴结转移比例", "", "", lblTextblockbr_pathology_br_pathology_lymphrate_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, "HLP_BR_PathologyUpdate.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-8", "left", "top", "", "", "div");
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtavBr_pathology_br_pathology_lymphrate_Internalname, AV10BR_Pathology.gxTpr_Br_pathology_lymphrate, StringUtil.RTrim( context.localUtil.Format( AV10BR_Pathology.gxTpr_Br_pathology_lymphrate, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,102);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavBr_pathology_br_pathology_lymphrate_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavBr_pathology_br_pathology_lymphrate_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 1, -1, -1, true, "", "left", true, "HLP_BR_PathologyUpdate.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-4 MergeLabelCell", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockvpathologym_Internalname, "是否远端转移", "", "", lblTextblockvpathologym_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, "HLP_BR_PathologyUpdate.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-8", "left", "top", "", "", "div");
            /* Div Control */
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavVpathologym, cmbavVpathologym_Internalname, StringUtil.RTrim( AV11vPathologyM), 1, cmbavVpathologym_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "svchar", "", 1, cmbavVpathologym.Enabled, 0, 0, 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,111);\"", "", true, "HLP_BR_PathologyUpdate.htm");
            cmbavVpathologym.CurrentValue = StringUtil.RTrim( AV11vPathologyM);
            ...
            GxWebStd.gx_single_line_edit( context, edtavVmetaloc_Internalname, AV12vMetaLoc, StringUtil.RTrim( context.localUtil.Format( AV12vMetaLoc, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,115);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavVmetaloc_Jsonclick, 0, "Attribute", "", "", "", "", edtavVmetaloc_Visible, edtavVmetaloc_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 1, -1, -1, true, "", "left", true, "HLP_BR_PathologyUpdate.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnenter_Internalname, "", "保存", bttBtnenter_Jsonclick, 5, "确认", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"EENTER."+"'", TempTags, "", context.GetButtonType( ), "HLP_BR_PathologyUpdate.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtncancel_Internalname, "", "取消", bttBtncancel_Jsonclick, 1, "取消", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", context.GetButtonType( ), "HLP_BR_PathologyUpdate.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void GXDLVBR_PATHOLOGY_BR_PATHOLOGYID_PAHOSP9A2( String AV14tCurrentCode )
      {
         if ( ! context.isAjaxRequest( ) )
         {
            context.GX_webresponse.AppendHeader("Cache-Control", "no-store");
         ...
         GXDLVBR_PATHOLOGY_BR_PATHOLOGYID_PAHOSP_data9A2( AV14tCurrentCode) ;
         gxdynajaxindex = 1;
      ...
      protected void GXVBR_PATHOLOGY_BR_PATHOLOGYID_PAHOSP_html9A2( String AV14tCurrentCode )
      {
      ...
      protected void GXDLVBR_PATHOLOGY_BR_PATHOLOGYID_PAHOSP_data9A2( String AV14tCurrentCode )
      {
         ...
         {
            gxdynajaxctrlcodr.Add(H009A2_A168XT_DefineCodeName[0]);
            gxdynajaxctrldescr.Add(H009A2_A168XT_DefineCodeName[0]);
      ...
      protected void fix_multi_value_controls( )
      {
         ...
         {
            AV11vPathologyM = cmbavVpathologym.getValidValue(AV11vPathologyM);
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV11vPathologyM", AV11vPathologyM);
         }
         if ( context.isAjaxRequest( ) )
         {
            cmbavVpathologym.CurrentValue = StringUtil.RTrim( AV11vPathologyM);
      ...
      protected void STRUP9A0( )
      {
         ...
         GXVBR_PATHOLOGY_BR_PATHOLOGYID_PAHOSP_html9A2( AV14tCurrentCode) ;
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            ...
            AV11vPathologyM = cgiGet( cmbavVpathologym_Internalname);
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV11vPathologyM", AV11vPathologyM);
            AV12vMetaLoc = cgiGet( edtavVmetaloc_Internalname);
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV12vMetaLoc", AV12vMetaLoc);
      ...
      protected void E119A2( )
      {
         ...
         AV10BR_Pathology.Load(AV15BR_PathologyID);
         AV12vMetaLoc = AV10BR_Pathology.gxTpr_Br_pathology_metaloc;
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV12vMetaLoc", AV12vMetaLoc);
      }
      ...
      protected void S122( )
      {
         ...
         AV34GXV14 = 1;
         while ( AV34GXV14 <= AV8Messages.Count )
         {
            AV7Message = ((SdtMessages_Message)AV8Messages.Item(AV34GXV14));
            GX_msglist.addItem(AV7Message.gxTpr_Description);
            AV34GXV14 = (int)(AV34GXV14+1);
         }
      }
      ...
      protected void E139A2( )
      {
         ...
         {
            AV17tFlag = true;
            if ( ( AV17tFlag ) && String.IsNullOrEmpty(StringUtil.RTrim( AV10BR_Pathology.gxTpr_Br_pathology_dia_name)) )
            {
               GX_msglist.addItem("病理诊断名称是必填的");
               AV17tFlag = false;
            }
            if ( ( AV17tFlag ) && (0==AV10BR_Pathology.gxTpr_Br_pathologyid_paage) )
            {
               GX_msglist.addItem("年龄是必填的");
               AV17tFlag = false;
            }
            if ( ( AV17tFlag ) && (DateTime.MinValue==AV10BR_Pathology.gxTpr_Br_pathologyid_padate) )
            {
               GX_msglist.addItem("病理检查日期是必填的");
               AV17tFlag = false;
            }
            AV10BR_Pathology.gxTpr_Br_pathology_m = AV11vPathologyM;
            AV10BR_Pathology.gxTpr_Br_pathology_metaloc = AV12vMetaLoc;
            GXt_char1 = "";
            ...
            AV10BR_Pathology.Update();
            if ( AV10BR_Pathology.Success() )
            {
               context.CommitDataStores("br_pathologyupdate",pr_default);
            ...
            else
            {
               AV16ErrorMsg = "";
               AV36GXV16 = 1;
               AV35GXV15 = AV10BR_Pathology.GetMessages();
               while ( AV36GXV16 <= AV35GXV15.Count )
               {
                  AV7Message = ((SdtMessages_Message)AV35GXV15.Item(AV36GXV16));
                  AV16ErrorMsg = AV16ErrorMsg + StringUtil.Trim( AV7Message.gxTpr_Description);
                  AV36GXV16 = (int)(AV36GXV16+1);
               }
            }
         }
      ...
      protected void E149A2( )
      {
         /* Load Routine */
         AV10BR_Pathology.Load(AV15BR_PathologyID);
         if ( StringUtil.StrCmp(AV10BR_Pathology.gxTpr_Br_pathology_m, "是") == 0 )
         {
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV10BR_Pathology.gxTpr_Br_pathology_m)) )
         {
            ...
            AV11vPathologyM = AV10BR_Pathology.gxTpr_Br_pathology_m;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV11vPathologyM", AV11vPathologyM);
         }
      }
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV15BR_PathologyID = Convert.ToInt64(getParm(obj,0));
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV15BR_PathologyID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV15BR_PathologyID), 18, 0)));
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "gxhash_vBR_PATHOLOGYID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV15BR_PathologyID), "ZZZZZZZZZZZZZZZZZZ"), context));
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202022815171033", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("br_pathologyupdate.js", "?202022815171033", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV15BR_PathologyID',fld:'vBR_PATHOLOGYID',pic:'ZZZZZZZZZZZZZZZZZZ',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("ENTER","{handler:'E139A2',iparms:[{av:'AV10BR_Pathology',fld:'vBR_PATHOLOGY',pic:''},{av:'cmbavVpathologym'},{av:'AV11vPathologyM',fld:'vVPATHOLOGYM',pic:''},{av:'AV12vMetaLoc',fld:'vVMETALOC',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         gxwrpcisep = "";
         scmdbuf = "";
         H009A2_A167XT_DefineCodeID = new long[1] ;
         H009A2_A168XT_DefineCodeName = new String[] {""} ;
         H009A2_n168XT_DefineCodeName = new bool[] {false} ;
         H009A2_A165XT_DefindcodeTypeID = new long[1] ;
         H009A2_A432XT_TenantCode = new String[] {""} ;
         H009A2_n432XT_TenantCode = new bool[] {false} ;
         ...
         GXt_char1 = "";
         AV16ErrorMsg = "";
         AV35GXV15 = new GXBaseCollection<SdtMessages_Message>( context, "Message", "GeneXus");
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_datastore1 = new DataStoreProvider(context, new GeneXus.Programs.br_pathologyupdate__datastore1(),
            new Object[][] {
            }
         );
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.br_pathologyupdate__default(),
            new Object[][] {
                new Object[] {
               H009A2_A167XT_DefineCodeID, H009A2_A168XT_DefineCodeName, H009A2_n168XT_DefineCodeName, H009A2_A165XT_DefindcodeTypeID, H009A2_A432XT_TenantCode, H009A2_n432XT_TenantCode
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private int AV34GXV14 ;
      private int AV36GXV16 ;
      private int idxLst ;
      private long AV15BR_PathologyID ;
      private long wcpOAV15BR_PathologyID ;
      ...
      private String AV11vPathologyM ;
      private String AV12vMetaLoc ;
      ...
      private long[] H009A2_A167XT_DefineCodeID ;
      private String[] H009A2_A168XT_DefineCodeName ;
      private bool[] H009A2_n168XT_DefineCodeName ;
      private long[] H009A2_A165XT_DefindcodeTypeID ;
      private String[] H009A2_A432XT_TenantCode ;
      private bool[] H009A2_n432XT_TenantCode ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private IDataStoreProvider pr_datastore1 ;
      private GXBaseCollection<SdtMessages_Message> AV8Messages ;
      private GXBaseCollection<SdtMessages_Message> AV35GXV15 ;
   ...
   public class br_pathologyupdate__datastore1 : DataStoreHelperBase, IDataStoreHelper
   {
 ...
 public class br_pathologyupdate__default : DataStoreHelperBase, IDataStoreHelper
 {
    public ICursor[] getCursors( )
    {
       cursorDefinitions();
  ...
  private void cursorDefinitions( )
  {
     ...
     {
        Object[] prmH009A2 ;
        prmH009A2 = new Object[] {
        new Object[] {"@AV14tCurrentCode",SqlDbType.NVarChar,40,0}
        } ;
        def= new CursorDef[] {
            new CursorDef("H009A2", "SELECT [XT_DefineCodeID], [XT_DefineCodeName], [XT_DefindcodeTypeID], [XT_TenantCode] FROM [XT_DefineCode] WITH (NOLOCK) WHERE ([XT_DefindcodeTypeID] = 32) AND ([XT_TenantCode] = @AV14tCurrentCode) ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH009A2,0,0,true,false )
        };
     }
  }
