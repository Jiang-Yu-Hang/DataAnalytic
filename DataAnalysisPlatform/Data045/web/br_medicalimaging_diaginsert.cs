/*
               File: BR_MedicalImaging_DiagInsert
        Description:
             Author: GeneXus C# Generator version 16_0_0-127771
       Generated on: 2/28/2020 15:16:58.25
...
namespace GeneXus.Programs {
   public class br_medicalimaging_diaginsert : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public br_medicalimaging_diaginsert( )
      {
      ...
      public br_medicalimaging_diaginsert( IGxContext context )
      {
      ...
      {
         this.AV12BR_MedicalImagingID = aP0_BR_MedicalImagingID;
         executePrivate();
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV12BR_MedicalImagingID = (long)(NumberUtil.Val( gxfirstwebparm, "."));
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV12BR_MedicalImagingID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV12BR_MedicalImagingID), 18, 0)));
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "gxhash_vBR_MEDICALIMAGINGID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12BR_MedicalImagingID), "ZZZZZZZZZZZZZZZZZZ"), context));
            }
            if ( context.isSpaRequest( ) )
            {
               enableJsOutput();
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202022815165827", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("br_medicalimaging_diaginsert.aspx") + "?" + UrlEncode("" +AV12BR_MedicalImagingID)+"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vBR_MEDICALIMAGINGID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV12BR_MedicalImagingID), 18, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vBR_MEDICALIMAGINGID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12BR_MedicalImagingID), "ZZZZZZZZZZZZZZZZZZ"), context));
      ...
      {
         return formatLink("br_medicalimaging_diaginsert.aspx") + "?" + UrlEncode("" +AV12BR_MedicalImagingID) ;
      }

      public override String GetPgmname( )
      {
         return "BR_MedicalImaging_DiagInsert" ;
      }
      ...
      protected void WB8W0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnenter_Internalname, "", "保存", bttBtnenter_Jsonclick, 5, "确认", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"EENTER."+"'", TempTags, "", context.GetButtonType( ), "HLP_BR_MedicalImaging_DiagInsert.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtncancel_Internalname, "", "取消", bttBtncancel_Jsonclick, 1, "取消", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", context.GetButtonType( ), "HLP_BR_MedicalImaging_DiagInsert.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void E138W2( )
      {
         ...
         if ( ! AV15tCheckFlag )
         {
            ...
            if ( AV16tFlag )
            {
               AV10BR_MedicalImaging_Diag.gxTpr_Br_medicalimagingid = AV12BR_MedicalImagingID;
               AV10BR_MedicalImaging_Diag.Save();
               if ( AV10BR_MedicalImaging_Diag.Success() )
               {
                  context.CommitDataStores("br_medicalimaging_diaginsert",pr_default);
         ...
         context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "AV10BR_MedicalImaging_Diag", AV10BR_MedicalImaging_Diag);
      }
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV12BR_MedicalImagingID = Convert.ToInt64(getParm(obj,0));
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV12BR_MedicalImagingID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV12BR_MedicalImagingID), 18, 0)));
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "gxhash_vBR_MEDICALIMAGINGID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12BR_MedicalImagingID), "ZZZZZZZZZZZZZZZZZZ"), context));
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202022815165914", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("br_medicalimaging_diaginsert.js", "?202022815165914", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV12BR_MedicalImagingID',fld:'vBR_MEDICALIMAGINGID',pic:'ZZZZZZZZZZZZZZZZZZ',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("ENTER","{handler:'E138W2',iparms:[{av:'AV10BR_MedicalImaging_Diag',fld:'vBR_MEDICALIMAGING_DIAG',pic:''},{av:'AV12BR_MedicalImagingID',fld:'vBR_MEDICALIMAGINGID',pic:'ZZZZZZZZZZZZZZZZZZ',hsh:true}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV10BR_MedicalImaging_Diag',fld:'vBR_MEDICALIMAGING_DIAG',pic:''}]}");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         pr_datastore1 = new DataStoreProvider(context, new GeneXus.Programs.br_medicalimaging_diaginsert__datastore1(),
            new Object[][] {
            }
         );
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.br_medicalimaging_diaginsert__default(),
            new Object[][] {
            }
         );
         /* GeneXus formulas. */
      ...
      private int idxLst ;
      private long AV12BR_MedicalImagingID ;
      private long wcpOAV12BR_MedicalImagingID ;
   ...
   public class br_medicalimaging_diaginsert__datastore1 : DataStoreHelperBase, IDataStoreHelper
   {
 ...
 public class br_medicalimaging_diaginsert__default : DataStoreHelperBase, IDataStoreHelper
 {
    public ICursor[] getCursors( )
    {
       cursorDefinitions();
