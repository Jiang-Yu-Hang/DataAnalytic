/*
       ...
       Generated on: 2/28/2020 15:8:56.61
...
namespace GeneXus.Programs {
   public class bas_tenant_bc : GXHttpHandler, IGxSilentTrn
   {
      ...
      protected void CheckExtendedTable1F52( )
      {
         ...
         {
            GX_msglist.addItem("≤ª∆•≈‰'SYS_Database'", "ForeignKeyNotFound", 1, "DATABASEID");
            AnyError = 1;
         }
         ...
         {
            GX_msglist.addItem("”ÚBAS_Tenant Create Time≥¨ΩÁ", "OutOfRange", 1, "");
            AnyError = 1;
         }
         if ( ! ( (DateTime.MinValue==A400BAS_TenantModifyTime) || ( A400BAS_TenantModifyTime >= context.localUtil.YMDHMSToT( 1753, 1, 1, 0, 0, 0) ) ) )
         {
            GX_msglist.addItem("”ÚBAS_Tenant Modify Time≥¨ΩÁ", "OutOfRange", 1, "");
            AnyError = 1;
         }
      }
