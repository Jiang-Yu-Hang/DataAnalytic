/*
       ...
       Generated on: 2/28/2020 15:7:54.75
...
namespace GeneXus.Programs {
   public class br_medicalimaging : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void CheckExtendedTable0T30( )
      {
         ...
         {
            GX_msglist.addItem("域检查日期超界", "OutOfRange", 1, "BR_MEDICALIMAGING_IMAGEDATE");
            AnyError = 1;
            GX_FocusControl = edtBR_MedicalImaging_ImageDate_Internalname;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "GX_FocusControl", GX_FocusControl);
         }
         ...
         {
            GX_msglist.addItem("域是否有肿瘤转移超界", "OutOfRange", 1, "BR_MEDICALIMAGING_METASTASESDX");
            AnyError = 1;
         ...
         {
            GX_msglist.addItem("域肿瘤转移时间超界", "OutOfRange", 1, "BR_MEDICALIMAGING_METADATE");
            AnyError = 1;
            GX_FocusControl = edtBR_MedicalImaging_MetaDate_Internalname;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "GX_FocusControl", GX_FocusControl);
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2020228158172", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?2020228158227", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("br_medicalimaging.js", "?2020228158228", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false);
