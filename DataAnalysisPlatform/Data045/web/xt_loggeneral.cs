/*
       ...
       Generated on: 2/28/2020 15:7:40.67
...
namespace GeneXus.Programs {
   public class xt_loggeneral : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20202281574071", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void RenderHtmlCloseForm4I2( )
      {
         ...
         {
            context.AddJavascriptSource("xt_loggeneral.js", "?20202281574074", false);
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?20202281574176", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("xt_loggeneral.js", "?20202281574177", false);
