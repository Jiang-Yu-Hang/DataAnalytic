/*
       ...
       Generated on: 2/28/2020 15:8:40.20
...
namespace GeneXus.Programs {
   public class br_procedure_bc : GXHttpHandler, IGxSilentTrn
   {
      ...
      protected void CheckExtendedTable0I19( )
      {
         ...
         {
            GX_msglist.addItem("域是否手术超界", "OutOfRange", 1, "");
            AnyError = 1;
         }
         ...
         {
            GX_msglist.addItem("域手术日期超界", "OutOfRange", 1, "");
            AnyError = 1;
         }
         ...
         {
            GX_msglist.addItem("域是否接受放射疗法超界", "OutOfRange", 1, "");
            AnyError = 1;
         }
         ...
         {
            GX_msglist.addItem("域放疗日期超界", "OutOfRange", 1, "");
            AnyError = 1;
         }
      }
