/*
               File: BR_EncounterUpdateBR_PathologyWC
        Description: Data Mgmt Portal - RAAP
             Author: GeneXus C# Generator version 16_0_0-127771
       Generated on: 2/28/2020 15:8:21.45
...
namespace GeneXus.Programs {
   public class br_encounterupdatebr_pathologywc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      public br_encounterupdatebr_pathologywc( )
      {
      ...
      public br_encounterupdatebr_pathologywc( IGxContext context )
      {
         ...
         if ( StringUtil.Len( (String)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
               {
                  ...
                  AV47ddo_BR_Pathology_Dia_NameTitleControlIdToReplace = GetNextPar( );
                  AV73Pgmname = GetNextPar( );
                  AV42IsAuthorized_Display = StringUtil.StrToBool( GetNextPar( ));
                  AV38IsAuthorized_Update = StringUtil.StrToBool( GetNextPar( ));
                  sPrefix = GetNextPar( );
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV73Pgmname = "BR_EncounterUpdateBR_PathologyWC";
               context.Gx_err = 0;
               WS5I2( ) ;
               if ( ! isAjaxCallMode( ) )
               {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20202281582160", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.skipLines(1);
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("br_encounterupdatebr_pathologywc.aspx") + "?" + UrlEncode("" +AV8BR_EncounterID)+"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri(sPrefix, false, sPrefix+"vBR_PATHOLOGY_DIA_NAMETITLEFILTERDATA", AV46BR_Pathology_Dia_NameTitleFilterData);
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt(sPrefix+"vBR_PATHOLOGY_DIA_NAMETITLEFILTERDATA", AV46BR_Pathology_Dia_NameTitleFilterData);
         }
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"vPGMNAME", StringUtil.RTrim( AV73Pgmname));
      ...
      protected void RenderHtmlCloseForm5I2( )
      {
         ...
         {
            context.AddJavascriptSource("br_encounterupdatebr_pathologywc.js", "?20202281582329", false);
         }
      ...
      {
         return "BR_EncounterUpdateBR_PathologyWC" ;
      }
      ...
      protected void WB5I0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "br_encounterupdatebr_pathologywc.aspx");
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
               context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false);
               context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false);
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(28), 2, 0)+","+"null"+");", "新增", bttBtninsert_Jsonclick, 5, "插入", "", StyleString, ClassString, bttBtninsert_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_BR_EncounterUpdateBR_PathologyWC.htm");
            ...
            else
            {
               ...
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", context.convertURL( AV44mydel));
         ...
         if ( wbEnd == 28 )
         {
            ...
            ClassString = "Attribute";
            StyleString = "";
            GxWebStd.gx_html_textarea( context, edtavDdo_br_pathologyidtitlecontrolidtoreplace_Internalname, AV18ddo_BR_PathologyIDTitleControlIdToReplace, "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,44);\"", 0, edtavDdo_br_pathologyidtitlecontrolidtoreplace_Visible, 1, 0, 80, "chr", 4, "row", StyleString, ClassString, "", "", "300", -1, 0, "", "", -1, true, "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", 0, "HLP_BR_EncounterUpdateBR_PathologyWC.htm");
            /* User Defined Control */
            ...
            ClassString = "Attribute";
            StyleString = "";
            GxWebStd.gx_html_textarea( context, edtavDdo_br_pathologyid_paagetitlecontrolidtoreplace_Internalname, AV26ddo_BR_PathologyID_PAAgeTitleControlIdToReplace, "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,46);\"", 0, edtavDdo_br_pathologyid_paagetitlecontrolidtoreplace_Visible, 1, 0, 80, "chr", 4, "row", StyleString, ClassString, "", "", "300", -1, 0, "", "", -1, true, "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", 0, "HLP_BR_EncounterUpdateBR_PathologyWC.htm");
            /* User Defined Control */
            ...
            ClassString = "Attribute";
            StyleString = "";
            GxWebStd.gx_html_textarea( context, edtavDdo_br_pathologyid_padatetitlecontrolidtoreplace_Internalname, AV22ddo_BR_PathologyID_PADateTitleControlIdToReplace, "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,48);\"", 0, edtavDdo_br_pathologyid_padatetitlecontrolidtoreplace_Visible, 1, 0, 80, "chr", 4, "row", StyleString, ClassString, "", "", "300", -1, 0, "", "", -1, true, "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", 0, "HLP_BR_EncounterUpdateBR_PathologyWC.htm");
            /* User Defined Control */
            ...
            ucDdo_br_pathology_dia_name.SetProperty("DropDownOptionsData", AV46BR_Pathology_Dia_NameTitleFilterData);
            ...
            GxWebStd.gx_single_line_edit( context, edtavBr_pathologyid_selected_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV45BR_PathologyID_Selected), 18, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV45BR_PathologyID_Selected), "ZZZZZZZZZZZZZZZZZZ")), TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,53);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavBr_pathologyid_selected_Jsonclick, 0, "Attribute", "", "", "", "", edtavBr_pathologyid_selected_Visible, 1, 0, "number", "1", 18, "chr", 1, "row", 18, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_BR_EncounterUpdateBR_PathologyWC.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 54,'" + sPrefix + "',false,'" + sGXsfl_28_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavOrderedby_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV14OrderedBy), 4, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV14OrderedBy), "ZZZ9")), TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,54);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavOrderedby_Jsonclick, 0, "Attribute", "", "", "", "", edtavOrderedby_Visible, 1, 0, "number", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_BR_EncounterUpdateBR_PathologyWC.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 55,'" + sPrefix + "',false,'" + sGXsfl_28_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavOrdereddsc_Internalname, StringUtil.BoolToStr( AV15OrderedDsc), StringUtil.BoolToStr( AV15OrderedDsc), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,55);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavOrdereddsc_Jsonclick, 0, "Attribute", "", "", "", "", edtavOrdereddsc_Visible, 1, 0, "text", "", 4, "chr", 1, "row", 4, 0, 0, 0, 1, 0, 0, true, "", "right", false, "HLP_BR_EncounterUpdateBR_PathologyWC.htm");
            wb_table1_56_5I2( true) ;
         }
         else
         {
            wb_table1_56_5I2( false) ;
         }
         return  ;
      }

      protected void wb_table1_56_5I2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 13), "VUPDATE.CLICK") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 13), "VUPDATE.CLICK") == 0 ) )
                           {
                              ...
                              context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtavDisplay_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV41Display)) ? AV70Display_GXI : context.convertURL( context.PathToRelativeUrl( AV41Display))), !bGXsfl_28_Refreshing);
                              ...
                              context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtavUpdate_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV37Update)) ? AV71Update_GXI : context.convertURL( context.PathToRelativeUrl( AV37Update))), !bGXsfl_28_Refreshing);
                              context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtavUpdate_Internalname, "SrcSet", context.GetImageSrcSet( AV37Update), true);
                              AV44mydel = cgiGet( edtavMydel_Internalname);
                              context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtavMydel_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV44mydel)) ? AV72Mydel_GXI : context.convertURL( context.PathToRelativeUrl( AV44mydel))), !bGXsfl_28_Refreshing);
                              context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtavMydel_Internalname, "SrcSet", context.GetImageSrcSet( AV44mydel), true);
      ...
      protected void gxgrGrid_refresh( int subGrid_Rows ,
                                       ...
                                       String AV47ddo_BR_Pathology_Dia_NameTitleControlIdToReplace ,
                                       String AV73Pgmname ,
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_BR_PATHOLOGYID", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(A226BR_PathologyID), "ZZZZZZZZZZZZZZZZZZ"), context));
         GxWebStd.gx_hidden_field( context, sPrefix+"BR_PATHOLOGYID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A226BR_PathologyID), 18, 0, ".", "")));
      }
      ...
      protected void RF5I2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A19BR_EncounterID = H005I2_A19BR_EncounterID[0];
               ...
               n19BR_EncounterID = H005I2_n19BR_EncounterID[0];
               A326BR_Pathology_Dia_Name = H005I2_A326BR_Pathology_Dia_Name[0];
               n326BR_Pathology_Dia_Name = H005I2_n326BR_Pathology_Dia_Name[0];
               A238BR_PathologyID_PADate = H005I2_A238BR_PathologyID_PADate[0];
               n238BR_PathologyID_PADate = H005I2_n238BR_PathologyID_PADate[0];
               A240BR_PathologyID_PAAge = H005I2_A240BR_PathologyID_PAAge[0];
               n240BR_PathologyID_PAAge = H005I2_n240BR_PathologyID_PAAge[0];
               A226BR_PathologyID = H005I2_A226BR_PathologyID[0];
               E215I2 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_BR_PATHOLOGYID"+"_"+sGXsfl_28_idx, GetSecureSignedToken( sPrefix+sGXsfl_28_idx, context.localUtil.Format( (decimal)(A226BR_PathologyID), "ZZZZZZZZZZZZZZZZZZ"), context));
      }
      ...
      protected void STRUP5I0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            ajax_req_read_hidden_sdt(cgiGet( sPrefix+"vBR_PATHOLOGY_DIA_NAMETITLEFILTERDATA"), AV46BR_Pathology_Dia_NameTitleFilterData);
            ...
            AV47ddo_BR_Pathology_Dia_NameTitleControlIdToReplace = cgiGet( edtavDdo_br_pathology_dia_nametitlecontrolidtoreplace_Internalname);
            context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "AV47ddo_BR_Pathology_Dia_NameTitleControlIdToReplace", AV47ddo_BR_Pathology_Dia_NameTitleControlIdToReplace);
            A19BR_EncounterID = (long)(context.localUtil.CToN( cgiGet( edtBR_EncounterID_Internalname), ".", ","));
            n19BR_EncounterID = false;
            context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "A19BR_EncounterID", StringUtil.LTrim( StringUtil.Str( (decimal)(A19BR_EncounterID), 18, 0)));
            if ( ( ( context.localUtil.CToN( cgiGet( edtavBr_pathologyid_selected_Internalname), ".", ",") < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtavBr_pathologyid_selected_Internalname), ".", ",") > Convert.ToDecimal( 999999999999999999L )) ) )
            {
               GX_msglist.addItem(context.GetMessage( "GXM_badnum", ""), 1, "vBR_PATHOLOGYID_SELECTED");
               GX_FocusControl = edtavBr_pathologyid_selected_Internalname;
               context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "GX_FocusControl", GX_FocusControl);
               wbErr = true;
               AV45BR_PathologyID_Selected = 0;
               context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "AV45BR_PathologyID_Selected", StringUtil.LTrim( StringUtil.Str( (decimal)(AV45BR_PathologyID_Selected), 18, 0)));
            }
            else
            {
               AV45BR_PathologyID_Selected = (long)(context.localUtil.CToN( cgiGet( edtavBr_pathologyid_selected_Internalname), ".", ","));
               context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "AV45BR_PathologyID_Selected", StringUtil.LTrim( StringUtil.Str( (decimal)(AV45BR_PathologyID_Selected), 18, 0)));
            }
            ...
            AV67GridPageCount = (long)(context.localUtil.CToN( cgiGet( sPrefix+"vGRIDPAGECOUNT"), ".", ","));
      ...
      {
         /* Start Routine */
         AV62tResult = AV65websession.Get("DAS_UserInfo");
         AV63tSDT_MicroUserInfo.FromJSonString(AV62tResult, null);
         edtavBr_pathologyid_selected_Visible = 0;
         context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtavBr_pathologyid_selected_Internalname, "Visible", StringUtil.LTrim( StringUtil.Str( (decimal)(edtavBr_pathologyid_selected_Visible), 5, 0)), true);
         subGrid_Rows = 9;
         GxWebStd.gx_hidden_field( context, sPrefix+"GRID_Rows", StringUtil.LTrim( StringUtil.NToC( (decimal)(subGrid_Rows), 6, 0, ".", "")));
         ...
         AV47ddo_BR_Pathology_Dia_NameTitleControlIdToReplace = Ddo_br_pathology_dia_name_Titlecontrolidtoreplace;
         context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "AV47ddo_BR_Pathology_Dia_NameTitleControlIdToReplace", AV47ddo_BR_Pathology_Dia_NameTitleControlIdToReplace);
      ...
      protected void E205I2( )
      {
         ...
         AV46BR_Pathology_Dia_NameTitleFilterData = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTDropDownOptionsData_Item>( context, "Item", "");
         ...
         context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtBR_PathologyID_Internalname, "Title", edtBR_PathologyID_Title, !bGXsfl_28_Refreshing);
         ...
         context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtBR_PathologyID_PAAge_Internalname, "Title", edtBR_PathologyID_PAAge_Title, !bGXsfl_28_Refreshing);
         ...
         context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtBR_PathologyID_PADate_Internalname, "Title", edtBR_PathologyID_PADate_Title, !bGXsfl_28_Refreshing);
         edtBR_Pathology_Dia_Name_Titleformat = 2;
         edtBR_Pathology_Dia_Name_Title = StringUtil.Format( "<div class='ColumnSettingsContainer''><span>%1</span><div id='%2'></div>", "病理诊断名称", AV47ddo_BR_Pathology_Dia_NameTitleControlIdToReplace, "", "", "", "", "", "", "");
         context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtBR_Pathology_Dia_Name_Internalname, "Title", edtBR_Pathology_Dia_Name_Title, !bGXsfl_28_Refreshing);
         ...
         context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "AV67GridPageCount", StringUtil.LTrim( StringUtil.Str( (decimal)(AV67GridPageCount), 10, 0)));
         ...
         context.httpAjaxContext.ajax_rsp_assign_sdt_attri(sPrefix, false, "AV46BR_Pathology_Dia_NameTitleFilterData", AV46BR_Pathology_Dia_NameTitleFilterData);
      }
      ...
      private void E215I2( )
      {
         ...
         context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, edtavUpdate_Internalname, AV37Update);
         ...
         AV44mydel = context.GetImagePath( "7695fe89-52c9-4b7e-871e-0e11548f823e", "", context.GetTheme( ));
         context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, edtavMydel_Internalname, AV44mydel);
         AV72Mydel_GXI = GXDbFile.PathToUrl( context.GetImagePath( "7695fe89-52c9-4b7e-871e-0e11548f823e", "", context.GetTheme( )));
      ...
      protected void E185I2( )
      {
         ...
         CallWebObject(formatLink("br_pathologyinsert.aspx") + "?" + UrlEncode("" +AV8BR_EncounterID));
         context.wjLocDisableFrm = 1;
      }
      ...
      protected void S132( )
      {
         ...
         GXt_boolean2 = AV38IsAuthorized_Update;
         new GeneXus.Programs.wwpbaseobjects.secisauthbyfunctionalitykey(context ).execute(  "Manage_Pathology", out  GXt_boolean2) ;
         AV38IsAuthorized_Update = GXt_boolean2;
         context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "AV38IsAuthorized_Update", AV38IsAuthorized_Update);
         if ( ! ( AV38IsAuthorized_Update ) )
         {
         ...
         GXt_boolean2 = AV61IsAuthorized_mydel;
         new GeneXus.Programs.wwpbaseobjects.secisauthbyfunctionalitykey(context ).execute(  "Manage_Pathology", out  GXt_boolean2) ;
         AV61IsAuthorized_mydel = GXt_boolean2;
         if ( ! ( AV61IsAuthorized_mydel ) )
         {
         ...
         GXt_boolean2 = AV43TempBoolean;
         new GeneXus.Programs.wwpbaseobjects.secisauthbyfunctionalitykey(context ).execute(  "Manage_Pathology", out  GXt_boolean2) ;
         AV43TempBoolean = GXt_boolean2;
         if ( ! ( AV43TempBoolean ) )
         {
      ...
      {
         /* 'DO MYDEL' Routine */
         new zutil_checksession(context ).execute( out  AV66tCheckFlag) ;
         if ( ! AV66tCheckFlag )
         {
            new zbr_deletepathology(context ).execute(  A226BR_PathologyID) ;
            context.DoAjaxRefreshCmp(sPrefix);
         }
      }
      ...
      protected void S122( )
      {
         ...
         {
            AV12GridState.FromXml(new GeneXus.Programs.wwpbaseobjects.loadgridstate(context).executeUdp(  AV73Pgmname+"GridState"), null, "WWPGridState", "DataAnalysisPlatform");
         }
         else
         {
            AV12GridState.FromXml(AV16Session.Get(AV73Pgmname+"GridState"), null, "WWPGridState", "DataAnalysisPlatform");
         }
      ...
      protected void S142( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.savegridstate(context ).execute(  AV73Pgmname+"GridState",  AV12GridState.ToXml(false, true, "WWPGridState", "DataAnalysisPlatform")) ;
      }
      ...
      protected void S112( )
      {
         ...
         AV10TrnContext.gxTpr_Callerobject = AV73Pgmname;
      ...
      protected void E225I2( )
      {
         /* Update_Click Routine */
         new zutil_checksession(context ).execute( out  AV66tCheckFlag) ;
         if ( ! AV66tCheckFlag )
         {
            CallWebObject(formatLink("br_pathologyupdate.aspx") + "?" + UrlEncode("" +A226BR_PathologyID));
            context.wjLocDisableFrm = 1;
         }
      }

      protected void wb_table1_56_5I2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_56_5I2e( true) ;
         }
         else
         {
            wb_table1_56_5I2e( false) ;
         }
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "br_encounterupdatebr_pathologywc", GetJustCreated( ));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?20202281583082", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("br_encounterupdatebr_pathologywc.js", "?20202281583082", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
      ...
      protected void SubsflControlProps_282( )
      {
         ...
         edtBR_PathologyID_Internalname = sPrefix+"BR_PATHOLOGYID_"+sGXsfl_28_idx;
         edtBR_PathologyID_PAAge_Internalname = sPrefix+"BR_PATHOLOGYID_PAAGE_"+sGXsfl_28_idx;
         edtBR_PathologyID_PADate_Internalname = sPrefix+"BR_PATHOLOGYID_PADATE_"+sGXsfl_28_idx;
         edtBR_Pathology_Dia_Name_Internalname = sPrefix+"BR_PATHOLOGY_DIA_NAME_"+sGXsfl_28_idx;
      }
      ...
      protected void SubsflControlProps_fel_282( )
      {
         ...
         edtBR_PathologyID_Internalname = sPrefix+"BR_PATHOLOGYID_"+sGXsfl_28_fel_idx;
         edtBR_PathologyID_PAAge_Internalname = sPrefix+"BR_PATHOLOGYID_PAAGE_"+sGXsfl_28_fel_idx;
         edtBR_PathologyID_PADate_Internalname = sPrefix+"BR_PATHOLOGYID_PADATE_"+sGXsfl_28_fel_idx;
         edtBR_Pathology_Dia_Name_Internalname = sPrefix+"BR_PATHOLOGY_DIA_NAME_"+sGXsfl_28_fel_idx;
      }
      ...
      protected void sendrow_282( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_28_idx <= subGrid_Recordsperpage( ) * 1 ) )
         {
            ...
            StyleString = "";
            AV41Display_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV41Display))&&String.IsNullOrEmpty(StringUtil.RTrim( AV70Display_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV41Display)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV41Display)) ? AV70Display_GXI : context.PathToRelativeUrl( AV41Display));
            ...
            ClassString = "ActionBaseColorAttribute";
            StyleString = "";
            AV37Update_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV37Update))&&String.IsNullOrEmpty(StringUtil.RTrim( AV71Update_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV37Update)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV37Update)) ? AV71Update_GXI : context.PathToRelativeUrl( AV37Update));
            GridRow.AddColumnProperties("bitmap", 1, isAjaxCallMode( ), new Object[] {(String)edtavUpdate_Internalname,(String)sImgUrl,(String)"",(String)"",(String)"",context.GetTheme( ),(int)edtavUpdate_Visible,(short)1,(String)"",(String)edtavUpdate_Tooltiptext,(short)0,(short)-1,(short)0,(String)"px",(short)0,(String)"px",(short)0,(short)0,(short)5,(String)edtavUpdate_Jsonclick,"'"+sPrefix+"'"+",false,"+"'"+sPrefix+"EVUPDATE.CLICK."+sGXsfl_28_idx+"'",(String)StyleString,(String)ClassString,(String)"WWActionColumn",(String)"",(String)"",(String)"",(String)""+TempTags,(String)"",(String)"",(short)1,(bool)AV37Update_IsBlob,(bool)false,context.GetImageSrcSet( sImgUrl)});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
            ...
            ClassString = "ActionBaseColorAttribute";
            StyleString = "";
            AV44mydel_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV44mydel))&&String.IsNullOrEmpty(StringUtil.RTrim( AV72Mydel_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV44mydel)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV44mydel)) ? AV72Mydel_GXI : context.PathToRelativeUrl( AV44mydel));
            GridRow.AddColumnProperties("bitmap", 1, isAjaxCallMode( ), new Object[] {(String)edtavMydel_Internalname,(String)sImgUrl,(String)"",(String)"",(String)"",context.GetTheme( ),(int)edtavMydel_Visible,(short)1,(String)"",(String)edtavMydel_Tooltiptext,(short)0,(short)-1,(short)0,(String)"px",(short)0,(String)"px",(short)0,(short)0,(short)7,(String)edtavMydel_Jsonclick,(String)"'"+sPrefix+"'"+",false,"+"'"+"e235i2_client"+"'",(String)StyleString,(String)ClassString,(String)"WWActionColumn",(String)"",(String)"",(String)"",(String)""+TempTags,(String)"",(String)"",(short)1,(bool)AV44mydel_IsBlob,(bool)false,context.GetImageSrcSet( sImgUrl)});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
      ...
      protected void init_default_properties( )
      {
         ...
         edtavBr_pathologyid_selected_Internalname = sPrefix+"vBR_PATHOLOGYID_SELECTED";
      ...
      public override void initialize_properties( )
      {
         ...
         edtavBr_pathologyid_selected_Jsonclick = "";
         edtavBr_pathologyid_selected_Visible = 1;
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("DDO_BR_PATHOLOGYID_PAAGE.ONOPTIONCLICKED","{handler:'E145I2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV8BR_EncounterID',fld:'vBR_ENCOUNTERID',pic:'ZZZZZZZZZZZZZZZZZZ'},{av:'AV18ddo_BR_PathologyIDTitleControlIdToReplace',fld:'vDDO_BR_PATHOLOGYIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV26ddo_BR_PathologyID_PAAgeTitleControlIdToReplace',fld:'vDDO_BR_PATHOLOGYID_PAAGETITLECONTROLIDTOREPLACE',pic:''},{av:'AV22ddo_BR_PathologyID_PADateTitleControlIdToReplace',fld:'vDDO_BR_PATHOLOGYID_PADATETITLECONTROLIDTOREPLACE',pic:''},{av:'AV47ddo_BR_Pathology_Dia_NameTitleControlIdToReplace',fld:'vDDO_BR_PATHOLOGY_DIA_NAMETITLECONTROLIDTOREPLACE',pic:''},{av:'AV73Pgmname',fld:'vPGMNAME',pic:''},{av:'AV42IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:''},{av:'AV38IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:''},{av:'sPrefix'},{av:'Ddo_br_pathologyid_paage_Activeeventkey',ctrl:'DDO_BR_PATHOLOGYID_PAAGE',prop:'ActiveEventKey'}]");
         ...
         setEventMetadata("DDO_BR_PATHOLOGYID_PADATE.ONOPTIONCLICKED","{handler:'E155I2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV8BR_EncounterID',fld:'vBR_ENCOUNTERID',pic:'ZZZZZZZZZZZZZZZZZZ'},{av:'AV18ddo_BR_PathologyIDTitleControlIdToReplace',fld:'vDDO_BR_PATHOLOGYIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV26ddo_BR_PathologyID_PAAgeTitleControlIdToReplace',fld:'vDDO_BR_PATHOLOGYID_PAAGETITLECONTROLIDTOREPLACE',pic:''},{av:'AV22ddo_BR_PathologyID_PADateTitleControlIdToReplace',fld:'vDDO_BR_PATHOLOGYID_PADATETITLECONTROLIDTOREPLACE',pic:''},{av:'AV47ddo_BR_Pathology_Dia_NameTitleControlIdToReplace',fld:'vDDO_BR_PATHOLOGY_DIA_NAMETITLECONTROLIDTOREPLACE',pic:''},{av:'AV73Pgmname',fld:'vPGMNAME',pic:''},{av:'AV42IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:''},{av:'AV38IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:''},{av:'sPrefix'},{av:'Ddo_br_pathologyid_padate_Activeeventkey',ctrl:'DDO_BR_PATHOLOGYID_PADATE',prop:'ActiveEventKey'}]");
         ...
         setEventMetadata("DDO_BR_PATHOLOGY_DIA_NAME.ONOPTIONCLICKED","{handler:'E165I2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV8BR_EncounterID',fld:'vBR_ENCOUNTERID',pic:'ZZZZZZZZZZZZZZZZZZ'},{av:'AV18ddo_BR_PathologyIDTitleControlIdToReplace',fld:'vDDO_BR_PATHOLOGYIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV26ddo_BR_PathologyID_PAAgeTitleControlIdToReplace',fld:'vDDO_BR_PATHOLOGYID_PAAGETITLECONTROLIDTOREPLACE',pic:''},{av:'AV22ddo_BR_PathologyID_PADateTitleControlIdToReplace',fld:'vDDO_BR_PATHOLOGYID_PADATETITLECONTROLIDTOREPLACE',pic:''},{av:'AV47ddo_BR_Pathology_Dia_NameTitleControlIdToReplace',fld:'vDDO_BR_PATHOLOGY_DIA_NAMETITLECONTROLIDTOREPLACE',pic:''},{av:'AV73Pgmname',fld:'vPGMNAME',pic:''},{av:'AV42IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:''},{av:'AV38IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:''},{av:'sPrefix'},{av:'Ddo_br_pathology_dia_name_Activeeventkey',ctrl:'DDO_BR_PATHOLOGY_DIA_NAME',prop:'ActiveEventKey'}]");
         ...
         setEventMetadata("GRID.LOAD","{handler:'E215I2',iparms:[{av:'AV42IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:''},{av:'A226BR_PathologyID',fld:'BR_PATHOLOGYID',pic:'ZZZZZZZZZZZZZZZZZZ',hsh:true},{av:'AV38IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:''}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'AV41Display',fld:'vDISPLAY',pic:''},{av:'edtavDisplay_Tooltiptext',ctrl:'vDISPLAY',prop:'Tooltiptext'},{av:'edtavDisplay_Link',ctrl:'vDISPLAY',prop:'Link'},{av:'AV37Update',fld:'vUPDATE',pic:''},{av:'edtavUpdate_Tooltiptext',ctrl:'vUPDATE',prop:'Tooltiptext'},{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'AV44mydel',fld:'vMYDEL',pic:''},{av:'edtavMydel_Tooltiptext',ctrl:'vMYDEL',prop:'Tooltiptext'}]}");
         setEventMetadata("'DOMYDEL'","{handler:'E235I2',iparms:[{av:'A226BR_PathologyID',fld:'BR_PATHOLOGYID',pic:'ZZZZZZZZZZZZZZZZZZ',hsh:true}]");
         setEventMetadata("'DOMYDEL'",",oparms:[{av:'AV45BR_PathologyID_Selected',fld:'vBR_PATHOLOGYID_SELECTED',pic:'ZZZZZZZZZZZZZZZZZZ'}]}");
         setEventMetadata("DVELOP_CONFIRMPANEL_MYDEL.CLOSE","{handler:'E175I2',iparms:[{av:'Dvelop_confirmpanel_mydel_Result',ctrl:'DVELOP_CONFIRMPANEL_MYDEL',prop:'Result'},{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV8BR_EncounterID',fld:'vBR_ENCOUNTERID',pic:'ZZZZZZZZZZZZZZZZZZ'},{av:'AV18ddo_BR_PathologyIDTitleControlIdToReplace',fld:'vDDO_BR_PATHOLOGYIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV26ddo_BR_PathologyID_PAAgeTitleControlIdToReplace',fld:'vDDO_BR_PATHOLOGYID_PAAGETITLECONTROLIDTOREPLACE',pic:''},{av:'AV22ddo_BR_PathologyID_PADateTitleControlIdToReplace',fld:'vDDO_BR_PATHOLOGYID_PADATETITLECONTROLIDTOREPLACE',pic:''},{av:'AV47ddo_BR_Pathology_Dia_NameTitleControlIdToReplace',fld:'vDDO_BR_PATHOLOGY_DIA_NAMETITLECONTROLIDTOREPLACE',pic:''},{av:'AV73Pgmname',fld:'vPGMNAME',pic:''},{av:'AV42IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:''},{av:'AV38IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:''},{av:'sPrefix'},{av:'A226BR_PathologyID',fld:'BR_PATHOLOGYID',pic:'ZZZZZZZZZZZZZZZZZZ',hsh:true}]");
         setEventMetadata("DVELOP_CONFIRMPANEL_MYDEL.CLOSE",",oparms:[{av:'AV17BR_PathologyIDTitleFilterData',fld:'vBR_PATHOLOGYIDTITLEFILTERDATA',pic:''},{av:'AV25BR_PathologyID_PAAgeTitleFilterData',fld:'vBR_PATHOLOGYID_PAAGETITLEFILTERDATA',pic:''},{av:'AV21BR_PathologyID_PADateTitleFilterData',fld:'vBR_PATHOLOGYID_PADATETITLEFILTERDATA',pic:''},{av:'AV46BR_Pathology_Dia_NameTitleFilterData',fld:'vBR_PATHOLOGY_DIA_NAMETITLEFILTERDATA',pic:''},{av:'edtBR_PathologyID_Titleformat',ctrl:'BR_PATHOLOGYID',prop:'Titleformat'},{av:'edtBR_PathologyID_Title',ctrl:'BR_PATHOLOGYID',prop:'Title'},{av:'edtBR_PathologyID_PAAge_Titleformat',ctrl:'BR_PATHOLOGYID_PAAGE',prop:'Titleformat'},{av:'edtBR_PathologyID_PAAge_Title',ctrl:'BR_PATHOLOGYID_PAAGE',prop:'Title'},{av:'edtBR_PathologyID_PADate_Titleformat',ctrl:'BR_PATHOLOGYID_PADATE',prop:'Titleformat'},{av:'edtBR_PathologyID_PADate_Title',ctrl:'BR_PATHOLOGYID_PADATE',prop:'Title'},{av:'edtBR_Pathology_Dia_Name_Titleformat',ctrl:'BR_PATHOLOGY_DIA_NAME',prop:'Titleformat'},{av:'edtBR_Pathology_Dia_Name_Title',ctrl:'BR_PATHOLOGY_DIA_NAME',prop:'Title'},{av:'AV34GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV67GridPageCount',fld:'vGRIDPAGECOUNT',pic:'ZZZZZZZZZ9'},{av:'AV42IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:''},{av:'edtavDisplay_Visible',ctrl:'vDISPLAY',prop:'Visible'},{av:'AV38IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:''},{av:'edtavUpdate_Visible',ctrl:'vUPDATE',prop:'Visible'},{av:'edtavMydel_Visible',ctrl:'vMYDEL',prop:'Visible'},{ctrl:'BTNINSERT',prop:'Visible'}]}");
         setEventMetadata("'DOINSERT'","{handler:'E185I2',iparms:[{av:'A226BR_PathologyID',fld:'BR_PATHOLOGYID',pic:'ZZZZZZZZZZZZZZZZZZ',hsh:true},{av:'AV8BR_EncounterID',fld:'vBR_ENCOUNTERID',pic:'ZZZZZZZZZZZZZZZZZZ'}]");
         setEventMetadata("'DOINSERT'",",oparms:[]}");
         setEventMetadata("VUPDATE.CLICK","{handler:'E225I2',iparms:[{av:'A226BR_PathologyID',fld:'BR_PATHOLOGYID',pic:'ZZZZZZZZZZZZZZZZZZ',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         AV47ddo_BR_Pathology_Dia_NameTitleControlIdToReplace = "";
         AV73Pgmname = "";
         GXKey = "";
         sDynURL = "";
         FormProcess = "";
         ...
         AV72Mydel_GXI = "";
         scmdbuf = "";
         H005I2_A19BR_EncounterID = new long[1] ;
         H005I2_n19BR_EncounterID = new bool[] {false} ;
         H005I2_A326BR_Pathology_Dia_Name = new String[] {""} ;
         H005I2_n326BR_Pathology_Dia_Name = new bool[] {false} ;
         H005I2_A238BR_PathologyID_PADate = new DateTime[] {DateTime.MinValue} ;
         H005I2_n238BR_PathologyID_PADate = new bool[] {false} ;
         H005I2_A240BR_PathologyID_PAAge = new short[1] ;
         H005I2_n240BR_PathologyID_PAAge = new bool[] {false} ;
         H005I2_A226BR_PathologyID = new long[1] ;
         H005I3_AGRID_nRecordCount = new long[1] ;
         AV62tResult = "";
         AV65websession = context.GetSession();
         AV63tSDT_MicroUserInfo = new SdtSDT_MicroUserInfo(context);
         ...
         sImgUrl = "";
         ROClassString = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.br_encounterupdatebr_pathologywc__default(),
            new Object[][] {
                new Object[] {
               H005I2_A19BR_EncounterID, H005I2_n19BR_EncounterID, H005I2_A326BR_Pathology_Dia_Name, H005I2_n326BR_Pathology_Dia_Name, H005I2_A238BR_PathologyID_PADate, H005I2_n238BR_PathologyID_PADate, H005I2_A240BR_PathologyID_PAAge, H005I2_n240BR_PathologyID_PAAge, H005I2_A226BR_PathologyID
               }
               , new Object[] {
      ...
      private int edtavBr_pathologyid_selected_Visible ;
      ...
      private long AV45BR_PathologyID_Selected ;
      ...
      private String edtavBr_pathologyid_selected_Internalname ;
      private String edtavBr_pathologyid_selected_Jsonclick ;
      ...
      private String AV47ddo_BR_Pathology_Dia_NameTitleControlIdToReplace ;
      private String A326BR_Pathology_Dia_Name ;
      private String AV70Display_GXI ;
      private String AV71Update_GXI ;
      private String AV72Mydel_GXI ;
      private String AV62tResult ;
      private String AV41Display ;
      private String AV37Update ;
      private String AV44mydel ;
      private IGxSession AV65websession ;
      ...
      private long[] H005I2_A19BR_EncounterID ;
      private bool[] H005I2_n19BR_EncounterID ;
      private String[] H005I2_A326BR_Pathology_Dia_Name ;
      private bool[] H005I2_n326BR_Pathology_Dia_Name ;
      private DateTime[] H005I2_A238BR_PathologyID_PADate ;
      private bool[] H005I2_n238BR_PathologyID_PADate ;
      private short[] H005I2_A240BR_PathologyID_PAAge ;
      private bool[] H005I2_n240BR_PathologyID_PAAge ;
      private long[] H005I2_A226BR_PathologyID ;
      ...
      private GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTDropDownOptionsData_Item> AV46BR_Pathology_Dia_NameTitleFilterData ;
      ...
      private SdtSDT_MicroUserInfo AV63tSDT_MicroUserInfo ;
      private GeneXus.Programs.wwpbaseobjects.SdtWWPContext AV6WWPContext ;
   }

   public class br_encounterupdatebr_pathologywc__default : DataStoreHelperBase, IDataStoreHelper
   {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H005I2(context, (short)dynConstraints[0] , (bool)dynConstraints[1] , (long)dynConstraints[2] , (long)dynConstraints[3] );
               case 1 :
                     return conditional_H005I3(context, (short)dynConstraints[0] , (bool)dynConstraints[1] , (long)dynConstraints[2] , (long)dynConstraints[3] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H005I2", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH005I2,11,0,true,false )
             ,new CursorDef("H005I3", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH005I3,1,0,true,false )
          };
       }
    }
