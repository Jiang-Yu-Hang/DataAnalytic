/*
       ...
       Generated on: 2/28/2020 15:9:29.53
...
namespace GeneXus.Programs {
   public class br_informationww : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               gxgrGrid_refresh( subGrid_Rows, AV17BR_Information_PatientNo, AV13OrderedBy, AV14OrderedDsc, AV6WWPContext, AV52ddo_BR_Information_PatientNoTitleControlIdToReplace, AV155Pgmname, AV142IsAuthorized_PatientReTenant, AV140IsAuthorized_Patient_Entity) ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vGRIDPAGECOUNT", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV147GridPageCount), 10, 0, ".", "")));
         if ( context.isAjaxRequest( ) )
         {
         ...
         GxWebStd.gx_hidden_field( context, "vPGMNAME", StringUtil.RTrim( AV155Pgmname));
      ...
      protected void WB1G0( )
      {
         ...
         if ( wbEnd == 32 )
         {
            ...
            ucGridpaginationbar.SetProperty("PageCount", AV147GridPageCount);
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "'DOADD'") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              context.httpAjaxContext.ajax_rsp_assign_prop("", false, edtavMyupdate_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV126myupdate)) ? AV152Myupdate_GXI : context.convertURL( context.PathToRelativeUrl( AV126myupdate))), !bGXsfl_32_Refreshing);
                              ...
                              context.httpAjaxContext.ajax_rsp_assign_prop("", false, edtavPatientretenant_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV141PatientReTenant)) ? AV153Patientretenant_GXI : context.convertURL( context.PathToRelativeUrl( AV141PatientReTenant))), !bGXsfl_32_Refreshing);
                              ...
                              context.httpAjaxContext.ajax_rsp_assign_prop("", false, edtavPatient_entity_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV139Patient_Entity)) ? AV154Patient_entity_GXI : context.convertURL( context.PathToRelativeUrl( AV139Patient_Entity))), !bGXsfl_32_Refreshing);
      ...
      protected void RF1G2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            pr_default.dynParam(0, new Object[]{ new Object[]{
                                                 ...
                                                 AV151BR_InformationWWDS_1_Br_information_patientno ,
            ...
            lV151BR_InformationWWDS_1_Br_information_patientno = StringUtil.Concat( StringUtil.RTrim( AV151BR_InformationWWDS_1_Br_information_patientno), "%", "");
            /* Using cursor H001G2 */
            pr_default.execute(0, new Object[] {lV151BR_InformationWWDS_1_Br_information_patientno, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_32_idx = 1;
            sGXsfl_32_idx = StringUtil.PadL( StringUtil.LTrim( StringUtil.Str( (decimal)(nGXsfl_32_idx), 4, 0)), 4, "0");
            SubsflControlProps_322( ) ;
      ...
      {
         AV151BR_InformationWWDS_1_Br_information_patientno = AV17BR_Information_PatientNo;
         ...
         lV151BR_InformationWWDS_1_Br_information_patientno = StringUtil.Concat( StringUtil.RTrim( AV151BR_InformationWWDS_1_Br_information_patientno), "%", "");
         /* Using cursor H001G3 */
         pr_default.execute(1, new Object[] {lV151BR_InformationWWDS_1_Br_information_patientno});
      ...
      protected void STRUP1G0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV147GridPageCount = (long)(context.localUtil.CToN( cgiGet( "vGRIDPAGECOUNT"), ".", ","));
      ...
      protected void E151G2( )
      {
         ...
         AV150Tresult = AV127websession.Get("DAS_UserInfo");
         AV128tSDT_MicroUserInfo.FromJSonString(AV150Tresult, null);
         subGrid_Rows = 9;
         GxWebStd.gx_hidden_field( context, "GRID_Rows", StringUtil.LTrim( StringUtil.NToC( (decimal)(subGrid_Rows), 6, 0, ".", "")));
      ...
      protected void E161G2( )
      {
         ...
         AV147GridPageCount = subGrid_Pagecount( );
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV147GridPageCount", StringUtil.LTrim( StringUtil.Str( (decimal)(AV147GridPageCount), 10, 0)));
         AV151BR_InformationWWDS_1_Br_information_patientno = AV17BR_Information_PatientNo;
      ...
      private void E171G2( )
      {
         ...
         AV152Myupdate_GXI = GXDbFile.PathToUrl( context.GetImagePath( "7c63c2b9-483e-4035-b512-febf9186a274", "", context.GetTheme( )));
         ...
         AV153Patientretenant_GXI = GXDbFile.PathToUrl( context.GetImagePath( "cc488df4-dfce-487a-a445-6fdd39fec85e", "", context.GetTheme( )));
         ...
         AV154Patient_entity_GXI = GXDbFile.PathToUrl( context.GetImagePath( "cc488df4-dfce-487a-a445-6fdd39fec85e", "", context.GetTheme( )));
      ...
      protected void S122( )
      {
         ...
         if ( StringUtil.StrCmp(AV40Session.Get(AV155Pgmname+"GridState"), "") == 0 )
         {
            AV11GridState.FromXml(new GeneXus.Programs.wwpbaseobjects.loadgridstate(context).executeUdp(  AV155Pgmname+"GridState"), null, "WWPGridState", "DataAnalysisPlatform");
         }
         else
         {
            AV11GridState.FromXml(AV40Session.Get(AV155Pgmname+"GridState"), null, "WWPGridState", "DataAnalysisPlatform");
         }
         ...
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV14OrderedDsc", AV14OrderedDsc);
         AV156GXV1 = 1;
         while ( AV156GXV1 <= AV11GridState.gxTpr_Filtervalues.Count )
         {
            AV12GridStateFilterValue = ((GeneXus.Programs.wwpbaseobjects.SdtWWPGridState_FilterValue)AV11GridState.gxTpr_Filtervalues.Item(AV156GXV1));
      ...
      protected void S142( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.savegridstate(context ).execute(  AV155Pgmname+"GridState",  AV11GridState.ToXml(false, true, "WWPGridState", "DataAnalysisPlatform")) ;
      }
      ...
      protected void S112( )
      {
         ...
         AV9TrnContext.gxTpr_Callerobject = AV155Pgmname;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?2020228159341", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("br_informationww.js", "?2020228159341", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
      ...
      protected void sendrow_322( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_32_idx <= subGrid_Recordsperpage( ) * 1 ) )
         {
            ...
            StyleString = "";
            AV126myupdate_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV126myupdate))&&String.IsNullOrEmpty(StringUtil.RTrim( AV152Myupdate_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV126myupdate)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV126myupdate)) ? AV152Myupdate_GXI : context.PathToRelativeUrl( AV126myupdate));
            ...
            ClassString = "ActionBaseColorAttribute";
            StyleString = "";
            AV141PatientReTenant_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV141PatientReTenant))&&String.IsNullOrEmpty(StringUtil.RTrim( AV153Patientretenant_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV141PatientReTenant)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV141PatientReTenant)) ? AV153Patientretenant_GXI : context.PathToRelativeUrl( AV141PatientReTenant));
            ...
            ClassString = "ActionBaseColorAttribute";
            StyleString = "";
            AV139Patient_Entity_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV139Patient_Entity))&&String.IsNullOrEmpty(StringUtil.RTrim( AV154Patient_entity_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV139Patient_Entity)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV139Patient_Entity)) ? AV154Patient_entity_GXI : context.PathToRelativeUrl( AV139Patient_Entity));
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'AV142IsAuthorized_PatientReTenant',fld:'vISAUTHORIZED_PATIENTRETENANT',pic:''},{av:'AV140IsAuthorized_Patient_Entity',fld:'vISAUTHORIZED_PATIENT_ENTITY',pic:''},{av:'AV6WWPContext',fld:'vWWPCONTEXT',pic:''},{av:'AV52ddo_BR_Information_PatientNoTitleControlIdToReplace',fld:'vDDO_BR_INFORMATION_PATIENTNOTITLECONTROLIDTOREPLACE',pic:''},{av:'AV17BR_Information_PatientNo',fld:'vBR_INFORMATION_PATIENTNO',pic:''},{av:'AV155Pgmname',fld:'vPGMNAME',pic:''},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'}]");
         setEventMetadata("REFRESH",",oparms:[{av:'AV49BR_Information_PatientNoTitleFilterData',fld:'vBR_INFORMATION_PATIENTNOTITLEFILTERDATA',pic:''},{av:'AV6WWPContext',fld:'vWWPCONTEXT',pic:''},{av:'edtBR_Information_PatientNo_Titleformat',ctrl:'BR_INFORMATION_PATIENTNO',prop:'Titleformat'},{av:'edtBR_Information_PatientNo_Title',ctrl:'BR_INFORMATION_PATIENTNO',prop:'Title'},{av:'AV93GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV147GridPageCount',fld:'vGRIDPAGECOUNT',pic:'ZZZZZZZZZ9'},{av:'edtavMyupdate_Visible',ctrl:'vMYUPDATE',prop:'Visible'},{av:'AV142IsAuthorized_PatientReTenant',fld:'vISAUTHORIZED_PATIENTRETENANT',pic:''},{av:'edtavPatientretenant_Visible',ctrl:'vPATIENTRETENANT',prop:'Visible'},{av:'AV140IsAuthorized_Patient_Entity',fld:'vISAUTHORIZED_PATIENT_ENTITY',pic:''},{av:'edtavPatient_entity_Visible',ctrl:'vPATIENT_ENTITY',prop:'Visible'},{ctrl:'BTNINSERT',prop:'Visible'}]}");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'E111G2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV17BR_Information_PatientNo',fld:'vBR_INFORMATION_PATIENTNO',pic:''},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV6WWPContext',fld:'vWWPCONTEXT',pic:''},{av:'AV52ddo_BR_Information_PatientNoTitleControlIdToReplace',fld:'vDDO_BR_INFORMATION_PATIENTNOTITLECONTROLIDTOREPLACE',pic:''},{av:'AV155Pgmname',fld:'vPGMNAME',pic:''},{av:'AV142IsAuthorized_PatientReTenant',fld:'vISAUTHORIZED_PATIENTRETENANT',pic:''},{av:'AV140IsAuthorized_Patient_Entity',fld:'vISAUTHORIZED_PATIENT_ENTITY',pic:''},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE",",oparms:[]}");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","{handler:'E121G2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV17BR_Information_PatientNo',fld:'vBR_INFORMATION_PATIENTNO',pic:''},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV6WWPContext',fld:'vWWPCONTEXT',pic:''},{av:'AV52ddo_BR_Information_PatientNoTitleControlIdToReplace',fld:'vDDO_BR_INFORMATION_PATIENTNOTITLECONTROLIDTOREPLACE',pic:''},{av:'AV155Pgmname',fld:'vPGMNAME',pic:''},{av:'AV142IsAuthorized_PatientReTenant',fld:'vISAUTHORIZED_PATIENTRETENANT',pic:''},{av:'AV140IsAuthorized_Patient_Entity',fld:'vISAUTHORIZED_PATIENT_ENTITY',pic:''},{av:'Gridpaginationbar_Rowsperpageselectedvalue',ctrl:'GRIDPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}]");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",",oparms:[{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'}]}");
         setEventMetadata("DDO_BR_INFORMATION_PATIENTNO.ONOPTIONCLICKED","{handler:'E131G2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV17BR_Information_PatientNo',fld:'vBR_INFORMATION_PATIENTNO',pic:''},{av:'AV13OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV14OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV6WWPContext',fld:'vWWPCONTEXT',pic:''},{av:'AV52ddo_BR_Information_PatientNoTitleControlIdToReplace',fld:'vDDO_BR_INFORMATION_PATIENTNOTITLECONTROLIDTOREPLACE',pic:''},{av:'AV155Pgmname',fld:'vPGMNAME',pic:''},{av:'AV142IsAuthorized_PatientReTenant',fld:'vISAUTHORIZED_PATIENTRETENANT',pic:''},{av:'AV140IsAuthorized_Patient_Entity',fld:'vISAUTHORIZED_PATIENT_ENTITY',pic:''},{av:'Ddo_br_information_patientno_Activeeventkey',ctrl:'DDO_BR_INFORMATION_PATIENTNO',prop:'ActiveEventKey'}]");
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         AV152Myupdate_GXI = "";
         AV153Patientretenant_GXI = "";
         AV154Patient_entity_GXI = "";
         scmdbuf = "";
         lV151BR_InformationWWDS_1_Br_information_patientno = "";
      ...
      private long AV147GridPageCount ;
      ...
      private String AV152Myupdate_GXI ;
      private String AV153Patientretenant_GXI ;
      private String AV154Patient_entity_GXI ;
      private String lV151BR_InformationWWDS_1_Br_information_patientno ;
      private String AV151BR_InformationWWDS_1_Br_information_patientno ;
   ...
   public class br_informationww__default : DataStoreHelperBase, IDataStoreHelper
   {
      protected Object[] conditional_H001G2( IGxContext context ,
                                             ...
                                             String AV151BR_InformationWWDS_1_Br_information_patientno ,
                                             ...
                                             bool AV14OrderedDsc )
      {
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV151BR_InformationWWDS_1_Br_information_patientno)) )
         {
            sWhereString = sWhereString + " and ([BR_Information_PatientNo] like '%' + @lV151BR_InformationWWDS_1_Br_information_patientno + '%')";
         }
         else
         {
            GXv_int5[0] = 1;
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@lV151BR_InformationWWDS_1_Br_information_patientno",SqlDbType.NVarChar,2000,0} ,
