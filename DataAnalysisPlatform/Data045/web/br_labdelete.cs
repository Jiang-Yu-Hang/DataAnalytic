/*
       ...
       Generated on: 2/28/2020 15:16:52.68
...
namespace GeneXus.Programs {
   public class br_labdelete : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202022815165276", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GXUtil.WriteLog("br_labdelete:[SendSecurityCheck value for]"+"GXV4:"+context.localUtil.Format( (decimal)(AV10BR_Lab.gxTpr_Br_lab_age), "ZZZ"));
         GXUtil.WriteLog("br_labdelete:[SendSecurityCheck value for]"+"GXV5:"+StringUtil.RTrim( context.localUtil.Format( AV10BR_Lab.gxTpr_Br_lab_diag, "")));
         GXUtil.WriteLog("br_labdelete:[SendSecurityCheck value for]"+"vSource:"+StringUtil.RTrim( context.localUtil.Format( AV11vSource, "")));
         GXUtil.WriteLog("br_labdelete:[SendSecurityCheck value for]"+"GXV6:"+StringUtil.RTrim( context.localUtil.Format( AV10BR_Lab.gxTpr_Br_lab_resultqual, "")));
         GXUtil.WriteLog("br_labdelete:[SendSecurityCheck value for]"+"GXV7:"+StringUtil.RTrim( context.localUtil.Format( AV10BR_Lab.gxTpr_Br_lab_resultunit, "")));
         GXUtil.WriteLog("br_labdelete:[SendSecurityCheck value for]"+"GXV8:"+StringUtil.RTrim( context.localUtil.Format( AV10BR_Lab.gxTpr_Br_lab_abnind, "")));
         GXUtil.WriteLog("br_labdelete:[SendSecurityCheck value for]"+"GXV9:"+StringUtil.RTrim( context.localUtil.Format( AV10BR_Lab.gxTpr_Br_lab_normrangelow, "")));
         GXUtil.WriteLog("br_labdelete:[SendSecurityCheck value for]"+"GXV10:"+StringUtil.RTrim( context.localUtil.Format( AV10BR_Lab.gxTpr_Br_lab_testmethod, "")));
         GXUtil.WriteLog("br_labdelete:[SendSecurityCheck value for]"+"GXV11:"+StringUtil.RTrim( context.localUtil.Format( AV10BR_Lab.gxTpr_Br_lab_instrumentcode, "")));
         GXUtil.WriteLog("br_labdelete:[SendSecurityCheck value for]"+"GXV12:"+StringUtil.RTrim( context.localUtil.Format( AV10BR_Lab.gxTpr_Br_lab_instrumentname, "")));
         GXUtil.WriteLog("br_labdelete:[SendSecurityCheck value for]"+"GXV13:"+StringUtil.RTrim( context.localUtil.Format( AV10BR_Lab.gxTpr_Br_lab_resultnum, "")));
      }
      ...
      protected void WB8R0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtavBr_lab_br_lab_testcode_Internalname, AV10BR_Lab.gxTpr_Br_lab_testcode, StringUtil.RTrim( context.localUtil.Format( AV10BR_Lab.gxTpr_Br_lab_testcode, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,34);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavBr_lab_br_lab_testcode_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavBr_lab_br_lab_testcode_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 1, -1, -1, true, "", "left", true, "HLP_BR_LabDelete.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            ...
            wb_table1_50_8R2( true) ;
         }
         else
         {
            wb_table1_50_8R2( false) ;
         }
         return  ;
      }

      protected void wb_table1_50_8R2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavVspecimendate_Internalname, context.localUtil.TToC( AV13vSpecimenDate, 10, 8, 0, 0, "/", ":", " "), context.localUtil.Format( AV13vSpecimenDate, "9999/99/99 99:99:99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'YMD',8,24,'chs',false,1);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,62);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavVspecimendate_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtavVspecimendate_Enabled, 0, "text", "", 19, "chr", 1, "row", 19, 0, 0, 0, 1, -1, 0, true, "DM_DataTime", "right", false, "HLP_BR_LabDelete.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtavBr_lab_br_encounterid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10BR_Lab.gxTpr_Br_encounterid), 18, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV10BR_Lab.gxTpr_Br_encounterid), "ZZZZZZZZZZZZZZZZZZ")), TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,118);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavBr_lab_br_encounterid_Jsonclick, 0, "Attribute", "", "", "", "", edtavBr_lab_br_encounterid_Visible, 1, 0, "number", "1", 18, "chr", 1, "row", 18, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_BR_LabDelete.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 119,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavBr_lab_br_information_patientno_Internalname, AV10BR_Lab.gxTpr_Br_information_patientno, StringUtil.RTrim( context.localUtil.Format( AV10BR_Lab.gxTpr_Br_information_patientno, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,119);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavBr_lab_br_information_patientno_Jsonclick, 0, "Attribute", "", "", "", "", edtavBr_lab_br_information_patientno_Visible, 1, 0, "text", "", 80, "chr", 1, "row", 2000, 0, 0, 0, 1, -1, -1, true, "", "left", true, "HLP_BR_LabDelete.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 120,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavBr_lab_br_labid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10BR_Lab.gxTpr_Br_labid), 18, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV10BR_Lab.gxTpr_Br_labid), "ZZZZZZZZZZZZZZZZZZ")), TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,120);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavBr_lab_br_labid_Jsonclick, 0, "Attribute", "", "", "", "", edtavBr_lab_br_labid_Visible, 1, 0, "number", "1", 18, "chr", 1, "row", 18, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_BR_LabDelete.htm");
            /* Single line edit */
            ...
            GxWebStd.gx_single_line_edit( context, edtavBr_lab_br_lab_testid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10BR_Lab.gxTpr_Br_lab_testid), 10, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV10BR_Lab.gxTpr_Br_lab_testid), "ZZZZZZZZZZ")), TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,122);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavBr_lab_br_lab_testid_Jsonclick, 0, "Attribute", "", "", "", "", edtavBr_lab_br_lab_testid_Visible, 1, 0, "number", "1", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_BR_LabDelete.htm");
            /* Single line edit */
      ...
      protected void STRUP8R0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            if ( ! GXUtil.CheckEncryptedHash( forbiddenHiddens, hsh, GXKey) )
            {
               ...
               GXUtil.WriteLog("br_labdelete:[SecurityCheckFailed value for]"+"GXV4:"+context.localUtil.Format( (decimal)(AV10BR_Lab.gxTpr_Br_lab_age), "ZZZ"));
               GXUtil.WriteLog("br_labdelete:[SecurityCheckFailed value for]"+"GXV5:"+StringUtil.RTrim( context.localUtil.Format( AV10BR_Lab.gxTpr_Br_lab_diag, "")));
               GXUtil.WriteLog("br_labdelete:[SecurityCheckFailed value for]"+"vSource:"+StringUtil.RTrim( context.localUtil.Format( AV11vSource, "")));
               GXUtil.WriteLog("br_labdelete:[SecurityCheckFailed value for]"+"GXV6:"+StringUtil.RTrim( context.localUtil.Format( AV10BR_Lab.gxTpr_Br_lab_resultqual, "")));
               GXUtil.WriteLog("br_labdelete:[SecurityCheckFailed value for]"+"GXV7:"+StringUtil.RTrim( context.localUtil.Format( AV10BR_Lab.gxTpr_Br_lab_resultunit, "")));
               GXUtil.WriteLog("br_labdelete:[SecurityCheckFailed value for]"+"GXV8:"+StringUtil.RTrim( context.localUtil.Format( AV10BR_Lab.gxTpr_Br_lab_abnind, "")));
               GXUtil.WriteLog("br_labdelete:[SecurityCheckFailed value for]"+"GXV9:"+StringUtil.RTrim( context.localUtil.Format( AV10BR_Lab.gxTpr_Br_lab_normrangelow, "")));
               GXUtil.WriteLog("br_labdelete:[SecurityCheckFailed value for]"+"GXV10:"+StringUtil.RTrim( context.localUtil.Format( AV10BR_Lab.gxTpr_Br_lab_testmethod, "")));
               GXUtil.WriteLog("br_labdelete:[SecurityCheckFailed value for]"+"GXV11:"+StringUtil.RTrim( context.localUtil.Format( AV10BR_Lab.gxTpr_Br_lab_instrumentcode, "")));
               GXUtil.WriteLog("br_labdelete:[SecurityCheckFailed value for]"+"GXV12:"+StringUtil.RTrim( context.localUtil.Format( AV10BR_Lab.gxTpr_Br_lab_instrumentname, "")));
               GXUtil.WriteLog("br_labdelete:[SecurityCheckFailed value for]"+"GXV13:"+StringUtil.RTrim( context.localUtil.Format( AV10BR_Lab.gxTpr_Br_lab_resultnum, "")));
               GxWebError = 1;
      ...
      protected void S112( )
      {
         ...
         AV41GXV20 = 1;
         while ( AV41GXV20 <= AV8Messages.Count )
         {
            AV7Message = ((SdtMessages_Message)AV8Messages.Item(AV41GXV20));
            GX_msglist.addItem(AV7Message.gxTpr_Description);
            AV41GXV20 = (int)(AV41GXV20+1);
         }
      }
      ...
      protected void wb_table1_50_8R2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, dynavVsource, dynavVsource_Internalname, StringUtil.RTrim( AV11vSource), 1, dynavVsource_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "svchar", "", 1, dynavVsource.Enabled, 0, 0, 0, "em", 0, "", "", "ReadonlyAttribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,54);\"", "", true, "HLP_BR_LabDelete.htm");
            dynavVsource.CurrentValue = StringUtil.RTrim( AV11vSource);
            ...
            wb_table1_50_8R2e( true) ;
         }
         else
         {
            wb_table1_50_8R2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202022815165543", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("br_labdelete.js", "?202022815165543", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false);
