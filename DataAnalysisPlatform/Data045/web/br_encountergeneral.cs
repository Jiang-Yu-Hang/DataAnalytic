/*
       ...
       Generated on: 2/28/2020 15:6:44.5
   ...
   public class br_encountergeneral : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV23Pgmname = "BR_EncounterGeneral";
               context.Gx_err = 0;
               ...
               context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtavVdepartmentadm_Internalname, "Enabled", StringUtil.LTrim( StringUtil.Str( (decimal)(edtavVdepartmentadm_Enabled), 5, 0)), true);
               edtavVdepartmentdisch_Enabled = 0;
               context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtavVdepartmentdisch_Internalname, "Enabled", StringUtil.LTrim( StringUtil.Str( (decimal)(edtavVdepartmentdisch_Enabled), 5, 0)), true);
               ...
               context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtavVinsurance_Internalname, "Enabled", StringUtil.LTrim( StringUtil.Str( (decimal)(edtavVinsurance_Enabled), 5, 0)), true);
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20202281564416", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void RenderHtmlCloseForm162( )
      {
         ...
         {
            context.AddJavascriptSource("br_encountergeneral.js", "?20202281564422", false);
         }
      ...
      protected void wb_table1_26_162e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-3 MergeLabelCell", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockbr_encounter_departmentadm_Internalname, "就诊入院科室", "", "", lblTextblockbr_encounter_departmentadm_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, "HLP_BR_EncounterGeneral.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-9", "left", "top", "", "", "div");
      ...
      protected void wb_table2_40_162e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-3 MergeLabelCell", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockbr_encounter_departmentdisch_Internalname, "就诊出院科室", "", "", lblTextblockbr_encounter_departmentdisch_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, "HLP_BR_EncounterGeneral.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-9", "left", "top", "", "", "div");
            wb_table3_55_162( true) ;
         }
         else
         {
            wb_table3_55_162( false) ;
         }
         return  ;
      }

      protected void wb_table3_55_162e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-9", "left", "top", "", "", "div");
            wb_table4_69_162( true) ;
         }
         else
         {
            wb_table4_69_162( false) ;
         }
         return  ;
      }

      protected void wb_table4_69_162e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-3 MergeLabelCell", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockbr_encounter_insurance_Internalname, "就诊保险类型", "", "", lblTextblockbr_encounter_insurance_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, "HLP_BR_EncounterGeneral.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-9", "left", "top", "", "", "div");
            wb_table5_84_162( true) ;
         }
         else
         {
            wb_table5_84_162( false) ;
         }
         return  ;
      }

      protected void wb_table5_84_162e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-9", "left", "top", "", "", "div");
            wb_table6_103_162( true) ;
         }
         else
         {
            wb_table6_103_162( false) ;
         }
         return  ;
      }

      protected void wb_table6_103_162e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void RF162( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            while ( (pr_default.getStatus(0) != 101) )
            {
               ...
               A574BR_Encounter_Insurance = H00162_A574BR_Encounter_Insurance[0];
               context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "A574BR_Encounter_Insurance", A574BR_Encounter_Insurance);
               n574BR_Encounter_Insurance = H00162_n574BR_Encounter_Insurance[0];
               ...
               A572BR_Encounter_Departmentdisch = H00162_A572BR_Encounter_Departmentdisch[0];
               context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "A572BR_Encounter_Departmentdisch", A572BR_Encounter_Departmentdisch);
               n572BR_Encounter_Departmentdisch = H00162_n572BR_Encounter_Departmentdisch[0];
               A570BR_Encounter_Departmentadm = H00162_A570BR_Encounter_Departmentadm[0];
               context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "A570BR_Encounter_Departmentadm", A570BR_Encounter_Departmentadm);
               n570BR_Encounter_Departmentadm = H00162_n570BR_Encounter_Departmentadm[0];
      ...
      protected void STRUP160( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "A570BR_Encounter_Departmentadm", A570BR_Encounter_Departmentadm);
            AV18vDepartmentadm = cgiGet( edtavVdepartmentadm_Internalname);
            context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "AV18vDepartmentadm", AV18vDepartmentadm);
            ...
            context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "A572BR_Encounter_Departmentdisch", A572BR_Encounter_Departmentdisch);
            AV20vDepartmentdisch = cgiGet( edtavVdepartmentdisch_Internalname);
            context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "AV20vDepartmentdisch", AV20vDepartmentdisch);
            ...
            A574BR_Encounter_Insurance = cgiGet( edtBR_Encounter_Insurance_Internalname);
            n574BR_Encounter_Insurance = false;
            context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "A574BR_Encounter_Insurance", A574BR_Encounter_Insurance);
            AV19vInsurance = cgiGet( edtavVinsurance_Internalname);
            context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "AV19vInsurance", AV19vInsurance);
      ...
      protected void E14162( )
      {
         ...
         if ( ! ( ( StringUtil.StrCmp(A84BR_Encounter_Department, "其它") == 0 ) ) )
         {
            ...
            context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtavVdepartmentadm_Internalname, "Visible", StringUtil.LTrim( StringUtil.Str( (decimal)(edtavVdepartmentadm_Visible), 5, 0)), true);
            cellVdepartmentadm_cell_Class = "Invisible";
            context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, cellVdepartmentadm_cell_Internalname, "Class", cellVdepartmentadm_cell_Class, true);
         }
         else
         {
      ...
      protected void wb_table6_103_162( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
      ...
      protected void wb_table5_84_162( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "left", "top", "", "", "div");
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtBR_Encounter_Insurance_Internalname, "就诊保险类型", "col-sm-3 ReadonlyAttributeLabel", 0, true);
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtBR_Encounter_Insurance_Internalname, A574BR_Encounter_Insurance, StringUtil.RTrim( context.localUtil.Format( A574BR_Encounter_Insurance, "")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtBR_Encounter_Insurance_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtBR_Encounter_Insurance_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 1, -1, -1, true, "", "left", true, "HLP_BR_EncounterGeneral.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            context.WriteHtmlText( "</td>") ;
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "left", "top", "", "", "div");
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavVinsurance_Internalname, "v Insurance", "col-sm-3 ReadonlyAttributeLabel", 0, true);
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 91,'" + sPrefix + "',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavVinsurance_Internalname, AV19vInsurance, StringUtil.RTrim( context.localUtil.Format( AV19vInsurance, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,91);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "请填写其保险类型", edtavVinsurance_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtavVinsurance_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 1, -1, -1, true, "", "left", true, "HLP_BR_EncounterGeneral.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table5_84_162e( true) ;
         }
         else
         {
            wb_table5_84_162e( false) ;
         }
      }

      protected void wb_table4_69_162( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            GxWebStd.gx_single_line_edit( context, edtavVenctype_Internalname, AV16vENCType, StringUtil.RTrim( context.localUtil.Format( AV16vENCType, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,76);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "请填写其它就诊方式", edtavVenctype_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", edtavVenctype_Visible, edtavVenctype_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 1, -1, -1, true, "", "left", true, "HLP_BR_EncounterGeneral.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table4_69_162e( true) ;
         }
         else
         {
            wb_table4_69_162e( false) ;
         }
      }

      protected void wb_table3_55_162( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "left", "top", "", "", "div");
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtBR_Encounter_Departmentdisch_Internalname, "就诊出院科室", "col-sm-3 ReadonlyAttributeLabel", 0, true);
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtBR_Encounter_Departmentdisch_Internalname, A572BR_Encounter_Departmentdisch, StringUtil.RTrim( context.localUtil.Format( A572BR_Encounter_Departmentdisch, "")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtBR_Encounter_Departmentdisch_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtBR_Encounter_Departmentdisch_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 1, -1, -1, true, "", "left", true, "HLP_BR_EncounterGeneral.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td class='DataContentCell'>") ;
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "left", "top", "", "", "div");
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavVdepartmentdisch_Internalname, "v Departmentdisch", "col-sm-3 ReadonlyAttributeLabel", 0, true);
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 62,'" + sPrefix + "',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavVdepartmentdisch_Internalname, AV20vDepartmentdisch, StringUtil.RTrim( context.localUtil.Format( AV20vDepartmentdisch, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,62);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "请填写其他出院科室", edtavVdepartmentdisch_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtavVdepartmentdisch_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 1, -1, -1, true, "", "left", true, "HLP_BR_EncounterGeneral.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table3_55_162e( true) ;
         }
         else
         {
            wb_table3_55_162e( false) ;
         }
      }
      ...
      protected void wb_table2_40_162( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "left", "top", "", "", "div");
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtBR_Encounter_Departmentadm_Internalname, "就诊入院科室", "col-sm-3 ReadonlyAttributeLabel", 0, true);
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtBR_Encounter_Departmentadm_Internalname, A570BR_Encounter_Departmentadm, StringUtil.RTrim( context.localUtil.Format( A570BR_Encounter_Departmentadm, "")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtBR_Encounter_Departmentadm_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtBR_Encounter_Departmentadm_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 1, -1, -1, true, "", "left", true, "HLP_BR_EncounterGeneral.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            context.WriteHtmlText( "</td>") ;
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "left", "top", "", "", "div");
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavVdepartmentadm_Internalname, "v Departmentadm", "col-sm-3 ReadonlyAttributeLabel", 0, true);
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 47,'" + sPrefix + "',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavVdepartmentadm_Internalname, AV18vDepartmentadm, StringUtil.RTrim( context.localUtil.Format( AV18vDepartmentadm, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,47);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "请填写其他入院科室", edtavVdepartmentadm_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", edtavVdepartmentadm_Visible, edtavVdepartmentadm_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 1, -1, -1, true, "", "left", true, "HLP_BR_EncounterGeneral.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?20202281564678", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("br_encountergeneral.js", "?20202281564678", false);
      ...
      protected void init_default_properties( )
      {
         ...
         lblTextblockbr_encounter_departmentadm_Internalname = sPrefix+"TEXTBLOCKBR_ENCOUNTER_DEPARTMENTADM";
         edtBR_Encounter_Departmentadm_Internalname = sPrefix+"BR_ENCOUNTER_DEPARTMENTADM";
         edtavVdepartmentadm_Internalname = sPrefix+"vVDEPARTMENTADM";
         cellVdepartmentadm_cell_Internalname = sPrefix+"VDEPARTMENTADM_CELL";
         tblTablemergedbr_encounter_departmentadm_Internalname = sPrefix+"TABLEMERGEDBR_ENCOUNTER_DEPARTMENTADM";
         divTablesplittedbr_encounter_departmentadm_Internalname = sPrefix+"TABLESPLITTEDBR_ENCOUNTER_DEPARTMENTADM";
         lblTextblockbr_encounter_departmentdisch_Internalname = sPrefix+"TEXTBLOCKBR_ENCOUNTER_DEPARTMENTDISCH";
         edtBR_Encounter_Departmentdisch_Internalname = sPrefix+"BR_ENCOUNTER_DEPARTMENTDISCH";
         edtavVdepartmentdisch_Internalname = sPrefix+"vVDEPARTMENTDISCH";
         tblTablemergedbr_encounter_departmentdisch_Internalname = sPrefix+"TABLEMERGEDBR_ENCOUNTER_DEPARTMENTDISCH";
         divTablesplittedbr_encounter_departmentdisch_Internalname = sPrefix+"TABLESPLITTEDBR_ENCOUNTER_DEPARTMENTDISCH";
         ...
         lblTextblockbr_encounter_insurance_Internalname = sPrefix+"TEXTBLOCKBR_ENCOUNTER_INSURANCE";
         edtBR_Encounter_Insurance_Internalname = sPrefix+"BR_ENCOUNTER_INSURANCE";
         edtavVinsurance_Internalname = sPrefix+"vVINSURANCE";
         tblTablemergedbr_encounter_insurance_Internalname = sPrefix+"TABLEMERGEDBR_ENCOUNTER_INSURANCE";
         divTablesplittedbr_encounter_insurance_Internalname = sPrefix+"TABLESPLITTEDBR_ENCOUNTER_INSURANCE";
      ...
      public override void initialize_properties( )
      {
         ...
         edtBR_Encounter_Insurance_Jsonclick = "";
         edtBR_Encounter_Insurance_Enabled = 0;
      ...
      public override void initialize( )
      {
         ...
         H00162_A574BR_Encounter_Insurance = new String[] {""} ;
         H00162_n574BR_Encounter_Insurance = new bool[] {false} ;
         H00162_A90BR_Encounter_ENCType = new String[] {""} ;
         H00162_n90BR_Encounter_ENCType = new bool[] {false} ;
         H00162_A572BR_Encounter_Departmentdisch = new String[] {""} ;
         H00162_n572BR_Encounter_Departmentdisch = new bool[] {false} ;
         H00162_A570BR_Encounter_Departmentadm = new String[] {""} ;
         H00162_n570BR_Encounter_Departmentadm = new bool[] {false} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.br_encountergeneral__default(),
            new Object[][] {
               ...
               H00162_n91BR_Encounter_AdmitDate, H00162_A574BR_Encounter_Insurance, H00162_n574BR_Encounter_Insurance, H00162_A90BR_Encounter_ENCType, H00162_n90BR_Encounter_ENCType, H00162_A572BR_Encounter_Departmentdisch, H00162_n572BR_Encounter_Departmentdisch, H00162_A570BR_Encounter_Departmentadm, H00162_n570BR_Encounter_Departmentadm, H00162_A84BR_Encounter_Department,
               H00162_n84BR_Encounter_Department, H00162_A36BR_Information_PatientNo, H00162_n36BR_Information_PatientNo, H00162_A85BR_Information_ID, H00162_n85BR_Information_ID
               }
            }
         );
         AV23Pgmname = "BR_EncounterGeneral";
      ...
      private int edtBR_Encounter_Insurance_Enabled ;
      private int edtBR_Encounter_ENCType_Enabled ;
      private int edtBR_Encounter_Departmentdisch_Enabled ;
      private int edtBR_Encounter_Departmentadm_Enabled ;
      ...
      private String edtBR_Encounter_Insurance_Internalname ;
      ...
      private String edtBR_Encounter_Insurance_Jsonclick ;
      ...
      private String AV18vDepartmentadm ;
      private String AV20vDepartmentdisch ;
      private String AV16vENCType ;
      private String AV19vInsurance ;
      ...
      private String[] H00162_A574BR_Encounter_Insurance ;
      private bool[] H00162_n574BR_Encounter_Insurance ;
      private String[] H00162_A90BR_Encounter_ENCType ;
      private bool[] H00162_n90BR_Encounter_ENCType ;
      private String[] H00162_A572BR_Encounter_Departmentdisch ;
      private bool[] H00162_n572BR_Encounter_Departmentdisch ;
      private String[] H00162_A570BR_Encounter_Departmentadm ;
      private bool[] H00162_n570BR_Encounter_Departmentadm ;
   ...
   public class br_encountergeneral__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H00162", "SELECT T1.[BR_EncounterID], T1.[BR_Encounter_UpdUser], T1.[BR_Encounter_CrtUser], T1.[BR_Encounter_UpdDate], T1.[BR_Encounter_CrtDate], T1.[BR_Encounter_Status], T1.[BR_Encounter_EncID], T1.[BR_Encounter_DischargeStatus], T1.[BR_Encounter_DischargeDate], T1.[BR_Encounter_AdmitSource], T1.[BR_Encounter_AdmitDate], T1.[BR_Encounter_Insurance], T1.[BR_Encounter_ENCType], T1.[BR_Encounter_Departmentdisch], T1.[BR_Encounter_Departmentadm], T1.[BR_Encounter_Department], T2.[BR_Information_PatientNo], T1.[BR_Information_ID] FROM ([BR_Encounter] T1 WITH (NOLOCK) LEFT JOIN [BR_Information] T2 WITH (NOLOCK) ON T2.[BR_Information_ID] = T1.[BR_Information_ID]) WHERE T1.[BR_EncounterID] = @BR_EncounterID ORDER BY T1.[BR_EncounterID] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00162,1,0,true,true )
          };
       }
    }
