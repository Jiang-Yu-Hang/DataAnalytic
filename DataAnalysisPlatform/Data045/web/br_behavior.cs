/*
       ...
       Generated on: 2/28/2020 15:6:31.50
...
namespace GeneXus.Programs {
   public class br_behavior : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void CheckExtendedTable089( )
      {
         ...
         {
            GX_msglist.addItem("域是否有家族肿瘤史超界", "OutOfRange", 1, "BR_BEHAVIOR_FAMILYCAHISTORY");
            AnyError = 1;
         ...
         {
            GX_msglist.addItem("域是否绝经超界", "OutOfRange", 1, "BR_BEHAVIOR_MENOPAUSE");
            AnyError = 1;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20202281563524", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?20202281563568", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("br_behavior.js", "?20202281563568", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false);
