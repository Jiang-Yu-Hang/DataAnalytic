/*
       ...
       Generated on: 2/28/2020 15:9:3.49
   ...
   public class view_new_encounter : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void Draw( )
      {
         ...
         if ( ! GxWebStd.gx_redirect( context) )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtview_NE_AdmitDate_Internalname, context.localUtil.TToC( A552view_NE_AdmitDate, 10, 8, 0, 0, "/", ":", " "), context.localUtil.Format( A552view_NE_AdmitDate, "9999/99/99 99:99:99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'YMD',8,24,'chs',false,1);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,43);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtview_NE_AdmitDate_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtview_NE_AdmitDate_Enabled, 0, "text", "", 19, "chr", 1, "row", 19, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_View_New_Encounter.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "form-group gx-form-group", "left", "top", ""+" data-gx-for=\""+edtview_NE_Status_Internalname+"\"", "", "div");
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtview_NE_Status_Internalname, "view_NE_Status", "col-sm-3 AttributeLabel", 1, true);
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 48,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtview_NE_Status_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A553view_NE_Status), 4, 0, ".", "")), ((edtview_NE_Status_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(A553view_NE_Status), "ZZZ9")) : context.localUtil.Format( (decimal)(A553view_NE_Status), "ZZZ9")), TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,48);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtview_NE_Status_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtview_NE_Status_Enabled, 0, "number", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_View_New_Encounter.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "form-group gx-form-group", "left", "top", ""+" data-gx-for=\""+edtview_NE_IsRandRecheck_Internalname+"\"", "", "div");
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtview_NE_IsRandRecheck_Internalname, "view_NE_Is Rand Recheck", "col-sm-3 AttributeLabel", 1, true);
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 53,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtview_NE_IsRandRecheck_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A554view_NE_IsRandRecheck), 1, 0, ".", "")), ((edtview_NE_IsRandRecheck_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(A554view_NE_IsRandRecheck), "9")) : context.localUtil.Format( (decimal)(A554view_NE_IsRandRecheck), "9")), TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,53);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtview_NE_IsRandRecheck_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtview_NE_IsRandRecheck_Enabled, 0, "number", "1", 1, "chr", 1, "row", 1, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_View_New_Encounter.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "form-group gx-form-group", "left", "top", ""+" data-gx-for=\""+edtview_NE_IsRandApprove_Internalname+"\"", "", "div");
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtview_NE_IsRandApprove_Internalname, "view_NE_Is Rand Approve", "col-sm-3 AttributeLabel", 1, true);
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 58,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtview_NE_IsRandApprove_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A555view_NE_IsRandApprove), 1, 0, ".", "")), ((edtview_NE_IsRandApprove_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(A555view_NE_IsRandApprove), "9")) : context.localUtil.Format( (decimal)(A555view_NE_IsRandApprove), "9")), TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,58);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtview_NE_IsRandApprove_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtview_NE_IsRandApprove_Enabled, 0, "number", "1", 1, "chr", 1, "row", 1, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_View_New_Encounter.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "form-group gx-form-group", "left", "top", ""+" data-gx-for=\""+edtview_NE_IsUpdate_Internalname+"\"", "", "div");
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtview_NE_IsUpdate_Internalname, "view_NE_Is Update", "col-sm-3 AttributeLabel", 1, true);
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 63,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtview_NE_IsUpdate_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A556view_NE_IsUpdate), 1, 0, ".", "")), ((edtview_NE_IsUpdate_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(A556view_NE_IsUpdate), "9")) : context.localUtil.Format( (decimal)(A556view_NE_IsUpdate), "9")), TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,63);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtview_NE_IsUpdate_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtview_NE_IsUpdate_Enabled, 0, "number", "1", 1, "chr", 1, "row", 1, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_View_New_Encounter.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void standaloneStartupServer( )
      {
         ...
         if ( AnyError == 0 )
         {
            if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
            {
               ...
               if ( context.localUtil.VCDateTime( cgiGet( edtview_NE_AdmitDate_Internalname), 0, 0) == 0 )
               {
                  GX_msglist.addItem(context.GetMessage( "GXM_baddatetime", new   object[]  {"view_NE_Admit Date"}), 1, "VIEW_NE_ADMITDATE");
                  AnyError = 1;
                  ...
                  context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A552view_NE_AdmitDate", context.localUtil.TToC( A552view_NE_AdmitDate, 10, 8, 0, 0, "/", ":", " "));
               }
               else
               {
               ...
               if ( ( ( context.localUtil.CToN( cgiGet( edtview_NE_Status_Internalname), ".", ",") < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtview_NE_Status_Internalname), ".", ",") > Convert.ToDecimal( 9999 )) ) )
               {
                  GX_msglist.addItem(context.GetMessage( "GXM_badnum", ""), 1, "VIEW_NE_STATUS");
                  AnyError = 1;
                  GX_FocusControl = edtview_NE_Status_Internalname;
                  context.httpAjaxContext.ajax_rsp_assign_attri("", false, "GX_FocusControl", GX_FocusControl);
                  wbErr = true;
               ...
               if ( ( ( context.localUtil.CToN( cgiGet( edtview_NE_IsRandRecheck_Internalname), ".", ",") < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtview_NE_IsRandRecheck_Internalname), ".", ",") > Convert.ToDecimal( 9 )) ) )
               {
                  GX_msglist.addItem(context.GetMessage( "GXM_badnum", ""), 1, "VIEW_NE_ISRANDRECHECK");
                  AnyError = 1;
                  GX_FocusControl = edtview_NE_IsRandRecheck_Internalname;
                  context.httpAjaxContext.ajax_rsp_assign_attri("", false, "GX_FocusControl", GX_FocusControl);
                  wbErr = true;
                  A554view_NE_IsRandRecheck = 0;
                  n554view_NE_IsRandRecheck = false;
                  context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A554view_NE_IsRandRecheck", StringUtil.Str( (decimal)(A554view_NE_IsRandRecheck), 1, 0));
               }
               else
               {
               ...
               n554view_NE_IsRandRecheck = ((0==A554view_NE_IsRandRecheck) ? true : false);
               if ( ( ( context.localUtil.CToN( cgiGet( edtview_NE_IsRandApprove_Internalname), ".", ",") < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtview_NE_IsRandApprove_Internalname), ".", ",") > Convert.ToDecimal( 9 )) ) )
               {
                  GX_msglist.addItem(context.GetMessage( "GXM_badnum", ""), 1, "VIEW_NE_ISRANDAPPROVE");
                  AnyError = 1;
                  GX_FocusControl = edtview_NE_IsRandApprove_Internalname;
                  context.httpAjaxContext.ajax_rsp_assign_attri("", false, "GX_FocusControl", GX_FocusControl);
                  wbErr = true;
                  A555view_NE_IsRandApprove = 0;
                  n555view_NE_IsRandApprove = false;
                  context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A555view_NE_IsRandApprove", StringUtil.Str( (decimal)(A555view_NE_IsRandApprove), 1, 0));
               }
               else
               {
               ...
               n555view_NE_IsRandApprove = ((0==A555view_NE_IsRandApprove) ? true : false);
               if ( ( ( context.localUtil.CToN( cgiGet( edtview_NE_IsUpdate_Internalname), ".", ",") < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtview_NE_IsUpdate_Internalname), ".", ",") > Convert.ToDecimal( 9 )) ) )
               {
                  GX_msglist.addItem(context.GetMessage( "GXM_badnum", ""), 1, "VIEW_NE_ISUPDATE");
                  AnyError = 1;
                  GX_FocusControl = edtview_NE_IsUpdate_Internalname;
                  context.httpAjaxContext.ajax_rsp_assign_attri("", false, "GX_FocusControl", GX_FocusControl);
                  wbErr = true;
                  A556view_NE_IsUpdate = 0;
                  n556view_NE_IsUpdate = false;
                  context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A556view_NE_IsUpdate", StringUtil.Str( (decimal)(A556view_NE_IsUpdate), 1, 0));
               }
               else
               {
               ...
               n556view_NE_IsUpdate = ((0==A556view_NE_IsUpdate) ? true : false);
               ...
               n551view_NE_ENCType = (String.IsNullOrEmpty(StringUtil.RTrim( A551view_NE_ENCType)) ? true : false);
               Z552view_NE_AdmitDate = context.localUtil.CToT( cgiGet( "Z552view_NE_AdmitDate"), 0);
               n552view_NE_AdmitDate = ((DateTime.MinValue==A552view_NE_AdmitDate) ? true : false);
               Z553view_NE_Status = (short)(context.localUtil.CToN( cgiGet( "Z553view_NE_Status"), ".", ","));
               n553view_NE_Status = ((0==A553view_NE_Status) ? true : false);
               Z554view_NE_IsRandRecheck = (short)(context.localUtil.CToN( cgiGet( "Z554view_NE_IsRandRecheck"), ".", ","));
               n554view_NE_IsRandRecheck = ((0==A554view_NE_IsRandRecheck) ? true : false);
               Z555view_NE_IsRandApprove = (short)(context.localUtil.CToN( cgiGet( "Z555view_NE_IsRandApprove"), ".", ","));
               n555view_NE_IsRandApprove = ((0==A555view_NE_IsRandApprove) ? true : false);
               Z556view_NE_IsUpdate = (short)(context.localUtil.CToN( cgiGet( "Z556view_NE_IsUpdate"), ".", ","));
               n556view_NE_IsUpdate = ((0==A556view_NE_IsUpdate) ? true : false);
      ...
      protected void CheckExtendedTable1Q72( )
      {
         Gx_BScreen = 1;
         standaloneModal( ) ;
         if ( ! ( (DateTime.MinValue==A552view_NE_AdmitDate) || ( A552view_NE_AdmitDate >= context.localUtil.YMDHMSToT( 1753, 1, 1, 0, 0, 0) ) ) )
         {
      ...
      protected void CheckOptimisticConcurrency1Q72( )
      {
         if ( StringUtil.StrCmp(Gx_mode, "INS") != 0 )
         {
            ...
            {
               GX_msglist.addItem(context.GetMessage( "GXM_lock", new   object[]  {"View_New_Encounter1"}), "RecordIsLocked", 1, "");
               AnyError = 1;
               return  ;
            }
            Gx_longc = false;
            ...
            if ( Gx_longc || ( Z555view_NE_IsRandApprove != T001Q2_A555view_NE_IsRandApprove[0] ) || ( Z556view_NE_IsUpdate != T001Q2_A556view_NE_IsUpdate[0] ) || ( StringUtil.StrCmp(Z557view_NE_TenantTenantCode, T001Q2_A557view_NE_TenantTenantCode[0]) != 0 ) || ( Z558view_NE_Information_ID != T001Q2_A558view_NE_Information_ID[0] ) || ( StringUtil.StrCmp(Z559view_NE_Information_PatientNo, T001Q2_A559view_NE_Information_PatientNo[0]) != 0 ) )
            {
               ...
               GX_msglist.addItem(context.GetMessage( "GXM_waschg", new   object[]  {"View_New_Encounter1"}), "RecordWasChanged", 1, "");
               AnyError = 1;
               return  ;
            }
         }
            ...
            if ( AnyError == 0 )
            {
               ...
               if ( AnyError == 0 )
               {
                  ...
                  if ( AnyError == 0 )
                  {
                     ...
                     pr_default.close(6);
                     dsDefault.SmartCacheProvider.SetUpdated("View_New_Encounter1") ;
      ...
      protected void DisableAttributes1Q72( )
      {
         ...
         edtview_NE_Status_Enabled = 0;
         context.httpAjaxContext.ajax_rsp_assign_prop("", false, edtview_NE_Status_Internalname, "Enabled", StringUtil.LTrim( StringUtil.Str( (decimal)(edtview_NE_Status_Enabled), 5, 0)), true);
         edtview_NE_IsRandRecheck_Enabled = 0;
         context.httpAjaxContext.ajax_rsp_assign_prop("", false, edtview_NE_IsRandRecheck_Internalname, "Enabled", StringUtil.LTrim( StringUtil.Str( (decimal)(edtview_NE_IsRandRecheck_Enabled), 5, 0)), true);
         edtview_NE_IsRandApprove_Enabled = 0;
         context.httpAjaxContext.ajax_rsp_assign_prop("", false, edtview_NE_IsRandApprove_Internalname, "Enabled", StringUtil.LTrim( StringUtil.Str( (decimal)(edtview_NE_IsRandApprove_Enabled), 5, 0)), true);
         edtview_NE_IsUpdate_Enabled = 0;
         context.httpAjaxContext.ajax_rsp_assign_prop("", false, edtview_NE_IsUpdate_Internalname, "Enabled", StringUtil.LTrim( StringUtil.Str( (decimal)(edtview_NE_IsUpdate_Enabled), 5, 0)), true);
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2020228159481", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "Z552view_NE_AdmitDate", context.localUtil.TToC( Z552view_NE_AdmitDate, 10, 8, 0, 0, "/", ":", " "));
         GxWebStd.gx_hidden_field( context, "Z553view_NE_Status", StringUtil.LTrim( StringUtil.NToC( (decimal)(Z553view_NE_Status), 4, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "Z554view_NE_IsRandRecheck", StringUtil.LTrim( StringUtil.NToC( (decimal)(Z554view_NE_IsRandRecheck), 1, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "Z555view_NE_IsRandApprove", StringUtil.LTrim( StringUtil.NToC( (decimal)(Z555view_NE_IsRandApprove), 1, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "Z556view_NE_IsUpdate", StringUtil.LTrim( StringUtil.NToC( (decimal)(Z556view_NE_IsUpdate), 1, 0, ".", "")));
      ...
      protected void InitializeNonKey1Q72( )
      {
         ...
         Z551view_NE_ENCType = "";
         Z552view_NE_AdmitDate = (DateTime)(DateTime.MinValue);
         Z553view_NE_Status = 0;
         Z554view_NE_IsRandRecheck = 0;
         Z555view_NE_IsRandApprove = 0;
         Z556view_NE_IsUpdate = 0;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?2020228159488", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("view_new_encounter.js", "?2020228159489", false);
      ...
      public override void initialize_properties( )
      {
         ...
         edtview_NE_IsUpdate_Enabled = 1;
         edtview_NE_IsRandApprove_Jsonclick = "";
         edtview_NE_IsRandApprove_Enabled = 1;
         edtview_NE_IsRandRecheck_Jsonclick = "";
         edtview_NE_IsRandRecheck_Enabled = 1;
         edtview_NE_Status_Jsonclick = "";
         edtview_NE_Status_Enabled = 1;
                                             ...
                                             String GX_Parm11 )
      {
         ...
         isValidOutput.Add(context.localUtil.TToC( A552view_NE_AdmitDate, 10, 8, 0, 0, "/", ":", " "));
         isValidOutput.Add(StringUtil.LTrim( StringUtil.NToC( (decimal)(A553view_NE_Status), 4, 0, ".", "")));
         isValidOutput.Add(StringUtil.LTrim( StringUtil.NToC( (decimal)(A554view_NE_IsRandRecheck), 1, 0, ".", "")));
         isValidOutput.Add(StringUtil.LTrim( StringUtil.NToC( (decimal)(A555view_NE_IsRandApprove), 1, 0, ".", "")));
         isValidOutput.Add(StringUtil.LTrim( StringUtil.NToC( (decimal)(A556view_NE_IsUpdate), 1, 0, ".", "")));
         ...
         isValidOutput.Add(context.localUtil.TToC( Z552view_NE_AdmitDate, 10, 8, 0, 0, "/", ":", " "));
         isValidOutput.Add(StringUtil.LTrim( StringUtil.NToC( (decimal)(Z553view_NE_Status), 4, 0, ".", "")));
         isValidOutput.Add(StringUtil.LTrim( StringUtil.NToC( (decimal)(Z554view_NE_IsRandRecheck), 1, 0, ".", "")));
         isValidOutput.Add(StringUtil.LTrim( StringUtil.NToC( (decimal)(Z555view_NE_IsRandApprove), 1, 0, ".", "")));
         isValidOutput.Add(StringUtil.LTrim( StringUtil.NToC( (decimal)(Z556view_NE_IsUpdate), 1, 0, ".", "")));
      ...
      public override void initialize( )
      {
         ...
         T001Q4_A554view_NE_IsRandRecheck = new short[1] ;
         T001Q4_n554view_NE_IsRandRecheck = new bool[] {false} ;
         T001Q4_A555view_NE_IsRandApprove = new short[1] ;
         T001Q4_n555view_NE_IsRandApprove = new bool[] {false} ;
         T001Q4_A556view_NE_IsUpdate = new short[1] ;
         ...
         T001Q3_A554view_NE_IsRandRecheck = new short[1] ;
         T001Q3_n554view_NE_IsRandRecheck = new bool[] {false} ;
         T001Q3_A555view_NE_IsRandApprove = new short[1] ;
         T001Q3_n555view_NE_IsRandApprove = new bool[] {false} ;
         T001Q3_A556view_NE_IsUpdate = new short[1] ;
         ...
         T001Q2_A554view_NE_IsRandRecheck = new short[1] ;
         T001Q2_n554view_NE_IsRandRecheck = new bool[] {false} ;
         T001Q2_A555view_NE_IsRandApprove = new short[1] ;
         T001Q2_n555view_NE_IsRandApprove = new bool[] {false} ;
         T001Q2_A556view_NE_IsUpdate = new short[1] ;
      ...
      private short Z554view_NE_IsRandRecheck ;
      private short Z555view_NE_IsRandApprove ;
      private short Z556view_NE_IsUpdate ;
      ...
      private int edtview_NE_Status_Enabled ;
      private int edtview_NE_IsRandRecheck_Enabled ;
      private int edtview_NE_IsRandApprove_Enabled ;
      private int edtview_NE_IsUpdate_Enabled ;
      ...
      private short[] T001Q4_A554view_NE_IsRandRecheck ;
      private bool[] T001Q4_n554view_NE_IsRandRecheck ;
      private short[] T001Q4_A555view_NE_IsRandApprove ;
      private bool[] T001Q4_n555view_NE_IsRandApprove ;
      private short[] T001Q4_A556view_NE_IsUpdate ;
      ...
      private short[] T001Q3_A554view_NE_IsRandRecheck ;
      private bool[] T001Q3_n554view_NE_IsRandRecheck ;
      private short[] T001Q3_A555view_NE_IsRandApprove ;
      private bool[] T001Q3_n555view_NE_IsRandApprove ;
      private short[] T001Q3_A556view_NE_IsUpdate ;
      ...
      private short[] T001Q2_A554view_NE_IsRandRecheck ;
      private bool[] T001Q2_n554view_NE_IsRandRecheck ;
      private short[] T001Q2_A555view_NE_IsRandApprove ;
      private bool[] T001Q2_n555view_NE_IsRandApprove ;
      private short[] T001Q2_A556view_NE_IsUpdate ;
 ...
 public class view_new_encounter__default : DataStoreHelperBase, IDataStoreHelper
 {
  ...
  private void cursorDefinitions( )
  {
     if ( def == null )
     {
        ...
        new Object[] {"@view_NE_AdmitDate",SqlDbType.DateTime,10,8} ,
        new Object[] {"@view_NE_Status",SqlDbType.SmallInt,4,0} ,
        new Object[] {"@view_NE_IsRandRecheck",SqlDbType.SmallInt,1,0} ,
        new Object[] {"@view_NE_IsRandApprove",SqlDbType.SmallInt,1,0} ,
        new Object[] {"@view_NE_IsUpdate",SqlDbType.SmallInt,1,0} ,
        ...
        def= new CursorDef[] {
            new CursorDef("T001Q2", "SELECT [view_NE_EncounterID], [view_NE_Department], [view_NE_ENCType], [view_NE_AdmitDate], [view_NE_Status], [view_NE_IsRandRecheck], [view_NE_IsRandApprove], [view_NE_IsUpdate], [view_NE_TenantTenantCode], [view_NE_Information_ID], [view_NE_Information_PatientNo] FROM [View_New_Encounter1] WITH (UPDLOCK) WHERE [view_NE_EncounterID] = @view_NE_EncounterID ",true, GxErrorMask.GX_NOMASK, false, this,prmT001Q2,1,0,true,false )
           ,new CursorDef("T001Q3", "SELECT [view_NE_EncounterID], [view_NE_Department], [view_NE_ENCType], [view_NE_AdmitDate], [view_NE_Status], [view_NE_IsRandRecheck], [view_NE_IsRandApprove], [view_NE_IsUpdate], [view_NE_TenantTenantCode], [view_NE_Information_ID], [view_NE_Information_PatientNo] FROM [View_New_Encounter1] WITH (NOLOCK) WHERE [view_NE_EncounterID] = @view_NE_EncounterID ",true, GxErrorMask.GX_NOMASK, false, this,prmT001Q3,1,0,true,false )
           ,new CursorDef("T001Q4", "SELECT TM1.[view_NE_EncounterID], TM1.[view_NE_Department], TM1.[view_NE_ENCType], TM1.[view_NE_AdmitDate], TM1.[view_NE_Status], TM1.[view_NE_IsRandRecheck], TM1.[view_NE_IsRandApprove], TM1.[view_NE_IsUpdate], TM1.[view_NE_TenantTenantCode], TM1.[view_NE_Information_ID], TM1.[view_NE_Information_PatientNo] FROM [View_New_Encounter1] TM1 WITH (NOLOCK) WHERE TM1.[view_NE_EncounterID] = @view_NE_EncounterID ORDER BY TM1.[view_NE_EncounterID]  OPTION (FAST 100)",true, GxErrorMask.GX_NOMASK, false, this,prmT001Q4,100,0,true,false )
           ,new CursorDef("T001Q5", "SELECT [view_NE_EncounterID] FROM [View_New_Encounter1] WITH (NOLOCK) WHERE [view_NE_EncounterID] = @view_NE_EncounterID  OPTION (FAST 1)",true, GxErrorMask.GX_NOMASK, false, this,prmT001Q5,1,0,true,false )
           ,new CursorDef("T001Q6", "SELECT TOP 1 [view_NE_EncounterID] FROM [View_New_Encounter1] WITH (NOLOCK) WHERE ( [view_NE_EncounterID] > @view_NE_EncounterID) ORDER BY [view_NE_EncounterID]  OPTION (FAST 1)",true, GxErrorMask.GX_NOMASK, false, this,prmT001Q6,1,0,true,true )
           ,new CursorDef("T001Q7", "SELECT TOP 1 [view_NE_EncounterID] FROM [View_New_Encounter1] WITH (NOLOCK) WHERE ( [view_NE_EncounterID] < @view_NE_EncounterID) ORDER BY [view_NE_EncounterID] DESC  OPTION (FAST 1)",true, GxErrorMask.GX_NOMASK, false, this,prmT001Q7,1,0,true,true )
           ,new CursorDef("T001Q8", "INSERT INTO [View_New_Encounter1]([view_NE_EncounterID], [view_NE_Department], [view_NE_ENCType], [view_NE_AdmitDate], [view_NE_Status], [view_NE_IsRandRecheck], [view_NE_IsRandApprove], [view_NE_IsUpdate], [view_NE_TenantTenantCode], [view_NE_Information_ID], [view_NE_Information_PatientNo]) VALUES(@view_NE_EncounterID, @view_NE_Department, @view_NE_ENCType, @view_NE_AdmitDate, @view_NE_Status, @view_NE_IsRandRecheck, @view_NE_IsRandApprove, @view_NE_IsUpdate, @view_NE_TenantTenantCode, @view_NE_Information_ID, @view_NE_Information_PatientNo)", GxErrorMask.GX_NOMASK,prmT001Q8)
           ,new CursorDef("T001Q9", "UPDATE [View_New_Encounter1] SET [view_NE_Department]=@view_NE_Department, [view_NE_ENCType]=@view_NE_ENCType, [view_NE_AdmitDate]=@view_NE_AdmitDate, [view_NE_Status]=@view_NE_Status, [view_NE_IsRandRecheck]=@view_NE_IsRandRecheck, [view_NE_IsRandApprove]=@view_NE_IsRandApprove, [view_NE_IsUpdate]=@view_NE_IsUpdate, [view_NE_TenantTenantCode]=@view_NE_TenantTenantCode, [view_NE_Information_ID]=@view_NE_Information_ID, [view_NE_Information_PatientNo]=@view_NE_Information_PatientNo  WHERE [view_NE_EncounterID] = @view_NE_EncounterID", GxErrorMask.GX_NOMASK,prmT001Q9)
           ,new CursorDef("T001Q10", "DELETE FROM [View_New_Encounter1]  WHERE [view_NE_EncounterID] = @view_NE_EncounterID", GxErrorMask.GX_NOMASK,prmT001Q10)
           ,new CursorDef("T001Q11", "SELECT [view_NE_EncounterID] FROM [View_New_Encounter1] WITH (NOLOCK) ORDER BY [view_NE_EncounterID]  OPTION (FAST 100)",true, GxErrorMask.GX_NOMASK, false, this,prmT001Q11,100,0,true,false )
        };
     }
  }
