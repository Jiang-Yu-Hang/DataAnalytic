/*
               File: BR_Scheme_MedicationView
        Description: BR_Scheme_Medication View
             Author: GeneXus C# Generator version 16_0_0-127771
       Generated on: 2/28/2020 15:15:15.24
...
namespace GeneXus.Programs {
   public class br_scheme_medicationview : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public br_scheme_medicationview( )
      {
      ...
      public br_scheme_medicationview( IGxContext context )
      {
      ...
      public void execute( long aP0_BR_Scheme_MedicationID ,
                           String aP1_TabCode )
      {
         this.AV10BR_Scheme_MedicationID = aP0_BR_Scheme_MedicationID;
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV10BR_Scheme_MedicationID = (long)(NumberUtil.Val( gxfirstwebparm, "."));
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV10BR_Scheme_MedicationID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV10BR_Scheme_MedicationID), 18, 0)));
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "gxhash_vBR_SCHEME_MEDICATIONID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10BR_Scheme_MedicationID), "ZZZZZZZZZZZZZZZZZZ"), context));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202022815151527", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("br_scheme_medicationview.aspx") + "?" + UrlEncode("" +AV10BR_Scheme_MedicationID) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode))+"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vBR_SCHEME_MEDICATIONID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10BR_Scheme_MedicationID), 18, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vBR_SCHEME_MEDICATIONID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10BR_Scheme_MedicationID), "ZZZZZZZZZZZZZZZZZZ"), context));
      ...
      {
         return formatLink("br_scheme_medicationview.aspx") + "?" + UrlEncode("" +AV10BR_Scheme_MedicationID) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode)) ;
      }

      public override String GetPgmname( )
      {
         return "BR_Scheme_MedicationView" ;
      }

      public override String GetPgmdesc( )
      {
         return "BR_Scheme_Medication View" ;
      }
      ...
      protected void WB6I0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnback_Internalname, "", "返回", bttBtnback_Jsonclick, 5, "返回", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOBACK\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_BR_Scheme_MedicationView.htm");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTxttabtitle_Internalname, lblTxttabtitle_Caption, "", "", lblTxttabtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockTitleWWPTab", 0, "", 1, 1, 0, "HLP_BR_Scheme_MedicationView.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "化疗方案药物详情", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, "HLP_BR_Scheme_MedicationView.htm");
            /* Div Control */
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtngeneral_Internalname, "", "化疗方案药物详情", bttBtngeneral_Jsonclick, 7, "化疗方案药物详情", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e116i1_client"+"'", TempTags, "", 2, "HLP_BR_Scheme_MedicationView.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START6I2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "BR_Scheme_Medication View", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void STRUP6I0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            /* Read saved values. */
            AV10BR_Scheme_MedicationID = (long)(context.localUtil.CToN( cgiGet( "vBR_SCHEME_MEDICATIONID"), ".", ","));
      ...
      protected void E126I2( )
      {
         ...
         AV16GXLvl9 = 0;
         /* Using cursor H006I2 */
         pr_default.execute(0, new Object[] {AV10BR_Scheme_MedicationID});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A332BR_Scheme_MedicationID = H006I2_A332BR_Scheme_MedicationID[0];
            AV16GXLvl9 = 1;
      ...
      protected void S112( )
      {
         ...
         {
            /* Object Property */
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "BR_Scheme_MedicationGeneral")) != 0 )
            {
               WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "br_scheme_medicationgeneral", new Object[] {context} );
               WebComp_Generalwc.ComponentInit();
               WebComp_Generalwc.Name = "BR_Scheme_MedicationGeneral";
               WebComp_Generalwc_Component = "BR_Scheme_MedicationGeneral";
            }
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               WebComp_Generalwc.setjustcreated();
               WebComp_Generalwc.componentprepare(new Object[] {(String)"W0026",(String)"",(long)AV10BR_Scheme_MedicationID});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV10BR_Scheme_MedicationID = Convert.ToInt64(getParm(obj,0));
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV10BR_Scheme_MedicationID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV10BR_Scheme_MedicationID), 18, 0)));
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "gxhash_vBR_SCHEME_MEDICATIONID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10BR_Scheme_MedicationID), "ZZZZZZZZZZZZZZZZZZ"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202022815151561", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("br_scheme_medicationview.js", "?202022815151561", false);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "BR_Scheme_Medication View";
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV10BR_Scheme_MedicationID',fld:'vBR_SCHEME_MEDICATIONID',pic:'ZZZZZZZZZZZZZZZZZZ',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("'DOBACK'","{handler:'E146I2',iparms:[]");
         setEventMetadata("'DOBACK'",",oparms:[]}");
         setEventMetadata("'GENERAL'","{handler:'E116I1',iparms:[{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV10BR_Scheme_MedicationID',fld:'vBR_SCHEME_MEDICATIONID',pic:'ZZZZZZZZZZZZZZZZZZ',hsh:true}]");
         ...
         setEventMetadata("'DORETURN'","{handler:'E156I2',iparms:[]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H006I2_A332BR_Scheme_MedicationID = new long[1] ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.br_scheme_medicationview__default(),
            new Object[][] {
                new Object[] {
               H006I2_A332BR_Scheme_MedicationID
               }
            }
         );
      ...
      private int idxLst ;
      private long AV10BR_Scheme_MedicationID ;
      private long wcpOAV10BR_Scheme_MedicationID ;
      ...
      private long[] H006I2_A332BR_Scheme_MedicationID ;
   ...
   public class br_scheme_medicationview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@AV10BR_Scheme_MedicationID",SqlDbType.Decimal,18,0}
          } ;
          def= new CursorDef[] {
              new CursorDef("H006I2", "SELECT [BR_Scheme_MedicationID] FROM [BR_Scheme_Medication] WITH (NOLOCK) WHERE [BR_Scheme_MedicationID] = @AV10BR_Scheme_MedicationID ORDER BY [BR_Scheme_MedicationID] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH006I2,1,0,false,true )
          };
       }
    }
