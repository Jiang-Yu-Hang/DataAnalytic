/*
       ...
       Generated on: 2/28/2020 15:5:36.84
...
namespace GeneXus.Programs {
   public class br_labgeneral : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20202281553690", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void RenderHtmlCloseForm3I2( )
      {
         ...
         {
            context.AddJavascriptSource("br_labgeneral.js", "?20202281553695", false);
         }
      ...
      protected void WB3I0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtBR_Lab_TestCode_Internalname, "检查项目编码", "col-sm-3 ReadonlyAttributeLabel", 1, true);
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtBR_Lab_TestCode_Internalname, A103BR_Lab_TestCode, StringUtil.RTrim( context.localUtil.Format( A103BR_Lab_TestCode, "")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtBR_Lab_TestCode_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtBR_Lab_TestCode_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 1, -1, -1, true, "", "left", true, "HLP_BR_LabGeneral.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void RF3I2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            while ( (pr_default.getStatus(0) != 101) )
            {
               ...
               A103BR_Lab_TestCode = H003I2_A103BR_Lab_TestCode[0];
               context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "A103BR_Lab_TestCode", A103BR_Lab_TestCode);
               n103BR_Lab_TestCode = H003I2_n103BR_Lab_TestCode[0];
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?20202281554019", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("br_labgeneral.js", "?20202281554020", false);
         }
      ...
      protected void init_default_properties( )
      {
         ...
         edtBR_Lab_TestCode_Internalname = sPrefix+"BR_LAB_TESTCODE";
      ...
      public override void initialize( )
      {
         ...
         H003I2_A103BR_Lab_TestCode = new String[] {""} ;
         H003I2_n103BR_Lab_TestCode = new bool[] {false} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.br_labgeneral__default(),
            new Object[][] {
                new Object[] {
               H003I2_A101BR_LabID, H003I2_A224BR_Lab_SampleID, H003I2_n224BR_Lab_SampleID, H003I2_A102BR_Lab_TestID, H003I2_n102BR_Lab_TestID, H003I2_A103BR_Lab_TestCode, H003I2_n103BR_Lab_TestCode, H003I2_A110BR_Lab_ResultNum, H003I2_n110BR_Lab_ResultNum, H003I2_A117BR_Lab_InstrumentName,
               H003I2_n117BR_Lab_InstrumentName, H003I2_A118BR_Lab_InstrumentCode, H003I2_n118BR_Lab_InstrumentCode, H003I2_A115BR_Lab_TestMethod, H003I2_n115BR_Lab_TestMethod, H003I2_A113BR_Lab_NormRangeLow, H003I2_n113BR_Lab_NormRangeLow, H003I2_A112BR_Lab_AbnInd, H003I2_n112BR_Lab_AbnInd, H003I2_A111BR_Lab_ResultUnit,
               H003I2_n111BR_Lab_ResultUnit, H003I2_A109BR_Lab_ResultQual, H003I2_n109BR_Lab_ResultQual, H003I2_A265BR_Lab_ReportTime, H003I2_n265BR_Lab_ReportTime, H003I2_A264BR_Lab_ReceivingTime, H003I2_n264BR_Lab_ReceivingTime, H003I2_A105BR_Lab_SpecimenDate, H003I2_n105BR_Lab_SpecimenDate, H003I2_A106BR_Lab_SpecimenSource,
               H003I2_n106BR_Lab_SpecimenSource, H003I2_A263BR_Lab_Diag, H003I2_n263BR_Lab_Diag, H003I2_A262BR_Lab_Age, H003I2_n262BR_Lab_Age, H003I2_A261BR_Lab_TestEngName, H003I2_n261BR_Lab_TestEngName, H003I2_A104BR_Lab_TestName, H003I2_n104BR_Lab_TestName
               }
            }
         );
         AV16Pgmname = "BR_LabGeneral";
      ...
      private String[] H003I2_A103BR_Lab_TestCode ;
      private bool[] H003I2_n103BR_Lab_TestCode ;
