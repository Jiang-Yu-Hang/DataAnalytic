/*
       ...
       Generated on: 2/28/2020 15:6:27.86
   ...
   public class br_encounterupdatecomorbidity : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV44Pgmname = "BR_EncounterUpdateComorbidity";
               context.Gx_err = 0;
               WS2U2( ) ;
               if ( ! isAjaxCallMode( ) )
               {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2020228156288", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void RenderHtmlCloseForm2U2( )
      {
         ...
         {
            context.AddJavascriptSource("br_encounterupdatecomorbidity.js", "?20202281562812", false);
         }
      ...
      protected void WB2U0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, cmbavBr_comorbidity_br_comorbidity_hapetitisc_Internalname, "丙肝", "col-sm-3 AttributeLabel", 1, true);
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 63,'" + sPrefix + "',false,'',0)\"";
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavBr_comorbidity_br_comorbidity_hapetitisc, cmbavBr_comorbidity_br_comorbidity_hapetitisc_Internalname, StringUtil.RTrim( AV13BR_Comorbidity.gxTpr_Br_comorbidity_hapetitisc), 1, cmbavBr_comorbidity_br_comorbidity_hapetitisc_Jsonclick, 0, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "svchar", "", 1, cmbavBr_comorbidity_br_comorbidity_hapetitisc.Enabled, 0, 0, 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,63);\"", "", true, "HLP_BR_EncounterUpdateComorbidity.htm");
            ...
            ClassString = "Attribute";
            StyleString = "";
            GxWebStd.gx_html_textarea( context, edtavBr_comorbidity_br_comorbidity_others_Internalname, AV13BR_Comorbidity.gxTpr_Br_comorbidity_others, "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,81);\"", 0, 1, edtavBr_comorbidity_br_comorbidity_others_Enabled, 0, 80, "chr", 4, "row", StyleString, ClassString, "", "", "255", -1, 0, "", "", -1, true, "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", 0, "HLP_BR_EncounterUpdateComorbidity.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavBr_comorbidity_br_comorbidityid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV13BR_Comorbidity.gxTpr_Br_comorbidityid), 18, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV13BR_Comorbidity.gxTpr_Br_comorbidityid), "ZZZZZZZZZZZZZZZZZZ")), TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,91);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavBr_comorbidity_br_comorbidityid_Jsonclick, 0, "Attribute", "", "", "", "", edtavBr_comorbidity_br_comorbidityid_Visible, 1, 0, "number", "1", 18, "chr", 1, "row", 18, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_BR_EncounterUpdateComorbidity.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 92,'" + sPrefix + "',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavBr_comorbidity_br_encounterid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV13BR_Comorbidity.gxTpr_Br_encounterid), 18, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV13BR_Comorbidity.gxTpr_Br_encounterid), "ZZZZZZZZZZZZZZZZZZ")), TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,92);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavBr_comorbidity_br_encounterid_Jsonclick, 0, "Attribute", "", "", "", "", edtavBr_comorbidity_br_encounterid_Visible, 1, 0, "number", "1", 18, "chr", 1, "row", 18, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_BR_EncounterUpdateComorbidity.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 93,'" + sPrefix + "',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavBr_comorbidity_br_information_patientno_Internalname, AV13BR_Comorbidity.gxTpr_Br_information_patientno, StringUtil.RTrim( context.localUtil.Format( AV13BR_Comorbidity.gxTpr_Br_information_patientno, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,93);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavBr_comorbidity_br_information_patientno_Jsonclick, 0, "Attribute", "", "", "", "", edtavBr_comorbidity_br_information_patientno_Visible, 1, 0, "text", "", 80, "chr", 1, "row", 2000, 0, 0, 0, 1, -1, -1, true, "", "left", true, "HLP_BR_EncounterUpdateComorbidity.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
         ...
         if ( ! AV20tCheckFlag )
         {
            ...
            if ( AV19tFlag )
            {
               ...
               else
               {
                  AV15ErrorMsg = "";
                  AV43GXV20 = 1;
                  AV42GXV19 = AV17BR_Behavior.GetMessages();
                  while ( AV43GXV20 <= AV42GXV19.Count )
                  {
                     AV16Message = ((SdtMessages_Message)AV42GXV19.Item(AV43GXV20));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?20202281563021", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("br_encounterupdatecomorbidity.js", "?20202281563021", false);
      ...
      public override void initialize( )
      {
         ...
         AV15ErrorMsg = "";
         AV42GXV19 = new GXBaseCollection<SdtMessages_Message>( context, "Message", "GeneXus");
      ...
      private GXBaseCollection<SdtMessages_Message> AV42GXV19 ;
