/*
       ...
       Generated on: 2/28/2020 15:15:52.28
...
namespace GeneXus.Programs {
   public class br_enteringsubmit : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202022815155250", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void wb_table1_25_782e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtavBr_encounter_refusereason_br_encounter_refusereason_noapprovedate_Internalname, context.localUtil.TToC( AV23BR_Encounter_RefuseReason.gxTpr_Br_encounter_refusereason_noapprovedate, 10, 8, 0, 0, "/", ":", " "), context.localUtil.Format( AV23BR_Encounter_RefuseReason.gxTpr_Br_encounter_refusereason_noapprovedate, "9999/99/99 99:99:99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'YMD',8,24,'chs',false,1);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,34);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavBr_encounter_refusereason_br_encounter_refusereason_noapprovedate_Jsonclick, 0, "Attribute", "", "", "", "", edtavBr_encounter_refusereason_br_encounter_refusereason_noapprovedate_Visible, 1, 0, "text", "", 19, "chr", 1, "row", 19, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_BR_EnteringSubmit.htm");
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202022815155320", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("br_enteringsubmit.js", "?202022815155320", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false);
