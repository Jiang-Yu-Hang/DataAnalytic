/*
       ...
       Generated on: 2/28/2020 15:4:59.6
   ...
   public class br_encountercheckbr_schemewc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV39Pgmname = "BR_EncounterCheckBR_SchemeWC";
               context.Gx_err = 0;
               WS6M2( ) ;
               if ( ! isAjaxCallMode( ) )
               {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20202281545922", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void RenderHtmlCloseForm6M2( )
      {
         ...
         {
            context.AddJavascriptSource("br_encountercheckbr_schemewc.js", "?2020228155118", false);
         }
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtavDisplay_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV31Display)) ? AV38Display_GXI : context.convertURL( context.PathToRelativeUrl( AV31Display))), !bGXsfl_12_Refreshing);
      ...
      protected void S122( )
      {
         ...
         {
            AV12GridState.FromXml(new GeneXus.Programs.wwpbaseobjects.loadgridstate(context).executeUdp(  AV39Pgmname+"GridState"), null, "WWPGridState", "DataAnalysisPlatform");
         }
         else
         {
            AV12GridState.FromXml(AV16Session.Get(AV39Pgmname+"GridState"), null, "WWPGridState", "DataAnalysisPlatform");
         }
      ...
      protected void S142( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.savegridstate(context ).execute(  AV39Pgmname+"GridState",  AV12GridState.ToXml(false, true, "WWPGridState", "DataAnalysisPlatform")) ;
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?20202281551011", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("br_encountercheckbr_schemewc.js", "?20202281551011", false);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("DDO_BR_SCHEME_CHEM_DETAIL.ONOPTIONCLICKED","{handler:'E166M2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV8BR_EncounterID',fld:'vBR_ENCOUNTERID',pic:'ZZZZZZZZZZZZZZZZZZ'},{av:'AV18ddo_BR_Scheme_Chem_RegimensTitleControlIdToReplace',fld:'vDDO_BR_SCHEME_CHEM_REGIMENSTITLECONTROLIDTOREPLACE',pic:''},{av:'AV20ddo_BR_Scheme_Therapy_LineTitleControlIdToReplace',fld:'vDDO_BR_SCHEME_THERAPY_LINETITLECONTROLIDTOREPLACE',pic:''},{av:'AV22ddo_BR_Scheme_Chem_CycleTitleControlIdToReplace',fld:'vDDO_BR_SCHEME_CHEM_CYCLETITLECONTROLIDTOREPLACE',pic:''},{av:'AV24ddo_BR_Scheme_Chem_DetailTitleControlIdToReplace',fld:'vDDO_BR_SCHEME_CHEM_DETAILTITLECONTROLIDTOREPLACE',pic:''},{av:'AV39Pgmname',fld:'vPGMNAME',pic:''},{av:'AV34IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:''},{av:'sPrefix'},{av:'Ddo_br_scheme_chem_detail_Activeeventkey',ctrl:'DDO_BR_SCHEME_CHEM_DETAIL',prop:'ActiveEventKey'}]");
