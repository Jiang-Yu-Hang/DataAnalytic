/*
       ...
       Generated on: 2/28/2020 15:9:6.71
   ...
   public class br_encounterupdatebehavior : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV47Pgmname = "BR_EncounterUpdateBehavior";
               context.Gx_err = 0;
               WS2T2( ) ;
               if ( ! isAjaxCallMode( ) )
               {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2020228159687", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void RenderHtmlCloseForm2T2( )
      {
         ...
         {
            context.AddJavascriptSource("br_encounterupdatebehavior.js", "?2020228159690", false);
         }
      ...
      protected void WB2T0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtavBr_behavior_br_behavior_rawmenopauseage_Internalname, AV13BR_Behavior.gxTpr_Br_behavior_rawmenopauseage, StringUtil.RTrim( context.localUtil.Format( AV13BR_Behavior.gxTpr_Br_behavior_rawmenopauseage, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,55);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavBr_behavior_br_behavior_rawmenopauseage_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavBr_behavior_br_behavior_rawmenopauseage_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 1, -1, -1, true, "", "left", true, "HLP_BR_EncounterUpdateBehavior.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavBr_behavior_br_behavior_menopause, cmbavBr_behavior_br_behavior_menopause_Internalname, StringUtil.RTrim( AV13BR_Behavior.gxTpr_Br_behavior_menopause), 1, cmbavBr_behavior_br_behavior_menopause_Jsonclick, 0, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "svchar", "", 1, cmbavBr_behavior_br_behavior_menopause.Enabled, 0, 0, 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,59);\"", "", true, "HLP_BR_EncounterUpdateBehavior.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtavBr_behavior_br_behaviorid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV13BR_Behavior.gxTpr_Br_behaviorid), 18, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV13BR_Behavior.gxTpr_Br_behaviorid), "ZZZZZZZZZZZZZZZZZZ")), TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,77);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavBr_behavior_br_behaviorid_Jsonclick, 0, "Attribute", "", "", "", "", edtavBr_behavior_br_behaviorid_Visible, 1, 0, "number", "1", 18, "chr", 1, "row", 18, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_BR_EncounterUpdateBehavior.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 78,'" + sPrefix + "',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavBr_behavior_br_encounterid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV13BR_Behavior.gxTpr_Br_encounterid), 18, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV13BR_Behavior.gxTpr_Br_encounterid), "ZZZZZZZZZZZZZZZZZZ")), TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,78);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavBr_behavior_br_encounterid_Jsonclick, 0, "Attribute", "", "", "", "", edtavBr_behavior_br_encounterid_Visible, 1, 0, "number", "1", 18, "chr", 1, "row", 18, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_BR_EncounterUpdateBehavior.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 79,'" + sPrefix + "',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavBr_behavior_br_information_patientno_Internalname, AV13BR_Behavior.gxTpr_Br_information_patientno, StringUtil.RTrim( context.localUtil.Format( AV13BR_Behavior.gxTpr_Br_information_patientno, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,79);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavBr_behavior_br_information_patientno_Jsonclick, 0, "Attribute", "", "", "", "", edtavBr_behavior_br_information_patientno_Visible, 1, 0, "text", "", 80, "chr", 1, "row", 2000, 0, 0, 0, 1, -1, -1, true, "", "left", true, "HLP_BR_EncounterUpdateBehavior.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 80,'" + sPrefix + "',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavBr_behavior_br_behavior_childnum_Internalname, AV13BR_Behavior.gxTpr_Br_behavior_childnum, StringUtil.RTrim( context.localUtil.Format( AV13BR_Behavior.gxTpr_Br_behavior_childnum, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,80);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavBr_behavior_br_behavior_childnum_Jsonclick, 0, "Attribute", "", "", "", "", edtavBr_behavior_br_behavior_childnum_Visible, 1, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 1, -1, -1, true, "", "left", true, "HLP_BR_EncounterUpdateBehavior.htm");
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 81,'" + sPrefix + "',false,'',0)\"";
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavBr_behavior_br_behavior_familycahistory, cmbavBr_behavior_br_behavior_familycahistory_Internalname, StringUtil.RTrim( AV13BR_Behavior.gxTpr_Br_behavior_familycahistory), 1, cmbavBr_behavior_br_behavior_familycahistory_Jsonclick, 0, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "svchar", "", cmbavBr_behavior_br_behavior_familycahistory.Visible, 1, 0, 0, 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,81);\"", "", true, "HLP_BR_EncounterUpdateBehavior.htm");
            ...
            ClassString = "Attribute";
            StyleString = "";
            GxWebStd.gx_html_textarea( context, edtavBr_behavior_br_behavior_familycancer_Internalname, AV13BR_Behavior.gxTpr_Br_behavior_familycancer, "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,82);\"", 0, edtavBr_behavior_br_behavior_familycancer_Visible, 1, 0, 80, "chr", 3, "row", StyleString, ClassString, "", "", "200", -1, 0, "", "", -1, true, "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", 0, "HLP_BR_EncounterUpdateBehavior.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void E122T2( )
      {
         ...
         edtavBr_behavior_br_behavior_childnum_Visible = 0;
         context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtavBr_behavior_br_behavior_childnum_Internalname, "Visible", StringUtil.LTrim( StringUtil.Str( (decimal)(edtavBr_behavior_br_behavior_childnum_Visible), 5, 0)), true);
         cmbavBr_behavior_br_behavior_familycahistory.Visible = 0;
         context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, cmbavBr_behavior_br_behavior_familycahistory_Internalname, "Visible", StringUtil.LTrim( StringUtil.Str( (decimal)(cmbavBr_behavior_br_behavior_familycahistory.Visible), 5, 0)), true);
         edtavBr_behavior_br_behavior_familycancer_Visible = 0;
         context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtavBr_behavior_br_behavior_familycancer_Internalname, "Visible", StringUtil.LTrim( StringUtil.Str( (decimal)(edtavBr_behavior_br_behavior_familycancer_Visible), 5, 0)), true);
         ...
         if ( ! AV21tCheckFlag )
         {
            ...
            if ( AV19tFlag )
            {
               ...
               else
               {
                  AV15ErrorMsg = "";
                  AV46GXV19 = 1;
                  AV45GXV18 = AV13BR_Behavior.GetMessages();
                  while ( AV46GXV19 <= AV45GXV18.Count )
                  {
                     AV16Message = ((SdtMessages_Message)AV45GXV18.Item(AV46GXV19));
                     AV15ErrorMsg = AV15ErrorMsg + StringUtil.Trim( AV16Message.gxTpr_Description);
                     AV46GXV19 = (int)(AV46GXV19+1);
                  }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?2020228159830", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("br_encounterupdatebehavior.js", "?2020228159831", false);
      ...
      public override void initialize_properties( )
      {
         ...
         init_default_properties( ) ;
         edtavBr_behavior_br_behavior_familycancer_Visible = 1;
         cmbavBr_behavior_br_behavior_familycahistory_Jsonclick = "";
         cmbavBr_behavior_br_behavior_familycahistory.Visible = 1;
         edtavBr_behavior_br_behavior_childnum_Jsonclick = "";
         edtavBr_behavior_br_behavior_childnum_Visible = 1;
      ...
      public override void initialize( )
      {
         ...
         AV15ErrorMsg = "";
         AV45GXV18 = new GXBaseCollection<SdtMessages_Message>( context, "Message", "GeneXus");
      ...
      private int edtavBr_behavior_br_behavior_childnum_Visible ;
      private int edtavBr_behavior_br_behavior_familycancer_Visible ;
      private int gxdynajaxindex ;
      private int AV46GXV19 ;
      private int idxLst ;
      ...
      private GXBaseCollection<SdtMessages_Message> AV45GXV18 ;
