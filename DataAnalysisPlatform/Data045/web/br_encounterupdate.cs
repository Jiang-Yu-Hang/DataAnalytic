/*
       ...
       Generated on: 2/28/2020 15:9:35.85
...
namespace GeneXus.Programs {
   public class br_encounterupdate : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20202281593620", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void WB1X0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblBr_familyhistory_title_Internalname, "家族史", "", "", lblBr_familyhistory_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, "HLP_BR_EncounterUpdate.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "left", "top", "", "display:none;", "div");
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0058"+"", StringUtil.RTrim( WebComp_Br_familyhistorywc_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0066"+"", StringUtil.RTrim( WebComp_Br_comorbiditywc_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0074"+"", StringUtil.RTrim( WebComp_Br_deathwc_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0082"+"", StringUtil.RTrim( WebComp_Br_vitalwc_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0090"+"", StringUtil.RTrim( WebComp_Br_diagnosiswc_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0098"+"", StringUtil.RTrim( WebComp_Br_labwc_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0106"+"", StringUtil.RTrim( WebComp_Br_medicationwc_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0114"+"", StringUtil.RTrim( WebComp_Br_schemewc_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0122"+"", StringUtil.RTrim( WebComp_Br_procedurewc_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0130"+"", StringUtil.RTrim( WebComp_Br_medicalimagingwc_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0138"+"", StringUtil.RTrim( WebComp_Br_pathologywc_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
               context.WriteHtmlText( " id=\""+"gxHTMLWrpW0138"+""+"\""+"") ;
               context.WriteHtmlText( ">") ;
               if ( StringUtil.Len( WebComp_Br_pathologywc_Component) != 0 )
               {
                  ...
                  {
                     context.httpAjaxContext.ajax_rspStartCmp("gxHTMLWrpW0138"+"");
                  }
            ...
            ClassString = "btn_Master btn-large btn-block Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnbr_familyhistory_Internalname, "", "家族史", bttBtnbr_familyhistory_Jsonclick, 5, "家族史", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'BR_FAMILYHISTORY\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_BR_EncounterUpdate.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            wb_table1_187_1X2( true) ;
         }
         else
         {
            wb_table1_187_1X2( false) ;
         }
         return  ;
      }

      protected void wb_table1_187_1X2e( bool wbgen )
      {
         if ( wbgen )
         {
            wb_table2_192_1X2( true) ;
         }
         else
         {
            wb_table2_192_1X2( false) ;
         }
         return  ;
      }

      protected void wb_table2_192_1X2e( bool wbgen )
      {
         if ( wbgen )
         {
            wb_table3_197_1X2( true) ;
         }
         else
         {
            wb_table3_197_1X2( false) ;
         }
         return  ;
      }

      protected void wb_table3_197_1X2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
               ...
               if ( StringUtil.Len( sEvt) > 0 )
               {
                  ...
                  if ( StringUtil.StrCmp(sEvtType, "M") != 0 )
                  {
                     ...
                     else if ( StringUtil.StrCmp(sEvtType, "W") == 0 )
                     {
                        ...
                        {
                           OldBr_familyhistorywc = cgiGet( "W0058");
                           ...
                           if ( StringUtil.Len( WebComp_Br_familyhistorywc_Component) != 0 )
                           {
                              WebComp_Br_familyhistorywc.componentprocess("W0058", "", sEvt);
                           }
                           WebComp_Br_familyhistorywc_Component = OldBr_familyhistorywc;
                        }
                        else if ( nCmpId == 66 )
                        {
                           OldBr_comorbiditywc = cgiGet( "W0066");
                           ...
                           if ( StringUtil.Len( WebComp_Br_comorbiditywc_Component) != 0 )
                           {
                              WebComp_Br_comorbiditywc.componentprocess("W0066", "", sEvt);
                           }
                           WebComp_Br_comorbiditywc_Component = OldBr_comorbiditywc;
                        }
                        else if ( nCmpId == 74 )
                        {
                           OldBr_deathwc = cgiGet( "W0074");
                           ...
                           if ( StringUtil.Len( WebComp_Br_deathwc_Component) != 0 )
                           {
                              WebComp_Br_deathwc.componentprocess("W0074", "", sEvt);
                           }
                           WebComp_Br_deathwc_Component = OldBr_deathwc;
                        }
                        else if ( nCmpId == 82 )
                        {
                           OldBr_vitalwc = cgiGet( "W0082");
                           ...
                           if ( StringUtil.Len( WebComp_Br_vitalwc_Component) != 0 )
                           {
                              WebComp_Br_vitalwc.componentprocess("W0082", "", sEvt);
                           }
                           WebComp_Br_vitalwc_Component = OldBr_vitalwc;
                        }
                        else if ( nCmpId == 90 )
                        {
                           OldBr_diagnosiswc = cgiGet( "W0090");
                           ...
                           if ( StringUtil.Len( WebComp_Br_diagnosiswc_Component) != 0 )
                           {
                              WebComp_Br_diagnosiswc.componentprocess("W0090", "", sEvt);
                           }
                           WebComp_Br_diagnosiswc_Component = OldBr_diagnosiswc;
                        }
                        else if ( nCmpId == 98 )
                        {
                           OldBr_labwc = cgiGet( "W0098");
                           ...
                           if ( StringUtil.Len( WebComp_Br_labwc_Component) != 0 )
                           {
                              WebComp_Br_labwc.componentprocess("W0098", "", sEvt);
                           }
                           WebComp_Br_labwc_Component = OldBr_labwc;
                        }
                        else if ( nCmpId == 106 )
                        {
                           OldBr_medicationwc = cgiGet( "W0106");
                           ...
                           if ( StringUtil.Len( WebComp_Br_medicationwc_Component) != 0 )
                           {
                              WebComp_Br_medicationwc.componentprocess("W0106", "", sEvt);
                           }
                           WebComp_Br_medicationwc_Component = OldBr_medicationwc;
                        }
                        else if ( nCmpId == 114 )
                        {
                           OldBr_schemewc = cgiGet( "W0114");
                           ...
                           if ( StringUtil.Len( WebComp_Br_schemewc_Component) != 0 )
                           {
                              WebComp_Br_schemewc.componentprocess("W0114", "", sEvt);
                           }
                           WebComp_Br_schemewc_Component = OldBr_schemewc;
                        }
                        else if ( nCmpId == 122 )
                        {
                           OldBr_procedurewc = cgiGet( "W0122");
                           ...
                           if ( StringUtil.Len( WebComp_Br_procedurewc_Component) != 0 )
                           {
                              WebComp_Br_procedurewc.componentprocess("W0122", "", sEvt);
                           }
                           WebComp_Br_procedurewc_Component = OldBr_procedurewc;
                        }
                        else if ( nCmpId == 130 )
                        {
                           OldBr_medicalimagingwc = cgiGet( "W0130");
                           ...
                           if ( StringUtil.Len( WebComp_Br_medicalimagingwc_Component) != 0 )
                           {
                              WebComp_Br_medicalimagingwc.componentprocess("W0130", "", sEvt);
                           }
                           WebComp_Br_medicalimagingwc_Component = OldBr_medicalimagingwc;
                        }
                        else if ( nCmpId == 138 )
                        {
                           OldBr_pathologywc = cgiGet( "W0138");
                           ...
                           if ( StringUtil.Len( WebComp_Br_pathologywc_Component) != 0 )
                           {
                              WebComp_Br_pathologywc.componentprocess("W0138", "", sEvt);
                           }
                           WebComp_Br_pathologywc_Component = OldBr_pathologywc;
                        }
                     }
      ...
      protected void S112( )
      {
         ...
         while ( (pr_default.getStatus(1) != 101) )
         {
            ...
            {
               /* Object Property */
               if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Br_familyhistorywc_Component), StringUtil.Lower( "BR_EncounterUpdateFamilyhistory")) != 0 )
               {
                  WebComp_Br_familyhistorywc = getWebComponent(GetType(), "GeneXus.Programs", "br_encounterupdatefamilyhistory", new Object[] {context} );
                  WebComp_Br_familyhistorywc.ComponentInit();
                  WebComp_Br_familyhistorywc.Name = "BR_EncounterUpdateFamilyhistory";
                  WebComp_Br_familyhistorywc_Component = "BR_EncounterUpdateFamilyhistory";
               }
               if ( StringUtil.Len( WebComp_Br_familyhistorywc_Component) != 0 )
               {
                  WebComp_Br_familyhistorywc.setjustcreated();
                  WebComp_Br_familyhistorywc.componentprepare(new Object[] {(String)"W0058",(String)"",(long)AV10BR_EncounterID});
            ...
            if ( AV13TempBoolean )
            {
               if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV12SelectedTabCode, "BR_Comorbidity") == 0 ) )
               {
                  ...
                  if ( StringUtil.Len( WebComp_Br_comorbiditywc_Component) != 0 )
                  {
                     ...
                     WebComp_Br_comorbiditywc.componentprepare(new Object[] {(String)"W0066",(String)"",(long)AV10BR_EncounterID});
            ...
            if ( AV13TempBoolean )
            {
               if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV12SelectedTabCode, "BR_Death") == 0 ) )
               {
                  ...
                  if ( StringUtil.Len( WebComp_Br_deathwc_Component) != 0 )
                  {
                     ...
                     WebComp_Br_deathwc.componentprepare(new Object[] {(String)"W0074",(String)"",(long)AV10BR_EncounterID});
            ...
            if ( AV13TempBoolean )
            {
               if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV12SelectedTabCode, "BR_Vital") == 0 ) )
               {
                  ...
                  if ( StringUtil.Len( WebComp_Br_vitalwc_Component) != 0 )
                  {
                     ...
                     WebComp_Br_vitalwc.componentprepare(new Object[] {(String)"W0082",(String)"",(long)AV10BR_EncounterID});
            ...
            if ( AV13TempBoolean )
            {
               if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV12SelectedTabCode, "BR_Diagnosis") == 0 ) )
               {
                  ...
                  if ( StringUtil.Len( WebComp_Br_diagnosiswc_Component) != 0 )
                  {
                     ...
                     WebComp_Br_diagnosiswc.componentprepare(new Object[] {(String)"W0090",(String)"",(long)AV10BR_EncounterID});
            ...
            if ( AV13TempBoolean )
            {
               if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV12SelectedTabCode, "BR_Lab") == 0 ) )
               {
                  ...
                  if ( StringUtil.Len( WebComp_Br_labwc_Component) != 0 )
                  {
                     ...
                     WebComp_Br_labwc.componentprepare(new Object[] {(String)"W0098",(String)"",(long)AV10BR_EncounterID});
            ...
            if ( AV13TempBoolean )
            {
               if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV12SelectedTabCode, "BR_Medication") == 0 ) )
               {
                  ...
                  if ( StringUtil.Len( WebComp_Br_medicationwc_Component) != 0 )
                  {
                     ...
                     WebComp_Br_medicationwc.componentprepare(new Object[] {(String)"W0106",(String)"",(long)AV10BR_EncounterID});
            ...
            if ( AV13TempBoolean )
            {
               if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV12SelectedTabCode, "BR_Scheme") == 0 ) )
               {
                  ...
                  if ( StringUtil.Len( WebComp_Br_schemewc_Component) != 0 )
                  {
                     ...
                     WebComp_Br_schemewc.componentprepare(new Object[] {(String)"W0114",(String)"",(long)AV10BR_EncounterID});
            ...
            if ( AV13TempBoolean )
            {
               if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV12SelectedTabCode, "BR_Procedure") == 0 ) )
               {
                  ...
                  if ( StringUtil.Len( WebComp_Br_procedurewc_Component) != 0 )
                  {
                     ...
                     WebComp_Br_procedurewc.componentprepare(new Object[] {(String)"W0122",(String)"",(long)AV10BR_EncounterID});
            ...
            if ( AV13TempBoolean )
            {
               if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV12SelectedTabCode, "BR_MedicalImaging") == 0 ) )
               {
                  ...
                  if ( StringUtil.Len( WebComp_Br_medicalimagingwc_Component) != 0 )
                  {
                     ...
                     WebComp_Br_medicalimagingwc.componentprepare(new Object[] {(String)"W0130",(String)"",(long)AV10BR_EncounterID});
            ...
            if ( AV13TempBoolean )
            {
               if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV12SelectedTabCode, "BR_Pathology") == 0 ) )
               {
                  ...
                  if ( StringUtil.Len( WebComp_Br_pathologywc_Component) != 0 )
                  {
                     ...
                     WebComp_Br_pathologywc.componentprepare(new Object[] {(String)"W0138",(String)"",(long)AV10BR_EncounterID});
            ...
            else
            {
               divCell_br_pathology_Visible = 0;
               context.httpAjaxContext.ajax_rsp_assign_prop("", false, divCell_br_pathology_Internalname, "Visible", StringUtil.LTrim( StringUtil.Str( (decimal)(divCell_br_pathology_Visible), 5, 0)), true);
               this.executeUsercontrolMethod("", false, "TABSContainer", "HideTab", "", new Object[] {(short)14});
            }
            /* Exiting from a For First loop. */
            if (true) break;
         }
      ...
      protected void wb_table3_197_1X2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            wb_table3_197_1X2e( true) ;
         }
         else
         {
            wb_table3_197_1X2e( false) ;
         }
      }

      protected void wb_table2_192_1X2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_192_1X2e( true) ;
         }
         else
         {
            wb_table2_192_1X2e( false) ;
         }
      }

      protected void wb_table1_187_1X2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_187_1X2e( true) ;
         }
         else
         {
            wb_table1_187_1X2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?20202281594242", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("br_encounterupdate.js", "?20202281594242", false);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'BR_FAMILYHISTORY'","{handler:'E251X2',iparms:[{av:'A19BR_EncounterID',fld:'BR_ENCOUNTERID',pic:'ZZZZZZZZZZZZZZZZZZ'},{av:'AV10BR_EncounterID',fld:'vBR_ENCOUNTERID',pic:'ZZZZZZZZZZZZZZZZZZ',hsh:true},{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''}]");
         setEventMetadata("'BR_FAMILYHISTORY'",",oparms:[{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'divCell_br_encounter_Visible',ctrl:'CELL_BR_ENCOUNTER',prop:'Visible'},{ctrl:'BR_ENCOUNTERWC'},{av:'lblTxttabtitle_Caption',ctrl:'TXTTABTITLE',prop:'Caption'},{av:'divCell_br_demographics_Visible',ctrl:'CELL_BR_DEMOGRAPHICS',prop:'Visible'},{ctrl:'BR_DEMOGRAPHICSWC'},{av:'divCell_br_behavior_Visible',ctrl:'CELL_BR_BEHAVIOR',prop:'Visible'},{ctrl:'BR_BEHAVIORWC'},{av:'divCell_br_familyhistory_Visible',ctrl:'CELL_BR_FAMILYHISTORY',prop:'Visible'},{ctrl:'BR_FAMILYHISTORYWC'},{av:'divCell_br_comorbidity_Visible',ctrl:'CELL_BR_COMORBIDITY',prop:'Visible'},{ctrl:'BR_COMORBIDITYWC'},{av:'divCell_br_death_Visible',ctrl:'CELL_BR_DEATH',prop:'Visible'},{ctrl:'BR_DEATHWC'},{av:'divCell_br_vital_Visible',ctrl:'CELL_BR_VITAL',prop:'Visible'},{ctrl:'BR_VITALWC'},{av:'divCell_br_diagnosis_Visible',ctrl:'CELL_BR_DIAGNOSIS',prop:'Visible'},{ctrl:'BR_DIAGNOSISWC'},{av:'divCell_br_lab_Visible',ctrl:'CELL_BR_LAB',prop:'Visible'},{ctrl:'BR_LABWC'},{av:'divCell_br_medication_Visible',ctrl:'CELL_BR_MEDICATION',prop:'Visible'},{ctrl:'BR_MEDICATIONWC'},{av:'divCell_br_scheme_Visible',ctrl:'CELL_BR_SCHEME',prop:'Visible'},{ctrl:'BR_SCHEMEWC'},{av:'divCell_br_procedure_Visible',ctrl:'CELL_BR_PROCEDURE',prop:'Visible'},{ctrl:'BR_PROCEDUREWC'},{av:'divCell_br_medicalimaging_Visible',ctrl:'CELL_BR_MEDICALIMAGING',prop:'Visible'},{ctrl:'BR_MEDICALIMAGINGWC'},{av:'divCell_br_pathology_Visible',ctrl:'CELL_BR_PATHOLOGY',prop:'Visible'},{ctrl:'BR_PATHOLOGYWC'}]}");
         setEventMetadata("'BR_COMORBIDITY'","{handler:'E261X2',iparms:[{av:'A19BR_EncounterID',fld:'BR_ENCOUNTERID',pic:'ZZZZZZZZZZZZZZZZZZ'},{av:'AV10BR_EncounterID',fld:'vBR_ENCOUNTERID',pic:'ZZZZZZZZZZZZZZZZZZ',hsh:true},{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''}]");
         ...
         setEventMetadata("'BR_DEATH'","{handler:'E271X2',iparms:[{av:'A19BR_EncounterID',fld:'BR_ENCOUNTERID',pic:'ZZZZZZZZZZZZZZZZZZ'},{av:'AV10BR_EncounterID',fld:'vBR_ENCOUNTERID',pic:'ZZZZZZZZZZZZZZZZZZ',hsh:true},{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''}]");
         ...
         setEventMetadata("'BR_VITAL'","{handler:'E281X2',iparms:[{av:'A19BR_EncounterID',fld:'BR_ENCOUNTERID',pic:'ZZZZZZZZZZZZZZZZZZ'},{av:'AV10BR_EncounterID',fld:'vBR_ENCOUNTERID',pic:'ZZZZZZZZZZZZZZZZZZ',hsh:true},{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''}]");
         ...
         setEventMetadata("'BR_DIAGNOSIS'","{handler:'E291X2',iparms:[{av:'A19BR_EncounterID',fld:'BR_ENCOUNTERID',pic:'ZZZZZZZZZZZZZZZZZZ'},{av:'AV10BR_EncounterID',fld:'vBR_ENCOUNTERID',pic:'ZZZZZZZZZZZZZZZZZZ',hsh:true},{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''}]");
         ...
         setEventMetadata("'BR_LAB'","{handler:'E301X2',iparms:[{av:'A19BR_EncounterID',fld:'BR_ENCOUNTERID',pic:'ZZZZZZZZZZZZZZZZZZ'},{av:'AV10BR_EncounterID',fld:'vBR_ENCOUNTERID',pic:'ZZZZZZZZZZZZZZZZZZ',hsh:true},{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''}]");
         ...
         setEventMetadata("'BR_MEDICATION'","{handler:'E311X2',iparms:[{av:'A19BR_EncounterID',fld:'BR_ENCOUNTERID',pic:'ZZZZZZZZZZZZZZZZZZ'},{av:'AV10BR_EncounterID',fld:'vBR_ENCOUNTERID',pic:'ZZZZZZZZZZZZZZZZZZ',hsh:true},{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''}]");
         ...
         setEventMetadata("'BR_SCHEME'","{handler:'E321X2',iparms:[{av:'A19BR_EncounterID',fld:'BR_ENCOUNTERID',pic:'ZZZZZZZZZZZZZZZZZZ'},{av:'AV10BR_EncounterID',fld:'vBR_ENCOUNTERID',pic:'ZZZZZZZZZZZZZZZZZZ',hsh:true},{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''}]");
         ...
         setEventMetadata("'BR_PROCEDURE'","{handler:'E331X2',iparms:[{av:'A19BR_EncounterID',fld:'BR_ENCOUNTERID',pic:'ZZZZZZZZZZZZZZZZZZ'},{av:'AV10BR_EncounterID',fld:'vBR_ENCOUNTERID',pic:'ZZZZZZZZZZZZZZZZZZ',hsh:true},{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''}]");
         ...
         setEventMetadata("'BR_MEDICALIMAGING'","{handler:'E341X2',iparms:[{av:'A19BR_EncounterID',fld:'BR_ENCOUNTERID',pic:'ZZZZZZZZZZZZZZZZZZ'},{av:'AV10BR_EncounterID',fld:'vBR_ENCOUNTERID',pic:'ZZZZZZZZZZZZZZZZZZ',hsh:true},{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''}]");
         ...
         setEventMetadata("'BR_PATHOLOGY'","{handler:'E351X2',iparms:[{av:'A19BR_EncounterID',fld:'BR_ENCOUNTERID',pic:'ZZZZZZZZZZZZZZZZZZ'},{av:'AV10BR_EncounterID',fld:'vBR_ENCOUNTERID',pic:'ZZZZZZZZZZZZZZZZZZ',hsh:true},{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''}]");
