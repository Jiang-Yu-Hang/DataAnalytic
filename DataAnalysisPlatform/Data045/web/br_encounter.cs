/*
       ...
       Generated on: 2/28/2020 15:6:53.60
...
namespace GeneXus.Programs {
   public class br_encounter : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void INITTRN( )
      {
         ...
         else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxCallCrl"+"_"+"BR_ENCOUNTER_DEPARTMENTADM") == 0 )
         {
            AV30tCurrentCode = GetNextPar( );
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV30tCurrentCode", AV30tCurrentCode);
            setAjaxCallMode();
            ...
            GXDLABR_ENCOUNTER_DEPARTMENTADM0E15( AV30tCurrentCode) ;
            return  ;
         }
         else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxCallCrl"+"_"+"BR_ENCOUNTER_DEPARTMENTDISCH") == 0 )
         {
            AV30tCurrentCode = GetNextPar( );
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV30tCurrentCode", AV30tCurrentCode);
            setAjaxCallMode();
            ...
            GXDLABR_ENCOUNTER_DEPARTMENTDISCH0E15( AV30tCurrentCode) ;
            return  ;
         }
         ...
         else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxCallCrl"+"_"+"BR_ENCOUNTER_INSURANCE") == 0 )
         {
            AV30tCurrentCode = GetNextPar( );
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV30tCurrentCode", AV30tCurrentCode);
            setAjaxCallMode();
            ...
            GXDLABR_ENCOUNTER_INSURANCE0E15( AV30tCurrentCode) ;
            return  ;
         }
         ...
         else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxAggSel22"+"_"+"BR_ENCOUNTER_ENCID") == 0 )
         {
            ...
            GX22ASABR_ENCOUNTER_ENCID0E15( A85BR_Information_ID) ;
            return  ;
         }
         else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxAggSel27"+"_"+"BR_ENCOUNTER_DEPARTMENT_CODE") == 0 )
         {
            ...
            GX27ASABR_ENCOUNTER_DEPARTMENT_CODE0E15( A84BR_Encounter_Department) ;
            return  ;
         }
         else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxAggSel28"+"_"+"BR_ENCOUNTER_DEPARTMENT_CODE") == 0 )
         {
            A84BR_Encounter_Department = GetNextPar( );
            n84BR_Encounter_Department = false;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A84BR_Encounter_Department", A84BR_Encounter_Department);
            ...
            GX28ASABR_ENCOUNTER_DEPARTMENT_CODE0E15( A84BR_Encounter_Department) ;
            return  ;
         }
         else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxAggSel29"+"_"+"BR_ENCOUNTER_ENCTYPE_CODE") == 0 )
         {
            ...
            GX29ASABR_ENCOUNTER_ENCTYPE_CODE0E15( A90BR_Encounter_ENCType) ;
            return  ;
         }
         else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxAggSel30"+"_"+"BR_ENCOUNTER_ENCTYPE_CODE") == 0 )
         {
            A90BR_Encounter_ENCType = GetNextPar( );
            n90BR_Encounter_ENCType = false;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A90BR_Encounter_ENCType", A90BR_Encounter_ENCType);
            ...
            GX30ASABR_ENCOUNTER_ENCTYPE_CODE0E15( A90BR_Encounter_ENCType) ;
            return  ;
         }
         else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxAggSel31"+"_"+"BR_ENCOUNTER_ADMITSOURCE_CODE") == 0 )
         {
            ...
            GX31ASABR_ENCOUNTER_ADMITSOURCE_CODE0E15( A92BR_Encounter_AdmitSource) ;
            return  ;
         }
         else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxAggSel32"+"_"+"BR_ENCOUNTER_ADMITSOURCE_CODE") == 0 )
         {
            A92BR_Encounter_AdmitSource = GetNextPar( );
            n92BR_Encounter_AdmitSource = false;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A92BR_Encounter_AdmitSource", A92BR_Encounter_AdmitSource);
            ...
            GX32ASABR_ENCOUNTER_ADMITSOURCE_CODE0E15( A92BR_Encounter_AdmitSource) ;
            return  ;
         }
         else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxAggSel33"+"_"+"BR_ENCOUNTER_DISCHARGESTATUS_CODE") == 0 )
         {
            ...
            GX33ASABR_ENCOUNTER_DISCHARGESTATUS_CODE0E15( A94BR_Encounter_DischargeStatus) ;
            return  ;
         }
         else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxAggSel34"+"_"+"BR_ENCOUNTER_DISCHARGESTATUS_CODE") == 0 )
         {
            A94BR_Encounter_DischargeStatus = GetNextPar( );
            n94BR_Encounter_DischargeStatus = false;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A94BR_Encounter_DischargeStatus", A94BR_Encounter_DischargeStatus);
            ...
            GX34ASABR_ENCOUNTER_DISCHARGESTATUS_CODE0E15( A94BR_Encounter_DischargeStatus) ;
            return  ;
         }
         else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxExecAct_"+"gxLoad_57") == 0 )
         {
            ...
            gxLoad_57( A85BR_Information_ID) ;
            return  ;
         }
         else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxExecAct_"+"gxLoad_59") == 0 )
         {
            ...
            gxLoad_59( A85BR_Information_ID, A360BAS_TenantTenantCode) ;
            return  ;
         }
         else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxExecAct_"+"gxLoad_58") == 0 )
         {
            ...
            gxLoad_58( A360BAS_TenantTenantCode) ;
            return  ;
         }
      ...
      protected override void createObjects( )
      {
         ...
         dynBR_Encounter_Departmentadm = new GXCombobox();
         dynBR_Encounter_Departmentdisch = new GXCombobox();
         dynBR_Encounter_ENCType = new GXCombobox();
         dynBR_Encounter_Insurance = new GXCombobox();
      ...
      protected void fix_multi_value_controls( )
      {
         ...
         if ( dynBR_Encounter_Departmentadm.ItemCount > 0 )
         {
            A570BR_Encounter_Departmentadm = dynBR_Encounter_Departmentadm.getValidValue(A570BR_Encounter_Departmentadm);
         ...
         if ( context.isAjaxRequest( ) )
         {
            dynBR_Encounter_Departmentadm.CurrentValue = StringUtil.RTrim( A570BR_Encounter_Departmentadm);
            context.httpAjaxContext.ajax_rsp_assign_prop("", false, dynBR_Encounter_Departmentadm_Internalname, "Values", dynBR_Encounter_Departmentadm.ToJavascriptSource(), true);
         }
         if ( dynBR_Encounter_Departmentdisch.ItemCount > 0 )
         {
            A572BR_Encounter_Departmentdisch = dynBR_Encounter_Departmentdisch.getValidValue(A572BR_Encounter_Departmentdisch);
         ...
         if ( context.isAjaxRequest( ) )
         {
            dynBR_Encounter_Departmentdisch.CurrentValue = StringUtil.RTrim( A572BR_Encounter_Departmentdisch);
            context.httpAjaxContext.ajax_rsp_assign_prop("", false, dynBR_Encounter_Departmentdisch_Internalname, "Values", dynBR_Encounter_Departmentdisch.ToJavascriptSource(), true);
         }
         ...
         if ( dynBR_Encounter_Insurance.ItemCount > 0 )
         {
            A574BR_Encounter_Insurance = dynBR_Encounter_Insurance.getValidValue(A574BR_Encounter_Insurance);
         ...
         if ( context.isAjaxRequest( ) )
         {
            dynBR_Encounter_Insurance.CurrentValue = StringUtil.RTrim( A574BR_Encounter_Insurance);
            context.httpAjaxContext.ajax_rsp_assign_prop("", false, dynBR_Encounter_Insurance_Internalname, "Values", dynBR_Encounter_Insurance.ToJavascriptSource(), true);
         }
      ...
      protected void wb_table1_37_0E15e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-md-6 DataContentCell", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divTablesplittedbr_encounter_departmentadm_Internalname, 1, 0, "px", 0, "px", "Table", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-3 MergeLabelCell", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockbr_encounter_departmentadm_Internalname, "就诊入院科室", "", "", lblTextblockbr_encounter_departmentadm_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, "HLP_BR_Encounter.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-9", "left", "top", "", "", "div");
      ...
      protected void wb_table2_51_0E15e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-md-6 DataContentCell", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divTablesplittedbr_encounter_departmentdisch_Internalname, 1, 0, "px", 0, "px", "Table", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-3 MergeLabelCell", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockbr_encounter_departmentdisch_Internalname, "就诊出院科室", "", "", lblTextblockbr_encounter_departmentdisch_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, "HLP_BR_Encounter.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-9", "left", "top", "", "", "div");
            wb_table3_66_0E15( true) ;
         }
         return  ;
      }

      protected void wb_table3_66_0E15e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-9", "left", "top", "", "", "div");
            wb_table4_80_0E15( true) ;
         }
         return  ;
      }

      protected void wb_table4_80_0E15e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-md-6 DataContentCell", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divTablesplittedbr_encounter_insurance_Internalname, 1, 0, "px", 0, "px", "Table", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-3 MergeLabelCell", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockbr_encounter_insurance_Internalname, "就诊保险类型", "", "", lblTextblockbr_encounter_insurance_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, "HLP_BR_Encounter.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-9", "left", "top", "", "", "div");
            wb_table5_95_0E15( true) ;
         }
         return  ;
      }

      protected void wb_table5_95_0E15e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtBR_Encounter_AdmitDate_Internalname, context.localUtil.Format(A91BR_Encounter_AdmitDate, "9999/99/99"), context.localUtil.Format( A91BR_Encounter_AdmitDate, "9999/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'YMD',0,24,'chs',false,1);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,106);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtBR_Encounter_AdmitDate_Jsonclick, 0, "AttributeDate", "", "", "", "", 1, edtBR_Encounter_AdmitDate_Enabled, 0, "text", "", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, 0, true, "DM_Date", "right", false, "HLP_BR_Encounter.htm");
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-9", "left", "top", "", "", "div");
            wb_table6_114_0E15( true) ;
         }
         return  ;
      }

      protected void wb_table6_114_0E15e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtBR_Encounter_DischargeDate_Internalname, context.localUtil.Format(A93BR_Encounter_DischargeDate, "9999/99/99"), context.localUtil.Format( A93BR_Encounter_DischargeDate, "9999/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'YMD',0,24,'chs',false,1);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,125);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtBR_Encounter_DischargeDate_Jsonclick, 0, "AttributeDate", "", "", "", "", 1, edtBR_Encounter_DischargeDate_Enabled, 0, "text", "", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, 0, true, "DM_Date", "right", false, "HLP_BR_Encounter.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtBR_Encounter_CrtDate_Internalname, context.localUtil.TToC( A182BR_Encounter_CrtDate, 10, 8, 0, 0, "/", ":", " "), context.localUtil.Format( A182BR_Encounter_CrtDate, "9999/99/99 99:99:99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'YMD',8,24,'chs',false,1);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,146);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtBR_Encounter_CrtDate_Jsonclick, 0, "Attribute", "", "", "", "", edtBR_Encounter_CrtDate_Visible, edtBR_Encounter_CrtDate_Enabled, 0, "text", "", 19, "chr", 1, "row", 19, 0, 0, 0, 1, -1, 0, true, "UpdDate", "right", false, "HLP_BR_Encounter.htm");
      ...
      protected void wb_table6_114_0E15( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, dynBR_Encounter_AdmitSource, dynBR_Encounter_AdmitSource_Internalname, StringUtil.RTrim( A92BR_Encounter_AdmitSource), 1, dynBR_Encounter_AdmitSource_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "svchar", "", 1, dynBR_Encounter_AdmitSource.Enabled, 0, 0, 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,118);\"", "", true, "HLP_BR_Encounter.htm");
            dynBR_Encounter_AdmitSource.CurrentValue = StringUtil.RTrim( A92BR_Encounter_AdmitSource);
            ...
            GxWebStd.gx_single_line_edit( context, edtavVreason_Internalname, AV27vReason, StringUtil.RTrim( context.localUtil.Format( AV27vReason, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,121);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "请填写其他入院原因", edtavVreason_Jsonclick, 0, "Attribute", "", "", "", "", edtavVreason_Visible, edtavVreason_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 1, -1, -1, true, "", "left", true, "HLP_BR_Encounter.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table6_114_0E15e( true) ;
         }
         else
         {
            wb_table6_114_0E15e( false) ;
         }
      }

      protected void wb_table5_95_0E15( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            sStyleString = "";
            GxWebStd.gx_table_start( context, tblTablemergedbr_encounter_insurance_Internalname, tblTablemergedbr_encounter_insurance_Internalname, "", "TableMerged", 0, "", "", 0, 0, sStyleString, "", "", 0);
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td class='MergeDataCell'>") ;
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "left", "top", "", "", "div");
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, dynBR_Encounter_Insurance_Internalname, "就诊保险类型", "col-sm-3 AttributeLabel", 0, true);
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 99,'',false,'',0)\"";
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, dynBR_Encounter_Insurance, dynBR_Encounter_Insurance_Internalname, StringUtil.RTrim( A574BR_Encounter_Insurance), 1, dynBR_Encounter_Insurance_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "svchar", "", 1, dynBR_Encounter_Insurance.Enabled, 0, 0, 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,99);\"", "", true, "HLP_BR_Encounter.htm");
            dynBR_Encounter_Insurance.CurrentValue = StringUtil.RTrim( A574BR_Encounter_Insurance);
            context.httpAjaxContext.ajax_rsp_assign_prop("", false, dynBR_Encounter_Insurance_Internalname, "Values", (String)(dynBR_Encounter_Insurance.ToJavascriptSource()), true);
            GxWebStd.gx_div_end( context, "left", "top", "div");
            context.WriteHtmlText( "</td>") ;
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "left", "top", "", "", "div");
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavVinsurance_Internalname, "v Insurance", "col-sm-3 AttributeLabel", 0, true);
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 102,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavVinsurance_Internalname, AV32vInsurance, StringUtil.RTrim( context.localUtil.Format( AV32vInsurance, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,102);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "请填写其保险类型", edtavVinsurance_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavVinsurance_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 1, -1, -1, true, "", "left", true, "HLP_BR_Encounter.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table5_95_0E15e( true) ;
         }
         else
         {
            wb_table5_95_0E15e( false) ;
         }
      }

      protected void wb_table4_80_0E15( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            GxWebStd.gx_single_line_edit( context, edtavVenctype_Internalname, AV26vENCType, StringUtil.RTrim( context.localUtil.Format( AV26vENCType, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,87);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "请填写其它就诊方式", edtavVenctype_Jsonclick, 0, "Attribute", "", "", "", "", edtavVenctype_Visible, edtavVenctype_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 1, -1, -1, true, "", "left", true, "HLP_BR_Encounter.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table4_80_0E15e( true) ;
         }
         else
         {
            wb_table4_80_0E15e( false) ;
         }
      }

      protected void wb_table3_66_0E15( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            sStyleString = "";
            GxWebStd.gx_table_start( context, tblTablemergedbr_encounter_departmentdisch_Internalname, tblTablemergedbr_encounter_departmentdisch_Internalname, "", "TableMerged", 0, "", "", 0, 0, sStyleString, "", "", 0);
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td class='MergeDataCell'>") ;
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "left", "top", "", "", "div");
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, dynBR_Encounter_Departmentdisch_Internalname, "就诊出院科室", "col-sm-3 AttributeLabel", 0, true);
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 70,'',false,'',0)\"";
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, dynBR_Encounter_Departmentdisch, dynBR_Encounter_Departmentdisch_Internalname, StringUtil.RTrim( A572BR_Encounter_Departmentdisch), 1, dynBR_Encounter_Departmentdisch_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "svchar", "", 1, dynBR_Encounter_Departmentdisch.Enabled, 0, 0, 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,70);\"", "", true, "HLP_BR_Encounter.htm");
            dynBR_Encounter_Departmentdisch.CurrentValue = StringUtil.RTrim( A572BR_Encounter_Departmentdisch);
            context.httpAjaxContext.ajax_rsp_assign_prop("", false, dynBR_Encounter_Departmentdisch_Internalname, "Values", (String)(dynBR_Encounter_Departmentdisch.ToJavascriptSource()), true);
            GxWebStd.gx_div_end( context, "left", "top", "div");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td class='DataContentCell'>") ;
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "left", "top", "", "", "div");
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavVdepartmentdisch_Internalname, "v Departmentdisch", "col-sm-3 AttributeLabel", 0, true);
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 73,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavVdepartmentdisch_Internalname, AV33vDepartmentdisch, StringUtil.RTrim( context.localUtil.Format( AV33vDepartmentdisch, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,73);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "请填写其他出院科室", edtavVdepartmentdisch_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavVdepartmentdisch_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 1, -1, -1, true, "", "left", true, "HLP_BR_Encounter.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table3_66_0E15e( true) ;
         }
         else
         {
            wb_table3_66_0E15e( false) ;
         }
      }
      ...
      protected void wb_table2_51_0E15( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            sStyleString = "";
            GxWebStd.gx_table_start( context, tblTablemergedbr_encounter_departmentadm_Internalname, tblTablemergedbr_encounter_departmentadm_Internalname, "", "TableMerged", 0, "", "", 0, 0, sStyleString, "", "", 0);
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td class='MergeDataCell'>") ;
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "left", "top", "", "", "div");
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, dynBR_Encounter_Departmentadm_Internalname, "就诊入院科室", "col-sm-3 AttributeLabel", 0, true);
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 55,'',false,'',0)\"";
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, dynBR_Encounter_Departmentadm, dynBR_Encounter_Departmentadm_Internalname, StringUtil.RTrim( A570BR_Encounter_Departmentadm), 1, dynBR_Encounter_Departmentadm_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "svchar", "", 1, dynBR_Encounter_Departmentadm.Enabled, 0, 0, 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,55);\"", "", true, "HLP_BR_Encounter.htm");
            dynBR_Encounter_Departmentadm.CurrentValue = StringUtil.RTrim( A570BR_Encounter_Departmentadm);
            context.httpAjaxContext.ajax_rsp_assign_prop("", false, dynBR_Encounter_Departmentadm_Internalname, "Values", (String)(dynBR_Encounter_Departmentadm.ToJavascriptSource()), true);
            GxWebStd.gx_div_end( context, "left", "top", "div");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td id=\""+cellVdepartmentadm_cell_Internalname+"\"  class='"+cellVdepartmentadm_cell_Class+"'>") ;
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "left", "top", "", "", "div");
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavVdepartmentadm_Internalname, "v Departmentadm", "col-sm-3 AttributeLabel", 0, true);
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 58,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavVdepartmentadm_Internalname, AV31vDepartmentadm, StringUtil.RTrim( context.localUtil.Format( AV31vDepartmentadm, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,58);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "请填写其他入院科室", edtavVdepartmentadm_Jsonclick, 0, "Attribute", "", "", "", "", edtavVdepartmentadm_Visible, edtavVdepartmentadm_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 1, -1, -1, true, "", "left", true, "HLP_BR_Encounter.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
      ...
      protected void standaloneStartupServer( )
      {
         ...
         if ( AnyError == 0 )
         {
            if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
            {
               ...
               dynBR_Encounter_Departmentadm.CurrentValue = cgiGet( dynBR_Encounter_Departmentadm_Internalname);
               A570BR_Encounter_Departmentadm = cgiGet( dynBR_Encounter_Departmentadm_Internalname);
               n570BR_Encounter_Departmentadm = false;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A570BR_Encounter_Departmentadm", A570BR_Encounter_Departmentadm);
               n570BR_Encounter_Departmentadm = (String.IsNullOrEmpty(StringUtil.RTrim( A570BR_Encounter_Departmentadm)) ? true : false);
               AV31vDepartmentadm = cgiGet( edtavVdepartmentadm_Internalname);
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV31vDepartmentadm", AV31vDepartmentadm);
               dynBR_Encounter_Departmentdisch.CurrentValue = cgiGet( dynBR_Encounter_Departmentdisch_Internalname);
               A572BR_Encounter_Departmentdisch = cgiGet( dynBR_Encounter_Departmentdisch_Internalname);
               n572BR_Encounter_Departmentdisch = false;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A572BR_Encounter_Departmentdisch", A572BR_Encounter_Departmentdisch);
               n572BR_Encounter_Departmentdisch = (String.IsNullOrEmpty(StringUtil.RTrim( A572BR_Encounter_Departmentdisch)) ? true : false);
               AV33vDepartmentdisch = cgiGet( edtavVdepartmentdisch_Internalname);
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV33vDepartmentdisch", AV33vDepartmentdisch);
               ...
               dynBR_Encounter_Insurance.CurrentValue = cgiGet( dynBR_Encounter_Insurance_Internalname);
               A574BR_Encounter_Insurance = cgiGet( dynBR_Encounter_Insurance_Internalname);
               n574BR_Encounter_Insurance = false;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A574BR_Encounter_Insurance", A574BR_Encounter_Insurance);
               n574BR_Encounter_Insurance = (String.IsNullOrEmpty(StringUtil.RTrim( A574BR_Encounter_Insurance)) ? true : false);
               AV32vInsurance = cgiGet( edtavVinsurance_Internalname);
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV32vInsurance", AV32vInsurance);
      ...
      protected void disable_std_buttons( )
      {
         ...
         context.httpAjaxContext.ajax_rsp_assign_prop("", false, edtavVdepartmentadm_Internalname, "Enabled", StringUtil.LTrim( StringUtil.Str( (decimal)(edtavVdepartmentadm_Enabled), 5, 0)), true);
         context.httpAjaxContext.ajax_rsp_assign_prop("", false, edtavVdepartmentdisch_Internalname, "Enabled", StringUtil.LTrim( StringUtil.Str( (decimal)(edtavVdepartmentdisch_Enabled), 5, 0)), true);
         ...
         context.httpAjaxContext.ajax_rsp_assign_prop("", false, edtavVinsurance_Internalname, "Enabled", StringUtil.LTrim( StringUtil.Str( (decimal)(edtavVinsurance_Enabled), 5, 0)), true);
      ...
      protected void E110E2( )
      {
         ...
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV30tCurrentCode", AV30tCurrentCode);
         AV34Pgmdesc = "Data Mgmt Portal -RAAP";
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV34Pgmdesc", AV34Pgmdesc);
         ...
         {
            AV36GXV1 = 1;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV36GXV1", StringUtil.LTrim( StringUtil.Str( (decimal)(AV36GXV1), 8, 0)));
            while ( AV36GXV1 <= AV11TrnContext.gxTpr_Attributes.Count )
            {
               AV12TrnContextAtt = ((GeneXus.Programs.wwpbaseobjects.SdtWWPTransactionContext_Attribute)AV11TrnContext.gxTpr_Attributes.Item(AV36GXV1));
      ...
      protected void S112( )
      {
         ...
         edtavVdepartmentadm_Visible = 0;
         context.httpAjaxContext.ajax_rsp_assign_prop("", false, edtavVdepartmentadm_Internalname, "Visible", StringUtil.LTrim( StringUtil.Str( (decimal)(edtavVdepartmentadm_Visible), 5, 0)), true);
         cellVdepartmentadm_cell_Class = "Invisible";
         context.httpAjaxContext.ajax_rsp_assign_prop("", false, cellVdepartmentadm_cell_Internalname, "Class", cellVdepartmentadm_cell_Class, true);
      ...
      protected void standaloneNotModal( )
      {
         ...
         GXABR_ENCOUNTER_DEPARTMENTADM_html0E15( AV30tCurrentCode) ;
         GXABR_ENCOUNTER_DEPARTMENTDISCH_html0E15( AV30tCurrentCode) ;
         GXABR_ENCOUNTER_ENCTYPE_html0E15( AV30tCurrentCode) ;
         GXABR_ENCOUNTER_INSURANCE_html0E15( AV30tCurrentCode) ;
      ...
      protected void standaloneModal( )
      {
         ...
         {
            AV35Pgmname = "BR_Encounter";
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV35Pgmname", AV35Pgmname);
            AV34Pgmdesc = "就诊信息";
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV34Pgmdesc", AV34Pgmdesc);
            ...
            edtavVdepartmentadm_Visible = ((StringUtil.StrCmp(A84BR_Encounter_Department, "其它")==0) ? 1 : 0);
            context.httpAjaxContext.ajax_rsp_assign_prop("", false, edtavVdepartmentadm_Internalname, "Visible", StringUtil.LTrim( StringUtil.Str( (decimal)(edtavVdepartmentadm_Visible), 5, 0)), true);
            if ( ! ( ( StringUtil.StrCmp(A84BR_Encounter_Department, "其它") == 0 ) ) )
            {
               cellVdepartmentadm_cell_Class = "Invisible";
            ...
            {
               if ( ( StringUtil.StrCmp(A84BR_Encounter_Department, "其它") == 0 ) && ! ( ( StringUtil.StrCmp(A570BR_Encounter_Departmentadm, "其它") == 0 ) ) )
               {
                  cellVdepartmentadm_cell_Class = "DataContentCell";
                  context.httpAjaxContext.ajax_rsp_assign_prop("", false, cellVdepartmentadm_cell_Internalname, "Class", cellVdepartmentadm_cell_Class, true);
               }
               else
               {
                  if ( ( StringUtil.StrCmp(A84BR_Encounter_Department, "其它") == 0 ) && ( ( StringUtil.StrCmp(A570BR_Encounter_Departmentadm, "其它") == 0 ) ) )
                  {
                     cellVdepartmentadm_cell_Class = "RequiredDataContentCell";
                     context.httpAjaxContext.ajax_rsp_assign_prop("", false, cellVdepartmentadm_cell_Internalname, "Class", cellVdepartmentadm_cell_Class, true);
                  }
               }
            }
      ...
      protected void CheckExtendedTable0E15( )
      {
         ...
         {
            GX_msglist.addItem("域就诊/入院时间超界", "OutOfRange", 1, "BR_ENCOUNTER_ADMITDATE");
            AnyError = 1;
            GX_FocusControl = edtBR_Encounter_AdmitDate_Internalname;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "GX_FocusControl", GX_FocusControl);
         }
         ...
         {
            GX_msglist.addItem("域出院时间超界", "OutOfRange", 1, "BR_ENCOUNTER_DISCHARGEDATE");
            AnyError = 1;
            GX_FocusControl = edtBR_Encounter_DischargeDate_Internalname;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "GX_FocusControl", GX_FocusControl);
         }
         ...
         {
            GX_msglist.addItem("域审批状态超界", "OutOfRange", 1, "BR_ENCOUNTER_STATUS");
            AnyError = 1;
         ...
         {
            GX_msglist.addItem("域创建时间超界", "OutOfRange", 1, "BR_ENCOUNTER_CRTDATE");
            AnyError = 1;
            GX_FocusControl = edtBR_Encounter_CrtDate_Internalname;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "GX_FocusControl", GX_FocusControl);
         }
         ...
         {
            GX_msglist.addItem("域修改时间超界", "OutOfRange", 1, "BR_ENCOUNTER_UPDDATE");
            AnyError = 1;
            GX_FocusControl = edtBR_Encounter_UpdDate_Internalname;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "GX_FocusControl", GX_FocusControl);
         }
         ...
         if ( ( ( StringUtil.StrCmp(A570BR_Encounter_Departmentadm, "其它") == 0 ) ) && String.IsNullOrEmpty(StringUtil.RTrim( AV31vDepartmentadm)) )
         {
            GX_msglist.addItem("其他入院科室是必填的", 1, "BR_ENCOUNTER_DEPARTMENTADM");
            AnyError = 1;
            GX_FocusControl = dynBR_Encounter_Departmentadm_Internalname;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "GX_FocusControl", GX_FocusControl);
         }
      ...
      protected void gxLoad_57( long A85BR_Information_ID )
      {
         /* Using cursor T000E8 */
      ...
      protected void gxLoad_59( long A85BR_Information_ID ,
      ...
      protected void gxLoad_58( String A360BAS_TenantTenantCode )
      {
      ...
      protected void OnDeleteControls0E15( )
      {
         ...
         if ( AnyError == 0 )
         {
            ...
            {
               GX_msglist.addItem(context.GetMessage( "GXM_del", new   object[]  {"家族史"}), "CannotDeleteReferencedRecord", 1, "");
               AnyError = 1;
            }
            pr_default.close(14);
      ...
      public void ScanStart0E15( )
      {
         ...
         {
            RcdFound15 = 1;
            A19BR_EncounterID = T000E33_A19BR_EncounterID[0];
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A19BR_EncounterID", StringUtil.LTrim( StringUtil.Str( (decimal)(A19BR_EncounterID), 18, 0)));
            n19BR_EncounterID = T000E33_n19BR_EncounterID[0];
         }
      ...
      protected void BeforeInsert0E15( )
      {
         ...
         if ( StringUtil.StrCmp(A574BR_Encounter_Insurance, "其它") == 0 )
         {
            A574BR_Encounter_Insurance = AV32vInsurance;
            n574BR_Encounter_Insurance = false;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A574BR_Encounter_Insurance", A574BR_Encounter_Insurance);
         }
         if ( StringUtil.StrCmp(A572BR_Encounter_Departmentdisch, "其它") == 0 )
         {
            A572BR_Encounter_Departmentdisch = AV33vDepartmentdisch;
            n572BR_Encounter_Departmentdisch = false;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A572BR_Encounter_Departmentdisch", A572BR_Encounter_Departmentdisch);
         }
         if ( StringUtil.StrCmp(A570BR_Encounter_Departmentadm, "其它") == 0 )
         {
            A570BR_Encounter_Departmentadm = AV31vDepartmentadm;
            n570BR_Encounter_Departmentadm = false;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A570BR_Encounter_Departmentadm", A570BR_Encounter_Departmentadm);
         }
      }
      ...
      protected void DisableAttributes0E15( )
      {
         ...
         context.httpAjaxContext.ajax_rsp_assign_prop("", false, edtavVdepartment_Internalname, "Enabled", StringUtil.LTrim( StringUtil.Str( (decimal)(edtavVdepartment_Enabled), 5, 0)), true);
         dynBR_Encounter_Departmentadm.Enabled = 0;
         context.httpAjaxContext.ajax_rsp_assign_prop("", false, dynBR_Encounter_Departmentadm_Internalname, "Enabled", StringUtil.LTrim( StringUtil.Str( (decimal)(dynBR_Encounter_Departmentadm.Enabled), 5, 0)), true);
         edtavVdepartmentadm_Enabled = 0;
         context.httpAjaxContext.ajax_rsp_assign_prop("", false, edtavVdepartmentadm_Internalname, "Enabled", StringUtil.LTrim( StringUtil.Str( (decimal)(edtavVdepartmentadm_Enabled), 5, 0)), true);
         dynBR_Encounter_Departmentdisch.Enabled = 0;
         context.httpAjaxContext.ajax_rsp_assign_prop("", false, dynBR_Encounter_Departmentdisch_Internalname, "Enabled", StringUtil.LTrim( StringUtil.Str( (decimal)(dynBR_Encounter_Departmentdisch.Enabled), 5, 0)), true);
         edtavVdepartmentdisch_Enabled = 0;
         context.httpAjaxContext.ajax_rsp_assign_prop("", false, edtavVdepartmentdisch_Internalname, "Enabled", StringUtil.LTrim( StringUtil.Str( (decimal)(edtavVdepartmentdisch_Enabled), 5, 0)), true);
         ...
         context.httpAjaxContext.ajax_rsp_assign_prop("", false, edtavVenctype_Internalname, "Enabled", StringUtil.LTrim( StringUtil.Str( (decimal)(edtavVenctype_Enabled), 5, 0)), true);
         dynBR_Encounter_Insurance.Enabled = 0;
         context.httpAjaxContext.ajax_rsp_assign_prop("", false, dynBR_Encounter_Insurance_Internalname, "Enabled", StringUtil.LTrim( StringUtil.Str( (decimal)(dynBR_Encounter_Insurance.Enabled), 5, 0)), true);
         edtavVinsurance_Enabled = 0;
         context.httpAjaxContext.ajax_rsp_assign_prop("", false, edtavVinsurance_Internalname, "Enabled", StringUtil.LTrim( StringUtil.Str( (decimal)(edtavVinsurance_Enabled), 5, 0)), true);
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202022815725", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vPGMDESC", StringUtil.RTrim( AV34Pgmdesc));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202022815731", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("br_encounter.js", "?202022815731", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false);
      ...
      protected void init_default_properties( )
      {
         ...
         lblTextblockbr_encounter_departmentadm_Internalname = "TEXTBLOCKBR_ENCOUNTER_DEPARTMENTADM";
         dynBR_Encounter_Departmentadm_Internalname = "BR_ENCOUNTER_DEPARTMENTADM";
         edtavVdepartmentadm_Internalname = "vVDEPARTMENTADM";
         cellVdepartmentadm_cell_Internalname = "VDEPARTMENTADM_CELL";
         tblTablemergedbr_encounter_departmentadm_Internalname = "TABLEMERGEDBR_ENCOUNTER_DEPARTMENTADM";
         divTablesplittedbr_encounter_departmentadm_Internalname = "TABLESPLITTEDBR_ENCOUNTER_DEPARTMENTADM";
         lblTextblockbr_encounter_departmentdisch_Internalname = "TEXTBLOCKBR_ENCOUNTER_DEPARTMENTDISCH";
         dynBR_Encounter_Departmentdisch_Internalname = "BR_ENCOUNTER_DEPARTMENTDISCH";
         edtavVdepartmentdisch_Internalname = "vVDEPARTMENTDISCH";
         tblTablemergedbr_encounter_departmentdisch_Internalname = "TABLEMERGEDBR_ENCOUNTER_DEPARTMENTDISCH";
         divTablesplittedbr_encounter_departmentdisch_Internalname = "TABLESPLITTEDBR_ENCOUNTER_DEPARTMENTDISCH";
         ...
         lblTextblockbr_encounter_insurance_Internalname = "TEXTBLOCKBR_ENCOUNTER_INSURANCE";
         dynBR_Encounter_Insurance_Internalname = "BR_ENCOUNTER_INSURANCE";
         edtavVinsurance_Internalname = "vVINSURANCE";
         tblTablemergedbr_encounter_insurance_Internalname = "TABLEMERGEDBR_ENCOUNTER_INSURANCE";
         divTablesplittedbr_encounter_insurance_Internalname = "TABLESPLITTEDBR_ENCOUNTER_INSURANCE";
      ...
      public override void initialize_properties( )
      {
         ...
         edtavVdepartmentadm_Jsonclick = "";
         edtavVdepartmentadm_Enabled = 1;
         edtavVdepartmentadm_Visible = 1;
         cellVdepartmentadm_cell_Class = "";
         dynBR_Encounter_Departmentadm_Jsonclick = "";
         dynBR_Encounter_Departmentadm.Enabled = 1;
         edtavVdepartmentdisch_Jsonclick = "";
         edtavVdepartmentdisch_Enabled = 1;
         dynBR_Encounter_Departmentdisch_Jsonclick = "";
         dynBR_Encounter_Departmentdisch.Enabled = 1;
         ...
         edtavVinsurance_Enabled = 1;
         dynBR_Encounter_Insurance_Jsonclick = "";
         dynBR_Encounter_Insurance.Enabled = 1;
      ...
      protected void GXDLABR_ENCOUNTER_DEPARTMENTADM0E15( String AV30tCurrentCode )
      {
         if ( ! context.isAjaxRequest( ) )
         {
            context.GX_webresponse.AppendHeader("Cache-Control", "no-store");
         ...
         context.GX_webresponse.AddString("[[");
         GXDLABR_ENCOUNTER_DEPARTMENTADM_data0E15( AV30tCurrentCode) ;
         gxdynajaxindex = 1;
         while ( gxdynajaxindex <= gxdynajaxctrlcodr.Count )
         {
            context.GX_webresponse.AddString(gxwrpcisep+"{\"c\":\""+GXUtil.EncodeJSConstant( ((String)gxdynajaxctrlcodr.Item(gxdynajaxindex)))+"\",\"d\":\""+GXUtil.EncodeJSConstant( ((String)gxdynajaxctrldescr.Item(gxdynajaxindex)))+"\"}");
      ...
      protected void GXABR_ENCOUNTER_DEPARTMENTADM_html0E15( String AV30tCurrentCode )
      {
         String gxdynajaxvalue ;
         GXDLABR_ENCOUNTER_DEPARTMENTADM_data0E15( AV30tCurrentCode) ;
         gxdynajaxindex = 1;
         if ( ! ( gxdyncontrolsrefreshing && context.isAjaxRequest( ) ) )
         {
            dynBR_Encounter_Departmentadm.removeAllItems();
         }
         while ( gxdynajaxindex <= gxdynajaxctrlcodr.Count )
         {
            gxdynajaxvalue = ((String)gxdynajaxctrlcodr.Item(gxdynajaxindex));
            dynBR_Encounter_Departmentadm.addItem(gxdynajaxvalue, ((String)gxdynajaxctrldescr.Item(gxdynajaxindex)), 0);
            gxdynajaxindex = (int)(gxdynajaxindex+1);
         }
      }

      protected void GXDLABR_ENCOUNTER_DEPARTMENTADM_data0E15( String AV30tCurrentCode )
      {
         gxdynajaxctrlcodr.Clear();
         gxdynajaxctrldescr.Clear();
         gxdynajaxctrlcodr.Add("");
      ...
      protected void GXDLABR_ENCOUNTER_DEPARTMENTDISCH0E15( String AV30tCurrentCode )
      {
         if ( ! context.isAjaxRequest( ) )
         {
            context.GX_webresponse.AppendHeader("Cache-Control", "no-store");
         ...
         context.GX_webresponse.AddString("[[");
         GXDLABR_ENCOUNTER_DEPARTMENTDISCH_data0E15( AV30tCurrentCode) ;
         gxdynajaxindex = 1;
         while ( gxdynajaxindex <= gxdynajaxctrlcodr.Count )
         {
            context.GX_webresponse.AddString(gxwrpcisep+"{\"c\":\""+GXUtil.EncodeJSConstant( ((String)gxdynajaxctrlcodr.Item(gxdynajaxindex)))+"\",\"d\":\""+GXUtil.EncodeJSConstant( ((String)gxdynajaxctrldescr.Item(gxdynajaxindex)))+"\"}");
      ...
      protected void GXABR_ENCOUNTER_DEPARTMENTDISCH_html0E15( String AV30tCurrentCode )
      {
         String gxdynajaxvalue ;
         GXDLABR_ENCOUNTER_DEPARTMENTDISCH_data0E15( AV30tCurrentCode) ;
         gxdynajaxindex = 1;
         if ( ! ( gxdyncontrolsrefreshing && context.isAjaxRequest( ) ) )
         {
            dynBR_Encounter_Departmentdisch.removeAllItems();
         }
         while ( gxdynajaxindex <= gxdynajaxctrlcodr.Count )
         {
            gxdynajaxvalue = ((String)gxdynajaxctrlcodr.Item(gxdynajaxindex));
            dynBR_Encounter_Departmentdisch.addItem(gxdynajaxvalue, ((String)gxdynajaxctrldescr.Item(gxdynajaxindex)), 0);
            gxdynajaxindex = (int)(gxdynajaxindex+1);
         }
      }

      protected void GXDLABR_ENCOUNTER_DEPARTMENTDISCH_data0E15( String AV30tCurrentCode )
      {
         gxdynajaxctrlcodr.Clear();
         gxdynajaxctrldescr.Clear();
         gxdynajaxctrlcodr.Add("");
      ...
      protected void GXDLABR_ENCOUNTER_ENCTYPE_data0E15( String AV30tCurrentCode )
      {
         ...
         pr_default.execute(33, new Object[] {AV30tCurrentCode});
         while ( (pr_default.getStatus(33) != 101) )
         {
            gxdynajaxctrlcodr.Add(T000E37_A168XT_DefineCodeName[0]);
            gxdynajaxctrldescr.Add(T000E37_A168XT_DefineCodeName[0]);
            pr_default.readNext(33);
         }
         pr_default.close(33);
      }

      protected void GXDLABR_ENCOUNTER_INSURANCE0E15( String AV30tCurrentCode )
      {
         if ( ! context.isAjaxRequest( ) )
         {
            context.GX_webresponse.AppendHeader("Cache-Control", "no-store");
         ...
         context.GX_webresponse.AddString("[[");
         GXDLABR_ENCOUNTER_INSURANCE_data0E15( AV30tCurrentCode) ;
         gxdynajaxindex = 1;
         while ( gxdynajaxindex <= gxdynajaxctrlcodr.Count )
         {
            context.GX_webresponse.AddString(gxwrpcisep+"{\"c\":\""+GXUtil.EncodeJSConstant( ((String)gxdynajaxctrlcodr.Item(gxdynajaxindex)))+"\",\"d\":\""+GXUtil.EncodeJSConstant( ((String)gxdynajaxctrldescr.Item(gxdynajaxindex)))+"\"}");
      ...
      protected void GXABR_ENCOUNTER_INSURANCE_html0E15( String AV30tCurrentCode )
      {
         String gxdynajaxvalue ;
         GXDLABR_ENCOUNTER_INSURANCE_data0E15( AV30tCurrentCode) ;
         gxdynajaxindex = 1;
         if ( ! ( gxdyncontrolsrefreshing && context.isAjaxRequest( ) ) )
         {
            dynBR_Encounter_Insurance.removeAllItems();
         }
         while ( gxdynajaxindex <= gxdynajaxctrlcodr.Count )
         {
            gxdynajaxvalue = ((String)gxdynajaxctrlcodr.Item(gxdynajaxindex));
            dynBR_Encounter_Insurance.addItem(gxdynajaxvalue, ((String)gxdynajaxctrldescr.Item(gxdynajaxindex)), 0);
            gxdynajaxindex = (int)(gxdynajaxindex+1);
         }
      }

      protected void GXDLABR_ENCOUNTER_INSURANCE_data0E15( String AV30tCurrentCode )
      {
         gxdynajaxctrlcodr.Clear();
         gxdynajaxctrldescr.Clear();
         gxdynajaxctrlcodr.Add("");
         gxdynajaxctrldescr.Add("(请选择)");
         /* Using cursor T000E38 */
         pr_default.execute(34, new Object[] {AV30tCurrentCode});
         while ( (pr_default.getStatus(34) != 101) )
         {
            gxdynajaxctrlcodr.Add(T000E38_A168XT_DefineCodeName[0]);
            gxdynajaxctrldescr.Add(T000E38_A168XT_DefineCodeName[0]);
      ...
      protected void GXDLABR_ENCOUNTER_ADMITSOURCE_data0E15( String AV30tCurrentCode )
      {
         ...
         gxdynajaxctrlcodr.Add("");
         gxdynajaxctrldescr.Add("(请选择)");
         /* Using cursor T000E39 */
         pr_default.execute(35, new Object[] {AV30tCurrentCode});
         while ( (pr_default.getStatus(35) != 101) )
         {
            gxdynajaxctrlcodr.Add(T000E39_A168XT_DefineCodeName[0]);
            gxdynajaxctrldescr.Add(T000E39_A168XT_DefineCodeName[0]);
      ...
      protected void GXDLABR_ENCOUNTER_DISCHARGESTATUS_data0E15( String AV30tCurrentCode )
      {
         ...
         gxdynajaxctrlcodr.Add("");
         gxdynajaxctrldescr.Add("(请选择)");
         /* Using cursor T000E40 */
         pr_default.execute(36, new Object[] {AV30tCurrentCode});
         while ( (pr_default.getStatus(36) != 101) )
         {
            gxdynajaxctrlcodr.Add(T000E40_A168XT_DefineCodeName[0]);
            gxdynajaxctrldescr.Add(T000E40_A168XT_DefineCodeName[0]);
      ...
      protected void GX22ASABR_ENCOUNTER_ENCID0E15( long A85BR_Information_ID )
      {
         GXt_int3 = A35BR_Encounter_EncID;
         new zutil_findcountbypatientno(context ).execute(  A85BR_Information_ID, out  GXt_int3) ;
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A85BR_Information_ID", StringUtil.LTrim( StringUtil.Str( (decimal)(A85BR_Information_ID), 18, 0)));
      ...
      protected void GX27ASABR_ENCOUNTER_DEPARTMENT_CODE0E15( String A84BR_Encounter_Department )
      {
         GXt_char1 = A470BR_Encounter_Department_Code;
         new zutil_findtargetcode(context ).execute(  3,  A84BR_Encounter_Department, out  GXt_char1) ;
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A84BR_Encounter_Department", A84BR_Encounter_Department);
      ...
      protected void GX28ASABR_ENCOUNTER_DEPARTMENT_CODE0E15( String A84BR_Encounter_Department )
      {
         GXt_char1 = A470BR_Encounter_Department_Code;
         new zutil_findtargetcode(context ).execute(  3,  A84BR_Encounter_Department, out  GXt_char1) ;
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A84BR_Encounter_Department", A84BR_Encounter_Department);
      ...
      protected void GX29ASABR_ENCOUNTER_ENCTYPE_CODE0E15( String A90BR_Encounter_ENCType )
      {
         GXt_char1 = A471BR_Encounter_ENCType_Code;
         new zutil_findtargetcode(context ).execute(  4,  A90BR_Encounter_ENCType, out  GXt_char1) ;
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A90BR_Encounter_ENCType", A90BR_Encounter_ENCType);
      ...
      protected void GX30ASABR_ENCOUNTER_ENCTYPE_CODE0E15( String A90BR_Encounter_ENCType )
      {
         GXt_char1 = A471BR_Encounter_ENCType_Code;
         new zutil_findtargetcode(context ).execute(  4,  A90BR_Encounter_ENCType, out  GXt_char1) ;
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A90BR_Encounter_ENCType", A90BR_Encounter_ENCType);
      ...
      protected void GX31ASABR_ENCOUNTER_ADMITSOURCE_CODE0E15( String A92BR_Encounter_AdmitSource )
      {
         GXt_char1 = A472BR_Encounter_AdmitSource_Code;
         new zutil_findtargetcode(context ).execute(  5,  A92BR_Encounter_AdmitSource, out  GXt_char1) ;
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A92BR_Encounter_AdmitSource", A92BR_Encounter_AdmitSource);
      ...
      protected void GX32ASABR_ENCOUNTER_ADMITSOURCE_CODE0E15( String A92BR_Encounter_AdmitSource )
      {
         GXt_char1 = A472BR_Encounter_AdmitSource_Code;
         new zutil_findtargetcode(context ).execute(  5,  A92BR_Encounter_AdmitSource, out  GXt_char1) ;
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A92BR_Encounter_AdmitSource", A92BR_Encounter_AdmitSource);
      ...
      protected void GX33ASABR_ENCOUNTER_DISCHARGESTATUS_CODE0E15( String A94BR_Encounter_DischargeStatus )
      {
         GXt_char1 = A473BR_Encounter_DischargeStatus_Code;
         new zutil_findtargetcode(context ).execute(  6,  A94BR_Encounter_DischargeStatus, out  GXt_char1) ;
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A94BR_Encounter_DischargeStatus", A94BR_Encounter_DischargeStatus);
      ...
      protected void GX34ASABR_ENCOUNTER_DISCHARGESTATUS_CODE0E15( String A94BR_Encounter_DischargeStatus )
      {
         GXt_char1 = A473BR_Encounter_DischargeStatus_Code;
         new zutil_findtargetcode(context ).execute(  6,  A94BR_Encounter_DischargeStatus, out  GXt_char1) ;
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A94BR_Encounter_DischargeStatus", A94BR_Encounter_DischargeStatus);
      ...
      protected void init_web_controls( )
      {
         ...
         dynBR_Encounter_Departmentadm.Name = "BR_ENCOUNTER_DEPARTMENTADM";
         dynBR_Encounter_Departmentadm.WebTags = "";
         dynBR_Encounter_Departmentdisch.Name = "BR_ENCOUNTER_DEPARTMENTDISCH";
         dynBR_Encounter_Departmentdisch.WebTags = "";
         dynBR_Encounter_ENCType.Name = "BR_ENCOUNTER_ENCTYPE";
         dynBR_Encounter_ENCType.WebTags = "";
         dynBR_Encounter_Insurance.Name = "BR_ENCOUNTER_INSURANCE";
         dynBR_Encounter_Insurance.WebTags = "";
                                           ...
                                           String GX_Parm2 )
      {
         ...
         pr_default.execute(37, new Object[] {n85BR_Information_ID, A85BR_Information_ID});
         ...
         A36BR_Information_PatientNo = T000E41_A36BR_Information_PatientNo[0];
         n36BR_Information_PatientNo = T000E41_n36BR_Information_PatientNo[0];
         pr_default.close(37);
         if ( (0==A85BR_Information_ID) )
         {
            GX_msglist.addItem("患者是必须选择的", 1, "BR_INFORMATION_ID");
      ...
      public override void initialize( )
      {
         ...
         lblTextblockbr_encounter_departmentadm_Jsonclick = "";
         lblTextblockbr_encounter_departmentdisch_Jsonclick = "";
         lblTextblockbr_encounter_enctype_Jsonclick = "";
         lblTextblockbr_encounter_insurance_Jsonclick = "";
         A91BR_Encounter_AdmitDate = DateTime.MinValue;
         ...
         T000E18_A576BR_FamilyhistoryID = new long[1] ;
         T000E19_A348BR_Encounter_RefuseReasonID = new long[1] ;
         T000E20_A347BR_Encounter_ID = new long[1] ;
         T000E21_A327BR_SchemeID = new long[1] ;
         T000E22_A226BR_PathologyID = new long[1] ;
         T000E23_A225BR_MedicalImagingID = new long[1] ;
         T000E24_A150BR_VitalID = new long[1] ;
         T000E25_A139BR_ProcedureID = new long[1] ;
         T000E26_A119BR_MedicationID = new long[1] ;
         T000E27_A101BR_LabID = new long[1] ;
         T000E28_A64BR_DiagnosisID = new long[1] ;
         T000E29_A61BR_Demographics_ID = new long[1] ;
         T000E30_A48BR_DeathID = new long[1] ;
         T000E31_A37BR_ComorbidityID = new long[1] ;
         T000E32_A20BR_BehaviorID = new long[1] ;
         T000E33_A19BR_EncounterID = new long[1] ;
         T000E33_n19BR_EncounterID = new bool[] {false} ;
         sDynURL = "";
         FormProcess = "";
         bodyStyle = "";
         ...
         T000E37_A167XT_DefineCodeID = new long[1] ;
         T000E37_A168XT_DefineCodeName = new String[] {""} ;
         T000E37_n168XT_DefineCodeName = new bool[] {false} ;
         T000E37_A165XT_DefindcodeTypeID = new long[1] ;
         T000E37_A432XT_TenantCode = new String[] {""} ;
         T000E37_n432XT_TenantCode = new bool[] {false} ;
         T000E38_A167XT_DefineCodeID = new long[1] ;
         T000E38_A168XT_DefineCodeName = new String[] {""} ;
         T000E38_n168XT_DefineCodeName = new bool[] {false} ;
         T000E38_A165XT_DefindcodeTypeID = new long[1] ;
         T000E38_A432XT_TenantCode = new String[] {""} ;
         T000E38_n432XT_TenantCode = new bool[] {false} ;
         T000E39_A167XT_DefineCodeID = new long[1] ;
         T000E39_A168XT_DefineCodeName = new String[] {""} ;
         T000E39_n168XT_DefineCodeName = new bool[] {false} ;
         T000E39_A165XT_DefindcodeTypeID = new long[1] ;
         T000E39_A432XT_TenantCode = new String[] {""} ;
         T000E39_n432XT_TenantCode = new bool[] {false} ;
         T000E40_A167XT_DefineCodeID = new long[1] ;
         T000E40_A168XT_DefineCodeName = new String[] {""} ;
         T000E40_n168XT_DefineCodeName = new bool[] {false} ;
         T000E40_A165XT_DefindcodeTypeID = new long[1] ;
         T000E40_A432XT_TenantCode = new String[] {""} ;
         T000E40_n432XT_TenantCode = new bool[] {false} ;
         GXt_char1 = "";
         T000E41_A36BR_Information_PatientNo = new String[] {""} ;
         T000E41_n36BR_Information_PatientNo = new bool[] {false} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.br_encounter__default(),
            new Object[][] {
               ...
               , new Object[] {
               T000E18_A576BR_FamilyhistoryID
               }
               , new Object[] {
               T000E19_A348BR_Encounter_RefuseReasonID
               }
               , new Object[] {
               T000E20_A347BR_Encounter_ID
               }
               , new Object[] {
               T000E21_A327BR_SchemeID
               }
               , new Object[] {
               T000E22_A226BR_PathologyID
               }
               , new Object[] {
               T000E23_A225BR_MedicalImagingID
               }
               , new Object[] {
               T000E24_A150BR_VitalID
               }
               , new Object[] {
               T000E25_A139BR_ProcedureID
               }
               , new Object[] {
               T000E26_A119BR_MedicationID
               }
               , new Object[] {
               T000E27_A101BR_LabID
               }
               , new Object[] {
               T000E28_A64BR_DiagnosisID
               }
               , new Object[] {
               T000E29_A61BR_Demographics_ID
               }
               , new Object[] {
               T000E30_A48BR_DeathID
               }
               , new Object[] {
               T000E31_A37BR_ComorbidityID
               }
               , new Object[] {
               T000E32_A20BR_BehaviorID
               }
               , new Object[] {
               T000E33_A19BR_EncounterID
               }
               , new Object[] {
               ...
               , new Object[] {
               T000E37_A167XT_DefineCodeID, T000E37_A168XT_DefineCodeName, T000E37_n168XT_DefineCodeName, T000E37_A165XT_DefindcodeTypeID, T000E37_A432XT_TenantCode, T000E37_n432XT_TenantCode
               }
               , new Object[] {
               T000E38_A167XT_DefineCodeID, T000E38_A168XT_DefineCodeName, T000E38_n168XT_DefineCodeName, T000E38_A165XT_DefindcodeTypeID, T000E38_A432XT_TenantCode, T000E38_n432XT_TenantCode
               }
               , new Object[] {
               T000E39_A167XT_DefineCodeID, T000E39_A168XT_DefineCodeName, T000E39_n168XT_DefineCodeName, T000E39_A165XT_DefindcodeTypeID, T000E39_A432XT_TenantCode, T000E39_n432XT_TenantCode
               }
               , new Object[] {
               T000E40_A167XT_DefineCodeID, T000E40_A168XT_DefineCodeName, T000E40_n168XT_DefineCodeName, T000E40_A165XT_DefindcodeTypeID, T000E40_A432XT_TenantCode, T000E40_n432XT_TenantCode
               }
               , new Object[] {
               T000E41_A36BR_Information_PatientNo, T000E41_n36BR_Information_PatientNo
               }
            }
         );
         AV35Pgmname = "BR_Encounter";
      ...
      private int edtavVinsurance_Enabled ;
      private int edtavVenctype_Visible ;
      private int edtavVenctype_Enabled ;
      private int edtavVdepartmentdisch_Enabled ;
      private int edtavVdepartmentadm_Visible ;
      private int edtavVdepartmentadm_Enabled ;
      ...
      private String dynBR_Encounter_Departmentadm_Internalname ;
      private String dynBR_Encounter_Departmentdisch_Internalname ;
      private String dynBR_Encounter_ENCType_Internalname ;
      private String dynBR_Encounter_Insurance_Internalname ;
      ...
      private String divTablesplittedbr_encounter_departmentadm_Internalname ;
      private String lblTextblockbr_encounter_departmentadm_Internalname ;
      private String lblTextblockbr_encounter_departmentadm_Jsonclick ;
      private String divTablesplittedbr_encounter_departmentdisch_Internalname ;
      private String lblTextblockbr_encounter_departmentdisch_Internalname ;
      private String lblTextblockbr_encounter_departmentdisch_Jsonclick ;
      ...
      private String divTablesplittedbr_encounter_insurance_Internalname ;
      private String lblTextblockbr_encounter_insurance_Internalname ;
      private String lblTextblockbr_encounter_insurance_Jsonclick ;
      ...
      private String tblTablemergedbr_encounter_insurance_Internalname ;
      private String dynBR_Encounter_Insurance_Jsonclick ;
      ...
      private String tblTablemergedbr_encounter_departmentdisch_Internalname ;
      private String dynBR_Encounter_Departmentdisch_Jsonclick ;
      private String edtavVdepartmentdisch_Internalname ;
      private String edtavVdepartmentdisch_Jsonclick ;
      private String tblTablemergedbr_encounter_departmentadm_Internalname ;
      private String dynBR_Encounter_Departmentadm_Jsonclick ;
      private String cellVdepartmentadm_cell_Internalname ;
      private String cellVdepartmentadm_cell_Class ;
      private String edtavVdepartmentadm_Internalname ;
      private String edtavVdepartmentadm_Jsonclick ;
      ...
      private String AV32vInsurance ;
      private String AV26vENCType ;
      private String AV33vDepartmentdisch ;
      private String AV31vDepartmentadm ;
      ...
      private GXCombobox dynBR_Encounter_Departmentadm ;
      private GXCombobox dynBR_Encounter_Departmentdisch ;
      private GXCombobox dynBR_Encounter_ENCType ;
      private GXCombobox dynBR_Encounter_Insurance ;
      ...
      private long[] T000E18_A576BR_FamilyhistoryID ;
      private long[] T000E19_A348BR_Encounter_RefuseReasonID ;
      private long[] T000E20_A347BR_Encounter_ID ;
      private long[] T000E21_A327BR_SchemeID ;
      private long[] T000E22_A226BR_PathologyID ;
      private long[] T000E23_A225BR_MedicalImagingID ;
      private long[] T000E24_A150BR_VitalID ;
      private long[] T000E25_A139BR_ProcedureID ;
      private long[] T000E26_A119BR_MedicationID ;
      private long[] T000E27_A101BR_LabID ;
      private long[] T000E28_A64BR_DiagnosisID ;
      private long[] T000E29_A61BR_Demographics_ID ;
      private long[] T000E30_A48BR_DeathID ;
      private long[] T000E31_A37BR_ComorbidityID ;
      private long[] T000E32_A20BR_BehaviorID ;
      private long[] T000E33_A19BR_EncounterID ;
      private bool[] T000E33_n19BR_EncounterID ;
      ...
      private long[] T000E37_A167XT_DefineCodeID ;
      private String[] T000E37_A168XT_DefineCodeName ;
      private bool[] T000E37_n168XT_DefineCodeName ;
      private long[] T000E37_A165XT_DefindcodeTypeID ;
      private String[] T000E37_A432XT_TenantCode ;
      private bool[] T000E37_n432XT_TenantCode ;
      private long[] T000E38_A167XT_DefineCodeID ;
      private String[] T000E38_A168XT_DefineCodeName ;
      private bool[] T000E38_n168XT_DefineCodeName ;
      private long[] T000E38_A165XT_DefindcodeTypeID ;
      private String[] T000E38_A432XT_TenantCode ;
      private bool[] T000E38_n432XT_TenantCode ;
      private long[] T000E39_A167XT_DefineCodeID ;
      private String[] T000E39_A168XT_DefineCodeName ;
      private bool[] T000E39_n168XT_DefineCodeName ;
      private long[] T000E39_A165XT_DefindcodeTypeID ;
      private String[] T000E39_A432XT_TenantCode ;
      private bool[] T000E39_n432XT_TenantCode ;
      private long[] T000E40_A167XT_DefineCodeID ;
      private String[] T000E40_A168XT_DefineCodeName ;
      private bool[] T000E40_n168XT_DefineCodeName ;
      private long[] T000E40_A165XT_DefindcodeTypeID ;
      private String[] T000E40_A432XT_TenantCode ;
      private bool[] T000E40_n432XT_TenantCode ;
      private String[] T000E41_A36BR_Information_PatientNo ;
      private bool[] T000E41_n36BR_Information_PatientNo ;
 ...
 public class br_encounter__default : DataStoreHelperBase, IDataStoreHelper
 {
  ...
  private void cursorDefinitions( )
  {
     if ( def == null )
     {
        ...
        Object[] prmT000E38 ;
        prmT000E38 = new Object[] {
        new Object[] {"@AV30tCurrentCode",SqlDbType.NVarChar,40,0}
        } ;
        Object[] prmT000E39 ;
        prmT000E39 = new Object[] {
        new Object[] {"@AV30tCurrentCode",SqlDbType.NVarChar,40,0}
        } ;
        Object[] prmT000E40 ;
        prmT000E40 = new Object[] {
        new Object[] {"@AV30tCurrentCode",SqlDbType.NVarChar,40,0}
        } ;
        Object[] prmT000E41 ;
        ...
        def= new CursorDef[] {
           ...
           ,new CursorDef("T000E18", "SELECT TOP 1 [BR_FamilyhistoryID] FROM [BR_Familyhistory] WITH (NOLOCK) WHERE [BR_EncounterID] = @BR_EncounterID ",true, GxErrorMask.GX_NOMASK, false, this,prmT000E18,1,0,true,true )
           ,new CursorDef("T000E19", "SELECT TOP 1 [BR_Encounter_RefuseReasonID] FROM [BR_Encounter_RefuseReason] WITH (NOLOCK) WHERE [BR_EncounterID] = @BR_EncounterID ",true, GxErrorMask.GX_NOMASK, false, this,prmT000E19,1,0,true,true )
           ,new CursorDef("T000E20", "SELECT TOP 1 [BR_Encounter_ID] FROM [BR_EncounterReason] WITH (NOLOCK) WHERE [BR_EncounterID] = @BR_EncounterID ",true, GxErrorMask.GX_NOMASK, false, this,prmT000E20,1,0,true,true )
           ,new CursorDef("T000E21", "SELECT TOP 1 [BR_SchemeID] FROM [BR_Scheme] WITH (NOLOCK) WHERE [BR_EncounterID] = @BR_EncounterID ",true, GxErrorMask.GX_NOMASK, false, this,prmT000E21,1,0,true,true )
           ,new CursorDef("T000E22", "SELECT TOP 1 [BR_PathologyID] FROM [BR_Pathology] WITH (NOLOCK) WHERE [BR_EncounterID] = @BR_EncounterID ",true, GxErrorMask.GX_NOMASK, false, this,prmT000E22,1,0,true,true )
           ,new CursorDef("T000E23", "SELECT TOP 1 [BR_MedicalImagingID] FROM [BR_MedicalImaging] WITH (NOLOCK) WHERE [BR_EncounterID] = @BR_EncounterID ",true, GxErrorMask.GX_NOMASK, false, this,prmT000E23,1,0,true,true )
           ,new CursorDef("T000E24", "SELECT TOP 1 [BR_VitalID] FROM [BR_Vital] WITH (NOLOCK) WHERE [BR_EncounterID] = @BR_EncounterID ",true, GxErrorMask.GX_NOMASK, false, this,prmT000E24,1,0,true,true )
           ,new CursorDef("T000E25", "SELECT TOP 1 [BR_ProcedureID] FROM [BR_Procedure] WITH (NOLOCK) WHERE [BR_EncounterID] = @BR_EncounterID ",true, GxErrorMask.GX_NOMASK, false, this,prmT000E25,1,0,true,true )
           ,new CursorDef("T000E26", "SELECT TOP 1 [BR_MedicationID] FROM [BR_Medication] WITH (NOLOCK) WHERE [BR_EncounterID] = @BR_EncounterID ",true, GxErrorMask.GX_NOMASK, false, this,prmT000E26,1,0,true,true )
           ,new CursorDef("T000E27", "SELECT TOP 1 [BR_LabID] FROM [BR_Lab] WITH (NOLOCK) WHERE [BR_EncounterID] = @BR_EncounterID ",true, GxErrorMask.GX_NOMASK, false, this,prmT000E27,1,0,true,true )
           ,new CursorDef("T000E28", "SELECT TOP 1 [BR_DiagnosisID] FROM [BR_Diagnosis] WITH (NOLOCK) WHERE [BR_EncounterID] = @BR_EncounterID ",true, GxErrorMask.GX_NOMASK, false, this,prmT000E28,1,0,true,true )
           ,new CursorDef("T000E29", "SELECT TOP 1 [BR_Demographics_ID] FROM [BR_Demographics] WITH (NOLOCK) WHERE [BR_EncounterID] = @BR_EncounterID ",true, GxErrorMask.GX_NOMASK, false, this,prmT000E29,1,0,true,true )
           ,new CursorDef("T000E30", "SELECT TOP 1 [BR_DeathID] FROM [BR_Death] WITH (NOLOCK) WHERE [BR_EncounterID] = @BR_EncounterID ",true, GxErrorMask.GX_NOMASK, false, this,prmT000E30,1,0,true,true )
           ,new CursorDef("T000E31", "SELECT TOP 1 [BR_ComorbidityID] FROM [BR_Comorbidity] WITH (NOLOCK) WHERE [BR_EncounterID] = @BR_EncounterID ",true, GxErrorMask.GX_NOMASK, false, this,prmT000E31,1,0,true,true )
           ,new CursorDef("T000E32", "SELECT TOP 1 [BR_BehaviorID] FROM [BR_Behavior] WITH (NOLOCK) WHERE [BR_EncounterID] = @BR_EncounterID ",true, GxErrorMask.GX_NOMASK, false, this,prmT000E32,1,0,true,true )
           ,new CursorDef("T000E33", "SELECT [BR_EncounterID] FROM [BR_Encounter] WITH (NOLOCK) ORDER BY [BR_EncounterID]  OPTION (FAST 100)",true, GxErrorMask.GX_NOMASK, false, this,prmT000E33,100,0,true,false )
           ,new CursorDef("T000E34", "SELECT [XT_DefineCodeID], [XT_DefineCodeName], [XT_DefindcodeTypeID], [XT_TenantCode] FROM [XT_DefineCode] WITH (NOLOCK) WHERE ([XT_DefindcodeTypeID] = 3) AND ([XT_TenantCode] = @AV30tCurrentCode) ",true, GxErrorMask.GX_NOMASK, false, this,prmT000E34,0,0,true,false )
           ,new CursorDef("T000E35", "SELECT [XT_DefineCodeID], [XT_DefineCodeName], [XT_DefindcodeTypeID], [XT_TenantCode] FROM [XT_DefineCode] WITH (NOLOCK) WHERE ([XT_DefindcodeTypeID] = 3) AND ([XT_TenantCode] = @AV30tCurrentCode) ",true, GxErrorMask.GX_NOMASK, false, this,prmT000E35,0,0,true,false )
           ,new CursorDef("T000E36", "SELECT [XT_DefineCodeID], [XT_DefineCodeName], [XT_DefindcodeTypeID], [XT_TenantCode] FROM [XT_DefineCode] WITH (NOLOCK) WHERE ([XT_DefindcodeTypeID] = 3) AND ([XT_TenantCode] = @AV30tCurrentCode) ",true, GxErrorMask.GX_NOMASK, false, this,prmT000E36,0,0,true,false )
           ,new CursorDef("T000E37", "SELECT [XT_DefineCodeID], [XT_DefineCodeName], [XT_DefindcodeTypeID], [XT_TenantCode] FROM [XT_DefineCode] WITH (NOLOCK) WHERE ([XT_DefindcodeTypeID] = 4) AND ([XT_TenantCode] = @AV30tCurrentCode) ",true, GxErrorMask.GX_NOMASK, false, this,prmT000E37,0,0,true,false )
           ,new CursorDef("T000E38", "SELECT [XT_DefineCodeID], [XT_DefineCodeName], [XT_DefindcodeTypeID], [XT_TenantCode] FROM [XT_DefineCode] WITH (NOLOCK) WHERE ([XT_DefindcodeTypeID] = 11) AND ([XT_TenantCode] = @AV30tCurrentCode) ",true, GxErrorMask.GX_NOMASK, false, this,prmT000E38,0,0,true,false )
           ,new CursorDef("T000E39", "SELECT [XT_DefineCodeID], [XT_DefineCodeName], [XT_DefindcodeTypeID], [XT_TenantCode] FROM [XT_DefineCode] WITH (NOLOCK) WHERE ([XT_DefindcodeTypeID] = 5) AND ([XT_TenantCode] = @AV30tCurrentCode) ",true, GxErrorMask.GX_NOMASK, false, this,prmT000E39,0,0,true,false )
           ,new CursorDef("T000E40", "SELECT [XT_DefineCodeID], [XT_DefineCodeName], [XT_DefindcodeTypeID], [XT_TenantCode] FROM [XT_DefineCode] WITH (NOLOCK) WHERE ([XT_DefindcodeTypeID] = 6) AND ([XT_TenantCode] = @AV30tCurrentCode) ",true, GxErrorMask.GX_NOMASK, false, this,prmT000E40,0,0,true,false )
           ,new CursorDef("T000E41", "SELECT [BR_Information_PatientNo] FROM [BR_Information] WITH (NOLOCK) WHERE [BR_Information_ID] = @BR_Information_ID ",true, GxErrorMask.GX_NOMASK, false, this,prmT000E41,1,0,true,false )
        };
     }
  }
