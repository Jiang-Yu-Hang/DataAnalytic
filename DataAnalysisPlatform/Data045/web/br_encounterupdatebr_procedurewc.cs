/*
       ...
       Generated on: 2/28/2020 15:8:30.65
   ...
   public class br_encounterupdatebr_procedurewc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
         ...
         if ( StringUtil.Len( (String)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
               {
                  ...
                  gxgrGrid_refresh( subGrid_Rows, AV14OrderedBy, AV15OrderedDsc, AV8BR_EncounterID, AV18ddo_BR_ProcedureIDTitleControlIdToReplace, AV26ddo_BR_Procedure_PXRadiotherapyTitleControlIdToReplace, AV22ddo_BR_Procedure_PXSurgeryTitleControlIdToReplace, AV71Pgmname, AV50IsAuthorized_Display, AV46IsAuthorized_Update, sPrefix) ;
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV71Pgmname = "BR_EncounterUpdateBR_ProcedureWC";
               context.Gx_err = 0;
               WS282( ) ;
               if ( ! isAjaxCallMode( ) )
               {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20202281583079", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"vGRIDPAGECOUNT", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV65GridPageCount), 10, 0, ".", "")));
         if ( context.isAjaxRequest( ) )
         {
      ...
      protected void RenderHtmlCloseForm282( )
      {
         ...
         {
            context.AddJavascriptSource("br_encounterupdatebr_procedurewc.js", "?20202281583219", false);
         }
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 13), "VUPDATE.CLICK") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 13), "VUPDATE.CLICK") == 0 ) )
                           {
                              ...
                              context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtavDisplay_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV49Display)) ? AV68Display_GXI : context.convertURL( context.PathToRelativeUrl( AV49Display))), !bGXsfl_28_Refreshing);
                              ...
                              context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtavUpdate_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV45Update)) ? AV69Update_GXI : context.convertURL( context.PathToRelativeUrl( AV45Update))), !bGXsfl_28_Refreshing);
                              ...
                              context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtavMydel_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV60mydel)) ? AV70Mydel_GXI : context.convertURL( context.PathToRelativeUrl( AV60mydel))), !bGXsfl_28_Refreshing);
      ...
      protected void STRUP280( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            AV65GridPageCount = (long)(context.localUtil.CToN( cgiGet( sPrefix+"vGRIDPAGECOUNT"), ".", ","));
      ...
      protected void E19282( )
      {
         ...
         context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "AV65GridPageCount", StringUtil.LTrim( StringUtil.Str( (decimal)(AV65GridPageCount), 10, 0)));
      ...
      private void E20282( )
      {
         ...
         AV68Display_GXI = GXDbFile.PathToUrl( context.GetImagePath( "f11923b6-6acd-4a79-bfc0-0cfc6f3bced5", "", context.GetTheme( )));
         ...
         AV69Update_GXI = GXDbFile.PathToUrl( context.GetImagePath( "7c63c2b9-483e-4035-b512-febf9186a274", "", context.GetTheme( )));
         ...
         AV70Mydel_GXI = GXDbFile.PathToUrl( context.GetImagePath( "7695fe89-52c9-4b7e-871e-0e11548f823e", "", context.GetTheme( )));
      ...
      protected void S122( )
      {
         ...
         {
            AV12GridState.FromXml(new GeneXus.Programs.wwpbaseobjects.loadgridstate(context).executeUdp(  AV71Pgmname+"GridState"), null, "WWPGridState", "DataAnalysisPlatform");
         }
         else
         {
            AV12GridState.FromXml(AV16Session.Get(AV71Pgmname+"GridState"), null, "WWPGridState", "DataAnalysisPlatform");
         }
      ...
      protected void S142( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.savegridstate(context ).execute(  AV71Pgmname+"GridState",  AV12GridState.ToXml(false, true, "WWPGridState", "DataAnalysisPlatform")) ;
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?20202281583886", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("br_encounterupdatebr_procedurewc.js", "?20202281583886", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
      ...
      protected void sendrow_282( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_28_idx <= subGrid_Recordsperpage( ) * 1 ) )
         {
            ...
            StyleString = "";
            AV49Display_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV49Display))&&String.IsNullOrEmpty(StringUtil.RTrim( AV68Display_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV49Display)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV49Display)) ? AV68Display_GXI : context.PathToRelativeUrl( AV49Display));
            ...
            ClassString = "ActionBaseColorAttribute";
            StyleString = "";
            AV45Update_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV45Update))&&String.IsNullOrEmpty(StringUtil.RTrim( AV69Update_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV45Update)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV45Update)) ? AV69Update_GXI : context.PathToRelativeUrl( AV45Update));
            ...
            ClassString = "ActionBaseColorAttribute";
            StyleString = "";
            AV60mydel_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV60mydel))&&String.IsNullOrEmpty(StringUtil.RTrim( AV70Mydel_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV60mydel)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV60mydel)) ? AV70Mydel_GXI : context.PathToRelativeUrl( AV60mydel));
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("DDO_BR_PROCEDURE_PXRADIOTHERAPY.ONOPTIONCLICKED","{handler:'E14282',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV8BR_EncounterID',fld:'vBR_ENCOUNTERID',pic:'ZZZZZZZZZZZZZZZZZZ'},{av:'AV18ddo_BR_ProcedureIDTitleControlIdToReplace',fld:'vDDO_BR_PROCEDUREIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV26ddo_BR_Procedure_PXRadiotherapyTitleControlIdToReplace',fld:'vDDO_BR_PROCEDURE_PXRADIOTHERAPYTITLECONTROLIDTOREPLACE',pic:''},{av:'AV22ddo_BR_Procedure_PXSurgeryTitleControlIdToReplace',fld:'vDDO_BR_PROCEDURE_PXSURGERYTITLECONTROLIDTOREPLACE',pic:''},{av:'AV71Pgmname',fld:'vPGMNAME',pic:''},{av:'AV50IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:''},{av:'AV46IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:''},{av:'sPrefix'},{av:'Ddo_br_procedure_pxradiotherapy_Activeeventkey',ctrl:'DDO_BR_PROCEDURE_PXRADIOTHERAPY',prop:'ActiveEventKey'}]");
         ...
         setEventMetadata("DDO_BR_PROCEDURE_PXSURGERY.ONOPTIONCLICKED","{handler:'E15282',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV8BR_EncounterID',fld:'vBR_ENCOUNTERID',pic:'ZZZZZZZZZZZZZZZZZZ'},{av:'AV18ddo_BR_ProcedureIDTitleControlIdToReplace',fld:'vDDO_BR_PROCEDUREIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV26ddo_BR_Procedure_PXRadiotherapyTitleControlIdToReplace',fld:'vDDO_BR_PROCEDURE_PXRADIOTHERAPYTITLECONTROLIDTOREPLACE',pic:''},{av:'AV22ddo_BR_Procedure_PXSurgeryTitleControlIdToReplace',fld:'vDDO_BR_PROCEDURE_PXSURGERYTITLECONTROLIDTOREPLACE',pic:''},{av:'AV71Pgmname',fld:'vPGMNAME',pic:''},{av:'AV50IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:''},{av:'AV46IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:''},{av:'sPrefix'},{av:'Ddo_br_procedure_pxsurgery_Activeeventkey',ctrl:'DDO_BR_PROCEDURE_PXSURGERY',prop:'ActiveEventKey'}]");
         ...
         setEventMetadata("DVELOP_CONFIRMPANEL_MYDEL.CLOSE","{handler:'E16282',iparms:[{av:'Dvelop_confirmpanel_mydel_Result',ctrl:'DVELOP_CONFIRMPANEL_MYDEL',prop:'Result'},{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV8BR_EncounterID',fld:'vBR_ENCOUNTERID',pic:'ZZZZZZZZZZZZZZZZZZ'},{av:'AV18ddo_BR_ProcedureIDTitleControlIdToReplace',fld:'vDDO_BR_PROCEDUREIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV26ddo_BR_Procedure_PXRadiotherapyTitleControlIdToReplace',fld:'vDDO_BR_PROCEDURE_PXRADIOTHERAPYTITLECONTROLIDTOREPLACE',pic:''},{av:'AV22ddo_BR_Procedure_PXSurgeryTitleControlIdToReplace',fld:'vDDO_BR_PROCEDURE_PXSURGERYTITLECONTROLIDTOREPLACE',pic:''},{av:'AV71Pgmname',fld:'vPGMNAME',pic:''},{av:'AV50IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:''},{av:'AV46IsAuthorized_Update',fld:'vISAUTHORIZED_UPDATE',pic:''},{av:'sPrefix'},{av:'A139BR_ProcedureID',fld:'BR_PROCEDUREID',pic:'ZZZZZZZZZZZZZZZZZZ',hsh:true}]");
      ...
      private String AV68Display_GXI ;
      private String AV69Update_GXI ;
      private String AV70Mydel_GXI ;
