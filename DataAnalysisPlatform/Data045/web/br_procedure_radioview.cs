/*
               File: BR_Procedure_RadioView
        Description: BR_Procedure_Radio View
             Author: GeneXus C# Generator version 16_0_0-127771
       Generated on: 2/28/2020 15:14:39.50
...
namespace GeneXus.Programs {
   public class br_procedure_radioview : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public br_procedure_radioview( )
      {
      ...
      public br_procedure_radioview( IGxContext context )
      {
      ...
      public void execute( long aP0_BR_Procedure_RadioID ,
                           String aP1_TabCode )
      {
         this.AV10BR_Procedure_RadioID = aP0_BR_Procedure_RadioID;
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV10BR_Procedure_RadioID = (long)(NumberUtil.Val( gxfirstwebparm, "."));
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV10BR_Procedure_RadioID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV10BR_Procedure_RadioID), 18, 0)));
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "gxhash_vBR_PROCEDURE_RADIOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10BR_Procedure_RadioID), "ZZZZZZZZZZZZZZZZZZ"), context));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202022815143952", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("br_procedure_radioview.aspx") + "?" + UrlEncode("" +AV10BR_Procedure_RadioID) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode))+"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vBR_PROCEDURE_RADIOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10BR_Procedure_RadioID), 18, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vBR_PROCEDURE_RADIOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10BR_Procedure_RadioID), "ZZZZZZZZZZZZZZZZZZ"), context));
      ...
      {
         return formatLink("br_procedure_radioview.aspx") + "?" + UrlEncode("" +AV10BR_Procedure_RadioID) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode)) ;
      }

      public override String GetPgmname( )
      {
         return "BR_Procedure_RadioView" ;
      }

      public override String GetPgmdesc( )
      {
         return "BR_Procedure_Radio View" ;
      }
      ...
      protected void WB670( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnreturn_Internalname, "", "返回", bttBtnreturn_Jsonclick, 5, "返回", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DORETURN\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_BR_Procedure_RadioView.htm");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTxttabtitle_Internalname, lblTxttabtitle_Caption, "", "", lblTxttabtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockTitleWWPTab", 0, "", 1, 1, 0, "HLP_BR_Procedure_RadioView.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "放疗信息", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, "HLP_BR_Procedure_RadioView.htm");
            /* Div Control */
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtngeneral_Internalname, "", "放疗信息", bttBtngeneral_Jsonclick, 7, "放疗信息", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e11671_client"+"'", TempTags, "", 2, "HLP_BR_Procedure_RadioView.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START672( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "BR_Procedure_Radio View", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void STRUP670( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            /* Read saved values. */
            AV10BR_Procedure_RadioID = (long)(context.localUtil.CToN( cgiGet( "vBR_PROCEDURE_RADIOID"), ".", ","));
      ...
      protected void E12672( )
      {
         ...
         AV16GXLvl9 = 0;
         /* Using cursor H00672 */
         pr_default.execute(0, new Object[] {AV10BR_Procedure_RadioID});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A323BR_Procedure_RadioID = H00672_A323BR_Procedure_RadioID[0];
            AV16GXLvl9 = 1;
      ...
      protected void S112( )
      {
         ...
         {
            /* Object Property */
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "BR_Procedure_RadioGeneral")) != 0 )
            {
               WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "br_procedure_radiogeneral", new Object[] {context} );
               WebComp_Generalwc.ComponentInit();
               WebComp_Generalwc.Name = "BR_Procedure_RadioGeneral";
               WebComp_Generalwc_Component = "BR_Procedure_RadioGeneral";
            }
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               WebComp_Generalwc.setjustcreated();
               WebComp_Generalwc.componentprepare(new Object[] {(String)"W0026",(String)"",(long)AV10BR_Procedure_RadioID});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV10BR_Procedure_RadioID = Convert.ToInt64(getParm(obj,0));
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV10BR_Procedure_RadioID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV10BR_Procedure_RadioID), 18, 0)));
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "gxhash_vBR_PROCEDURE_RADIOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10BR_Procedure_RadioID), "ZZZZZZZZZZZZZZZZZZ"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202022815143983", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("br_procedure_radioview.js", "?202022815143983", false);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "BR_Procedure_Radio View";
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV10BR_Procedure_RadioID',fld:'vBR_PROCEDURE_RADIOID',pic:'ZZZZZZZZZZZZZZZZZZ',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("'DORETURN'","{handler:'E14672',iparms:[]");
         setEventMetadata("'DORETURN'",",oparms:[]}");
         setEventMetadata("'GENERAL'","{handler:'E11671',iparms:[{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV10BR_Procedure_RadioID',fld:'vBR_PROCEDURE_RADIOID',pic:'ZZZZZZZZZZZZZZZZZZ',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H00672_A323BR_Procedure_RadioID = new long[1] ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.br_procedure_radioview__default(),
            new Object[][] {
                new Object[] {
               H00672_A323BR_Procedure_RadioID
               }
            }
         );
      ...
      private int idxLst ;
      private long AV10BR_Procedure_RadioID ;
      private long wcpOAV10BR_Procedure_RadioID ;
      ...
      private long[] H00672_A323BR_Procedure_RadioID ;
   ...
   public class br_procedure_radioview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@AV10BR_Procedure_RadioID",SqlDbType.Decimal,18,0}
          } ;
          def= new CursorDef[] {
              new CursorDef("H00672", "SELECT [BR_Procedure_RadioID] FROM [BR_Procedure_Radio] WITH (NOLOCK) WHERE [BR_Procedure_RadioID] = @AV10BR_Procedure_RadioID ORDER BY [BR_Procedure_RadioID] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00672,1,0,false,true )
          };
       }
    }
