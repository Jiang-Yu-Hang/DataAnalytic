/*
       ...
       Generated on: 2/28/2020 15:16:40.99
...
namespace GeneXus.Programs {
   public class br_diagnosisupdate : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20202281516416", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void WB8O0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtavBr_diagnosis_br_diagnosis_tumorstageclinical_Internalname, AV5BR_Diagnosis.gxTpr_Br_diagnosis_tumorstageclinical, StringUtil.RTrim( context.localUtil.Format( AV5BR_Diagnosis.gxTpr_Br_diagnosis_tumorstageclinical, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,65);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavBr_diagnosis_br_diagnosis_tumorstageclinical_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavBr_diagnosis_br_diagnosis_tumorstageclinical_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 1, -1, -1, true, "", "left", true, "HLP_BR_DiagnosisUpdate.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavBr_diagnosis_br_information_patientno_Internalname, AV5BR_Diagnosis.gxTpr_Br_information_patientno, StringUtil.RTrim( context.localUtil.Format( AV5BR_Diagnosis.gxTpr_Br_information_patientno, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,78);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavBr_diagnosis_br_information_patientno_Jsonclick, 0, "Attribute", "", "", "", "", edtavBr_diagnosis_br_information_patientno_Visible, 1, 0, "text", "", 80, "chr", 1, "row", 2000, 0, 0, 0, 1, -1, -1, true, "", "left", true, "HLP_BR_DiagnosisUpdate.htm");
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 79,'',false,'',0)\"";
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, dynavBr_diagnosis_br_diagnosis_dxtsource, dynavBr_diagnosis_br_diagnosis_dxtsource_Internalname, StringUtil.RTrim( AV5BR_Diagnosis.gxTpr_Br_diagnosis_dxtsource), 1, dynavBr_diagnosis_br_diagnosis_dxtsource_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "svchar", "", dynavBr_diagnosis_br_diagnosis_dxtsource.Visible, 1, 0, 0, 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,79);\"", "", true, "HLP_BR_DiagnosisUpdate.htm");
      ...
      protected void S122( )
      {
         ...
         AV34GXV11 = 1;
         while ( AV34GXV11 <= AV11Messages.Count )
         {
            AV10Message = ((SdtMessages_Message)AV11Messages.Item(AV34GXV11));
            GX_msglist.addItem(AV10Message.gxTpr_Description);
            AV34GXV11 = (int)(AV34GXV11+1);
         }
      }
      ...
      protected void E138O2( )
      {
         ...
         if ( ! AV21tCheckFlag )
         {
            ...
            else
            {
               AV19ErrorMsg = "";
               AV36GXV13 = 1;
               AV35GXV12 = AV5BR_Diagnosis.GetMessages();
               while ( AV36GXV13 <= AV35GXV12.Count )
               {
                  AV10Message = ((SdtMessages_Message)AV35GXV12.Item(AV36GXV13));
                  AV19ErrorMsg = AV19ErrorMsg + StringUtil.Trim( AV10Message.gxTpr_Description);
                  AV36GXV13 = (int)(AV36GXV13+1);
               }
            }
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202022815164270", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("br_diagnosisupdate.js", "?202022815164270", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false);
      ...
      public override void initialize( )
      {
         ...
         AV19ErrorMsg = "";
         AV35GXV12 = new GXBaseCollection<SdtMessages_Message>( context, "Message", "GeneXus");
      ...
      private int AV34GXV11 ;
      private int AV36GXV13 ;
      private int idxLst ;
      ...
      private GXBaseCollection<SdtMessages_Message> AV35GXV12 ;
