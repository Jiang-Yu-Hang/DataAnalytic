/*
       ...
       Generated on: 2/28/2020 15:11:6.28
...
namespace GeneXus.Programs {
   public class br_encountercheck : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20202281511664", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      public override void RenderHtmlCloseForm( )
      {
         ...
         if ( ! ( WebComp_Br_familyhistorywc == null ) )
         {
            WebComp_Br_familyhistorywc.componentjscripts();
         }
      ...
      protected void WB3S0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblBr_familyhistory_title_Internalname, "家族史", "", "", lblBr_familyhistory_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, "HLP_BR_EncounterCheck.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "left", "top", "", "display:none;", "div");
            context.WriteHtmlText( "BR_Familyhistory") ;
            GxWebStd.gx_div_end( context, "left", "top", "div");
            context.WriteHtmlText( "</div>") ;
            context.WriteHtmlText( "<div class=\"gx_usercontrol_child\" id=\""+"TABSContainer"+"panel4"+"\" style=\"display:none;\">") ;
            /* Div Control */
            GxWebStd.gx_div_start( context, divUnnamedtablebr_familyhistory_Internalname, 1, 0, "px", 0, "px", "TableViewTab", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0062"+"", StringUtil.RTrim( WebComp_Br_familyhistorywc_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
               context.WriteHtmlText( " id=\""+"gxHTMLWrpW0062"+""+"\""+"") ;
               context.WriteHtmlText( ">") ;
               if ( StringUtil.Len( WebComp_Br_familyhistorywc_Component) != 0 )
               {
                  if ( StringUtil.StrCmp(StringUtil.Lower( OldBr_familyhistorywc), StringUtil.Lower( WebComp_Br_familyhistorywc_Component)) != 0 )
                  {
                     context.httpAjaxContext.ajax_rspStartCmp("gxHTMLWrpW0062"+"");
                  }
                  WebComp_Br_familyhistorywc.componentdraw();
                  if ( StringUtil.StrCmp(StringUtil.Lower( OldBr_familyhistorywc), StringUtil.Lower( WebComp_Br_familyhistorywc_Component)) != 0 )
                  {
                     context.httpAjaxContext.ajax_rspEndCmp();
                  }
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0070"+"", StringUtil.RTrim( WebComp_Checkcomorbiditywc_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0078"+"", StringUtil.RTrim( WebComp_Checkdeathwc_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0086"+"", StringUtil.RTrim( WebComp_Checkvitalwc_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0094"+"", StringUtil.RTrim( WebComp_Br_diagnosiswc_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0102"+"", StringUtil.RTrim( WebComp_Br_labwc_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0110"+"", StringUtil.RTrim( WebComp_Br_medicationwc_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0118"+"", StringUtil.RTrim( WebComp_Br_schemewc_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0126"+"", StringUtil.RTrim( WebComp_Br_procedurewc_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0134"+"", StringUtil.RTrim( WebComp_Br_medicalimagingwc_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
            ...
            GxWebStd.gx_div_end( context, "left", "top", "div");
            context.WriteHtmlText( "</div>") ;
            context.WriteHtmlText( "<div class=\"gx_usercontrol_child\" id=\""+"TABSContainer"+"title14"+"\" style=\"display:none;\">") ;
            /* Text block */
            ...
            GxWebStd.gx_div_end( context, "left", "top", "div");
            context.WriteHtmlText( "</div>") ;
            context.WriteHtmlText( "<div class=\"gx_usercontrol_child\" id=\""+"TABSContainer"+"panel14"+"\" style=\"display:none;\">") ;
            /* Div Control */
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0142"+"", StringUtil.RTrim( WebComp_Br_pathologywc_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, divCell_br_familyhistory_Internalname, divCell_br_familyhistory_Visible, 0, "px", 0, "px", "col-xs-12 CellMarginTop", "left", "top", "", "", "div");
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 157,'',false,'',0)\"";
            ClassString = "btn_Master btn-large btn-block Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnbr_familyhistory_Internalname, "", "家族史", bttBtnbr_familyhistory_Jsonclick, 5, "家族史", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'BR_FAMILYHISTORY\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_BR_EncounterCheck.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            wb_table1_191_3S2( true) ;
         }
         else
         {
            wb_table1_191_3S2( false) ;
         }
         return  ;
      }

      protected void wb_table1_191_3S2e( bool wbgen )
      {
         if ( wbgen )
         {
            wb_table2_196_3S2( true) ;
         }
         else
         {
            wb_table2_196_3S2( false) ;
         }
         return  ;
      }

      protected void wb_table2_196_3S2e( bool wbgen )
      {
         if ( wbgen )
         {
            wb_table3_201_3S2( true) ;
         }
         else
         {
            wb_table3_201_3S2( false) ;
         }
         return  ;
      }

      protected void wb_table3_201_3S2e( bool wbgen )
      {
         if ( wbgen )
         {
            wb_table4_206_3S2( true) ;
         }
         else
         {
            wb_table4_206_3S2( false) ;
         }
         return  ;
      }

      protected void wb_table4_206_3S2e( bool wbgen )
      {
         if ( wbgen )
         {
            wb_table5_211_3S2( true) ;
         }
         else
         {
            wb_table5_211_3S2( false) ;
         }
         return  ;
      }

      protected void wb_table5_211_3S2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
                  ...
                  if ( StringUtil.StrCmp(sEvtType, "M") != 0 )
                  {
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                        {
                           ...
                           else if ( StringUtil.StrCmp(sEvt, "'BR_FAMILYHISTORY'") == 0 )
                           {
                              context.wbHandled = 1;
                              dynload_actions( ) ;
                              /* Execute user event: 'BR_Familyhistory' */
                              E293S2 ();
                           }
                     ...
                     else if ( StringUtil.StrCmp(sEvtType, "W") == 0 )
                     {
                        ...
                        {
                           OldBr_familyhistorywc = cgiGet( "W0062");
                           if ( ( StringUtil.Len( OldBr_familyhistorywc) == 0 ) || ( StringUtil.StrCmp(OldBr_familyhistorywc, WebComp_Br_familyhistorywc_Component) != 0 ) )
                           {
                              WebComp_Br_familyhistorywc = getWebComponent(GetType(), "GeneXus.Programs", OldBr_familyhistorywc, new Object[] {context} );
                              WebComp_Br_familyhistorywc.ComponentInit();
                              WebComp_Br_familyhistorywc.Name = "OldBr_familyhistorywc";
                              WebComp_Br_familyhistorywc_Component = OldBr_familyhistorywc;
                           }
                           if ( StringUtil.Len( WebComp_Br_familyhistorywc_Component) != 0 )
                           {
                              WebComp_Br_familyhistorywc.componentprocess("W0062", "", sEvt);
                           }
                           WebComp_Br_familyhistorywc_Component = OldBr_familyhistorywc;
                        }
                        else if ( nCmpId == 70 )
                        {
                           OldCheckcomorbiditywc = cgiGet( "W0070");
                           ...
                           if ( StringUtil.Len( WebComp_Checkcomorbiditywc_Component) != 0 )
                           {
                              WebComp_Checkcomorbiditywc.componentprocess("W0070", "", sEvt);
                           }
                           WebComp_Checkcomorbiditywc_Component = OldCheckcomorbiditywc;
                        }
                        else if ( nCmpId == 78 )
                        {
                           OldCheckdeathwc = cgiGet( "W0078");
                           ...
                           if ( StringUtil.Len( WebComp_Checkdeathwc_Component) != 0 )
                           {
                              WebComp_Checkdeathwc.componentprocess("W0078", "", sEvt);
                           }
                           WebComp_Checkdeathwc_Component = OldCheckdeathwc;
                        }
                        else if ( nCmpId == 86 )
                        {
                           OldCheckvitalwc = cgiGet( "W0086");
                           ...
                           if ( StringUtil.Len( WebComp_Checkvitalwc_Component) != 0 )
                           {
                              WebComp_Checkvitalwc.componentprocess("W0086", "", sEvt);
                           }
                           WebComp_Checkvitalwc_Component = OldCheckvitalwc;
                        }
                        else if ( nCmpId == 94 )
                        {
                           OldBr_diagnosiswc = cgiGet( "W0094");
                           ...
                           if ( StringUtil.Len( WebComp_Br_diagnosiswc_Component) != 0 )
                           {
                              WebComp_Br_diagnosiswc.componentprocess("W0094", "", sEvt);
                           }
                           WebComp_Br_diagnosiswc_Component = OldBr_diagnosiswc;
                        }
                        else if ( nCmpId == 102 )
                        {
                           OldBr_labwc = cgiGet( "W0102");
                           ...
                           if ( StringUtil.Len( WebComp_Br_labwc_Component) != 0 )
                           {
                              WebComp_Br_labwc.componentprocess("W0102", "", sEvt);
                           }
                           WebComp_Br_labwc_Component = OldBr_labwc;
                        }
                        else if ( nCmpId == 110 )
                        {
                           OldBr_medicationwc = cgiGet( "W0110");
                           ...
                           if ( StringUtil.Len( WebComp_Br_medicationwc_Component) != 0 )
                           {
                              WebComp_Br_medicationwc.componentprocess("W0110", "", sEvt);
                           }
                           WebComp_Br_medicationwc_Component = OldBr_medicationwc;
                        }
                        else if ( nCmpId == 118 )
                        {
                           OldBr_schemewc = cgiGet( "W0118");
                           ...
                           if ( StringUtil.Len( WebComp_Br_schemewc_Component) != 0 )
                           {
                              WebComp_Br_schemewc.componentprocess("W0118", "", sEvt);
                           }
                           WebComp_Br_schemewc_Component = OldBr_schemewc;
                        }
                        else if ( nCmpId == 126 )
                        {
                           OldBr_procedurewc = cgiGet( "W0126");
                           ...
                           if ( StringUtil.Len( WebComp_Br_procedurewc_Component) != 0 )
                           {
                              WebComp_Br_procedurewc.componentprocess("W0126", "", sEvt);
                           }
                           WebComp_Br_procedurewc_Component = OldBr_procedurewc;
                        }
                        else if ( nCmpId == 134 )
                        {
                           OldBr_medicalimagingwc = cgiGet( "W0134");
                           ...
                           if ( StringUtil.Len( WebComp_Br_medicalimagingwc_Component) != 0 )
                           {
                              WebComp_Br_medicalimagingwc.componentprocess("W0134", "", sEvt);
                           }
                           WebComp_Br_medicalimagingwc_Component = OldBr_medicalimagingwc;
                        }
                        else if ( nCmpId == 142 )
                        {
                           OldBr_pathologywc = cgiGet( "W0142");
                           ...
                           if ( StringUtil.Len( WebComp_Br_pathologywc_Component) != 0 )
                           {
                              WebComp_Br_pathologywc.componentprocess("W0142", "", sEvt);
                           }
                           WebComp_Br_pathologywc_Component = OldBr_pathologywc;
                        }
                     }
      ...
      protected void RF3S2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            if ( 1 != 0 )
            {
               if ( StringUtil.Len( WebComp_Br_familyhistorywc_Component) != 0 )
               {
                  WebComp_Br_familyhistorywc.componentstart();
               }
            }
         }
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
      ...
      protected void E233S2( )
      {
         ...
         {
            CallWebObject(formatLink("br_encounterlistww.aspx") );
      ...
      protected void E393S2( )
      {
         ...
         new zutil_setsession(context ).execute(  AV6WWPContext) ;
         this.executeUsercontrolMethod("", false, "TABSContainer", "SelectTab", "", new Object[] {(short)14});
      ...
      protected void S112( )
      {
         ...
         divCell_br_familyhistory_Visible = 1;
         context.httpAjaxContext.ajax_rsp_assign_prop("", false, divCell_br_familyhistory_Internalname, "Visible", StringUtil.LTrim( StringUtil.Str( (decimal)(divCell_br_familyhistory_Visible), 5, 0)), true);
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV12SelectedTabCode, "BR_Familyhistory") == 0 ) )
         {
            /* Object Property */
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Br_familyhistorywc_Component), StringUtil.Lower( "BR_EncounterCheckFamilyhistory")) != 0 )
            {
               WebComp_Br_familyhistorywc = getWebComponent(GetType(), "GeneXus.Programs", "br_encountercheckfamilyhistory", new Object[] {context} );
               WebComp_Br_familyhistorywc.ComponentInit();
               WebComp_Br_familyhistorywc.Name = "BR_EncounterCheckFamilyhistory";
               WebComp_Br_familyhistorywc_Component = "BR_EncounterCheckFamilyhistory";
            }
            if ( StringUtil.Len( WebComp_Br_familyhistorywc_Component) != 0 )
            {
               WebComp_Br_familyhistorywc.setjustcreated();
               WebComp_Br_familyhistorywc.componentprepare(new Object[] {(String)"W0062",(String)"",(long)AV10BR_EncounterID});
               WebComp_Br_familyhistorywc.componentbind(new Object[] {(String)""});
            }
            if ( isFullAjaxMode( ) )
            {
               context.httpAjaxContext.ajax_rspStartCmp("gxHTMLWrpW0062"+"");
            ...
            lblTxttabtitle_Caption = "家族史";
            context.httpAjaxContext.ajax_rsp_assign_prop("", false, lblTxttabtitle_Internalname, "Caption", lblTxttabtitle_Caption, true);
            if ( StringUtil.StrCmp(AV12SelectedTabCode, "BR_Familyhistory") == 0 )
            {
               divCell_br_familyhistory_Visible = 0;
               context.httpAjaxContext.ajax_rsp_assign_prop("", false, divCell_br_familyhistory_Internalname, "Visible", StringUtil.LTrim( StringUtil.Str( (decimal)(divCell_br_familyhistory_Visible), 5, 0)), true);
            }
         }
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV12SelectedTabCode, "CheckComorbidity") == 0 ) )
         {
            ...
            if ( StringUtil.Len( WebComp_Checkcomorbiditywc_Component) != 0 )
            {
               ...
               WebComp_Checkcomorbiditywc.componentprepare(new Object[] {(String)"W0070",(String)"",(long)AV10BR_EncounterID});
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV12SelectedTabCode, "CheckDeath") == 0 ) )
         {
            ...
            if ( StringUtil.Len( WebComp_Checkdeathwc_Component) != 0 )
            {
               ...
               WebComp_Checkdeathwc.componentprepare(new Object[] {(String)"W0078",(String)"",(long)AV10BR_EncounterID});
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV12SelectedTabCode, "CheckVital") == 0 ) )
         {
            ...
            if ( StringUtil.Len( WebComp_Checkvitalwc_Component) != 0 )
            {
               ...
               WebComp_Checkvitalwc.componentprepare(new Object[] {(String)"W0086",(String)"",(long)AV10BR_EncounterID});
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV12SelectedTabCode, "BR_Diagnosis") == 0 ) )
         {
            ...
            if ( StringUtil.Len( WebComp_Br_diagnosiswc_Component) != 0 )
            {
               ...
               WebComp_Br_diagnosiswc.componentprepare(new Object[] {(String)"W0094",(String)"",(long)AV10BR_EncounterID});
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV12SelectedTabCode, "BR_Lab") == 0 ) )
         {
            ...
            if ( StringUtil.Len( WebComp_Br_labwc_Component) != 0 )
            {
               ...
               WebComp_Br_labwc.componentprepare(new Object[] {(String)"W0102",(String)"",(long)AV10BR_EncounterID});
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV12SelectedTabCode, "BR_Medication") == 0 ) )
         {
            ...
            if ( StringUtil.Len( WebComp_Br_medicationwc_Component) != 0 )
            {
               ...
               WebComp_Br_medicationwc.componentprepare(new Object[] {(String)"W0110",(String)"",(long)AV10BR_EncounterID});
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV12SelectedTabCode, "BR_Scheme") == 0 ) )
         {
            ...
            if ( StringUtil.Len( WebComp_Br_schemewc_Component) != 0 )
            {
               ...
               WebComp_Br_schemewc.componentprepare(new Object[] {(String)"W0118",(String)"",(long)AV10BR_EncounterID});
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV12SelectedTabCode, "BR_Procedure") == 0 ) )
         {
            ...
            if ( StringUtil.Len( WebComp_Br_procedurewc_Component) != 0 )
            {
               ...
               WebComp_Br_procedurewc.componentprepare(new Object[] {(String)"W0126",(String)"",(long)AV10BR_EncounterID});
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV12SelectedTabCode, "BR_MedicalImaging") == 0 ) )
         {
            ...
            if ( StringUtil.Len( WebComp_Br_medicalimagingwc_Component) != 0 )
            {
               ...
               WebComp_Br_medicalimagingwc.componentprepare(new Object[] {(String)"W0134",(String)"",(long)AV10BR_EncounterID});
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV12SelectedTabCode, "BR_Pathology") == 0 ) )
         {
            ...
            if ( StringUtil.Len( WebComp_Br_pathologywc_Component) != 0 )
            {
               ...
               WebComp_Br_pathologywc.componentprepare(new Object[] {(String)"W0142",(String)"",(long)AV10BR_EncounterID});
      ...
      protected void wb_table5_211_3S2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            wb_table5_211_3S2e( true) ;
         }
         else
         {
            wb_table5_211_3S2e( false) ;
         }
      }

      protected void wb_table4_206_3S2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table4_206_3S2e( true) ;
         }
         else
         {
            wb_table4_206_3S2e( false) ;
         }
      }

      protected void wb_table3_201_3S2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table3_201_3S2e( true) ;
         }
         else
         {
            wb_table3_201_3S2e( false) ;
         }
      }

      protected void wb_table2_196_3S2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_196_3S2e( true) ;
         }
         else
         {
            wb_table2_196_3S2e( false) ;
         }
      }

      protected void wb_table1_191_3S2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_191_3S2e( true) ;
         }
         else
         {
            wb_table1_191_3S2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         if ( ! ( WebComp_Br_familyhistorywc == null ) )
         {
            if ( StringUtil.Len( WebComp_Br_familyhistorywc_Component) != 0 )
            {
               WebComp_Br_familyhistorywc.componentthemes();
            }
         }
         if ( ! ( WebComp_Checkcomorbiditywc == null ) )
         {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?20202281511141", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("br_encountercheck.js", "?20202281511142", false);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false);
      ...
      protected void init_default_properties( )
      {
         ...
         lblBr_familyhistory_title_Internalname = "BR_FAMILYHISTORY_TITLE";
         divUnnamedtablebr_familyhistory_Internalname = "UNNAMEDTABLEBR_FAMILYHISTORY";
         ...
         bttBtnbr_familyhistory_Internalname = "BTNBR_FAMILYHISTORY";
         divCell_br_familyhistory_Internalname = "CELL_BR_FAMILYHISTORY";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'GENERAL'",",oparms:[{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'divCell_general_Visible',ctrl:'CELL_GENERAL',prop:'Visible'},{ctrl:'GENERALWC'},{av:'lblTxttabtitle_Caption',ctrl:'TXTTABTITLE',prop:'Caption'},{av:'divCell_checkdemographics_Visible',ctrl:'CELL_CHECKDEMOGRAPHICS',prop:'Visible'},{ctrl:'CHECKDEMOGRAPHICSWC'},{av:'divCell_checkbehavior_Visible',ctrl:'CELL_CHECKBEHAVIOR',prop:'Visible'},{ctrl:'CHECKBEHAVIORWC'},{av:'divCell_br_familyhistory_Visible',ctrl:'CELL_BR_FAMILYHISTORY',prop:'Visible'},{ctrl:'BR_FAMILYHISTORYWC'},{av:'divCell_checkcomorbidity_Visible',ctrl:'CELL_CHECKCOMORBIDITY',prop:'Visible'},{ctrl:'CHECKCOMORBIDITYWC'},{av:'divCell_checkdeath_Visible',ctrl:'CELL_CHECKDEATH',prop:'Visible'},{ctrl:'CHECKDEATHWC'},{av:'divCell_checkvital_Visible',ctrl:'CELL_CHECKVITAL',prop:'Visible'},{ctrl:'CHECKVITALWC'},{av:'divCell_br_diagnosis_Visible',ctrl:'CELL_BR_DIAGNOSIS',prop:'Visible'},{ctrl:'BR_DIAGNOSISWC'},{av:'divCell_br_lab_Visible',ctrl:'CELL_BR_LAB',prop:'Visible'},{ctrl:'BR_LABWC'},{av:'divCell_br_medication_Visible',ctrl:'CELL_BR_MEDICATION',prop:'Visible'},{ctrl:'BR_MEDICATIONWC'},{av:'divCell_br_scheme_Visible',ctrl:'CELL_BR_SCHEME',prop:'Visible'},{ctrl:'BR_SCHEMEWC'},{av:'divCell_br_procedure_Visible',ctrl:'CELL_BR_PROCEDURE',prop:'Visible'},{ctrl:'BR_PROCEDUREWC'},{av:'divCell_br_medicalimaging_Visible',ctrl:'CELL_BR_MEDICALIMAGING',prop:'Visible'},{ctrl:'BR_MEDICALIMAGINGWC'},{av:'divCell_br_pathology_Visible',ctrl:'CELL_BR_PATHOLOGY',prop:'Visible'},{ctrl:'BR_PATHOLOGYWC'}]}");
         ...
         setEventMetadata("'CHECKDEMOGRAPHICS'",",oparms:[{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'divCell_general_Visible',ctrl:'CELL_GENERAL',prop:'Visible'},{ctrl:'GENERALWC'},{av:'lblTxttabtitle_Caption',ctrl:'TXTTABTITLE',prop:'Caption'},{av:'divCell_checkdemographics_Visible',ctrl:'CELL_CHECKDEMOGRAPHICS',prop:'Visible'},{ctrl:'CHECKDEMOGRAPHICSWC'},{av:'divCell_checkbehavior_Visible',ctrl:'CELL_CHECKBEHAVIOR',prop:'Visible'},{ctrl:'CHECKBEHAVIORWC'},{av:'divCell_br_familyhistory_Visible',ctrl:'CELL_BR_FAMILYHISTORY',prop:'Visible'},{ctrl:'BR_FAMILYHISTORYWC'},{av:'divCell_checkcomorbidity_Visible',ctrl:'CELL_CHECKCOMORBIDITY',prop:'Visible'},{ctrl:'CHECKCOMORBIDITYWC'},{av:'divCell_checkdeath_Visible',ctrl:'CELL_CHECKDEATH',prop:'Visible'},{ctrl:'CHECKDEATHWC'},{av:'divCell_checkvital_Visible',ctrl:'CELL_CHECKVITAL',prop:'Visible'},{ctrl:'CHECKVITALWC'},{av:'divCell_br_diagnosis_Visible',ctrl:'CELL_BR_DIAGNOSIS',prop:'Visible'},{ctrl:'BR_DIAGNOSISWC'},{av:'divCell_br_lab_Visible',ctrl:'CELL_BR_LAB',prop:'Visible'},{ctrl:'BR_LABWC'},{av:'divCell_br_medication_Visible',ctrl:'CELL_BR_MEDICATION',prop:'Visible'},{ctrl:'BR_MEDICATIONWC'},{av:'divCell_br_scheme_Visible',ctrl:'CELL_BR_SCHEME',prop:'Visible'},{ctrl:'BR_SCHEMEWC'},{av:'divCell_br_procedure_Visible',ctrl:'CELL_BR_PROCEDURE',prop:'Visible'},{ctrl:'BR_PROCEDUREWC'},{av:'divCell_br_medicalimaging_Visible',ctrl:'CELL_BR_MEDICALIMAGING',prop:'Visible'},{ctrl:'BR_MEDICALIMAGINGWC'},{av:'divCell_br_pathology_Visible',ctrl:'CELL_BR_PATHOLOGY',prop:'Visible'},{ctrl:'BR_PATHOLOGYWC'}]}");
         ...
         setEventMetadata("'CHECKBEHAVIOR'",",oparms:[{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'divCell_general_Visible',ctrl:'CELL_GENERAL',prop:'Visible'},{ctrl:'GENERALWC'},{av:'lblTxttabtitle_Caption',ctrl:'TXTTABTITLE',prop:'Caption'},{av:'divCell_checkdemographics_Visible',ctrl:'CELL_CHECKDEMOGRAPHICS',prop:'Visible'},{ctrl:'CHECKDEMOGRAPHICSWC'},{av:'divCell_checkbehavior_Visible',ctrl:'CELL_CHECKBEHAVIOR',prop:'Visible'},{ctrl:'CHECKBEHAVIORWC'},{av:'divCell_br_familyhistory_Visible',ctrl:'CELL_BR_FAMILYHISTORY',prop:'Visible'},{ctrl:'BR_FAMILYHISTORYWC'},{av:'divCell_checkcomorbidity_Visible',ctrl:'CELL_CHECKCOMORBIDITY',prop:'Visible'},{ctrl:'CHECKCOMORBIDITYWC'},{av:'divCell_checkdeath_Visible',ctrl:'CELL_CHECKDEATH',prop:'Visible'},{ctrl:'CHECKDEATHWC'},{av:'divCell_checkvital_Visible',ctrl:'CELL_CHECKVITAL',prop:'Visible'},{ctrl:'CHECKVITALWC'},{av:'divCell_br_diagnosis_Visible',ctrl:'CELL_BR_DIAGNOSIS',prop:'Visible'},{ctrl:'BR_DIAGNOSISWC'},{av:'divCell_br_lab_Visible',ctrl:'CELL_BR_LAB',prop:'Visible'},{ctrl:'BR_LABWC'},{av:'divCell_br_medication_Visible',ctrl:'CELL_BR_MEDICATION',prop:'Visible'},{ctrl:'BR_MEDICATIONWC'},{av:'divCell_br_scheme_Visible',ctrl:'CELL_BR_SCHEME',prop:'Visible'},{ctrl:'BR_SCHEMEWC'},{av:'divCell_br_procedure_Visible',ctrl:'CELL_BR_PROCEDURE',prop:'Visible'},{ctrl:'BR_PROCEDUREWC'},{av:'divCell_br_medicalimaging_Visible',ctrl:'CELL_BR_MEDICALIMAGING',prop:'Visible'},{ctrl:'BR_MEDICALIMAGINGWC'},{av:'divCell_br_pathology_Visible',ctrl:'CELL_BR_PATHOLOGY',prop:'Visible'},{ctrl:'BR_PATHOLOGYWC'}]}");
         setEventMetadata("'BR_FAMILYHISTORY'","{handler:'E293S2',iparms:[{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV10BR_EncounterID',fld:'vBR_ENCOUNTERID',pic:'ZZZZZZZZZZZZZZZZZZ',hsh:true}]");
         setEventMetadata("'BR_FAMILYHISTORY'",",oparms:[{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'divCell_general_Visible',ctrl:'CELL_GENERAL',prop:'Visible'},{ctrl:'GENERALWC'},{av:'lblTxttabtitle_Caption',ctrl:'TXTTABTITLE',prop:'Caption'},{av:'divCell_checkdemographics_Visible',ctrl:'CELL_CHECKDEMOGRAPHICS',prop:'Visible'},{ctrl:'CHECKDEMOGRAPHICSWC'},{av:'divCell_checkbehavior_Visible',ctrl:'CELL_CHECKBEHAVIOR',prop:'Visible'},{ctrl:'CHECKBEHAVIORWC'},{av:'divCell_br_familyhistory_Visible',ctrl:'CELL_BR_FAMILYHISTORY',prop:'Visible'},{ctrl:'BR_FAMILYHISTORYWC'},{av:'divCell_checkcomorbidity_Visible',ctrl:'CELL_CHECKCOMORBIDITY',prop:'Visible'},{ctrl:'CHECKCOMORBIDITYWC'},{av:'divCell_checkdeath_Visible',ctrl:'CELL_CHECKDEATH',prop:'Visible'},{ctrl:'CHECKDEATHWC'},{av:'divCell_checkvital_Visible',ctrl:'CELL_CHECKVITAL',prop:'Visible'},{ctrl:'CHECKVITALWC'},{av:'divCell_br_diagnosis_Visible',ctrl:'CELL_BR_DIAGNOSIS',prop:'Visible'},{ctrl:'BR_DIAGNOSISWC'},{av:'divCell_br_lab_Visible',ctrl:'CELL_BR_LAB',prop:'Visible'},{ctrl:'BR_LABWC'},{av:'divCell_br_medication_Visible',ctrl:'CELL_BR_MEDICATION',prop:'Visible'},{ctrl:'BR_MEDICATIONWC'},{av:'divCell_br_scheme_Visible',ctrl:'CELL_BR_SCHEME',prop:'Visible'},{ctrl:'BR_SCHEMEWC'},{av:'divCell_br_procedure_Visible',ctrl:'CELL_BR_PROCEDURE',prop:'Visible'},{ctrl:'BR_PROCEDUREWC'},{av:'divCell_br_medicalimaging_Visible',ctrl:'CELL_BR_MEDICALIMAGING',prop:'Visible'},{ctrl:'BR_MEDICALIMAGINGWC'},{av:'divCell_br_pathology_Visible',ctrl:'CELL_BR_PATHOLOGY',prop:'Visible'},{ctrl:'BR_PATHOLOGYWC'}]}");
         setEventMetadata("'CHECKCOMORBIDITY'","{handler:'E303S2',iparms:[{av:'AV6WWPContext',fld:'vWWPCONTEXT',pic:''},{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV10BR_EncounterID',fld:'vBR_ENCOUNTERID',pic:'ZZZZZZZZZZZZZZZZZZ',hsh:true}]");
         setEventMetadata("'CHECKCOMORBIDITY'",",oparms:[{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'divCell_general_Visible',ctrl:'CELL_GENERAL',prop:'Visible'},{ctrl:'GENERALWC'},{av:'lblTxttabtitle_Caption',ctrl:'TXTTABTITLE',prop:'Caption'},{av:'divCell_checkdemographics_Visible',ctrl:'CELL_CHECKDEMOGRAPHICS',prop:'Visible'},{ctrl:'CHECKDEMOGRAPHICSWC'},{av:'divCell_checkbehavior_Visible',ctrl:'CELL_CHECKBEHAVIOR',prop:'Visible'},{ctrl:'CHECKBEHAVIORWC'},{av:'divCell_br_familyhistory_Visible',ctrl:'CELL_BR_FAMILYHISTORY',prop:'Visible'},{ctrl:'BR_FAMILYHISTORYWC'},{av:'divCell_checkcomorbidity_Visible',ctrl:'CELL_CHECKCOMORBIDITY',prop:'Visible'},{ctrl:'CHECKCOMORBIDITYWC'},{av:'divCell_checkdeath_Visible',ctrl:'CELL_CHECKDEATH',prop:'Visible'},{ctrl:'CHECKDEATHWC'},{av:'divCell_checkvital_Visible',ctrl:'CELL_CHECKVITAL',prop:'Visible'},{ctrl:'CHECKVITALWC'},{av:'divCell_br_diagnosis_Visible',ctrl:'CELL_BR_DIAGNOSIS',prop:'Visible'},{ctrl:'BR_DIAGNOSISWC'},{av:'divCell_br_lab_Visible',ctrl:'CELL_BR_LAB',prop:'Visible'},{ctrl:'BR_LABWC'},{av:'divCell_br_medication_Visible',ctrl:'CELL_BR_MEDICATION',prop:'Visible'},{ctrl:'BR_MEDICATIONWC'},{av:'divCell_br_scheme_Visible',ctrl:'CELL_BR_SCHEME',prop:'Visible'},{ctrl:'BR_SCHEMEWC'},{av:'divCell_br_procedure_Visible',ctrl:'CELL_BR_PROCEDURE',prop:'Visible'},{ctrl:'BR_PROCEDUREWC'},{av:'divCell_br_medicalimaging_Visible',ctrl:'CELL_BR_MEDICALIMAGING',prop:'Visible'},{ctrl:'BR_MEDICALIMAGINGWC'},{av:'divCell_br_pathology_Visible',ctrl:'CELL_BR_PATHOLOGY',prop:'Visible'},{ctrl:'BR_PATHOLOGYWC'}]}");
         setEventMetadata("'CHECKDEATH'","{handler:'E313S2',iparms:[{av:'AV6WWPContext',fld:'vWWPCONTEXT',pic:''},{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV10BR_EncounterID',fld:'vBR_ENCOUNTERID',pic:'ZZZZZZZZZZZZZZZZZZ',hsh:true}]");
         setEventMetadata("'CHECKDEATH'",",oparms:[{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'divCell_general_Visible',ctrl:'CELL_GENERAL',prop:'Visible'},{ctrl:'GENERALWC'},{av:'lblTxttabtitle_Caption',ctrl:'TXTTABTITLE',prop:'Caption'},{av:'divCell_checkdemographics_Visible',ctrl:'CELL_CHECKDEMOGRAPHICS',prop:'Visible'},{ctrl:'CHECKDEMOGRAPHICSWC'},{av:'divCell_checkbehavior_Visible',ctrl:'CELL_CHECKBEHAVIOR',prop:'Visible'},{ctrl:'CHECKBEHAVIORWC'},{av:'divCell_br_familyhistory_Visible',ctrl:'CELL_BR_FAMILYHISTORY',prop:'Visible'},{ctrl:'BR_FAMILYHISTORYWC'},{av:'divCell_checkcomorbidity_Visible',ctrl:'CELL_CHECKCOMORBIDITY',prop:'Visible'},{ctrl:'CHECKCOMORBIDITYWC'},{av:'divCell_checkdeath_Visible',ctrl:'CELL_CHECKDEATH',prop:'Visible'},{ctrl:'CHECKDEATHWC'},{av:'divCell_checkvital_Visible',ctrl:'CELL_CHECKVITAL',prop:'Visible'},{ctrl:'CHECKVITALWC'},{av:'divCell_br_diagnosis_Visible',ctrl:'CELL_BR_DIAGNOSIS',prop:'Visible'},{ctrl:'BR_DIAGNOSISWC'},{av:'divCell_br_lab_Visible',ctrl:'CELL_BR_LAB',prop:'Visible'},{ctrl:'BR_LABWC'},{av:'divCell_br_medication_Visible',ctrl:'CELL_BR_MEDICATION',prop:'Visible'},{ctrl:'BR_MEDICATIONWC'},{av:'divCell_br_scheme_Visible',ctrl:'CELL_BR_SCHEME',prop:'Visible'},{ctrl:'BR_SCHEMEWC'},{av:'divCell_br_procedure_Visible',ctrl:'CELL_BR_PROCEDURE',prop:'Visible'},{ctrl:'BR_PROCEDUREWC'},{av:'divCell_br_medicalimaging_Visible',ctrl:'CELL_BR_MEDICALIMAGING',prop:'Visible'},{ctrl:'BR_MEDICALIMAGINGWC'},{av:'divCell_br_pathology_Visible',ctrl:'CELL_BR_PATHOLOGY',prop:'Visible'},{ctrl:'BR_PATHOLOGYWC'}]}");
         setEventMetadata("'CHECKVITAL'","{handler:'E323S2',iparms:[{av:'AV6WWPContext',fld:'vWWPCONTEXT',pic:''},{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV10BR_EncounterID',fld:'vBR_ENCOUNTERID',pic:'ZZZZZZZZZZZZZZZZZZ',hsh:true}]");
         setEventMetadata("'CHECKVITAL'",",oparms:[{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'divCell_general_Visible',ctrl:'CELL_GENERAL',prop:'Visible'},{ctrl:'GENERALWC'},{av:'lblTxttabtitle_Caption',ctrl:'TXTTABTITLE',prop:'Caption'},{av:'divCell_checkdemographics_Visible',ctrl:'CELL_CHECKDEMOGRAPHICS',prop:'Visible'},{ctrl:'CHECKDEMOGRAPHICSWC'},{av:'divCell_checkbehavior_Visible',ctrl:'CELL_CHECKBEHAVIOR',prop:'Visible'},{ctrl:'CHECKBEHAVIORWC'},{av:'divCell_br_familyhistory_Visible',ctrl:'CELL_BR_FAMILYHISTORY',prop:'Visible'},{ctrl:'BR_FAMILYHISTORYWC'},{av:'divCell_checkcomorbidity_Visible',ctrl:'CELL_CHECKCOMORBIDITY',prop:'Visible'},{ctrl:'CHECKCOMORBIDITYWC'},{av:'divCell_checkdeath_Visible',ctrl:'CELL_CHECKDEATH',prop:'Visible'},{ctrl:'CHECKDEATHWC'},{av:'divCell_checkvital_Visible',ctrl:'CELL_CHECKVITAL',prop:'Visible'},{ctrl:'CHECKVITALWC'},{av:'divCell_br_diagnosis_Visible',ctrl:'CELL_BR_DIAGNOSIS',prop:'Visible'},{ctrl:'BR_DIAGNOSISWC'},{av:'divCell_br_lab_Visible',ctrl:'CELL_BR_LAB',prop:'Visible'},{ctrl:'BR_LABWC'},{av:'divCell_br_medication_Visible',ctrl:'CELL_BR_MEDICATION',prop:'Visible'},{ctrl:'BR_MEDICATIONWC'},{av:'divCell_br_scheme_Visible',ctrl:'CELL_BR_SCHEME',prop:'Visible'},{ctrl:'BR_SCHEMEWC'},{av:'divCell_br_procedure_Visible',ctrl:'CELL_BR_PROCEDURE',prop:'Visible'},{ctrl:'BR_PROCEDUREWC'},{av:'divCell_br_medicalimaging_Visible',ctrl:'CELL_BR_MEDICALIMAGING',prop:'Visible'},{ctrl:'BR_MEDICALIMAGINGWC'},{av:'divCell_br_pathology_Visible',ctrl:'CELL_BR_PATHOLOGY',prop:'Visible'},{ctrl:'BR_PATHOLOGYWC'}]}");
         setEventMetadata("'BR_DIAGNOSIS'","{handler:'E333S2',iparms:[{av:'AV6WWPContext',fld:'vWWPCONTEXT',pic:''},{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV10BR_EncounterID',fld:'vBR_ENCOUNTERID',pic:'ZZZZZZZZZZZZZZZZZZ',hsh:true}]");
         setEventMetadata("'BR_DIAGNOSIS'",",oparms:[{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'divCell_general_Visible',ctrl:'CELL_GENERAL',prop:'Visible'},{ctrl:'GENERALWC'},{av:'lblTxttabtitle_Caption',ctrl:'TXTTABTITLE',prop:'Caption'},{av:'divCell_checkdemographics_Visible',ctrl:'CELL_CHECKDEMOGRAPHICS',prop:'Visible'},{ctrl:'CHECKDEMOGRAPHICSWC'},{av:'divCell_checkbehavior_Visible',ctrl:'CELL_CHECKBEHAVIOR',prop:'Visible'},{ctrl:'CHECKBEHAVIORWC'},{av:'divCell_br_familyhistory_Visible',ctrl:'CELL_BR_FAMILYHISTORY',prop:'Visible'},{ctrl:'BR_FAMILYHISTORYWC'},{av:'divCell_checkcomorbidity_Visible',ctrl:'CELL_CHECKCOMORBIDITY',prop:'Visible'},{ctrl:'CHECKCOMORBIDITYWC'},{av:'divCell_checkdeath_Visible',ctrl:'CELL_CHECKDEATH',prop:'Visible'},{ctrl:'CHECKDEATHWC'},{av:'divCell_checkvital_Visible',ctrl:'CELL_CHECKVITAL',prop:'Visible'},{ctrl:'CHECKVITALWC'},{av:'divCell_br_diagnosis_Visible',ctrl:'CELL_BR_DIAGNOSIS',prop:'Visible'},{ctrl:'BR_DIAGNOSISWC'},{av:'divCell_br_lab_Visible',ctrl:'CELL_BR_LAB',prop:'Visible'},{ctrl:'BR_LABWC'},{av:'divCell_br_medication_Visible',ctrl:'CELL_BR_MEDICATION',prop:'Visible'},{ctrl:'BR_MEDICATIONWC'},{av:'divCell_br_scheme_Visible',ctrl:'CELL_BR_SCHEME',prop:'Visible'},{ctrl:'BR_SCHEMEWC'},{av:'divCell_br_procedure_Visible',ctrl:'CELL_BR_PROCEDURE',prop:'Visible'},{ctrl:'BR_PROCEDUREWC'},{av:'divCell_br_medicalimaging_Visible',ctrl:'CELL_BR_MEDICALIMAGING',prop:'Visible'},{ctrl:'BR_MEDICALIMAGINGWC'},{av:'divCell_br_pathology_Visible',ctrl:'CELL_BR_PATHOLOGY',prop:'Visible'},{ctrl:'BR_PATHOLOGYWC'}]}");
         setEventMetadata("'BR_LAB'","{handler:'E343S2',iparms:[{av:'AV6WWPContext',fld:'vWWPCONTEXT',pic:''},{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV10BR_EncounterID',fld:'vBR_ENCOUNTERID',pic:'ZZZZZZZZZZZZZZZZZZ',hsh:true}]");
         setEventMetadata("'BR_LAB'",",oparms:[{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'divCell_general_Visible',ctrl:'CELL_GENERAL',prop:'Visible'},{ctrl:'GENERALWC'},{av:'lblTxttabtitle_Caption',ctrl:'TXTTABTITLE',prop:'Caption'},{av:'divCell_checkdemographics_Visible',ctrl:'CELL_CHECKDEMOGRAPHICS',prop:'Visible'},{ctrl:'CHECKDEMOGRAPHICSWC'},{av:'divCell_checkbehavior_Visible',ctrl:'CELL_CHECKBEHAVIOR',prop:'Visible'},{ctrl:'CHECKBEHAVIORWC'},{av:'divCell_br_familyhistory_Visible',ctrl:'CELL_BR_FAMILYHISTORY',prop:'Visible'},{ctrl:'BR_FAMILYHISTORYWC'},{av:'divCell_checkcomorbidity_Visible',ctrl:'CELL_CHECKCOMORBIDITY',prop:'Visible'},{ctrl:'CHECKCOMORBIDITYWC'},{av:'divCell_checkdeath_Visible',ctrl:'CELL_CHECKDEATH',prop:'Visible'},{ctrl:'CHECKDEATHWC'},{av:'divCell_checkvital_Visible',ctrl:'CELL_CHECKVITAL',prop:'Visible'},{ctrl:'CHECKVITALWC'},{av:'divCell_br_diagnosis_Visible',ctrl:'CELL_BR_DIAGNOSIS',prop:'Visible'},{ctrl:'BR_DIAGNOSISWC'},{av:'divCell_br_lab_Visible',ctrl:'CELL_BR_LAB',prop:'Visible'},{ctrl:'BR_LABWC'},{av:'divCell_br_medication_Visible',ctrl:'CELL_BR_MEDICATION',prop:'Visible'},{ctrl:'BR_MEDICATIONWC'},{av:'divCell_br_scheme_Visible',ctrl:'CELL_BR_SCHEME',prop:'Visible'},{ctrl:'BR_SCHEMEWC'},{av:'divCell_br_procedure_Visible',ctrl:'CELL_BR_PROCEDURE',prop:'Visible'},{ctrl:'BR_PROCEDUREWC'},{av:'divCell_br_medicalimaging_Visible',ctrl:'CELL_BR_MEDICALIMAGING',prop:'Visible'},{ctrl:'BR_MEDICALIMAGINGWC'},{av:'divCell_br_pathology_Visible',ctrl:'CELL_BR_PATHOLOGY',prop:'Visible'},{ctrl:'BR_PATHOLOGYWC'}]}");
         setEventMetadata("'BR_MEDICATION'","{handler:'E353S2',iparms:[{av:'AV6WWPContext',fld:'vWWPCONTEXT',pic:''},{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV10BR_EncounterID',fld:'vBR_ENCOUNTERID',pic:'ZZZZZZZZZZZZZZZZZZ',hsh:true}]");
         setEventMetadata("'BR_MEDICATION'",",oparms:[{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'divCell_general_Visible',ctrl:'CELL_GENERAL',prop:'Visible'},{ctrl:'GENERALWC'},{av:'lblTxttabtitle_Caption',ctrl:'TXTTABTITLE',prop:'Caption'},{av:'divCell_checkdemographics_Visible',ctrl:'CELL_CHECKDEMOGRAPHICS',prop:'Visible'},{ctrl:'CHECKDEMOGRAPHICSWC'},{av:'divCell_checkbehavior_Visible',ctrl:'CELL_CHECKBEHAVIOR',prop:'Visible'},{ctrl:'CHECKBEHAVIORWC'},{av:'divCell_br_familyhistory_Visible',ctrl:'CELL_BR_FAMILYHISTORY',prop:'Visible'},{ctrl:'BR_FAMILYHISTORYWC'},{av:'divCell_checkcomorbidity_Visible',ctrl:'CELL_CHECKCOMORBIDITY',prop:'Visible'},{ctrl:'CHECKCOMORBIDITYWC'},{av:'divCell_checkdeath_Visible',ctrl:'CELL_CHECKDEATH',prop:'Visible'},{ctrl:'CHECKDEATHWC'},{av:'divCell_checkvital_Visible',ctrl:'CELL_CHECKVITAL',prop:'Visible'},{ctrl:'CHECKVITALWC'},{av:'divCell_br_diagnosis_Visible',ctrl:'CELL_BR_DIAGNOSIS',prop:'Visible'},{ctrl:'BR_DIAGNOSISWC'},{av:'divCell_br_lab_Visible',ctrl:'CELL_BR_LAB',prop:'Visible'},{ctrl:'BR_LABWC'},{av:'divCell_br_medication_Visible',ctrl:'CELL_BR_MEDICATION',prop:'Visible'},{ctrl:'BR_MEDICATIONWC'},{av:'divCell_br_scheme_Visible',ctrl:'CELL_BR_SCHEME',prop:'Visible'},{ctrl:'BR_SCHEMEWC'},{av:'divCell_br_procedure_Visible',ctrl:'CELL_BR_PROCEDURE',prop:'Visible'},{ctrl:'BR_PROCEDUREWC'},{av:'divCell_br_medicalimaging_Visible',ctrl:'CELL_BR_MEDICALIMAGING',prop:'Visible'},{ctrl:'BR_MEDICALIMAGINGWC'},{av:'divCell_br_pathology_Visible',ctrl:'CELL_BR_PATHOLOGY',prop:'Visible'},{ctrl:'BR_PATHOLOGYWC'}]}");
         setEventMetadata("'BR_SCHEME'","{handler:'E363S2',iparms:[{av:'AV6WWPContext',fld:'vWWPCONTEXT',pic:''},{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV10BR_EncounterID',fld:'vBR_ENCOUNTERID',pic:'ZZZZZZZZZZZZZZZZZZ',hsh:true}]");
         setEventMetadata("'BR_SCHEME'",",oparms:[{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'divCell_general_Visible',ctrl:'CELL_GENERAL',prop:'Visible'},{ctrl:'GENERALWC'},{av:'lblTxttabtitle_Caption',ctrl:'TXTTABTITLE',prop:'Caption'},{av:'divCell_checkdemographics_Visible',ctrl:'CELL_CHECKDEMOGRAPHICS',prop:'Visible'},{ctrl:'CHECKDEMOGRAPHICSWC'},{av:'divCell_checkbehavior_Visible',ctrl:'CELL_CHECKBEHAVIOR',prop:'Visible'},{ctrl:'CHECKBEHAVIORWC'},{av:'divCell_br_familyhistory_Visible',ctrl:'CELL_BR_FAMILYHISTORY',prop:'Visible'},{ctrl:'BR_FAMILYHISTORYWC'},{av:'divCell_checkcomorbidity_Visible',ctrl:'CELL_CHECKCOMORBIDITY',prop:'Visible'},{ctrl:'CHECKCOMORBIDITYWC'},{av:'divCell_checkdeath_Visible',ctrl:'CELL_CHECKDEATH',prop:'Visible'},{ctrl:'CHECKDEATHWC'},{av:'divCell_checkvital_Visible',ctrl:'CELL_CHECKVITAL',prop:'Visible'},{ctrl:'CHECKVITALWC'},{av:'divCell_br_diagnosis_Visible',ctrl:'CELL_BR_DIAGNOSIS',prop:'Visible'},{ctrl:'BR_DIAGNOSISWC'},{av:'divCell_br_lab_Visible',ctrl:'CELL_BR_LAB',prop:'Visible'},{ctrl:'BR_LABWC'},{av:'divCell_br_medication_Visible',ctrl:'CELL_BR_MEDICATION',prop:'Visible'},{ctrl:'BR_MEDICATIONWC'},{av:'divCell_br_scheme_Visible',ctrl:'CELL_BR_SCHEME',prop:'Visible'},{ctrl:'BR_SCHEMEWC'},{av:'divCell_br_procedure_Visible',ctrl:'CELL_BR_PROCEDURE',prop:'Visible'},{ctrl:'BR_PROCEDUREWC'},{av:'divCell_br_medicalimaging_Visible',ctrl:'CELL_BR_MEDICALIMAGING',prop:'Visible'},{ctrl:'BR_MEDICALIMAGINGWC'},{av:'divCell_br_pathology_Visible',ctrl:'CELL_BR_PATHOLOGY',prop:'Visible'},{ctrl:'BR_PATHOLOGYWC'}]}");
         setEventMetadata("'BR_PROCEDURE'","{handler:'E373S2',iparms:[{av:'AV6WWPContext',fld:'vWWPCONTEXT',pic:''},{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV10BR_EncounterID',fld:'vBR_ENCOUNTERID',pic:'ZZZZZZZZZZZZZZZZZZ',hsh:true}]");
         setEventMetadata("'BR_PROCEDURE'",",oparms:[{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'divCell_general_Visible',ctrl:'CELL_GENERAL',prop:'Visible'},{ctrl:'GENERALWC'},{av:'lblTxttabtitle_Caption',ctrl:'TXTTABTITLE',prop:'Caption'},{av:'divCell_checkdemographics_Visible',ctrl:'CELL_CHECKDEMOGRAPHICS',prop:'Visible'},{ctrl:'CHECKDEMOGRAPHICSWC'},{av:'divCell_checkbehavior_Visible',ctrl:'CELL_CHECKBEHAVIOR',prop:'Visible'},{ctrl:'CHECKBEHAVIORWC'},{av:'divCell_br_familyhistory_Visible',ctrl:'CELL_BR_FAMILYHISTORY',prop:'Visible'},{ctrl:'BR_FAMILYHISTORYWC'},{av:'divCell_checkcomorbidity_Visible',ctrl:'CELL_CHECKCOMORBIDITY',prop:'Visible'},{ctrl:'CHECKCOMORBIDITYWC'},{av:'divCell_checkdeath_Visible',ctrl:'CELL_CHECKDEATH',prop:'Visible'},{ctrl:'CHECKDEATHWC'},{av:'divCell_checkvital_Visible',ctrl:'CELL_CHECKVITAL',prop:'Visible'},{ctrl:'CHECKVITALWC'},{av:'divCell_br_diagnosis_Visible',ctrl:'CELL_BR_DIAGNOSIS',prop:'Visible'},{ctrl:'BR_DIAGNOSISWC'},{av:'divCell_br_lab_Visible',ctrl:'CELL_BR_LAB',prop:'Visible'},{ctrl:'BR_LABWC'},{av:'divCell_br_medication_Visible',ctrl:'CELL_BR_MEDICATION',prop:'Visible'},{ctrl:'BR_MEDICATIONWC'},{av:'divCell_br_scheme_Visible',ctrl:'CELL_BR_SCHEME',prop:'Visible'},{ctrl:'BR_SCHEMEWC'},{av:'divCell_br_procedure_Visible',ctrl:'CELL_BR_PROCEDURE',prop:'Visible'},{ctrl:'BR_PROCEDUREWC'},{av:'divCell_br_medicalimaging_Visible',ctrl:'CELL_BR_MEDICALIMAGING',prop:'Visible'},{ctrl:'BR_MEDICALIMAGINGWC'},{av:'divCell_br_pathology_Visible',ctrl:'CELL_BR_PATHOLOGY',prop:'Visible'},{ctrl:'BR_PATHOLOGYWC'}]}");
         setEventMetadata("'BR_MEDICALIMAGING'","{handler:'E383S2',iparms:[{av:'AV6WWPContext',fld:'vWWPCONTEXT',pic:''},{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV10BR_EncounterID',fld:'vBR_ENCOUNTERID',pic:'ZZZZZZZZZZZZZZZZZZ',hsh:true}]");
         setEventMetadata("'BR_MEDICALIMAGING'",",oparms:[{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'divCell_general_Visible',ctrl:'CELL_GENERAL',prop:'Visible'},{ctrl:'GENERALWC'},{av:'lblTxttabtitle_Caption',ctrl:'TXTTABTITLE',prop:'Caption'},{av:'divCell_checkdemographics_Visible',ctrl:'CELL_CHECKDEMOGRAPHICS',prop:'Visible'},{ctrl:'CHECKDEMOGRAPHICSWC'},{av:'divCell_checkbehavior_Visible',ctrl:'CELL_CHECKBEHAVIOR',prop:'Visible'},{ctrl:'CHECKBEHAVIORWC'},{av:'divCell_br_familyhistory_Visible',ctrl:'CELL_BR_FAMILYHISTORY',prop:'Visible'},{ctrl:'BR_FAMILYHISTORYWC'},{av:'divCell_checkcomorbidity_Visible',ctrl:'CELL_CHECKCOMORBIDITY',prop:'Visible'},{ctrl:'CHECKCOMORBIDITYWC'},{av:'divCell_checkdeath_Visible',ctrl:'CELL_CHECKDEATH',prop:'Visible'},{ctrl:'CHECKDEATHWC'},{av:'divCell_checkvital_Visible',ctrl:'CELL_CHECKVITAL',prop:'Visible'},{ctrl:'CHECKVITALWC'},{av:'divCell_br_diagnosis_Visible',ctrl:'CELL_BR_DIAGNOSIS',prop:'Visible'},{ctrl:'BR_DIAGNOSISWC'},{av:'divCell_br_lab_Visible',ctrl:'CELL_BR_LAB',prop:'Visible'},{ctrl:'BR_LABWC'},{av:'divCell_br_medication_Visible',ctrl:'CELL_BR_MEDICATION',prop:'Visible'},{ctrl:'BR_MEDICATIONWC'},{av:'divCell_br_scheme_Visible',ctrl:'CELL_BR_SCHEME',prop:'Visible'},{ctrl:'BR_SCHEMEWC'},{av:'divCell_br_procedure_Visible',ctrl:'CELL_BR_PROCEDURE',prop:'Visible'},{ctrl:'BR_PROCEDUREWC'},{av:'divCell_br_medicalimaging_Visible',ctrl:'CELL_BR_MEDICALIMAGING',prop:'Visible'},{ctrl:'BR_MEDICALIMAGINGWC'},{av:'divCell_br_pathology_Visible',ctrl:'CELL_BR_PATHOLOGY',prop:'Visible'},{ctrl:'BR_PATHOLOGYWC'}]}");
         setEventMetadata("'BR_PATHOLOGY'","{handler:'E393S2',iparms:[{av:'AV6WWPContext',fld:'vWWPCONTEXT',pic:''},{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV10BR_EncounterID',fld:'vBR_ENCOUNTERID',pic:'ZZZZZZZZZZZZZZZZZZ',hsh:true}]");
         setEventMetadata("'BR_PATHOLOGY'",",oparms:[{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'divCell_general_Visible',ctrl:'CELL_GENERAL',prop:'Visible'},{ctrl:'GENERALWC'},{av:'lblTxttabtitle_Caption',ctrl:'TXTTABTITLE',prop:'Caption'},{av:'divCell_checkdemographics_Visible',ctrl:'CELL_CHECKDEMOGRAPHICS',prop:'Visible'},{ctrl:'CHECKDEMOGRAPHICSWC'},{av:'divCell_checkbehavior_Visible',ctrl:'CELL_CHECKBEHAVIOR',prop:'Visible'},{ctrl:'CHECKBEHAVIORWC'},{av:'divCell_br_familyhistory_Visible',ctrl:'CELL_BR_FAMILYHISTORY',prop:'Visible'},{ctrl:'BR_FAMILYHISTORYWC'},{av:'divCell_checkcomorbidity_Visible',ctrl:'CELL_CHECKCOMORBIDITY',prop:'Visible'},{ctrl:'CHECKCOMORBIDITYWC'},{av:'divCell_checkdeath_Visible',ctrl:'CELL_CHECKDEATH',prop:'Visible'},{ctrl:'CHECKDEATHWC'},{av:'divCell_checkvital_Visible',ctrl:'CELL_CHECKVITAL',prop:'Visible'},{ctrl:'CHECKVITALWC'},{av:'divCell_br_diagnosis_Visible',ctrl:'CELL_BR_DIAGNOSIS',prop:'Visible'},{ctrl:'BR_DIAGNOSISWC'},{av:'divCell_br_lab_Visible',ctrl:'CELL_BR_LAB',prop:'Visible'},{ctrl:'BR_LABWC'},{av:'divCell_br_medication_Visible',ctrl:'CELL_BR_MEDICATION',prop:'Visible'},{ctrl:'BR_MEDICATIONWC'},{av:'divCell_br_scheme_Visible',ctrl:'CELL_BR_SCHEME',prop:'Visible'},{ctrl:'BR_SCHEMEWC'},{av:'divCell_br_procedure_Visible',ctrl:'CELL_BR_PROCEDURE',prop:'Visible'},{ctrl:'BR_PROCEDUREWC'},{av:'divCell_br_medicalimaging_Visible',ctrl:'CELL_BR_MEDICALIMAGING',prop:'Visible'},{ctrl:'BR_MEDICALIMAGINGWC'},{av:'divCell_br_pathology_Visible',ctrl:'CELL_BR_PATHOLOGY',prop:'Visible'},{ctrl:'BR_PATHOLOGYWC'}]}");
         setEventMetadata("'DOREFUSE'","{handler:'E403S2',iparms:[{av:'AV10BR_EncounterID',fld:'vBR_ENCOUNTERID',pic:'ZZZZZZZZZZZZZZZZZZ',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         OldCheckbehaviorwc = "";
         lblBr_familyhistory_title_Jsonclick = "";
         WebComp_Br_familyhistorywc_Component = "";
         OldBr_familyhistorywc = "";
         ...
         bttBtnbr_familyhistory_Jsonclick = "";
         ...
         WebComp_Br_familyhistorywc = new GeneXus.Http.GXNullWebComponent();
      ...
      private int divCell_br_familyhistory_Visible ;
      ...
      private String lblBr_familyhistory_title_Internalname ;
      private String lblBr_familyhistory_title_Jsonclick ;
      private String divUnnamedtablebr_familyhistory_Internalname ;
      private String WebComp_Br_familyhistorywc_Component ;
      private String OldBr_familyhistorywc ;
      ...
      private String divCell_br_familyhistory_Internalname ;
      private String bttBtnbr_familyhistory_Internalname ;
      private String bttBtnbr_familyhistory_Jsonclick ;
      ...
      private GXWebComponent WebComp_Br_familyhistorywc ;
