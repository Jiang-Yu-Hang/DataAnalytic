/*
       ...
       Generated on: 2/28/2020 15:7:41.86
...
namespace GeneXus.Programs {
   public class xt_log : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void CheckExtendedTable0O25( )
      {
         ...
         {
            GX_msglist.addItem("域操作时间超界", "OutOfRange", 1, "XT_LOGTIME");
            AnyError = 1;
            GX_FocusControl = edtXT_LogTime_Internalname;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "GX_FocusControl", GX_FocusControl);
         }
         ...
         {
            GX_msglist.addItem("域日志操作对象动作超界", "OutOfRange", 1, "XT_LOGTARGETOPERATE");
            AnyError = 1;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20202281574447", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?20202281574487", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("xt_log.js", "?20202281574487", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false);
