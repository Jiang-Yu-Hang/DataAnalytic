/*!   GeneXus C# 16_0_0-127771 on 2/28/2020 15:9:10.0
*/
...
gx.define('wwpbaseobjects.exportoptions', false, function () {
   ...
   this.Validv_Exporttype=function()
   {
      try {
         ...
         {
            try {
               gxballoon.setError("域Export Type超界");
   ...
   DVPANEL_TABLEEXPORTContainer.setProp("Title", "Title", "导出到哪里？", "str");
   ...
   DVPANEL_TABLEATTRIBUTESContainer.setProp("Title", "Title", "谷歌云端硬盘信息", "str");
