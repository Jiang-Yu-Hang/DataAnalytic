/*
       ...
       Generated on: 2/28/2020 15:5:41.52
...
namespace GeneXus.Programs.wwpbaseobjects {
   public class secusersecuserrolewc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20202281554167", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void RenderHtmlCloseForm102( )
      {
         ...
         {
            context.AddJavascriptSource("wwpbaseobjects/secusersecuserrolewc.js", "?20202281554288", false);
         }
      ...
      protected void E16102( )
      {
         ...
         edtSecRoleName_Title = StringUtil.Format( "<div class='ColumnSettingsContainer''><span>%1</span><div id='%2'></div>", "½ÇÉ«Ãû³Æ", AV40ddo_SecRoleNameTitleControlIdToReplace, "", "", "", "", "", "", "");
         ...
         edtSecRoleDescription_Title = StringUtil.Format( "<div class='ColumnSettingsContainer''><span>%1</span><div id='%2'></div>", "½ÇÉ«ÃèÊö", AV44ddo_SecRoleDescriptionTitleControlIdToReplace, "", "", "", "", "", "", "");
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?20202281554824", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("wwpbaseobjects/secusersecuserrolewc.js", "?20202281554824", false);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
