/*
       ...
       Generated on: 2/28/2020 15:16:26.57
...
namespace GeneXus.Programs.wwpbaseobjects {
   public class workwithplusmasterpageap : GXMasterPage, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlCloseForm802( )
      {
         ...
         context.AddJavascriptSource("wwpbaseobjects/workwithplusmasterpageap.js", "?202022815162658", false);
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)(getDataAreaObject() == null ? Form : getDataAreaObject().GetForm()).Jscriptsrc.Item(idxLst))), "?202022815162668", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("wwpbaseobjects/workwithplusmasterpageap.js", "?202022815162668", false);
         }
