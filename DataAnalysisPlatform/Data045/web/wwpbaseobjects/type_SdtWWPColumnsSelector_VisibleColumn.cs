...
namespace GeneXus.Programs.wwpbaseobjects{
	...
	[XmlType(TypeName="WWPColumnsSelector.VisibleColumn" , Namespace="DataAnalysisPlatform" )]
	[Serializable]
	...
	[DataContract(Name=@"WWPColumnsSelector.VisibleColumn", Namespace="DataAnalysisPlatform")]
