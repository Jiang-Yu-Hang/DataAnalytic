/*!   GeneXus C# 16_0_0-127771 on 2/28/2020 15:5:48.91
*/
...
gx.define('wwpbaseobjects.secusersecuserrolewc', true, function (CmpContext) {
   ...
   this.GridContainer = new gx.grid.grid(this, 2,"WbpLvl2",12,"Grid","Grid","GridContainer",this.CmpContext,this.IsMasterPage,"wwpbaseobjects.secusersecuserrolewc",[],false,1,false,true,0,false,false,false,"",0,"px",0,"px","增加空白行",true,false,false,null,null,false,"",false,[1,1,1,1],false,0,true,false);
   var GridContainer = this.GridContainer;
   GridContainer.addSingleLineEdit(4,13,"SECROLEID","角色编号","","SecRoleId","int",0,"px",4,4,"right",null,[],4,"SecRoleId",false,0,false,false,"Attribute",1,"WWColumn");
