/*
       ...
       Generated on: 2/28/2020 15:6:12.7
...
namespace GeneXus.Programs.wwpbaseobjects {
   public class secfunctionalitysecfunctionalityrolewc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20202281561230", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void RenderHtmlCloseForm0S2( )
      {
         ...
         {
            context.AddJavascriptSource("wwpbaseobjects/secfunctionalitysecfunctionalityrolewc.js", "?20202281561435", false);
         }
      ...
      protected void WB0S0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblFiltertextsecrolename_Internalname, "½ÇÉ«Ãû³Æ", "", "", lblFiltertextsecrolename_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, "HLP_WWPBaseObjects\\SecFunctionalitySecFunctionalityRoleWC.htm");
      ...
      protected void E160S2( )
      {
         ...
         edtSecRoleName_Title = StringUtil.Format( "<div class='ColumnSettingsContainer''><span>%1</span><div id='%2'></div>", "½ÇÉ«Ãû³Æ", AV25ddo_SecRoleNameTitleControlIdToReplace, "", "", "", "", "", "", "");
         ...
         edtSecRoleDescription_Title = StringUtil.Format( "<div class='ColumnSettingsContainer''><span>%1</span><div id='%2'></div>", "½ÇÉ«ÃèÊö", AV29ddo_SecRoleDescriptionTitleControlIdToReplace, "", "", "", "", "", "", "");
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?20202281562163", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("wwpbaseobjects/secfunctionalitysecfunctionalityrolewc.js", "?20202281562164", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
      ...
      public override void initialize_properties( )
      {
         ...
         edtSecRoleDescription_Title = "½ÇÉ«ÃèÊö";
         edtSecRoleName_Titleformat = 0;
         edtSecRoleName_Title = "½ÇÉ«Ãû³Æ";
