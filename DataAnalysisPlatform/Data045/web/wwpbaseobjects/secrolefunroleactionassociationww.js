/*!   GeneXus C# 16_0_0-127771 on 2/28/2020 15:9:25.22
*/
...
gx.define('wwpbaseobjects.secrolefunroleactionassociationww', false, function () {
   ...
   this.GridContainer = new gx.grid.grid(this, 2,"WbpLvl2",25,"Grid","Grid","GridContainer",this.CmpContext,this.IsMasterPage,"wwpbaseobjects.secrolefunroleactionassociationww",[],false,1,false,true,0,false,false,false,"",0,"px",0,"px","增加空白行",true,false,false,null,null,false,"",false,[1,1,1,1],false,0,true,false);
   ...
   GridContainer.addSingleLineEdit(1,28,"SECFUNCTIONALITYID","编号","","SecFunctionalityId","int",0,"px",10,10,"right",null,[],1,"SecFunctionalityId",false,0,false,false,"Attribute",1,"WWColumn hidden-xs");
   ...
   GridContainer.addComboBox(9,31,"SECFUNCTIONALITYTYPE","类型","SecFunctionalityType","int",null,0,false,false,0,"px","WWColumn hidden-xs");
   GridContainer.addSingleLineEdit(2,32,"SECPARENTFUNCTIONALITYID","父功能编号  ","","SecParentFunctionalityId","int",0,"px",10,10,"right",null,[],2,"SecParentFunctionalityId",false,0,false,false,"Attribute",1,"WWColumn hidden-xs");
   ...
   GridContainer.addCheckBox(7,34,"SECFUNCTIONALITYACTIVE","是否启用？","","SecFunctionalityActive","boolean","true","false",null,false,false,0,"px","WWColumn hidden-xs");
