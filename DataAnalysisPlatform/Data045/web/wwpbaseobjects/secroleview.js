/*!   GeneXus C# 16_0_0-127771 on 2/28/2020 15:9:23.73
*/
...
gx.define('wwpbaseobjects.secroleview', false, function () {
   ...
   this.s112_client=function()
   {
      ...
      if ( this.AV14LoadAllTabs || ( this.AV15SelectedTabCode == "" ) || ( this.AV15SelectedTabCode == "General" ) )
      {
         ...
         gx.fn.setCtrlProperty("TXTTABTITLE","Caption", "角色信息" );
      ...
      if ( this.AV14LoadAllTabs || ( this.AV15SelectedTabCode == "SecFunctionalityRole" ) )
      {
         ...
         gx.fn.setCtrlProperty("TXTTABTITLE","Caption", "权限" );
      ...
      if ( this.AV14LoadAllTabs || ( this.AV15SelectedTabCode == "SecUserRole" ) )
      {
         ...
         gx.fn.setCtrlProperty("TXTTABTITLE","Caption", "用户" );
   ...
   DVELOP_CONFIRMPANEL_DELETEROLEContainer.setProp("ConfirmationText", "Confirmationtext", "确认删除？", "str");
