/*
       ...
       Generated on: 2/28/2020 15:6:22.93
...
namespace GeneXus.Programs.wwpbaseobjects {
   public class secuser : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void CheckExtendedTable056( )
      {
         ...
         {
            GX_msglist.addItem("域创建时间超界", "OutOfRange", 1, "SECUSERCRTDATE");
            AnyError = 1;
            GX_FocusControl = edtSecUserCrtDate_Internalname;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "GX_FocusControl", GX_FocusControl);
         }
         ...
         {
            GX_msglist.addItem("域更新时间超界", "OutOfRange", 1, "SECUSERUPDDATE");
            AnyError = 1;
            GX_FocusControl = edtSecUserUpdDate_Internalname;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "GX_FocusControl", GX_FocusControl);
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20202281562495", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?20202281562527", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wwpbaseobjects/secuser.js", "?20202281562528", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false);
