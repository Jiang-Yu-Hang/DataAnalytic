/*!   GeneXus C# 16_0_0-127771 on 2/28/2020 15:6:14.98
*/
...
gx.define('wwpbaseobjects.secobject', false, function () {
   ...
   this.Gridsecobject_functionalitiesContainer = new gx.grid.grid(this, 4,"Functionalities",34,"Gridsecobject_functionalities","Gridsecobject_functionalities","Gridsecobject_functionalitiesContainer",this.CmpContext,this.IsMasterPage,"wwpbaseobjects.secobject",[1],false,1,false,true,5,false,false,false,"",0,"px",0,"px","增加空白行",true,false,false,null,null,false,"",false,[1,1,1,1],false,0,true,false);
   var Gridsecobject_functionalitiesContainer = this.Gridsecobject_functionalitiesContainer;
   Gridsecobject_functionalitiesContainer.addSingleLineEdit(1,35,"SECFUNCTIONALITYID","功能编号","","SecFunctionalityId","int",0,"px",10,10,"right",null,[],1,"SecFunctionalityId",true,0,false,false,"Attribute",1,"");
   Gridsecobject_functionalitiesContainer.addSingleLineEdit(8,36,"SECFUNCTIONALITYDESCRIPTION","权限描述","","SecFunctionalityDescription","svchar",0,"px",100,80,"left",null,[],8,"SecFunctionalityDescription",true,0,false,false,"Attribute",1,"");
