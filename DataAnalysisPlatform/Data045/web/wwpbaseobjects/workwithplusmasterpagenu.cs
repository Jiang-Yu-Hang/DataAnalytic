/*
               File: WWPBaseObjects.WorkWithPlusMasterPageNU
        Description: Master Page
             Author: GeneXus C# Generator version 16_0_0-127771
       Generated on: 2/28/2020 15:16:27.17
...
namespace GeneXus.Programs.wwpbaseobjects {
   public class workwithplusmasterpagenu : GXMasterPage, System.Web.SessionState.IRequiresSessionState
   {
      public workwithplusmasterpagenu( )
      {
      ...
      public workwithplusmasterpagenu( IGxContext context )
      {
      ...
      protected void RenderHtmlCloseForm7X2( )
      {
         ...
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false);
         context.AddJavascriptSource("wwpbaseobjects/workwithplusmasterpagenu.js", "?202022815162753", false);
      ...
      {
         return "WWPBaseObjects.WorkWithPlusMasterPageNU" ;
      }
      ...
      protected void WB7X0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            wb_table1_12_7X2( true) ;
         }
         else
         {
            wb_table1_12_7X2( false) ;
         }
         return  ;
      }

      protected void wb_table1_12_7X2e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            GxWebStd.gx_bitmap( context, imgRoche_logo_Internalname, sImgUrl, "", "", "", context.GetTheme( ), imgRoche_logo_Visible, 1, "", "", 0, 0, 0, "px", 0, "px", 0, 0, 0, "", "", StyleString, ClassString, "", "", "", "", " "+"data-gx-image"+" ", "", "", 1, false, false, context.GetImageSrcSet( sImgUrl), "HLP_WWPBaseObjects\\WorkWithPlusMasterPageNU.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 ShowMenuImageCellDes", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextdatamanager_Internalname, "Overview", "", "", lblTextdatamanager_Jsonclick, "'"+""+"'"+",true,"+"'"+"E_MPAGE."+"'", "", "TextBlock_Des", 0, "", 1, 1, 0, "HLP_WWPBaseObjects\\WorkWithPlusMasterPageNU.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            StyleString = "";
            AV16hospitalLogo_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV16hospitalLogo))&&String.IsNullOrEmpty(StringUtil.RTrim( AV51Hospitallogo_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV16hospitalLogo)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV16hospitalLogo)) ? AV51Hospitallogo_GXI : context.PathToRelativeUrl( AV16hospitalLogo));
            GxWebStd.gx_bitmap( context, imgavHospitallogo_Internalname, sImgUrl, "", "", "", context.GetTheme( ), imgavHospitallogo_Visible, 0, "", "", 0, -1, 0, "", 0, "", 0, 0, 0, "", "", StyleString, ClassString, "", "", "", "", "", "", "", 1, AV16hospitalLogo_IsBlob, false, context.GetImageSrcSet( sImgUrl), "HLP_WWPBaseObjects\\WorkWithPlusMasterPageNU.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void E137X2( )
      {
         ...
         new zutil_setsessionfordash(context ).execute(  AV5WWPContext) ;
         ...
         else
         {
            ...
            context.httpAjaxContext.ajax_rsp_assign_prop("", true, imgavHospitallogo_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV16hospitalLogo)) ? AV51Hospitallogo_GXI : context.convertURL( context.PathToRelativeUrl( AV16hospitalLogo))), true);
            ...
            AV51Hospitallogo_GXI = GXDbFile.PathToUrl( AV11BCBAS_Tenant.gxTpr_Bas_tenantlogo);
            context.httpAjaxContext.ajax_rsp_assign_prop("", true, imgavHospitallogo_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV16hospitalLogo)) ? AV51Hospitallogo_GXI : context.convertURL( context.PathToRelativeUrl( AV16hospitalLogo))), true);
            context.httpAjaxContext.ajax_rsp_assign_prop("", true, imgavHospitallogo_Internalname, "SrcSet", context.GetImageSrcSet( AV16hospitalLogo), true);
            AV35tLogoImageUrl = AV51Hospitallogo_GXI;
            AV48BCNewXT_Config.Load(8);
            AV51Hospitallogo_GXI = StringUtil.StringReplace( AV35tLogoImageUrl, StringUtil.Trim( AV48BCNewXT_Config.gxTpr_Xt_configvalue1), StringUtil.Trim( AV48BCNewXT_Config.gxTpr_Xt_configvalue2));
            context.httpAjaxContext.ajax_rsp_assign_prop("", true, imgavHospitallogo_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV16hospitalLogo)) ? AV51Hospitallogo_GXI : context.convertURL( context.PathToRelativeUrl( AV16hospitalLogo))), true);
            context.httpAjaxContext.ajax_rsp_assign_prop("", true, imgavHospitallogo_Internalname, "SrcSet", context.GetImageSrcSet( AV16hospitalLogo), true);
            AV16hospitalLogo = "";
            context.httpAjaxContext.ajax_rsp_assign_prop("", true, imgavHospitallogo_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV16hospitalLogo)) ? AV51Hospitallogo_GXI : context.convertURL( context.PathToRelativeUrl( AV16hospitalLogo))), true);
      ...
      protected void S172( )
      {
         ...
         new zutil_checksessionandrejwt(context ).execute( ) ;
         AV12BCXT_Config.Load(4);
         AV48BCNewXT_Config.Load(3);
         AV41tTargetUrl = StringUtil.Trim( AV12BCXT_Config.gxTpr_Xt_configvalue4);
         AV41tTargetUrl = AV41tTargetUrl + "?returnurl=" + StringUtil.Trim( AV48BCNewXT_Config.gxTpr_Xt_configvalue1);
         CallWebObject(formatLink(AV41tTargetUrl) );
         context.wjLocDisableFrm = 0;
      }
      ...
      protected void wb_table1_12_7X2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblWelcomeuse_Internalname, "欢迎使用", "", "", lblWelcomeuse_Jsonclick, "'"+""+"'"+",true,"+"'"+"E_MPAGE."+"'", "", "TextBlock_Welcome", 0, "", 1, 1, 0, "HLP_WWPBaseObjects\\WorkWithPlusMasterPageNU.htm");
            context.WriteHtmlText( "</td>") ;
            ...
            wb_table1_12_7X2e( true) ;
         }
         else
         {
            wb_table1_12_7X2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)(getDataAreaObject() == null ? Form : getDataAreaObject().GetForm()).Jscriptsrc.Item(idxLst))), "?202022815163034", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("wwpbaseobjects/workwithplusmasterpagenu.js", "?202022815163034", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("DDO_ACTIONGM_MPAGE.ONOPTIONCLICKED_MPAGE","{handler:'E127X2',iparms:[{av:'Ddo_actiongm_Activeeventkey',ctrl:'DDO_ACTIONGM_MPAGE',prop:'ActiveEventKey'}]");
         setEventMetadata("DDO_ACTIONGM_MPAGE.ONOPTIONCLICKED_MPAGE",",oparms:[]}");
         setEventMetadata("DDO_ADMINAG_MPAGE.ONOPTIONCLICKED_MPAGE","{handler:'E117X2',iparms:[{av:'Ddo_adminag_Activeeventkey',ctrl:'DDO_ADMINAG_MPAGE',prop:'ActiveEventKey'}]");
      ...
      public override void initialize( )
      {
         ...
         AV30tCurrentCode = "";
         AV35tLogoImageUrl = "";
         AV48BCNewXT_Config = new SdtXT_Config(context);
      ...
      private String AV51Hospitallogo_GXI ;
      ...
      private SdtXT_Config AV48BCNewXT_Config ;
