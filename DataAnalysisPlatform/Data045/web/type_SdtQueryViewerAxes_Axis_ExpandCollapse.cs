...
namespace GeneXus.Programs{
	...
	[XmlType(TypeName="QueryViewerAxes.Axis.ExpandCollapse" , Namespace="DataAnalysisPlatform" )]
	[Serializable]
	...
	[DataContract(Name=@"QueryViewerAxes.Axis.ExpandCollapse", Namespace="DataAnalysisPlatform")]
