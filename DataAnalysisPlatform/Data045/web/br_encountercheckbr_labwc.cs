/*
       ...
       Generated on: 2/28/2020 15:5:19.51
   ...
   public class br_encountercheckbr_labwc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV84Pgmname = "BR_EncounterCheckBR_LabWC";
               context.Gx_err = 0;
               WS412( ) ;
               if ( ! isAjaxCallMode( ) )
               {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20202281551970", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void RenderHtmlCloseForm412( )
      {
         ...
         {
            context.AddJavascriptSource("br_encountercheckbr_labwc.js", "?20202281552213", false);
         }
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtavDisplay_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV63Display)) ? AV83Display_GXI : context.convertURL( context.PathToRelativeUrl( AV63Display))), !bGXsfl_12_Refreshing);
      ...
      protected void S122( )
      {
         ...
         {
            AV12GridState.FromXml(new GeneXus.Programs.wwpbaseobjects.loadgridstate(context).executeUdp(  AV84Pgmname+"GridState"), null, "WWPGridState", "DataAnalysisPlatform");
         }
         else
         {
            AV12GridState.FromXml(AV16Session.Get(AV84Pgmname+"GridState"), null, "WWPGridState", "DataAnalysisPlatform");
         }
      ...
      protected void S142( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.savegridstate(context ).execute(  AV84Pgmname+"GridState",  AV12GridState.ToXml(false, true, "WWPGridState", "DataAnalysisPlatform")) ;
      }
      ...
      protected void S112( )
      {
         ...
         AV10TrnContext.gxTpr_Callerobject = AV84Pgmname;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?20202281553326", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("br_encountercheckbr_labwc.js", "?20202281553327", false);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
      ...
      protected void sendrow_122( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_12_idx <= subGrid_Recordsperpage( ) * 1 ) )
         {
            ...
            StyleString = "";
            AV63Display_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV63Display))&&String.IsNullOrEmpty(StringUtil.RTrim( AV83Display_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV63Display)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV63Display)) ? AV83Display_GXI : context.PathToRelativeUrl( AV63Display));
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'E11412',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV8BR_EncounterID',fld:'vBR_ENCOUNTERID',pic:'ZZZZZZZZZZZZZZZZZZ'},{av:'AV18ddo_BR_LabIDTitleControlIdToReplace',fld:'vDDO_BR_LABIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV24ddo_BR_Lab_TestNameTitleControlIdToReplace',fld:'vDDO_BR_LAB_TESTNAMETITLECONTROLIDTOREPLACE',pic:''},{av:'AV28ddo_BR_Lab_SpecimenSourceTitleControlIdToReplace',fld:'vDDO_BR_LAB_SPECIMENSOURCETITLECONTROLIDTOREPLACE',pic:''},{av:'AV26ddo_BR_Lab_SpecimenDateTitleControlIdToReplace',fld:'vDDO_BR_LAB_SPECIMENDATETITLECONTROLIDTOREPLACE',pic:''},{av:'AV40ddo_BR_Lab_AbnIndTitleControlIdToReplace',fld:'vDDO_BR_LAB_ABNINDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV84Pgmname',fld:'vPGMNAME',pic:''},{av:'AV65IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:''},{av:'sPrefix'},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE",",oparms:[]}");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","{handler:'E12412',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV8BR_EncounterID',fld:'vBR_ENCOUNTERID',pic:'ZZZZZZZZZZZZZZZZZZ'},{av:'AV18ddo_BR_LabIDTitleControlIdToReplace',fld:'vDDO_BR_LABIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV24ddo_BR_Lab_TestNameTitleControlIdToReplace',fld:'vDDO_BR_LAB_TESTNAMETITLECONTROLIDTOREPLACE',pic:''},{av:'AV28ddo_BR_Lab_SpecimenSourceTitleControlIdToReplace',fld:'vDDO_BR_LAB_SPECIMENSOURCETITLECONTROLIDTOREPLACE',pic:''},{av:'AV26ddo_BR_Lab_SpecimenDateTitleControlIdToReplace',fld:'vDDO_BR_LAB_SPECIMENDATETITLECONTROLIDTOREPLACE',pic:''},{av:'AV40ddo_BR_Lab_AbnIndTitleControlIdToReplace',fld:'vDDO_BR_LAB_ABNINDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV84Pgmname',fld:'vPGMNAME',pic:''},{av:'AV65IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:''},{av:'sPrefix'},{av:'Gridpaginationbar_Rowsperpageselectedvalue',ctrl:'GRIDPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}]");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",",oparms:[{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'}]}");
         setEventMetadata("DDO_BR_LABID.ONOPTIONCLICKED","{handler:'E13412',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV8BR_EncounterID',fld:'vBR_ENCOUNTERID',pic:'ZZZZZZZZZZZZZZZZZZ'},{av:'AV18ddo_BR_LabIDTitleControlIdToReplace',fld:'vDDO_BR_LABIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV24ddo_BR_Lab_TestNameTitleControlIdToReplace',fld:'vDDO_BR_LAB_TESTNAMETITLECONTROLIDTOREPLACE',pic:''},{av:'AV28ddo_BR_Lab_SpecimenSourceTitleControlIdToReplace',fld:'vDDO_BR_LAB_SPECIMENSOURCETITLECONTROLIDTOREPLACE',pic:''},{av:'AV26ddo_BR_Lab_SpecimenDateTitleControlIdToReplace',fld:'vDDO_BR_LAB_SPECIMENDATETITLECONTROLIDTOREPLACE',pic:''},{av:'AV40ddo_BR_Lab_AbnIndTitleControlIdToReplace',fld:'vDDO_BR_LAB_ABNINDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV84Pgmname',fld:'vPGMNAME',pic:''},{av:'AV65IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:''},{av:'sPrefix'},{av:'Ddo_br_labid_Activeeventkey',ctrl:'DDO_BR_LABID',prop:'ActiveEventKey'}]");
         ...
         setEventMetadata("DDO_BR_LAB_TESTNAME.ONOPTIONCLICKED","{handler:'E14412',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV8BR_EncounterID',fld:'vBR_ENCOUNTERID',pic:'ZZZZZZZZZZZZZZZZZZ'},{av:'AV18ddo_BR_LabIDTitleControlIdToReplace',fld:'vDDO_BR_LABIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV24ddo_BR_Lab_TestNameTitleControlIdToReplace',fld:'vDDO_BR_LAB_TESTNAMETITLECONTROLIDTOREPLACE',pic:''},{av:'AV28ddo_BR_Lab_SpecimenSourceTitleControlIdToReplace',fld:'vDDO_BR_LAB_SPECIMENSOURCETITLECONTROLIDTOREPLACE',pic:''},{av:'AV26ddo_BR_Lab_SpecimenDateTitleControlIdToReplace',fld:'vDDO_BR_LAB_SPECIMENDATETITLECONTROLIDTOREPLACE',pic:''},{av:'AV40ddo_BR_Lab_AbnIndTitleControlIdToReplace',fld:'vDDO_BR_LAB_ABNINDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV84Pgmname',fld:'vPGMNAME',pic:''},{av:'AV65IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:''},{av:'sPrefix'},{av:'Ddo_br_lab_testname_Activeeventkey',ctrl:'DDO_BR_LAB_TESTNAME',prop:'ActiveEventKey'}]");
         ...
         setEventMetadata("DDO_BR_LAB_SPECIMENSOURCE.ONOPTIONCLICKED","{handler:'E15412',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV8BR_EncounterID',fld:'vBR_ENCOUNTERID',pic:'ZZZZZZZZZZZZZZZZZZ'},{av:'AV18ddo_BR_LabIDTitleControlIdToReplace',fld:'vDDO_BR_LABIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV24ddo_BR_Lab_TestNameTitleControlIdToReplace',fld:'vDDO_BR_LAB_TESTNAMETITLECONTROLIDTOREPLACE',pic:''},{av:'AV28ddo_BR_Lab_SpecimenSourceTitleControlIdToReplace',fld:'vDDO_BR_LAB_SPECIMENSOURCETITLECONTROLIDTOREPLACE',pic:''},{av:'AV26ddo_BR_Lab_SpecimenDateTitleControlIdToReplace',fld:'vDDO_BR_LAB_SPECIMENDATETITLECONTROLIDTOREPLACE',pic:''},{av:'AV40ddo_BR_Lab_AbnIndTitleControlIdToReplace',fld:'vDDO_BR_LAB_ABNINDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV84Pgmname',fld:'vPGMNAME',pic:''},{av:'AV65IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:''},{av:'sPrefix'},{av:'Ddo_br_lab_specimensource_Activeeventkey',ctrl:'DDO_BR_LAB_SPECIMENSOURCE',prop:'ActiveEventKey'}]");
         ...
         setEventMetadata("DDO_BR_LAB_SPECIMENDATE.ONOPTIONCLICKED","{handler:'E16412',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV8BR_EncounterID',fld:'vBR_ENCOUNTERID',pic:'ZZZZZZZZZZZZZZZZZZ'},{av:'AV18ddo_BR_LabIDTitleControlIdToReplace',fld:'vDDO_BR_LABIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV24ddo_BR_Lab_TestNameTitleControlIdToReplace',fld:'vDDO_BR_LAB_TESTNAMETITLECONTROLIDTOREPLACE',pic:''},{av:'AV28ddo_BR_Lab_SpecimenSourceTitleControlIdToReplace',fld:'vDDO_BR_LAB_SPECIMENSOURCETITLECONTROLIDTOREPLACE',pic:''},{av:'AV26ddo_BR_Lab_SpecimenDateTitleControlIdToReplace',fld:'vDDO_BR_LAB_SPECIMENDATETITLECONTROLIDTOREPLACE',pic:''},{av:'AV40ddo_BR_Lab_AbnIndTitleControlIdToReplace',fld:'vDDO_BR_LAB_ABNINDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV84Pgmname',fld:'vPGMNAME',pic:''},{av:'AV65IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:''},{av:'sPrefix'},{av:'Ddo_br_lab_specimendate_Activeeventkey',ctrl:'DDO_BR_LAB_SPECIMENDATE',prop:'ActiveEventKey'}]");
         ...
         setEventMetadata("DDO_BR_LAB_ABNIND.ONOPTIONCLICKED","{handler:'E17412',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV8BR_EncounterID',fld:'vBR_ENCOUNTERID',pic:'ZZZZZZZZZZZZZZZZZZ'},{av:'AV18ddo_BR_LabIDTitleControlIdToReplace',fld:'vDDO_BR_LABIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV24ddo_BR_Lab_TestNameTitleControlIdToReplace',fld:'vDDO_BR_LAB_TESTNAMETITLECONTROLIDTOREPLACE',pic:''},{av:'AV28ddo_BR_Lab_SpecimenSourceTitleControlIdToReplace',fld:'vDDO_BR_LAB_SPECIMENSOURCETITLECONTROLIDTOREPLACE',pic:''},{av:'AV26ddo_BR_Lab_SpecimenDateTitleControlIdToReplace',fld:'vDDO_BR_LAB_SPECIMENDATETITLECONTROLIDTOREPLACE',pic:''},{av:'AV40ddo_BR_Lab_AbnIndTitleControlIdToReplace',fld:'vDDO_BR_LAB_ABNINDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV84Pgmname',fld:'vPGMNAME',pic:''},{av:'AV65IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:''},{av:'sPrefix'},{av:'Ddo_br_lab_abnind_Activeeventkey',ctrl:'DDO_BR_LAB_ABNIND',prop:'ActiveEventKey'}]");
