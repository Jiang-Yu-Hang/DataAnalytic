/*
       ...
       Generated on: 2/28/2020 15:9:4.85
...
namespace GeneXus.Programs {
   public class appmasterpage : GXMasterPage, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlCloseForm012( )
      {
         ...
         context.AddJavascriptSource("appmasterpage.js", "?2020228159486", false);
      ...
      protected void E11012( )
      {
         ...
         if ( StringUtil.StrCmp(StringUtil.Lower( Contentholder.Pgmname), "wwpbaseobjects.notauthorized") != 0 )
         {
            new GeneXus.Programs.wwpbaseobjects.secisauthbyobjectname(context ).execute(  Contentholder.Pgmname, out  AV5IsAuthorized) ;
            if ( ! AV5IsAuthorized )
            {
               CallWebObject(formatLink("wwpbaseobjects.notauthorized.aspx") + "?" + UrlEncode(StringUtil.RTrim(Contentholder.Pgmname)));
      ...
      protected void wb_table6_10_012( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            context.WriteHtmlText( "<td>") ;
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblSpanish_Internalname, "Espa?ol", "", "", lblSpanish_Jsonclick, "'"+""+"'"+",true,"+"'"+"E_MPAGE."+"'", "", "SmallText", 0, "", 1, 1, 0, "HLP_AppMasterPage.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Text block */
            ...
            context.WriteHtmlText( "<td>") ;
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblPortuguese_Internalname, "Portugu¨ºs", "", "", lblPortuguese_Jsonclick, "'"+""+"'"+",true,"+"'"+"E_MPAGE."+"'", "", "SmallText", 0, "", 1, 1, 0, "HLP_AppMasterPage.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "</tbody>") ;
            /* End of table */
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)(getDataAreaObject() == null ? Form : getDataAreaObject().GetForm()).Jscriptsrc.Item(idxLst))), "?202022815951", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("appmasterpage.js", "?202022815951", false);
