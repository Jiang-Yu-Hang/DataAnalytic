...
namespace GeneXus.Programs{
	...
	[XmlType(TypeName="QueryViewerItemDoubleClickData.Element" , Namespace="DataAnalysisPlatform" )]
	[Serializable]
	...
	[DataContract(Name=@"QueryViewerItemDoubleClickData.Element", Namespace="DataAnalysisPlatform")]
