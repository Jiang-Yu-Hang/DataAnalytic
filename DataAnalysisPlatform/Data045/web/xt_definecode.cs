/*
       ...
       Generated on: 2/28/2020 15:7:34.36
...
namespace GeneXus.Programs {
   public class xt_definecode : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void CheckExtendedTable0N24( )
      {
         ...
         {
            GX_msglist.addItem("不匹配'数据字典类型'", "ForeignKeyNotFound", 1, "XT_DEFINDCODETYPEID");
            AnyError = 1;
            GX_FocusControl = edtXT_DefindcodeTypeID_Internalname;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "GX_FocusControl", GX_FocusControl);
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20202281573626", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?20202281573659", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("xt_definecode.js", "?20202281573659", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false);
