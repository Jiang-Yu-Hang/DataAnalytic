/*
 * FileUpload GeneXus User Control 0.0.0.124845
 *
 * Copyright 2015, GeneXus
 */
(function(b){"function"===typeof define&&define.amd?define(["jquery"],b):"object"===typeof exports?b(require("jquery")):b(jQuery)})(function(b){var g=0,a=Array.prototype.slice;b.cleanData=function(a){return function(d){var f,e,h;for(h=0;null!=(e=d[h]);h++)try{(f=b._data(e,"events"))&&f.remove&&b(e).triggerHandler("remove")}catch(g){}a(d)}}(b.cleanData);b.widget=function(a,d,f){var e,h,g,k,l={},n=a.split(".")[0];a=a.split(".")[1];e=n+"-"+a;f||(f=d,d=b.Widget);b.expr[":"][e.toLowerCase()]=function(a){return!!b.data(a,
e)};b[n]=b[n]||{};h=b[n][a];g=b[n][a]=function(a,c){if(!this._createWidget)return new g(a,c);arguments.length&&this._createWidget(a,c)};b.extend(g,h,{version:f.version,_proto:b.extend({},f),_childConstructors:[]});k=new d;k.options=b.widget.extend({},k.options);b.each(f,function(a,c){b.isFunction(c)?l[a]=function(){var b=function(){return d.prototype[a].apply(this,arguments)},e=function(c){return d.prototype[a].apply(this,c)};return function(){var a=this._super,d=this._superApply,f;this._super=b;
this._superApply=e;f=c.apply(this,arguments);this._super=a;this._superApply=d;return f}}():l[a]=c});g.prototype=b.widget.extend(k,{widgetEventPrefix:h?k.widgetEventPrefix||a:a},l,{constructor:g,namespace:n,widgetName:a,widgetFullName:e});h?(b.each(h._childConstructors,function(a,c){var d=c.prototype;b.widget(d.namespace+"."+d.widgetName,g,c._proto)}),delete h._childConstructors):d._childConstructors.push(g);b.widget.bridge(a,g);return g};b.widget.extend=function(c){for(var d=a.call(arguments,1),f=
...
_on:function(a,d,f){var e,h=this;"boolean"!==typeof a&&(f=d,d=a,a=!1);f?(d=e=b(d),this.bindings=this.bindings.add(d)):(f=d,d=this.element,e=this.widget());b.each(f,function(f,g){function l(){if(a||!0!==h.options.disabled&&!b(this).hasClass("ui-state-disabled"))return("string"===typeof g?h[g]:g).apply(h,arguments)}"string"!==typeof g&&(l.guid=g.guid=g.guid||l.guid||b.guid++);var n=f.match(/^([\w:-]*)\s*(.*)$/),p=n[1]+h.eventNamespace;(n=n[2])?e.delegate(n,p,l):d.bind(p,l)})},_off:function(a,d){d=(d||
...
b.tmpl=g})(this);(function(b){var g=function(a,d,b){var e=document.createElement("img"),h,m;e.onerror=d;e.onload=function(){!m||b&&b.noRevoke||g.revokeObjectURL(m);d&&d(g.scale(e,b))};if(g.isInstanceOf("Blob",a)||g.isInstanceOf("File",a))h=m=g.createObjectURL(a),e._type=a.type;else if("string"===typeof a)h=a,b&&b.crossOrigin&&(e.crossOrigin=b.crossOrigin);else return!1;return h?(e.src=h,e):g.readFile(a,function(a){var c=a.target;c&&c.result?e.src=c.result:d&&d(a)})},a=window.createObjectURL&&window||window.URL&&URL.revokeObjectURL&&
URL||window.webkitURL&&webkitURL;g.isInstanceOf=function(a,d){return Object.prototype.toString.call(d)==="[object "+a+"]"};g.transformCoordinates=function(){};g.getTransformedOptions=function(a,d){var b=d.aspectRatio,e,h,g;if(!b)return d;e={};for(h in d)d.hasOwnProperty(h)&&(e[h]=d[h]);e.crop=!0;h=a.naturalWidth||a.width;g=a.naturalHeight||a.height;h/g>b?(e.maxWidth=g*b,e.maxHeight=g):(e.maxWidth=h,e.maxHeight=h/b);return e};g.renderImageToCanvas=function(a,d,b,e,h,g,k,l,n,p){a.getContext("2d").drawImage(d,
b,e,h,g,k,l,n,p);return a};g.hasCanvasOption=function(a){return a.canvas||a.crop||a.aspectRatio};g.scale=function(a,d){d=d||{};var b=document.createElement("canvas"),e=a.getContext||g.hasCanvasOption(d)&&b.getContext,h=a.naturalWidth||a.width,m=a.naturalHeight||a.height,k=h,l=m,n,p,r,u,q,t,w,x,v;v=function(){var a=Math.max((r||k)/k,(u||l)/l);1<a&&(k*=a,l*=a)};var y=function(){var a=Math.min((n||k)/k,(p||l)/l);1>a&&(k*=a,l*=a)};e&&(d=g.getTransformedOptions(a,d),w=d.left||0,x=d.top||0,d.sourceWidth?
(q=d.sourceWidth,void 0!==d.right&&void 0===d.left&&(w=h-q-d.right)):q=h-w-(d.right||0),d.sourceHeight?(t=d.sourceHeight,void 0!==d.bottom&&void 0===d.top&&(x=m-t-d.bottom)):t=m-x-(d.bottom||0),k=q,l=t);n=d.maxWidth;p=d.maxHeight;r=d.minWidth;u=d.minHeight;if(e&&n&&p&&d.crop)k=n,l=p,v=q/t-n/p,0>v?(t=p*q/n,void 0===d.top&&void 0===d.bottom&&(x=(m-t)/2)):0<v&&(q=n*t/p,void 0===d.left&&void 0===d.right&&(w=(h-q)/2));else{if(d.contain||d.cover)r=n=n||r,u=p=p||u;d.cover?(y(),v()):(v(),y())}if(e)return b.width=
k,b.height=l,g.transformCoordinates(b,d),g.renderImageToCanvas(b,a,w,x,q,t,0,0,k,l);a.width=k;a.height=l;return a};g.createObjectURL=function(c){return a?a.createObjectURL(c):!1};g.revokeObjectURL=function(c){return a?a.revokeObjectURL(c):!1};g.readFile=function(a,d,b){if(window.FileReader){var e=new FileReader;e.onload=e.onerror=d;b=b||"readAsDataURL";if(e[b])return e[b](a),e}return!1};"function"===typeof define&&define.amd?define(function(){return g}):b.loadImage=g})(this);(function(b){"function"===typeof define&&define.amd?define(["load-image"],b):b(window.loadImage)})(function(b){if(window.navigator&&window.navigator.platform&&/iP(hone|od|ad)/.test(window.navigator.platform)){var g=b.renderImageToCanvas;b.detectSubsampling=function(a){var c;return 1048576<a.width*a.height?(c=document.createElement("canvas"),c.width=c.height=1,c=c.getContext("2d"),c.drawImage(a,-a.width+1,0),0===c.getImageData(0,0,1,1).data[3]):!1};b.detectVerticalSquash=function(a,c){var d=a.naturalHeight||
a.height,b=document.createElement("canvas"),e=b.getContext("2d"),h,g,k;c&&(d/=2);b.width=1;b.height=d;e.drawImage(a,0,0);b=e.getImageData(0,0,1,d).data;e=0;for(g=h=d;g>e;)k=b[4*(g-1)+3],0===k?h=g:e=g,g=h+e>>1;return g/d||1};b.renderImageToCanvas=function(a,c,d,f,e,h,m,k,l,n){if("image/jpeg"===c._type){var p=a.getContext("2d"),r=document.createElement("canvas"),u=r.getContext("2d"),q,t;r.width=1024;r.height=1024;p.save();if(q=b.detectSubsampling(c))d/=2,f/=2,e/=2,h/=2;t=b.detectVerticalSquash(c,q);
if(q||1!==t){f*=t;l=Math.ceil(1024*l/e);n=Math.ceil(1024*n/h/t);for(t=k=0;t<h;){for(q=m=0;q<e;)u.clearRect(0,0,1024,1024),u.drawImage(c,d,f,e,h,-q,-t,e,h),p.drawImage(r,0,0,1024,1024,m,k,l,n),q+=1024,m+=l;t+=1024;k+=n}p.restore();return a}}return g(a,c,d,f,e,h,m,k,l,n)}}});(function(b){"function"===typeof define&&define.amd?define(["load-image"],b):b(window.loadImage)})(function(b){var g=b.hasCanvasOption,a=b.transformCoordinates,c=b.getTransformedOptions;b.hasCanvasOption=function(a){return g.call(b,a)||a.orientation};b.transformCoordinates=function(c,f){a.call(b,c,f);var e=c.getContext("2d"),h=c.width,g=c.height,k=f.orientation;if(k&&!(8<k))switch(4<k&&(c.width=g,c.height=h),k){case 2:e.translate(h,0);e.scale(-1,1);break;case 3:e.translate(h,g);e.rotate(Math.PI);
...
0,f),function(f){if(f.target.error)console.log(f.target.error);else{f=f.target.result;var g=new DataView(f),k=2,l=g.byteLength-4,n=k,p,r;if(65496===g.getUint16(0)){for(;k<l;)if(p=g.getUint16(k),65504<=p&&65519>=p||65534===p){r=g.getUint16(k+2)+2;if(k+r>g.byteLength){console.log("Invalid meta data: Invalid segment size.");break}if(n=b.metaDataParsers.jpeg[p])for(p=0;p<n.length;p+=1)n[p].call(d,g,k,r,e,c);n=k+=r}else break;!c.disableImageHead&&6<n&&(e.imageHead=f.slice?f.slice(0,n):(new Uint8Array(f)).subarray(0,
...
(c=this.tags[a])&&(b[c]=this.getText(c));return b}});(function(b){var g=b.HTMLCanvasElement&&b.HTMLCanvasElement.prototype,a;if(a=b.Blob)try{a=Boolean(new Blob)}catch(c){a=!1}var d=a;if(a=d&&b.Uint8Array)try{a=100===(new Blob([new Uint8Array(100)])).size}catch(f){a=!1}var e=a,h=b.BlobBuilder||b.WebKitBlobBuilder||b.MozBlobBuilder||b.MSBlobBuilder,m=(d||h)&&b.atob&&b.ArrayBuffer&&b.Uint8Array&&function(a){var b,c,f,g;b=0<=a.split(",")[0].indexOf("base64")?atob(a.split(",")[1]):decodeURIComponent(a.split(",")[1]);c=new ArrayBuffer(b.length);f=new Uint8Array(c);
for(g=0;g<b.length;g+=1)f[g]=b.charCodeAt(g);a=a.split(",")[0].split(":")[1].split(";")[0];if(d)return new Blob([e?f:c],{type:a});f=new h;f.append(c);return f.getBlob(a)};b.HTMLCanvasElement&&!g.toBlob&&(g.mozGetAsFile?g.toBlob=function(a,b,c){c&&g.toDataURL&&m?a(m(this.toDataURL(b,c))):a(this.mozGetAsFile("blob",b))}:g.toDataURL&&m&&(g.toBlob=function(a,b,c){a(m(this.toDataURL(b,c)))}));"function"===typeof define&&define.amd?define(function(){return m}):b.dataURLtoBlob=m})(window);(function(b){"function"===typeof define&&define.amd?define(["jquery"],b):"object"===typeof exports?b(require("jquery")):b(window.jQuery)})(function(b){var g=0;b.ajaxTransport("iframe",function(a){if(a.async){var c=a.initialIframeSrc||"javascript:false;",d,f,e;return{send:function(h,m){d=b('\x3cform style\x3d"display:none;"\x3e\x3c/form\x3e');d.attr("accept-charset",a.formAcceptCharset);e=/\?/.test(a.url)?"\x26":"?";"DELETE"===a.type?(a.url=a.url+e+"_method\x3dDELETE",a.type="POST"):"PUT"===a.type?
(a.url=a.url+e+"_method\x3dPUT",a.type="POST"):"PATCH"===a.type&&(a.url=a.url+e+"_method\x3dPATCH",a.type="POST");g+=1;f=b('\x3ciframe src\x3d"'+c+'" name\x3d"iframe-transport-'+g+'"\x3e\x3c/iframe\x3e').bind("load",function(){var e,h=b.isArray(a.paramName)?a.paramName:[a.paramName];f.unbind("load").bind("load",function(){var a;try{if(a=f.contents(),!a.length||!a[0].firstChild)throw Error();}catch(e){a=void 0}m(200,"success",{iframe:a});b('\x3ciframe src\x3d"'+c+'"\x3e\x3c/iframe\x3e').appendTo(d);
...
sequentialUploads:!1,limitConcurrentUploads:void 0,forceIframeTransport:!1,redirect:void 0,redirectParamName:void 0,postMessage:void 0,multipart:!0,maxChunkSize:void 0,uploadedBytes:void 0,recalculateProgress:!0,progressInterval:100,bitrateInterval:500,autoUpload:!0,messages:{uploadedBytes:"Uploaded bytes exceed file size"},i18n:function(a,c){a=this.messages[a]||a.toString();c&&b.each(c,function(c,b){a=a.replace("{"+c+"}",b)});return a},formData:function(a){return a.serializeArray()},add:function(a,
...
d._onProgress(b.Event("progress",{lengthComputable:!0,loaded:h-c.uploadedBytes,total:h-c.uploadedBytes}),c);a.uploadedBytes=c.uploadedBytes=h;c.result=f;c.textStatus=g;c.jqXHR=k;d._trigger("chunkdone",null,c);d._trigger("chunkalways",null,c);h<e?r():l.resolveWith(c.context,[f,g,k])}).fail(function(a,b,e){c.jqXHR=a;c.textStatus=b;c.errorThrown=e;d._trigger("chunkfail",null,c);d._trigger("chunkalways",null,c);l.rejectWith(c.context,[a,b,e])})};this._enhancePromise(n);n.abort=function(){return p.abort()};
r();return n},_beforeSend:function(a,c){0===this._active&&(this._trigger("start"),this._bitrateTimer=new this._BitrateTimer,this._progress.loaded=this._progress.total=0,this._progress.bitrate=0);this._initResponseObject(c);this._initProgressObject(c);c._progress.loaded=c.loaded=c.uploadedBytes||0;c._progress.total=c.total=this._getTotal(c.files)||1;c._progress.bitrate=c.bitrate=0;this._active+=1;this._progress.loaded+=c.loaded;this._progress.total+=c.total},_onDone:function(a,c,d,f){var e=f._progress.total,
h=f._response;f._progress.loaded<e&&this._onProgress(b.Event("progress",{lengthComputable:!0,loaded:e,total:e}),f);h.result=f.result=a;h.textStatus=f.textStatus=c;h.jqXHR=f.jqXHR=d;this._trigger("done",null,f)},_onFail:function(a,c,b,f){var e=f._response;f.recalculateProgress&&(this._progress.loaded-=f._progress.loaded,this._progress.total-=f._progress.total);e.jqXHR=f.jqXHR=a;e.textStatus=f.textStatus=c;e.errorThrown=f.errorThrown=b;this._trigger("fail",null,f)},_onAlways:function(a,c,b,f){this._trigger("always",
null,f)},_onSend:function(a,c){c.submit||this._addConvenienceMethods(a,c);var d=this,f,e,h,g,k=d._getAJAXSettings(c),l=function(){d._sending+=1;k._bitrateTimer=new d._BitrateTimer;return f=f||((e||!1===d._trigger("send",b.Event("send",{delegatedEvent:a}),k))&&d._getXHRPromise(!1,k.context,e)||d._chunkedUpload(k)||b.ajax(k)).done(function(a,c,b){d._onDone(a,c,b,k)}).fail(function(a,c,b){d._onFail(a,c,b,k)}).always(function(a,c,b){d._onAlways(a,c,b,k);--d._sending;--d._active;if(k.limitConcurrentUploads&&
k.limitConcurrentUploads>d._sending)for(a=d._slots.shift();a;){if("pending"===d._getDeferredState(a)){a.resolve();break}a=d._slots.shift()}0===d._active&&d._trigger("stop")})};this._beforeSend(a,k);return this.options.sequentialUploads||this.options.limitConcurrentUploads&&this.options.limitConcurrentUploads<=this._sending?(1<this.options.limitConcurrentUploads?(h=b.Deferred(),this._slots.push(h),g=h.pipe(l)):g=this._sequence=this._sequence.pipe(l,l),g.abort=function(){e=[void 0,"abort","abort"];
return f?f.abort():(h&&h.rejectWith(k.context,e),l())},this._enhancePromise(g)):l()},_onAdd:function(a,c){var d=this,f=!0,e=b.extend({},this.options,c),h=c.files,g=h.length,k=e.limitMultiFileUploads,l=e.limitMultiFileUploadSize,n=e.limitMultiFileUploadSizeOverhead,p=0,r=this._getParamName(e),u,q,t=0;if(!g)return!1;l&&void 0===h[0].size&&(l=void 0);if((e.singleFileUploads||k||l)&&this._isXHRUpload(e))if(e.singleFileUploads||l||!k)if(!e.singleFileUploads&&l)for(q=[],u=[],e=0;e<g;e+=1){if(p+=h[e].size+
n,e+1===g||p+h[e+1].size+n>l||k&&e+1-t>=k)q.push(h.slice(t,e+1)),p=r.slice(t,e+1),p.length||(p=r),u.push(p),t=e+1,p=0}else u=r;else for(q=[],u=[],e=0;e<g;e+=k)q.push(h.slice(e,e+k)),p=r.slice(e,e+k),p.length||(p=r),u.push(p);else q=[h],u=[r];c.originalFiles=h;b.each(q||h,function(e,h){var g=b.extend({},c);g.files=q?h:[h];g.paramName=u[e];d._initResponseObject(g);d._initProgressObject(g);d._addConvenienceMethods(a,g);return f=d._trigger("add",b.Event("add",{delegatedEvent:a}),g)});return f},_replaceFileInput:function(a){var c=
...
(l=l.concat(a),g()):h(l)},e)},k,l=[];c=c||"";a.isFile?a._file?(a._file.relativePath=c,f.resolve(a._file)):a.file(function(a){a.relativePath=c;f.resolve(a)},e):a.isDirectory?(k=a.createReader(),g()):f.resolve([]);return f.promise()},_handleFileTreeEntries:function(a,c){var d=this;return b.when.apply(b,b.map(a,function(a){return d._handleFileTreeEntry(a,c)})).pipe(function(){return Array.prototype.concat.apply([],arguments)})},_getDroppedFiles:function(a){a=a||{};var c=a.items;return c&&c.length&&(c[0].webkitGetAsEntry||
...
_initDataAttributes:function(){var a=this,c=this.options,d=this.element.data();b.each(this.element[0].attributes,function(b,e){var h=e.name.toLowerCase(),g;/^data-/.test(h)&&(h=h.slice(5).replace(/-[a-z]/g,function(a){return a.charAt(1).toUpperCase()}),g=d[h],a._isRegExpOption(h,g)&&(g=a._getRegExp(g)),c[h]=g)})},_create:function(){this._initDataAttributes();this._initSpecialOptions();this._slots=[];this._sequence=this._getXHRPromise(!0);this._sending=this._active=0;this._initProgressObject(this);
...
this._trigger("process",null,a);b.each(a.processQueue,function(a,g){var m=function(a){return c.errorThrown?b.Deferred().rejectWith(d,[c]).promise():d.processActions[g.action].call(d,a,g)};f=f.pipe(m,g.always&&m)});f.done(function(){d._trigger("processdone",null,a);d._trigger("processalways",null,a)}).fail(function(){d._trigger("processfail",null,a);d._trigger("processalways",null,a)});return f},_transformProcessQueue:function(a){var c=[];b.each(a.processQueue,function(){var d={},f=this.action,e=!0===
...
c.canvas&&a.canvas||a.img,h=function(b){b&&(b.width!==e.width||b.height!==e.height||c.forceResize)&&(a[b.getContext?"canvas":"img"]=b);a.preview=b;f.resolveWith(d,[a])},m;if(a.exif){!0===c.orientation&&(c.orientation=a.exif.get("Orientation"));if(c.thumbnail&&(m=a.exif.get("Thumbnail")))return g(m,h,c),f.promise();a.orientation?delete c.orientation:a.orientation=c.orientation}return e?(h(g.scale(e,c)),f.promise()):a},saveImage:function(a,c){if(!a.canvas||c.disabled)return a;var d=this,f=a.files[a.index],
...
do{if(a===g[0]){b=!0;break}a=a.parentNode}while(null!=a);b?g.addClass("hover"):g.removeClass("hover");window.dropZoneTimeout=setTimeout(function(){window.dropZoneTimeout=null;g.removeClass("in hover")},100)})},_create:function(){this._super();var b=this.element,a=function(){var a=b.find(".files"),d=a.children(".template-upload").not(".processing").length,f=a.children(".template-upload.processing").length,e=a.children(".template-download").not(".processing").length,a=a.children(".template-download").not(".processing").find(".toggle:checked").length,
h=b.find(".fileupload-buttonbar");h.find(".start").prop("disabled",0==d);h.find(".cancel").prop("disabled",0==d&&0==f);h.find(".delete").prop("disabled",0==a);h.find(".toggle").prop("disabled",0==e)};b.bind("fileuploadfailed fileuploadadded fileuploaddestroyed fileuploadcompleted",a);b.on("click",".toggle",a);b.bind("fileuploadcompleted",function(a,d){(b.data("blueimp-fileupload")||b.data("fileupload"))._renderPreviews(d)});a();this._defineDropZone()},_destroy:function(){b(document).unbind("dragover").undelegate("dragover")}})});gx.uc.FileUpload=function(b){var g=[],a,c=gx.lang.gxBoolean,d=function(a,b){b=b||"";switch(a){case "image":return/(\.|\/)(gif|jpe?g|png)$/i;case "audio":return/(\.|\/)(mp3|wav|ogg|3gp|aac|wma)$/i;case "video":return/(\.|\/)(avi|flv|wmv|mov|mp4)$/i;case "custom":if(b)return new RegExp("(\\.|\\/)("+b.replace(/,/g,"|")+")$","i")}};this.getFiles=function(){return b.map(g,function(a){return{FullName:a.name,Name:a.name.replace(new RegExp("."+a.extension+"$","i"),""),Extension:a.extension,Size:a.size,File:a.path}})};
this.show=function(){if(!this.IsPostBack){var f=b(this.getContainerControl());f.attr("id");var e=this.AcceptedFileTypes,h=this.CustomFileTypes,m="",k=d(e,h),l=this.Class||"",n=0,p=0;"image"==e||"audio"==e||"video"==e?m=' accept\x3d"'+e+'/*"':h&&(m=' accept\x3d".'+h.split(",").join(",.")+'"');a=b(['\x3cdiv class\x3d"gx-fileupload ',l,'"\x3e\n\x3cdiv class\x3d"row fileupload-buttonbar"\x3e\n\x3cdiv class\x3d"col-lg-7"\x3e\n\x3cspan class\x3d"btn btn-success fileinput-button"\x3e\n\x3ci class\x3d"glyphicon glyphicon-plus"\x3e\x3c/i\x3e\n\x3cspan\x3e',
gx.getMessage("GXM_fileupload_addfiles"),'\x3c/span\x3e\n\x3cinput type\x3d"file" name\x3d"files[]" multiple',m,'\x3e\n\x3c/span\x3e\n\x3cbutton type\x3d"submit" class\x3d"btn btn-primary start"\x3e\n\x3ci class\x3d"glyphicon glyphicon-upload"\x3e\x3c/i\x3e\n\x3cspan\x3e',gx.getMessage("GXM_fileupload_start"),'\x3c/span\x3e\n\x3c/button\x3e\n\x3cbutton type\x3d"reset" class\x3d"btn btn-warning cancel"\x3e\n\x3ci class\x3d"glyphicon glyphicon-ban-circle"\x3e\x3c/i\x3e\n\x3cspan\x3e',gx.getMessage("GXM_fileupload_cancel"),
...
gx.getMessage("GXM_fileupload_deleteone"),'\x3c/span\x3e\n\x3c/button\x3e\n\x3cinput type\x3d"checkbox" name\x3d"delete" value\x3d"1" class\x3d"toggle"\x3e\n{% } else { %}\n\x3cbutton class\x3d"btn btn-warning cancel"\x3e\n\x3ci class\x3d"glyphicon glyphicon-ban-circle"\x3e\x3c/i\x3e\n\x3cspan\x3e',gx.getMessage("GXM_fileupload_cancelone"),"\x3c/span\x3e\n\x3c/button\x3e\n{% } %}\n\x3c/td\x3e\n\x3c/tr\x3e\n{% } %}\n\x3c/script\x3e"].join("\n")).appendTo(document.body)});
