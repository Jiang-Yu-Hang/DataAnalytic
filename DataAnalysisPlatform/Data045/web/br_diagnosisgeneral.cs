/*
       ...
       Generated on: 2/28/2020 15:5:35.48
...
namespace GeneXus.Programs {
   public class br_diagnosisgeneral : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20202281553553", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void RenderHtmlCloseForm3E2( )
      {
         ...
         {
            context.AddJavascriptSource("br_diagnosisgeneral.js", "?20202281553556", false);
         }
      ...
      protected void WB3E0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtBR_Diagnosis_TumorStageClinical_Internalname, "肿瘤临床分期", "col-sm-3 ReadonlyAttributeLabel", 1, true);
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtBR_Diagnosis_TumorStageClinical_Internalname, A569BR_Diagnosis_TumorStageClinical, StringUtil.RTrim( context.localUtil.Format( A569BR_Diagnosis_TumorStageClinical, "")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtBR_Diagnosis_TumorStageClinical_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtBR_Diagnosis_TumorStageClinical_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 1, -1, -1, true, "", "left", true, "HLP_BR_DiagnosisGeneral.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void RF3E2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            while ( (pr_default.getStatus(0) != 101) )
            {
               ...
               A569BR_Diagnosis_TumorStageClinical = H003E2_A569BR_Diagnosis_TumorStageClinical[0];
               context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "A569BR_Diagnosis_TumorStageClinical", A569BR_Diagnosis_TumorStageClinical);
               n569BR_Diagnosis_TumorStageClinical = H003E2_n569BR_Diagnosis_TumorStageClinical[0];
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?20202281553647", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("br_diagnosisgeneral.js", "?20202281553648", false);
         }
      ...
      protected void init_default_properties( )
      {
         ...
         edtBR_Diagnosis_TumorStageClinical_Internalname = sPrefix+"BR_DIAGNOSIS_TUMORSTAGECLINICAL";
      ...
      public override void initialize( )
      {
         ...
         H003E2_A569BR_Diagnosis_TumorStageClinical = new String[] {""} ;
         H003E2_n569BR_Diagnosis_TumorStageClinical = new bool[] {false} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.br_diagnosisgeneral__default(),
            new Object[][] {
                new Object[] {
               H003E2_A85BR_Information_ID, H003E2_n85BR_Information_ID, H003E2_A64BR_DiagnosisID, H003E2_A36BR_Information_PatientNo, H003E2_n36BR_Information_PatientNo, H003E2_A19BR_EncounterID, H003E2_A569BR_Diagnosis_TumorStageClinical, H003E2_n569BR_Diagnosis_TumorStageClinical, H003E2_A260BR_Diagnosis_DXSource, H003E2_n260BR_Diagnosis_DXSource,
               H003E2_A71BR_Diagnosis_MetastasesDX, H003E2_n71BR_Diagnosis_MetastasesDX, H003E2_A70BR_Diagnosis_InitialDX, H003E2_n70BR_Diagnosis_InitialDX, H003E2_A67BR_Diagnosis_DXType, H003E2_n67BR_Diagnosis_DXType, H003E2_A66BR_Diagnosis_DXCode, H003E2_n66BR_Diagnosis_DXCode, H003E2_A65BR_Diagnosis_DXID, H003E2_n65BR_Diagnosis_DXID,
               H003E2_A68BR_Diagnosis_DXTsource, H003E2_n68BR_Diagnosis_DXTsource, H003E2_A69BR_Diagnosis_DXDescription, H003E2_n69BR_Diagnosis_DXDescription, H003E2_A513BR_Diagnosis_No, H003E2_n513BR_Diagnosis_No
               }
            }
         );
         AV16Pgmname = "BR_DiagnosisGeneral";
      ...
      private String[] H003E2_A569BR_Diagnosis_TumorStageClinical ;
      private bool[] H003E2_n569BR_Diagnosis_TumorStageClinical ;
   ...
   public class br_diagnosisgeneral__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H003E2", "SELECT T2.[BR_Information_ID], T1.[BR_DiagnosisID], T3.[BR_Information_PatientNo], T1.[BR_EncounterID], T1.[BR_Diagnosis_TumorStageClinical], T1.[BR_Diagnosis_DXSource], T1.[BR_Diagnosis_MetastasesDX], T1.[BR_Diagnosis_InitialDX], T1.[BR_Diagnosis_DXType], T1.[BR_Diagnosis_DXCode], T1.[BR_Diagnosis_DXID], T1.[BR_Diagnosis_DXTsource], T1.[BR_Diagnosis_DXDescription], T1.[BR_Diagnosis_No] FROM (([BR_Diagnosis] T1 WITH (NOLOCK) INNER JOIN [BR_Encounter] T2 WITH (NOLOCK) ON T2.[BR_EncounterID] = T1.[BR_EncounterID]) LEFT JOIN [BR_Information] T3 WITH (NOLOCK) ON T3.[BR_Information_ID] = T2.[BR_Information_ID]) WHERE T1.[BR_DiagnosisID] = @BR_DiagnosisID ORDER BY T1.[BR_DiagnosisID] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH003E2,1,0,true,true )
          };
       }
    }
