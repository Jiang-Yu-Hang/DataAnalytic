/*
       ...
       Generated on: 2/28/2020 12:48:17.96
   ...
   public class reorg : GXReorganization
   {
      ...
      private void TablesCount( )
      {
         if ( ! IsResumeMode( ) )
         {
            ...
            BR_FamilyhistoryCount = P00012_ABR_FamilyhistoryCount[0];
            pr_default.close(0);
            PrintRecordCount ( "BR_Familyhistory" ,  BR_FamilyhistoryCount );
         }
      }
      ...
      private bool PreviousCheck( )
      {
         ...
         if ( ! ColumnExist("BR_Familyhistory",sSchemaVar,"BR_Encounter_ID") )
         {
            SetCheckError ( GXResourceManager.GetMessage("GXM_column_not_exist", new   object[]  {"BR_Encounter_ID", "BR_Familyhistory"}) ) ;
            return false ;
         }
         return true ;
      }
      ...
      {
         ReorgExecute.RegisterBlockForSubmit( 1 ,  "ReorganizeBR_Familyhistory" , new Object[]{ });
      }

      private void ExecuteOnlyRisReorganization( )
      {
         ReorgExecute.RegisterBlockForSubmit( 2 ,  "RIBR_FamilyhistoryBR_Encounter" , new Object[]{ });
      }
      ...
      {
         GXReorganization.SetMsg( 1 ,  GXResourceManager.GetMessage("GXM_fileupdate", new   object[]  {"BR_Familyhistory", ""}) );
      }
      ...
      {
         scmdbuf = "";
         P00012_ABR_FamilyhistoryCount = new int[1] ;
         sSchemaVar = "";
         nsSchemaVar = false;
      ...
      protected int BR_FamilyhistoryCount ;
      ...
      protected int[] P00012_ABR_FamilyhistoryCount ;
   ...
   public class reorg__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P00012", "SELECT COUNT(*) FROM [BR_Familyhistory] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00012,100,0,true,false )
