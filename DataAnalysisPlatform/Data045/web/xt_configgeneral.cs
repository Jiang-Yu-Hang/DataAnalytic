/*
       ...
       Generated on: 2/28/2020 15:7:42.16
...
namespace GeneXus.Programs {
   public class xt_configgeneral : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20202281574220", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void RenderHtmlCloseForm6Y2( )
      {
         ...
         {
            context.AddJavascriptSource("xt_configgeneral.js", "?20202281574222", false);
         }
      ...
      protected void WB6Y0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_label_element( context, edtXT_ConfigKey_Internalname, "ÅäÖÃÃû³Æ", "col-sm-3 ReadonlyAttributeLabel", 1, true);
            /* Div Control */
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtXT_ConfigValue1_Internalname, "ÅäÖÃÖµ1", "col-sm-3 ReadonlyAttributeLabel", 1, true);
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
            /* Multiple line edit */
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtXT_ConfigValue2_Internalname, "ÅäÖÃÖµ2", "col-sm-3 ReadonlyAttributeLabel", 1, true);
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
            /* Multiple line edit */
            ClassString = "ReadonlyAttribute";
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtXT_ConfigValue3_Internalname, "ÅäÖÃÖµ3", "col-sm-3 ReadonlyAttributeLabel", 1, true);
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
            /* Multiple line edit */
            ClassString = "ReadonlyAttribute";
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtXT_ConfigValue4_Internalname, "ÅäÖÃÖµ4", "col-sm-3 ReadonlyAttributeLabel", 1, true);
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
            /* Multiple line edit */
            ClassString = "ReadonlyAttribute";
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtXT_ConfigValue5_Internalname, "ÅäÖÃÖµ5", "col-sm-3 ReadonlyAttributeLabel", 1, true);
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
            /* Multiple line edit */
            ClassString = "ReadonlyAttribute";
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnupdate_Internalname, "", "ÐÞ¸Ä", bttBtnupdate_Jsonclick, 7, "ÐÞ¸Ä", "", StyleString, ClassString, bttBtnupdate_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e116y1_client"+"'", TempTags, "", 2, "HLP_XT_ConfigGeneral.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtndelete_Internalname, "", "É¾³ý", bttBtndelete_Jsonclick, 7, "É¾³ý", "", StyleString, ClassString, bttBtndelete_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e126y1_client"+"'", TempTags, "", 2, "HLP_XT_ConfigGeneral.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?20202281574287", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("xt_configgeneral.js", "?20202281574288", false);
