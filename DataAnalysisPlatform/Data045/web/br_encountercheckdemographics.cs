/*
       ...
       Generated on: 2/28/2020 15:6:32.80
...
namespace GeneXus.Programs {
   public class br_encountercheckdemographics : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20202281563289", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void RenderHtmlCloseForm3U2( )
      {
         ...
         {
            context.AddJavascriptSource("br_encountercheckdemographics.js", "?20202281563293", false);
         }
      ...
      protected void WB3U0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 hidden-xs hidden-sm col-md-6 hidden-md hidden-lg DataContentCell", "left", "top", "", "", "div");
            /* Div Control */
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?20202281563426", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("br_encountercheckdemographics.js", "?20202281563427", false);
         }
