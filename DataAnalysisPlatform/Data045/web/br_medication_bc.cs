/*
       ...
       Generated on: 2/28/2020 15:7:27.6
...
namespace GeneXus.Programs {
   public class br_medication_bc : GXHttpHandler, IGxSilentTrn
   {
      ...
      protected void CheckExtendedTable0H18( )
      {
         ...
         {
            GX_msglist.addItem("域停药日期超界", "OutOfRange", 1, "");
            AnyError = 1;
         }
         ...
         {
            GX_msglist.addItem("域是否接受住院化疗超界", "OutOfRange", 1, "");
            AnyError = 1;
         }
      }
