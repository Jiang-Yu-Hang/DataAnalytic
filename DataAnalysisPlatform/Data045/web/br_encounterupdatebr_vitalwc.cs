/*
       ...
       Generated on: 2/28/2020 15:7:29.61
   ...
   public class br_encounterupdatebr_vitalwc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
         ...
         if ( StringUtil.Len( (String)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
               {
                  ...
                  gxgrGrid_refresh( subGrid_Rows, AV14OrderedBy, AV15OrderedDsc, AV28TFBR_Vital_Temperature, AV29TFBR_Vital_Temperature_To, AV8BR_EncounterID, AV62ddo_BR_VitalIDTitleControlIdToReplace, AV22ddo_BR_Vital_MeasureDateTitleControlIdToReplace, AV26ddo_BR_Vital_WeightTitleControlIdToReplace, AV30ddo_BR_Vital_TemperatureTitleControlIdToReplace, AV78Pgmname, AV54IsAuthorized_Display, AV56IsAuthorized_Update, AV58IsAuthorized_Delete, sPrefix) ;
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV78Pgmname = "BR_EncounterUpdateBR_VitalWC";
               context.Gx_err = 0;
               WS602( ) ;
               if ( ! isAjaxCallMode( ) )
               {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20202281572988", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"vGRIDPAGECOUNT", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV72GridPageCount), 10, 0, ".", "")));
         if ( context.isAjaxRequest( ) )
         {
      ...
      protected void RenderHtmlCloseForm602( )
      {
         ...
         {
            context.AddJavascriptSource("br_encounterupdatebr_vitalwc.js", "?20202281573244", false);
         }
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 13), "VUPDATE.CLICK") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 13), "VDELETE.CLICK") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 13), "VUPDATE.CLICK") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 13), "VDELETE.CLICK") == 0 ) )
                           {
                              ...
                              context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtavDisplay_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV53Display)) ? AV75Display_GXI : context.convertURL( context.PathToRelativeUrl( AV53Display))), !bGXsfl_28_Refreshing);
                              ...
                              context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtavUpdate_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV55Update)) ? AV76Update_GXI : context.convertURL( context.PathToRelativeUrl( AV55Update))), !bGXsfl_28_Refreshing);
                              ...
                              context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtavDelete_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV57Delete)) ? AV77Delete_GXI : context.convertURL( context.PathToRelativeUrl( AV57Delete))), !bGXsfl_28_Refreshing);
      ...
      protected void STRUP600( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            AV72GridPageCount = (long)(context.localUtil.CToN( cgiGet( sPrefix+"vGRIDPAGECOUNT"), ".", ","));
      ...
      protected void E19602( )
      {
         ...
         context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "AV72GridPageCount", StringUtil.LTrim( StringUtil.Str( (decimal)(AV72GridPageCount), 10, 0)));
      ...
      private void E20602( )
      {
         ...
         AV75Display_GXI = GXDbFile.PathToUrl( context.GetImagePath( "f11923b6-6acd-4a79-bfc0-0cfc6f3bced5", "", context.GetTheme( )));
         ...
         AV77Delete_GXI = GXDbFile.PathToUrl( context.GetImagePath( "7695fe89-52c9-4b7e-871e-0e11548f823e", "", context.GetTheme( )));
      ...
      protected void S122( )
      {
         ...
         {
            AV12GridState.FromXml(new GeneXus.Programs.wwpbaseobjects.loadgridstate(context).executeUdp(  AV78Pgmname+"GridState"), null, "WWPGridState", "DataAnalysisPlatform");
         }
         else
         {
            AV12GridState.FromXml(AV16Session.Get(AV78Pgmname+"GridState"), null, "WWPGridState", "DataAnalysisPlatform");
         }
      ...
      protected void S152( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.savegridstate(context ).execute(  AV78Pgmname+"GridState",  AV12GridState.ToXml(false, true, "WWPGridState", "DataAnalysisPlatform")) ;
      }
      ...
      protected void S112( )
      {
         ...
         AV10TrnContext.gxTpr_Callerobject = AV78Pgmname;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?20202281574346", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("br_encounterupdatebr_vitalwc.js", "?20202281574347", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
      ...
      protected void sendrow_282( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_28_idx <= subGrid_Recordsperpage( ) * 1 ) )
         {
            ...
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV53Display)) ? AV75Display_GXI : context.PathToRelativeUrl( AV53Display));
            ...
            ClassString = "ActionBaseColorAttribute";
            StyleString = "";
            AV55Update_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV55Update))&&String.IsNullOrEmpty(StringUtil.RTrim( AV76Update_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV55Update)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV55Update)) ? AV76Update_GXI : context.PathToRelativeUrl( AV55Update));
            ...
            StyleString = "";
            AV57Delete_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV57Delete))&&String.IsNullOrEmpty(StringUtil.RTrim( AV77Delete_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV57Delete)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV57Delete)) ? AV77Delete_GXI : context.PathToRelativeUrl( AV57Delete));
