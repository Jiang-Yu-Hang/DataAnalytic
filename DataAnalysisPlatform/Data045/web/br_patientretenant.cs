/*
       ...
       Generated on: 2/28/2020 15:9:2.31
...
namespace GeneXus.Programs {
   public class br_patientretenant : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202022815936", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("br_patientretenant.js", "?202022815939", false);
