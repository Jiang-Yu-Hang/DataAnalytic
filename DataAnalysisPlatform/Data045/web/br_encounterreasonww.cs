/*
       ...
       Generated on: 2/28/2020 15:16:8.44
...
namespace GeneXus.Programs {
   public class br_encounterreasonww : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20202281516874", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void WB760( )
      {
         ...
         if ( wbEnd == 31 )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtavTfbr_encounterreason_israndnoapprovedate_to_Internalname, context.localUtil.TToC( AV30TFBR_EncounterReason_IsRandNoApproveDate_To, 10, 8, 0, 0, "/", ":", " "), context.localUtil.Format( AV30TFBR_EncounterReason_IsRandNoApproveDate_To, "9999/99/99 99:99:99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'YMD',8,24,'chs',false,1);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,73);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavTfbr_encounterreason_israndnoapprovedate_to_Jsonclick, 0, "Attribute", "", "", "", "", edtavTfbr_encounterreason_israndnoapprovedate_to_Visible, 1, 0, "text", "", 19, "chr", 1, "row", 19, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_BR_EncounterReasonWW.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtavDdo_br_encounterreason_israndnoapprovedateauxdate_Internalname, context.localUtil.Format(AV31DDO_BR_EncounterReason_IsRandNoApproveDateAuxDate, "9999/99/99"), context.localUtil.Format( AV31DDO_BR_EncounterReason_IsRandNoApproveDateAuxDate, "9999/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'YMD',0,24,'chs',false,1);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,75);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavDdo_br_encounterreason_israndnoapprovedateauxdate_Jsonclick, 0, "Attribute", "", "", "", "", 1, 1, 0, "text", "", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_BR_EncounterReasonWW.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtavDdo_br_encounterreason_israndnoapprovedateauxdateto_Internalname, context.localUtil.Format(AV32DDO_BR_EncounterReason_IsRandNoApproveDateAuxDateTo, "9999/99/99"), context.localUtil.Format( AV32DDO_BR_EncounterReason_IsRandNoApproveDateAuxDateTo, "9999/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'YMD',0,24,'chs',false,1);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,76);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavDdo_br_encounterreason_israndnoapprovedateauxdateto_Jsonclick, 0, "Attribute", "", "", "", "", 1, 1, 0, "text", "", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_BR_EncounterReasonWW.htm");
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202022815162590", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("br_encounterreasonww.js", "?202022815162591", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
