/*
               File: BR_Procedure_SurgeryView
        Description: BR_Procedure_Surgery View
             Author: GeneXus C# Generator version 16_0_0-127771
       Generated on: 2/28/2020 15:14:39.4
...
namespace GeneXus.Programs {
   public class br_procedure_surgeryview : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public br_procedure_surgeryview( )
      {
      ...
      public br_procedure_surgeryview( IGxContext context )
      {
      ...
      public void execute( long aP0_BR_Procedure_SurgeryID ,
                           String aP1_TabCode )
      {
         this.AV10BR_Procedure_SurgeryID = aP0_BR_Procedure_SurgeryID;
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV10BR_Procedure_SurgeryID = (long)(NumberUtil.Val( gxfirstwebparm, "."));
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV10BR_Procedure_SurgeryID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV10BR_Procedure_SurgeryID), 18, 0)));
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "gxhash_vBR_PROCEDURE_SURGERYID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10BR_Procedure_SurgeryID), "ZZZZZZZZZZZZZZZZZZ"), context));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20202281514396", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("br_procedure_surgeryview.aspx") + "?" + UrlEncode("" +AV10BR_Procedure_SurgeryID) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode))+"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vBR_PROCEDURE_SURGERYID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10BR_Procedure_SurgeryID), 18, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vBR_PROCEDURE_SURGERYID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10BR_Procedure_SurgeryID), "ZZZZZZZZZZZZZZZZZZ"), context));
      ...
      {
         return formatLink("br_procedure_surgeryview.aspx") + "?" + UrlEncode("" +AV10BR_Procedure_SurgeryID) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode)) ;
      }

      public override String GetPgmname( )
      {
         return "BR_Procedure_SurgeryView" ;
      }

      public override String GetPgmdesc( )
      {
         return "BR_Procedure_Surgery View" ;
      }
      ...
      protected void WB650( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnreturn_Internalname, "", "返回", bttBtnreturn_Jsonclick, 5, "返回", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DORETURN\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_BR_Procedure_SurgeryView.htm");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTxttabtitle_Internalname, lblTxttabtitle_Caption, "", "", lblTxttabtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockTitleWWPTab", 0, "", 1, 1, 0, "HLP_BR_Procedure_SurgeryView.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "手术信息", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, "HLP_BR_Procedure_SurgeryView.htm");
            /* Div Control */
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtngeneral_Internalname, "", "手术信息", bttBtngeneral_Jsonclick, 7, "手术信息", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e11651_client"+"'", TempTags, "", 2, "HLP_BR_Procedure_SurgeryView.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START652( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "BR_Procedure_Surgery View", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void STRUP650( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            /* Read saved values. */
            AV10BR_Procedure_SurgeryID = (long)(context.localUtil.CToN( cgiGet( "vBR_PROCEDURE_SURGERYID"), ".", ","));
      ...
      protected void E12652( )
      {
         ...
         AV19GXLvl9 = 0;
         /* Using cursor H00652 */
         pr_default.execute(0, new Object[] {AV10BR_Procedure_SurgeryID});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A320BR_Procedure_SurgeryID = H00652_A320BR_Procedure_SurgeryID[0];
            AV19GXLvl9 = 1;
      ...
      protected void S112( )
      {
         ...
         {
            /* Object Property */
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "BR_Procedure_SurgeryGeneral")) != 0 )
            {
               WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "br_procedure_surgerygeneral", new Object[] {context} );
               WebComp_Generalwc.ComponentInit();
               WebComp_Generalwc.Name = "BR_Procedure_SurgeryGeneral";
               WebComp_Generalwc_Component = "BR_Procedure_SurgeryGeneral";
            }
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               WebComp_Generalwc.setjustcreated();
               WebComp_Generalwc.componentprepare(new Object[] {(String)"W0026",(String)"",(long)AV10BR_Procedure_SurgeryID});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV10BR_Procedure_SurgeryID = Convert.ToInt64(getParm(obj,0));
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV10BR_Procedure_SurgeryID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV10BR_Procedure_SurgeryID), 18, 0)));
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "gxhash_vBR_PROCEDURE_SURGERYID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10BR_Procedure_SurgeryID), "ZZZZZZZZZZZZZZZZZZ"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202022815143936", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("br_procedure_surgeryview.js", "?202022815143936", false);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "BR_Procedure_Surgery View";
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV10BR_Procedure_SurgeryID',fld:'vBR_PROCEDURE_SURGERYID',pic:'ZZZZZZZZZZZZZZZZZZ',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("'DORETURN'","{handler:'E14652',iparms:[]");
         setEventMetadata("'DORETURN'",",oparms:[]}");
         setEventMetadata("'GENERAL'","{handler:'E11651',iparms:[{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV10BR_Procedure_SurgeryID',fld:'vBR_PROCEDURE_SURGERYID',pic:'ZZZZZZZZZZZZZZZZZZ',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H00652_A320BR_Procedure_SurgeryID = new long[1] ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.br_procedure_surgeryview__default(),
            new Object[][] {
                new Object[] {
               H00652_A320BR_Procedure_SurgeryID
               }
            }
         );
      ...
      private int idxLst ;
      private long AV10BR_Procedure_SurgeryID ;
      private long wcpOAV10BR_Procedure_SurgeryID ;
      ...
      private long[] H00652_A320BR_Procedure_SurgeryID ;
   ...
   public class br_procedure_surgeryview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@AV10BR_Procedure_SurgeryID",SqlDbType.Decimal,18,0}
          } ;
          def= new CursorDef[] {
              new CursorDef("H00652", "SELECT [BR_Procedure_SurgeryID] FROM [BR_Procedure_Surgery] WITH (NOLOCK) WHERE [BR_Procedure_SurgeryID] = @AV10BR_Procedure_SurgeryID ORDER BY [BR_Procedure_SurgeryID] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00652,1,0,false,true )
          };
       }
    }
