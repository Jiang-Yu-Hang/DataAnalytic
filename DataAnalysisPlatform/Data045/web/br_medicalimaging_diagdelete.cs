/*
               File: BR_MedicalImaging_DiagDelete
        Description:
             Author: GeneXus C# Generator version 16_0_0-127771
       Generated on: 2/28/2020 15:16:59.84
...
namespace GeneXus.Programs {
   public class br_medicalimaging_diagdelete : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public br_medicalimaging_diagdelete( )
      {
      ...
      public br_medicalimaging_diagdelete( IGxContext context )
      {
      ...
      {
         this.AV11BR_MedicalImaging_DiagID = aP0_BR_MedicalImaging_DiagID;
         executePrivate();
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV11BR_MedicalImaging_DiagID = (long)(NumberUtil.Val( gxfirstwebparm, "."));
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV11BR_MedicalImaging_DiagID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV11BR_MedicalImaging_DiagID), 18, 0)));
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "gxhash_vBR_MEDICALIMAGING_DIAGID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV11BR_MedicalImaging_DiagID), "ZZZZZZZZZZZZZZZZZZ"), context));
            }
            if ( context.isSpaRequest( ) )
            {
               enableJsOutput();
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202022815165986", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("br_medicalimaging_diagdelete.aspx") + "?" + UrlEncode("" +AV11BR_MedicalImaging_DiagID)+"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         forbiddenHiddens = "hsh" + "BR_MedicalImaging_DiagDelete";
         forbiddenHiddens = forbiddenHiddens + context.localUtil.Format( (decimal)(AV10BR_MedicalImaging_Diag.gxTpr_Br_medicalimaging_diag_no), "ZZZZZZZZZZZZZZZZZZ");
         forbiddenHiddens = forbiddenHiddens + StringUtil.RTrim( context.localUtil.Format( AV10BR_MedicalImaging_Diag.gxTpr_Br_medicalimaging_diag_loc, ""));
         forbiddenHiddens = forbiddenHiddens + StringUtil.RTrim( context.localUtil.Format( AV10BR_MedicalImaging_Diag.gxTpr_Br_medicalimaging_diag_organ, ""));
         forbiddenHiddens = forbiddenHiddens + StringUtil.RTrim( context.localUtil.Format( AV10BR_MedicalImaging_Diag.gxTpr_Br_medicalimaging_diag_dis, ""));
         GxWebStd.gx_hidden_field( context, "hsh", GetEncryptedHash( forbiddenHiddens, GXKey));
         GXUtil.WriteLog("br_medicalimaging_diagdelete:[SendSecurityCheck value for]"+"GXV1:"+context.localUtil.Format( (decimal)(AV10BR_MedicalImaging_Diag.gxTpr_Br_medicalimaging_diag_no), "ZZZZZZZZZZZZZZZZZZ"));
         GXUtil.WriteLog("br_medicalimaging_diagdelete:[SendSecurityCheck value for]"+"GXV2:"+StringUtil.RTrim( context.localUtil.Format( AV10BR_MedicalImaging_Diag.gxTpr_Br_medicalimaging_diag_loc, "")));
         GXUtil.WriteLog("br_medicalimaging_diagdelete:[SendSecurityCheck value for]"+"GXV3:"+StringUtil.RTrim( context.localUtil.Format( AV10BR_MedicalImaging_Diag.gxTpr_Br_medicalimaging_diag_organ, "")));
         GXUtil.WriteLog("br_medicalimaging_diagdelete:[SendSecurityCheck value for]"+"GXV4:"+StringUtil.RTrim( context.localUtil.Format( AV10BR_MedicalImaging_Diag.gxTpr_Br_medicalimaging_diag_dis, "")));
      }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vBR_MEDICALIMAGING_DIAGID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV11BR_MedicalImaging_DiagID), 18, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vBR_MEDICALIMAGING_DIAGID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV11BR_MedicalImaging_DiagID), "ZZZZZZZZZZZZZZZZZZ"), context));
      ...
      {
         return formatLink("br_medicalimaging_diagdelete.aspx") + "?" + UrlEncode("" +AV11BR_MedicalImaging_DiagID) ;
      }

      public override String GetPgmname( )
      {
         return "BR_MedicalImaging_DiagDelete" ;
      }
      ...
      protected void WB8Y0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavBr_medicalimaging_diag_br_medicalimaging_diag_loc_Internalname, "诊断意见(部位)", "col-sm-3 ReadonlyAttributeLabel", 1, true);
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtavBr_medicalimaging_diag_br_medicalimaging_diag_loc_Internalname, AV10BR_MedicalImaging_Diag.gxTpr_Br_medicalimaging_diag_loc, StringUtil.RTrim( context.localUtil.Format( AV10BR_MedicalImaging_Diag.gxTpr_Br_medicalimaging_diag_loc, "")), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavBr_medicalimaging_diag_br_medicalimaging_diag_loc_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtavBr_medicalimaging_diag_br_medicalimaging_diag_loc_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 1, -1, -1, true, "", "left", true, "HLP_BR_MedicalImaging_DiagDelete.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavBr_medicalimaging_diag_br_medicalimaging_diag_organ_Internalname, "诊断意见(器官)", "col-sm-3 ReadonlyAttributeLabel", 1, true);
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtavBr_medicalimaging_diag_br_medicalimaging_diag_organ_Internalname, AV10BR_MedicalImaging_Diag.gxTpr_Br_medicalimaging_diag_organ, StringUtil.RTrim( context.localUtil.Format( AV10BR_MedicalImaging_Diag.gxTpr_Br_medicalimaging_diag_organ, "")), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavBr_medicalimaging_diag_br_medicalimaging_diag_organ_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtavBr_medicalimaging_diag_br_medicalimaging_diag_organ_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 1, -1, -1, true, "", "left", true, "HLP_BR_MedicalImaging_DiagDelete.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavBr_medicalimaging_diag_br_medicalimaging_diag_dis_Internalname, "诊断意见(疾病)", "col-sm-3 ReadonlyAttributeLabel", 1, true);
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtavBr_medicalimaging_diag_br_medicalimaging_diag_dis_Internalname, AV10BR_MedicalImaging_Diag.gxTpr_Br_medicalimaging_diag_dis, StringUtil.RTrim( context.localUtil.Format( AV10BR_MedicalImaging_Diag.gxTpr_Br_medicalimaging_diag_dis, "")), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavBr_medicalimaging_diag_br_medicalimaging_diag_dis_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtavBr_medicalimaging_diag_br_medicalimaging_diag_dis_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 1, -1, -1, true, "", "left", true, "HLP_BR_MedicalImaging_DiagDelete.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnenter_Internalname, "", "确认", bttBtnenter_Jsonclick, 5, "确认", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"EENTER."+"'", TempTags, "", context.GetButtonType( ), "HLP_BR_MedicalImaging_DiagDelete.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtncancel_Internalname, "", "取消", bttBtncancel_Jsonclick, 1, "取消", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", context.GetButtonType( ), "HLP_BR_MedicalImaging_DiagDelete.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void initialize_formulas( )
      {
         /* GeneXus formulas. */
         context.Gx_err = 0;
         edtavBr_medicalimaging_diag_br_medicalimaging_diag_no_Enabled = 0;
         context.httpAjaxContext.ajax_rsp_assign_prop("", false, edtavBr_medicalimaging_diag_br_medicalimaging_diag_no_Internalname, "Enabled", StringUtil.LTrim( StringUtil.Str( (decimal)(edtavBr_medicalimaging_diag_br_medicalimaging_diag_no_Enabled), 5, 0)), true);
         edtavBr_medicalimaging_diag_br_medicalimaging_diag_loc_Enabled = 0;
         context.httpAjaxContext.ajax_rsp_assign_prop("", false, edtavBr_medicalimaging_diag_br_medicalimaging_diag_loc_Internalname, "Enabled", StringUtil.LTrim( StringUtil.Str( (decimal)(edtavBr_medicalimaging_diag_br_medicalimaging_diag_loc_Enabled), 5, 0)), true);
         edtavBr_medicalimaging_diag_br_medicalimaging_diag_organ_Enabled = 0;
         context.httpAjaxContext.ajax_rsp_assign_prop("", false, edtavBr_medicalimaging_diag_br_medicalimaging_diag_organ_Internalname, "Enabled", StringUtil.LTrim( StringUtil.Str( (decimal)(edtavBr_medicalimaging_diag_br_medicalimaging_diag_organ_Enabled), 5, 0)), true);
         edtavBr_medicalimaging_diag_br_medicalimaging_diag_dis_Enabled = 0;
         context.httpAjaxContext.ajax_rsp_assign_prop("", false, edtavBr_medicalimaging_diag_br_medicalimaging_diag_dis_Internalname, "Enabled", StringUtil.LTrim( StringUtil.Str( (decimal)(edtavBr_medicalimaging_diag_br_medicalimaging_diag_dis_Enabled), 5, 0)), true);
      }
      ...
      protected void STRUP8Y0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            {
               GXUtil.WriteLog("br_medicalimaging_diagdelete:[SecurityCheckFailed value for]"+"GXV1:"+context.localUtil.Format( (decimal)(AV10BR_MedicalImaging_Diag.gxTpr_Br_medicalimaging_diag_no), "ZZZZZZZZZZZZZZZZZZ"));
               GXUtil.WriteLog("br_medicalimaging_diagdelete:[SecurityCheckFailed value for]"+"GXV2:"+StringUtil.RTrim( context.localUtil.Format( AV10BR_MedicalImaging_Diag.gxTpr_Br_medicalimaging_diag_loc, "")));
               GXUtil.WriteLog("br_medicalimaging_diagdelete:[SecurityCheckFailed value for]"+"GXV3:"+StringUtil.RTrim( context.localUtil.Format( AV10BR_MedicalImaging_Diag.gxTpr_Br_medicalimaging_diag_organ, "")));
               GXUtil.WriteLog("br_medicalimaging_diagdelete:[SecurityCheckFailed value for]"+"GXV4:"+StringUtil.RTrim( context.localUtil.Format( AV10BR_MedicalImaging_Diag.gxTpr_Br_medicalimaging_diag_dis, "")));
               GxWebError = 1;
      ...
      protected void E118Y2( )
      {
         ...
         AV10BR_MedicalImaging_Diag.Load(AV11BR_MedicalImaging_DiagID);
      ...
      protected void S112( )
      {
         ...
         AV22GXV7 = 1;
         while ( AV22GXV7 <= AV8Messages.Count )
         {
            AV7Message = ((SdtMessages_Message)AV8Messages.Item(AV22GXV7));
            GX_msglist.addItem(AV7Message.gxTpr_Description);
            AV22GXV7 = (int)(AV22GXV7+1);
         }
      }
      ...
      protected void E138Y2( )
      {
         ...
         if ( ! AV13tCheckFlag )
         {
            AV10BR_MedicalImaging_Diag.Delete();
            context.CommitDataStores("br_medicalimaging_diagdelete",pr_default);
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV11BR_MedicalImaging_DiagID = Convert.ToInt64(getParm(obj,0));
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV11BR_MedicalImaging_DiagID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV11BR_MedicalImaging_DiagID), 18, 0)));
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "gxhash_vBR_MEDICALIMAGING_DIAGID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV11BR_MedicalImaging_DiagID), "ZZZZZZZZZZZZZZZZZZ"), context));
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?20202281517079", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("br_medicalimaging_diagdelete.js", "?20202281517080", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV11BR_MedicalImaging_DiagID',fld:'vBR_MEDICALIMAGING_DIAGID',pic:'ZZZZZZZZZZZZZZZZZZ',hsh:true},{av:'AV10BR_MedicalImaging_Diag.gxTpr_Br_medicalimaging_diag_no',fld:'BR_MEDICALIMAGING_DIAG_BR_MEDICALIMAGING_DIAG_NO',pic:'ZZZZZZZZZZZZZZZZZZ'},{av:'AV10BR_MedicalImaging_Diag.gxTpr_Br_medicalimaging_diag_loc',fld:'BR_MEDICALIMAGING_DIAG_BR_MEDICALIMAGING_DIAG_LOC',pic:''},{av:'AV10BR_MedicalImaging_Diag.gxTpr_Br_medicalimaging_diag_organ',fld:'BR_MEDICALIMAGING_DIAG_BR_MEDICALIMAGING_DIAG_ORGAN',pic:''},{av:'AV10BR_MedicalImaging_Diag.gxTpr_Br_medicalimaging_diag_dis',fld:'BR_MEDICALIMAGING_DIAG_BR_MEDICALIMAGING_DIAG_DIS',pic:''}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("ENTER","{handler:'E138Y2',iparms:[{av:'AV10BR_MedicalImaging_Diag',fld:'vBR_MEDICALIMAGING_DIAG',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         pr_datastore1 = new DataStoreProvider(context, new GeneXus.Programs.br_medicalimaging_diagdelete__datastore1(),
            new Object[][] {
            }
         );
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.br_medicalimaging_diagdelete__default(),
            new Object[][] {
            }
         );
         /* GeneXus formulas. */
      ...
      private int AV22GXV7 ;
      private int idxLst ;
      private long AV11BR_MedicalImaging_DiagID ;
      private long wcpOAV11BR_MedicalImaging_DiagID ;
   ...
   public class br_medicalimaging_diagdelete__datastore1 : DataStoreHelperBase, IDataStoreHelper
   {
 ...
 public class br_medicalimaging_diagdelete__default : DataStoreHelperBase, IDataStoreHelper
 {
    public ICursor[] getCursors( )
    {
       cursorDefinitions();
