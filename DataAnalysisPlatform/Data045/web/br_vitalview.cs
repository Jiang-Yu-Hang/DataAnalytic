/*
               File: BR_VitalView
        Description: BR_Vital View
             Author: GeneXus C# Generator version 16_0_0-127771
       Generated on: 2/28/2020 15:14:35.10
...
namespace GeneXus.Programs {
   public class br_vitalview : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public br_vitalview( )
      {
      ...
      public br_vitalview( IGxContext context )
      {
      ...
      public void execute( long aP0_BR_VitalID ,
                           String aP1_TabCode )
      {
         this.AV10BR_VitalID = aP0_BR_VitalID;
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV10BR_VitalID = (long)(NumberUtil.Val( gxfirstwebparm, "."));
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV10BR_VitalID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV10BR_VitalID), 18, 0)));
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "gxhash_vBR_VITALID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10BR_VitalID), "ZZZZZZZZZZZZZZZZZZ"), context));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202022815143513", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("br_vitalview.aspx") + "?" + UrlEncode("" +AV10BR_VitalID) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode))+"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vBR_VITALID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10BR_VitalID), 18, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vBR_VITALID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10BR_VitalID), "ZZZZZZZZZZZZZZZZZZ"), context));
      ...
      {
         return formatLink("br_vitalview.aspx") + "?" + UrlEncode("" +AV10BR_VitalID) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode)) ;
      }
      ...
      protected void WB5X0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnback_Internalname, "", "返回", bttBtnback_Jsonclick, 5, "返回", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOBACK\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_BR_VitalView.htm");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTxttabtitle_Internalname, lblTxttabtitle_Caption, "", "", lblTxttabtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockTitleWWPTab", 0, "", 1, 1, 0, "HLP_BR_VitalView.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "生命体征", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, "HLP_BR_VitalView.htm");
            /* Div Control */
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtngeneral_Internalname, "", "生命体征", bttBtngeneral_Jsonclick, 7, "生命体征", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e115x1_client"+"'", TempTags, "", 2, "HLP_BR_VitalView.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START5X2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "BR_Vital View", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void STRUP5X0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            /* Read saved values. */
            AV10BR_VitalID = (long)(context.localUtil.CToN( cgiGet( "vBR_VITALID"), ".", ","));
      ...
      protected void E125X2( )
      {
         ...
         AV16GXLvl9 = 0;
         /* Using cursor H005X2 */
         pr_default.execute(0, new Object[] {AV10BR_VitalID});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A150BR_VitalID = H005X2_A150BR_VitalID[0];
            AV16GXLvl9 = 1;
      ...
      protected void S112( )
      {
         ...
         {
            /* Object Property */
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "BR_VitalGeneral")) != 0 )
            {
               WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "br_vitalgeneral", new Object[] {context} );
               WebComp_Generalwc.ComponentInit();
               WebComp_Generalwc.Name = "BR_VitalGeneral";
               WebComp_Generalwc_Component = "BR_VitalGeneral";
            }
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               WebComp_Generalwc.setjustcreated();
               WebComp_Generalwc.componentprepare(new Object[] {(String)"W0026",(String)"",(long)AV10BR_VitalID});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV10BR_VitalID = Convert.ToInt64(getParm(obj,0));
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV10BR_VitalID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV10BR_VitalID), 18, 0)));
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "gxhash_vBR_VITALID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10BR_VitalID), "ZZZZZZZZZZZZZZZZZZ"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202022815143545", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("br_vitalview.js", "?202022815143545", false);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV10BR_VitalID',fld:'vBR_VITALID',pic:'ZZZZZZZZZZZZZZZZZZ',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("'DOBACK'","{handler:'E145X2',iparms:[]");
         setEventMetadata("'DOBACK'",",oparms:[]}");
         setEventMetadata("'GENERAL'","{handler:'E115X1',iparms:[{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV10BR_VitalID',fld:'vBR_VITALID',pic:'ZZZZZZZZZZZZZZZZZZ',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H005X2_A150BR_VitalID = new long[1] ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.br_vitalview__default(),
            new Object[][] {
                new Object[] {
               H005X2_A150BR_VitalID
               }
            }
         );
      ...
      private int idxLst ;
      private long AV10BR_VitalID ;
      private long wcpOAV10BR_VitalID ;
      ...
      private long[] H005X2_A150BR_VitalID ;
   ...
   public class br_vitalview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@AV10BR_VitalID",SqlDbType.Decimal,18,0}
          } ;
          def= new CursorDef[] {
              new CursorDef("H005X2", "SELECT [BR_VitalID] FROM [BR_Vital] WITH (NOLOCK) WHERE [BR_VitalID] = @AV10BR_VitalID ORDER BY [BR_VitalID] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH005X2,1,0,false,true )
          };
       }
    }
