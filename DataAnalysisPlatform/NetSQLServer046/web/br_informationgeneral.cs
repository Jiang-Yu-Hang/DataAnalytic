/*
       ...
       Generated on: 2/27/2020 11:58:14.62
...
namespace GeneXus.Programs {
   public class br_informationgeneral : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202022711581467", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void RenderHtmlCloseForm1I2( )
      {
         ...
         {
            context.AddJavascriptSource("br_informationgeneral.js", "?202022711581468", false);
         }
      ...
      protected void WB1I0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtavView_lastest_patient_info_view_lpi_br_encounter_admitdate_Internalname, context.localUtil.TToC( AV16view_lastest_patient_info.gxTpr_View_lpi_br_encounter_admitdate, 10, 8, 0, 0, "/", ":", " "), context.localUtil.Format( AV16view_lastest_patient_info.gxTpr_View_lpi_br_encounter_admitdate, "9999/99/99 99:99:99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'YMD',8,24,'chs',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,49);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavView_lastest_patient_info_view_lpi_br_encounter_admitdate_Jsonclick, 0, "Attribute", "", "", "", "", edtavView_lastest_patient_info_view_lpi_br_encounter_admitdate_Visible, 1, 0, "text", "", 19, "chr", 1, "row", 19, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_BR_InformationGeneral.htm");
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202022711581524", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("br_informationgeneral.js", "?202022711581525", false);
         }
