/*
       ...
       Generated on: 2/27/2020 12:6:16.51
...
namespace GeneXus.Programs {
   public class br_encounter_refusereasonww : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20202271261677", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void WB7C0( )
      {
         ...
         if ( wbEnd == 31 )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtavTfbr_encounter_refusereason_noapprovedate_Internalname, context.localUtil.TToC( AV29TFBR_Encounter_RefuseReason_NoApproveDate, 10, 8, 0, 0, "/", ":", " "), context.localUtil.Format( AV29TFBR_Encounter_RefuseReason_NoApproveDate, "9999/99/99 99:99:99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'YMD',8,24,'chs',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,66);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavTfbr_encounter_refusereason_noapprovedate_Jsonclick, 0, "Attribute", "", "", "", "", edtavTfbr_encounter_refusereason_noapprovedate_Visible, 1, 0, "text", "", 19, "chr", 1, "row", 19, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_BR_Encounter_RefuseReasonWW.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtavTfbr_encounter_refusereason_noapprovedate_to_Internalname, context.localUtil.TToC( AV30TFBR_Encounter_RefuseReason_NoApproveDate_To, 10, 8, 0, 0, "/", ":", " "), context.localUtil.Format( AV30TFBR_Encounter_RefuseReason_NoApproveDate_To, "9999/99/99 99:99:99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'YMD',8,24,'chs',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,67);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavTfbr_encounter_refusereason_noapprovedate_to_Jsonclick, 0, "Attribute", "", "", "", "", edtavTfbr_encounter_refusereason_noapprovedate_to_Visible, 1, 0, "text", "", 19, "chr", 1, "row", 19, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_BR_Encounter_RefuseReasonWW.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtavDdo_br_encounter_refusereason_noapprovedateauxdate_Internalname, context.localUtil.Format(AV31DDO_BR_Encounter_RefuseReason_NoApproveDateAuxDate, "9999/99/99"), context.localUtil.Format( AV31DDO_BR_Encounter_RefuseReason_NoApproveDateAuxDate, "9999/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'YMD',0,24,'chs',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,69);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavDdo_br_encounter_refusereason_noapprovedateauxdate_Jsonclick, 0, "Attribute", "", "", "", "", 1, 1, 0, "text", "", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_BR_Encounter_RefuseReasonWW.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtavDdo_br_encounter_refusereason_noapprovedateauxdateto_Internalname, context.localUtil.Format(AV32DDO_BR_Encounter_RefuseReason_NoApproveDateAuxDateTo, "9999/99/99"), context.localUtil.Format( AV32DDO_BR_Encounter_RefuseReason_NoApproveDateAuxDateTo, "9999/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'YMD',0,24,'chs',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,70);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavDdo_br_encounter_refusereason_noapprovedateauxdateto_Jsonclick, 0, "Attribute", "", "", "", "", 1, 1, 0, "text", "", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_BR_Encounter_RefuseReasonWW.htm");
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?20202271263063", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("br_encounter_refusereasonww.js", "?20202271263063", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
