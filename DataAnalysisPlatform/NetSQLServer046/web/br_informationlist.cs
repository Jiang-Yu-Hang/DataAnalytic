/*
       ...
       Generated on: 2/27/2020 12:7:16.14
...
namespace GeneXus.Programs {
   public class br_informationlist : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20202271271644", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void wb_table1_30_A02e( bool wbgen )
      {
         ...
         if ( wbEnd == 68 )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtavTfview_lpi_br_demographics_birthdate_to_Internalname, context.localUtil.Format(AV32TFVIEW_LPI_BR_Demographics_BirthDate_To, "9999/99/99"), context.localUtil.Format( AV32TFVIEW_LPI_BR_Demographics_BirthDate_To, "9999/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'YMD',0,24,'chs',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,99);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavTfview_lpi_br_demographics_birthdate_to_Jsonclick, 0, "Attribute", "", "", "", "", edtavTfview_lpi_br_demographics_birthdate_to_Visible, 1, 0, "text", "", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_BR_InformationList.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtavDdo_view_lpi_br_demographics_birthdateauxdateto_Internalname, context.localUtil.Format(AV34DDO_VIEW_LPI_BR_Demographics_BirthDateAuxDateTo, "9999/99/99"), context.localUtil.Format( AV34DDO_VIEW_LPI_BR_Demographics_BirthDateAuxDateTo, "9999/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'YMD',0,24,'chs',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,102);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavDdo_view_lpi_br_demographics_birthdateauxdateto_Jsonclick, 0, "Attribute", "", "", "", "", 1, 1, 0, "text", "", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_BR_InformationList.htm");
      ...
      protected void wb_table1_30_A02( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtavView_lpi_br_demographics_birthdate_Internalname, context.localUtil.Format(AV18VIEW_LPI_BR_Demographics_BirthDate, "9999/99/99"), context.localUtil.Format( AV18VIEW_LPI_BR_Demographics_BirthDate, "9999/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'YMD',0,24,'chs',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,37);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavView_lpi_br_demographics_birthdate_Jsonclick, 0, "AttributeDate", "", "", "", "", 1, edtavView_lpi_br_demographics_birthdate_Enabled, 0, "text", "", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_BR_InformationList.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtavView_lpi_br_demographics_birthdate_to_Internalname, context.localUtil.Format(AV17VIEW_LPI_BR_Demographics_BirthDate_To, "9999/99/99"), context.localUtil.Format( AV17VIEW_LPI_BR_Demographics_BirthDate_To, "9999/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'YMD',0,24,'chs',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,42);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavView_lpi_br_demographics_birthdate_to_Jsonclick, 0, "AttributeDate", "", "", "", "", 1, edtavView_lpi_br_demographics_birthdate_to_Enabled, 0, "text", "", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_BR_InformationList.htm");
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?20202271272878", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("br_informationlist.js", "?20202271272878", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
