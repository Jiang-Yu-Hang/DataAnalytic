/*
       ...
       Generated on: 2/27/2020 11:57:17.24
...
namespace GeneXus.Programs {
   public class br_medicalshowupoloadimage : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202022711571730", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void RenderHtmlCloseForm6S2( )
      {
         ...
         {
            context.AddJavascriptSource("br_medicalshowupoloadimage.js", "?202022711571733", false);
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202022711571756", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("br_medicalshowupoloadimage.js", "?202022711571756", false);
         context.AddJavascriptSource("CKEditor/ckeditor/ckeditor.js", "", false);
         context.AddJavascriptSource("CKEditor/CKEditorRender.js", "", false);
