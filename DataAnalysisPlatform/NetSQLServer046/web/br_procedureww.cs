/*
       ...
       Generated on: 2/27/2020 12:0:12.43
...
namespace GeneXus.Programs {
   public class br_procedureww : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20202271201290", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void WB3O0( )
      {
         ...
         if ( wbEnd == 28 )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtavTfbr_procedure_date_Internalname, context.localUtil.Format(AV83TFBR_Procedure_Date, "9999/99/99"), context.localUtil.Format( AV83TFBR_Procedure_Date, "9999/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'YMD',0,24,'chs',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,77);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavTfbr_procedure_date_Jsonclick, 0, "Attribute", "", "", "", "", edtavTfbr_procedure_date_Visible, 1, 0, "text", "", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_BR_ProcedureWW.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtavTfbr_procedure_date_to_Internalname, context.localUtil.Format(AV84TFBR_Procedure_Date_To, "9999/99/99"), context.localUtil.Format( AV84TFBR_Procedure_Date_To, "9999/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'YMD',0,24,'chs',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,78);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavTfbr_procedure_date_to_Jsonclick, 0, "Attribute", "", "", "", "", edtavTfbr_procedure_date_to_Visible, 1, 0, "text", "", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_BR_ProcedureWW.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtavDdo_br_procedure_dateauxdate_Internalname, context.localUtil.Format(AV85DDO_BR_Procedure_DateAuxDate, "9999/99/99"), context.localUtil.Format( AV85DDO_BR_Procedure_DateAuxDate, "9999/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'YMD',0,24,'chs',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,80);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavDdo_br_procedure_dateauxdate_Jsonclick, 0, "Attribute", "", "", "", "", 1, 1, 0, "text", "", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_BR_ProcedureWW.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtavDdo_br_procedure_dateauxdateto_Internalname, context.localUtil.Format(AV86DDO_BR_Procedure_DateAuxDateTo, "9999/99/99"), context.localUtil.Format( AV86DDO_BR_Procedure_DateAuxDateTo, "9999/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'YMD',0,24,'chs',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,81);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavDdo_br_procedure_dateauxdateto_Jsonclick, 0, "Attribute", "", "", "", "", 1, 1, 0, "text", "", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_BR_ProcedureWW.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtavTfbr_procedure_radiodate_to_Internalname, context.localUtil.Format(AV94TFBR_Procedure_RadioDate_To, "9999/99/99"), context.localUtil.Format( AV94TFBR_Procedure_RadioDate_To, "9999/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'YMD',0,24,'chs',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,83);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavTfbr_procedure_radiodate_to_Jsonclick, 0, "Attribute", "", "", "", "", edtavTfbr_procedure_radiodate_to_Visible, 1, 0, "text", "", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_BR_ProcedureWW.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtavDdo_br_procedure_radiodateauxdate_Internalname, context.localUtil.Format(AV95DDO_BR_Procedure_RadioDateAuxDate, "9999/99/99"), context.localUtil.Format( AV95DDO_BR_Procedure_RadioDateAuxDate, "9999/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'YMD',0,24,'chs',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,85);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavDdo_br_procedure_radiodateauxdate_Jsonclick, 0, "Attribute", "", "", "", "", 1, 1, 0, "text", "", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_BR_ProcedureWW.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtavDdo_br_procedure_radiodateauxdateto_Internalname, context.localUtil.Format(AV96DDO_BR_Procedure_RadioDateAuxDateTo, "9999/99/99"), context.localUtil.Format( AV96DDO_BR_Procedure_RadioDateAuxDateTo, "9999/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'YMD',0,24,'chs',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,86);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavDdo_br_procedure_radiodateauxdateto_Jsonclick, 0, "Attribute", "", "", "", "", 1, 1, 0, "text", "", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_BR_ProcedureWW.htm");
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?20202271203697", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("br_procedureww.js", "?20202271203697", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
