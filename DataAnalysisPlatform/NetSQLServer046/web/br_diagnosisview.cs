/*
               File: BR_DiagnosisView
        Description: BR_Diagnosis View
             Author: GeneXus C# Generator version 16_0_0-127771
       Generated on: 2/27/2020 11:59:8.39
...
namespace GeneXus.Programs {
   public class br_diagnosisview : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public br_diagnosisview( )
      {
      ...
      public br_diagnosisview( IGxContext context )
      {
      ...
      public void execute( long aP0_BR_DiagnosisID ,
                           String aP1_TabCode )
      {
         this.AV10BR_DiagnosisID = aP0_BR_DiagnosisID;
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV10BR_DiagnosisID = (long)(NumberUtil.Val( gxfirstwebparm, "."));
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV10BR_DiagnosisID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV10BR_DiagnosisID), 18, 0)));
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "gxhash_vBR_DIAGNOSISID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10BR_DiagnosisID), "ZZZZZZZZZZZZZZZZZZ"), context));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20202271159841", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("br_diagnosisview.aspx") + "?" + UrlEncode("" +AV10BR_DiagnosisID) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode))+"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vBR_DIAGNOSISID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10BR_DiagnosisID), 18, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vBR_DIAGNOSISID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10BR_DiagnosisID), "ZZZZZZZZZZZZZZZZZZ"), context));
      ...
      {
         return formatLink("br_diagnosisview.aspx") + "?" + UrlEncode("" +AV10BR_DiagnosisID) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode)) ;
      }

      public override String GetPgmname( )
      {
         return "BR_DiagnosisView" ;
      }

      public override String GetPgmdesc( )
      {
         return "BR_Diagnosis View" ;
      }
      ...
      protected void WB3F0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnreturn_Internalname, "", "返回", bttBtnreturn_Jsonclick, 5, "返回", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DORETURN\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_BR_DiagnosisView.htm");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTxttabtitle_Internalname, lblTxttabtitle_Caption, "", "", lblTxttabtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockTitleWWPTab", 0, "", 1, 1, 0, "HLP_BR_DiagnosisView.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "诊断信息", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, "HLP_BR_DiagnosisView.htm");
            /* Div Control */
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtngeneral_Internalname, "", "诊断信息", bttBtngeneral_Jsonclick, 7, "诊断信息", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e113f1_client"+"'", TempTags, "", 2, "HLP_BR_DiagnosisView.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START3F2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "BR_Diagnosis View", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void STRUP3F0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            /* Read saved values. */
            AV10BR_DiagnosisID = (long)(context.localUtil.CToN( cgiGet( "vBR_DIAGNOSISID"), ".", ","));
      ...
      protected void E123F2( )
      {
         ...
         AV16GXLvl9 = 0;
         /* Using cursor H003F2 */
         pr_default.execute(0, new Object[] {AV10BR_DiagnosisID});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A64BR_DiagnosisID = H003F2_A64BR_DiagnosisID[0];
            AV16GXLvl9 = 1;
      ...
      protected void S112( )
      {
         ...
         {
            /* Object Property */
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "BR_DiagnosisGeneral")) != 0 )
            {
               WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "br_diagnosisgeneral", new Object[] {context} );
               WebComp_Generalwc.ComponentInit();
               WebComp_Generalwc.Name = "BR_DiagnosisGeneral";
               WebComp_Generalwc_Component = "BR_DiagnosisGeneral";
            }
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               WebComp_Generalwc.setjustcreated();
               WebComp_Generalwc.componentprepare(new Object[] {(String)"W0026",(String)"",(long)AV10BR_DiagnosisID});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV10BR_DiagnosisID = Convert.ToInt64(getParm(obj,0));
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV10BR_DiagnosisID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV10BR_DiagnosisID), 18, 0)));
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "gxhash_vBR_DIAGNOSISID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10BR_DiagnosisID), "ZZZZZZZZZZZZZZZZZZ"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?20202271159876", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("br_diagnosisview.js", "?20202271159876", false);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "BR_Diagnosis View";
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV10BR_DiagnosisID',fld:'vBR_DIAGNOSISID',pic:'ZZZZZZZZZZZZZZZZZZ',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("'DORETURN'","{handler:'E143F2',iparms:[]");
         setEventMetadata("'DORETURN'",",oparms:[]}");
         setEventMetadata("'GENERAL'","{handler:'E113F1',iparms:[{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV10BR_DiagnosisID',fld:'vBR_DIAGNOSISID',pic:'ZZZZZZZZZZZZZZZZZZ',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H003F2_A64BR_DiagnosisID = new long[1] ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.br_diagnosisview__default(),
            new Object[][] {
                new Object[] {
               H003F2_A64BR_DiagnosisID
               }
            }
         );
      ...
      private int idxLst ;
      private long AV10BR_DiagnosisID ;
      private long wcpOAV10BR_DiagnosisID ;
      ...
      private long[] H003F2_A64BR_DiagnosisID ;
   ...
   public class br_diagnosisview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@AV10BR_DiagnosisID",SqlDbType.Decimal,18,0}
          } ;
          def= new CursorDef[] {
              new CursorDef("H003F2", "SELECT [BR_DiagnosisID] FROM [BR_Diagnosis] WITH (NOLOCK) WHERE [BR_DiagnosisID] = @AV10BR_DiagnosisID ORDER BY [BR_DiagnosisID] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH003F2,1,0,false,true )
          };
       }
    }
