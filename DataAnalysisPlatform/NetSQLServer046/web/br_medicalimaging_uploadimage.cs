/*
               File: BR_MedicalImaging_UploadImage
        Description: BR_Medical Imaging_Upload Image
             Author: GeneXus C# Generator version 16_0_0-127771
       Generated on: 2/27/2020 11:57:17.37
...
namespace GeneXus.Programs {
   public class br_medicalimaging_uploadimage : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      public br_medicalimaging_uploadimage( )
      {
      ...
      public br_medicalimaging_uploadimage( IGxContext context )
      {
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV20Pgmname = "BR_MedicalImaging_UploadImage";
               context.Gx_err = 0;
               WS6R2( ) ;
               if ( ! isAjaxCallMode( ) )
               {
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "BR_Medical Imaging_Upload Image") ;
         ...
         context.AddJavascriptSource("gxcfg.js", "?202022711571741", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.skipLines(1);
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("br_medicalimaging_uploadimage.aspx") + "?" + UrlEncode("" +A225BR_MedicalImagingID)+"\">") ;
      ...
      protected void RenderHtmlCloseForm6R2( )
      {
         ...
         {
            context.AddJavascriptSource("br_medicalimaging_uploadimage.js", "?202022711571758", false);
         }
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            include_jscripts( ) ;
            if ( ! ( WebComp_Fckeditor == null ) )
            {
               WebComp_Fckeditor.componentjscripts();
            }
      ...
      {
         return "BR_MedicalImaging_UploadImage" ;
      }

      public override String GetPgmdesc( )
      {
         return "BR_Medical Imaging_Upload Image" ;
      }
      ...
      protected void WB6R0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "br_medicalimaging_uploadimage.aspx");
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
               context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false);
            }
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtngenerateqrcode_Internalname, "", "生成手机上传二维码", bttBtngenerateqrcode_Jsonclick, 5, "生成手机上传二维码", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOGENERATEQRCODE\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_BR_MedicalImaging_UploadImage.htm");
            ...
            ClassString = "ButtonColor";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnloadimage_Internalname, "", "读取上传图片", bttBtnloadimage_Jsonclick, 5, "读取上传图片", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOLOADIMAGE\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_BR_MedicalImaging_UploadImage.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, sPrefix+"W0030"+"", StringUtil.RTrim( WebComp_Fckeditor_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
               context.WriteHtmlText( " id=\""+sPrefix+"gxHTMLWrpW0030"+""+"\""+"") ;
               context.WriteHtmlText( ">") ;
               if ( StringUtil.Len( WebComp_Fckeditor_Component) != 0 )
               {
                  if ( StringUtil.StrCmp(StringUtil.Lower( OldFckeditor), StringUtil.Lower( WebComp_Fckeditor_Component)) != 0 )
                  {
                     context.httpAjaxContext.ajax_rspStartCmp(sPrefix+"gxHTMLWrpW0030"+"");
                  }
                  WebComp_Fckeditor.componentdraw();
                  if ( StringUtil.StrCmp(StringUtil.Lower( OldFckeditor), StringUtil.Lower( WebComp_Fckeditor_Component)) != 0 )
                  {
                     context.httpAjaxContext.ajax_rspEndCmp();
                  }
      ...
      protected void START6R2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( ! context.isSpaRequest( ) )
            {
               ...
               Form.Meta.addItem("description", "BR_Medical Imaging_Upload Image", 0) ;
            }
            context.wjLoc = "";
                  ...
                  if ( StringUtil.Len( sEvt) > 0 )
                  {
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                        {
                           ...
                           else if ( StringUtil.StrCmp(sEvt, "'DOGENERATEQRCODE'") == 0 )
                           {
                              if ( ( StringUtil.Len( sPrefix) != 0 ) && ( nDoneStart == 0 ) )
                              {
                                 STRUP6R0( ) ;
                              ...
                              if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
                              {
                                 ...
                                 {
                                    dynload_actions( ) ;
                                    /* Execute user event: 'DogenerateQRCode' */
                                    E136R2 ();
                                 }
                              }
                           }
                           else if ( StringUtil.StrCmp(sEvt, "'DOLOADIMAGE'") == 0 )
                           {
                              if ( ( StringUtil.Len( sPrefix) != 0 ) && ( nDoneStart == 0 ) )
                              {
                                 STRUP6R0( ) ;
                              ...
                              if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
                              {
                                 ...
                                 {
                                    dynload_actions( ) ;
                                    /* Execute user event: 'DoloadImage' */
                                    E146R2 ();
                                 }
                              }
                           }
                     ...
                     else if ( StringUtil.StrCmp(sEvtType, "W") == 0 )
                     {
                        ...
                        if ( nCmpId == 30 )
                        {
                           OldFckeditor = cgiGet( sPrefix+"W0030");
                           if ( ( StringUtil.Len( OldFckeditor) == 0 ) || ( StringUtil.StrCmp(OldFckeditor, WebComp_Fckeditor_Component) != 0 ) )
                           {
                              WebComp_Fckeditor = getWebComponent(GetType(), "GeneXus.Programs", OldFckeditor, new Object[] {context} );
                              WebComp_Fckeditor.ComponentInit();
                              WebComp_Fckeditor.Name = "OldFckeditor";
                              WebComp_Fckeditor_Component = OldFckeditor;
                           }
                           if ( StringUtil.Len( WebComp_Fckeditor_Component) != 0 )
                           {
                              WebComp_Fckeditor.componentprocess(sPrefix+"W0030", "", sEvt);
                           }
                           WebComp_Fckeditor_Component = OldFckeditor;
                        }
                     }
      ...
      protected void RF6R2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            if ( 1 != 0 )
            {
               if ( StringUtil.Len( WebComp_Fckeditor_Component) != 0 )
               {
                  WebComp_Fckeditor.componentstart();
               }
            }
         }
      ...
      protected void E116R2( )
      {
         ...
         /* Object Property */
         if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Fckeditor_Component), StringUtil.Lower( "BR_MedicalShowUpoloadImage")) != 0 )
         {
            WebComp_Fckeditor = getWebComponent(GetType(), "GeneXus.Programs", "br_medicalshowupoloadimage", new Object[] {context} );
            WebComp_Fckeditor.ComponentInit();
            WebComp_Fckeditor.Name = "BR_MedicalShowUpoloadImage";
            WebComp_Fckeditor_Component = "BR_MedicalShowUpoloadImage";
         }
         if ( StringUtil.Len( WebComp_Fckeditor_Component) != 0 )
         {
            WebComp_Fckeditor.setjustcreated();
            WebComp_Fckeditor.componentprepare(new Object[] {(String)sPrefix+"W0030",(String)"",(long)A225BR_MedicalImagingID});
            WebComp_Fckeditor.componentbind(new Object[] {(String)""});
         }
         AV13tEncounterType = StringUtil.Trim( AV14WebSession.Get("Br_EncounterType"));
         if ( StringUtil.StrCmp(AV13tEncounterType, "check") == 0 )
         {
      ...
      {
         /* 'DogenerateQRCode' Routine */
         new zutil_checksession(context ).execute( out  AV16tCheckFlag) ;
         if ( ! AV16tCheckFlag )
         {
            context.PopUp(formatLink("br_medicalqrcode.aspx") + "?" + UrlEncode("" +A225BR_MedicalImagingID), new Object[] {});
         }
      }
      ...
      protected void E146R2( )
      {
         ...
         if ( ! AV16tCheckFlag )
         {
            CallWebObject(formatLink("br_medicalimagingview.aspx") + "?" + UrlEncode("" +A225BR_MedicalImagingID) + "," + UrlEncode(StringUtil.RTrim("medicalImage")));
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "br_medicalimaging_uploadimage", GetJustCreated( ));
      ...
      protected void define_styles( )
      {
         ...
         if ( ! ( WebComp_Fckeditor == null ) )
         {
            if ( StringUtil.Len( WebComp_Fckeditor_Component) != 0 )
            {
               WebComp_Fckeditor.componentthemes();
            }
         }
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202022711571827", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("br_medicalimaging_uploadimage.js", "?202022711571828", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false);
      ...
      {
         bttBtngenerateqrcode_Internalname = sPrefix+"BTNGENERATEQRCODE";
         bttBtnloadimage_Internalname = sPrefix+"BTNLOADIMAGE";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'DOGENERATEQRCODE'","{handler:'E136R2',iparms:[{av:'A225BR_MedicalImagingID',fld:'BR_MEDICALIMAGINGID',pic:'ZZZZZZZZZZZZZZZZZZ'}]");
         setEventMetadata("'DOGENERATEQRCODE'",",oparms:[]}");
         setEventMetadata("'DOLOADIMAGE'","{handler:'E146R2',iparms:[{av:'A225BR_MedicalImagingID',fld:'BR_MEDICALIMAGINGID',pic:'ZZZZZZZZZZZZZZZZZZ'}]");
         setEventMetadata("'DOLOADIMAGE'",",oparms:[]}");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         ClassString = "";
         StyleString = "";
         bttBtngenerateqrcode_Jsonclick = "";
         bttBtnloadimage_Jsonclick = "";
         WebComp_Fckeditor_Component = "";
         OldFckeditor = "";
         Form = new GXWebForm();
         sXEvt = "";
         sEvt = "";
         ...
         sEvtType = "";
         scmdbuf = "";
         H006R2_A225BR_MedicalImagingID = new long[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.br_medicalimaging_uploadimage__default(),
            new Object[][] {
                new Object[] {
               H006R2_A225BR_MedicalImagingID
               }
            }
         );
         WebComp_Fckeditor = new GeneXus.Http.GXNullWebComponent();
         AV20Pgmname = "BR_MedicalImaging_UploadImage";
         /* GeneXus formulas. */
         AV20Pgmname = "BR_MedicalImaging_UploadImage";
         context.Gx_err = 0;
      ...
      private String bttBtngenerateqrcode_Internalname ;
      private String bttBtngenerateqrcode_Jsonclick ;
      private String bttBtnloadimage_Internalname ;
      private String bttBtnloadimage_Jsonclick ;
      private String divUnnamedtable2_Internalname ;
      private String WebComp_Fckeditor_Component ;
      private String OldFckeditor ;
      ...
      private String AV13tEncounterType ;
      private IGxSession AV14WebSession ;
      private GXWebComponent WebComp_Fckeditor ;
      private GXUserControl ucDvpanel_tableheader ;
      private GXWebForm Form ;
      private IGxDataStore dsDataStore1 ;
      private IGxDataStore dsDefault ;
      private IDataStoreProvider pr_default ;
      private long[] H006R2_A225BR_MedicalImagingID ;
   ...
   public class br_medicalimaging_uploadimage__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H006R2", "SELECT [BR_MedicalImagingID] FROM [BR_MedicalImaging] WITH (NOLOCK) WHERE [BR_MedicalImagingID] = @BR_MedicalImagingID ORDER BY [BR_MedicalImagingID] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH006R2,1,0,true,true )
          };
       }
    }
