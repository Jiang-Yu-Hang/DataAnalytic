/*
       ...
       Generated on: 2/27/2020 11:53:59.48
   ...
   public class br_encountercheckvitalwc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV64Pgmname = "BR_EncounterCheckVitalWC";
               context.Gx_err = 0;
               WS612( ) ;
               if ( ! isAjaxCallMode( ) )
               {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202022711535976", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"vPGMNAME", StringUtil.RTrim( AV64Pgmname));
      ...
      protected void RenderHtmlCloseForm612( )
      {
         ...
         {
            context.AddJavascriptSource("br_encountercheckvitalwc.js", "?20202271154278", false);
         }
      ...
      protected void WB610( )
      {
         ...
         if ( wbEnd == 12 )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtavTfbr_vital_measuredate_Internalname, context.localUtil.Format(AV22TFBR_Vital_MeasureDate, "9999/99/99"), context.localUtil.Format( AV22TFBR_Vital_MeasureDate, "9999/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'YMD',0,24,'chs',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,39);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavTfbr_vital_measuredate_Jsonclick, 0, "Attribute", "", "", "", "", edtavTfbr_vital_measuredate_Visible, 1, 0, "text", "", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_BR_EncounterCheckVitalWC.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtavTfbr_vital_measuredate_to_Internalname, context.localUtil.Format(AV23TFBR_Vital_MeasureDate_To, "9999/99/99"), context.localUtil.Format( AV23TFBR_Vital_MeasureDate_To, "9999/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'YMD',0,24,'chs',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,40);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavTfbr_vital_measuredate_to_Jsonclick, 0, "Attribute", "", "", "", "", edtavTfbr_vital_measuredate_to_Visible, 1, 0, "text", "", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_BR_EncounterCheckVitalWC.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtavDdo_br_vital_measuredateauxdate_Internalname, context.localUtil.Format(AV24DDO_BR_Vital_MeasureDateAuxDate, "9999/99/99"), context.localUtil.Format( AV24DDO_BR_Vital_MeasureDateAuxDate, "9999/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'YMD',0,24,'chs',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,42);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavDdo_br_vital_measuredateauxdate_Jsonclick, 0, "Attribute", "", "", "", "", 1, 1, 0, "text", "", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_BR_EncounterCheckVitalWC.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtavDdo_br_vital_measuredateauxdateto_Internalname, context.localUtil.Format(AV25DDO_BR_Vital_MeasureDateAuxDateTo, "9999/99/99"), context.localUtil.Format( AV25DDO_BR_Vital_MeasureDateAuxDateTo, "9999/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'YMD',0,24,'chs',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,43);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavDdo_br_vital_measuredateauxdateto_Jsonclick, 0, "Attribute", "", "", "", "", 1, 1, 0, "text", "", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_BR_EncounterCheckVitalWC.htm");
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtavDisplay_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV57Display)) ? AV63Display_GXI : context.convertURL( context.PathToRelativeUrl( AV57Display))), !bGXsfl_12_Refreshing);
      ...
      private void E19612( )
      {
         ...
         AV63Display_GXI = GXDbFile.PathToUrl( context.GetImagePath( "f11923b6-6acd-4a79-bfc0-0cfc6f3bced5", "", context.GetTheme( )));
      ...
      protected void S122( )
      {
         ...
         {
            AV12GridState.FromXml(new GeneXus.Programs.wwpbaseobjects.loadgridstate(context).executeUdp(  AV64Pgmname+"GridState"), null, "WWPGridState", "DataAnalysisPlatform");
         }
         else
         {
            AV12GridState.FromXml(AV16Session.Get(AV64Pgmname+"GridState"), null, "WWPGridState", "DataAnalysisPlatform");
         }
         ...
         AV65GXV1 = 1;
         while ( AV65GXV1 <= AV12GridState.gxTpr_Filtervalues.Count )
         {
            AV13GridStateFilterValue = ((GeneXus.Programs.wwpbaseobjects.SdtWWPGridState_FilterValue)AV12GridState.gxTpr_Filtervalues.Item(AV65GXV1));
      ...
      protected void S152( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.savegridstate(context ).execute(  AV64Pgmname+"GridState",  AV12GridState.ToXml(false, true, "WWPGridState", "DataAnalysisPlatform")) ;
      }
      ...
      protected void S112( )
      {
         ...
         AV10TrnContext.gxTpr_Callerobject = AV64Pgmname;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202022711541593", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("br_encountercheckvitalwc.js", "?202022711541594", false);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
      ...
      protected void sendrow_122( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_12_idx <= subGrid_Recordsperpage( ) * 1 ) )
         {
            ...
            StyleString = "";
            AV57Display_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV57Display))&&String.IsNullOrEmpty(StringUtil.RTrim( AV63Display_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV57Display)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV57Display)) ? AV63Display_GXI : context.PathToRelativeUrl( AV57Display));
      ...
      private String AV63Display_GXI ;
