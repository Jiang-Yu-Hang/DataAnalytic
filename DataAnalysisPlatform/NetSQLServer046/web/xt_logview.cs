/*
               File: XT_LogView
        Description: XT_Log View
             Author: GeneXus C# Generator version 16_0_0-127771
       Generated on: 2/27/2020 12:1:19.56
...
namespace GeneXus.Programs {
   public class xt_logview : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public xt_logview( )
      {
      ...
      public xt_logview( IGxContext context )
      {
      ...
      public void execute( long aP0_XT_LogID ,
                           String aP1_TabCode )
      {
         this.AV10XT_LogID = aP0_XT_LogID;
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV10XT_LogID = (long)(NumberUtil.Val( gxfirstwebparm, "."));
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV10XT_LogID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV10XT_LogID), 18, 0)));
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "gxhash_vXT_LOGID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10XT_LogID), "ZZZZZZZZZZZZZZZZZZ"), context));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20202271211958", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("xt_logview.aspx") + "?" + UrlEncode("" +AV10XT_LogID) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode))+"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vXT_LOGID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10XT_LogID), 18, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vXT_LOGID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10XT_LogID), "ZZZZZZZZZZZZZZZZZZ"), context));
      ...
      {
         return formatLink("xt_logview.aspx") + "?" + UrlEncode("" +AV10XT_LogID) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode)) ;
      }
      ...
      protected void WB4F0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnreturn_Internalname, "", "返回", bttBtnreturn_Jsonclick, 7, "返回", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e114f1_client"+"'", TempTags, "", 2, "HLP_XT_LogView.htm");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTxttabtitle_Internalname, lblTxttabtitle_Caption, "", "", lblTxttabtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockTitleWWPTab", 0, "", 1, 1, 0, "HLP_XT_LogView.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "日志信息", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, "HLP_XT_LogView.htm");
            /* Div Control */
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtngeneral_Internalname, "", "日志信息", bttBtngeneral_Jsonclick, 7, "日志信息", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e124f1_client"+"'", TempTags, "", 2, "HLP_XT_LogView.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START4F2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "XT_Log View", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void STRUP4F0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            /* Read saved values. */
            AV10XT_LogID = (long)(context.localUtil.CToN( cgiGet( "vXT_LOGID"), ".", ","));
      ...
      protected void E134F2( )
      {
         ...
         AV16GXLvl9 = 0;
         /* Using cursor H004F2 */
         pr_default.execute(0, new Object[] {AV10XT_LogID});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A173XT_LogID = H004F2_A173XT_LogID[0];
            A214XT_LogUserID = H004F2_A214XT_LogUserID[0];
            n214XT_LogUserID = H004F2_n214XT_LogUserID[0];
            AV16GXLvl9 = 1;
            Form.Caption = StringUtil.Str( (decimal)(A214XT_LogUserID), 18, 0);
      ...
      protected void S112( )
      {
         ...
         {
            /* Object Property */
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "XT_LogGeneral")) != 0 )
            {
               WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "xt_loggeneral", new Object[] {context} );
               WebComp_Generalwc.ComponentInit();
               WebComp_Generalwc.Name = "XT_LogGeneral";
               WebComp_Generalwc_Component = "XT_LogGeneral";
            }
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               WebComp_Generalwc.setjustcreated();
               WebComp_Generalwc.componentprepare(new Object[] {(String)"W0026",(String)"",(long)AV10XT_LogID});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV10XT_LogID = Convert.ToInt64(getParm(obj,0));
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV10XT_LogID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV10XT_LogID), 18, 0)));
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "gxhash_vXT_LOGID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10XT_LogID), "ZZZZZZZZZZZZZZZZZZ"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?20202271211994", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("xt_logview.js", "?20202271211995", false);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV10XT_LogID',fld:'vXT_LOGID',pic:'ZZZZZZZZZZZZZZZZZZ',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("'DORETURN'","{handler:'E114F1',iparms:[]");
         setEventMetadata("'DORETURN'",",oparms:[]}");
         setEventMetadata("'GENERAL'","{handler:'E124F1',iparms:[{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV10XT_LogID',fld:'vXT_LOGID',pic:'ZZZZZZZZZZZZZZZZZZ',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H004F2_A173XT_LogID = new long[1] ;
         H004F2_A214XT_LogUserID = new long[1] ;
         H004F2_n214XT_LogUserID = new bool[] {false} ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.xt_logview__default(),
            new Object[][] {
                new Object[] {
               H004F2_A173XT_LogID, H004F2_A214XT_LogUserID, H004F2_n214XT_LogUserID
               }
            }
         );
      ...
      private int idxLst ;
      private long AV10XT_LogID ;
      private long wcpOAV10XT_LogID ;
      ...
      private long[] H004F2_A173XT_LogID ;
      private long[] H004F2_A214XT_LogUserID ;
      private bool[] H004F2_n214XT_LogUserID ;
   ...
   public class xt_logview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@AV10XT_LogID",SqlDbType.Decimal,18,0}
          } ;
          def= new CursorDef[] {
              new CursorDef("H004F2", "SELECT [XT_LogID], [XT_LogUserID] FROM [XT_Log] WITH (NOLOCK) WHERE [XT_LogID] = @AV10XT_LogID ORDER BY [XT_LogID] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH004F2,1,0,false,true )
          };
       }
    }
