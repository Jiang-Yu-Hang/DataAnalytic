/*!   GeneXus C# 16_0_0-127771 on 2/27/2020 12:7:4.78
*/
gx.evt.autoSkip = false;
gx.define('br_pathology_otherinsert', false, function () {
   this.ServerClass =  "br_pathology_otherinsert" ;
   ...
   this.SetStandaloneVars=function()
   {
      ...
      this.AV17BR_PathologyID=gx.fn.getIntegerValue("vBR_PATHOLOGYID",',') ;
   };
   ...
   GXValidFnc[29]={ id:29 ,lvl:0,type:"svchar",len:100,dec:0,sign:false,ro:0,grid:0,gxgrid:null,fnc:null,isvalid:null,evt_cvc:'e17951_client',evt_cvcing:null,rgrid:[],fld:"vZLNAME",gxz:"ZV11zlName",gxold:"OV11zlName",gxvar:"AV11zlName",ucs:[],op:[],ip:[],
   ...
   GXValidFnc[40]={ id:40 ,lvl:0,type:"decimal",len:15,dec:5,sign:false,pic:"ZZZZZZZZZ.ZZZZZ",ro:0,grid:0,gxgrid:null,fnc:null,isvalid:null,evt_cvc:null,evt_cvcing:null,rgrid:[],fld:"BR_PATHOLOGY_OTHER_BR_PATHOLOGY_OTHER_BIONUM",gxz:"ZV24GXV1",gxold:"OV24GXV1",gxvar:"GXV1",ucs:[],op:[],ip:[],
						nacdep:[],ctrltype:"edit",v2v:function(Value){if(Value!==undefined)gx.O.GXV1=gx.fn.toDecimalValue(Value,',','.')},v2z:function(Value){if(Value!==undefined)gx.O.ZV24GXV1=gx.fn.toDecimalValue(Value,',','.')},v2c:function(){gx.fn.setDecimalValue("BR_PATHOLOGY_OTHER_BR_PATHOLOGY_OTHER_BIONUM",gx.O.GXV1,5,'.')},c2v:function(){if(this.val()!==undefined)gx.O.GXV1=this.val()},val:function(){return gx.fn.getDecimalValue("BR_PATHOLOGY_OTHER_BR_PATHOLOGY_OTHER_BIONUM",',','.')},nac:gx.falseFn};
   ...
   GXValidFnc[49]={ id:49 ,lvl:0,type:"svchar",len:40,dec:0,sign:false,ro:0,grid:0,gxgrid:null,fnc:null,isvalid:null,evt_cvc:null,evt_cvcing:null,rgrid:[],fld:"BR_PATHOLOGY_OTHER_BR_PATHOLOGY_OTHER_BIONUMUNIT",gxz:"ZV25GXV2",gxold:"OV25GXV2",gxvar:"GXV2",ucs:[],op:[],ip:[],
						nacdep:[],ctrltype:"dyncombo",v2v:function(Value){if(Value!==undefined)gx.O.GXV2=Value},v2z:function(Value){if(Value!==undefined)gx.O.ZV25GXV2=Value},v2c:function(){gx.fn.setComboBoxValue("BR_PATHOLOGY_OTHER_BR_PATHOLOGY_OTHER_BIONUMUNIT",gx.O.GXV2)},c2v:function(){if(this.val()!==undefined)gx.O.GXV2=this.val()},val:function(){return gx.fn.getControlValue("BR_PATHOLOGY_OTHER_BR_PATHOLOGY_OTHER_BIONUMUNIT")},nac:gx.falseFn};
   ...
   GXValidFnc[57]={ id:57 ,lvl:0,type:"decimal",len:15,dec:5,sign:false,pic:"ZZZZZZZZZ.ZZZZZ",ro:0,grid:0,gxgrid:null,fnc:null,isvalid:null,evt_cvc:null,evt_cvcing:null,rgrid:[],fld:"BR_PATHOLOGY_OTHER_BR_PATHOLOGY_OTHER_LOW",gxz:"ZV26GXV3",gxold:"OV26GXV3",gxvar:"GXV3",ucs:[],op:[],ip:[],
						nacdep:[],ctrltype:"edit",v2v:function(Value){if(Value!==undefined)gx.O.GXV3=gx.fn.toDecimalValue(Value,',','.')},v2z:function(Value){if(Value!==undefined)gx.O.ZV26GXV3=gx.fn.toDecimalValue(Value,',','.')},v2c:function(){gx.fn.setDecimalValue("BR_PATHOLOGY_OTHER_BR_PATHOLOGY_OTHER_LOW",gx.O.GXV3,5,'.')},c2v:function(){if(this.val()!==undefined)gx.O.GXV3=this.val()},val:function(){return gx.fn.getDecimalValue("BR_PATHOLOGY_OTHER_BR_PATHOLOGY_OTHER_LOW",',','.')},nac:gx.falseFn};
   ...
   GXValidFnc[66]={ id:66 ,lvl:0,type:"decimal",len:15,dec:5,sign:false,pic:"ZZZZZZZZZ.ZZZZZ",ro:0,grid:0,gxgrid:null,fnc:null,isvalid:null,evt_cvc:null,evt_cvcing:null,rgrid:[],fld:"BR_PATHOLOGY_OTHER_BR_PATHOLOGY_OTHER_HIGH",gxz:"ZV27GXV4",gxold:"OV27GXV4",gxvar:"GXV4",ucs:[],op:[],ip:[],
						nacdep:[],ctrltype:"edit",v2v:function(Value){if(Value!==undefined)gx.O.GXV4=gx.fn.toDecimalValue(Value,',','.')},v2z:function(Value){if(Value!==undefined)gx.O.ZV27GXV4=gx.fn.toDecimalValue(Value,',','.')},v2c:function(){gx.fn.setDecimalValue("BR_PATHOLOGY_OTHER_BR_PATHOLOGY_OTHER_HIGH",gx.O.GXV4,5,'.')},c2v:function(){if(this.val()!==undefined)gx.O.GXV4=this.val()},val:function(){return gx.fn.getDecimalValue("BR_PATHOLOGY_OTHER_BR_PATHOLOGY_OTHER_HIGH",',','.')},nac:gx.falseFn};
   ...
   GXValidFnc[74]={ id:74 ,lvl:0,type:"svchar",len:40,dec:0,sign:false,ro:0,grid:0,gxgrid:null,fnc:null,isvalid:null,evt_cvc:null,evt_cvcing:null,rgrid:[],fld:"BR_PATHOLOGY_OTHER_BR_PATHOLOGY_OTHER_ABNIND",gxz:"ZV28GXV5",gxold:"OV28GXV5",gxvar:"GXV5",ucs:[],op:[],ip:[],
						nacdep:[],ctrltype:"edit",v2v:function(Value){if(Value!==undefined)gx.O.GXV5=Value},v2z:function(Value){if(Value!==undefined)gx.O.ZV28GXV5=Value},v2c:function(){gx.fn.setControlValue("BR_PATHOLOGY_OTHER_BR_PATHOLOGY_OTHER_ABNIND",gx.O.GXV5,0)},c2v:function(){if(this.val()!==undefined)gx.O.GXV5=this.val()},val:function(){return gx.fn.getControlValue("BR_PATHOLOGY_OTHER_BR_PATHOLOGY_OTHER_ABNIND")},nac:gx.falseFn};
   ...
   GXValidFnc[86]={ id:86 ,lvl:0,type:"svchar",len:100,dec:0,sign:false,ro:0,grid:0,gxgrid:null,fnc:null,isvalid:null,evt_cvc:'e16951_client',evt_cvcing:null,rgrid:[],fld:"vVNAME",gxz:"ZV13vName",gxold:"OV13vName",gxvar:"AV13vName",ucs:[],op:[],ip:[],
   ...
   GXValidFnc[102]={ id:102 ,lvl:0,type:"int",len:18,dec:0,sign:false,pic:"ZZZZZZZZZZZZZZZZZZ",ro:0,grid:0,gxgrid:null,fnc:null,isvalid:null,evt_cvc:null,evt_cvcing:null,rgrid:[],fld:"BR_PATHOLOGY_OTHER_BR_PATHOLOGY_OTHERID",gxz:"ZV29GXV6",gxold:"OV29GXV6",gxvar:"GXV6",ucs:[],op:[],ip:[],
						nacdep:[],ctrltype:"edit",v2v:function(Value){if(Value!==undefined)gx.O.GXV6=gx.num.intval(Value)},v2z:function(Value){if(Value!==undefined)gx.O.ZV29GXV6=gx.num.intval(Value)},v2c:function(){gx.fn.setControlValue("BR_PATHOLOGY_OTHER_BR_PATHOLOGY_OTHERID",gx.O.GXV6,0)},c2v:function(){if(this.val()!==undefined)gx.O.GXV6=gx.num.intval(this.val())},val:function(){return gx.fn.getIntegerValue("BR_PATHOLOGY_OTHER_BR_PATHOLOGY_OTHERID",',')},nac:gx.falseFn};
   GXValidFnc[103]={ id:103 ,lvl:0,type:"int",len:18,dec:0,sign:false,pic:"ZZZZZZZZZZZZZZZZZZ",ro:0,grid:0,gxgrid:null,fnc:null,isvalid:null,evt_cvc:null,evt_cvcing:null,rgrid:[],fld:"BR_PATHOLOGY_OTHER_BR_PATHOLOGYID",gxz:"ZV30GXV7",gxold:"OV30GXV7",gxvar:"GXV7",ucs:[],op:[],ip:[],
						nacdep:[],ctrltype:"edit",v2v:function(Value){if(Value!==undefined)gx.O.GXV7=gx.num.intval(Value)},v2z:function(Value){if(Value!==undefined)gx.O.ZV30GXV7=gx.num.intval(Value)},v2c:function(){gx.fn.setControlValue("BR_PATHOLOGY_OTHER_BR_PATHOLOGYID",gx.O.GXV7,0)},c2v:function(){if(this.val()!==undefined)gx.O.GXV7=gx.num.intval(this.val())},val:function(){return gx.fn.getIntegerValue("BR_PATHOLOGY_OTHER_BR_PATHOLOGYID",',')},nac:gx.falseFn};
   GXValidFnc[104]={ id:104 ,lvl:0,type:"svchar",len:40,dec:0,sign:false,ro:0,grid:0,gxgrid:null,fnc:null,isvalid:null,evt_cvc:null,evt_cvcing:null,rgrid:[],fld:"BR_PATHOLOGY_OTHER_BR_PATHOLOGY_OTHER_BIO",gxz:"ZV31GXV8",gxold:"OV31GXV8",gxvar:"GXV8",ucs:[],op:[],ip:[],
						nacdep:[],ctrltype:"dyncombo",v2v:function(Value){if(Value!==undefined)gx.O.GXV8=Value},v2z:function(Value){if(Value!==undefined)gx.O.ZV31GXV8=Value},v2c:function(){gx.fn.setComboBoxValue("BR_PATHOLOGY_OTHER_BR_PATHOLOGY_OTHER_BIO",gx.O.GXV8)},c2v:function(){if(this.val()!==undefined)gx.O.GXV8=this.val()},val:function(){return gx.fn.getControlValue("BR_PATHOLOGY_OTHER_BR_PATHOLOGY_OTHER_BIO")},nac:gx.falseFn};
   GXValidFnc[105]={ id:105 ,lvl:0,type:"svchar",len:40,dec:0,sign:false,ro:0,grid:0,gxgrid:null,fnc:null,isvalid:null,evt_cvc:null,evt_cvcing:null,rgrid:[],fld:"BR_PATHOLOGY_OTHER_BR_PATHOLOGY_OTHER_BIOQUAL",gxz:"ZV32GXV9",gxold:"OV32GXV9",gxvar:"GXV9",ucs:[],op:[],ip:[],
						nacdep:[],ctrltype:"dyncombo",v2v:function(Value){if(Value!==undefined)gx.O.GXV9=Value},v2z:function(Value){if(Value!==undefined)gx.O.ZV32GXV9=Value},v2c:function(){gx.fn.setComboBoxValue("BR_PATHOLOGY_OTHER_BR_PATHOLOGY_OTHER_BIOQUAL",gx.O.GXV9)},c2v:function(){if(this.val()!==undefined)gx.O.GXV9=this.val()},val:function(){return gx.fn.getControlValue("BR_PATHOLOGY_OTHER_BR_PATHOLOGY_OTHER_BIOQUAL")},nac:gx.falseFn};
   this.AV11zlName = "" ;
   this.ZV11zlName = "" ;
   this.OV11zlName = "" ;
   this.AV12bzName = "" ;
   ...
   this.EvtParms["ENTER"] = [[{ctrl:'vVNAME'},{av:'AV13vName',fld:'vVNAME',pic:''},{av:'AV14vOtherName',fld:'vVOTHERNAME',pic:''},{av:'AV10BR_Pathology_Other',fld:'vBR_PATHOLOGY_OTHER',pic:''},{ctrl:'vZLNAME'},{av:'AV11zlName',fld:'vZLNAME',pic:''},{av:'AV12bzName',fld:'vBZNAME',pic:''},{av:'AV17BR_PathologyID',fld:'vBR_PATHOLOGYID',pic:'ZZZZZZZZZZZZZZZZZZ',hsh:true}],[{av:'AV10BR_Pathology_Other',fld:'vBR_PATHOLOGY_OTHER',pic:''}]];
   this.EvtParms["LOAD"] = [[{av:'AV18BR_Pathology_OtherID',fld:'vBR_PATHOLOGY_OTHERID',pic:'ZZZZZZZZZZZZZZZZZZ'},{ctrl:'vZLNAME'},{av:'AV11zlName',fld:'vZLNAME',pic:''},{ctrl:'vVNAME'},{av:'AV13vName',fld:'vVNAME',pic:''}],[{av:'AV10BR_Pathology_Other',fld:'vBR_PATHOLOGY_OTHER',pic:''},{ctrl:'vZLNAME'},{av:'AV11zlName',fld:'vZLNAME',pic:''},{ctrl:'vVNAME'},{av:'AV13vName',fld:'vVNAME',pic:''}]];
   ...
   this.setVCMap("AV17BR_PathologyID", "vBR_PATHOLOGYID", 0, "int", 18, 0);
...
gx.createParentObj(br_pathology_otherinsert);
