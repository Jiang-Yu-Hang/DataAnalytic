/*
       ...
       Generated on: 2/27/2020 12:7:9.22
...
namespace GeneXus.Programs {
   public class br_vitalinsert : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2020227127928", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void WB9B0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtavBr_vital_br_vital_measuredate_Internalname, context.localUtil.Format(AV10BR_Vital.gxTpr_Br_vital_measuredate, "9999/99/99"), context.localUtil.Format( AV10BR_Vital.gxTpr_Br_vital_measuredate, "9999/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'YMD',0,24,'chs',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,29);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavBr_vital_br_vital_measuredate_Jsonclick, 0, "AttributeDate", "", "", "", "", 1, edtavBr_vital_br_vital_measuredate_Enabled, 0, "text", "", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_BR_VitalInsert.htm");
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?20202271271127", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("br_vitalinsert.js", "?20202271271127", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false);
