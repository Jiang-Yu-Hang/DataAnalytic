/*
               File: BR_Pathology_SpecimenView
        Description: BR_Pathology_Specimen View
             Author: GeneXus C# Generator version 16_0_0-127771
       Generated on: 2/27/2020 12:1:58.54
...
namespace GeneXus.Programs {
   public class br_pathology_specimenview : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public br_pathology_specimenview( )
      {
      ...
      public br_pathology_specimenview( IGxContext context )
      {
      ...
      public void execute( long aP0_BR_Pathology_SpecimenID ,
                           String aP1_TabCode )
      {
         this.AV10BR_Pathology_SpecimenID = aP0_BR_Pathology_SpecimenID;
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV10BR_Pathology_SpecimenID = (long)(NumberUtil.Val( gxfirstwebparm, "."));
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV10BR_Pathology_SpecimenID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV10BR_Pathology_SpecimenID), 18, 0)));
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "gxhash_vBR_PATHOLOGY_SPECIMENID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10BR_Pathology_SpecimenID), "ZZZZZZZZZZZZZZZZZZ"), context));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20202271215856", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("br_pathology_specimenview.aspx") + "?" + UrlEncode("" +AV10BR_Pathology_SpecimenID) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode))+"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vBR_PATHOLOGY_SPECIMENID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10BR_Pathology_SpecimenID), 18, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vBR_PATHOLOGY_SPECIMENID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10BR_Pathology_SpecimenID), "ZZZZZZZZZZZZZZZZZZ"), context));
      ...
      {
         return formatLink("br_pathology_specimenview.aspx") + "?" + UrlEncode("" +AV10BR_Pathology_SpecimenID) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode)) ;
      }

      public override String GetPgmname( )
      {
         return "BR_Pathology_SpecimenView" ;
      }

      public override String GetPgmdesc( )
      {
         return "BR_Pathology_Specimen View" ;
      }
      ...
      protected void WB520( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnback_Internalname, "", "返回", bttBtnback_Jsonclick, 5, "返回", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOBACK\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_BR_Pathology_SpecimenView.htm");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTxttabtitle_Internalname, lblTxttabtitle_Caption, "", "", lblTxttabtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockTitleWWPTab", 0, "", 1, 1, 0, "HLP_BR_Pathology_SpecimenView.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "病理送检组织", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, "HLP_BR_Pathology_SpecimenView.htm");
            /* Div Control */
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtngeneral_Internalname, "", "病理送检组织", bttBtngeneral_Jsonclick, 7, "病理送检组织", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e11521_client"+"'", TempTags, "", 2, "HLP_BR_Pathology_SpecimenView.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START522( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "BR_Pathology_Specimen View", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void STRUP520( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            /* Read saved values. */
            AV10BR_Pathology_SpecimenID = (long)(context.localUtil.CToN( cgiGet( "vBR_PATHOLOGY_SPECIMENID"), ".", ","));
      ...
      protected void E12522( )
      {
         ...
         AV16GXLvl9 = 0;
         /* Using cursor H00522 */
         pr_default.execute(0, new Object[] {AV10BR_Pathology_SpecimenID});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A274BR_Pathology_SpecimenID = H00522_A274BR_Pathology_SpecimenID[0];
            AV16GXLvl9 = 1;
      ...
      protected void S112( )
      {
         ...
         {
            /* Object Property */
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "BR_Pathology_SpecimenGeneral")) != 0 )
            {
               WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "br_pathology_specimengeneral", new Object[] {context} );
               WebComp_Generalwc.ComponentInit();
               WebComp_Generalwc.Name = "BR_Pathology_SpecimenGeneral";
               WebComp_Generalwc_Component = "BR_Pathology_SpecimenGeneral";
            }
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               WebComp_Generalwc.setjustcreated();
               WebComp_Generalwc.componentprepare(new Object[] {(String)"W0026",(String)"",(long)AV10BR_Pathology_SpecimenID});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV10BR_Pathology_SpecimenID = Convert.ToInt64(getParm(obj,0));
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV10BR_Pathology_SpecimenID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV10BR_Pathology_SpecimenID), 18, 0)));
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "gxhash_vBR_PATHOLOGY_SPECIMENID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10BR_Pathology_SpecimenID), "ZZZZZZZZZZZZZZZZZZ"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?20202271215891", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("br_pathology_specimenview.js", "?20202271215891", false);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "BR_Pathology_Specimen View";
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV10BR_Pathology_SpecimenID',fld:'vBR_PATHOLOGY_SPECIMENID',pic:'ZZZZZZZZZZZZZZZZZZ',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("'DOBACK'","{handler:'E14522',iparms:[]");
         setEventMetadata("'DOBACK'",",oparms:[]}");
         setEventMetadata("'GENERAL'","{handler:'E11521',iparms:[{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV10BR_Pathology_SpecimenID',fld:'vBR_PATHOLOGY_SPECIMENID',pic:'ZZZZZZZZZZZZZZZZZZ',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H00522_A274BR_Pathology_SpecimenID = new long[1] ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.br_pathology_specimenview__default(),
            new Object[][] {
                new Object[] {
               H00522_A274BR_Pathology_SpecimenID
               }
            }
         );
      ...
      private int idxLst ;
      private long AV10BR_Pathology_SpecimenID ;
      private long wcpOAV10BR_Pathology_SpecimenID ;
      ...
      private long[] H00522_A274BR_Pathology_SpecimenID ;
   ...
   public class br_pathology_specimenview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@AV10BR_Pathology_SpecimenID",SqlDbType.Decimal,18,0}
          } ;
          def= new CursorDef[] {
              new CursorDef("H00522", "SELECT [BR_Pathology_SpecimenID] FROM [BR_Pathology_Specimen] WITH (NOLOCK) WHERE [BR_Pathology_SpecimenID] = @AV10BR_Pathology_SpecimenID ORDER BY [BR_Pathology_SpecimenID] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00522,1,0,false,true )
          };
       }
    }
