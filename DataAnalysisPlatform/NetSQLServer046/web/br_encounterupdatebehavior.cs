/*
       ...
       Generated on: 2/27/2020 11:55:49.90
...
namespace GeneXus.Programs {
   public class br_encounterupdatebehavior : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202022711555019", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void RenderHtmlCloseForm2T2( )
      {
         ...
         {
            context.AddJavascriptSource("br_encounterupdatebehavior.js", "?202022711555024", false);
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202022711555312", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("br_encounterupdatebehavior.js", "?202022711555312", false);
