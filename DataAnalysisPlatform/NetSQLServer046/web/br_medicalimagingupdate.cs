/*
       ...
       Generated on: 2/27/2020 12:7:5.26
...
namespace GeneXus.Programs {
   public class br_medicalimagingupdate : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2020227127538", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void wb_table1_32_982e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtavBr_medicalimaging_br_medicalimaging_imagedate_Internalname, context.localUtil.Format(AV10BR_MedicalImaging.gxTpr_Br_medicalimaging_imagedate, "9999/99/99"), context.localUtil.Format( AV10BR_MedicalImaging.gxTpr_Br_medicalimaging_imagedate, "9999/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'YMD',0,24,'chs',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,44);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavBr_medicalimaging_br_medicalimaging_imagedate_Jsonclick, 0, "AttributeDate", "", "", "", "", 1, edtavBr_medicalimaging_br_medicalimaging_imagedate_Enabled, 0, "text", "", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_BR_MedicalImagingUpdate.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtavVmetadate_Internalname, context.localUtil.Format(AV23vMetaDate, "9999/99/99"), context.localUtil.Format( AV23vMetaDate, "9999/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'YMD',0,24,'chs',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,71);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavVmetadate_Jsonclick, 0, "AttributeDate", "", "", "", "", edtavVmetadate_Visible, edtavVmetadate_Enabled, 0, "text", "", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_BR_MedicalImagingUpdate.htm");
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?2020227127831", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("br_medicalimagingupdate.js", "?2020227127831", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false);
