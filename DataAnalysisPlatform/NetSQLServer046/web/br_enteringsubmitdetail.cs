/*
       ...
       Generated on: 2/27/2020 12:6:7.75
...
namespace GeneXus.Programs {
   public class br_enteringsubmitdetail : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202022712682", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void WB7D0( )
      {
         ...
         if ( wbEnd == 17 )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtavTfbr_encounter_refusereason_noapprovedate_Internalname, context.localUtil.TToC( AV38TFBR_Encounter_RefuseReason_NoApproveDate, 10, 8, 0, 0, "/", ":", " "), context.localUtil.Format( AV38TFBR_Encounter_RefuseReason_NoApproveDate, "9999/99/99 99:99:99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'YMD',8,24,'chs',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,48);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavTfbr_encounter_refusereason_noapprovedate_Jsonclick, 0, "Attribute", "", "", "", "", edtavTfbr_encounter_refusereason_noapprovedate_Visible, 1, 0, "text", "", 19, "chr", 1, "row", 19, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_BR_EnteringSubmitDetail.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtavTfbr_encounter_refusereason_noapprovedate_to_Internalname, context.localUtil.TToC( AV39TFBR_Encounter_RefuseReason_NoApproveDate_To, 10, 8, 0, 0, "/", ":", " "), context.localUtil.Format( AV39TFBR_Encounter_RefuseReason_NoApproveDate_To, "9999/99/99 99:99:99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'YMD',8,24,'chs',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,49);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavTfbr_encounter_refusereason_noapprovedate_to_Jsonclick, 0, "Attribute", "", "", "", "", edtavTfbr_encounter_refusereason_noapprovedate_to_Visible, 1, 0, "text", "", 19, "chr", 1, "row", 19, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_BR_EnteringSubmitDetail.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtavDdo_br_encounter_refusereason_noapprovedateauxdate_Internalname, context.localUtil.Format(AV40DDO_BR_Encounter_RefuseReason_NoApproveDateAuxDate, "9999/99/99"), context.localUtil.Format( AV40DDO_BR_Encounter_RefuseReason_NoApproveDateAuxDate, "9999/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'YMD',0,24,'chs',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,51);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavDdo_br_encounter_refusereason_noapprovedateauxdate_Jsonclick, 0, "Attribute", "", "", "", "", 1, 1, 0, "text", "", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_BR_EnteringSubmitDetail.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtavDdo_br_encounter_refusereason_noapprovedateauxdateto_Internalname, context.localUtil.Format(AV41DDO_BR_Encounter_RefuseReason_NoApproveDateAuxDateTo, "9999/99/99"), context.localUtil.Format( AV41DDO_BR_Encounter_RefuseReason_NoApproveDateAuxDateTo, "9999/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'YMD',0,24,'chs',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,52);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavDdo_br_encounter_refusereason_noapprovedateauxdateto_Jsonclick, 0, "Attribute", "", "", "", "", 1, 1, 0, "text", "", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_BR_EnteringSubmitDetail.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtavTfbr_encounter_refusereason_fapprovedate_Internalname, context.localUtil.TToC( AV54TFBR_Encounter_RefuseReason_FApproveDate, 10, 8, 0, 0, "/", ":", " "), context.localUtil.Format( AV54TFBR_Encounter_RefuseReason_FApproveDate, "9999/99/99 99:99:99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'YMD',8,24,'chs',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,55);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavTfbr_encounter_refusereason_fapprovedate_Jsonclick, 0, "Attribute", "", "", "", "", edtavTfbr_encounter_refusereason_fapprovedate_Visible, 1, 0, "text", "", 19, "chr", 1, "row", 19, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_BR_EnteringSubmitDetail.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtavDdo_br_encounter_refusereason_fapprovedateauxdate_Internalname, context.localUtil.Format(AV56DDO_BR_Encounter_RefuseReason_FApproveDateAuxDate, "9999/99/99"), context.localUtil.Format( AV56DDO_BR_Encounter_RefuseReason_FApproveDateAuxDate, "9999/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'YMD',0,24,'chs',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,58);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavDdo_br_encounter_refusereason_fapprovedateauxdate_Jsonclick, 0, "Attribute", "", "", "", "", 1, 1, 0, "text", "", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_BR_EnteringSubmitDetail.htm");
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?20202271261962", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("br_enteringsubmitdetail.js", "?20202271261962", false);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
