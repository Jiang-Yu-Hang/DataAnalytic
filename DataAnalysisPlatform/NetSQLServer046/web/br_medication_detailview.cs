/*
               File: BR_Medication_DetailView
        Description: BR_Medication_Detail View
             Author: GeneXus C# Generator version 16_0_0-127771
       Generated on: 2/27/2020 12:1:32.53
...
namespace GeneXus.Programs {
   public class br_medication_detailview : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public br_medication_detailview( )
      {
      ...
      public br_medication_detailview( IGxContext context )
      {
      ...
      public void execute( long aP0_BR_Medication_DetailID ,
                           String aP1_TabCode )
      {
         this.AV10BR_Medication_DetailID = aP0_BR_Medication_DetailID;
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV10BR_Medication_DetailID = (long)(NumberUtil.Val( gxfirstwebparm, "."));
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV10BR_Medication_DetailID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV10BR_Medication_DetailID), 18, 0)));
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "gxhash_vBR_MEDICATION_DETAILID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10BR_Medication_DetailID), "ZZZZZZZZZZZZZZZZZZ"), context));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20202271213256", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("br_medication_detailview.aspx") + "?" + UrlEncode("" +AV10BR_Medication_DetailID) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode))+"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vBR_MEDICATION_DETAILID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10BR_Medication_DetailID), 18, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vBR_MEDICATION_DETAILID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10BR_Medication_DetailID), "ZZZZZZZZZZZZZZZZZZ"), context));
      ...
      {
         return formatLink("br_medication_detailview.aspx") + "?" + UrlEncode("" +AV10BR_Medication_DetailID) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode)) ;
      }

      public override String GetPgmname( )
      {
         return "BR_Medication_DetailView" ;
      }

      public override String GetPgmdesc( )
      {
         return "BR_Medication_Detail View" ;
      }
      ...
      protected void WB4V0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnback_Internalname, "", "返回", bttBtnback_Jsonclick, 5, "返回", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOBACK\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_BR_Medication_DetailView.htm");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTxttabtitle_Internalname, lblTxttabtitle_Caption, "", "", lblTxttabtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockTitleWWPTab", 0, "", 1, 1, 0, "HLP_BR_Medication_DetailView.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "药物治疗药物详情", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, "HLP_BR_Medication_DetailView.htm");
            /* Div Control */
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtngeneral_Internalname, "", "药物治疗药物详情", bttBtngeneral_Jsonclick, 7, "药物治疗药物详情", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e114v1_client"+"'", TempTags, "", 2, "HLP_BR_Medication_DetailView.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START4V2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "BR_Medication_Detail View", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void STRUP4V0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            /* Read saved values. */
            AV10BR_Medication_DetailID = (long)(context.localUtil.CToN( cgiGet( "vBR_MEDICATION_DETAILID"), ".", ","));
      ...
      protected void E124V2( )
      {
         ...
         AV16GXLvl9 = 0;
         /* Using cursor H004V2 */
         pr_default.execute(0, new Object[] {AV10BR_Medication_DetailID});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A301BR_Medication_DetailID = H004V2_A301BR_Medication_DetailID[0];
            AV16GXLvl9 = 1;
            Form.Caption = "药物详情";
      ...
      protected void S112( )
      {
         ...
         {
            /* Object Property */
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "BR_Medication_DetailGeneral")) != 0 )
            {
               WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "br_medication_detailgeneral", new Object[] {context} );
               WebComp_Generalwc.ComponentInit();
               WebComp_Generalwc.Name = "BR_Medication_DetailGeneral";
               WebComp_Generalwc_Component = "BR_Medication_DetailGeneral";
            }
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               WebComp_Generalwc.setjustcreated();
               WebComp_Generalwc.componentprepare(new Object[] {(String)"W0026",(String)"",(long)AV10BR_Medication_DetailID});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV10BR_Medication_DetailID = Convert.ToInt64(getParm(obj,0));
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV10BR_Medication_DetailID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV10BR_Medication_DetailID), 18, 0)));
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "gxhash_vBR_MEDICATION_DETAILID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10BR_Medication_DetailID), "ZZZZZZZZZZZZZZZZZZ"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?20202271213290", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("br_medication_detailview.js", "?20202271213290", false);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "BR_Medication_Detail View";
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV10BR_Medication_DetailID',fld:'vBR_MEDICATION_DETAILID',pic:'ZZZZZZZZZZZZZZZZZZ',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("'DOBACK'","{handler:'E144V2',iparms:[]");
         setEventMetadata("'DOBACK'",",oparms:[]}");
         setEventMetadata("'GENERAL'","{handler:'E114V1',iparms:[{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV10BR_Medication_DetailID',fld:'vBR_MEDICATION_DETAILID',pic:'ZZZZZZZZZZZZZZZZZZ',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H004V2_A301BR_Medication_DetailID = new long[1] ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.br_medication_detailview__default(),
            new Object[][] {
                new Object[] {
               H004V2_A301BR_Medication_DetailID
               }
            }
         );
      ...
      private int idxLst ;
      private long AV10BR_Medication_DetailID ;
      private long wcpOAV10BR_Medication_DetailID ;
      ...
      private long[] H004V2_A301BR_Medication_DetailID ;
   ...
   public class br_medication_detailview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@AV10BR_Medication_DetailID",SqlDbType.Decimal,18,0}
          } ;
          def= new CursorDef[] {
              new CursorDef("H004V2", "SELECT [BR_Medication_DetailID] FROM [BR_Medication_Detail] WITH (NOLOCK) WHERE [BR_Medication_DetailID] = @AV10BR_Medication_DetailID ORDER BY [BR_Medication_DetailID] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH004V2,1,0,false,true )
          };
       }
    }
