/*
               File: BR_LabView
        Description: BR_Lab View
             Author: GeneXus C# Generator version 16_0_0-127771
       Generated on: 2/27/2020 11:59:36.9
...
namespace GeneXus.Programs {
   public class br_labview : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public br_labview( )
      {
      ...
      public br_labview( IGxContext context )
      {
      ...
      public void execute( long aP0_BR_LabID ,
                           String aP1_TabCode )
      {
         this.AV10BR_LabID = aP0_BR_LabID;
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV10BR_LabID = (long)(NumberUtil.Val( gxfirstwebparm, "."));
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV10BR_LabID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV10BR_LabID), 18, 0)));
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "gxhash_vBR_LABID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10BR_LabID), "ZZZZZZZZZZZZZZZZZZ"), context));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202022711593612", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("br_labview.aspx") + "?" + UrlEncode("" +AV10BR_LabID) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode))+"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vBR_LABID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10BR_LabID), 18, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vBR_LABID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10BR_LabID), "ZZZZZZZZZZZZZZZZZZ"), context));
      ...
      {
         return formatLink("br_labview.aspx") + "?" + UrlEncode("" +AV10BR_LabID) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode)) ;
      }
      ...
      protected void WB3J0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnreturn_Internalname, "", "返回", bttBtnreturn_Jsonclick, 5, "返回", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DORETURN\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_BR_LabView.htm");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTxttabtitle_Internalname, lblTxttabtitle_Caption, "", "", lblTxttabtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockTitleWWPTab", 0, "", 1, 1, 0, "HLP_BR_LabView.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "实验室检查", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, "HLP_BR_LabView.htm");
            /* Div Control */
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtngeneral_Internalname, "", "实验室检查", bttBtngeneral_Jsonclick, 7, "实验室检查", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e113j1_client"+"'", TempTags, "", 2, "HLP_BR_LabView.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START3J2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "BR_Lab View", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void STRUP3J0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            /* Read saved values. */
            AV10BR_LabID = (long)(context.localUtil.CToN( cgiGet( "vBR_LABID"), ".", ","));
      ...
      protected void E123J2( )
      {
         ...
         AV16GXLvl9 = 0;
         /* Using cursor H003J2 */
         pr_default.execute(0, new Object[] {AV10BR_LabID});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A101BR_LabID = H003J2_A101BR_LabID[0];
            AV16GXLvl9 = 1;
      ...
      protected void S112( )
      {
         ...
         {
            /* Object Property */
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "BR_LabGeneral")) != 0 )
            {
               WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "br_labgeneral", new Object[] {context} );
               WebComp_Generalwc.ComponentInit();
               WebComp_Generalwc.Name = "BR_LabGeneral";
               WebComp_Generalwc_Component = "BR_LabGeneral";
            }
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               WebComp_Generalwc.setjustcreated();
               WebComp_Generalwc.componentprepare(new Object[] {(String)"W0026",(String)"",(long)AV10BR_LabID});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV10BR_LabID = Convert.ToInt64(getParm(obj,0));
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV10BR_LabID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV10BR_LabID), 18, 0)));
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "gxhash_vBR_LABID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10BR_LabID), "ZZZZZZZZZZZZZZZZZZ"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202022711593649", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("br_labview.js", "?202022711593649", false);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV10BR_LabID',fld:'vBR_LABID',pic:'ZZZZZZZZZZZZZZZZZZ',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("'DORETURN'","{handler:'E143J2',iparms:[]");
         setEventMetadata("'DORETURN'",",oparms:[]}");
         setEventMetadata("'GENERAL'","{handler:'E113J1',iparms:[{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV10BR_LabID',fld:'vBR_LABID',pic:'ZZZZZZZZZZZZZZZZZZ',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H003J2_A101BR_LabID = new long[1] ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.br_labview__default(),
            new Object[][] {
                new Object[] {
               H003J2_A101BR_LabID
               }
      ...
      private int idxLst ;
      private long AV10BR_LabID ;
      private long wcpOAV10BR_LabID ;
      ...
      private long[] H003J2_A101BR_LabID ;
   ...
   public class br_labview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@AV10BR_LabID",SqlDbType.Decimal,18,0}
          } ;
          def= new CursorDef[] {
              new CursorDef("H003J2", "SELECT [BR_LabID] FROM [BR_Lab] WITH (NOLOCK) WHERE [BR_LabID] = @AV10BR_LabID ORDER BY [BR_LabID] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH003J2,1,0,false,true )
          };
       }
    }
