/*
       ...
       Generated on: 2/27/2020 12:4:59.1
...
namespace GeneXus.Programs {
   public class br_vitalww : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20202271245984", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void WB5Y0( )
      {
         ...
         if ( wbEnd == 31 )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtavTfbr_vital_measuredate_to_Internalname, context.localUtil.Format(AV34TFBR_Vital_MeasureDate_To, "9999/99/99"), context.localUtil.Format( AV34TFBR_Vital_MeasureDate_To, "9999/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'YMD',0,24,'chs',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,90);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavTfbr_vital_measuredate_to_Jsonclick, 0, "Attribute", "", "", "", "", edtavTfbr_vital_measuredate_to_Visible, 1, 0, "text", "", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_BR_VitalWW.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtavDdo_br_vital_measuredateauxdate_Internalname, context.localUtil.Format(AV35DDO_BR_Vital_MeasureDateAuxDate, "9999/99/99"), context.localUtil.Format( AV35DDO_BR_Vital_MeasureDateAuxDate, "9999/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'YMD',0,24,'chs',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,92);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavDdo_br_vital_measuredateauxdate_Jsonclick, 0, "Attribute", "", "", "", "", 1, 1, 0, "text", "", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_BR_VitalWW.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtavDdo_br_vital_measuredateauxdateto_Internalname, context.localUtil.Format(AV36DDO_BR_Vital_MeasureDateAuxDateTo, "9999/99/99"), context.localUtil.Format( AV36DDO_BR_Vital_MeasureDateAuxDateTo, "9999/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'YMD',0,24,'chs',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,93);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavDdo_br_vital_measuredateauxdateto_Jsonclick, 0, "Attribute", "", "", "", "", 1, 1, 0, "text", "", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_BR_VitalWW.htm");
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?20202271253836", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("br_vitalww.js", "?20202271253836", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
