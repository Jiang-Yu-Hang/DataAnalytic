/*
       ...
       Generated on: 2/27/2020 12:4:11.78
...
namespace GeneXus.Programs {
   public class br_labupdate : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20202271241189", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void WB5U0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtavBr_lab_br_lab_age_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10BR_Lab.gxTpr_Br_lab_age), 3, 0, ".", "")), ((edtavBr_lab_br_lab_age_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(AV10BR_Lab.gxTpr_Br_lab_age), "ZZZ")) : context.localUtil.Format( (decimal)(AV10BR_Lab.gxTpr_Br_lab_age), "ZZZ")), TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,34);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavBr_lab_br_lab_age_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavBr_lab_br_lab_age_Enabled, 0, "number", "1", 3, "chr", 1, "row", 3, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_BR_LabUpdate.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            ...
            wb_table1_46_5U2( true) ;
         }
         else
         {
            wb_table1_46_5U2( false) ;
         }
         return  ;
      }

      protected void wb_table1_46_5U2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavVspecimendate_Internalname, context.localUtil.TToC( AV17vSpecimenDate, 10, 8, 0, 0, "/", ":", " "), context.localUtil.Format( AV17vSpecimenDate, "9999/99/99 99:99:99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'YMD',8,24,'chs',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,57);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavVspecimendate_Jsonclick, 0, "AttributeDateTime", "", "", "", "", 1, edtavVspecimendate_Enabled, 0, "text", "", 19, "chr", 1, "row", 19, 0, 0, 0, 1, -1, 0, true, "DM_DataTime", "right", false, "HLP_BR_LabUpdate.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtavVreceivingtime_Internalname, context.localUtil.TToC( AV18vReceivingTime, 10, 8, 0, 0, "/", ":", " "), context.localUtil.Format( AV18vReceivingTime, "9999/99/99 99:99:99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'YMD',8,24,'chs',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,62);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavVreceivingtime_Jsonclick, 0, "AttributeDateTime", "", "", "", "", 1, edtavVreceivingtime_Enabled, 0, "text", "", 19, "chr", 1, "row", 19, 0, 0, 0, 1, -1, 0, true, "DM_DataTime", "right", false, "HLP_BR_LabUpdate.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtavVreporttime_Internalname, context.localUtil.TToC( AV19vReportTime, 10, 8, 0, 0, "/", ":", " "), context.localUtil.Format( AV19vReportTime, "9999/99/99 99:99:99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'YMD',8,24,'chs',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,66);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavVreporttime_Jsonclick, 0, "AttributeDateTime", "", "", "", "", 1, edtavVreporttime_Enabled, 0, "text", "", 19, "chr", 1, "row", 19, 0, 0, 0, 1, -1, 0, true, "DM_DataTime", "right", false, "HLP_BR_LabUpdate.htm");
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, dynavBr_lab_br_lab_resultqual, dynavBr_lab_br_lab_resultqual_Internalname, StringUtil.RTrim( AV10BR_Lab.gxTpr_Br_lab_resultqual), 1, dynavBr_lab_br_lab_resultqual_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "svchar", "", 1, dynavBr_lab_br_lab_resultqual.Enabled, 0, 0, 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,71);\"", "", true, "HLP_BR_LabUpdate.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtavBr_lab_br_lab_resultunit_Internalname, AV10BR_Lab.gxTpr_Br_lab_resultunit, StringUtil.RTrim( context.localUtil.Format( AV10BR_Lab.gxTpr_Br_lab_resultunit, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,76);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavBr_lab_br_lab_resultunit_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavBr_lab_br_lab_resultunit_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 1, -1, -1, true, "", "left", true, "HLP_BR_LabUpdate.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtavBr_lab_br_labid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10BR_Lab.gxTpr_Br_labid), 18, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV10BR_Lab.gxTpr_Br_labid), "ZZZZZZZZZZZZZZZZZZ")), TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,114);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavBr_lab_br_labid_Jsonclick, 0, "Attribute", "", "", "", "", edtavBr_lab_br_labid_Visible, 1, 0, "number", "1", 18, "chr", 1, "row", 18, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_BR_LabUpdate.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 115,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavBr_lab_br_encounterid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10BR_Lab.gxTpr_Br_encounterid), 18, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV10BR_Lab.gxTpr_Br_encounterid), "ZZZZZZZZZZZZZZZZZZ")), TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,115);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavBr_lab_br_encounterid_Jsonclick, 0, "Attribute", "", "", "", "", edtavBr_lab_br_encounterid_Visible, 1, 0, "number", "1", 18, "chr", 1, "row", 18, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_BR_LabUpdate.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 116,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavBr_lab_br_information_patientno_Internalname, AV10BR_Lab.gxTpr_Br_information_patientno, StringUtil.RTrim( context.localUtil.Format( AV10BR_Lab.gxTpr_Br_information_patientno, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,116);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavBr_lab_br_information_patientno_Jsonclick, 0, "Attribute", "", "", "", "", edtavBr_lab_br_information_patientno_Visible, 1, 0, "text", "", 80, "chr", 1, "row", 2000, 0, 0, 0, 1, -1, -1, true, "", "left", true, "HLP_BR_LabUpdate.htm");
            /* Single line edit */
            ...
            GxWebStd.gx_single_line_edit( context, edtavBr_lab_br_lab_testid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10BR_Lab.gxTpr_Br_lab_testid), 10, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV10BR_Lab.gxTpr_Br_lab_testid), "ZZZZZZZZZZ")), TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,118);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavBr_lab_br_lab_testid_Jsonclick, 0, "Attribute", "", "", "", "", edtavBr_lab_br_lab_testid_Visible, 1, 0, "number", "1", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_BR_LabUpdate.htm");
            /* Single line edit */
      ...
      protected void S132( )
      {
         ...
         AV42GXV19 = 1;
         while ( AV42GXV19 <= AV8Messages.Count )
         {
            AV7Message = ((SdtMessages_Message)AV8Messages.Item(AV42GXV19));
         ...
         if ( ! AV21tCheckFlag )
         {
            ...
            if ( AV15tFlag )
            {
               ...
               else
               {
                  AV16ErrorMsg = "";
                  AV44GXV21 = 1;
                  AV43GXV20 = AV10BR_Lab.GetMessages();
                  while ( AV44GXV21 <= AV43GXV20.Count )
                  {
                     AV7Message = ((SdtMessages_Message)AV43GXV20.Item(AV44GXV21));
                     AV16ErrorMsg = AV16ErrorMsg + StringUtil.Trim( AV7Message.gxTpr_Description);
                     AV44GXV21 = (int)(AV44GXV21+1);
                  }
      ...
      protected void wb_table1_46_5U2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, dynavVsource, dynavVsource_Internalname, StringUtil.RTrim( AV11vSource), 1, dynavVsource_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "svchar", "", 1, dynavVsource.Enabled, 0, 0, 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,50);\"", "", true, "HLP_BR_LabUpdate.htm");
            dynavVsource.CurrentValue = StringUtil.RTrim( AV11vSource);
            ...
            wb_table1_46_5U2e( true) ;
         }
         else
         {
            wb_table1_46_5U2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?20202271241460", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("br_labupdate.js", "?20202271241460", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false);
      ...
      public override void initialize( )
      {
         ...
         AV16ErrorMsg = "";
         AV43GXV20 = new GXBaseCollection<SdtMessages_Message>( context, "Message", "GeneXus");
         sStyleString = "";
      ...
      private GXBaseCollection<SdtMessages_Message> AV43GXV20 ;
