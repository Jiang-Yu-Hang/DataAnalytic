/*
       ...
       Generated on: 2/27/2020 11:57:31.83
   ...
   public class br_medicalimaging : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void wb_table2_93_0T30e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtBR_MedicalImaging_MetaDate_Internalname, context.localUtil.Format(A516BR_MedicalImaging_MetaDate, "9999/99/99"), context.localUtil.Format( A516BR_MedicalImaging_MetaDate, "9999/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'YMD',0,24,'chs',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,144);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtBR_MedicalImaging_MetaDate_Jsonclick, 0, "AttributeDate", "", "", "", "", edtBR_MedicalImaging_MetaDate_Visible, edtBR_MedicalImaging_MetaDate_Enabled, 0, "text", "", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, 0, true, "DM_Date", "right", false, "HLP_BR_MedicalImaging.htm");
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202022711573691", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202022711573732", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("br_medicalimaging.js", "?202022711573732", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false);
