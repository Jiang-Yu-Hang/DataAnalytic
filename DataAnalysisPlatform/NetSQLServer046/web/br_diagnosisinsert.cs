/*
       ...
       Generated on: 2/27/2020 12:6:36.33
...
namespace GeneXus.Programs {
   public class br_diagnosisinsert : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20202271263641", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void WB8N0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtavBr_diagnosis_br_information_patientno_Internalname, AV5BR_Diagnosis.gxTpr_Br_information_patientno, StringUtil.RTrim( context.localUtil.Format( AV5BR_Diagnosis.gxTpr_Br_information_patientno, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,74);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavBr_diagnosis_br_information_patientno_Jsonclick, 0, "Attribute", "", "", "", "", edtavBr_diagnosis_br_information_patientno_Visible, 1, 0, "text", "", 80, "chr", 1, "row", 2000, 0, 0, 0, 1, -1, -1, true, "", "left", true, "HLP_BR_DiagnosisInsert.htm");
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 75,'',false,'',0)\"";
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, dynavBr_diagnosis_br_diagnosis_dxtsource, dynavBr_diagnosis_br_diagnosis_dxtsource_Internalname, StringUtil.RTrim( AV5BR_Diagnosis.gxTpr_Br_diagnosis_dxtsource), 1, dynavBr_diagnosis_br_diagnosis_dxtsource_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "svchar", "", dynavBr_diagnosis_br_diagnosis_dxtsource.Visible, 1, 0, 0, 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,75);\"", "", true, "HLP_BR_DiagnosisInsert.htm");
      ...
      protected void S122( )
      {
         ...
         AV33GXV11 = 1;
         while ( AV33GXV11 <= AV11Messages.Count )
         {
            AV10Message = ((SdtMessages_Message)AV11Messages.Item(AV33GXV11));
            GX_msglist.addItem(AV10Message.gxTpr_Description);
            AV33GXV11 = (int)(AV33GXV11+1);
         }
      }
      ...
      protected void E138N2( )
      {
         ...
         if ( ! AV20tCheckFlag )
         {
            ...
            else
            {
               AV17ErrorMsg = "";
               AV35GXV13 = 1;
               AV34GXV12 = AV5BR_Diagnosis.GetMessages();
               while ( AV35GXV13 <= AV34GXV12.Count )
               {
                  AV10Message = ((SdtMessages_Message)AV34GXV12.Item(AV35GXV13));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?20202271263834", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("br_diagnosisinsert.js", "?20202271263834", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false);
      ...
      public override void initialize( )
      {
         ...
         AV17ErrorMsg = "";
         AV34GXV12 = new GXBaseCollection<SdtMessages_Message>( context, "Message", "GeneXus");
      ...
      private GXBaseCollection<SdtMessages_Message> AV34GXV12 ;
