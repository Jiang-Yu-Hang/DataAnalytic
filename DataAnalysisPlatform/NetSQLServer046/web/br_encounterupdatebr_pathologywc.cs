/*
       ...
       Generated on: 2/27/2020 11:57:41.41
   ...
   public class br_encounterupdatebr_pathologywc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
         ...
         if ( StringUtil.Len( (String)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
               {
                  ...
                  gxgrGrid_refresh( subGrid_Rows, AV14OrderedBy, AV15OrderedDsc, AV8BR_EncounterID, AV18ddo_BR_PathologyIDTitleControlIdToReplace, AV26ddo_BR_PathologyID_PAAgeTitleControlIdToReplace, AV22ddo_BR_PathologyID_PADateTitleControlIdToReplace, AV47ddo_BR_Pathology_Dia_NameTitleControlIdToReplace, AV72Pgmname, AV42IsAuthorized_Display, AV38IsAuthorized_Update, sPrefix) ;
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV72Pgmname = "BR_EncounterUpdateBR_PathologyWC";
               context.Gx_err = 0;
               WS5I2( ) ;
               if ( ! isAjaxCallMode( ) )
               {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202022711574159", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void RenderHtmlCloseForm5I2( )
      {
         ...
         {
            context.AddJavascriptSource("br_encounterupdatebr_pathologywc.js", "?202022711574350", false);
         }
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 13), "VUPDATE.CLICK") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 13), "VUPDATE.CLICK") == 0 ) )
                           {
                              ...
                              context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtavDisplay_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV41Display)) ? AV69Display_GXI : context.convertURL( context.PathToRelativeUrl( AV41Display))), !bGXsfl_28_Refreshing);
                              ...
                              context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtavUpdate_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV37Update)) ? AV70Update_GXI : context.convertURL( context.PathToRelativeUrl( AV37Update))), !bGXsfl_28_Refreshing);
                              ...
                              context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtavMydel_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV44mydel)) ? AV71Mydel_GXI : context.convertURL( context.PathToRelativeUrl( AV44mydel))), !bGXsfl_28_Refreshing);
      ...
      private void E215I2( )
      {
         ...
         AV69Display_GXI = GXDbFile.PathToUrl( context.GetImagePath( "f11923b6-6acd-4a79-bfc0-0cfc6f3bced5", "", context.GetTheme( )));
         ...
         AV70Update_GXI = GXDbFile.PathToUrl( context.GetImagePath( "7c63c2b9-483e-4035-b512-febf9186a274", "", context.GetTheme( )));
         ...
         AV71Mydel_GXI = GXDbFile.PathToUrl( context.GetImagePath( "7695fe89-52c9-4b7e-871e-0e11548f823e", "", context.GetTheme( )));
      ...
      protected void S122( )
      {
         ...
         {
            AV12GridState.FromXml(new GeneXus.Programs.wwpbaseobjects.loadgridstate(context).executeUdp(  AV72Pgmname+"GridState"), null, "WWPGridState", "DataAnalysisPlatform");
         }
         else
         {
            AV12GridState.FromXml(AV16Session.Get(AV72Pgmname+"GridState"), null, "WWPGridState", "DataAnalysisPlatform");
         }
      ...
      protected void S142( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.savegridstate(context ).execute(  AV72Pgmname+"GridState",  AV12GridState.ToXml(false, true, "WWPGridState", "DataAnalysisPlatform")) ;
      }
      ...
      protected void S112( )
      {
         ...
         AV10TrnContext.gxTpr_Callerobject = AV72Pgmname;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202022711575222", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("br_encounterupdatebr_pathologywc.js", "?202022711575223", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
      ...
      protected void sendrow_282( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_28_idx <= subGrid_Recordsperpage( ) * 1 ) )
         {
            ...
            StyleString = "";
            AV41Display_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV41Display))&&String.IsNullOrEmpty(StringUtil.RTrim( AV69Display_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV41Display)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV41Display)) ? AV69Display_GXI : context.PathToRelativeUrl( AV41Display));
            ...
            ClassString = "ActionBaseColorAttribute";
            StyleString = "";
            AV37Update_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV37Update))&&String.IsNullOrEmpty(StringUtil.RTrim( AV70Update_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV37Update)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV37Update)) ? AV70Update_GXI : context.PathToRelativeUrl( AV37Update));
            ...
            ClassString = "ActionBaseColorAttribute";
            StyleString = "";
            AV44mydel_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV44mydel))&&String.IsNullOrEmpty(StringUtil.RTrim( AV71Mydel_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV44mydel)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV44mydel)) ? AV71Mydel_GXI : context.PathToRelativeUrl( AV44mydel));
      ...
      private String AV69Display_GXI ;
      private String AV70Update_GXI ;
      private String AV71Mydel_GXI ;
