/*
       ...
       Generated on: 2/27/2020 11:56:0.70
   ...
   public class br_encounter : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void wb_table2_51_0E15e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtBR_Encounter_AdmitDate_Internalname, context.localUtil.Format(A91BR_Encounter_AdmitDate, "9999/99/99"), context.localUtil.Format( A91BR_Encounter_AdmitDate, "9999/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'YMD',0,24,'chs',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,63);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtBR_Encounter_AdmitDate_Jsonclick, 0, "AttributeDate", "", "", "", "", 1, edtBR_Encounter_AdmitDate_Enabled, 0, "text", "", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, 0, true, "DM_Date", "right", false, "HLP_BR_Encounter.htm");
      ...
      protected void wb_table3_70_0E15e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtBR_Encounter_DischargeDate_Internalname, context.localUtil.Format(A93BR_Encounter_DischargeDate, "9999/99/99"), context.localUtil.Format( A93BR_Encounter_DischargeDate, "9999/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'YMD',0,24,'chs',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,82);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtBR_Encounter_DischargeDate_Jsonclick, 0, "AttributeDate", "", "", "", "", 1, edtBR_Encounter_DischargeDate_Enabled, 0, "text", "", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, 0, true, "DM_Date", "right", false, "HLP_BR_Encounter.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtBR_Encounter_CrtDate_Internalname, context.localUtil.TToC( A182BR_Encounter_CrtDate, 10, 8, 0, 0, "/", ":", " "), context.localUtil.Format( A182BR_Encounter_CrtDate, "9999/99/99 99:99:99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'YMD',8,24,'chs',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,102);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtBR_Encounter_CrtDate_Jsonclick, 0, "Attribute", "", "", "", "", edtBR_Encounter_CrtDate_Visible, edtBR_Encounter_CrtDate_Enabled, 0, "text", "", 19, "chr", 1, "row", 19, 0, 0, 0, 1, -1, 0, true, "UpdDate", "right", false, "HLP_BR_Encounter.htm");
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20202271156865", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?20202271156978", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("br_encounter.js", "?20202271156979", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false);
