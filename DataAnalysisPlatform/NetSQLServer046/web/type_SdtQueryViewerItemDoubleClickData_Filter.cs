...
namespace GeneXus.Programs{
	...
	[XmlType(TypeName="QueryViewerItemDoubleClickData.Filter" , Namespace="DataAnalysisPlatform" )]
	[Serializable]
	...
	[DataContract(Name=@"QueryViewerItemDoubleClickData.Filter", Namespace="DataAnalysisPlatform")]
