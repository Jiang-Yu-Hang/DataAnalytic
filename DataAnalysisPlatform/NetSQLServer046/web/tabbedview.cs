/*
       ...
       Generated on: 2/27/2020 11:54:40.67
...
namespace GeneXus.Programs {
   public class tabbedview : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202022711544072", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void RenderHtmlCloseForm2Q2( )
      {
         ...
         {
            context.AddJavascriptSource("tabbedview.js", "?202022711544077", false);
         }
      ...
      protected void wb_table1_2_2Q2( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            wb_table2_11_2Q2( true) ;
         }
         else
         {
            wb_table2_11_2Q2( false) ;
         }
         return  ;
      }

      protected void wb_table2_11_2Q2e( bool wbgen )
      {
         if ( wbgen )
         {
            context.WriteHtmlText( "</td>") ;
      ...
      protected void wb_table2_11_2Q2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_11_2Q2e( true) ;
         }
         else
         {
            wb_table2_11_2Q2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202022711544112", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("tabbedview.js", "?202022711544113", false);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("HISTORYMANAGER.URLCHANGED","{handler:'E112Q2',iparms:[{av:'AV5FirstTab',fld:'vFIRSTTAB',pic:'ZZZ9'},{av:'AV11LastTab',fld:'vLASTTAB',pic:'ZZZ9'},{av:'AV18Tabs',fld:'vTABS',pic:''},{av:'AV15TabCode',fld:'vTABCODE',pic:''},{av:'Historymanager_Hash',ctrl:'HISTORYMANAGER',prop:'Hash'},{av:'AV8Index',fld:'vINDEX',pic:'ZZZ9'},{av:'AV13SelectedTab',fld:'vSELECTEDTAB',pic:'ZZZ9'},{av:'AV14Tab',fld:'vTAB',pic:''},{av:'AV19TabsMarkup',fld:'vTABSMARKUP',pic:''},{av:'AV20TabTemplate',fld:'vTABTEMPLATE',pic:'',hsh:true}]");
      ...
      {
         AV18Tabs = new GXBaseCollection<SdtTabOptions_TabOptionsItem>( context, "TabOptionsItem", "DataAnalysisPlatform");
         wcpOAV15TabCode = "";
         Historymanager_Hash = "";
         gxfirstwebparm = "";
         gxfirstwebparm_bkp = "";
