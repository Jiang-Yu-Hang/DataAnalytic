/*
       ...
       Generated on: 2/27/2020 11:53:59.12
   ...
   public class GxWebStd
   {
                                          ...
                                          bool bIsRwd )
      {
         ...
         if ( nContentType == 0 )
         {
            ...
            context.WriteHtmlTextNl( "<html lang=\"zh\""+">") ;
                                           ...
                                           String sCallerPgm )
      {
         ...
         if ( nEnabled == 0 )
         {
            ...
            {
               sEventJsCode = "gx.util.help(" + "'" + context.convertURL( "Help/"+"SimplifiedChinese/"+StringUtil.Lower( sCallerPgm)) + "');";
            }
                                            ...
                                            String sCallerPgm )
      {
         ...
         {
            sEventJsCode = "gx.util.help(" + "'" + context.convertURL( "Help/"+"SimplifiedChinese/"+StringUtil.Lower( sCallerPgm)) + "');" + "return false;";
         }
         else if ( nJScriptCode == 7 )
         {
            sEventJsCode = "" + "gx.evt.execCliEvt(" + sEventName + ",this);";
