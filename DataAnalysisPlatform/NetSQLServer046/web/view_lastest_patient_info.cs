/*
       ...
       Generated on: 2/27/2020 11:58:14.45
   ...
   public class view_lastest_patient_info : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void Draw( )
      {
         ...
         if ( ! GxWebStd.gx_redirect( context) )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtVIEW_LPI_BR_Encounter_AdmitDate_Internalname, context.localUtil.TToC( A521VIEW_LPI_BR_Encounter_AdmitDate, 10, 8, 0, 0, "/", ":", " "), context.localUtil.Format( A521VIEW_LPI_BR_Encounter_AdmitDate, "9999/99/99 99:99:99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'YMD',8,24,'chs',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,38);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtVIEW_LPI_BR_Encounter_AdmitDate_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtVIEW_LPI_BR_Encounter_AdmitDate_Enabled, 0, "text", "", 19, "chr", 1, "row", 19, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_view_lastest_patient_info.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtVIEW_LPI_BR_Demographics_BirthDate_Internalname, context.localUtil.Format(A523VIEW_LPI_BR_Demographics_BirthDate, "9999/99/99"), context.localUtil.Format( A523VIEW_LPI_BR_Demographics_BirthDate, "9999/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'YMD',0,24,'chs',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,48);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtVIEW_LPI_BR_Demographics_BirthDate_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtVIEW_LPI_BR_Demographics_BirthDate_Enabled, 0, "text", "", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_view_lastest_patient_info.htm");
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202022711581533", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202022711581538", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("view_lastest_patient_info.js", "?202022711581538", false);
