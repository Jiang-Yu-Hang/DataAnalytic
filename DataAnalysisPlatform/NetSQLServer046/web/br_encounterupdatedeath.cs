/*
       ...
       Generated on: 2/27/2020 11:55:44.8
...
namespace GeneXus.Programs {
   public class br_encounterupdatedeath : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202022711554417", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void RenderHtmlCloseForm2X2( )
      {
         ...
         {
            context.AddJavascriptSource("br_encounterupdatedeath.js", "?202022711554420", false);
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202022711554561", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("br_encounterupdatedeath.js", "?202022711554562", false);
