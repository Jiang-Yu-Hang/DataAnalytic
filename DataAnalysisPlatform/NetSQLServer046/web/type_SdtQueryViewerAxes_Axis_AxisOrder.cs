...
namespace GeneXus.Programs{
	...
	[XmlType(TypeName="QueryViewerAxes.Axis.AxisOrder" , Namespace="DataAnalysisPlatform" )]
	[Serializable]
	...
	[DataContract(Name=@"QueryViewerAxes.Axis.AxisOrder", Namespace="DataAnalysisPlatform")]
