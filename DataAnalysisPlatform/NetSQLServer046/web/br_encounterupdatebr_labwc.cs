/*
       ...
       Generated on: 2/27/2020 11:56:14.62
   ...
   public class br_encounterupdatebr_labwc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV89Pgmname = "BR_EncounterUpdateBR_LabWC";
               context.Gx_err = 0;
               WS262( ) ;
               if ( ! isAjaxCallMode( ) )
               {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202022711561487", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"vPGMNAME", StringUtil.RTrim( AV89Pgmname));
      ...
      protected void RenderHtmlCloseForm262( )
      {
         ...
         {
            context.AddJavascriptSource("br_encounterupdatebr_labwc.js", "?20202271156181", false);
         }
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 11), "VBACK.CLICK") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 13), "VDELETE.CLICK") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 11), "VBACK.CLICK") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 13), "VDELETE.CLICK") == 0 ) )
                           {
                              ...
                              context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtavDisplay_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV63Display)) ? AV86Display_GXI : context.convertURL( context.PathToRelativeUrl( AV63Display))), !bGXsfl_28_Refreshing);
                              ...
                              context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtavBack_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV80back)) ? AV87Back_GXI : context.convertURL( context.PathToRelativeUrl( AV80back))), !bGXsfl_28_Refreshing);
                              ...
                              context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtavDelete_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV61Delete)) ? AV88Delete_GXI : context.convertURL( context.PathToRelativeUrl( AV61Delete))), !bGXsfl_28_Refreshing);
      ...
      private void E21262( )
      {
         ...
         AV86Display_GXI = GXDbFile.PathToUrl( context.GetImagePath( "f11923b6-6acd-4a79-bfc0-0cfc6f3bced5", "", context.GetTheme( )));
         ...
         AV87Back_GXI = GXDbFile.PathToUrl( context.GetImagePath( "7c63c2b9-483e-4035-b512-febf9186a274", "", context.GetTheme( )));
         ...
         AV88Delete_GXI = GXDbFile.PathToUrl( context.GetImagePath( "7695fe89-52c9-4b7e-871e-0e11548f823e", "", context.GetTheme( )));
      ...
      protected void S122( )
      {
         ...
         {
            AV12GridState.FromXml(new GeneXus.Programs.wwpbaseobjects.loadgridstate(context).executeUdp(  AV89Pgmname+"GridState"), null, "WWPGridState", "DataAnalysisPlatform");
         }
         else
         {
            AV12GridState.FromXml(AV16Session.Get(AV89Pgmname+"GridState"), null, "WWPGridState", "DataAnalysisPlatform");
         }
      ...
      protected void S142( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.savegridstate(context ).execute(  AV89Pgmname+"GridState",  AV12GridState.ToXml(false, true, "WWPGridState", "DataAnalysisPlatform")) ;
      }
      ...
      protected void S112( )
      {
         ...
         AV10TrnContext.gxTpr_Callerobject = AV89Pgmname;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202022711563281", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("br_encounterupdatebr_labwc.js", "?202022711563281", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
      ...
      protected void sendrow_282( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_28_idx <= subGrid_Recordsperpage( ) * 1 ) )
         {
            ...
            StyleString = "";
            AV63Display_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV63Display))&&String.IsNullOrEmpty(StringUtil.RTrim( AV86Display_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV63Display)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV63Display)) ? AV86Display_GXI : context.PathToRelativeUrl( AV63Display));
            ...
            ClassString = "ActionBaseColorAttribute";
            StyleString = "";
            AV80back_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV80back))&&String.IsNullOrEmpty(StringUtil.RTrim( AV87Back_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV80back)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV80back)) ? AV87Back_GXI : context.PathToRelativeUrl( AV80back));
            ...
            StyleString = "";
            AV61Delete_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV61Delete))&&String.IsNullOrEmpty(StringUtil.RTrim( AV88Delete_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV61Delete)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV61Delete)) ? AV88Delete_GXI : context.PathToRelativeUrl( AV61Delete));
      ...
      private String AV87Back_GXI ;
      private String AV88Delete_GXI ;
