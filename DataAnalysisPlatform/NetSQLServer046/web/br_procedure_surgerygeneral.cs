/*
       ...
       Generated on: 2/27/2020 11:53:55.98
...
namespace GeneXus.Programs {
   public class br_procedure_surgerygeneral : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20202271153563", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void RenderHtmlCloseForm6A2( )
      {
         ...
         {
            context.AddJavascriptSource("br_procedure_surgerygeneral.js", "?20202271153565", false);
         }
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("br_procedure_surgerygeneral.js", "?202022711535649", false);
         }
