/*
       ...
       Generated on: 2/27/2020 11:55:51.74
...
namespace GeneXus.Programs {
   public class br_encounterupdatedemographics : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
         ...
         if ( StringUtil.Len( (String)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxCallCrl"+"_"+"vVINSURANCE") == 0 )
               {
                  ...
                  GXDLVvVINSURANCE2K2( AV21tCurrentCode) ;
                  return  ;
               }
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20202271155520", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"vBR_DEMOGRAPHICS_Br_demographics_insurance", AV13BR_Demographics.gxTpr_Br_demographics_insurance);
      }
      ...
      protected void RenderHtmlCloseForm2K2( )
      {
         ...
         {
            context.AddJavascriptSource("br_encounterupdatedemographics.js", "?20202271155524", false);
         }
      ...
      protected void WB2K0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtavBr_demographics_br_demographics_birthdate_Internalname, context.localUtil.Format(AV13BR_Demographics.gxTpr_Br_demographics_birthdate, "9999/99/99"), context.localUtil.Format( AV13BR_Demographics.gxTpr_Br_demographics_birthdate, "9999/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'YMD',0,24,'chs',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,18);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavBr_demographics_br_demographics_birthdate_Jsonclick, 0, "AttributeDate", "", "", "", "", 1, edtavBr_demographics_br_demographics_birthdate_Enabled, 0, "text", "", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_BR_EncounterUpdateDemographics.htm");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockvinsurance_Internalname, "保险", "", "", lblTextblockvinsurance_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, "HLP_BR_EncounterUpdateDemographics.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-9", "left", "top", "", "", "div");
            wb_table1_53_2K2( true) ;
         }
         else
         {
            wb_table1_53_2K2( false) ;
         }
         return  ;
      }

      protected void wb_table1_53_2K2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavBr_demographics_br_demographics_id_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV13BR_Demographics.gxTpr_Br_demographics_id), 18, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV13BR_Demographics.gxTpr_Br_demographics_id), "ZZZZZZZZZZZZZZZZZZ")), TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,70);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavBr_demographics_br_demographics_id_Jsonclick, 0, "Attribute", "", "", "", "", edtavBr_demographics_br_demographics_id_Visible, 1, 0, "number", "1", 18, "chr", 1, "row", 18, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_BR_EncounterUpdateDemographics.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 71,'" + sPrefix + "',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavBr_demographics_br_encounterid_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV13BR_Demographics.gxTpr_Br_encounterid), 18, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV13BR_Demographics.gxTpr_Br_encounterid), "ZZZZZZZZZZZZZZZZZZ")), TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,71);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavBr_demographics_br_encounterid_Jsonclick, 0, "Attribute", "", "", "", "", edtavBr_demographics_br_encounterid_Visible, 1, 0, "number", "1", 18, "chr", 1, "row", 18, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_BR_EncounterUpdateDemographics.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 72,'" + sPrefix + "',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavBr_demographics_br_information_patientno_Internalname, AV13BR_Demographics.gxTpr_Br_information_patientno, StringUtil.RTrim( context.localUtil.Format( AV13BR_Demographics.gxTpr_Br_information_patientno, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,72);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavBr_demographics_br_information_patientno_Jsonclick, 0, "Attribute", "", "", "", "", edtavBr_demographics_br_information_patientno_Visible, 1, 0, "text", "", 80, "chr", 1, "row", 2000, 0, 0, 0, 1, -1, -1, true, "", "left", true, "HLP_BR_EncounterUpdateDemographics.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void GXDLVvVINSURANCE2K2( String AV21tCurrentCode )
      {
         if ( ! context.isAjaxRequest( ) )
         {
            context.GX_webresponse.AppendHeader("Cache-Control", "no-store");
         ...
         context.GX_webresponse.AddString("[[");
         GXDLVvVINSURANCE_data2K2( AV21tCurrentCode) ;
         gxdynajaxindex = 1;
         while ( gxdynajaxindex <= gxdynajaxctrlcodr.Count )
         {
            context.GX_webresponse.AddString(gxwrpcisep+"{\"c\":\""+GXUtil.EncodeJSConstant( ((String)gxdynajaxctrlcodr.Item(gxdynajaxindex)))+"\",\"d\":\""+GXUtil.EncodeJSConstant( ((String)gxdynajaxctrldescr.Item(gxdynajaxindex)))+"\"}");
      ...
      protected void GXVvVINSURANCE_html2K2( String AV21tCurrentCode )
      {
         String gxdynajaxvalue ;
         GXDLVvVINSURANCE_data2K2( AV21tCurrentCode) ;
         gxdynajaxindex = 1;
      ...
      protected void GXDLVvVINSURANCE_data2K2( String AV21tCurrentCode )
      {
         gxdynajaxctrlcodr.Clear();
         gxdynajaxctrldescr.Clear();
         gxdynajaxctrlcodr.Add("");
         gxdynajaxctrldescr.Add("(请选择)");
         /* Using cursor H002K6 */
         pr_default.execute(4, new Object[] {AV21tCurrentCode});
         while ( (pr_default.getStatus(4) != 101) )
         {
            gxdynajaxctrlcodr.Add(H002K6_A168XT_DefineCodeName[0]);
            gxdynajaxctrldescr.Add(H002K6_A168XT_DefineCodeName[0]);
      ...
      protected void fix_multi_value_controls( )
      {
         ...
         {
            AV16vInsurance = dynavVinsurance.getValidValue(AV16vInsurance);
            context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "AV16vInsurance", AV16vInsurance);
         }
         if ( context.isAjaxRequest( ) )
         {
            dynavVinsurance.CurrentValue = StringUtil.RTrim( AV16vInsurance);
      ...
      protected void RF2K2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A20BR_BehaviorID = H002K7_A20BR_BehaviorID[0];
               ...
               GXVvVINSURANCE_html2K2( AV21tCurrentCode) ;
               /* Execute user event: Load */
               E122K2 ();
      ...
      protected void STRUP2K0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            AV16vInsurance = cgiGet( dynavVinsurance_Internalname);
            context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "AV16vInsurance", AV16vInsurance);
      ...
      protected void E112K2( )
      {
         ...
         {
            A61BR_Demographics_ID = H002K8_A61BR_Demographics_ID[0];
            AV42GXLvl7 = 1;
      ...
      protected void E122K2( )
      {
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV13BR_Demographics.gxTpr_Br_demographics_insurance)) )
         {
            dynavVinsurance.addItem(AV13BR_Demographics.gxTpr_Br_demographics_insurance, AV13BR_Demographics.gxTpr_Br_demographics_insurance, 0);
            AV16vInsurance = AV13BR_Demographics.gxTpr_Br_demographics_insurance;
            context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "AV16vInsurance", AV16vInsurance);
         }
      }
      ...
      protected void E132K2( )
      {
         ...
         if ( ! AV22tCheckFlag )
         {
            ...
            if ( AV15tFlag == 1 )
            {
               if ( StringUtil.StrCmp(AV16vInsurance, "其它") == 0 )
               {
                  if ( String.IsNullOrEmpty(StringUtil.RTrim( AV17vOtherInsurance)) )
                  {
                  ...
                  {
                     AV13BR_Demographics.gxTpr_Br_demographics_insurance = AV17vOtherInsurance;
                  }
               }
               else
               {
                  AV13BR_Demographics.gxTpr_Br_demographics_insurance = AV16vInsurance;
               }
            }
            if ( AV15tFlag == 1 )
            {
      ...
      protected void wb_table1_53_2K2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, dynavVinsurance, dynavVinsurance_Internalname, StringUtil.RTrim( AV16vInsurance), 1, dynavVinsurance_Jsonclick, 0, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "svchar", "", 1, dynavVinsurance.Enabled, 0, 0, 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,57);\"", "", true, "HLP_BR_EncounterUpdateDemographics.htm");
            dynavVinsurance.CurrentValue = StringUtil.RTrim( AV16vInsurance);
            ...
            GxWebStd.gx_single_line_edit( context, edtavVotherinsurance_Internalname, AV17vOtherInsurance, StringUtil.RTrim( context.localUtil.Format( AV17vOtherInsurance, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,60);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "请填写其保险类型", edtavVotherinsurance_Jsonclick, 0, "Attribute", "", "", "", "", edtavVotherinsurance_Visible, edtavVotherinsurance_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 1, -1, -1, true, "", "left", true, "HLP_BR_EncounterUpdateDemographics.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_53_2K2e( true) ;
         }
         else
         {
            wb_table1_53_2K2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202022711555424", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("br_encounterupdatedemographics.js", "?202022711555424", false);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV13BR_Demographics',fld:'vBR_DEMOGRAPHICS',pic:''},{av:'dynavVinsurance'},{av:'AV16vInsurance',fld:'vVINSURANCE',pic:''},{av:'A20BR_BehaviorID',fld:'BR_BEHAVIORID',pic:'ZZZZZZZZZZZZZZZZZZ',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[{ctrl:'BR_DEMOGRAPHICS_BR_DEMOGRAPHICS_ID',prop:'Visible'},{ctrl:'BR_DEMOGRAPHICS_BR_ENCOUNTERID',prop:'Visible'},{ctrl:'BR_DEMOGRAPHICS_BR_INFORMATION_PATIENTNO',prop:'Visible'},{av:'dynavVinsurance'},{av:'AV16vInsurance',fld:'vVINSURANCE',pic:''}]}");
         setEventMetadata("'DOSAVE'","{handler:'E132K2',iparms:[{av:'AV13BR_Demographics',fld:'vBR_DEMOGRAPHICS',pic:''},{av:'dynavVinsurance'},{av:'AV16vInsurance',fld:'vVINSURANCE',pic:''},{av:'AV17vOtherInsurance',fld:'vVOTHERINSURANCE',pic:''},{av:'A20BR_BehaviorID',fld:'BR_BEHAVIORID',pic:'ZZZZZZZZZZZZZZZZZZ',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         AV16vInsurance = "";
         H002K6_A167XT_DefineCodeID = new long[1] ;
         H002K6_A168XT_DefineCodeName = new String[] {""} ;
         H002K6_n168XT_DefineCodeName = new bool[] {false} ;
         H002K6_A165XT_DefindcodeTypeID = new long[1] ;
         H002K6_A432XT_TenantCode = new String[] {""} ;
         H002K6_n432XT_TenantCode = new bool[] {false} ;
         H002K7_A19BR_EncounterID = new long[1] ;
         H002K7_A20BR_BehaviorID = new long[1] ;
         AV17vOtherInsurance = "";
         GXt_char1 = "";
         H002K8_A19BR_EncounterID = new long[1] ;
         H002K8_A61BR_Demographics_ID = new long[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.br_encounterupdatedemographics__default(),
            new Object[][] {
               ...
               , new Object[] {
               H002K6_A167XT_DefineCodeID, H002K6_A168XT_DefineCodeName, H002K6_n168XT_DefineCodeName, H002K6_A165XT_DefindcodeTypeID, H002K6_A432XT_TenantCode, H002K6_n432XT_TenantCode
               }
               , new Object[] {
               H002K7_A19BR_EncounterID, H002K7_A20BR_BehaviorID
               }
               , new Object[] {
               H002K8_A19BR_EncounterID, H002K8_A61BR_Demographics_ID
               }
            }
         );
         AV45Pgmname = "BR_EncounterUpdateDemographics";
      ...
      private long[] H002K6_A167XT_DefineCodeID ;
      private String[] H002K6_A168XT_DefineCodeName ;
      private bool[] H002K6_n168XT_DefineCodeName ;
      private long[] H002K6_A165XT_DefindcodeTypeID ;
      private String[] H002K6_A432XT_TenantCode ;
      private bool[] H002K6_n432XT_TenantCode ;
      private long[] H002K7_A19BR_EncounterID ;
      private long[] H002K7_A20BR_BehaviorID ;
      private long[] H002K8_A19BR_EncounterID ;
      private long[] H002K8_A61BR_Demographics_ID ;
  ...
  private void cursorDefinitions( )
  {
     if ( def == null )
     {
        ...
        def= new CursorDef[] {
           ...
           ,new CursorDef("H002K6", "SELECT [XT_DefineCodeID], [XT_DefineCodeName], [XT_DefindcodeTypeID], [XT_TenantCode] FROM [XT_DefineCode] WITH (NOLOCK) WHERE ([XT_DefindcodeTypeID] = 11) AND ([XT_TenantCode] = @AV21tCurrentCode) ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH002K6,0,0,true,false )
           ,new CursorDef("H002K7", "SELECT [BR_EncounterID], [BR_BehaviorID] FROM [BR_Behavior] WITH (NOLOCK) WHERE [BR_EncounterID] = @BR_EncounterID ORDER BY [BR_EncounterID] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH002K7,100,0,true,false )
           ,new CursorDef("H002K8", "SELECT TOP 1 [BR_EncounterID], [BR_Demographics_ID] FROM [BR_Demographics] WITH (NOLOCK) WHERE [BR_EncounterID] = @BR_EncounterID ORDER BY [BR_EncounterID] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH002K8,1,0,true,true )
        };
     }
  }
