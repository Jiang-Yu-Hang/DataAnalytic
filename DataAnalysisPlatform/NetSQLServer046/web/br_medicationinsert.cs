/*
               File: BR_MedicationInsert
        Description:
             Author: GeneXus C# Generator version 16_0_0-127771
       Generated on: 2/27/2020 12:6:52.50
...
namespace GeneXus.Programs {
   public class br_medicationinsert : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public br_medicationinsert( )
      {
      ...
      public br_medicationinsert( IGxContext context )
      {
      ...
      {
         this.AV11BR_EncounterID = aP0_BR_EncounterID;
         executePrivate();
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxCallCrl"+"_"+"vVMEDICATIONNAME") == 0 )
            {
               ...
               GXDLVvVMEDICATIONNAME8S2( AV12tCurrentCode) ;
               return  ;
            }
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxCallCrl"+"_"+"vVRXFREQUENCY") == 0 )
            {
               ...
               GXDLVvVRXFREQUENCY8S2( AV12tCurrentCode) ;
               return  ;
            }
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxCallCrl"+"_"+"vVUPDATERXROUTE") == 0 )
            {
               ...
               GXDLVvVUPDATERXROUTE8S2( AV12tCurrentCode) ;
               return  ;
            }
            ...
            {
               AV11BR_EncounterID = (long)(NumberUtil.Val( gxfirstwebparm, "."));
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV11BR_EncounterID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV11BR_EncounterID), 18, 0)));
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "gxhash_vBR_ENCOUNTERID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV11BR_EncounterID), "ZZZZZZZZZZZZZZZZZZ"), context));
            }
            if ( context.isSpaRequest( ) )
            {
               enableJsOutput();
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20202271265260", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("br_medicationinsert.aspx") + "?" + UrlEncode("" +AV11BR_EncounterID)+"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vBR_ENCOUNTERID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV11BR_EncounterID), 18, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vBR_ENCOUNTERID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV11BR_EncounterID), "ZZZZZZZZZZZZZZZZZZ"), context));
      ...
      {
         return formatLink("br_medicationinsert.aspx") + "?" + UrlEncode("" +AV11BR_EncounterID) ;
      }

      public override String GetPgmname( )
      {
         return "BR_MedicationInsert" ;
      }
      ...
      protected void WB8S0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockvmedicationname_Internalname, "药物名称", "", "", lblTextblockvmedicationname_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, "HLP_BR_MedicationInsert.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-9", "left", "top", "", "", "div");
            wb_table1_28_8S2( true) ;
         }
         else
         {
            wb_table1_28_8S2( false) ;
         }
         return  ;
      }

      protected void wb_table1_28_8S2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavBr_medication_br_medication_rxcode_Internalname, AV10BR_Medication.gxTpr_Br_medication_rxcode, StringUtil.RTrim( context.localUtil.Format( AV10BR_Medication.gxTpr_Br_medication_rxcode, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,39);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavBr_medication_br_medication_rxcode_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavBr_medication_br_medication_rxcode_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 1, -1, -1, true, "", "left", true, "HLP_BR_MedicationInsert.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavBr_medication_br_medication_rxtype_Internalname, AV10BR_Medication.gxTpr_Br_medication_rxtype, StringUtil.RTrim( context.localUtil.Format( AV10BR_Medication.gxTpr_Br_medication_rxtype, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,44);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavBr_medication_br_medication_rxtype_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavBr_medication_br_medication_rxtype_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 1, -1, -1, true, "", "left", true, "HLP_BR_MedicationInsert.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-3 MergeLabelCell", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockvrxfrequency_Internalname, "服药频率", "", "", lblTextblockvrxfrequency_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, "HLP_BR_MedicationInsert.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-9", "left", "top", "", "", "div");
            wb_table2_60_8S2( true) ;
         }
         else
         {
            wb_table2_60_8S2( false) ;
         }
         return  ;
      }

      protected void wb_table2_60_8S2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-3 MergeLabelCell", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblockvupdaterxroute_Internalname, "给药途径", "", "", lblTextblockvupdaterxroute_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, "HLP_BR_MedicationInsert.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-9", "left", "top", "", "", "div");
            wb_table3_84_8S2( true) ;
         }
         else
         {
            wb_table3_84_8S2( false) ;
         }
         return  ;
      }

      protected void wb_table3_84_8S2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavBr_medication_br_medication_prescriptiondate_Internalname, context.localUtil.Format(AV10BR_Medication.gxTpr_Br_medication_prescriptiondate, "9999/99/99"), context.localUtil.Format( AV10BR_Medication.gxTpr_Br_medication_prescriptiondate, "9999/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'YMD',0,24,'chs',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,95);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavBr_medication_br_medication_prescriptiondate_Jsonclick, 0, "AttributeDate", "", "", "", "", 1, edtavBr_medication_br_medication_prescriptiondate_Enabled, 0, "text", "", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_BR_MedicationInsert.htm");
            GxWebStd.gx_bitmap( context, edtavBr_medication_br_medication_prescriptiondate_Internalname+"_dp_trigger", context.GetImagePath( "61b9b5d3-dff6-4d59-9b00-da61bc2cbe93", "", context.GetTheme( )), "", "", "", "", ((1==0)||(edtavBr_medication_br_medication_prescriptiondate_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_BR_MedicationInsert.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtavBr_medication_br_medication_admitenddate_Internalname, context.localUtil.Format(AV10BR_Medication.gxTpr_Br_medication_admitenddate, "9999/99/99"), context.localUtil.Format( AV10BR_Medication.gxTpr_Br_medication_admitenddate, "9999/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'YMD',0,24,'chs',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,104);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavBr_medication_br_medication_admitenddate_Jsonclick, 0, "AttributeDate", "", "", "", "", 1, edtavBr_medication_br_medication_admitenddate_Enabled, 0, "text", "", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_BR_MedicationInsert.htm");
            GxWebStd.gx_bitmap( context, edtavBr_medication_br_medication_admitenddate_Internalname+"_dp_trigger", context.GetImagePath( "61b9b5d3-dff6-4d59-9b00-da61bc2cbe93", "", context.GetTheme( )), "", "", "", "", ((1==0)||(edtavBr_medication_br_medication_admitenddate_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_BR_MedicationInsert.htm");
            context.WriteHtmlTextNl( "</div>") ;
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnenter_Internalname, "", "保存", bttBtnenter_Jsonclick, 5, "确认", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"EENTER."+"'", TempTags, "", context.GetButtonType( ), "HLP_BR_MedicationInsert.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtncancel_Internalname, "", "取消", bttBtncancel_Jsonclick, 1, "取消", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", context.GetButtonType( ), "HLP_BR_MedicationInsert.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void GXDLVvVMEDICATIONNAME8S2( String AV12tCurrentCode )
      {
         if ( ! context.isAjaxRequest( ) )
         {
            context.GX_webresponse.AppendHeader("Cache-Control", "no-store");
         ...
         GXDLVvVMEDICATIONNAME_data8S2( AV12tCurrentCode) ;
         gxdynajaxindex = 1;
      ...
      protected void GXVvVMEDICATIONNAME_html8S2( String AV12tCurrentCode )
      {
      ...
      protected void GXDLVvVMEDICATIONNAME_data8S2( String AV12tCurrentCode )
      {
         ...
         {
            gxdynajaxctrlcodr.Add(H008S2_A168XT_DefineCodeName[0]);
            gxdynajaxctrldescr.Add(H008S2_A168XT_DefineCodeName[0]);
            pr_default.readNext(0);
         }
         pr_default.close(0);
      }

      protected void GXDLVvVRXFREQUENCY8S2( String AV12tCurrentCode )
      {
         if ( ! context.isAjaxRequest( ) )
         {
            context.GX_webresponse.AppendHeader("Cache-Control", "no-store");
         ...
         context.GX_webresponse.AddString("[[");
         GXDLVvVRXFREQUENCY_data8S2( AV12tCurrentCode) ;
         gxdynajaxindex = 1;
         while ( gxdynajaxindex <= gxdynajaxctrlcodr.Count )
         {
            context.GX_webresponse.AddString(gxwrpcisep+"{\"c\":\""+GXUtil.EncodeJSConstant( ((String)gxdynajaxctrlcodr.Item(gxdynajaxindex)))+"\",\"d\":\""+GXUtil.EncodeJSConstant( ((String)gxdynajaxctrldescr.Item(gxdynajaxindex)))+"\"}");
      ...
      protected void GXVvVRXFREQUENCY_html8S2( String AV12tCurrentCode )
      {
         String gxdynajaxvalue ;
         GXDLVvVRXFREQUENCY_data8S2( AV12tCurrentCode) ;
         gxdynajaxindex = 1;
      ...
      protected void GXDLVvVRXFREQUENCY_data8S2( String AV12tCurrentCode )
      {
         gxdynajaxctrlcodr.Clear();
         gxdynajaxctrldescr.Clear();
         ...
         /* Using cursor H008S3 */
         pr_default.execute(1, new Object[] {AV12tCurrentCode});
         while ( (pr_default.getStatus(1) != 101) )
         {
            gxdynajaxctrlcodr.Add(H008S3_A168XT_DefineCodeName[0]);
            gxdynajaxctrldescr.Add(H008S3_A168XT_DefineCodeName[0]);
            pr_default.readNext(1);
         }
         pr_default.close(1);
      }

      protected void GXDLVvVUPDATERXROUTE8S2( String AV12tCurrentCode )
      {
         if ( ! context.isAjaxRequest( ) )
         {
            context.GX_webresponse.AppendHeader("Cache-Control", "no-store");
         ...
         context.GX_webresponse.AddString("[[");
         GXDLVvVUPDATERXROUTE_data8S2( AV12tCurrentCode) ;
         gxdynajaxindex = 1;
         while ( gxdynajaxindex <= gxdynajaxctrlcodr.Count )
         {
            context.GX_webresponse.AddString(gxwrpcisep+"{\"c\":\""+GXUtil.EncodeJSConstant( ((String)gxdynajaxctrlcodr.Item(gxdynajaxindex)))+"\",\"d\":\""+GXUtil.EncodeJSConstant( ((String)gxdynajaxctrldescr.Item(gxdynajaxindex)))+"\"}");
      ...
      protected void GXVvVUPDATERXROUTE_html8S2( String AV12tCurrentCode )
      {
         String gxdynajaxvalue ;
         GXDLVvVUPDATERXROUTE_data8S2( AV12tCurrentCode) ;
         gxdynajaxindex = 1;
      ...
      protected void GXDLVvVUPDATERXROUTE_data8S2( String AV12tCurrentCode )
      {
         gxdynajaxctrlcodr.Clear();
         gxdynajaxctrldescr.Clear();
         gxdynajaxctrlcodr.Add("");
         gxdynajaxctrldescr.Add("(请选择)");
         /* Using cursor H008S4 */
         pr_default.execute(2, new Object[] {AV12tCurrentCode});
         while ( (pr_default.getStatus(2) != 101) )
         {
            gxdynajaxctrlcodr.Add(H008S4_A168XT_DefineCodeName[0]);
            gxdynajaxctrldescr.Add(H008S4_A168XT_DefineCodeName[0]);
      ...
      protected void fix_multi_value_controls( )
      {
         ...
         {
            AV13vMedicationName = dynavVmedicationname.getValidValue(AV13vMedicationName);
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV13vMedicationName", AV13vMedicationName);
         }
         if ( context.isAjaxRequest( ) )
         {
            dynavVmedicationname.CurrentValue = StringUtil.RTrim( AV13vMedicationName);
         ...
         {
            AV15vRXFrequency = dynavVrxfrequency.getValidValue(AV15vRXFrequency);
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV15vRXFrequency", AV15vRXFrequency);
         }
         if ( context.isAjaxRequest( ) )
         {
            dynavVrxfrequency.CurrentValue = StringUtil.RTrim( AV15vRXFrequency);
         ...
         {
            AV17vUpdateRXRoute = dynavVupdaterxroute.getValidValue(AV17vUpdateRXRoute);
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV17vUpdateRXRoute", AV17vUpdateRXRoute);
         }
         if ( context.isAjaxRequest( ) )
         {
            dynavVupdaterxroute.CurrentValue = StringUtil.RTrim( AV17vUpdateRXRoute);
      ...
      protected void STRUP8S0( )
      {
         ...
         GXVvVMEDICATIONNAME_html8S2( AV12tCurrentCode) ;
         GXVvVRXFREQUENCY_html8S2( AV12tCurrentCode) ;
         GXVvVUPDATERXROUTE_html8S2( AV12tCurrentCode) ;
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            ...
            AV13vMedicationName = cgiGet( dynavVmedicationname_Internalname);
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV13vMedicationName", AV13vMedicationName);
            AV14vOtherMedicationName = cgiGet( edtavVothermedicationname_Internalname);
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV14vOtherMedicationName", AV14vOtherMedicationName);
            ...
            AV15vRXFrequency = cgiGet( dynavVrxfrequency_Internalname);
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV15vRXFrequency", AV15vRXFrequency);
            AV16vOtherRXFrequency = cgiGet( edtavVotherrxfrequency_Internalname);
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV16vOtherRXFrequency", AV16vOtherRXFrequency);
            ...
            AV17vUpdateRXRoute = cgiGet( dynavVupdaterxroute_Internalname);
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV17vUpdateRXRoute", AV17vUpdateRXRoute);
            AV18vRXRoute = cgiGet( edtavVrxroute_Internalname);
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV18vRXRoute", AV18vRXRoute);
      ...
      protected void S122( )
      {
         ...
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV13vMedicationName)) )
         {
            GX_msglist.addItem("药物名称是必须填写的。");
            AV19CheckRequiredFieldsResult = false;
         }
         if ( ( ( StringUtil.StrCmp(AV13vMedicationName, "其它") == 0 ) ) && String.IsNullOrEmpty(StringUtil.RTrim( AV14vOtherMedicationName)) )
         {
            GX_msglist.addItem("其它药物名称是必填的");
            AV19CheckRequiredFieldsResult = false;
         }
         if ( ( ( StringUtil.StrCmp(AV15vRXFrequency, "其它") == 0 ) ) && String.IsNullOrEmpty(StringUtil.RTrim( AV16vOtherRXFrequency)) )
         {
            GX_msglist.addItem("其它服药频率是必填的");
            AV19CheckRequiredFieldsResult = false;
         }
         if ( ( ( StringUtil.StrCmp(AV17vUpdateRXRoute, "其它") == 0 ) ) && String.IsNullOrEmpty(StringUtil.RTrim( AV18vRXRoute)) )
         {
      ...
      protected void S112( )
      {
         ...
         if ( StringUtil.StrCmp(AV13vMedicationName, "其它") == 0 )
         {
         ...
         if ( StringUtil.StrCmp(AV15vRXFrequency, "其它") == 0 )
         {
         ...
         if ( StringUtil.StrCmp(AV17vUpdateRXRoute, "其它") == 0 )
         {
      ...
      protected void S132( )
      {
         ...
         AV39GXV14 = 1;
         while ( AV39GXV14 <= AV8Messages.Count )
         {
            AV7Message = ((SdtMessages_Message)AV8Messages.Item(AV39GXV14));
      ...
      protected void E138S2( )
      {
         ...
         if ( ! AV23tCheckFlag )
         {
            ...
            else
            {
               if ( StringUtil.StrCmp(AV13vMedicationName, "其它") == 0 )
               {
                  if ( String.IsNullOrEmpty(StringUtil.RTrim( AV14vOtherMedicationName)) )
                  {
                     GX_msglist.addItem("其它药物名称是必填的");
                     AV21tFlag = false;
                  }
                  ...
                  {
                     AV10BR_Medication.gxTpr_Br_medication_rxname = AV14vOtherMedicationName;
                  }
               }
               else
               {
                  AV10BR_Medication.gxTpr_Br_medication_rxname = AV13vMedicationName;
               }
            }
            if ( ( AV21tFlag ) && (DateTime.MinValue==AV10BR_Medication.gxTpr_Br_medication_admitstartdate) )
            {
            ...
            if ( AV21tFlag )
            {
               if ( StringUtil.StrCmp(AV15vRXFrequency, "其它") == 0 )
               {
                  if ( String.IsNullOrEmpty(StringUtil.RTrim( AV16vOtherRXFrequency)) )
                  {
                     GX_msglist.addItem("其它服药频率是必填的");
                     AV21tFlag = false;
                  }
                  ...
                  {
                     AV10BR_Medication.gxTpr_Br_medication_rxfrequency = AV16vOtherRXFrequency;
                  }
               }
               else
               {
                  AV10BR_Medication.gxTpr_Br_medication_rxfrequency = AV15vRXFrequency;
               }
            }
            if ( AV21tFlag )
            {
               if ( StringUtil.StrCmp(AV17vUpdateRXRoute, "其它") == 0 )
               {
                  if ( String.IsNullOrEmpty(StringUtil.RTrim( AV18vRXRoute)) )
                  {
                     GX_msglist.addItem("其它给药途径是必填的");
                     AV21tFlag = false;
                  }
                  ...
                  {
                     AV10BR_Medication.gxTpr_Br_medication_rxroute = AV18vRXRoute;
                  }
               }
               else
               {
                  AV10BR_Medication.gxTpr_Br_medication_rxroute = AV17vUpdateRXRoute;
               }
            }
            if ( AV21tFlag )
            {
               AV10BR_Medication.gxTpr_Br_encounterid = AV11BR_EncounterID;
               ...
               if ( AV10BR_Medication.Success() )
               {
                  ...
                  context.CommitDataStores("br_medicationinsert",pr_default);
               ...
               else
               {
                  AV20tErrorMsg = "";
                  AV41GXV16 = 1;
                  AV40GXV15 = AV10BR_Medication.GetMessages();
                  while ( AV41GXV16 <= AV40GXV15.Count )
                  {
                     AV7Message = ((SdtMessages_Message)AV40GXV15.Item(AV41GXV16));
                     AV20tErrorMsg = AV20tErrorMsg + StringUtil.Trim( AV7Message.gxTpr_Description);
                     AV41GXV16 = (int)(AV41GXV16+1);
                  }
                  GX_msglist.addItem(AV20tErrorMsg);
               }
            }
         }
      ...
      protected void wb_table3_84_8S2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            GxWebStd.gx_single_line_edit( context, edtavVrxroute_Internalname, AV18vRXRoute, StringUtil.RTrim( context.localUtil.Format( AV18vRXRoute, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,91);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "请填写其它给药途径", edtavVrxroute_Jsonclick, 0, "Attribute", "", "", "", "", edtavVrxroute_Visible, edtavVrxroute_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 1, -1, -1, true, "", "left", true, "HLP_BR_MedicationInsert.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table3_84_8S2e( true) ;
         }
         else
         {
            wb_table3_84_8S2e( false) ;
         }
      }

      protected void wb_table2_60_8S2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", " gx-attribute", "left", "top", "", "", "div");
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, dynavVrxfrequency_Internalname, "v RXFrequency", "col-sm-3 AttributeLabel", 0, true);
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 64,'',false,'',0)\"";
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, dynavVrxfrequency, dynavVrxfrequency_Internalname, StringUtil.RTrim( AV15vRXFrequency), 1, dynavVrxfrequency_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "svchar", "", 1, dynavVrxfrequency.Enabled, 0, 0, 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,64);\"", "", true, "HLP_BR_MedicationInsert.htm");
            dynavVrxfrequency.CurrentValue = StringUtil.RTrim( AV15vRXFrequency);
            ...
            GxWebStd.gx_single_line_edit( context, edtavVotherrxfrequency_Internalname, AV16vOtherRXFrequency, StringUtil.RTrim( context.localUtil.Format( AV16vOtherRXFrequency, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,67);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "请填写其它服药频率", edtavVotherrxfrequency_Jsonclick, 0, "Attribute", "", "", "", "", edtavVotherrxfrequency_Visible, edtavVotherrxfrequency_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 1, -1, -1, true, "", "left", true, "HLP_BR_MedicationInsert.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_60_8S2e( true) ;
         }
         else
         {
            wb_table2_60_8S2e( false) ;
         }
      }

      protected void wb_table1_28_8S2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, dynavVmedicationname, dynavVmedicationname_Internalname, StringUtil.RTrim( AV13vMedicationName), 1, dynavVmedicationname_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "svchar", "", 1, dynavVmedicationname.Enabled, 0, 0, 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,32);\"", "", true, "HLP_BR_MedicationInsert.htm");
            dynavVmedicationname.CurrentValue = StringUtil.RTrim( AV13vMedicationName);
            ...
            GxWebStd.gx_single_line_edit( context, edtavVothermedicationname_Internalname, AV14vOtherMedicationName, StringUtil.RTrim( context.localUtil.Format( AV14vOtherMedicationName, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,35);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "请填写其它药物名称", edtavVothermedicationname_Jsonclick, 0, "Attribute", "", "", "", "", edtavVothermedicationname_Visible, edtavVothermedicationname_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 1, -1, -1, true, "", "left", true, "HLP_BR_MedicationInsert.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_28_8S2e( true) ;
         }
         else
         {
            wb_table1_28_8S2e( false) ;
         }
      }
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV11BR_EncounterID = Convert.ToInt64(getParm(obj,0));
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV11BR_EncounterID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV11BR_EncounterID), 18, 0)));
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "gxhash_vBR_ENCOUNTERID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV11BR_EncounterID), "ZZZZZZZZZZZZZZZZZZ"), context));
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?20202271265521", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("br_medicationinsert.js", "?20202271265522", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV11BR_EncounterID',fld:'vBR_ENCOUNTERID',pic:'ZZZZZZZZZZZZZZZZZZ',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("ENTER","{handler:'E138S2',iparms:[{av:'dynavVmedicationname'},{av:'AV13vMedicationName',fld:'vVMEDICATIONNAME',pic:''},{av:'AV14vOtherMedicationName',fld:'vVOTHERMEDICATIONNAME',pic:''},{av:'AV10BR_Medication',fld:'vBR_MEDICATION',pic:''},{av:'dynavVrxfrequency'},{av:'AV15vRXFrequency',fld:'vVRXFREQUENCY',pic:''},{av:'AV16vOtherRXFrequency',fld:'vVOTHERRXFREQUENCY',pic:''},{av:'dynavVupdaterxroute'},{av:'AV17vUpdateRXRoute',fld:'vVUPDATERXROUTE',pic:''},{av:'AV18vRXRoute',fld:'vVRXROUTE',pic:''},{av:'AV11BR_EncounterID',fld:'vBR_ENCOUNTERID',pic:'ZZZZZZZZZZZZZZZZZZ',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         gxwrpcisep = "";
         scmdbuf = "";
         H008S2_A167XT_DefineCodeID = new long[1] ;
         H008S2_A168XT_DefineCodeName = new String[] {""} ;
         H008S2_n168XT_DefineCodeName = new bool[] {false} ;
         H008S2_A165XT_DefindcodeTypeID = new long[1] ;
         H008S2_A432XT_TenantCode = new String[] {""} ;
         H008S2_n432XT_TenantCode = new bool[] {false} ;
         AV15vRXFrequency = "";
         H008S3_A167XT_DefineCodeID = new long[1] ;
         H008S3_A168XT_DefineCodeName = new String[] {""} ;
         H008S3_n168XT_DefineCodeName = new bool[] {false} ;
         H008S3_A165XT_DefindcodeTypeID = new long[1] ;
         H008S3_A432XT_TenantCode = new String[] {""} ;
         H008S3_n432XT_TenantCode = new bool[] {false} ;
         AV17vUpdateRXRoute = "";
         H008S4_A167XT_DefineCodeID = new long[1] ;
         H008S4_A168XT_DefineCodeName = new String[] {""} ;
         H008S4_n168XT_DefineCodeName = new bool[] {false} ;
         H008S4_A165XT_DefindcodeTypeID = new long[1] ;
         H008S4_A432XT_TenantCode = new String[] {""} ;
         H008S4_n432XT_TenantCode = new bool[] {false} ;
         AV13vMedicationName = "";
         AV14vOtherMedicationName = "";
         AV16vOtherRXFrequency = "";
         AV18vRXRoute = "";
         GXt_char1 = "";
         ...
         AV20tErrorMsg = "";
         AV40GXV15 = new GXBaseCollection<SdtMessages_Message>( context, "Message", "GeneXus");
         sStyleString = "";
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_datastore1 = new DataStoreProvider(context, new GeneXus.Programs.br_medicationinsert__datastore1(),
            new Object[][] {
            }
         );
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.br_medicationinsert__default(),
            new Object[][] {
                new Object[] {
               H008S2_A167XT_DefineCodeID, H008S2_A168XT_DefineCodeName, H008S2_n168XT_DefineCodeName, H008S2_A165XT_DefindcodeTypeID, H008S2_A432XT_TenantCode, H008S2_n432XT_TenantCode
               }
               , new Object[] {
               H008S3_A167XT_DefineCodeID, H008S3_A168XT_DefineCodeName, H008S3_n168XT_DefineCodeName, H008S3_A165XT_DefindcodeTypeID, H008S3_A432XT_TenantCode, H008S3_n432XT_TenantCode
               }
               , new Object[] {
               H008S4_A167XT_DefineCodeID, H008S4_A168XT_DefineCodeName, H008S4_n168XT_DefineCodeName, H008S4_A165XT_DefindcodeTypeID, H008S4_A432XT_TenantCode, H008S4_n432XT_TenantCode
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private int idxLst ;
      private long AV11BR_EncounterID ;
      private long wcpOAV11BR_EncounterID ;
      ...
      private bool AV21tFlag ;
      private String AV12tCurrentCode ;
      private String AV15vRXFrequency ;
      private String AV17vUpdateRXRoute ;
      private String AV13vMedicationName ;
      private String AV14vOtherMedicationName ;
      private String AV16vOtherRXFrequency ;
      private String AV18vRXRoute ;
      private String AV20tErrorMsg ;
      ...
      private long[] H008S2_A167XT_DefineCodeID ;
      private String[] H008S2_A168XT_DefineCodeName ;
      private bool[] H008S2_n168XT_DefineCodeName ;
      private long[] H008S2_A165XT_DefindcodeTypeID ;
      private String[] H008S2_A432XT_TenantCode ;
      private bool[] H008S2_n432XT_TenantCode ;
      private long[] H008S3_A167XT_DefineCodeID ;
      private String[] H008S3_A168XT_DefineCodeName ;
      private bool[] H008S3_n168XT_DefineCodeName ;
      private long[] H008S3_A165XT_DefindcodeTypeID ;
      private String[] H008S3_A432XT_TenantCode ;
      private bool[] H008S3_n432XT_TenantCode ;
      private long[] H008S4_A167XT_DefineCodeID ;
      private String[] H008S4_A168XT_DefineCodeName ;
      private bool[] H008S4_n168XT_DefineCodeName ;
      private long[] H008S4_A165XT_DefindcodeTypeID ;
      private String[] H008S4_A432XT_TenantCode ;
      private bool[] H008S4_n432XT_TenantCode ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private IDataStoreProvider pr_datastore1 ;
      private GXBaseCollection<SdtMessages_Message> AV8Messages ;
      private GXBaseCollection<SdtMessages_Message> AV40GXV15 ;
   ...
   public class br_medicationinsert__datastore1 : DataStoreHelperBase, IDataStoreHelper
   {
 ...
 public class br_medicationinsert__default : DataStoreHelperBase, IDataStoreHelper
 {
    public ICursor[] getCursors( )
    {
       cursorDefinitions();
  ...
  private void cursorDefinitions( )
  {
     if ( def == null )
     {
        ...
        Object[] prmH008S3 ;
        prmH008S3 = new Object[] {
        new Object[] {"@AV12tCurrentCode",SqlDbType.NVarChar,40,0}
        } ;
        Object[] prmH008S4 ;
        prmH008S4 = new Object[] {
        new Object[] {"@AV12tCurrentCode",SqlDbType.NVarChar,40,0}
        } ;
        def= new CursorDef[] {
            new CursorDef("H008S2", "SELECT [XT_DefineCodeID], [XT_DefineCodeName], [XT_DefindcodeTypeID], [XT_TenantCode] FROM [XT_DefineCode] WITH (NOLOCK) WHERE ([XT_DefindcodeTypeID] = 33) AND ([XT_TenantCode] = @AV12tCurrentCode) ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH008S2,0,0,true,false )
           ,new CursorDef("H008S3", "SELECT [XT_DefineCodeID], [XT_DefineCodeName], [XT_DefindcodeTypeID], [XT_TenantCode] FROM [XT_DefineCode] WITH (NOLOCK) WHERE ([XT_DefindcodeTypeID] = 25) AND ([XT_TenantCode] = @AV12tCurrentCode) ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH008S3,0,0,true,false )
           ,new CursorDef("H008S4", "SELECT [XT_DefineCodeID], [XT_DefineCodeName], [XT_DefindcodeTypeID], [XT_TenantCode] FROM [XT_DefineCode] WITH (NOLOCK) WHERE ([XT_DefindcodeTypeID] = 26) AND ([XT_TenantCode] = @AV12tCurrentCode) ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH008S4,0,0,true,false )
        };
     }
  }
