/*
       ...
       Generated on: 2/27/2020 11:56:43.86
   ...
   public class br_medication : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void wb_table3_84_0H18e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtBR_Medication_PrescriptionDate_Internalname, context.localUtil.Format(A130BR_Medication_PrescriptionDate, "9999/99/99"), context.localUtil.Format( A130BR_Medication_PrescriptionDate, "9999/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'YMD',0,24,'chs',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,95);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtBR_Medication_PrescriptionDate_Jsonclick, 0, "AttributeDate", "", "", "", "", 1, edtBR_Medication_PrescriptionDate_Enabled, 0, "text", "", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, 0, true, "DM_Date", "right", false, "HLP_BR_Medication.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtBR_Medication_AdmitStartDate_Internalname, context.localUtil.Format(A132BR_Medication_AdmitStartDate, "9999/99/99"), context.localUtil.Format( A132BR_Medication_AdmitStartDate, "9999/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'YMD',0,24,'chs',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,100);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtBR_Medication_AdmitStartDate_Jsonclick, 0, "AttributeDate", "", "", "", "", 1, edtBR_Medication_AdmitStartDate_Enabled, 0, "text", "", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, 0, true, "DM_Date", "right", false, "HLP_BR_Medication.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtBR_Medication_AdmitEndDate_Internalname, context.localUtil.Format(A133BR_Medication_AdmitEndDate, "9999/99/99"), context.localUtil.Format( A133BR_Medication_AdmitEndDate, "9999/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'YMD',0,24,'chs',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,104);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtBR_Medication_AdmitEndDate_Jsonclick, 0, "AttributeDate", "", "", "", "", 1, edtBR_Medication_AdmitEndDate_Enabled, 0, "text", "", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, 0, true, "DM_Date", "right", false, "HLP_BR_Medication.htm");
      ...
      protected void CheckExtendedTable0H18( )
      {
         ...
         {
            GX_msglist.addItem("域������������超界", "OutOfRange", 1, "BR_MEDICATION_PRESCRIPTIONDATE");
            AnyError = 1;
            GX_FocusControl = edtBR_Medication_PrescriptionDate_Internalname;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "GX_FocusControl", GX_FocusControl);
         }
         ...
         {
            GX_msglist.addItem("域������������超界", "OutOfRange", 1, "BR_MEDICATION_ADMITSTARTDATE");
            AnyError = 1;
            GX_FocusControl = edtBR_Medication_AdmitStartDate_Internalname;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "GX_FocusControl", GX_FocusControl);
         }
         ...
         {
            GX_msglist.addItem("域������������超界", "OutOfRange", 1, "BR_MEDICATION_ADMITENDDATE");
            AnyError = 1;
            GX_FocusControl = edtBR_Medication_AdmitEndDate_Internalname;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "GX_FocusControl", GX_FocusControl);
         }
         ...
         {
            GX_msglist.addItem("域������������������������超界", "OutOfRange", 1, "BR_MEDICATION_INPATIENTCHEMO");
            AnyError = 1;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202022711565052", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202022711565114", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("br_medication.js", "?202022711565114", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false);
