/*
       ...
       Generated on: 2/27/2020 11:56:7.11
   ...
   public class br_encounterupdatebr_diagnosiswc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV90Pgmname = "BR_EncounterUpdateBR_DiagnosisWC";
               context.Gx_err = 0;
               WS242( ) ;
               if ( ! isAjaxCallMode( ) )
               {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20202271156755", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void RenderHtmlCloseForm242( )
      {
         ...
         {
            context.AddJavascriptSource("br_encounterupdatebr_diagnosiswc.js", "?20202271156123", false);
         }
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 13), "VUPDATE.CLICK") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 13), "VDELETE.CLICK") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 13), "VUPDATE.CLICK") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 13), "VDELETE.CLICK") == 0 ) )
                           {
                              ...
                              context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtavDisplay_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV43Display)) ? AV87Display_GXI : context.convertURL( context.PathToRelativeUrl( AV43Display))), !bGXsfl_28_Refreshing);
                              ...
                              context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtavUpdate_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV39Update)) ? AV88Update_GXI : context.convertURL( context.PathToRelativeUrl( AV39Update))), !bGXsfl_28_Refreshing);
                              ...
                              context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtavDelete_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV41Delete)) ? AV89Delete_GXI : context.convertURL( context.PathToRelativeUrl( AV41Delete))), !bGXsfl_28_Refreshing);
      ...
      private void E22242( )
      {
         ...
         AV88Update_GXI = GXDbFile.PathToUrl( context.GetImagePath( "7c63c2b9-483e-4035-b512-febf9186a274", "", context.GetTheme( )));
      ...
      protected void S122( )
      {
         ...
         AV91GXV1 = 1;
         while ( AV91GXV1 <= AV12GridState.gxTpr_Filtervalues.Count )
         {
            AV13GridStateFilterValue = ((GeneXus.Programs.wwpbaseobjects.SdtWWPGridState_FilterValue)AV12GridState.gxTpr_Filtervalues.Item(AV91GXV1));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202022711563179", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("br_encounterupdatebr_diagnosiswc.js", "?202022711563179", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
      ...
      protected void sendrow_282( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_28_idx <= subGrid_Recordsperpage( ) * 1 ) )
         {
            ...
            StyleString = "";
            AV43Display_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV43Display))&&String.IsNullOrEmpty(StringUtil.RTrim( AV87Display_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV43Display)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV43Display)) ? AV87Display_GXI : context.PathToRelativeUrl( AV43Display));
            ...
            ClassString = "ActionBaseColorAttribute";
            StyleString = "";
            AV39Update_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV39Update))&&String.IsNullOrEmpty(StringUtil.RTrim( AV88Update_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV39Update)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV39Update)) ? AV88Update_GXI : context.PathToRelativeUrl( AV39Update));
            ...
            StyleString = "";
            AV41Delete_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV41Delete))&&String.IsNullOrEmpty(StringUtil.RTrim( AV89Delete_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV41Delete)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV41Delete)) ? AV89Delete_GXI : context.PathToRelativeUrl( AV41Delete));
