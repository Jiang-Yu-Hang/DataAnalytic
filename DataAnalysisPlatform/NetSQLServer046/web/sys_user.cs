/*
       ...
       Generated on: 2/27/2020 11:58:8.8
   ...
   public class sys_user : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void Draw( )
      {
         ...
         if ( ! GxWebStd.gx_redirect( context) )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtLoginTime_Internalname, context.localUtil.TToC( A420LoginTime, 10, 8, 0, 0, "/", ":", " "), context.localUtil.Format( A420LoginTime, "9999/99/99 99:99:99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'YMD',8,24,'chs',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,58);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtLoginTime_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtLoginTime_Enabled, 0, "text", "", 19, "chr", 1, "row", 19, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_SYS_User.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtSYS_UserCreateTime_Internalname, context.localUtil.TToC( A422SYS_UserCreateTime, 10, 8, 0, 0, "/", ":", " "), context.localUtil.Format( A422SYS_UserCreateTime, "9999/99/99 99:99:99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'YMD',8,24,'chs',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,68);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtSYS_UserCreateTime_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtSYS_UserCreateTime_Enabled, 0, "text", "", 19, "chr", 1, "row", 19, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_SYS_User.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtSYS_UserModifyTime_Internalname, context.localUtil.TToC( A424SYS_UserModifyTime, 10, 8, 0, 0, "/", ":", " "), context.localUtil.Format( A424SYS_UserModifyTime, "9999/99/99 99:99:99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'YMD',8,24,'chs',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,78);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtSYS_UserModifyTime_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtSYS_UserModifyTime_Enabled, 0, "text", "", 19, "chr", 1, "row", 19, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_SYS_User.htm");
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20202271158993", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?20202271158104", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("sys_user.js", "?20202271158105", false);
