/*
       ...
       Generated on: 2/27/2020 11:56:4.10
   ...
   public class br_lab : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void Draw( )
      {
         ...
         if ( ! GxWebStd.gx_redirect( context) )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtBR_Lab_Age_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A262BR_Lab_Age), 3, 0, ".", "")), ((edtBR_Lab_Age_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(A262BR_Lab_Age), "ZZZ")) : context.localUtil.Format( (decimal)(A262BR_Lab_Age), "ZZZ")), TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,46);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtBR_Lab_Age_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtBR_Lab_Age_Enabled, 0, "number", "1", 3, "chr", 1, "row", 3, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_BR_Lab.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtBR_Lab_Diag_Internalname, A263BR_Lab_Diag, StringUtil.RTrim( context.localUtil.Format( A263BR_Lab_Diag, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,54);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtBR_Lab_Diag_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtBR_Lab_Diag_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 1, -1, -1, true, "", "left", true, "HLP_BR_Lab.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-8", "left", "top", "", "", "div");
            wb_table1_62_0G17( true) ;
         }
         return  ;
      }

      protected void wb_table1_62_0G17e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtBR_Lab_SpecimenDate_Internalname, context.localUtil.TToC( A105BR_Lab_SpecimenDate, 10, 8, 0, 0, "/", ":", " "), context.localUtil.Format( A105BR_Lab_SpecimenDate, "9999/99/99 99:99:99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'YMD',8,24,'chs',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,77);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtBR_Lab_SpecimenDate_Jsonclick, 0, "AttributeDateTime", "", "", "", "", 1, edtBR_Lab_SpecimenDate_Enabled, 0, "text", "", 19, "chr", 1, "row", 19, 0, 0, 0, 1, -1, 0, true, "DM_DataTime", "right", false, "HLP_BR_Lab.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtBR_Lab_ReceivingTime_Internalname, context.localUtil.TToC( A264BR_Lab_ReceivingTime, 10, 8, 0, 0, "/", ":", " "), context.localUtil.Format( A264BR_Lab_ReceivingTime, "9999/99/99 99:99:99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'YMD',8,24,'chs',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,86);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtBR_Lab_ReceivingTime_Jsonclick, 0, "AttributeDateTime", "", "", "", "", 1, edtBR_Lab_ReceivingTime_Enabled, 0, "text", "", 19, "chr", 1, "row", 19, 0, 0, 0, 1, -1, 0, true, "DM_DataTime", "right", false, "HLP_BR_Lab.htm");
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, dynBR_Lab_ResultQual, dynBR_Lab_ResultQual_Internalname, StringUtil.RTrim( A109BR_Lab_ResultQual), 1, dynBR_Lab_ResultQual_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "svchar", "", 1, dynBR_Lab_ResultQual.Enabled, 0, 0, 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,103);\"", "", true, "HLP_BR_Lab.htm");
            dynBR_Lab_ResultQual.CurrentValue = StringUtil.RTrim( A109BR_Lab_ResultQual);
            ...
            GxWebStd.gx_single_line_edit( context, edtBR_Lab_ResultUnit_Internalname, A111BR_Lab_ResultUnit, StringUtil.RTrim( context.localUtil.Format( A111BR_Lab_ResultUnit, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,112);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtBR_Lab_ResultUnit_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtBR_Lab_ResultUnit_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 1, -1, -1, true, "", "left", true, "HLP_BR_Lab.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, dynBR_Lab_AbnInd, dynBR_Lab_AbnInd_Internalname, StringUtil.RTrim( A112BR_Lab_AbnInd), 1, dynBR_Lab_AbnInd_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "svchar", "", 1, dynBR_Lab_AbnInd.Enabled, 0, 0, 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,120);\"", "", true, "HLP_BR_Lab.htm");
            dynBR_Lab_AbnInd.CurrentValue = StringUtil.RTrim( A112BR_Lab_AbnInd);
            ...
            GxWebStd.gx_single_line_edit( context, edtBR_Lab_NormRangeLow_Internalname, A113BR_Lab_NormRangeLow, StringUtil.RTrim( context.localUtil.Format( A113BR_Lab_NormRangeLow, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,129);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtBR_Lab_NormRangeLow_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtBR_Lab_NormRangeLow_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 1, -1, -1, true, "", "left", true, "HLP_BR_Lab.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtBR_Lab_TestMethod_Internalname, A115BR_Lab_TestMethod, StringUtil.RTrim( context.localUtil.Format( A115BR_Lab_TestMethod, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,138);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtBR_Lab_TestMethod_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtBR_Lab_TestMethod_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 1, -1, -1, true, "", "left", true, "HLP_BR_Lab.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtBR_Lab_InstrumentCode_Internalname, A118BR_Lab_InstrumentCode, StringUtil.RTrim( context.localUtil.Format( A118BR_Lab_InstrumentCode, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,146);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtBR_Lab_InstrumentCode_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtBR_Lab_InstrumentCode_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 1, -1, -1, true, "", "left", true, "HLP_BR_Lab.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            ClassString = "Attribute";
            StyleString = "";
            GxWebStd.gx_html_textarea( context, edtBR_Lab_InstrumentName_Internalname, A117BR_Lab_InstrumentName, "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,155);\"", 0, 1, edtBR_Lab_InstrumentName_Enabled, 0, 80, "chr", 3, "row", StyleString, ClassString, "", "", "200", -1, 0, "", "", -1, true, "", "'"+""+"'"+",false,"+"'"+""+"'", 0, "HLP_BR_Lab.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            ClassString = "Attribute";
            StyleString = "";
            GxWebStd.gx_html_textarea( context, edtBR_Lab_ResultNum_Internalname, A110BR_Lab_ResultNum, "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,163);\"", 0, 1, edtBR_Lab_ResultNum_Enabled, 0, 80, "chr", 7, "row", StyleString, ClassString, "", "", "500", -1, 0, "", "", -1, true, "", "'"+""+"'"+",false,"+"'"+""+"'", 0, "HLP_BR_Lab.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtBR_EncounterID_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A19BR_EncounterID), 18, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(A19BR_EncounterID), "ZZZZZZZZZZZZZZZZZZ")), TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,177);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtBR_EncounterID_Jsonclick, 0, "Attribute", "", "", "", "", edtBR_EncounterID_Visible, edtBR_EncounterID_Enabled, 1, "number", "1", 18, "chr", 1, "row", 18, 0, 0, 0, 1, -1, 0, true, "ID", "right", false, "HLP_BR_Lab.htm");
            /* Single line edit */
            ...
            GxWebStd.gx_single_line_edit( context, edtBR_Lab_TestID_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A102BR_Lab_TestID), 10, 0, ".", "")), ((edtBR_Lab_TestID_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(A102BR_Lab_TestID), "ZZZZZZZZZZ")) : context.localUtil.Format( (decimal)(A102BR_Lab_TestID), "ZZZZZZZZZZ")), TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,179);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtBR_Lab_TestID_Jsonclick, 0, "Attribute", "", "", "", "", edtBR_Lab_TestID_Visible, edtBR_Lab_TestID_Enabled, 0, "number", "1", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_BR_Lab.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 180,'',false,'',0)\"";
            GxWebStd.gx_single_line_edit( context, edtBR_Lab_NormRangeHigh_Internalname, A114BR_Lab_NormRangeHigh, StringUtil.RTrim( context.localUtil.Format( A114BR_Lab_NormRangeHigh, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,180);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtBR_Lab_NormRangeHigh_Jsonclick, 0, "Attribute", "", "", "", "", edtBR_Lab_NormRangeHigh_Visible, edtBR_Lab_NormRangeHigh_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 1, -1, -1, true, "", "left", true, "HLP_BR_Lab.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void wb_table1_62_0G17( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, dynBR_Lab_SpecimenSource, dynBR_Lab_SpecimenSource_Internalname, StringUtil.RTrim( A106BR_Lab_SpecimenSource), 1, dynBR_Lab_SpecimenSource_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "svchar", "", 1, dynBR_Lab_SpecimenSource.Enabled, 0, 0, 0, "em", 0, "", "", "Attribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,66);\"", "", true, "HLP_BR_Lab.htm");
            dynBR_Lab_SpecimenSource.CurrentValue = StringUtil.RTrim( A106BR_Lab_SpecimenSource);
            ...
            GxWebStd.gx_single_line_edit( context, edtavVsource_Internalname, AV15vSource, StringUtil.RTrim( context.localUtil.Format( AV15vSource, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,69);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "请填写其它标本种类", edtavVsource_Jsonclick, 0, "Attribute", "", "", "", "", edtavVsource_Visible, edtavVsource_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 1, -1, -1, true, "", "left", true, "HLP_BR_Lab.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_62_0G17e( true) ;
         }
         else
         {
            wb_table1_62_0G17e( false) ;
         }
      }
      ...
      protected void standaloneStartupServer( )
      {
         ...
         if ( AnyError == 0 )
         {
            if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
            {
               ...
               n224BR_Lab_SampleID = (String.IsNullOrEmpty(StringUtil.RTrim( A224BR_Lab_SampleID)) ? true : false);
               A103BR_Lab_TestCode = cgiGet( "Z103BR_Lab_TestCode");
               ...
               n224BR_Lab_SampleID = (String.IsNullOrEmpty(StringUtil.RTrim( A224BR_Lab_SampleID)) ? true : false);
               A103BR_Lab_TestCode = cgiGet( "BR_LAB_TESTCODE");
               n103BR_Lab_TestCode = (String.IsNullOrEmpty(StringUtil.RTrim( A103BR_Lab_TestCode)) ? true : false);
               ...
               forbiddenHiddens = forbiddenHiddens + StringUtil.RTrim( context.localUtil.Format( A103BR_Lab_TestCode, ""));
               ...
               if ( ( ! ( ( A101BR_LabID != Z101BR_LabID ) ) || ( StringUtil.StrCmp(Gx_mode, "INS") == 0 ) ) && ! GXUtil.CheckEncryptedHash( forbiddenHiddens, hsh, GXKey) )
               {
                  ...
                  GXUtil.WriteLog("br_lab:[SecurityCheckFailed value for]"+"BR_Lab_TestCode:"+StringUtil.RTrim( context.localUtil.Format( A103BR_Lab_TestCode, "")));
      ...
      protected void CheckExtendedTable0G17( )
      {
         ...
         {
            GX_msglist.addItem("域������������超界", "OutOfRange", 1, "BR_LAB_SPECIMENDATE");
            AnyError = 1;
            GX_FocusControl = edtBR_Lab_SpecimenDate_Internalname;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "GX_FocusControl", GX_FocusControl);
         }
         ...
         {
            GX_msglist.addItem("域������������超界", "OutOfRange", 1, "BR_LAB_RECEIVINGTIME");
            AnyError = 1;
            GX_FocusControl = edtBR_Lab_ReceivingTime_Internalname;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "GX_FocusControl", GX_FocusControl);
         }
         ...
         {
            GX_msglist.addItem("域������������超界", "OutOfRange", 1, "BR_LAB_REPORTTIME");
            AnyError = 1;
            GX_FocusControl = edtBR_Lab_ReportTime_Internalname;
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "GX_FocusControl", GX_FocusControl);
         }
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202022711561283", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GXUtil.WriteLog("br_lab:[SendSecurityCheck value for]"+"BR_Lab_TestCode:"+StringUtil.RTrim( context.localUtil.Format( A103BR_Lab_TestCode, "")));
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "BR_LAB_TESTCODE", A103BR_Lab_TestCode);
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202022711561353", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("br_lab.js", "?202022711561354", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'Gx_mode',fld:'vMODE',pic:'@!',hsh:true},{av:'AV12BR_LabID',fld:'vBR_LABID',pic:'ZZZZZZZZZZZZZZZZZZ',hsh:true},{av:'A101BR_LabID',fld:'BR_LABID',pic:'ZZZZZZZZZZZZZZZZZZ'},{av:'AV16tCurrentCode',fld:'vTCURRENTCODE',pic:''},{av:'AV10Insert_BR_EncounterID',fld:'vINSERT_BR_ENCOUNTERID',pic:'ZZZZZZZZZZZZZZZZZZ'},{av:'A224BR_Lab_SampleID',fld:'BR_LAB_SAMPLEID',pic:''},{av:'A103BR_Lab_TestCode',fld:'BR_LAB_TESTCODE',pic:''},{av:'A430BR_SampleId',fld:'BR_SAMPLEID',pic:'ZZZZZZZZZZZZZZZZZZ'}]");
