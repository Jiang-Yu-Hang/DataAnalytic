/*!   GeneXus C# 16_0_0-127771 on 2/27/2020 12:6:55.58
*/
gx.evt.autoSkip = false;
gx.define('br_medicalimaging_diaginsert', false, function () {
   this.ServerClass =  "br_medicalimaging_diaginsert" ;
   ...
   this.SetStandaloneVars=function()
   {
      ...
      this.AV12BR_MedicalImagingID=gx.fn.getIntegerValue("vBR_MEDICALIMAGINGID",',') ;
   };
   this.e138w2_client=function()
   {
      return this.executeServerEvent("ENTER", true, null, false, false);
   };
   this.e158w1_client=function()
   {
   ...
   this.GXV5 = 0 ;
   this.GXV6 = 0 ;
   this.AV12BR_MedicalImagingID = 0 ;
   ...
   this.Events = {"e138w2_client": ["ENTER", true] ,"e158w1_client": ["CANCEL", true]};
   this.EvtParms["REFRESH"] = [[{av:'AV12BR_MedicalImagingID',fld:'vBR_MEDICALIMAGINGID',pic:'ZZZZZZZZZZZZZZZZZZ',hsh:true}],[]];
   this.EvtParms["START"] = [[],[{ctrl:'BR_MEDICALIMAGING_DIAG_BR_MEDICALIMAGING_DIAGID',prop:'Visible'},{ctrl:'BR_MEDICALIMAGING_DIAG_BR_MEDICALIMAGINGID',prop:'Visible'}]];
   this.EvtParms["ENTER"] = [[{av:'AV10BR_MedicalImaging_Diag',fld:'vBR_MEDICALIMAGING_DIAG',pic:''},{av:'AV12BR_MedicalImagingID',fld:'vBR_MEDICALIMAGINGID',pic:'ZZZZZZZZZZZZZZZZZZ',hsh:true}],[{av:'AV10BR_MedicalImaging_Diag',fld:'vBR_MEDICALIMAGING_DIAG',pic:''}]];
   this.EnterCtrl = ["BTNENTER"];
   this.setVCMap("AV10BR_MedicalImaging_Diag", "vBR_MEDICALIMAGING_DIAG", 0, "BR_MedicalImaging_Diag", 0, 0);
   this.setVCMap("AV12BR_MedicalImagingID", "vBR_MEDICALIMAGINGID", 0, "int", 18, 0);
...
gx.createParentObj(br_medicalimaging_diaginsert);
