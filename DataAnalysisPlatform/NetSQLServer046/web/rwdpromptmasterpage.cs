/*
       ...
       Generated on: 2/27/2020 11:58:15.51
...
namespace GeneXus.Programs {
   public class rwdpromptmasterpage : GXMasterPage, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlCloseForm062( )
      {
         ...
         context.AddJavascriptSource("rwdpromptmasterpage.js", "?202022711581552", false);
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)(getDataAreaObject() == null ? Form : getDataAreaObject().GetForm()).Jscriptsrc.Item(idxLst))), "?202022711581557", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("rwdpromptmasterpage.js", "?202022711581557", false);
         }
