/*
               File: BR_EncounterCheckBR_LabWC
        Description: Data Mgmt Portal - RAAP
             Author: GeneXus C# Generator version 16_0_0-127771
       Generated on: 2/27/2020 11:54:24.55
...
namespace GeneXus.Programs {
   public class br_encountercheckbr_labwc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      public br_encountercheckbr_labwc( )
      {
      ...
      public br_encountercheckbr_labwc( IGxContext context )
      {
         ...
         if ( StringUtil.Len( (String)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
               {
                  ...
                  AV65IsAuthorized_Display = StringUtil.StrToBool( GetNextPar( ));
                  sPrefix = GetNextPar( );
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV83Pgmname = "BR_EncounterCheckBR_LabWC";
               context.Gx_err = 0;
               WS412( ) ;
               if ( ! isAjaxCallMode( ) )
               {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202022711542477", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.skipLines(1);
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("br_encountercheckbr_labwc.aspx") + "?" + UrlEncode("" +AV8BR_EncounterID)+"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"vGRIDRECORDCOUNT", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV58GridRecordCount), 10, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"vGRIDPAGESIZE", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV57GridPageSize), 10, 0, ".", "")));
         if ( context.isAjaxRequest( ) )
         {
         ...
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vISAUTHORIZED_DISPLAY", AV65IsAuthorized_Display);
      ...
      protected void RenderHtmlCloseForm412( )
      {
         ...
         {
            context.AddJavascriptSource("br_encountercheckbr_labwc.js", "?202022711542782", false);
         }
      ...
      {
         return "BR_EncounterCheckBR_LabWC" ;
      }
      ...
      protected void WB410( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "br_encountercheckbr_labwc.aspx");
               context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false);
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
               context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false);
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
         ...
         if ( wbEnd == 12 )
         {
            ...
            ClassString = "Attribute";
            StyleString = "";
            GxWebStd.gx_html_textarea( context, edtavDdo_br_lab_testnametitlecontrolidtoreplace_Internalname, AV24ddo_BR_Lab_TestNameTitleControlIdToReplace, "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,29);\"", 0, edtavDdo_br_lab_testnametitlecontrolidtoreplace_Visible, 1, 0, 80, "chr", 4, "row", StyleString, ClassString, "", "", "300", -1, 0, "", "", -1, true, "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", 0, "HLP_BR_EncounterCheckBR_LabWC.htm");
            /* User Defined Control */
            ...
            ClassString = "Attribute";
            StyleString = "";
            GxWebStd.gx_html_textarea( context, edtavDdo_br_lab_specimensourcetitlecontrolidtoreplace_Internalname, AV28ddo_BR_Lab_SpecimenSourceTitleControlIdToReplace, "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,31);\"", 0, edtavDdo_br_lab_specimensourcetitlecontrolidtoreplace_Visible, 1, 0, 80, "chr", 4, "row", StyleString, ClassString, "", "", "300", -1, 0, "", "", -1, true, "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", 0, "HLP_BR_EncounterCheckBR_LabWC.htm");
            /* User Defined Control */
            ...
            ClassString = "Attribute";
            StyleString = "";
            GxWebStd.gx_html_textarea( context, edtavDdo_br_lab_specimendatetitlecontrolidtoreplace_Internalname, AV26ddo_BR_Lab_SpecimenDateTitleControlIdToReplace, "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,33);\"", 0, edtavDdo_br_lab_specimendatetitlecontrolidtoreplace_Visible, 1, 0, 80, "chr", 4, "row", StyleString, ClassString, "", "", "300", -1, 0, "", "", -1, true, "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", 0, "HLP_BR_EncounterCheckBR_LabWC.htm");
            /* User Defined Control */
            ...
            GxWebStd.gx_single_line_edit( context, edtavOrderedby_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV14OrderedBy), 4, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV14OrderedBy), "ZZZ9")), TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,38);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavOrderedby_Jsonclick, 0, "Attribute", "", "", "", "", edtavOrderedby_Visible, 1, 0, "number", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_BR_EncounterCheckBR_LabWC.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 39,'" + sPrefix + "',false,'" + sGXsfl_12_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavOrdereddsc_Internalname, StringUtil.BoolToStr( AV15OrderedDsc), StringUtil.BoolToStr( AV15OrderedDsc), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,39);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavOrdereddsc_Jsonclick, 0, "Attribute", "", "", "", "", edtavOrdereddsc_Visible, 1, 0, "text", "", 4, "chr", 1, "row", 4, 0, 0, 0, 1, 0, 0, true, "", "right", false, "HLP_BR_EncounterCheckBR_LabWC.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtavDisplay_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV63Display)) ? AV82Display_GXI : context.convertURL( context.PathToRelativeUrl( AV63Display))), !bGXsfl_12_Refreshing);
      ...
      protected void RF412( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A19BR_EncounterID = H00412_A19BR_EncounterID[0];
               ...
               A112BR_Lab_AbnInd = H00412_A112BR_Lab_AbnInd[0];
               n112BR_Lab_AbnInd = H00412_n112BR_Lab_AbnInd[0];
               A105BR_Lab_SpecimenDate = H00412_A105BR_Lab_SpecimenDate[0];
               n105BR_Lab_SpecimenDate = H00412_n105BR_Lab_SpecimenDate[0];
               A106BR_Lab_SpecimenSource = H00412_A106BR_Lab_SpecimenSource[0];
               n106BR_Lab_SpecimenSource = H00412_n106BR_Lab_SpecimenSource[0];
               A104BR_Lab_TestName = H00412_A104BR_Lab_TestName[0];
               n104BR_Lab_TestName = H00412_n104BR_Lab_TestName[0];
               A101BR_LabID = H00412_A101BR_LabID[0];
               E20412 ();
      ...
      protected void STRUP410( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            AV58GridRecordCount = (long)(context.localUtil.CToN( cgiGet( sPrefix+"vGRIDRECORDCOUNT"), ".", ","));
            AV57GridPageSize = (long)(context.localUtil.CToN( cgiGet( sPrefix+"vGRIDPAGESIZE"), ".", ","));
      ...
      protected void E19412( )
      {
         ...
         context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtBR_LabID_Internalname, "Title", edtBR_LabID_Title, !bGXsfl_12_Refreshing);
         ...
         context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtBR_Lab_TestName_Internalname, "Title", edtBR_Lab_TestName_Title, !bGXsfl_12_Refreshing);
         ...
         context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtBR_Lab_SpecimenSource_Internalname, "Title", edtBR_Lab_SpecimenSource_Title, !bGXsfl_12_Refreshing);
         ...
         context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtBR_Lab_SpecimenDate_Internalname, "Title", edtBR_Lab_SpecimenDate_Title, !bGXsfl_12_Refreshing);
         ...
         context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtBR_Lab_AbnInd_Internalname, "Title", edtBR_Lab_AbnInd_Title, !bGXsfl_12_Refreshing);
         ...
         context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "AV57GridPageSize", StringUtil.LTrim( StringUtil.Str( (decimal)(AV57GridPageSize), 10, 0)));
         AV58GridRecordCount = subGrid_Recordcount( );
         context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "AV58GridRecordCount", StringUtil.LTrim( StringUtil.Str( (decimal)(AV58GridRecordCount), 10, 0)));
      ...
      private void E20412( )
      {
         ...
         AV82Display_GXI = GXDbFile.PathToUrl( context.GetImagePath( "f11923b6-6acd-4a79-bfc0-0cfc6f3bced5", "", context.GetTheme( )));
      ...
      protected void S132( )
      {
         ...
         GXt_boolean2 = AV65IsAuthorized_Display;
         new GeneXus.Programs.wwpbaseobjects.secisauthbyfunctionalitykey(context ).execute(  "Manage_Lab", out  GXt_boolean2) ;
         AV65IsAuthorized_Display = GXt_boolean2;
         context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "AV65IsAuthorized_Display", AV65IsAuthorized_Display);
         if ( ! ( AV65IsAuthorized_Display ) )
         {
      ...
      protected void S122( )
      {
         ...
         {
            AV12GridState.FromXml(new GeneXus.Programs.wwpbaseobjects.loadgridstate(context).executeUdp(  AV83Pgmname+"GridState"), null, "WWPGridState", "DataAnalysisPlatform");
         }
         else
         {
            AV12GridState.FromXml(AV16Session.Get(AV83Pgmname+"GridState"), null, "WWPGridState", "DataAnalysisPlatform");
         }
      ...
      protected void S142( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.savegridstate(context ).execute(  AV83Pgmname+"GridState",  AV12GridState.ToXml(false, true, "WWPGridState", "DataAnalysisPlatform")) ;
      }
      ...
      protected void S112( )
      {
         ...
         AV10TrnContext.gxTpr_Callerobject = AV83Pgmname;
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "br_encountercheckbr_labwc", GetJustCreated( ));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202022711544094", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("br_encountercheckbr_labwc.js", "?202022711544094", false);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
      ...
      protected void SubsflControlProps_122( )
      {
         ...
         edtBR_LabID_Internalname = sPrefix+"BR_LABID_"+sGXsfl_12_idx;
         edtBR_Lab_TestName_Internalname = sPrefix+"BR_LAB_TESTNAME_"+sGXsfl_12_idx;
         edtBR_Lab_SpecimenSource_Internalname = sPrefix+"BR_LAB_SPECIMENSOURCE_"+sGXsfl_12_idx;
         edtBR_Lab_SpecimenDate_Internalname = sPrefix+"BR_LAB_SPECIMENDATE_"+sGXsfl_12_idx;
         edtBR_Lab_AbnInd_Internalname = sPrefix+"BR_LAB_ABNIND_"+sGXsfl_12_idx;
      }

      protected void SubsflControlProps_fel_122( )
      {
         edtavDisplay_Internalname = sPrefix+"vDISPLAY_"+sGXsfl_12_fel_idx;
         edtBR_LabID_Internalname = sPrefix+"BR_LABID_"+sGXsfl_12_fel_idx;
         edtBR_Lab_TestName_Internalname = sPrefix+"BR_LAB_TESTNAME_"+sGXsfl_12_fel_idx;
         edtBR_Lab_SpecimenSource_Internalname = sPrefix+"BR_LAB_SPECIMENSOURCE_"+sGXsfl_12_fel_idx;
         edtBR_Lab_SpecimenDate_Internalname = sPrefix+"BR_LAB_SPECIMENDATE_"+sGXsfl_12_fel_idx;
         edtBR_Lab_AbnInd_Internalname = sPrefix+"BR_LAB_ABNIND_"+sGXsfl_12_fel_idx;
      }
      ...
      protected void sendrow_122( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_12_idx <= subGrid_Recordsperpage( ) * 1 ) )
         {
            ...
            StyleString = "";
            AV63Display_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV63Display))&&String.IsNullOrEmpty(StringUtil.RTrim( AV82Display_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV63Display)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV63Display)) ? AV82Display_GXI : context.PathToRelativeUrl( AV63Display));
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("DDO_BR_LAB_TESTNAME.ONOPTIONCLICKED","{handler:'E14412',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV8BR_EncounterID',fld:'vBR_ENCOUNTERID',pic:'ZZZZZZZZZZZZZZZZZZ'},{av:'AV18ddo_BR_LabIDTitleControlIdToReplace',fld:'vDDO_BR_LABIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV24ddo_BR_Lab_TestNameTitleControlIdToReplace',fld:'vDDO_BR_LAB_TESTNAMETITLECONTROLIDTOREPLACE',pic:''},{av:'AV28ddo_BR_Lab_SpecimenSourceTitleControlIdToReplace',fld:'vDDO_BR_LAB_SPECIMENSOURCETITLECONTROLIDTOREPLACE',pic:''},{av:'AV26ddo_BR_Lab_SpecimenDateTitleControlIdToReplace',fld:'vDDO_BR_LAB_SPECIMENDATETITLECONTROLIDTOREPLACE',pic:''},{av:'AV40ddo_BR_Lab_AbnIndTitleControlIdToReplace',fld:'vDDO_BR_LAB_ABNINDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV83Pgmname',fld:'vPGMNAME',pic:''},{av:'AV65IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:''},{av:'sPrefix'},{av:'Ddo_br_lab_testname_Activeeventkey',ctrl:'DDO_BR_LAB_TESTNAME',prop:'ActiveEventKey'}]");
         ...
         setEventMetadata("DDO_BR_LAB_SPECIMENSOURCE.ONOPTIONCLICKED","{handler:'E15412',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV8BR_EncounterID',fld:'vBR_ENCOUNTERID',pic:'ZZZZZZZZZZZZZZZZZZ'},{av:'AV18ddo_BR_LabIDTitleControlIdToReplace',fld:'vDDO_BR_LABIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV24ddo_BR_Lab_TestNameTitleControlIdToReplace',fld:'vDDO_BR_LAB_TESTNAMETITLECONTROLIDTOREPLACE',pic:''},{av:'AV28ddo_BR_Lab_SpecimenSourceTitleControlIdToReplace',fld:'vDDO_BR_LAB_SPECIMENSOURCETITLECONTROLIDTOREPLACE',pic:''},{av:'AV26ddo_BR_Lab_SpecimenDateTitleControlIdToReplace',fld:'vDDO_BR_LAB_SPECIMENDATETITLECONTROLIDTOREPLACE',pic:''},{av:'AV40ddo_BR_Lab_AbnIndTitleControlIdToReplace',fld:'vDDO_BR_LAB_ABNINDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV83Pgmname',fld:'vPGMNAME',pic:''},{av:'AV65IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:''},{av:'sPrefix'},{av:'Ddo_br_lab_specimensource_Activeeventkey',ctrl:'DDO_BR_LAB_SPECIMENSOURCE',prop:'ActiveEventKey'}]");
         ...
         setEventMetadata("DDO_BR_LAB_SPECIMENDATE.ONOPTIONCLICKED","{handler:'E16412',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV8BR_EncounterID',fld:'vBR_ENCOUNTERID',pic:'ZZZZZZZZZZZZZZZZZZ'},{av:'AV18ddo_BR_LabIDTitleControlIdToReplace',fld:'vDDO_BR_LABIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV24ddo_BR_Lab_TestNameTitleControlIdToReplace',fld:'vDDO_BR_LAB_TESTNAMETITLECONTROLIDTOREPLACE',pic:''},{av:'AV28ddo_BR_Lab_SpecimenSourceTitleControlIdToReplace',fld:'vDDO_BR_LAB_SPECIMENSOURCETITLECONTROLIDTOREPLACE',pic:''},{av:'AV26ddo_BR_Lab_SpecimenDateTitleControlIdToReplace',fld:'vDDO_BR_LAB_SPECIMENDATETITLECONTROLIDTOREPLACE',pic:''},{av:'AV40ddo_BR_Lab_AbnIndTitleControlIdToReplace',fld:'vDDO_BR_LAB_ABNINDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV83Pgmname',fld:'vPGMNAME',pic:''},{av:'AV65IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:''},{av:'sPrefix'},{av:'Ddo_br_lab_specimendate_Activeeventkey',ctrl:'DDO_BR_LAB_SPECIMENDATE',prop:'ActiveEventKey'}]");
         ...
         setEventMetadata("DDO_BR_LAB_ABNIND.ONOPTIONCLICKED","{handler:'E17412',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV8BR_EncounterID',fld:'vBR_ENCOUNTERID',pic:'ZZZZZZZZZZZZZZZZZZ'},{av:'AV18ddo_BR_LabIDTitleControlIdToReplace',fld:'vDDO_BR_LABIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV24ddo_BR_Lab_TestNameTitleControlIdToReplace',fld:'vDDO_BR_LAB_TESTNAMETITLECONTROLIDTOREPLACE',pic:''},{av:'AV28ddo_BR_Lab_SpecimenSourceTitleControlIdToReplace',fld:'vDDO_BR_LAB_SPECIMENSOURCETITLECONTROLIDTOREPLACE',pic:''},{av:'AV26ddo_BR_Lab_SpecimenDateTitleControlIdToReplace',fld:'vDDO_BR_LAB_SPECIMENDATETITLECONTROLIDTOREPLACE',pic:''},{av:'AV40ddo_BR_Lab_AbnIndTitleControlIdToReplace',fld:'vDDO_BR_LAB_ABNINDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV83Pgmname',fld:'vPGMNAME',pic:''},{av:'AV65IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:''},{av:'sPrefix'},{av:'Ddo_br_lab_abnind_Activeeventkey',ctrl:'DDO_BR_LAB_ABNIND',prop:'ActiveEventKey'}]");
         ...
         setEventMetadata("GRID.LOAD","{handler:'E20412',iparms:[{av:'AV65IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:''},{av:'A101BR_LabID',fld:'BR_LABID',pic:'ZZZZZZZZZZZZZZZZZZ'}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'AV63Display',fld:'vDISPLAY',pic:''},{av:'edtavDisplay_Tooltiptext',ctrl:'vDISPLAY',prop:'Tooltiptext'},{av:'edtavDisplay_Link',ctrl:'vDISPLAY',prop:'Link'}]}");
         return  ;
      }
      ...
      public override void initialize( )
      {
         ...
         AV82Display_GXI = "";
         scmdbuf = "";
         H00412_A19BR_EncounterID = new long[1] ;
         H00412_A112BR_Lab_AbnInd = new String[] {""} ;
         H00412_n112BR_Lab_AbnInd = new bool[] {false} ;
         H00412_A105BR_Lab_SpecimenDate = new DateTime[] {DateTime.MinValue} ;
         H00412_n105BR_Lab_SpecimenDate = new bool[] {false} ;
         H00412_A106BR_Lab_SpecimenSource = new String[] {""} ;
         H00412_n106BR_Lab_SpecimenSource = new bool[] {false} ;
         H00412_A104BR_Lab_TestName = new String[] {""} ;
         H00412_n104BR_Lab_TestName = new bool[] {false} ;
         H00412_A101BR_LabID = new long[1] ;
         ...
         sImgUrl = "";
         ROClassString = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.br_encountercheckbr_labwc__default(),
            new Object[][] {
                new Object[] {
               H00412_A19BR_EncounterID, H00412_A112BR_Lab_AbnInd, H00412_n112BR_Lab_AbnInd, H00412_A105BR_Lab_SpecimenDate, H00412_n105BR_Lab_SpecimenDate, H00412_A106BR_Lab_SpecimenSource, H00412_n106BR_Lab_SpecimenSource, H00412_A104BR_Lab_TestName, H00412_n104BR_Lab_TestName, H00412_A101BR_LabID
               }
               , new Object[] {
      ...
      private long[] H00412_A19BR_EncounterID ;
      private String[] H00412_A112BR_Lab_AbnInd ;
      private bool[] H00412_n112BR_Lab_AbnInd ;
      private DateTime[] H00412_A105BR_Lab_SpecimenDate ;
      private bool[] H00412_n105BR_Lab_SpecimenDate ;
      private String[] H00412_A106BR_Lab_SpecimenSource ;
      private bool[] H00412_n106BR_Lab_SpecimenSource ;
      private String[] H00412_A104BR_Lab_TestName ;
      private bool[] H00412_n104BR_Lab_TestName ;
      private long[] H00412_A101BR_LabID ;
   ...
   public class br_encountercheckbr_labwc__default : DataStoreHelperBase, IDataStoreHelper
   {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H00412(context, (short)dynConstraints[0] , (bool)dynConstraints[1] , (long)dynConstraints[2] , (long)dynConstraints[3] );
               case 1 :
                     return conditional_H00413(context, (short)dynConstraints[0] , (bool)dynConstraints[1] , (long)dynConstraints[2] , (long)dynConstraints[3] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H00412", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00412,11,0,true,false )
             ,new CursorDef("H00413", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00413,1,0,true,false )
          };
       }
    }
