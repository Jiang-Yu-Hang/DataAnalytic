/*
       ...
       Generated on: 2/27/2020 11:58:3.0
...
namespace GeneXus.Programs {
   public class br_encounter_refusereasongeneral : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2020227115834", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void RenderHtmlCloseForm7F2( )
      {
         ...
         {
            context.AddJavascriptSource("br_encounter_refusereasongeneral.js", "?2020227115836", false);
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?20202271158364", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("br_encounter_refusereasongeneral.js", "?20202271158364", false);
