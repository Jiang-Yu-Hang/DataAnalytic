...
namespace GeneXus.Programs{
	...
	[XmlType(TypeName="QueryViewerItemClickData.Element" , Namespace="DataAnalysisPlatform" )]
	[Serializable]
	...
	[DataContract(Name=@"QueryViewerItemClickData.Element", Namespace="DataAnalysisPlatform")]
