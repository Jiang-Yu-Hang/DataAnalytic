/*
       ...
       Generated on: 2/27/2020 11:58:11.79
   ...
   public class bas_institute : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void Draw( )
      {
         ...
         if ( ! GxWebStd.gx_redirect( context) )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtBAS_InstituteCreateTime_Internalname, context.localUtil.TToC( A389BAS_InstituteCreateTime, 10, 8, 0, 0, "/", ":", " "), context.localUtil.Format( A389BAS_InstituteCreateTime, "9999/99/99 99:99:99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'YMD',8,24,'chs',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,48);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtBAS_InstituteCreateTime_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtBAS_InstituteCreateTime_Enabled, 0, "text", "", 19, "chr", 1, "row", 19, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_BAS_Institute.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtBAS_InstituteModifyTime_Internalname, context.localUtil.TToC( A391BAS_InstituteModifyTime, 10, 8, 0, 0, "/", ":", " "), context.localUtil.Format( A391BAS_InstituteModifyTime, "9999/99/99 99:99:99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'YMD',8,24,'chs',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,58);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtBAS_InstituteModifyTime_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtBAS_InstituteModifyTime_Enabled, 0, "text", "", 19, "chr", 1, "row", 19, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_BAS_Institute.htm");
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202022711581299", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?20202271158136", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("bas_institute.js", "?20202271158137", false);
