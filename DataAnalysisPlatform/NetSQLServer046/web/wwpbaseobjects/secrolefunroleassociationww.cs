/*
               File: WWPBaseObjects.SecRoleFunRoleAssociationWW
        Description: 权限相关
             Author: GeneXus C# Generator version 16_0_0-127771
       Generated on: 2/27/2020 11:58:29.11
...
namespace GeneXus.Programs.wwpbaseobjects {
   public class secrolefunroleassociationww : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               AV38OrderedBy = (short)(NumberUtil.Val( GetNextPar( ), "."));
               AV39OrderedDsc = StringUtil.StrToBool( GetNextPar( ));
               AV62ddo_SecFunctionalityKeyTitleControlIdToReplace = GetNextPar( );
               AV66ddo_SecFunctionalityDescriptionTitleControlIdToReplace = GetNextPar( );
               ...
               AV34SecRoleIdParm = (short)(NumberUtil.Val( GetNextPar( ), "."));
               setAjaxCallMode();
               if ( ! IsValidAjaxCall( true) )
               {
                  GxWebError = 1;
               ...
               gxgrGrid_refresh( subGrid_Rows, AV25SecFunctionalityKey, AV38OrderedBy, AV39OrderedDsc, AV62ddo_SecFunctionalityKeyTitleControlIdToReplace, AV66ddo_SecFunctionalityDescriptionTitleControlIdToReplace, AV13SecFunctionalityIdRemovedXml, AV12SecFunctionalityIdAddedXml, AV9SecRoleId, A4SecRoleId, AV21i, AV11SecFunctionalityIdRemoved, AV15SecFunctionalityIdToFind, AV10SecFunctionalityIdAdded, AV34SecRoleIdParm) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202022711582928", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wwpbaseobjects.secrolefunroleassociationww.aspx") + "?" + UrlEncode("" +AV9SecRoleId)+"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vORDEREDBY", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV38OrderedBy), 4, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "GXH_vORDEREDDSC", StringUtil.BoolToStr( AV39OrderedDsc));
         /* Send saved values. */
         ...
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "vSECFUNCTIONALITYKEYTITLEFILTERDATA", AV59SecFunctionalityKeyTitleFilterData);
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt("vSECFUNCTIONALITYKEYTITLEFILTERDATA", AV59SecFunctionalityKeyTitleFilterData);
         }
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "vSECFUNCTIONALITYDESCRIPTIONTITLEFILTERDATA", AV63SecFunctionalityDescriptionTitleFilterData);
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt("vSECFUNCTIONALITYDESCRIPTIONTITLEFILTERDATA", AV63SecFunctionalityDescriptionTitleFilterData);
         }
         ...
         GxWebStd.gx_hidden_field( context, "vSECROLEIDPARM", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV34SecRoleIdParm), 4, 0, ".", "")));
         if ( context.isAjaxRequest( ) )
         {
      ...
      {
         return formatLink("wwpbaseobjects.secrolefunroleassociationww.aspx") + "?" + UrlEncode("" +AV9SecRoleId) ;
      }
      ...
      protected void WB0M0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "left", "top", " "+"data-gx-base-lib=\"bootstrapv3\""+" "+"data-abstract-form"+" ", "", "div");
            wb_table1_14_0M2( true) ;
         }
         else
         {
            wb_table1_14_0M2( false) ;
         }
         return  ;
      }

      protected void wb_table1_14_0M2e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            else
            {
               ...
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", context.convertURL( AV29UAViewChildren));
         ...
         if ( wbEnd == 25 )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnconfirm_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(25), 2, 0)+","+"null"+");", "保存", bttBtnconfirm_Jsonclick, 5, "确认", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"EENTER."+"'", TempTags, "", context.GetButtonType( ), "HLP_WWPBaseObjects\\SecRoleFunRoleAssociationWW.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtncancel_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(25), 2, 0)+","+"null"+");", "取消", bttBtncancel_Jsonclick, 1, "取消", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", context.GetButtonType( ), "HLP_WWPBaseObjects\\SecRoleFunRoleAssociationWW.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            ucDdo_secfunctionalitykey.SetProperty("DropDownOptionsTitleSettingsIcons", AV74DDO_TitleSettingsIcons);
            ucDdo_secfunctionalitykey.SetProperty("DropDownOptionsData", AV59SecFunctionalityKeyTitleFilterData);
            ...
            /* Multiple line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 51,'',false,'" + sGXsfl_25_idx + "',0)\"";
            ClassString = "Attribute";
            StyleString = "";
            ClassString = "Attribute";
            StyleString = "";
            GxWebStd.gx_html_textarea( context, edtavDdo_secfunctionalitykeytitlecontrolidtoreplace_Internalname, AV62ddo_SecFunctionalityKeyTitleControlIdToReplace, "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,51);\"", 0, edtavDdo_secfunctionalitykeytitlecontrolidtoreplace_Visible, 1, 0, 80, "chr", 4, "row", StyleString, ClassString, "", "", "300", -1, 0, "", "", -1, true, "", "'"+""+"'"+",false,"+"'"+""+"'", 0, "HLP_WWPBaseObjects\\SecRoleFunRoleAssociationWW.htm");
            /* User Defined Control */
            ...
            ucDdo_secfunctionalitydescription.SetProperty("DropDownOptionsTitleSettingsIcons", AV74DDO_TitleSettingsIcons);
            ucDdo_secfunctionalitydescription.SetProperty("DropDownOptionsData", AV63SecFunctionalityDescriptionTitleFilterData);
            ...
            ClassString = "Attribute";
            StyleString = "";
            GxWebStd.gx_html_textarea( context, edtavDdo_secfunctionalitydescriptiontitlecontrolidtoreplace_Internalname, AV66ddo_SecFunctionalityDescriptionTitleControlIdToReplace, "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,53);\"", 0, edtavDdo_secfunctionalitydescriptiontitlecontrolidtoreplace_Visible, 1, 0, 80, "chr", 4, "row", StyleString, ClassString, "", "", "300", -1, 0, "", "", -1, true, "", "'"+""+"'"+",false,"+"'"+""+"'", 0, "HLP_WWPBaseObjects\\SecRoleFunRoleAssociationWW.htm");
            /* Multiple line edit */
            ...
            ClassString = "Attribute";
            StyleString = "";
            GxWebStd.gx_html_textarea( context, edtavSecfunctionalityidaddedxml_Internalname, AV12SecFunctionalityIdAddedXml, "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,54);\"", 0, edtavSecfunctionalityidaddedxml_Visible, 1, 0, 80, "chr", 10, "row", StyleString, ClassString, "", "", "2097152", -1, 0, "", "", -1, true, "", "'"+""+"'"+",false,"+"'"+""+"'", 0, "HLP_WWPBaseObjects\\SecRoleFunRoleAssociationWW.htm");
            /* Multiple line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 55,'',false,'" + sGXsfl_25_idx + "',0)\"";
            ClassString = "Attribute";
            StyleString = "";
            ClassString = "Attribute";
            StyleString = "";
            GxWebStd.gx_html_textarea( context, edtavSecfunctionalityidremovedxml_Internalname, AV13SecFunctionalityIdRemovedXml, "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,55);\"", 0, edtavSecfunctionalityidremovedxml_Visible, 1, 0, 80, "chr", 10, "row", StyleString, ClassString, "", "", "2097152", -1, 0, "", "", -1, true, "", "'"+""+"'"+",false,"+"'"+""+"'", 0, "HLP_WWPBaseObjects\\SecRoleFunRoleAssociationWW.htm");
            /* User Defined Control */
            ucWorkwithplusutilities1.Render(context, "dvelop.workwithplusutilities", Workwithplusutilities1_Internalname, "WORKWITHPLUSUTILITIES1Container");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 57,'',false,'" + sGXsfl_25_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavSecfunctionalityid_selected_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV33SecFunctionalityId_Selected), 10, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV33SecFunctionalityId_Selected), "ZZZZZZZZZ9")), TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,57);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavSecfunctionalityid_selected_Jsonclick, 0, "Attribute", "", "", "", "", edtavSecfunctionalityid_selected_Visible, 1, 0, "number", "1", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_WWPBaseObjects\\SecRoleFunRoleAssociationWW.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 58,'',false,'" + sGXsfl_25_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavOrderedby_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV38OrderedBy), 4, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV38OrderedBy), "ZZZ9")), TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,58);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavOrderedby_Jsonclick, 0, "Attribute", "", "", "", "", edtavOrderedby_Visible, 1, 0, "number", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_WWPBaseObjects\\SecRoleFunRoleAssociationWW.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 59,'',false,'" + sGXsfl_25_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavOrdereddsc_Internalname, StringUtil.BoolToStr( AV39OrderedDsc), StringUtil.BoolToStr( AV39OrderedDsc), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,59);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavOrdereddsc_Jsonclick, 0, "Attribute", "", "", "", "", edtavOrdereddsc_Visible, 1, 0, "text", "", 4, "chr", 1, "row", 4, 0, 0, 0, 1, 0, 0, true, "", "right", false, "HLP_WWPBaseObjects\\SecRoleFunRoleAssociationWW.htm");
            wb_table2_60_0M2( true) ;
         }
         else
         {
            wb_table2_60_0M2( false) ;
         }
         return  ;
      }

      protected void wb_table2_60_0M2e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START0M2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "权限相关", 0) ;
         }
         context.wjLoc = "";
                  ...
                  if ( StringUtil.StrCmp(sEvtType, "M") != 0 )
                  {
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                        {
                           ...
                           else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                           {
                              ...
                              if ( ! wbErr )
                              {
                                 ...
                                 if ( ( context.localUtil.CToN( cgiGet( "GXH_vORDEREDBY"), ".", ",") != Convert.ToDecimal( AV38OrderedBy )) )
                                 {
                                    Rfr0gs = true;
                                 }
                                 /* Set Refresh If Ordereddsc Changed */
                                 if ( StringUtil.StrToBool( cgiGet( "GXH_vORDEREDDSC")) != AV39OrderedDsc )
                                 {
                                    Rfr0gs = true;
                                 }
                                 if ( ! Rfr0gs )
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 18), "'DOUAVIEWCHILDREN'") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 19), "VISASSOCIATED.CLICK") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 19), "VISASSOCIATED.CLICK") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 18), "'DOUAVIEWCHILDREN'") == 0 ) )
                           {
                              ...
                              AV29UAViewChildren = cgiGet( edtavUaviewchildren_Internalname);
                              context.httpAjaxContext.ajax_rsp_assign_prop("", false, edtavUaviewchildren_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV29UAViewChildren)) ? AV88Uaviewchildren_GXI : context.convertURL( context.PathToRelativeUrl( AV29UAViewChildren))), !bGXsfl_25_Refreshing);
                              context.httpAjaxContext.ajax_rsp_assign_prop("", false, edtavUaviewchildren_Internalname, "SrcSet", context.GetImageSrcSet( AV29UAViewChildren), true);
                              ...
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "'DOUAVIEWCHILDREN'") == 0 )
                                 {
                                    context.wbHandled = 1;
                                    dynload_actions( ) ;
      ...
      protected void gxgrGrid_refresh( int subGrid_Rows ,
                                       ...
                                       short AV38OrderedBy ,
                                       bool AV39OrderedDsc ,
                                       String AV62ddo_SecFunctionalityKeyTitleControlIdToReplace ,
                                       String AV66ddo_SecFunctionalityDescriptionTitleControlIdToReplace ,
      ...
      protected void RF0M2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            /* Using cursor H000M2 */
            pr_default.execute(0, new Object[] {lV25SecFunctionalityKey, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_25_idx = 1;
            sGXsfl_25_idx = StringUtil.PadL( StringUtil.LTrim( StringUtil.Str( (decimal)(nGXsfl_25_idx), 4, 0)), 4, "0");
            SubsflControlProps_252( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_Recordsperpage( ) ) ) ) )
            {
               A1SecFunctionalityId = H000M2_A1SecFunctionalityId[0];
               A7SecFunctionalityActive = H000M2_A7SecFunctionalityActive[0];
               A11SecParentFunctionalityDescription = H000M2_A11SecParentFunctionalityDescription[0];
               A2SecParentFunctionalityId = H000M2_A2SecParentFunctionalityId[0];
               n2SecParentFunctionalityId = H000M2_n2SecParentFunctionalityId[0];
               A9SecFunctionalityType = H000M2_A9SecFunctionalityType[0];
               A8SecFunctionalityDescription = H000M2_A8SecFunctionalityDescription[0];
               A3SecFunctionalityKey = H000M2_A3SecFunctionalityKey[0];
               A11SecParentFunctionalityDescription = H000M2_A11SecParentFunctionalityDescription[0];
               E180M2 ();
      ...
      protected int subGrid_Recordcount( )
      {
         ...
         lV25SecFunctionalityKey = StringUtil.Concat( StringUtil.RTrim( AV25SecFunctionalityKey), "%", "");
         /* Using cursor H000M3 */
         pr_default.execute(1, new Object[] {lV25SecFunctionalityKey});
      ...
      protected void STRUP0M0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            ajax_req_read_hidden_sdt(cgiGet( "vSECFUNCTIONALITYKEYTITLEFILTERDATA"), AV59SecFunctionalityKeyTitleFilterData);
            ajax_req_read_hidden_sdt(cgiGet( "vSECFUNCTIONALITYDESCRIPTIONTITLEFILTERDATA"), AV63SecFunctionalityDescriptionTitleFilterData);
            ...
            AV62ddo_SecFunctionalityKeyTitleControlIdToReplace = cgiGet( edtavDdo_secfunctionalitykeytitlecontrolidtoreplace_Internalname);
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV62ddo_SecFunctionalityKeyTitleControlIdToReplace", AV62ddo_SecFunctionalityKeyTitleControlIdToReplace);
            AV66ddo_SecFunctionalityDescriptionTitleControlIdToReplace = cgiGet( edtavDdo_secfunctionalitydescriptiontitlecontrolidtoreplace_Internalname);
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV66ddo_SecFunctionalityDescriptionTitleControlIdToReplace", AV66ddo_SecFunctionalityDescriptionTitleControlIdToReplace);
            ...
            if ( ( ( context.localUtil.CToN( cgiGet( edtavSecfunctionalityid_selected_Internalname), ".", ",") < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtavSecfunctionalityid_selected_Internalname), ".", ",") > Convert.ToDecimal( 9999999999L )) ) )
            {
               GX_msglist.addItem(context.GetMessage( "GXM_badnum", ""), 1, "vSECFUNCTIONALITYID_SELECTED");
               GX_FocusControl = edtavSecfunctionalityid_selected_Internalname;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "GX_FocusControl", GX_FocusControl);
               wbErr = true;
               AV33SecFunctionalityId_Selected = 0;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV33SecFunctionalityId_Selected", StringUtil.LTrim( StringUtil.Str( (decimal)(AV33SecFunctionalityId_Selected), 10, 0)));
            }
            else
            {
               AV33SecFunctionalityId_Selected = (long)(context.localUtil.CToN( cgiGet( edtavSecfunctionalityid_selected_Internalname), ".", ","));
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV33SecFunctionalityId_Selected", StringUtil.LTrim( StringUtil.Str( (decimal)(AV33SecFunctionalityId_Selected), 10, 0)));
            }
            if ( ( ( context.localUtil.CToN( cgiGet( edtavOrderedby_Internalname), ".", ",") < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtavOrderedby_Internalname), ".", ",") > Convert.ToDecimal( 9999 )) ) )
            {
               ...
               wbErr = true;
               AV38OrderedBy = 0;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV38OrderedBy", StringUtil.LTrim( StringUtil.Str( (decimal)(AV38OrderedBy), 4, 0)));
            }
            else
            {
               AV38OrderedBy = (short)(context.localUtil.CToN( cgiGet( edtavOrderedby_Internalname), ".", ","));
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV38OrderedBy", StringUtil.LTrim( StringUtil.Str( (decimal)(AV38OrderedBy), 4, 0)));
            }
            AV39OrderedDsc = StringUtil.StrToBool( cgiGet( edtavOrdereddsc_Internalname));
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV39OrderedDsc", AV39OrderedDsc);
            /* Read saved values. */
            ...
            AV9SecRoleId = (short)(context.localUtil.CToN( cgiGet( "vSECROLEID"), ".", ","));
      ...
      {
         /* Start Routine */
         edtavSecfunctionalityid_selected_Visible = 0;
         context.httpAjaxContext.ajax_rsp_assign_prop("", false, edtavSecfunctionalityid_selected_Internalname, "Visible", StringUtil.LTrim( StringUtil.Str( (decimal)(edtavSecfunctionalityid_selected_Visible), 5, 0)), true);
         subGrid_Rows = 9;
         GxWebStd.gx_hidden_field( context, "GRID_Rows", StringUtil.LTrim( StringUtil.NToC( (decimal)(subGrid_Rows), 6, 0, ".", "")));
         ...
         AV62ddo_SecFunctionalityKeyTitleControlIdToReplace = Ddo_secfunctionalitykey_Titlecontrolidtoreplace;
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV62ddo_SecFunctionalityKeyTitleControlIdToReplace", AV62ddo_SecFunctionalityKeyTitleControlIdToReplace);
         ...
         AV66ddo_SecFunctionalityDescriptionTitleControlIdToReplace = Ddo_secfunctionalitydescription_Titlecontrolidtoreplace;
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV66ddo_SecFunctionalityDescriptionTitleControlIdToReplace", AV66ddo_SecFunctionalityDescriptionTitleControlIdToReplace);
         ...
         {
            A4SecRoleId = H000M4_A4SecRoleId[0];
            A13SecRoleName = H000M4_A13SecRoleName[0];
            Form.Caption = StringUtil.Format( "Associate Functionalities to Role :: %1", A13SecRoleName, "", "", "", "", "", "", "", "");
            context.httpAjaxContext.ajax_rsp_assign_prop("", false, "FORM", "Caption", Form.Caption, true);
      ...
      protected void E170M2( )
      {
         ...
         /* Refresh Routine */
         AV59SecFunctionalityKeyTitleFilterData = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTDropDownOptionsData_Item>( context, "Item", "");
         AV63SecFunctionalityDescriptionTitleFilterData = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTDropDownOptionsData_Item>( context, "Item", "");
         ...
         edtSecFunctionalityKey_Title = StringUtil.Format( "<div class='ColumnSettingsContainer''><span>%1</span><div id='%2'></div>", "权限名称", AV62ddo_SecFunctionalityKeyTitleControlIdToReplace, "", "", "", "", "", "", "");
         ...
         edtSecFunctionalityDescription_Title = StringUtil.Format( "<div class='ColumnSettingsContainer''><span>%1</span><div id='%2'></div>", "权限描述", AV66ddo_SecFunctionalityDescriptionTitleControlIdToReplace, "", "", "", "", "", "", "");
         ...
         context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "AV59SecFunctionalityKeyTitleFilterData", AV59SecFunctionalityKeyTitleFilterData);
         context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "AV63SecFunctionalityDescriptionTitleFilterData", AV63SecFunctionalityDescriptionTitleFilterData);
      ...
      {
         /* Grid_Load Routine */
         AV29UAViewChildren = context.GetImagePath( "f11923b6-6acd-4a79-bfc0-0cfc6f3bced5", "", context.GetTheme( ));
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, edtavUaviewchildren_Internalname, AV29UAViewChildren);
         AV88Uaviewchildren_GXI = GXDbFile.PathToUrl( context.GetImagePath( "f11923b6-6acd-4a79-bfc0-0cfc6f3bced5", "", context.GetTheme( )));
         edtavUaviewchildren_Tooltiptext = "View Actions, Tabs and Modes";
         GXt_boolean2 = AV31TempBoolean;
         new GeneXus.Programs.wwpbaseobjects.secfunctionalityhaschildren(context ).execute(  A1SecFunctionalityId, out  GXt_boolean2) ;
         AV31TempBoolean = GXt_boolean2;
         if ( AV31TempBoolean )
         {
         ...
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV34SecRoleIdParm", StringUtil.LTrim( StringUtil.Str( (decimal)(AV34SecRoleIdParm), 4, 0)));
         AV19IsAssociatedOld = false;
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, chkavIsassociatedold_Internalname, AV19IsAssociatedOld);
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "gxhash_vISASSOCIATEDOLD"+"_"+sGXsfl_25_idx, GetSecureSignedToken( sGXsfl_25_idx, AV19IsAssociatedOld, context));
         /* Using cursor H000M5 */
         pr_default.execute(3, new Object[] {A1SecFunctionalityId, AV34SecRoleIdParm});
         while ( (pr_default.getStatus(3) != 101) )
         {
            A4SecRoleId = H000M5_A4SecRoleId[0];
      ...
      protected void E150M2( )
      {
         ...
         AV90GXV1 = 1;
         while ( AV90GXV1 <= AV11SecFunctionalityIdRemoved.Count )
         {
            AV14SecFunctionalityId = (long)(AV11SecFunctionalityIdRemoved.GetNumeric(AV90GXV1));
         ...
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV21i", StringUtil.LTrim( StringUtil.Str( (decimal)(AV21i), 10, 0)));
         AV91GXV2 = 1;
         while ( AV91GXV2 <= AV10SecFunctionalityIdAdded.Count )
         {
            AV14SecFunctionalityId = (long)(AV10SecFunctionalityIdAdded.GetNumeric(AV91GXV2));
            AV16SecFunctionalityRole = new GeneXus.Programs.wwpbaseobjects.SdtSecFunctionalityRole(context);
      ...
      protected void S152( )
      {
         ...
         CallWebObject(formatLink("wwpbaseobjects.secrolefunroleactionassociationww.aspx") + "?" + UrlEncode("" +AV9SecRoleId) + "," + UrlEncode("" +AV33SecFunctionalityId_Selected));
         context.wjLocDisableFrm = 1;
      }
      ...
      protected void S132( )
      {
         ...
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV21i", StringUtil.LTrim( StringUtil.Str( (decimal)(AV21i), 10, 0)));
         AV92GXV3 = 1;
         while ( AV92GXV3 <= AV10SecFunctionalityIdAdded.Count )
         {
            AV14SecFunctionalityId = (long)(AV10SecFunctionalityIdAdded.GetNumeric(AV92GXV3));
      ...
      protected void S122( )
      {
         ...
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV21i", StringUtil.LTrim( StringUtil.Str( (decimal)(AV21i), 10, 0)));
         AV93GXV4 = 1;
         while ( AV93GXV4 <= AV11SecFunctionalityIdRemoved.Count )
         {
            AV14SecFunctionalityId = (long)(AV11SecFunctionalityIdRemoved.GetNumeric(AV93GXV4));
            if ( AV14SecFunctionalityId == AV15SecFunctionalityIdToFind )
            {
               if (true) break;
            }
      ...
      protected void S142( )
      {
         ...
         AV95GXV6 = 1;
         AV94GXV5 = AV16SecFunctionalityRole.GetMessages();
         while ( AV95GXV6 <= AV94GXV5.Count )
         {
            AV20Message = ((SdtMessages_Message)AV94GXV5.Item(AV95GXV6));
            if ( AV20Message.gxTpr_Type == 1 )
            {
               GX_msglist.addItem(AV20Message.gxTpr_Description);
            }
            AV95GXV6 = (int)(AV95GXV6+1);
         }
      }

      protected void wb_table2_60_0M2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table2_60_0M2e( true) ;
         }
         else
         {
            wb_table2_60_0M2e( false) ;
         }
      }

      protected void wb_table1_14_0M2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_14_0M2e( true) ;
         }
         else
         {
            wb_table1_14_0M2e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202022711583640", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wwpbaseobjects/secrolefunroleassociationww.js", "?202022711583640", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
      ...
      protected void SubsflControlProps_252( )
      {
         ...
         edtavUaviewchildren_Internalname = "vUAVIEWCHILDREN_"+sGXsfl_25_idx;
      ...
      protected void SubsflControlProps_fel_252( )
      {
         ...
         edtavUaviewchildren_Internalname = "vUAVIEWCHILDREN_"+sGXsfl_25_fel_idx;
      ...
      protected void sendrow_252( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_25_idx <= subGrid_Recordsperpage( ) * 1 ) )
         {
            ...
            TempTags = " " + ((edtavUaviewchildren_Enabled!=0)&&(edtavUaviewchildren_Visible!=0) ? " onfocus=\"gx.evt.onfocus(this, 28,'',false,'',25)\"" : " ");
            ClassString = edtavUaviewchildren_Class;
            StyleString = "";
            AV29UAViewChildren_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV29UAViewChildren))&&String.IsNullOrEmpty(StringUtil.RTrim( AV88Uaviewchildren_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV29UAViewChildren)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV29UAViewChildren)) ? AV88Uaviewchildren_GXI : context.PathToRelativeUrl( AV29UAViewChildren));
            GridRow.AddColumnProperties("bitmap", 1, isAjaxCallMode( ), new Object[] {(String)edtavUaviewchildren_Internalname,(String)sImgUrl,(String)"",(String)"",(String)"",context.GetTheme( ),(short)-1,(short)1,(String)"",(String)edtavUaviewchildren_Tooltiptext,(short)0,(short)-1,(short)0,(String)"px",(short)0,(String)"px",(short)0,(short)0,(short)5,(String)edtavUaviewchildren_Jsonclick,"'"+""+"'"+",false,"+"'"+"E\\'DOUAVIEWCHILDREN\\'."+sGXsfl_25_idx+"'",(String)StyleString,(String)ClassString,(String)"WWActionColumn",(String)"",(String)"",(String)"",(String)""+TempTags,(String)"",(String)"",(short)1,(bool)AV29UAViewChildren_IsBlob,(bool)false,context.GetImageSrcSet( sImgUrl)});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
      ...
      protected void init_default_properties( )
      {
         ...
         edtavSecfunctionalityid_selected_Internalname = "vSECFUNCTIONALITYID_SELECTED";
      ...
      public override void initialize_properties( )
      {
         ...
         edtavSecfunctionalityid_selected_Jsonclick = "";
         edtavSecfunctionalityid_selected_Visible = 1;
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'AV25SecFunctionalityKey',fld:'vSECFUNCTIONALITYKEY',pic:''},{av:'AV38OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV39OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'A4SecRoleId',fld:'SECROLEID',pic:'ZZZ9'},{av:'AV21i',fld:'vI',pic:'ZZZZZZZZZ9'},{av:'AV11SecFunctionalityIdRemoved',fld:'vSECFUNCTIONALITYIDREMOVED',pic:''},{av:'AV15SecFunctionalityIdToFind',fld:'vSECFUNCTIONALITYIDTOFIND',pic:'ZZZZZZZZZ9'},{av:'AV10SecFunctionalityIdAdded',fld:'vSECFUNCTIONALITYIDADDED',pic:''},{av:'AV34SecRoleIdParm',fld:'vSECROLEIDPARM',pic:'ZZZ9'},{av:'AV62ddo_SecFunctionalityKeyTitleControlIdToReplace',fld:'vDDO_SECFUNCTIONALITYKEYTITLECONTROLIDTOREPLACE',pic:''},{av:'AV66ddo_SecFunctionalityDescriptionTitleControlIdToReplace',fld:'vDDO_SECFUNCTIONALITYDESCRIPTIONTITLECONTROLIDTOREPLACE',pic:''},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV13SecFunctionalityIdRemovedXml',fld:'vSECFUNCTIONALITYIDREMOVEDXML',pic:''},{av:'AV12SecFunctionalityIdAddedXml',fld:'vSECFUNCTIONALITYIDADDEDXML',pic:''},{av:'AV9SecRoleId',fld:'vSECROLEID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[{av:'AV59SecFunctionalityKeyTitleFilterData',fld:'vSECFUNCTIONALITYKEYTITLEFILTERDATA',pic:''},{av:'AV63SecFunctionalityDescriptionTitleFilterData',fld:'vSECFUNCTIONALITYDESCRIPTIONTITLEFILTERDATA',pic:''},{av:'edtSecFunctionalityKey_Titleformat',ctrl:'SECFUNCTIONALITYKEY',prop:'Titleformat'},{av:'edtSecFunctionalityKey_Title',ctrl:'SECFUNCTIONALITYKEY',prop:'Title'},{av:'edtSecFunctionalityDescription_Titleformat',ctrl:'SECFUNCTIONALITYDESCRIPTION',prop:'Titleformat'},{av:'edtSecFunctionalityDescription_Title',ctrl:'SECFUNCTIONALITYDESCRIPTION',prop:'Title'},{av:'AV81GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV83GridPageSize',fld:'vGRIDPAGESIZE',pic:'ZZZZZZZZZ9'},{av:'AV84GridRecordCount',fld:'vGRIDRECORDCOUNT',pic:'ZZZZZZZZZ9'},{av:'AV11SecFunctionalityIdRemoved',fld:'vSECFUNCTIONALITYIDREMOVED',pic:''},{av:'AV10SecFunctionalityIdAdded',fld:'vSECFUNCTIONALITYIDADDED',pic:''}]}");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'E110M2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV25SecFunctionalityKey',fld:'vSECFUNCTIONALITYKEY',pic:''},{av:'AV38OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV39OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV62ddo_SecFunctionalityKeyTitleControlIdToReplace',fld:'vDDO_SECFUNCTIONALITYKEYTITLECONTROLIDTOREPLACE',pic:''},{av:'AV66ddo_SecFunctionalityDescriptionTitleControlIdToReplace',fld:'vDDO_SECFUNCTIONALITYDESCRIPTIONTITLECONTROLIDTOREPLACE',pic:''},{av:'AV13SecFunctionalityIdRemovedXml',fld:'vSECFUNCTIONALITYIDREMOVEDXML',pic:''},{av:'AV12SecFunctionalityIdAddedXml',fld:'vSECFUNCTIONALITYIDADDEDXML',pic:''},{av:'AV9SecRoleId',fld:'vSECROLEID',pic:'ZZZ9',hsh:true},{av:'A4SecRoleId',fld:'SECROLEID',pic:'ZZZ9'},{av:'AV21i',fld:'vI',pic:'ZZZZZZZZZ9'},{av:'AV11SecFunctionalityIdRemoved',fld:'vSECFUNCTIONALITYIDREMOVED',pic:''},{av:'AV15SecFunctionalityIdToFind',fld:'vSECFUNCTIONALITYIDTOFIND',pic:'ZZZZZZZZZ9'},{av:'AV10SecFunctionalityIdAdded',fld:'vSECFUNCTIONALITYIDADDED',pic:''},{av:'AV34SecRoleIdParm',fld:'vSECROLEIDPARM',pic:'ZZZ9'},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE",",oparms:[]}");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","{handler:'E120M2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV25SecFunctionalityKey',fld:'vSECFUNCTIONALITYKEY',pic:''},{av:'AV38OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV39OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV62ddo_SecFunctionalityKeyTitleControlIdToReplace',fld:'vDDO_SECFUNCTIONALITYKEYTITLECONTROLIDTOREPLACE',pic:''},{av:'AV66ddo_SecFunctionalityDescriptionTitleControlIdToReplace',fld:'vDDO_SECFUNCTIONALITYDESCRIPTIONTITLECONTROLIDTOREPLACE',pic:''},{av:'AV13SecFunctionalityIdRemovedXml',fld:'vSECFUNCTIONALITYIDREMOVEDXML',pic:''},{av:'AV12SecFunctionalityIdAddedXml',fld:'vSECFUNCTIONALITYIDADDEDXML',pic:''},{av:'AV9SecRoleId',fld:'vSECROLEID',pic:'ZZZ9',hsh:true},{av:'A4SecRoleId',fld:'SECROLEID',pic:'ZZZ9'},{av:'AV21i',fld:'vI',pic:'ZZZZZZZZZ9'},{av:'AV11SecFunctionalityIdRemoved',fld:'vSECFUNCTIONALITYIDREMOVED',pic:''},{av:'AV15SecFunctionalityIdToFind',fld:'vSECFUNCTIONALITYIDTOFIND',pic:'ZZZZZZZZZ9'},{av:'AV10SecFunctionalityIdAdded',fld:'vSECFUNCTIONALITYIDADDED',pic:''},{av:'AV34SecRoleIdParm',fld:'vSECROLEIDPARM',pic:'ZZZ9'},{av:'Gridpaginationbar_Rowsperpageselectedvalue',ctrl:'GRIDPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}]");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",",oparms:[{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'}]}");
         setEventMetadata("DDO_SECFUNCTIONALITYKEY.ONOPTIONCLICKED","{handler:'E130M2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV25SecFunctionalityKey',fld:'vSECFUNCTIONALITYKEY',pic:''},{av:'AV38OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV39OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV62ddo_SecFunctionalityKeyTitleControlIdToReplace',fld:'vDDO_SECFUNCTIONALITYKEYTITLECONTROLIDTOREPLACE',pic:''},{av:'AV66ddo_SecFunctionalityDescriptionTitleControlIdToReplace',fld:'vDDO_SECFUNCTIONALITYDESCRIPTIONTITLECONTROLIDTOREPLACE',pic:''},{av:'AV13SecFunctionalityIdRemovedXml',fld:'vSECFUNCTIONALITYIDREMOVEDXML',pic:''},{av:'AV12SecFunctionalityIdAddedXml',fld:'vSECFUNCTIONALITYIDADDEDXML',pic:''},{av:'AV9SecRoleId',fld:'vSECROLEID',pic:'ZZZ9',hsh:true},{av:'A4SecRoleId',fld:'SECROLEID',pic:'ZZZ9'},{av:'AV21i',fld:'vI',pic:'ZZZZZZZZZ9'},{av:'AV11SecFunctionalityIdRemoved',fld:'vSECFUNCTIONALITYIDREMOVED',pic:''},{av:'AV15SecFunctionalityIdToFind',fld:'vSECFUNCTIONALITYIDTOFIND',pic:'ZZZZZZZZZ9'},{av:'AV10SecFunctionalityIdAdded',fld:'vSECFUNCTIONALITYIDADDED',pic:''},{av:'AV34SecRoleIdParm',fld:'vSECROLEIDPARM',pic:'ZZZ9'},{av:'Ddo_secfunctionalitykey_Activeeventkey',ctrl:'DDO_SECFUNCTIONALITYKEY',prop:'ActiveEventKey'}]");
         setEventMetadata("DDO_SECFUNCTIONALITYKEY.ONOPTIONCLICKED",",oparms:[{av:'AV38OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV39OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'Ddo_secfunctionalitykey_Sortedstatus',ctrl:'DDO_SECFUNCTIONALITYKEY',prop:'SortedStatus'},{av:'AV59SecFunctionalityKeyTitleFilterData',fld:'vSECFUNCTIONALITYKEYTITLEFILTERDATA',pic:''},{av:'AV63SecFunctionalityDescriptionTitleFilterData',fld:'vSECFUNCTIONALITYDESCRIPTIONTITLEFILTERDATA',pic:''},{av:'edtSecFunctionalityKey_Titleformat',ctrl:'SECFUNCTIONALITYKEY',prop:'Titleformat'},{av:'edtSecFunctionalityKey_Title',ctrl:'SECFUNCTIONALITYKEY',prop:'Title'},{av:'edtSecFunctionalityDescription_Titleformat',ctrl:'SECFUNCTIONALITYDESCRIPTION',prop:'Titleformat'},{av:'edtSecFunctionalityDescription_Title',ctrl:'SECFUNCTIONALITYDESCRIPTION',prop:'Title'},{av:'AV81GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV83GridPageSize',fld:'vGRIDPAGESIZE',pic:'ZZZZZZZZZ9'},{av:'AV84GridRecordCount',fld:'vGRIDRECORDCOUNT',pic:'ZZZZZZZZZ9'},{av:'AV11SecFunctionalityIdRemoved',fld:'vSECFUNCTIONALITYIDREMOVED',pic:''},{av:'AV10SecFunctionalityIdAdded',fld:'vSECFUNCTIONALITYIDADDED',pic:''}]}");
         setEventMetadata("DDO_SECFUNCTIONALITYDESCRIPTION.ONOPTIONCLICKED","{handler:'E140M2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV25SecFunctionalityKey',fld:'vSECFUNCTIONALITYKEY',pic:''},{av:'AV38OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV39OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV62ddo_SecFunctionalityKeyTitleControlIdToReplace',fld:'vDDO_SECFUNCTIONALITYKEYTITLECONTROLIDTOREPLACE',pic:''},{av:'AV66ddo_SecFunctionalityDescriptionTitleControlIdToReplace',fld:'vDDO_SECFUNCTIONALITYDESCRIPTIONTITLECONTROLIDTOREPLACE',pic:''},{av:'AV13SecFunctionalityIdRemovedXml',fld:'vSECFUNCTIONALITYIDREMOVEDXML',pic:''},{av:'AV12SecFunctionalityIdAddedXml',fld:'vSECFUNCTIONALITYIDADDEDXML',pic:''},{av:'AV9SecRoleId',fld:'vSECROLEID',pic:'ZZZ9',hsh:true},{av:'A4SecRoleId',fld:'SECROLEID',pic:'ZZZ9'},{av:'AV21i',fld:'vI',pic:'ZZZZZZZZZ9'},{av:'AV11SecFunctionalityIdRemoved',fld:'vSECFUNCTIONALITYIDREMOVED',pic:''},{av:'AV15SecFunctionalityIdToFind',fld:'vSECFUNCTIONALITYIDTOFIND',pic:'ZZZZZZZZZ9'},{av:'AV10SecFunctionalityIdAdded',fld:'vSECFUNCTIONALITYIDADDED',pic:''},{av:'AV34SecRoleIdParm',fld:'vSECROLEIDPARM',pic:'ZZZ9'},{av:'Ddo_secfunctionalitydescription_Activeeventkey',ctrl:'DDO_SECFUNCTIONALITYDESCRIPTION',prop:'ActiveEventKey'}]");
         setEventMetadata("DDO_SECFUNCTIONALITYDESCRIPTION.ONOPTIONCLICKED",",oparms:[{av:'AV38OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV39OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'Ddo_secfunctionalitydescription_Sortedstatus',ctrl:'DDO_SECFUNCTIONALITYDESCRIPTION',prop:'SortedStatus'},{av:'AV59SecFunctionalityKeyTitleFilterData',fld:'vSECFUNCTIONALITYKEYTITLEFILTERDATA',pic:''},{av:'AV63SecFunctionalityDescriptionTitleFilterData',fld:'vSECFUNCTIONALITYDESCRIPTIONTITLEFILTERDATA',pic:''},{av:'edtSecFunctionalityKey_Titleformat',ctrl:'SECFUNCTIONALITYKEY',prop:'Titleformat'},{av:'edtSecFunctionalityKey_Title',ctrl:'SECFUNCTIONALITYKEY',prop:'Title'},{av:'edtSecFunctionalityDescription_Titleformat',ctrl:'SECFUNCTIONALITYDESCRIPTION',prop:'Titleformat'},{av:'edtSecFunctionalityDescription_Title',ctrl:'SECFUNCTIONALITYDESCRIPTION',prop:'Title'},{av:'AV81GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV83GridPageSize',fld:'vGRIDPAGESIZE',pic:'ZZZZZZZZZ9'},{av:'AV84GridRecordCount',fld:'vGRIDRECORDCOUNT',pic:'ZZZZZZZZZ9'},{av:'AV11SecFunctionalityIdRemoved',fld:'vSECFUNCTIONALITYIDREMOVED',pic:''},{av:'AV10SecFunctionalityIdAdded',fld:'vSECFUNCTIONALITYIDADDED',pic:''}]}");
         setEventMetadata("GRID.LOAD","{handler:'E180M2',iparms:[{av:'A1SecFunctionalityId',fld:'SECFUNCTIONALITYID',pic:'ZZZZZZZZZ9',hsh:true},{av:'AV9SecRoleId',fld:'vSECROLEID',pic:'ZZZ9',hsh:true},{av:'A4SecRoleId',fld:'SECROLEID',pic:'ZZZ9'},{av:'AV21i',fld:'vI',pic:'ZZZZZZZZZ9'},{av:'AV11SecFunctionalityIdRemoved',fld:'vSECFUNCTIONALITYIDREMOVED',pic:''},{av:'AV15SecFunctionalityIdToFind',fld:'vSECFUNCTIONALITYIDTOFIND',pic:'ZZZZZZZZZ9'},{av:'AV10SecFunctionalityIdAdded',fld:'vSECFUNCTIONALITYIDADDED',pic:''},{av:'AV34SecRoleIdParm',fld:'vSECROLEIDPARM',pic:'ZZZ9'}]");
      ...
      public override void initialize( )
      {
         ...
         EvtRowId = "";
         sEvtType = "";
         AV88Uaviewchildren_GXI = "";
         scmdbuf = "";
         lV25SecFunctionalityKey = "";
         H000M2_A1SecFunctionalityId = new long[1] ;
         H000M2_A7SecFunctionalityActive = new bool[] {false} ;
         H000M2_A11SecParentFunctionalityDescription = new String[] {""} ;
         H000M2_A2SecParentFunctionalityId = new long[1] ;
         H000M2_n2SecParentFunctionalityId = new bool[] {false} ;
         H000M2_A9SecFunctionalityType = new short[1] ;
         H000M2_A8SecFunctionalityDescription = new String[] {""} ;
         H000M2_A3SecFunctionalityKey = new String[] {""} ;
         H000M3_AGRID_nRecordCount = new long[1] ;
         GXt_SdtDVB_SDTDropDownOptionsTitleSettingsIcons1 = new GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTDropDownOptionsTitleSettingsIcons(context);
         H000M4_A4SecRoleId = new short[1] ;
         H000M4_A13SecRoleName = new String[] {""} ;
         A13SecRoleName = "";
         AV77WWPContext = new GeneXus.Programs.wwpbaseobjects.SdtWWPContext(context);
         H000M5_A1SecFunctionalityId = new long[1] ;
         H000M5_A4SecRoleId = new short[1] ;
         GridRow = new GXWebRow();
         AV94GXV5 = new GXBaseCollection<SdtMessages_Message>( context, "Message", "GeneXus");
         ...
         ROClassString = "";
         GXCCtl = "";
         pr_datastore1 = new DataStoreProvider(context, new GeneXus.Programs.wwpbaseobjects.secrolefunroleassociationww__datastore1(),
            new Object[][] {
            }
         );
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwpbaseobjects.secrolefunroleassociationww__default(),
            new Object[][] {
                new Object[] {
               H000M2_A1SecFunctionalityId, H000M2_A7SecFunctionalityActive, H000M2_A11SecParentFunctionalityDescription, H000M2_A2SecParentFunctionalityId, H000M2_n2SecParentFunctionalityId, H000M2_A9SecFunctionalityType, H000M2_A8SecFunctionalityDescription, H000M2_A3SecFunctionalityKey
               }
               , new Object[] {
               H000M3_AGRID_nRecordCount
               }
               , new Object[] {
               H000M4_A4SecRoleId, H000M4_A13SecRoleName
               }
               , new Object[] {
               H000M5_A1SecFunctionalityId, H000M5_A4SecRoleId
               }
            }
         );
         /* GeneXus formulas. */
      ...
      private int edtavSecfunctionalityid_selected_Visible ;
      ...
      private String edtavSecfunctionalityid_selected_Internalname ;
      private String edtavSecfunctionalityid_selected_Jsonclick ;
      ...
      private bool AV29UAViewChildren_IsBlob ;
      ...
      private String AV62ddo_SecFunctionalityKeyTitleControlIdToReplace ;
      private String AV66ddo_SecFunctionalityDescriptionTitleControlIdToReplace ;
      ...
      private String AV88Uaviewchildren_GXI ;
      ...
      private long[] H000M2_A1SecFunctionalityId ;
      private bool[] H000M2_A7SecFunctionalityActive ;
      private String[] H000M2_A11SecParentFunctionalityDescription ;
      private long[] H000M2_A2SecParentFunctionalityId ;
      private bool[] H000M2_n2SecParentFunctionalityId ;
      private short[] H000M2_A9SecFunctionalityType ;
      private String[] H000M2_A8SecFunctionalityDescription ;
      private String[] H000M2_A3SecFunctionalityKey ;
      private long[] H000M3_AGRID_nRecordCount ;
      private short[] H000M4_A4SecRoleId ;
      private String[] H000M4_A13SecRoleName ;
      private long[] H000M5_A1SecFunctionalityId ;
      private short[] H000M5_A4SecRoleId ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private IDataStoreProvider pr_datastore1 ;
      private GXBaseCollection<SdtMessages_Message> AV94GXV5 ;
      private GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTDropDownOptionsData_Item> AV59SecFunctionalityKeyTitleFilterData ;
      private GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTDropDownOptionsData_Item> AV63SecFunctionalityDescriptionTitleFilterData ;
   ...
   public class secrolefunroleassociationww__datastore1 : DataStoreHelperBase, IDataStoreHelper
   {
 ...
 public class secrolefunroleassociationww__default : DataStoreHelperBase, IDataStoreHelper
 {
                                           ...
                                           bool AV39OrderedDsc )
    {
       ...
       if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV25SecFunctionalityKey)) )
       {
          ...
          {
             sWhereString = sWhereString + " (T1.[SecFunctionalityKey] like '%' + @lV25SecFunctionalityKey + '%')";
          }
       }
       else
       {
                                                   ...
                                                   Object [] dynConstraints )
    {
       ...
       {
             case 0 :
                   return conditional_H000M2(context, (String)dynConstraints[0] , (String)dynConstraints[1] , (short)dynConstraints[2] , (bool)dynConstraints[3] );
             case 1 :
                   return conditional_H000M3(context, (String)dynConstraints[0] , (String)dynConstraints[1] , (short)dynConstraints[2] , (bool)dynConstraints[3] );
       }
  ...
  private void cursorDefinitions( )
  {
     if ( def == null )
     {
        ...
        new Object[] {"@AV34SecRoleIdParm",SqlDbType.SmallInt,4,0}
        } ;
        Object[] prmH000M2 ;
        ...
        def= new CursorDef[] {
           ...
           ,new CursorDef("H000M4", "SELECT [SecRoleId], [SecRoleName] FROM [SecRole] WITH (NOLOCK) WHERE [SecRoleId] = @AV9SecRoleId ORDER BY [SecRoleId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000M4,1,0,false,true )
           ,new CursorDef("H000M5", "SELECT [SecFunctionalityId], [SecRoleId] FROM [SecFunctionalityRole] WITH (NOLOCK) WHERE [SecFunctionalityId] = @SecFunctionalityId and [SecRoleId] = @AV34SecRoleIdParm ORDER BY [SecFunctionalityId], [SecRoleId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000M5,1,0,false,true )
        };
     }
  }
