...
namespace GeneXus.Programs.wwpbaseobjects{
	...
	[XmlType(TypeName="WWPColumnsSelector.InvisibleColumn" , Namespace="DataAnalysisPlatform" )]
	[Serializable]
	...
	[DataContract(Name=@"WWPColumnsSelector.InvisibleColumn", Namespace="DataAnalysisPlatform")]
