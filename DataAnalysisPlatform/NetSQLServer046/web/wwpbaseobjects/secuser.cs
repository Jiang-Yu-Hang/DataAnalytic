/*
       ...
       Generated on: 2/27/2020 11:55:31.57
   ...
   public class secuser : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void Draw( )
      {
         ...
         if ( ! GxWebStd.gx_redirect( context) )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtSecUserCrtDate_Internalname, context.localUtil.TToC( A180SecUserCrtDate, 10, 8, 0, 0, "/", ":", " "), context.localUtil.Format( A180SecUserCrtDate, "99/99/99 99:99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 8,'YMD',5,24,'chs',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,52);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtSecUserCrtDate_Jsonclick, 0, "Attribute", "", "", "", "", edtSecUserCrtDate_Visible, edtSecUserCrtDate_Enabled, 0, "text", "", 14, "chr", 1, "row", 14, 0, 0, 0, 1, -1, 0, true, "CrtDate", "right", false, "HLP_WWPBaseObjects\\SecUser.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtSecUserUpdDate_Internalname, context.localUtil.TToC( A181SecUserUpdDate, 10, 8, 0, 0, "/", ":", " "), context.localUtil.Format( A181SecUserUpdDate, "9999/99/99 99:99:99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 10,'YMD',8,24,'chs',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,53);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtSecUserUpdDate_Jsonclick, 0, "Attribute", "", "", "", "", edtSecUserUpdDate_Visible, edtSecUserUpdDate_Enabled, 0, "text", "", 19, "chr", 1, "row", 19, 0, 0, 0, 1, -1, 0, true, "UpdDate", "right", false, "HLP_WWPBaseObjects\\SecUser.htm");
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202022711553389", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202022711553428", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wwpbaseobjects/secuser.js", "?202022711553428", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false);
