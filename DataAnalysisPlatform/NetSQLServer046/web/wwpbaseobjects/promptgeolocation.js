/*!   GeneXus C# 16_0_0-127771 on 2/27/2020 11:58:16.64
*/
...
gx.define('wwpbaseobjects.promptgeolocation', false, function () {
   ...
   GXValidFnc[15]={ id: 15, fld:"BTNENTER",grid:0};
   GXValidFnc[16]={ id: 16, fld:"BTNCANCEL",grid:0};
   ...
   this.EvtParms["START"] = [[{av:'AV7Geolocation',fld:'vGEOLOCATION',pic:''},{av:'GxMapPoint',fld:'vGXMAPPOINT',pic:''},{av:'GxMapData',fld:'vGXMAPDATA',pic:''},{av:'AV18Pgmname',fld:'vPGMNAME',pic:''}],[{av:'GxMapPoint',fld:'vGXMAPPOINT',pic:''},{av:'GxMapData',fld:'vGXMAPDATA',pic:''}]];
