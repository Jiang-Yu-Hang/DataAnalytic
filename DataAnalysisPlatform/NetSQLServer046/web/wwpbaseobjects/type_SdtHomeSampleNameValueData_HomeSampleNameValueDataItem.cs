...
namespace GeneXus.Programs.wwpbaseobjects{
	...
	[XmlType(TypeName="HomeSampleNameValueDataItem" , Namespace="DataAnalysisPlatform" )]
	[Serializable]
	...
	[DataContract(Name=@"HomeSampleNameValueDataItem", Namespace="DataAnalysisPlatform")]
