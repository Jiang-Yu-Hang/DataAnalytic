/*
       ...
       Generated on: 2/27/2020 11:55:22.65
...
namespace GeneXus.Programs.wwpbaseobjects {
   public class secfunctionalitygeneral : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202022711552270", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void RenderHtmlCloseForm0R2( )
      {
         ...
         {
            context.AddJavascriptSource("wwpbaseobjects/secfunctionalitygeneral.js", "?202022711552272", false);
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202022711552325", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("wwpbaseobjects/secfunctionalitygeneral.js", "?202022711552325", false);
