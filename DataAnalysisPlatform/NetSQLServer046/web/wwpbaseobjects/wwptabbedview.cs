/*
       ...
       Generated on: 2/27/2020 11:54:49.8
...
namespace GeneXus.Programs.wwpbaseobjects {
   public class wwptabbedview : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202022711544913", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void RenderHtmlCloseForm0F2( )
      {
         ...
         {
            context.AddJavascriptSource("wwpbaseobjects/wwptabbedview.js", "?202022711544915", false);
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202022711544948", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("wwpbaseobjects/wwptabbedview.js", "?202022711544948", false);
      ...
      {
         AV5Tabs = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtWWPTabOptions_TabOptionsItem>( context, "TabOptionsItem", "DataAnalysisPlatform");
         wcpOAV7TabCode = "";
         gxfirstwebparm = "";
         gxfirstwebparm_bkp = "";
         sPrefix = "";
