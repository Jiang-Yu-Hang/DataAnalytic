/*!   GeneXus C# 16_0_0-127771 on 2/27/2020 11:58:37.52
*/
...
gx.define('wwpbaseobjects.secrolefunroleassociationww', false, function () {
   ...
   this.GridContainer = new gx.grid.grid(this, 2,"WbpLvl2",25,"Grid","Grid","GridContainer",this.CmpContext,this.IsMasterPage,"wwpbaseobjects.secrolefunroleassociationww",[],false,1,false,true,0,false,false,false,"",0,"px",0,"px","澧炲姞绌虹櫧琛?,true,false,false,null,null,false,"",false,[1,1,1,1],false,0,true,false);
   ...
   GridContainer.addSingleLineEdit(1,29,"SECFUNCTIONALITYID","缂栧彿","","SecFunctionalityId","int",0,"px",10,10,"right",null,[],1,"SecFunctionalityId",false,0,false,false,"Attribute",1,"WWColumn hidden-xs");
   ...
   GridContainer.addComboBox(9,32,"SECFUNCTIONALITYTYPE","绫诲瀷","SecFunctionalityType","int",null,0,false,false,0,"px","WWColumn hidden-xs");
   GridContainer.addSingleLineEdit(2,33,"SECPARENTFUNCTIONALITYID","鐖跺姛鑳界紪鍙? ","","SecParentFunctionalityId","int",0,"px",10,10,"right",null,[],2,"SecParentFunctionalityId",false,0,false,false,"Attribute",1,"WWColumn hidden-xs");
   ...
   GridContainer.addCheckBox(7,35,"SECFUNCTIONALITYACTIVE","鏄惁鍚敤锛?,"","SecFunctionalityActive","boolean","true","false",null,false,false,0,"px","WWColumn hidden-xs");
