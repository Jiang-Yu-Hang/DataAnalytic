/*
        ...
        Description: Excel导出选项
             Author: GeneXus C# Generator version 16_0_0-127771
       Generated on: 2/27/2020 11:58:15.85
   ...
   public class exportoptions : GXHttpHandler, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV26Pgmname = "WWPBaseObjects.ExportOptions";
               context.Gx_err = 0;
               WS082( ) ;
               if ( ! isAjaxCallMode( ) )
               {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.SendWebValue( "Excel导出选项") ;
         ...
         context.AddJavascriptSource("gxcfg.js", "?202022711581588", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void START082( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Excel导出选项", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void E11082( )
      {
         ...
         GXt_boolean1 = AV17IsAuthorized;
         new GeneXus.Programs.wwpbaseobjects.secisauthbyfunctionalitykey(context ).execute(  "WPAskExport", out  GXt_boolean1) ;
         AV17IsAuthorized = GXt_boolean1;
         if ( ! AV17IsAuthorized )
         {
            CallWebObject(formatLink("wwpbaseobjects.notauthorized.aspx") + "?" + UrlEncode(StringUtil.RTrim(AV26Pgmname)));
      ...
      protected void wb_table3_51_082e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtndownloadtofile_Internalname, "", "保存", bttBtndownloadtofile_Jsonclick, 5, "", "", StyleString, ClassString, bttBtndownloadtofile_Visible, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DODOWNLOADTOFILE\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WWPBaseObjects\\ExportOptions.htm");
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 59,'',false,'',0)\"";
            ClassString = "Button";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnsavegoogledrive_Internalname, "", "保存", bttBtnsavegoogledrive_Jsonclick, 5, "", "", StyleString, ClassString, bttBtnsavegoogledrive_Visible, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOSAVEGOOGLEDRIVE\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WWPBaseObjects\\ExportOptions.htm");
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 60,'',false,'',0)\"";
            ClassString = "ButtonMaterialDefault";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtncancel_Internalname, "", bttBtncancel_Caption, bttBtncancel_Jsonclick, 1, "取消", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", context.GetButtonType( ), "HLP_WWPBaseObjects\\ExportOptions.htm");
      ...
      protected void wb_table2_11_082( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            GxWebStd.gx_label_element( context, cmbavExporttype_Internalname, "导出类型", "col-sm-3 AttributeLabel", 1, true);
            /* Div Control */
      ...
      protected void wb_table4_26_082( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavUser_Internalname, "邮箱", "col-sm-3 AttributeLabel", 1, true);
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
            /* Single line edit */
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavDoctitle_Internalname, "文档标题", "col-sm-3 AttributeLabel", 1, true);
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
            /* Single line edit */
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavPassword_Internalname, "密码", "col-sm-3 AttributeLabel", 1, true);
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
            /* Single line edit */
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202022711581753", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wwpbaseobjects/exportoptions.js", "?202022711581753", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false);
      ...
      public override void initialize_properties( )
      {
         ...
         Dvpanel_tableattributes_Title = "谷歌云端硬盘信息";
         ...
         Dvpanel_tableexport_Title = "导出到哪里？";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'DODOWNLOADTOFILE'","{handler:'E12082',iparms:[]");
         setEventMetadata("'DODOWNLOADTOFILE'",",oparms:[]}");
         setEventMetadata("'DOSAVEGOOGLEDRIVE'","{handler:'E13082',iparms:[{av:'AV14GoogleDocResultXML',fld:'vGOOGLEDOCRESULTXML',pic:''}]");
         ...
         setEventMetadata("VEXPORTTYPE.CLICK","{handler:'E15081',iparms:[{av:'cmbavExporttype'},{av:'AV13ExportType',fld:'vEXPORTTYPE',pic:'9'}]");
