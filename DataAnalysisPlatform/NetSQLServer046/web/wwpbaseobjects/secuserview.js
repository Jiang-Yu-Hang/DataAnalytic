/*!   GeneXus C# 16_0_0-127771 on 2/27/2020 11:58:19.20
*/
...
gx.define('wwpbaseobjects.secuserview', false, function () {
   ...
   this.s112_client=function()
   {
      ...
      if ( this.AV14LoadAllTabs || ( this.AV15SelectedTabCode == "" ) || ( this.AV15SelectedTabCode == "General" ) )
      {
         ...
         gx.fn.setCtrlProperty("TXTTABTITLE","Caption", "鐢ㄦ埛淇℃伅" );
   ...
   DVELOP_CONFIRMPANEL_DELETEContainer.setProp("ConfirmationText", "Confirmationtext", "纭鍒犻櫎璇ョ敤鎴凤紵", "str");
