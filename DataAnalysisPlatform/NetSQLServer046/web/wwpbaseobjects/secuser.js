/*!   GeneXus C# 16_0_0-127771 on 2/27/2020 11:55:34.91
*/
...
gx.define('wwpbaseobjects.secuser', false, function () {
   ...
   this.Valid_Secusername=function()
   {
      try {
         ...
         {
            try {
               gxballoon.setError("濮撳悕鏄繀椤诲～鍐欑殑銆?);
   ...
   this.Validv_Secuserpassword=function()
   {
      try {
         ...
         {
            try {
               gxballoon.setError("瀵嗙爜鏄繀椤诲～鍐欑殑銆?);
               this.AnyError = gx.num.trunc( 1 ,0) ;
            }
            catch(e){}
         }
   ...
   DVPANEL_TABLEATTRIBUTESContainer.setProp("Title", "Title", "鐢ㄦ埛淇℃伅", "str");
