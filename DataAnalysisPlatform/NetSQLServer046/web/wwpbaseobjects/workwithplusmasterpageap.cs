/*
               File: WWPBaseObjects.WorkWithPlusMasterPageAP
        Description: Master Page
             Author: GeneXus C# Generator version 16_0_0-127771
       Generated on: 2/27/2020 12:6:18.6
...
namespace GeneXus.Programs.wwpbaseobjects {
   public class workwithplusmasterpageap : GXMasterPage, System.Web.SessionState.IRequiresSessionState
   {
      public workwithplusmasterpageap( )
      {
      ...
      public workwithplusmasterpageap( IGxContext context )
      {
      ...
      protected void RenderHtmlCloseForm802( )
      {
         ...
         context.AddJavascriptSource("wwpbaseobjects/workwithplusmasterpageap.js", "?2020227126187", false);
      ...
      {
         return "WWPBaseObjects.WorkWithPlusMasterPageAP" ;
      }
      ...
      protected void WB800( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            StyleString = "";
            sImgUrl = (String)(context.GetImagePath( "45f04407-c95d-4a17-94f7-326939ea74f2", "", context.GetTheme( )));
            GxWebStd.gx_bitmap( context, imgRoche_logo_Internalname, sImgUrl, "", "", "", context.GetTheme( ), 1, 1, "", "", 0, 0, 0, "px", 0, "px", 0, 0, 0, "", "", StyleString, ClassString, "", "", "", "", " "+"data-gx-image"+" ", "", "", 1, false, false, context.GetImageSrcSet( sImgUrl), "HLP_WWPBaseObjects\\WorkWithPlusMasterPageAP.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-6 ShowMenuImageCellDes", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextdatamanager_Internalname, "Data Management Platform", "", "", lblTextdatamanager_Jsonclick, "'"+""+"'"+",true,"+"'"+"E_MPAGE."+"'", "", "TextBlock_Des", 0, "", 1, 1, 0, "HLP_WWPBaseObjects\\WorkWithPlusMasterPageAP.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)(getDataAreaObject() == null ? Form : getDataAreaObject().GetForm()).Jscriptsrc.Item(idxLst))), "?20202271261818", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("wwpbaseobjects/workwithplusmasterpageap.js", "?20202271261818", false);
         }
