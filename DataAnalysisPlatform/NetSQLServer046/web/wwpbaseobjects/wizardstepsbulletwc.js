/*!   GeneXus C# 16_0_0-127771 on 2/27/2020 11:54:50.7
*/
...
gx.define('wwpbaseobjects.wizardstepsbulletwc', true, function (CmpContext) {
   ...
   this.GridwizardstepsContainer = new gx.grid.grid(this, 2,"WbpLvl2",5,"Gridwizardsteps","Gridwizardsteps","GridwizardstepsContainer",this.CmpContext,this.IsMasterPage,"wwpbaseobjects.wizardstepsbulletwc",[],true,0,true,true,0,false,false,false,"CollWWPBaseObjects\WizardSteps.WizardStepsItem",0,"px",0,"px","澧炲姞绌虹櫧琛?,false,false,false,null,null,false,"AV11WizardSteps",false,[1,1,1,1],false,0,false,false);
   ...
   this.EvtParms["REFRESH"] = [[{av:'GRIDWIZARDSTEPS_nFirstRecordOnPage'},{av:'GRIDWIZARDSTEPS_nEOF'},{av:'AV11WizardSteps',fld:'vWIZARDSTEPS',grid:5,pic:''},{av:'nRC_GXsfl_5',ctrl:'GRIDWIZARDSTEPS',prop:'GridRC'},{av:'sPrefix'},{av:'AV9StepNumber',fld:'vSTEPNUMBER',pic:'ZZZ9',hsh:true},{av:'AV12SelectedStepNumber',fld:'vSELECTEDSTEPNUMBER',pic:'ZZZ9',hsh:true}],[]];
   this.EvtParms["START"] = [[{av:'AV11WizardSteps',fld:'vWIZARDSTEPS',grid:5,pic:''},{av:'GRIDWIZARDSTEPS_nFirstRecordOnPage'},{av:'nRC_GXsfl_5',ctrl:'GRIDWIZARDSTEPS',prop:'GridRC'},{av:'AV8CurrentStep',fld:'vCURRENTSTEP',pic:''}],[{av:'AV12SelectedStepNumber',fld:'vSELECTEDSTEPNUMBER',pic:'ZZZ9',hsh:true},{av:'AV9StepNumber',fld:'vSTEPNUMBER',pic:'ZZZ9',hsh:true}]];
   this.EvtParms["GRIDWIZARDSTEPS.LOAD"] = [[{av:'AV9StepNumber',fld:'vSTEPNUMBER',pic:'ZZZ9',hsh:true},{av:'AV12SelectedStepNumber',fld:'vSELECTEDSTEPNUMBER',pic:'ZZZ9',hsh:true}],[{av:'gx.fn.getCtrlProperty("STEPNUMBER","Visible")',ctrl:'STEPNUMBER',prop:'Visible'},{av:'gx.fn.getCtrlProperty("STEPNUMBER","Caption")',ctrl:'STEPNUMBER',prop:'Caption'},{av:'gx.fn.getCtrlProperty("TABLESTEPBULLETLINELEFT","Class")',ctrl:'TABLESTEPBULLETLINELEFT',prop:'Class'},{av:'gx.fn.getCtrlProperty("TABLESTEPBULLETLINERIGHT","Class")',ctrl:'TABLESTEPBULLETLINERIGHT',prop:'Class'},{av:'gx.fn.getCtrlProperty("TABLESTEPITEM","Class")',ctrl:'TABLESTEPITEM',prop:'Class'},{ctrl:'WIZARDSTEPS__TITLE',prop:'Class'},{av:'gx.fn.getCtrlProperty("STEPNUMBER","Class")',ctrl:'STEPNUMBER',prop:'Class'},{av:'AV9StepNumber',fld:'vSTEPNUMBER',pic:'ZZZ9',hsh:true}]];
   this.setVCMap("AV9StepNumber", "STEPNUMBER", 0, "int", 4, 0);
   this.setVCMap("AV12SelectedStepNumber", "vSELECTEDSTEPNUMBER", 0, "int", 4, 0);
   this.setVCMap("AV11WizardSteps", "vWIZARDSTEPS", 0, "CollWWPBaseObjects\WizardSteps.WizardStepsItem", 0, 0);
   this.setVCMap("AV8CurrentStep", "vCURRENTSTEP", 0, "svchar", 40, 0);
   this.setVCMap("AV9StepNumber", "STEPNUMBER", 0, "int", 4, 0);
   this.setVCMap("AV12SelectedStepNumber", "vSELECTEDSTEPNUMBER", 0, "int", 4, 0);
   this.setVCMap("AV9StepNumber", "STEPNUMBER", 0, "int", 4, 0);
   this.setVCMap("AV12SelectedStepNumber", "vSELECTEDSTEPNUMBER", 0, "int", 4, 0);
