/*!   GeneXus C# 16_0_0-127771 on 2/27/2020 11:58:17.68
*/
...
gx.define('wwpbaseobjects.exportoptions', false, function () {
   ...
   this.Validv_Exporttype=function()
   {
      try {
         ...
         {
            try {
               gxballoon.setError("鍩烢xport Type瓒呯晫");
   ...
   INNEWWINDOW1Container.setDynProp("Width", "Width", "", "str");
   INNEWWINDOW1Container.setDynProp("Height", "Height", "", "str");
   ...
   INNEWWINDOW1Container.setProp("copyhistory", "Copyhistory", false, "bool");
   INNEWWINDOW1Container.setProp("top", "Top", "", "str");
   INNEWWINDOW1Container.setProp("left", "Left", "", "str");
   ...
   DVPANEL_TABLEEXPORTContainer.setProp("Title", "Title", "瀵煎嚭鍒板摢閲岋紵", "str");
   ...
   DVPANEL_TABLEATTRIBUTESContainer.setProp("Title", "Title", "璋锋瓕浜戠纭洏淇℃伅", "str");
   ...
   this.EvtParms["START"] = [[{av:'AV9DefaultTitle',fld:'vDEFAULTTITLE',pic:'',hsh:true},{av:'AV12ExcelFileName',fld:'vEXCELFILENAME',pic:'',hsh:true},{av:'AV26Pgmname',fld:'vPGMNAME',pic:''}],[{av:'gx.fn.getCtrlProperty("TABLECONTENT","Height")',ctrl:'TABLECONTENT',prop:'Height'},{av:'AV5DocTitle',fld:'vDOCTITLE',pic:''},{av:'gx.fn.getCtrlProperty("vPASSWORD","Ispassword")',ctrl:'vPASSWORD',prop:'Ispassword'},{av:'gx.fn.getCtrlProperty("TABLEGOOGLEDRIVEINFO","Visible")',ctrl:'TABLEGOOGLEDRIVEINFO',prop:'Visible'},{ctrl:'BTNSAVEGOOGLEDRIVE',prop:'Visible'},{ctrl:'BTNDOWNLOADTOFILE',prop:'Jsonclick'},{av:'gx.fn.getCtrlProperty("JS","Caption")',ctrl:'JS',prop:'Caption'}]];
