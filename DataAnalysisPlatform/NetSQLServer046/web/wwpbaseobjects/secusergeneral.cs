/*
       ...
       Generated on: 2/27/2020 11:54:48.29
...
namespace GeneXus.Programs.wwpbaseobjects {
   public class secusergeneral : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202022711544833", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void RenderHtmlCloseForm0Z2( )
      {
         ...
         {
            context.AddJavascriptSource("wwpbaseobjects/secusergeneral.js", "?202022711544836", false);
         }
      ...
      protected void WB0Z0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblocksecusername_Internalname, "姓名", "", "", lblTextblocksecusername_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "Label", 0, "", 1, 1, 0, "HLP_WWPBaseObjects\\SecUserGeneral.htm");
            ...
            GxWebStd.gx_label_element( context, edtSecUserName_Internalname, "姓名", "col-sm-3 ReadonlyAttributeLabel", 0, true);
            /* Single line edit */
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202022711544884", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("wwpbaseobjects/secusergeneral.js", "?202022711544884", false);
         }
