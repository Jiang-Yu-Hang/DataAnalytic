/*
       ...
       Generated on: 2/27/2020 11:58:17.0
...
namespace GeneXus.Programs.wwpbaseobjects {
   public class managefilters : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20202271158174", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"FormNoBackgroundColor\" data-gx-class=\"FormNoBackgroundColor\" novalidate action=\""+formatLink("wwpbaseobjects.managefilters.aspx") + "?" + UrlEncode(StringUtil.RTrim(AV17UserKey))+"\">") ;
      ...
      protected void wb_table1_10_0A2e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnenter_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(13), 2, 0)+","+"null"+");", "保存", bttBtnenter_Jsonclick, 5, "确认", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"EENTER."+"'", TempTags, "", context.GetButtonType( ), "HLP_WWPBaseObjects\\ManageFilters.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtncancel_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(13), 2, 0)+","+"null"+");", "取消", bttBtncancel_Jsonclick, 1, "取消", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", context.GetButtonType( ), "HLP_WWPBaseObjects\\ManageFilters.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void wb_table2_29_0A2e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            StyleString = "";
            GxWebStd.gx_checkbox_ctrl( context, chkavCollectionisempty_Internalname, StringUtil.BoolToStr( AV18CollectionIsEmpty), "", "", chkavCollectionisempty.Visible, 1, "true", "", StyleString, ClassString, "", "", TempTags+" onclick=\"gx.fn.checkboxClick(34, this, 'true', 'false');gx.evt.onchange(this, event);\" ");
         }
         if ( wbEnd == 13 )
         {
            wbEnd = 0;
      ...
      protected void START0A2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "过滤器管理", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202022711581781", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("wwpbaseobjects/managefilters.js", "?202022711581781", false);
         context.AddJavascriptSource("Shared/jquery/jquery1.9.1.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/bootstrap.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRIDGRIDSTATECOLLECTIONS_nFirstRecordOnPage'},{av:'GRIDGRIDSTATECOLLECTIONS_nEOF'},{av:'AV7GridStateCollection',fld:'vGRIDSTATECOLLECTION',grid:13,pic:''},{av:'nRC_GXsfl_13',ctrl:'GRIDGRIDSTATECOLLECTIONS',prop:'GridRC'},{av:'subGridgridstatecollections_Rows',ctrl:'GRIDGRIDSTATECOLLECTIONS',prop:'Rows'},{av:'AV17UserKey',fld:'vUSERKEY',pic:'',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRIDGRIDSTATECOLLECTIONS.LOAD","{handler:'E130A2',iparms:[]");
         ...
         setEventMetadata("ENTER","{handler:'E110A2',iparms:[{av:'AV7GridStateCollection',fld:'vGRIDSTATECOLLECTION',grid:13,pic:''},{av:'GRIDGRIDSTATECOLLECTIONS_nFirstRecordOnPage'},{av:'nRC_GXsfl_13',ctrl:'GRIDGRIDSTATECOLLECTIONS',prop:'GridRC'},{av:'AV18CollectionIsEmpty',fld:'vCOLLECTIONISEMPTY',pic:''},{av:'AV17UserKey',fld:'vUSERKEY',pic:'',hsh:true},{av:'GRIDGRIDSTATECOLLECTIONS_nEOF'},{av:'subGridgridstatecollections_Rows'}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV7GridStateCollection',fld:'vGRIDSTATECOLLECTION',grid:13,pic:''},{av:'GRIDGRIDSTATECOLLECTIONS_nFirstRecordOnPage'},{av:'nRC_GXsfl_13',ctrl:'GRIDGRIDSTATECOLLECTIONS',prop:'GridRC'}]}");
         setEventMetadata("VMOVEUP.CLICK","{handler:'E140A2',iparms:[{av:'AV7GridStateCollection',fld:'vGRIDSTATECOLLECTION',grid:13,pic:''},{av:'GRIDGRIDSTATECOLLECTIONS_nFirstRecordOnPage'},{av:'nRC_GXsfl_13',ctrl:'GRIDGRIDSTATECOLLECTIONS',prop:'GridRC'},{av:'GRIDGRIDSTATECOLLECTIONS_nEOF'},{av:'subGridgridstatecollections_Rows'},{av:'AV17UserKey',fld:'vUSERKEY',pic:'',hsh:true}]");
         setEventMetadata("VMOVEUP.CLICK",",oparms:[{av:'AV7GridStateCollection',fld:'vGRIDSTATECOLLECTION',grid:13,pic:''},{av:'GRIDGRIDSTATECOLLECTIONS_nFirstRecordOnPage'},{av:'nRC_GXsfl_13',ctrl:'GRIDGRIDSTATECOLLECTIONS',prop:'GridRC'}]}");
         setEventMetadata("VMOVEDOWN.CLICK","{handler:'E150A2',iparms:[{av:'AV7GridStateCollection',fld:'vGRIDSTATECOLLECTION',grid:13,pic:''},{av:'GRIDGRIDSTATECOLLECTIONS_nFirstRecordOnPage'},{av:'nRC_GXsfl_13',ctrl:'GRIDGRIDSTATECOLLECTIONS',prop:'GridRC'},{av:'GRIDGRIDSTATECOLLECTIONS_nEOF'},{av:'subGridgridstatecollections_Rows'},{av:'AV17UserKey',fld:'vUSERKEY',pic:'',hsh:true}]");
         setEventMetadata("VMOVEDOWN.CLICK",",oparms:[{av:'AV7GridStateCollection',fld:'vGRIDSTATECOLLECTION',grid:13,pic:''},{av:'GRIDGRIDSTATECOLLECTIONS_nFirstRecordOnPage'},{av:'nRC_GXsfl_13',ctrl:'GRIDGRIDSTATECOLLECTIONS',prop:'GridRC'}]}");
         setEventMetadata("VUDELETE.CLICK","{handler:'E160A2',iparms:[{av:'AV7GridStateCollection',fld:'vGRIDSTATECOLLECTION',grid:13,pic:''},{av:'GRIDGRIDSTATECOLLECTIONS_nFirstRecordOnPage'},{av:'nRC_GXsfl_13',ctrl:'GRIDGRIDSTATECOLLECTIONS',prop:'GridRC'},{av:'GRIDGRIDSTATECOLLECTIONS_nEOF'},{av:'subGridgridstatecollections_Rows'},{av:'AV17UserKey',fld:'vUSERKEY',pic:'',hsh:true}]");
         setEventMetadata("VUDELETE.CLICK",",oparms:[{av:'AV7GridStateCollection',fld:'vGRIDSTATECOLLECTION',grid:13,pic:''},{av:'GRIDGRIDSTATECOLLECTIONS_nFirstRecordOnPage'},{av:'nRC_GXsfl_13',ctrl:'GRIDGRIDSTATECOLLECTIONS',prop:'GridRC'},{av:'AV18CollectionIsEmpty',fld:'vCOLLECTIONISEMPTY',pic:''}]}");
         ...
         setEventMetadata("GRIDGRIDSTATECOLLECTIONS_FIRSTPAGE",",oparms:[]}");
         ...
         setEventMetadata("GRIDGRIDSTATECOLLECTIONS_PREVPAGE",",oparms:[]}");
         ...
         setEventMetadata("GRIDGRIDSTATECOLLECTIONS_NEXTPAGE",",oparms:[]}");
         ...
         setEventMetadata("GRIDGRIDSTATECOLLECTIONS_LASTPAGE",",oparms:[]}");
         return  ;
      }
