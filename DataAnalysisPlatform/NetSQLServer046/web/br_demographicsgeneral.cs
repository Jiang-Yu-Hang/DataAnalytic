/*
       ...
       Generated on: 2/27/2020 11:55:49.77
...
namespace GeneXus.Programs {
   public class br_demographicsgeneral : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202022711554982", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void RenderHtmlCloseForm2N2( )
      {
         ...
         {
            context.AddJavascriptSource("br_demographicsgeneral.js", "?202022711554986", false);
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?20202271155516", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("br_demographicsgeneral.js", "?20202271155516", false);
