/*
       ...
       Generated on: 2/27/2020 11:54:0.36
   ...
   public class br_encountercheckbr_medicalimagingwc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV61Pgmname = "BR_EncounterCheckBR_MedicalImagingWC";
               context.Gx_err = 0;
               WS5J2( ) ;
               if ( ! isAjaxCallMode( ) )
               {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20202271154058", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void RenderHtmlCloseForm5J2( )
      {
         ...
         {
            context.AddJavascriptSource("br_encountercheckbr_medicalimagingwc.js", "?2020227115439", false);
         }
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtavDisplay_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV49Display)) ? AV60Display_GXI : context.convertURL( context.PathToRelativeUrl( AV49Display))), !bGXsfl_12_Refreshing);
      ...
      protected void S122( )
      {
         ...
         {
            AV12GridState.FromXml(new GeneXus.Programs.wwpbaseobjects.loadgridstate(context).executeUdp(  AV61Pgmname+"GridState"), null, "WWPGridState", "DataAnalysisPlatform");
         }
         else
         {
            AV12GridState.FromXml(AV16Session.Get(AV61Pgmname+"GridState"), null, "WWPGridState", "DataAnalysisPlatform");
         }
      ...
      protected void S142( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.savegridstate(context ).execute(  AV61Pgmname+"GridState",  AV12GridState.ToXml(false, true, "WWPGridState", "DataAnalysisPlatform")) ;
      }
      ...
      protected void S112( )
      {
         ...
         AV10TrnContext.gxTpr_Callerobject = AV61Pgmname;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202022711541687", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("br_encountercheckbr_medicalimagingwc.js", "?202022711541688", false);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
      ...
      protected void sendrow_122( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_12_idx <= subGrid_Recordsperpage( ) * 1 ) )
         {
            ...
            StyleString = "";
            AV49Display_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV49Display))&&String.IsNullOrEmpty(StringUtil.RTrim( AV60Display_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV49Display)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV49Display)) ? AV60Display_GXI : context.PathToRelativeUrl( AV49Display));
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE","{handler:'E115J2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV8BR_EncounterID',fld:'vBR_ENCOUNTERID',pic:'ZZZZZZZZZZZZZZZZZZ'},{av:'AV18ddo_BR_MedicalImagingIDTitleControlIdToReplace',fld:'vDDO_BR_MEDICALIMAGINGIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV28ddo_BR_MedicalImaging_ImageAgeTitleControlIdToReplace',fld:'vDDO_BR_MEDICALIMAGING_IMAGEAGETITLECONTROLIDTOREPLACE',pic:''},{av:'AV22ddo_BR_MedicalImaging_ImageNameTitleControlIdToReplace',fld:'vDDO_BR_MEDICALIMAGING_IMAGENAMETITLECONTROLIDTOREPLACE',pic:''},{av:'AV24ddo_BR_MedicalImaging_ImageDateTitleControlIdToReplace',fld:'vDDO_BR_MEDICALIMAGING_IMAGEDATETITLECONTROLIDTOREPLACE',pic:''},{av:'AV26ddo_BR_MedicalImaging_ImageHospTitleControlIdToReplace',fld:'vDDO_BR_MEDICALIMAGING_IMAGEHOSPTITLECONTROLIDTOREPLACE',pic:''},{av:'AV61Pgmname',fld:'vPGMNAME',pic:''},{av:'AV50IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:''},{av:'sPrefix'},{av:'Gridpaginationbar_Selectedpage',ctrl:'GRIDPAGINATIONBAR',prop:'SelectedPage'}]");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEPAGE",",oparms:[]}");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE","{handler:'E125J2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV8BR_EncounterID',fld:'vBR_ENCOUNTERID',pic:'ZZZZZZZZZZZZZZZZZZ'},{av:'AV18ddo_BR_MedicalImagingIDTitleControlIdToReplace',fld:'vDDO_BR_MEDICALIMAGINGIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV28ddo_BR_MedicalImaging_ImageAgeTitleControlIdToReplace',fld:'vDDO_BR_MEDICALIMAGING_IMAGEAGETITLECONTROLIDTOREPLACE',pic:''},{av:'AV22ddo_BR_MedicalImaging_ImageNameTitleControlIdToReplace',fld:'vDDO_BR_MEDICALIMAGING_IMAGENAMETITLECONTROLIDTOREPLACE',pic:''},{av:'AV24ddo_BR_MedicalImaging_ImageDateTitleControlIdToReplace',fld:'vDDO_BR_MEDICALIMAGING_IMAGEDATETITLECONTROLIDTOREPLACE',pic:''},{av:'AV26ddo_BR_MedicalImaging_ImageHospTitleControlIdToReplace',fld:'vDDO_BR_MEDICALIMAGING_IMAGEHOSPTITLECONTROLIDTOREPLACE',pic:''},{av:'AV61Pgmname',fld:'vPGMNAME',pic:''},{av:'AV50IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:''},{av:'sPrefix'},{av:'Gridpaginationbar_Rowsperpageselectedvalue',ctrl:'GRIDPAGINATIONBAR',prop:'RowsPerPageSelectedValue'}]");
         setEventMetadata("GRIDPAGINATIONBAR.CHANGEROWSPERPAGE",",oparms:[{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'}]}");
         setEventMetadata("DDO_BR_MEDICALIMAGINGID.ONOPTIONCLICKED","{handler:'E135J2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV8BR_EncounterID',fld:'vBR_ENCOUNTERID',pic:'ZZZZZZZZZZZZZZZZZZ'},{av:'AV18ddo_BR_MedicalImagingIDTitleControlIdToReplace',fld:'vDDO_BR_MEDICALIMAGINGIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV28ddo_BR_MedicalImaging_ImageAgeTitleControlIdToReplace',fld:'vDDO_BR_MEDICALIMAGING_IMAGEAGETITLECONTROLIDTOREPLACE',pic:''},{av:'AV22ddo_BR_MedicalImaging_ImageNameTitleControlIdToReplace',fld:'vDDO_BR_MEDICALIMAGING_IMAGENAMETITLECONTROLIDTOREPLACE',pic:''},{av:'AV24ddo_BR_MedicalImaging_ImageDateTitleControlIdToReplace',fld:'vDDO_BR_MEDICALIMAGING_IMAGEDATETITLECONTROLIDTOREPLACE',pic:''},{av:'AV26ddo_BR_MedicalImaging_ImageHospTitleControlIdToReplace',fld:'vDDO_BR_MEDICALIMAGING_IMAGEHOSPTITLECONTROLIDTOREPLACE',pic:''},{av:'AV61Pgmname',fld:'vPGMNAME',pic:''},{av:'AV50IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:''},{av:'sPrefix'},{av:'Ddo_br_medicalimagingid_Activeeventkey',ctrl:'DDO_BR_MEDICALIMAGINGID',prop:'ActiveEventKey'}]");
         ...
         setEventMetadata("DDO_BR_MEDICALIMAGING_IMAGEAGE.ONOPTIONCLICKED","{handler:'E145J2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV8BR_EncounterID',fld:'vBR_ENCOUNTERID',pic:'ZZZZZZZZZZZZZZZZZZ'},{av:'AV18ddo_BR_MedicalImagingIDTitleControlIdToReplace',fld:'vDDO_BR_MEDICALIMAGINGIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV28ddo_BR_MedicalImaging_ImageAgeTitleControlIdToReplace',fld:'vDDO_BR_MEDICALIMAGING_IMAGEAGETITLECONTROLIDTOREPLACE',pic:''},{av:'AV22ddo_BR_MedicalImaging_ImageNameTitleControlIdToReplace',fld:'vDDO_BR_MEDICALIMAGING_IMAGENAMETITLECONTROLIDTOREPLACE',pic:''},{av:'AV24ddo_BR_MedicalImaging_ImageDateTitleControlIdToReplace',fld:'vDDO_BR_MEDICALIMAGING_IMAGEDATETITLECONTROLIDTOREPLACE',pic:''},{av:'AV26ddo_BR_MedicalImaging_ImageHospTitleControlIdToReplace',fld:'vDDO_BR_MEDICALIMAGING_IMAGEHOSPTITLECONTROLIDTOREPLACE',pic:''},{av:'AV61Pgmname',fld:'vPGMNAME',pic:''},{av:'AV50IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:''},{av:'sPrefix'},{av:'Ddo_br_medicalimaging_imageage_Activeeventkey',ctrl:'DDO_BR_MEDICALIMAGING_IMAGEAGE',prop:'ActiveEventKey'}]");
         ...
         setEventMetadata("DDO_BR_MEDICALIMAGING_IMAGENAME.ONOPTIONCLICKED","{handler:'E155J2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV8BR_EncounterID',fld:'vBR_ENCOUNTERID',pic:'ZZZZZZZZZZZZZZZZZZ'},{av:'AV18ddo_BR_MedicalImagingIDTitleControlIdToReplace',fld:'vDDO_BR_MEDICALIMAGINGIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV28ddo_BR_MedicalImaging_ImageAgeTitleControlIdToReplace',fld:'vDDO_BR_MEDICALIMAGING_IMAGEAGETITLECONTROLIDTOREPLACE',pic:''},{av:'AV22ddo_BR_MedicalImaging_ImageNameTitleControlIdToReplace',fld:'vDDO_BR_MEDICALIMAGING_IMAGENAMETITLECONTROLIDTOREPLACE',pic:''},{av:'AV24ddo_BR_MedicalImaging_ImageDateTitleControlIdToReplace',fld:'vDDO_BR_MEDICALIMAGING_IMAGEDATETITLECONTROLIDTOREPLACE',pic:''},{av:'AV26ddo_BR_MedicalImaging_ImageHospTitleControlIdToReplace',fld:'vDDO_BR_MEDICALIMAGING_IMAGEHOSPTITLECONTROLIDTOREPLACE',pic:''},{av:'AV61Pgmname',fld:'vPGMNAME',pic:''},{av:'AV50IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:''},{av:'sPrefix'},{av:'Ddo_br_medicalimaging_imagename_Activeeventkey',ctrl:'DDO_BR_MEDICALIMAGING_IMAGENAME',prop:'ActiveEventKey'}]");
         ...
         setEventMetadata("DDO_BR_MEDICALIMAGING_IMAGEDATE.ONOPTIONCLICKED","{handler:'E165J2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV8BR_EncounterID',fld:'vBR_ENCOUNTERID',pic:'ZZZZZZZZZZZZZZZZZZ'},{av:'AV18ddo_BR_MedicalImagingIDTitleControlIdToReplace',fld:'vDDO_BR_MEDICALIMAGINGIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV28ddo_BR_MedicalImaging_ImageAgeTitleControlIdToReplace',fld:'vDDO_BR_MEDICALIMAGING_IMAGEAGETITLECONTROLIDTOREPLACE',pic:''},{av:'AV22ddo_BR_MedicalImaging_ImageNameTitleControlIdToReplace',fld:'vDDO_BR_MEDICALIMAGING_IMAGENAMETITLECONTROLIDTOREPLACE',pic:''},{av:'AV24ddo_BR_MedicalImaging_ImageDateTitleControlIdToReplace',fld:'vDDO_BR_MEDICALIMAGING_IMAGEDATETITLECONTROLIDTOREPLACE',pic:''},{av:'AV26ddo_BR_MedicalImaging_ImageHospTitleControlIdToReplace',fld:'vDDO_BR_MEDICALIMAGING_IMAGEHOSPTITLECONTROLIDTOREPLACE',pic:''},{av:'AV61Pgmname',fld:'vPGMNAME',pic:''},{av:'AV50IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:''},{av:'sPrefix'},{av:'Ddo_br_medicalimaging_imagedate_Activeeventkey',ctrl:'DDO_BR_MEDICALIMAGING_IMAGEDATE',prop:'ActiveEventKey'}]");
         ...
         setEventMetadata("DDO_BR_MEDICALIMAGING_IMAGEHOSP.ONOPTIONCLICKED","{handler:'E175J2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV8BR_EncounterID',fld:'vBR_ENCOUNTERID',pic:'ZZZZZZZZZZZZZZZZZZ'},{av:'AV18ddo_BR_MedicalImagingIDTitleControlIdToReplace',fld:'vDDO_BR_MEDICALIMAGINGIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV28ddo_BR_MedicalImaging_ImageAgeTitleControlIdToReplace',fld:'vDDO_BR_MEDICALIMAGING_IMAGEAGETITLECONTROLIDTOREPLACE',pic:''},{av:'AV22ddo_BR_MedicalImaging_ImageNameTitleControlIdToReplace',fld:'vDDO_BR_MEDICALIMAGING_IMAGENAMETITLECONTROLIDTOREPLACE',pic:''},{av:'AV24ddo_BR_MedicalImaging_ImageDateTitleControlIdToReplace',fld:'vDDO_BR_MEDICALIMAGING_IMAGEDATETITLECONTROLIDTOREPLACE',pic:''},{av:'AV26ddo_BR_MedicalImaging_ImageHospTitleControlIdToReplace',fld:'vDDO_BR_MEDICALIMAGING_IMAGEHOSPTITLECONTROLIDTOREPLACE',pic:''},{av:'AV61Pgmname',fld:'vPGMNAME',pic:''},{av:'AV50IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:''},{av:'sPrefix'},{av:'Ddo_br_medicalimaging_imagehosp_Activeeventkey',ctrl:'DDO_BR_MEDICALIMAGING_IMAGEHOSP',prop:'ActiveEventKey'}]");
