/*
               File: BR_EncounterUpdateBR_MedicationWC
        Description: Data Mgmt Portal - RAAP
             Author: GeneXus C# Generator version 16_0_0-127771
       Generated on: 2/27/2020 11:56:35.42
...
namespace GeneXus.Programs {
   public class br_encounterupdatebr_medicationwc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      public br_encounterupdatebr_medicationwc( )
      {
      ...
      public br_encounterupdatebr_medicationwc( IGxContext context )
      {
         ...
         if ( StringUtil.Len( (String)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
               {
                  ...
                  AV68IsAuthorized_Display = StringUtil.StrToBool( GetNextPar( ));
                  sPrefix = GetNextPar( );
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV79Pgmname = "BR_EncounterUpdateBR_MedicationWC";
               context.Gx_err = 0;
               WS272( ) ;
               if ( ! isAjaxCallMode( ) )
               {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202022711563578", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.skipLines(1);
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("br_encounterupdatebr_medicationwc.aspx") + "?" + UrlEncode("" +AV8BR_EncounterID)+"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_boolean_hidden_field( context, sPrefix+"vISAUTHORIZED_DISPLAY", AV68IsAuthorized_Display);
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"DVELOP_CONFIRMPANEL_GOTODELETE_Title", StringUtil.RTrim( Dvelop_confirmpanel_gotodelete_Title));
         GxWebStd.gx_hidden_field( context, sPrefix+"DVELOP_CONFIRMPANEL_GOTODELETE_Confirmationtext", StringUtil.RTrim( Dvelop_confirmpanel_gotodelete_Confirmationtext));
         GxWebStd.gx_hidden_field( context, sPrefix+"DVELOP_CONFIRMPANEL_GOTODELETE_Yesbuttoncaption", StringUtil.RTrim( Dvelop_confirmpanel_gotodelete_Yesbuttoncaption));
         GxWebStd.gx_hidden_field( context, sPrefix+"DVELOP_CONFIRMPANEL_GOTODELETE_Nobuttoncaption", StringUtil.RTrim( Dvelop_confirmpanel_gotodelete_Nobuttoncaption));
         GxWebStd.gx_hidden_field( context, sPrefix+"DVELOP_CONFIRMPANEL_GOTODELETE_Cancelbuttoncaption", StringUtil.RTrim( Dvelop_confirmpanel_gotodelete_Cancelbuttoncaption));
         GxWebStd.gx_hidden_field( context, sPrefix+"DVELOP_CONFIRMPANEL_GOTODELETE_Yesbuttonposition", StringUtil.RTrim( Dvelop_confirmpanel_gotodelete_Yesbuttonposition));
         GxWebStd.gx_hidden_field( context, sPrefix+"DVELOP_CONFIRMPANEL_GOTODELETE_Confirmtype", StringUtil.RTrim( Dvelop_confirmpanel_gotodelete_Confirmtype));
         GxWebStd.gx_hidden_field( context, sPrefix+"GRID_Rows", StringUtil.LTrim( StringUtil.NToC( (decimal)(subGrid_Rows), 6, 0, ".", "")));
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"DVELOP_CONFIRMPANEL_GOTODELETE_Result", StringUtil.RTrim( Dvelop_confirmpanel_gotodelete_Result));
         GxWebStd.gx_hidden_field( context, sPrefix+"GRID_Rows", StringUtil.LTrim( StringUtil.NToC( (decimal)(subGrid_Rows), 6, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"GRIDPAGINATIONBAR_Selectedpage", StringUtil.RTrim( Gridpaginationbar_Selectedpage));
         GxWebStd.gx_hidden_field( context, sPrefix+"GRIDPAGINATIONBAR_Rowsperpageselectedvalue", StringUtil.LTrim( StringUtil.NToC( (decimal)(Gridpaginationbar_Rowsperpageselectedvalue), 9, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"DDO_BR_MEDICATIONID_Activeeventkey", StringUtil.RTrim( Ddo_br_medicationid_Activeeventkey));
      ...
      protected void RenderHtmlCloseForm272( )
      {
         ...
         {
            context.AddJavascriptSource("br_encounterupdatebr_medicationwc.js", "?202022711564012", false);
         }
      ...
      {
         return "BR_EncounterUpdateBR_MedicationWC" ;
      }
      ...
      protected void WB270( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "br_encounterupdatebr_medicationwc.aspx");
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
               context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false);
               context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false);
               context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(28), 2, 0)+","+"null"+");", "新增", bttBtninsert_Jsonclick, 5, "插入", "", StyleString, ClassString, bttBtninsert_Visible, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_BR_EncounterUpdateBR_MedicationWC.htm");
            ...
            if ( GridContainer.GetWrapped() == 1 )
            {
               ...
               context.SendWebValue( "") ;
               context.WriteHtmlTextNl( "</th>") ;
               context.WriteHtmlText( "<th align=\""+""+"\" "+" nowrap=\"nowrap\" "+" class=\""+"ActionBaseColorAttribute"+"\" "+" style=\""+((edtavGotodelete_Visible==0) ? "display:none;" : "")+""+"\" "+">") ;
               context.SendWebValue( "") ;
               context.WriteHtmlTextNl( "</th>") ;
            ...
            else
            {
               ...
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", context.convertURL( AV70gotodelete));
               GridColumn.AddObjectProperty("Tooltiptext", StringUtil.RTrim( edtavGotodelete_Tooltiptext));
               GridColumn.AddObjectProperty("Visible", StringUtil.LTrim( StringUtil.NToC( (decimal)(edtavGotodelete_Visible), 5, 0, ".", "")));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
         ...
         if ( wbEnd == 28 )
         {
            ...
            ClassString = "Attribute";
            StyleString = "";
            GxWebStd.gx_html_textarea( context, edtavDdo_br_medicationidtitlecontrolidtoreplace_Internalname, AV18ddo_BR_MedicationIDTitleControlIdToReplace, "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,54);\"", 0, edtavDdo_br_medicationidtitlecontrolidtoreplace_Visible, 1, 0, 80, "chr", 4, "row", StyleString, ClassString, "", "", "300", -1, 0, "", "", -1, true, "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", 0, "HLP_BR_EncounterUpdateBR_MedicationWC.htm");
            /* User Defined Control */
            ...
            ClassString = "Attribute";
            StyleString = "";
            GxWebStd.gx_html_textarea( context, edtavDdo_br_medication_rxnametitlecontrolidtoreplace_Internalname, AV22ddo_BR_Medication_RXNameTitleControlIdToReplace, "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,56);\"", 0, edtavDdo_br_medication_rxnametitlecontrolidtoreplace_Visible, 1, 0, 80, "chr", 4, "row", StyleString, ClassString, "", "", "300", -1, 0, "", "", -1, true, "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", 0, "HLP_BR_EncounterUpdateBR_MedicationWC.htm");
            /* User Defined Control */
            ...
            ClassString = "Attribute";
            StyleString = "";
            GxWebStd.gx_html_textarea( context, edtavDdo_br_medication_admitstartdatetitlecontrolidtoreplace_Internalname, AV44ddo_BR_Medication_AdmitStartDateTitleControlIdToReplace, "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,58);\"", 0, edtavDdo_br_medication_admitstartdatetitlecontrolidtoreplace_Visible, 1, 0, 80, "chr", 4, "row", StyleString, ClassString, "", "", "300", -1, 0, "", "", -1, true, "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", 0, "HLP_BR_EncounterUpdateBR_MedicationWC.htm");
            /* User Defined Control */
            ...
            ClassString = "Attribute";
            StyleString = "";
            GxWebStd.gx_html_textarea( context, edtavDdo_br_medication_admitenddatetitlecontrolidtoreplace_Internalname, AV46ddo_BR_Medication_AdmitEndDateTitleControlIdToReplace, "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,60);\"", 0, edtavDdo_br_medication_admitenddatetitlecontrolidtoreplace_Visible, 1, 0, 80, "chr", 4, "row", StyleString, ClassString, "", "", "300", -1, 0, "", "", -1, true, "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", 0, "HLP_BR_EncounterUpdateBR_MedicationWC.htm");
            /* User Defined Control */
            ...
            ClassString = "Attribute";
            StyleString = "";
            GxWebStd.gx_html_textarea( context, edtavDdo_br_medication_rxdosetitlecontrolidtoreplace_Internalname, AV28ddo_BR_Medication_RXDoseTitleControlIdToReplace, "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,62);\"", 0, edtavDdo_br_medication_rxdosetitlecontrolidtoreplace_Visible, 1, 0, 80, "chr", 4, "row", StyleString, ClassString, "", "", "300", -1, 0, "", "", -1, true, "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", 0, "HLP_BR_EncounterUpdateBR_MedicationWC.htm");
            /* User Defined Control */
            ...
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 67,'" + sPrefix + "',false,'" + sGXsfl_28_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavBr_medicationid_selected_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV72BR_MedicationID_Selected), 18, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV72BR_MedicationID_Selected), "ZZZZZZZZZZZZZZZZZZ")), TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,67);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavBr_medicationid_selected_Jsonclick, 0, "Attribute", "", "", "", "", edtavBr_medicationid_selected_Visible, 1, 0, "number", "1", 18, "chr", 1, "row", 18, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_BR_EncounterUpdateBR_MedicationWC.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 68,'" + sPrefix + "',false,'" + sGXsfl_28_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavOrderedby_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV14OrderedBy), 4, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV14OrderedBy), "ZZZ9")), TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,68);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavOrderedby_Jsonclick, 0, "Attribute", "", "", "", "", edtavOrderedby_Visible, 1, 0, "number", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_BR_EncounterUpdateBR_MedicationWC.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 69,'" + sPrefix + "',false,'" + sGXsfl_28_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavOrdereddsc_Internalname, StringUtil.BoolToStr( AV15OrderedDsc), StringUtil.BoolToStr( AV15OrderedDsc), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,69);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavOrdereddsc_Jsonclick, 0, "Attribute", "", "", "", "", edtavOrdereddsc_Visible, 1, 0, "text", "", 4, "chr", 1, "row", 4, 0, 0, 0, 1, 0, 0, true, "", "right", false, "HLP_BR_EncounterUpdateBR_MedicationWC.htm");
                  ...
                  if ( StringUtil.Len( sEvt) > 0 )
                  {
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                        {
                           ...
                           else if ( StringUtil.StrCmp(sEvt, "DVELOP_CONFIRMPANEL_GOTODELETE.CLOSE") == 0 )
                           {
                              if ( ( StringUtil.Len( sPrefix) != 0 ) && ( nDoneStart == 0 ) )
                              {
                                 STRUP270( ) ;
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 13), "VUPDATE.CLICK") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 13), "VUPDATE.CLICK") == 0 ) )
                           {
                              ...
                              context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtavDisplay_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV67Display)) ? AV76Display_GXI : context.convertURL( context.PathToRelativeUrl( AV67Display))), !bGXsfl_28_Refreshing);
                              ...
                              context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtavUpdate_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV63Update)) ? AV77Update_GXI : context.convertURL( context.PathToRelativeUrl( AV63Update))), !bGXsfl_28_Refreshing);
                              context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtavUpdate_Internalname, "SrcSet", context.GetImageSrcSet( AV63Update), true);
                              AV70gotodelete = cgiGet( edtavGotodelete_Internalname);
                              context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtavGotodelete_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV70gotodelete)) ? AV78Gotodelete_GXI : context.convertURL( context.PathToRelativeUrl( AV70gotodelete))), !bGXsfl_28_Refreshing);
                              context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtavGotodelete_Internalname, "SrcSet", context.GetImageSrcSet( AV70gotodelete), true);
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_BR_MEDICATIONID", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(A119BR_MedicationID), "ZZZZZZZZZZZZZZZZZZ"), context));
         GxWebStd.gx_hidden_field( context, sPrefix+"BR_MEDICATIONID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A119BR_MedicationID), 18, 0, ".", "")));
      }
      ...
      protected void RF272( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A19BR_EncounterID = H00272_A19BR_EncounterID[0];
               ...
               A131BR_Medication_InpatientChemo = H00272_A131BR_Medication_InpatientChemo[0];
               n131BR_Medication_InpatientChemo = H00272_n131BR_Medication_InpatientChemo[0];
               A130BR_Medication_PrescriptionDate = H00272_A130BR_Medication_PrescriptionDate[0];
               n130BR_Medication_PrescriptionDate = H00272_n130BR_Medication_PrescriptionDate[0];
               A129BR_Medication_RXRoute = H00272_A129BR_Medication_RXRoute[0];
               n129BR_Medication_RXRoute = H00272_n129BR_Medication_RXRoute[0];
               A128BR_Medication_RXDaysSupply = H00272_A128BR_Medication_RXDaysSupply[0];
               n128BR_Medication_RXDaysSupply = H00272_n128BR_Medication_RXDaysSupply[0];
               A127BR_Medication_RXQuantity = H00272_A127BR_Medication_RXQuantity[0];
               n127BR_Medication_RXQuantity = H00272_n127BR_Medication_RXQuantity[0];
               A126BR_Medication_RXFrequency = H00272_A126BR_Medication_RXFrequency[0];
               n126BR_Medication_RXFrequency = H00272_n126BR_Medication_RXFrequency[0];
               A125BR_Medication_RXUnit = H00272_A125BR_Medication_RXUnit[0];
               n125BR_Medication_RXUnit = H00272_n125BR_Medication_RXUnit[0];
               A123BR_Medication_RXType = H00272_A123BR_Medication_RXType[0];
               n123BR_Medication_RXType = H00272_n123BR_Medication_RXType[0];
               A122BR_Medication_RXCode = H00272_A122BR_Medication_RXCode[0];
               n122BR_Medication_RXCode = H00272_n122BR_Medication_RXCode[0];
               A124BR_Medication_RXDose = H00272_A124BR_Medication_RXDose[0];
               n124BR_Medication_RXDose = H00272_n124BR_Medication_RXDose[0];
               A133BR_Medication_AdmitEndDate = H00272_A133BR_Medication_AdmitEndDate[0];
               n133BR_Medication_AdmitEndDate = H00272_n133BR_Medication_AdmitEndDate[0];
               A132BR_Medication_AdmitStartDate = H00272_A132BR_Medication_AdmitStartDate[0];
               n132BR_Medication_AdmitStartDate = H00272_n132BR_Medication_AdmitStartDate[0];
               A121BR_Medication_RXName = H00272_A121BR_Medication_RXName[0];
               n121BR_Medication_RXName = H00272_n121BR_Medication_RXName[0];
               A119BR_MedicationID = H00272_A119BR_MedicationID[0];
               E23272 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_BR_MEDICATIONID"+"_"+sGXsfl_28_idx, GetSecureSignedToken( sPrefix+sGXsfl_28_idx, context.localUtil.Format( (decimal)(A119BR_MedicationID), "ZZZZZZZZZZZZZZZZZZ"), context));
      }
      ...
      protected void STRUP270( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "A19BR_EncounterID", StringUtil.LTrim( StringUtil.Str( (decimal)(A19BR_EncounterID), 18, 0)));
            if ( ( ( context.localUtil.CToN( cgiGet( edtavBr_medicationid_selected_Internalname), ".", ",") < Convert.ToDecimal( 0 )) ) || ( ( context.localUtil.CToN( cgiGet( edtavBr_medicationid_selected_Internalname), ".", ",") > Convert.ToDecimal( 999999999999999999L )) ) )
            {
               GX_msglist.addItem(context.GetMessage( "GXM_badnum", ""), 1, "vBR_MEDICATIONID_SELECTED");
               GX_FocusControl = edtavBr_medicationid_selected_Internalname;
               context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "GX_FocusControl", GX_FocusControl);
               wbErr = true;
               AV72BR_MedicationID_Selected = 0;
               context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "AV72BR_MedicationID_Selected", StringUtil.LTrim( StringUtil.Str( (decimal)(AV72BR_MedicationID_Selected), 18, 0)));
            }
            else
            {
               AV72BR_MedicationID_Selected = (long)(context.localUtil.CToN( cgiGet( edtavBr_medicationid_selected_Internalname), ".", ","));
               context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "AV72BR_MedicationID_Selected", StringUtil.LTrim( StringUtil.Str( (decimal)(AV72BR_MedicationID_Selected), 18, 0)));
            }
            ...
            Dvelop_confirmpanel_gotodelete_Title = cgiGet( sPrefix+"DVELOP_CONFIRMPANEL_GOTODELETE_Title");
            Dvelop_confirmpanel_gotodelete_Confirmationtext = cgiGet( sPrefix+"DVELOP_CONFIRMPANEL_GOTODELETE_Confirmationtext");
            Dvelop_confirmpanel_gotodelete_Yesbuttoncaption = cgiGet( sPrefix+"DVELOP_CONFIRMPANEL_GOTODELETE_Yesbuttoncaption");
            Dvelop_confirmpanel_gotodelete_Nobuttoncaption = cgiGet( sPrefix+"DVELOP_CONFIRMPANEL_GOTODELETE_Nobuttoncaption");
            Dvelop_confirmpanel_gotodelete_Cancelbuttoncaption = cgiGet( sPrefix+"DVELOP_CONFIRMPANEL_GOTODELETE_Cancelbuttoncaption");
            Dvelop_confirmpanel_gotodelete_Yesbuttonposition = cgiGet( sPrefix+"DVELOP_CONFIRMPANEL_GOTODELETE_Yesbuttonposition");
            Dvelop_confirmpanel_gotodelete_Confirmtype = cgiGet( sPrefix+"DVELOP_CONFIRMPANEL_GOTODELETE_Confirmtype");
            subGrid_Rows = (int)(context.localUtil.CToN( cgiGet( sPrefix+"GRID_Rows"), ".", ","));
            GxWebStd.gx_hidden_field( context, sPrefix+"GRID_Rows", StringUtil.LTrim( StringUtil.NToC( (decimal)(subGrid_Rows), 6, 0, ".", "")));
            ...
            Dvelop_confirmpanel_gotodelete_Result = cgiGet( sPrefix+"DVELOP_CONFIRMPANEL_GOTODELETE_Result");
      ...
      {
         /* Start Routine */
         edtavBr_medicationid_selected_Visible = 0;
         context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtavBr_medicationid_selected_Internalname, "Visible", StringUtil.LTrim( StringUtil.Str( (decimal)(edtavBr_medicationid_selected_Visible), 5, 0)), true);
         subGrid_Rows = 9;
         GxWebStd.gx_hidden_field( context, sPrefix+"GRID_Rows", StringUtil.LTrim( StringUtil.NToC( (decimal)(subGrid_Rows), 6, 0, ".", "")));
      ...
      protected void E22272( )
      {
         ...
         context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtBR_MedicationID_Internalname, "Title", edtBR_MedicationID_Title, !bGXsfl_28_Refreshing);
         ...
         context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtBR_Medication_AdmitStartDate_Internalname, "Title", edtBR_Medication_AdmitStartDate_Title, !bGXsfl_28_Refreshing);
         ...
         context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtBR_Medication_AdmitEndDate_Internalname, "Title", edtBR_Medication_AdmitEndDate_Title, !bGXsfl_28_Refreshing);
         ...
         context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtBR_Medication_RXCode_Internalname, "Title", edtBR_Medication_RXCode_Title, !bGXsfl_28_Refreshing);
      ...
      private void E23272( )
      {
         ...
         AV76Display_GXI = GXDbFile.PathToUrl( context.GetImagePath( "f11923b6-6acd-4a79-bfc0-0cfc6f3bced5", "", context.GetTheme( )));
         ...
         context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, edtavUpdate_Internalname, AV63Update);
         AV77Update_GXI = GXDbFile.PathToUrl( context.GetImagePath( "7c63c2b9-483e-4035-b512-febf9186a274", "", context.GetTheme( )));
         edtavUpdate_Tooltiptext = "";
         AV70gotodelete = context.GetImagePath( "7695fe89-52c9-4b7e-871e-0e11548f823e", "", context.GetTheme( ));
         context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, edtavGotodelete_Internalname, AV70gotodelete);
         AV78Gotodelete_GXI = GXDbFile.PathToUrl( context.GetImagePath( "7695fe89-52c9-4b7e-871e-0e11548f823e", "", context.GetTheme( )));
         edtavGotodelete_Tooltiptext = "";
         /* Load Method */
         if ( wbStart != -1 )
         {
            wbStart = 28;
      ...
      {
         /* Dvelop_confirmpanel_gotodelete_Close Routine */
         new zutil_checksession(context ).execute( out  AV73tCheckFlag) ;
         if ( ! AV73tCheckFlag )
         {
            if ( StringUtil.StrCmp(Dvelop_confirmpanel_gotodelete_Result, "Yes") == 0 )
            {
               /* Execute user subroutine: 'DO GOTODELETE' */
               S152 ();
               if ( returnInSub )
               {
                  returnInSub = true;
      ...
      protected void E20272( )
      {
         ...
         if ( 1 == 0 )
         {
            CallWebObject(formatLink("br_medication.aspx") + "?" + UrlEncode(StringUtil.RTrim("INS")) + "," + UrlEncode("" +0));
            context.wjLocDisableFrm = 1;
         }
         CallWebObject(formatLink("br_medicationinsert.aspx") + "?" + UrlEncode("" +AV8BR_EncounterID));
         context.wjLocDisableFrm = 1;
      }
      ...
      protected void S132( )
      {
         ...
         GXt_boolean2 = AV68IsAuthorized_Display;
         new GeneXus.Programs.wwpbaseobjects.secisauthbyfunctionalitykey(context ).execute(  "Manage_Medication", out  GXt_boolean2) ;
         AV68IsAuthorized_Display = GXt_boolean2;
         context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "AV68IsAuthorized_Display", AV68IsAuthorized_Display);
         if ( ! ( AV68IsAuthorized_Display ) )
         {
         ...
         GXt_boolean2 = AV64IsAuthorized_Update;
         new GeneXus.Programs.wwpbaseobjects.secisauthbyfunctionalitykey(context ).execute(  "Manage_Medication", out  GXt_boolean2) ;
         AV64IsAuthorized_Update = GXt_boolean2;
         ...
         GXt_boolean2 = AV71IsAuthorized_gotodelete;
         new GeneXus.Programs.wwpbaseobjects.secisauthbyfunctionalitykey(context ).execute(  "Manage_Medication", out  GXt_boolean2) ;
         AV71IsAuthorized_gotodelete = GXt_boolean2;
         if ( ! ( AV71IsAuthorized_gotodelete ) )
         {
            edtavGotodelete_Visible = 0;
            context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtavGotodelete_Internalname, "Visible", StringUtil.LTrim( StringUtil.Str( (decimal)(edtavGotodelete_Visible), 5, 0)), !bGXsfl_28_Refreshing);
         }
         GXt_boolean2 = AV69TempBoolean;
         new GeneXus.Programs.wwpbaseobjects.secisauthbyfunctionalitykey(context ).execute(  "Manage_Medication", out  GXt_boolean2) ;
         AV69TempBoolean = GXt_boolean2;
         if ( ! ( AV69TempBoolean ) )
         {
      ...
      protected void S152( )
      {
         /* 'DO GOTODELETE' Routine */
         new zbr_deletemedication(context ).execute(  AV8BR_EncounterID,  A119BR_MedicationID) ;
         context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "AV8BR_EncounterID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV8BR_EncounterID), 18, 0)));
         context.DoAjaxRefreshCmp(sPrefix);
      }
      ...
      protected void S122( )
      {
         ...
         {
            AV12GridState.FromXml(new GeneXus.Programs.wwpbaseobjects.loadgridstate(context).executeUdp(  AV79Pgmname+"GridState"), null, "WWPGridState", "DataAnalysisPlatform");
         }
         else
         {
            AV12GridState.FromXml(AV16Session.Get(AV79Pgmname+"GridState"), null, "WWPGridState", "DataAnalysisPlatform");
         }
      ...
      protected void S142( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.savegridstate(context ).execute(  AV79Pgmname+"GridState",  AV12GridState.ToXml(false, true, "WWPGridState", "DataAnalysisPlatform")) ;
      }
      ...
      protected void E24272( )
      {
         ...
         if ( ! AV73tCheckFlag )
         {
            CallWebObject(formatLink("br_medicationupdate.aspx") + "?" + UrlEncode("" +A119BR_MedicationID));
            context.wjLocDisableFrm = 1;
         }
      }
      ...
      protected void wb_table1_70_272( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            sStyleString = "";
            GxWebStd.gx_table_start( context, tblTabledvelop_confirmpanel_gotodelete_Internalname, tblTabledvelop_confirmpanel_gotodelete_Internalname, "", "Table", 0, "", "", 1, 2, sStyleString, "", "", 0);
            context.WriteHtmlText( "<tbody>") ;
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td data-align=\"center\"  style=\""+CSSHelper.Prettify( "text-align:-khtml-center;text-align:-moz-center;text-align:-webkit-center")+"\">") ;
            /* User Defined Control */
            ucDvelop_confirmpanel_gotodelete.SetProperty("Title", Dvelop_confirmpanel_gotodelete_Title);
            ucDvelop_confirmpanel_gotodelete.SetProperty("ConfirmationText", Dvelop_confirmpanel_gotodelete_Confirmationtext);
            ucDvelop_confirmpanel_gotodelete.SetProperty("YesButtonCaption", Dvelop_confirmpanel_gotodelete_Yesbuttoncaption);
            ucDvelop_confirmpanel_gotodelete.SetProperty("NoButtonCaption", Dvelop_confirmpanel_gotodelete_Nobuttoncaption);
            ucDvelop_confirmpanel_gotodelete.SetProperty("CancelButtonCaption", Dvelop_confirmpanel_gotodelete_Cancelbuttoncaption);
            ucDvelop_confirmpanel_gotodelete.SetProperty("YesButtonPosition", Dvelop_confirmpanel_gotodelete_Yesbuttonposition);
            ucDvelop_confirmpanel_gotodelete.SetProperty("ConfirmType", Dvelop_confirmpanel_gotodelete_Confirmtype);
            ucDvelop_confirmpanel_gotodelete.Render(context, "dvelop.gxbootstrap.confirmpanel", Dvelop_confirmpanel_gotodelete_Internalname, sPrefix+"DVELOP_CONFIRMPANEL_GOTODELETEContainer");
            context.WriteHtmlText( "<div class=\"gx_usercontrol_child\" id=\""+sPrefix+"DVELOP_CONFIRMPANEL_GOTODELETEContainer"+"Body"+"\" style=\"display:none;\">") ;
            context.WriteHtmlText( "</div>") ;
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "br_encounterupdatebr_medicationwc", GetJustCreated( ));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?20202271156595", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("br_encounterupdatebr_medicationwc.js", "?20202271156596", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
      ...
      protected void SubsflControlProps_282( )
      {
         ...
         edtavGotodelete_Internalname = sPrefix+"vGOTODELETE_"+sGXsfl_28_idx;
         ...
         edtBR_Medication_AdmitStartDate_Internalname = sPrefix+"BR_MEDICATION_ADMITSTARTDATE_"+sGXsfl_28_idx;
         edtBR_Medication_AdmitEndDate_Internalname = sPrefix+"BR_MEDICATION_ADMITENDDATE_"+sGXsfl_28_idx;
         edtBR_Medication_RXDose_Internalname = sPrefix+"BR_MEDICATION_RXDOSE_"+sGXsfl_28_idx;
         edtBR_Medication_RXCode_Internalname = sPrefix+"BR_MEDICATION_RXCODE_"+sGXsfl_28_idx;
         edtBR_Medication_RXType_Internalname = sPrefix+"BR_MEDICATION_RXTYPE_"+sGXsfl_28_idx;
         edtBR_Medication_RXUnit_Internalname = sPrefix+"BR_MEDICATION_RXUNIT_"+sGXsfl_28_idx;
         edtBR_Medication_RXFrequency_Internalname = sPrefix+"BR_MEDICATION_RXFREQUENCY_"+sGXsfl_28_idx;
         edtBR_Medication_RXQuantity_Internalname = sPrefix+"BR_MEDICATION_RXQUANTITY_"+sGXsfl_28_idx;
         edtBR_Medication_RXDaysSupply_Internalname = sPrefix+"BR_MEDICATION_RXDAYSSUPPLY_"+sGXsfl_28_idx;
         edtBR_Medication_RXRoute_Internalname = sPrefix+"BR_MEDICATION_RXROUTE_"+sGXsfl_28_idx;
         edtBR_Medication_PrescriptionDate_Internalname = sPrefix+"BR_MEDICATION_PRESCRIPTIONDATE_"+sGXsfl_28_idx;
         cmbBR_Medication_InpatientChemo_Internalname = sPrefix+"BR_MEDICATION_INPATIENTCHEMO_"+sGXsfl_28_idx;
      }
      ...
      protected void SubsflControlProps_fel_282( )
      {
         ...
         edtavGotodelete_Internalname = sPrefix+"vGOTODELETE_"+sGXsfl_28_fel_idx;
         ...
         edtBR_Medication_AdmitStartDate_Internalname = sPrefix+"BR_MEDICATION_ADMITSTARTDATE_"+sGXsfl_28_fel_idx;
         edtBR_Medication_AdmitEndDate_Internalname = sPrefix+"BR_MEDICATION_ADMITENDDATE_"+sGXsfl_28_fel_idx;
         edtBR_Medication_RXDose_Internalname = sPrefix+"BR_MEDICATION_RXDOSE_"+sGXsfl_28_fel_idx;
         edtBR_Medication_RXCode_Internalname = sPrefix+"BR_MEDICATION_RXCODE_"+sGXsfl_28_fel_idx;
         edtBR_Medication_RXType_Internalname = sPrefix+"BR_MEDICATION_RXTYPE_"+sGXsfl_28_fel_idx;
         edtBR_Medication_RXUnit_Internalname = sPrefix+"BR_MEDICATION_RXUNIT_"+sGXsfl_28_fel_idx;
         edtBR_Medication_RXFrequency_Internalname = sPrefix+"BR_MEDICATION_RXFREQUENCY_"+sGXsfl_28_fel_idx;
         edtBR_Medication_RXQuantity_Internalname = sPrefix+"BR_MEDICATION_RXQUANTITY_"+sGXsfl_28_fel_idx;
         edtBR_Medication_RXDaysSupply_Internalname = sPrefix+"BR_MEDICATION_RXDAYSSUPPLY_"+sGXsfl_28_fel_idx;
         edtBR_Medication_RXRoute_Internalname = sPrefix+"BR_MEDICATION_RXROUTE_"+sGXsfl_28_fel_idx;
         edtBR_Medication_PrescriptionDate_Internalname = sPrefix+"BR_MEDICATION_PRESCRIPTIONDATE_"+sGXsfl_28_fel_idx;
         cmbBR_Medication_InpatientChemo_Internalname = sPrefix+"BR_MEDICATION_INPATIENTCHEMO_"+sGXsfl_28_fel_idx;
      }
      ...
      protected void sendrow_282( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_28_idx <= subGrid_Recordsperpage( ) * 1 ) )
         {
            ...
            StyleString = "";
            AV67Display_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV67Display))&&String.IsNullOrEmpty(StringUtil.RTrim( AV76Display_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV67Display)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV67Display)) ? AV76Display_GXI : context.PathToRelativeUrl( AV67Display));
            ...
            ClassString = "ActionBaseColorAttribute";
            StyleString = "";
            AV63Update_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV63Update))&&String.IsNullOrEmpty(StringUtil.RTrim( AV77Update_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV63Update)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV63Update)) ? AV77Update_GXI : context.PathToRelativeUrl( AV63Update));
            GridRow.AddColumnProperties("bitmap", 1, isAjaxCallMode( ), new Object[] {(String)edtavUpdate_Internalname,(String)sImgUrl,(String)"",(String)"",(String)"",context.GetTheme( ),(int)edtavUpdate_Visible,(short)1,(String)"",(String)edtavUpdate_Tooltiptext,(short)0,(short)-1,(short)0,(String)"px",(short)0,(String)"px",(short)0,(short)0,(short)5,(String)edtavUpdate_Jsonclick,"'"+sPrefix+"'"+",false,"+"'"+sPrefix+"EVUPDATE.CLICK."+sGXsfl_28_idx+"'",(String)StyleString,(String)ClassString,(String)"WWActionColumn",(String)"",(String)"",(String)"",(String)""+TempTags,(String)"",(String)"",(short)1,(bool)AV63Update_IsBlob,(bool)false,context.GetImageSrcSet( sImgUrl)});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+""+"\""+" style=\""+((edtavGotodelete_Visible==0) ? "display:none;" : "")+"\">") ;
            }
            /* Active Bitmap Variable */
            TempTags = " " + ((edtavGotodelete_Enabled!=0)&&(edtavGotodelete_Visible!=0) ? " onfocus=\"gx.evt.onfocus(this, 31,'"+sPrefix+"',false,'',28)\"" : " ");
            ClassString = "ActionBaseColorAttribute";
            StyleString = "";
            AV70gotodelete_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV70gotodelete))&&String.IsNullOrEmpty(StringUtil.RTrim( AV78Gotodelete_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV70gotodelete)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV70gotodelete)) ? AV78Gotodelete_GXI : context.PathToRelativeUrl( AV70gotodelete));
            GridRow.AddColumnProperties("bitmap", 1, isAjaxCallMode( ), new Object[] {(String)edtavGotodelete_Internalname,(String)sImgUrl,(String)"",(String)"",(String)"",context.GetTheme( ),(int)edtavGotodelete_Visible,(short)1,(String)"",(String)edtavGotodelete_Tooltiptext,(short)0,(short)-1,(short)0,(String)"px",(short)0,(String)"px",(short)0,(short)0,(short)7,(String)edtavGotodelete_Jsonclick,(String)"'"+sPrefix+"'"+",false,"+"'"+"e25272_client"+"'",(String)StyleString,(String)ClassString,(String)"WWActionColumn",(String)"",(String)"",(String)"",(String)""+TempTags,(String)"",(String)"",(short)1,(bool)AV70gotodelete_IsBlob,(bool)false,context.GetImageSrcSet( sImgUrl)});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
            ...
            {
               GXCCtl = "BR_MEDICATION_INPATIENTCHEMO_" + sGXsfl_28_idx;
            ...
            context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, cmbBR_Medication_InpatientChemo_Internalname, "Values", (String)(cmbBR_Medication_InpatientChemo.ToJavascriptSource()), !bGXsfl_28_Refreshing);
      ...
      protected void init_default_properties( )
      {
         ...
         edtavGotodelete_Internalname = sPrefix+"vGOTODELETE";
         ...
         edtavBr_medicationid_selected_Internalname = sPrefix+"vBR_MEDICATIONID_SELECTED";
         edtavOrderedby_Internalname = sPrefix+"vORDEREDBY";
         edtavOrdereddsc_Internalname = sPrefix+"vORDEREDDSC";
         Dvelop_confirmpanel_gotodelete_Internalname = sPrefix+"DVELOP_CONFIRMPANEL_GOTODELETE";
         tblTabledvelop_confirmpanel_gotodelete_Internalname = sPrefix+"TABLEDVELOP_CONFIRMPANEL_GOTODELETE";
      ...
      public override void initialize_properties( )
      {
         ...
         edtavGotodelete_Jsonclick = "";
         edtavGotodelete_Enabled = 1;
         ...
         edtavBr_medicationid_selected_Jsonclick = "";
         edtavBr_medicationid_selected_Visible = 1;
         ...
         edtavGotodelete_Visible = -1;
         edtavUpdate_Visible = -1;
         edtavDisplay_Visible = -1;
         subGrid_Class = "GridWithPaginationBar GridWithBorderColor WorkWith";
         subGrid_Backcolorstyle = 0;
         bttBtninsert_Visible = 1;
         Dvelop_confirmpanel_gotodelete_Confirmtype = "1";
         Dvelop_confirmpanel_gotodelete_Yesbuttonposition = "left";
         Dvelop_confirmpanel_gotodelete_Cancelbuttoncaption = "WWP_ConfirmTextCancel";
         Dvelop_confirmpanel_gotodelete_Nobuttoncaption = "WWP_ConfirmTextNo";
         Dvelop_confirmpanel_gotodelete_Yesbuttoncaption = "WWP_ConfirmTextYes";
         Dvelop_confirmpanel_gotodelete_Confirmationtext = "确认删除？";
         Dvelop_confirmpanel_gotodelete_Title = "";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("DDO_BR_MEDICATION_RXNAME.ONOPTIONCLICKED","{handler:'E14272',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV8BR_EncounterID',fld:'vBR_ENCOUNTERID',pic:'ZZZZZZZZZZZZZZZZZZ'},{av:'AV18ddo_BR_MedicationIDTitleControlIdToReplace',fld:'vDDO_BR_MEDICATIONIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV22ddo_BR_Medication_RXNameTitleControlIdToReplace',fld:'vDDO_BR_MEDICATION_RXNAMETITLECONTROLIDTOREPLACE',pic:''},{av:'AV44ddo_BR_Medication_AdmitStartDateTitleControlIdToReplace',fld:'vDDO_BR_MEDICATION_ADMITSTARTDATETITLECONTROLIDTOREPLACE',pic:''},{av:'AV46ddo_BR_Medication_AdmitEndDateTitleControlIdToReplace',fld:'vDDO_BR_MEDICATION_ADMITENDDATETITLECONTROLIDTOREPLACE',pic:''},{av:'AV28ddo_BR_Medication_RXDoseTitleControlIdToReplace',fld:'vDDO_BR_MEDICATION_RXDOSETITLECONTROLIDTOREPLACE',pic:''},{av:'AV24ddo_BR_Medication_RXCodeTitleControlIdToReplace',fld:'vDDO_BR_MEDICATION_RXCODETITLECONTROLIDTOREPLACE',pic:''},{av:'AV79Pgmname',fld:'vPGMNAME',pic:''},{av:'AV68IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:''},{av:'sPrefix'},{av:'Ddo_br_medication_rxname_Activeeventkey',ctrl:'DDO_BR_MEDICATION_RXNAME',prop:'ActiveEventKey'}]");
         ...
         setEventMetadata("DDO_BR_MEDICATION_ADMITSTARTDATE.ONOPTIONCLICKED","{handler:'E15272',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV8BR_EncounterID',fld:'vBR_ENCOUNTERID',pic:'ZZZZZZZZZZZZZZZZZZ'},{av:'AV18ddo_BR_MedicationIDTitleControlIdToReplace',fld:'vDDO_BR_MEDICATIONIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV22ddo_BR_Medication_RXNameTitleControlIdToReplace',fld:'vDDO_BR_MEDICATION_RXNAMETITLECONTROLIDTOREPLACE',pic:''},{av:'AV44ddo_BR_Medication_AdmitStartDateTitleControlIdToReplace',fld:'vDDO_BR_MEDICATION_ADMITSTARTDATETITLECONTROLIDTOREPLACE',pic:''},{av:'AV46ddo_BR_Medication_AdmitEndDateTitleControlIdToReplace',fld:'vDDO_BR_MEDICATION_ADMITENDDATETITLECONTROLIDTOREPLACE',pic:''},{av:'AV28ddo_BR_Medication_RXDoseTitleControlIdToReplace',fld:'vDDO_BR_MEDICATION_RXDOSETITLECONTROLIDTOREPLACE',pic:''},{av:'AV24ddo_BR_Medication_RXCodeTitleControlIdToReplace',fld:'vDDO_BR_MEDICATION_RXCODETITLECONTROLIDTOREPLACE',pic:''},{av:'AV79Pgmname',fld:'vPGMNAME',pic:''},{av:'AV68IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:''},{av:'sPrefix'},{av:'Ddo_br_medication_admitstartdate_Activeeventkey',ctrl:'DDO_BR_MEDICATION_ADMITSTARTDATE',prop:'ActiveEventKey'}]");
         ...
         setEventMetadata("DDO_BR_MEDICATION_ADMITENDDATE.ONOPTIONCLICKED","{handler:'E16272',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV8BR_EncounterID',fld:'vBR_ENCOUNTERID',pic:'ZZZZZZZZZZZZZZZZZZ'},{av:'AV18ddo_BR_MedicationIDTitleControlIdToReplace',fld:'vDDO_BR_MEDICATIONIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV22ddo_BR_Medication_RXNameTitleControlIdToReplace',fld:'vDDO_BR_MEDICATION_RXNAMETITLECONTROLIDTOREPLACE',pic:''},{av:'AV44ddo_BR_Medication_AdmitStartDateTitleControlIdToReplace',fld:'vDDO_BR_MEDICATION_ADMITSTARTDATETITLECONTROLIDTOREPLACE',pic:''},{av:'AV46ddo_BR_Medication_AdmitEndDateTitleControlIdToReplace',fld:'vDDO_BR_MEDICATION_ADMITENDDATETITLECONTROLIDTOREPLACE',pic:''},{av:'AV28ddo_BR_Medication_RXDoseTitleControlIdToReplace',fld:'vDDO_BR_MEDICATION_RXDOSETITLECONTROLIDTOREPLACE',pic:''},{av:'AV24ddo_BR_Medication_RXCodeTitleControlIdToReplace',fld:'vDDO_BR_MEDICATION_RXCODETITLECONTROLIDTOREPLACE',pic:''},{av:'AV79Pgmname',fld:'vPGMNAME',pic:''},{av:'AV68IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:''},{av:'sPrefix'},{av:'Ddo_br_medication_admitenddate_Activeeventkey',ctrl:'DDO_BR_MEDICATION_ADMITENDDATE',prop:'ActiveEventKey'}]");
         ...
         setEventMetadata("DDO_BR_MEDICATION_RXDOSE.ONOPTIONCLICKED","{handler:'E17272',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV8BR_EncounterID',fld:'vBR_ENCOUNTERID',pic:'ZZZZZZZZZZZZZZZZZZ'},{av:'AV18ddo_BR_MedicationIDTitleControlIdToReplace',fld:'vDDO_BR_MEDICATIONIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV22ddo_BR_Medication_RXNameTitleControlIdToReplace',fld:'vDDO_BR_MEDICATION_RXNAMETITLECONTROLIDTOREPLACE',pic:''},{av:'AV44ddo_BR_Medication_AdmitStartDateTitleControlIdToReplace',fld:'vDDO_BR_MEDICATION_ADMITSTARTDATETITLECONTROLIDTOREPLACE',pic:''},{av:'AV46ddo_BR_Medication_AdmitEndDateTitleControlIdToReplace',fld:'vDDO_BR_MEDICATION_ADMITENDDATETITLECONTROLIDTOREPLACE',pic:''},{av:'AV28ddo_BR_Medication_RXDoseTitleControlIdToReplace',fld:'vDDO_BR_MEDICATION_RXDOSETITLECONTROLIDTOREPLACE',pic:''},{av:'AV24ddo_BR_Medication_RXCodeTitleControlIdToReplace',fld:'vDDO_BR_MEDICATION_RXCODETITLECONTROLIDTOREPLACE',pic:''},{av:'AV79Pgmname',fld:'vPGMNAME',pic:''},{av:'AV68IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:''},{av:'sPrefix'},{av:'Ddo_br_medication_rxdose_Activeeventkey',ctrl:'DDO_BR_MEDICATION_RXDOSE',prop:'ActiveEventKey'}]");
         ...
         setEventMetadata("DDO_BR_MEDICATION_RXCODE.ONOPTIONCLICKED","{handler:'E18272',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV8BR_EncounterID',fld:'vBR_ENCOUNTERID',pic:'ZZZZZZZZZZZZZZZZZZ'},{av:'AV18ddo_BR_MedicationIDTitleControlIdToReplace',fld:'vDDO_BR_MEDICATIONIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV22ddo_BR_Medication_RXNameTitleControlIdToReplace',fld:'vDDO_BR_MEDICATION_RXNAMETITLECONTROLIDTOREPLACE',pic:''},{av:'AV44ddo_BR_Medication_AdmitStartDateTitleControlIdToReplace',fld:'vDDO_BR_MEDICATION_ADMITSTARTDATETITLECONTROLIDTOREPLACE',pic:''},{av:'AV46ddo_BR_Medication_AdmitEndDateTitleControlIdToReplace',fld:'vDDO_BR_MEDICATION_ADMITENDDATETITLECONTROLIDTOREPLACE',pic:''},{av:'AV28ddo_BR_Medication_RXDoseTitleControlIdToReplace',fld:'vDDO_BR_MEDICATION_RXDOSETITLECONTROLIDTOREPLACE',pic:''},{av:'AV24ddo_BR_Medication_RXCodeTitleControlIdToReplace',fld:'vDDO_BR_MEDICATION_RXCODETITLECONTROLIDTOREPLACE',pic:''},{av:'AV79Pgmname',fld:'vPGMNAME',pic:''},{av:'AV68IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:''},{av:'sPrefix'},{av:'Ddo_br_medication_rxcode_Activeeventkey',ctrl:'DDO_BR_MEDICATION_RXCODE',prop:'ActiveEventKey'}]");
         ...
         setEventMetadata("GRID.LOAD","{handler:'E23272',iparms:[{av:'AV68IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:''},{av:'A119BR_MedicationID',fld:'BR_MEDICATIONID',pic:'ZZZZZZZZZZZZZZZZZZ',hsh:true}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'AV67Display',fld:'vDISPLAY',pic:''},{av:'edtavDisplay_Tooltiptext',ctrl:'vDISPLAY',prop:'Tooltiptext'},{av:'edtavDisplay_Link',ctrl:'vDISPLAY',prop:'Link'},{av:'AV63Update',fld:'vUPDATE',pic:''},{av:'edtavUpdate_Tooltiptext',ctrl:'vUPDATE',prop:'Tooltiptext'},{av:'AV70gotodelete',fld:'vGOTODELETE',pic:''},{av:'edtavGotodelete_Tooltiptext',ctrl:'vGOTODELETE',prop:'Tooltiptext'}]}");
         setEventMetadata("'DOGOTODELETE'","{handler:'E25272',iparms:[{av:'A119BR_MedicationID',fld:'BR_MEDICATIONID',pic:'ZZZZZZZZZZZZZZZZZZ',hsh:true}]");
         setEventMetadata("'DOGOTODELETE'",",oparms:[{av:'AV72BR_MedicationID_Selected',fld:'vBR_MEDICATIONID_SELECTED',pic:'ZZZZZZZZZZZZZZZZZZ'}]}");
         setEventMetadata("DVELOP_CONFIRMPANEL_GOTODELETE.CLOSE","{handler:'E19272',iparms:[{av:'Dvelop_confirmpanel_gotodelete_Result',ctrl:'DVELOP_CONFIRMPANEL_GOTODELETE',prop:'Result'},{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV8BR_EncounterID',fld:'vBR_ENCOUNTERID',pic:'ZZZZZZZZZZZZZZZZZZ'},{av:'AV18ddo_BR_MedicationIDTitleControlIdToReplace',fld:'vDDO_BR_MEDICATIONIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV22ddo_BR_Medication_RXNameTitleControlIdToReplace',fld:'vDDO_BR_MEDICATION_RXNAMETITLECONTROLIDTOREPLACE',pic:''},{av:'AV44ddo_BR_Medication_AdmitStartDateTitleControlIdToReplace',fld:'vDDO_BR_MEDICATION_ADMITSTARTDATETITLECONTROLIDTOREPLACE',pic:''},{av:'AV46ddo_BR_Medication_AdmitEndDateTitleControlIdToReplace',fld:'vDDO_BR_MEDICATION_ADMITENDDATETITLECONTROLIDTOREPLACE',pic:''},{av:'AV28ddo_BR_Medication_RXDoseTitleControlIdToReplace',fld:'vDDO_BR_MEDICATION_RXDOSETITLECONTROLIDTOREPLACE',pic:''},{av:'AV24ddo_BR_Medication_RXCodeTitleControlIdToReplace',fld:'vDDO_BR_MEDICATION_RXCODETITLECONTROLIDTOREPLACE',pic:''},{av:'AV79Pgmname',fld:'vPGMNAME',pic:''},{av:'AV68IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:''},{av:'sPrefix'},{av:'A119BR_MedicationID',fld:'BR_MEDICATIONID',pic:'ZZZZZZZZZZZZZZZZZZ',hsh:true}]");
         setEventMetadata("DVELOP_CONFIRMPANEL_GOTODELETE.CLOSE",",oparms:[{av:'AV17BR_MedicationIDTitleFilterData',fld:'vBR_MEDICATIONIDTITLEFILTERDATA',pic:''},{av:'AV21BR_Medication_RXNameTitleFilterData',fld:'vBR_MEDICATION_RXNAMETITLEFILTERDATA',pic:''},{av:'AV43BR_Medication_AdmitStartDateTitleFilterData',fld:'vBR_MEDICATION_ADMITSTARTDATETITLEFILTERDATA',pic:''},{av:'AV45BR_Medication_AdmitEndDateTitleFilterData',fld:'vBR_MEDICATION_ADMITENDDATETITLEFILTERDATA',pic:''},{av:'AV27BR_Medication_RXDoseTitleFilterData',fld:'vBR_MEDICATION_RXDOSETITLEFILTERDATA',pic:''},{av:'AV23BR_Medication_RXCodeTitleFilterData',fld:'vBR_MEDICATION_RXCODETITLEFILTERDATA',pic:''},{av:'edtBR_MedicationID_Titleformat',ctrl:'BR_MEDICATIONID',prop:'Titleformat'},{av:'edtBR_MedicationID_Title',ctrl:'BR_MEDICATIONID',prop:'Title'},{av:'edtBR_Medication_RXName_Titleformat',ctrl:'BR_MEDICATION_RXNAME',prop:'Titleformat'},{av:'edtBR_Medication_RXName_Title',ctrl:'BR_MEDICATION_RXNAME',prop:'Title'},{av:'edtBR_Medication_AdmitStartDate_Titleformat',ctrl:'BR_MEDICATION_ADMITSTARTDATE',prop:'Titleformat'},{av:'edtBR_Medication_AdmitStartDate_Title',ctrl:'BR_MEDICATION_ADMITSTARTDATE',prop:'Title'},{av:'edtBR_Medication_AdmitEndDate_Titleformat',ctrl:'BR_MEDICATION_ADMITENDDATE',prop:'Titleformat'},{av:'edtBR_Medication_AdmitEndDate_Title',ctrl:'BR_MEDICATION_ADMITENDDATE',prop:'Title'},{av:'edtBR_Medication_RXDose_Titleformat',ctrl:'BR_MEDICATION_RXDOSE',prop:'Titleformat'},{av:'edtBR_Medication_RXDose_Title',ctrl:'BR_MEDICATION_RXDOSE',prop:'Title'},{av:'edtBR_Medication_RXCode_Titleformat',ctrl:'BR_MEDICATION_RXCODE',prop:'Titleformat'},{av:'edtBR_Medication_RXCode_Title',ctrl:'BR_MEDICATION_RXCODE',prop:'Title'},{av:'AV60GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV61GridPageSize',fld:'vGRIDPAGESIZE',pic:'ZZZZZZZZZ9'},{av:'AV62GridRecordCount',fld:'vGRIDRECORDCOUNT',pic:'ZZZZZZZZZ9'},{av:'AV68IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:''},{av:'edtavDisplay_Visible',ctrl:'vDISPLAY',prop:'Visible'},{av:'edtavUpdate_Visible',ctrl:'vUPDATE',prop:'Visible'},{av:'edtavGotodelete_Visible',ctrl:'vGOTODELETE',prop:'Visible'},{ctrl:'BTNINSERT',prop:'Visible'}]}");
         setEventMetadata("'DOINSERT'","{handler:'E20272',iparms:[{av:'A119BR_MedicationID',fld:'BR_MEDICATIONID',pic:'ZZZZZZZZZZZZZZZZZZ',hsh:true},{av:'AV8BR_EncounterID',fld:'vBR_ENCOUNTERID',pic:'ZZZZZZZZZZZZZZZZZZ'}]");
         setEventMetadata("'DOINSERT'",",oparms:[]}");
         setEventMetadata("VUPDATE.CLICK","{handler:'E24272',iparms:[{av:'A119BR_MedicationID',fld:'BR_MEDICATIONID',pic:'ZZZZZZZZZZZZZZZZZZ',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         Dvelop_confirmpanel_gotodelete_Result = "";
         gxfirstwebparm = "";
         gxfirstwebparm_bkp = "";
         sPrefix = "";
         ...
         AV78Gotodelete_GXI = "";
         scmdbuf = "";
         H00272_A19BR_EncounterID = new long[1] ;
         H00272_A131BR_Medication_InpatientChemo = new String[] {""} ;
         H00272_n131BR_Medication_InpatientChemo = new bool[] {false} ;
         H00272_A130BR_Medication_PrescriptionDate = new DateTime[] {DateTime.MinValue} ;
         H00272_n130BR_Medication_PrescriptionDate = new bool[] {false} ;
         H00272_A129BR_Medication_RXRoute = new String[] {""} ;
         H00272_n129BR_Medication_RXRoute = new bool[] {false} ;
         H00272_A128BR_Medication_RXDaysSupply = new decimal[1] ;
         H00272_n128BR_Medication_RXDaysSupply = new bool[] {false} ;
         H00272_A127BR_Medication_RXQuantity = new String[] {""} ;
         H00272_n127BR_Medication_RXQuantity = new bool[] {false} ;
         H00272_A126BR_Medication_RXFrequency = new String[] {""} ;
         H00272_n126BR_Medication_RXFrequency = new bool[] {false} ;
         H00272_A125BR_Medication_RXUnit = new String[] {""} ;
         H00272_n125BR_Medication_RXUnit = new bool[] {false} ;
         H00272_A123BR_Medication_RXType = new String[] {""} ;
         H00272_n123BR_Medication_RXType = new bool[] {false} ;
         H00272_A122BR_Medication_RXCode = new String[] {""} ;
         H00272_n122BR_Medication_RXCode = new bool[] {false} ;
         H00272_A124BR_Medication_RXDose = new decimal[1] ;
         H00272_n124BR_Medication_RXDose = new bool[] {false} ;
         H00272_A133BR_Medication_AdmitEndDate = new DateTime[] {DateTime.MinValue} ;
         H00272_n133BR_Medication_AdmitEndDate = new bool[] {false} ;
         H00272_A132BR_Medication_AdmitStartDate = new DateTime[] {DateTime.MinValue} ;
         H00272_n132BR_Medication_AdmitStartDate = new bool[] {false} ;
         H00272_A121BR_Medication_RXName = new String[] {""} ;
         H00272_n121BR_Medication_RXName = new bool[] {false} ;
         H00272_A119BR_MedicationID = new long[1] ;
         ...
         AV11TrnContextAtt = new GeneXus.Programs.wwpbaseobjects.SdtWWPTransactionContext_Attribute(context);
         ucDvelop_confirmpanel_gotodelete = new GXUserControl();
         ...
         ROClassString = "";
         GXCCtl = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.br_encounterupdatebr_medicationwc__default(),
            new Object[][] {
                new Object[] {
               H00272_A19BR_EncounterID, H00272_A131BR_Medication_InpatientChemo, H00272_n131BR_Medication_InpatientChemo, H00272_A130BR_Medication_PrescriptionDate, H00272_n130BR_Medication_PrescriptionDate, H00272_A129BR_Medication_RXRoute, H00272_n129BR_Medication_RXRoute, H00272_A128BR_Medication_RXDaysSupply, H00272_n128BR_Medication_RXDaysSupply, H00272_A127BR_Medication_RXQuantity,
               H00272_n127BR_Medication_RXQuantity, H00272_A126BR_Medication_RXFrequency, H00272_n126BR_Medication_RXFrequency, H00272_A125BR_Medication_RXUnit, H00272_n125BR_Medication_RXUnit, H00272_A123BR_Medication_RXType, H00272_n123BR_Medication_RXType, H00272_A122BR_Medication_RXCode, H00272_n122BR_Medication_RXCode, H00272_A124BR_Medication_RXDose,
               H00272_n124BR_Medication_RXDose, H00272_A133BR_Medication_AdmitEndDate, H00272_n133BR_Medication_AdmitEndDate, H00272_A132BR_Medication_AdmitStartDate, H00272_n132BR_Medication_AdmitStartDate, H00272_A121BR_Medication_RXName, H00272_n121BR_Medication_RXName, H00272_A119BR_MedicationID
               }
               , new Object[] {
      ...
      private int edtavGotodelete_Visible ;
      ...
      private int edtavBr_medicationid_selected_Visible ;
      ...
      private int edtavGotodelete_Enabled ;
      ...
      private long AV72BR_MedicationID_Selected ;
      ...
      private String Dvelop_confirmpanel_gotodelete_Result ;
      ...
      private String Dvelop_confirmpanel_gotodelete_Title ;
      private String Dvelop_confirmpanel_gotodelete_Confirmationtext ;
      private String Dvelop_confirmpanel_gotodelete_Yesbuttoncaption ;
      private String Dvelop_confirmpanel_gotodelete_Nobuttoncaption ;
      private String Dvelop_confirmpanel_gotodelete_Cancelbuttoncaption ;
      private String Dvelop_confirmpanel_gotodelete_Yesbuttonposition ;
      private String Dvelop_confirmpanel_gotodelete_Confirmtype ;
      ...
      private String edtavGotodelete_Tooltiptext ;
      ...
      private String edtavBr_medicationid_selected_Internalname ;
      private String edtavBr_medicationid_selected_Jsonclick ;
      ...
      private String edtavGotodelete_Internalname ;
      ...
      private String tblTabledvelop_confirmpanel_gotodelete_Internalname ;
      private String Dvelop_confirmpanel_gotodelete_Internalname ;
      private String sCtrlAV8BR_EncounterID ;
      private String sGXsfl_28_fel_idx="0001" ;
      private String sImgUrl ;
      private String edtavUpdate_Jsonclick ;
      private String edtavGotodelete_Jsonclick ;
      ...
      private bool AV73tCheckFlag ;
      private bool AV64IsAuthorized_Update ;
      private bool AV71IsAuthorized_gotodelete ;
      private bool AV69TempBoolean ;
      private bool GXt_boolean2 ;
      private bool AV67Display_IsBlob ;
      private bool AV63Update_IsBlob ;
      private bool AV70gotodelete_IsBlob ;
      ...
      private String AV76Display_GXI ;
      private String AV77Update_GXI ;
      private String AV78Gotodelete_GXI ;
      private String AV67Display ;
      private String AV63Update ;
      private String AV70gotodelete ;
      ...
      private GXUserControl ucDvelop_confirmpanel_gotodelete ;
      private GXWebForm Form ;
      private IGxDataStore dsDataStore1 ;
      private IGxDataStore dsDefault ;
      private GXCombobox cmbBR_Medication_InpatientChemo ;
      private IDataStoreProvider pr_default ;
      private long[] H00272_A19BR_EncounterID ;
      private String[] H00272_A131BR_Medication_InpatientChemo ;
      private bool[] H00272_n131BR_Medication_InpatientChemo ;
      private DateTime[] H00272_A130BR_Medication_PrescriptionDate ;
      private bool[] H00272_n130BR_Medication_PrescriptionDate ;
      private String[] H00272_A129BR_Medication_RXRoute ;
      private bool[] H00272_n129BR_Medication_RXRoute ;
      private decimal[] H00272_A128BR_Medication_RXDaysSupply ;
      private bool[] H00272_n128BR_Medication_RXDaysSupply ;
      private String[] H00272_A127BR_Medication_RXQuantity ;
      private bool[] H00272_n127BR_Medication_RXQuantity ;
      private String[] H00272_A126BR_Medication_RXFrequency ;
      private bool[] H00272_n126BR_Medication_RXFrequency ;
      private String[] H00272_A125BR_Medication_RXUnit ;
      private bool[] H00272_n125BR_Medication_RXUnit ;
      private String[] H00272_A123BR_Medication_RXType ;
      private bool[] H00272_n123BR_Medication_RXType ;
      private String[] H00272_A122BR_Medication_RXCode ;
      private bool[] H00272_n122BR_Medication_RXCode ;
      private decimal[] H00272_A124BR_Medication_RXDose ;
      private bool[] H00272_n124BR_Medication_RXDose ;
      private DateTime[] H00272_A133BR_Medication_AdmitEndDate ;
      private bool[] H00272_n133BR_Medication_AdmitEndDate ;
      private DateTime[] H00272_A132BR_Medication_AdmitStartDate ;
      private bool[] H00272_n132BR_Medication_AdmitStartDate ;
      private String[] H00272_A121BR_Medication_RXName ;
      private bool[] H00272_n121BR_Medication_RXName ;
      private long[] H00272_A119BR_MedicationID ;
   ...
   public class br_encounterupdatebr_medicationwc__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             long AV8BR_EncounterID )
      {
         ...
         String sFromString ;
         String sOrderString ;
         sSelectString = " [BR_EncounterID], [BR_Medication_InpatientChemo], [BR_Medication_PrescriptionDate], [BR_Medication_RXRoute], [BR_Medication_RXDaysSupply], [BR_Medication_RXQuantity], [BR_Medication_RXFrequency], [BR_Medication_RXUnit], [BR_Medication_RXType], [BR_Medication_RXCode], [BR_Medication_RXDose], [BR_Medication_AdmitEndDate], [BR_Medication_AdmitStartDate], [BR_Medication_RXName], [BR_MedicationID]";
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H00272(context, (short)dynConstraints[0] , (bool)dynConstraints[1] , (long)dynConstraints[2] , (long)dynConstraints[3] );
               case 1 :
                     return conditional_H00273(context, (short)dynConstraints[0] , (bool)dynConstraints[1] , (long)dynConstraints[2] , (long)dynConstraints[3] );
         }
