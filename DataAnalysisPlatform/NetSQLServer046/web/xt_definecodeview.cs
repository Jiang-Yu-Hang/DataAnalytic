/*
               File: XT_DefineCodeView
        Description: Data Mgmt Portal - RAAP
             Author: GeneXus C# Generator version 16_0_0-127771
       Generated on: 2/27/2020 11:58:46.12
...
namespace GeneXus.Programs {
   public class xt_definecodeview : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public xt_definecodeview( )
      {
      ...
      public xt_definecodeview( IGxContext context )
      {
      ...
      public void execute( long aP0_XT_DefineCodeID ,
                           String aP1_TabCode )
      {
         this.AV10XT_DefineCodeID = aP0_XT_DefineCodeID;
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV10XT_DefineCodeID = (long)(NumberUtil.Val( gxfirstwebparm, "."));
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV10XT_DefineCodeID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV10XT_DefineCodeID), 18, 0)));
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "gxhash_vXT_DEFINECODEID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10XT_DefineCodeID), "ZZZZZZZZZZZZZZZZZZ"), context));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202022711584615", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("xt_definecodeview.aspx") + "?" + UrlEncode("" +AV10XT_DefineCodeID) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode))+"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vXT_DEFINECODEID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10XT_DefineCodeID), 18, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vXT_DEFINECODEID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10XT_DefineCodeID), "ZZZZZZZZZZZZZZZZZZ"), context));
      ...
      {
         return formatLink("xt_definecodeview.aspx") + "?" + UrlEncode("" +AV10XT_DefineCodeID) + "," + UrlEncode(StringUtil.RTrim(AV8TabCode)) ;
      }

      public override String GetPgmname( )
      {
         return "XT_DefineCodeView" ;
      }
      ...
      protected void WB2F0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnreturn_Internalname, "", "返回", bttBtnreturn_Jsonclick, 5, "返回", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DORETURN\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_XT_DefineCodeView.htm");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTxttabtitle_Internalname, lblTxttabtitle_Caption, "", "", lblTxttabtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlockTitleWWPTab", 0, "", 1, 1, 0, "HLP_XT_DefineCodeView.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "数据字典信息", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, "HLP_XT_DefineCodeView.htm");
            /* Div Control */
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtngeneral_Internalname, "", "数据字典信息", bttBtngeneral_Jsonclick, 7, "数据字典信息", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e112f1_client"+"'", TempTags, "", 2, "HLP_XT_DefineCodeView.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void STRUP2F0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            /* Read saved values. */
            AV10XT_DefineCodeID = (long)(context.localUtil.CToN( cgiGet( "vXT_DEFINECODEID"), ".", ","));
      ...
      protected void E122F2( )
      {
         ...
         AV16GXLvl9 = 0;
         /* Using cursor H002F2 */
         pr_default.execute(0, new Object[] {AV10XT_DefineCodeID});
         while ( (pr_default.getStatus(0) != 101) )
         {
            A167XT_DefineCodeID = H002F2_A167XT_DefineCodeID[0];
            AV16GXLvl9 = 1;
      ...
      protected void S112( )
      {
         ...
         {
            /* Object Property */
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "XT_DefineCodeGeneral")) != 0 )
            {
               WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "xt_definecodegeneral", new Object[] {context} );
               WebComp_Generalwc.ComponentInit();
               WebComp_Generalwc.Name = "XT_DefineCodeGeneral";
               WebComp_Generalwc_Component = "XT_DefineCodeGeneral";
            }
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               WebComp_Generalwc.setjustcreated();
               WebComp_Generalwc.componentprepare(new Object[] {(String)"W0026",(String)"",(long)AV10XT_DefineCodeID});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV10XT_DefineCodeID = Convert.ToInt64(getParm(obj,0));
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV10XT_DefineCodeID", StringUtil.LTrim( StringUtil.Str( (decimal)(AV10XT_DefineCodeID), 18, 0)));
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "gxhash_vXT_DEFINECODEID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV10XT_DefineCodeID), "ZZZZZZZZZZZZZZZZZZ"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202022711584650", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("xt_definecodeview.js", "?202022711584651", false);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV10XT_DefineCodeID',fld:'vXT_DEFINECODEID',pic:'ZZZZZZZZZZZZZZZZZZ',hsh:true},{av:'AV8TabCode',fld:'vTABCODE',pic:'',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("'DORETURN'","{handler:'E142F2',iparms:[]");
         setEventMetadata("'DORETURN'",",oparms:[]}");
         setEventMetadata("'GENERAL'","{handler:'E112F1',iparms:[{av:'AV11LoadAllTabs',fld:'vLOADALLTABS',pic:''},{av:'AV12SelectedTabCode',fld:'vSELECTEDTABCODE',pic:''},{av:'AV10XT_DefineCodeID',fld:'vXT_DEFINECODEID',pic:'ZZZZZZZZZZZZZZZZZZ',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H002F2_A167XT_DefineCodeID = new long[1] ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.xt_definecodeview__default(),
            new Object[][] {
                new Object[] {
               H002F2_A167XT_DefineCodeID
               }
            }
         );
      ...
      private int idxLst ;
      private long AV10XT_DefineCodeID ;
      private long wcpOAV10XT_DefineCodeID ;
      ...
      private long[] H002F2_A167XT_DefineCodeID ;
   ...
   public class xt_definecodeview__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@AV10XT_DefineCodeID",SqlDbType.Decimal,18,0}
          } ;
          def= new CursorDef[] {
              new CursorDef("H002F2", "SELECT [XT_DefineCodeID] FROM [XT_DefineCode] WITH (NOLOCK) WHERE [XT_DefineCodeID] = @AV10XT_DefineCodeID ORDER BY [XT_DefineCodeID] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH002F2,1,0,false,true )
          };
       }
    }
