/*
       ...
       Generated on: 2/27/2020 11:54:31.40
   ...
   public class br_encountercheckbr_diagnosiswc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV59Pgmname = "BR_EncounterCheckBR_DiagnosisWC";
               context.Gx_err = 0;
               WS402( ) ;
               if ( ! isAjaxCallMode( ) )
               {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202022711543175", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void RenderHtmlCloseForm402( )
      {
         ...
         {
            context.AddJavascriptSource("br_encountercheckbr_diagnosiswc.js", "?202022711543560", false);
         }
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtavDisplay_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV43Display)) ? AV58Display_GXI : context.convertURL( context.PathToRelativeUrl( AV43Display))), !bGXsfl_12_Refreshing);
      ...
      protected void E20402( )
      {
         ...
         edtBR_Diagnosis_No_Title = StringUtil.Format( "<div class='ColumnSettingsContainer''><span>%1</span><div id='%2'></div>", "诊断次序", AV55ddo_BR_Diagnosis_NoTitleControlIdToReplace, "", "", "", "", "", "", "");
      ...
      private void E21402( )
      {
         ...
         AV58Display_GXI = GXDbFile.PathToUrl( context.GetImagePath( "f11923b6-6acd-4a79-bfc0-0cfc6f3bced5", "", context.GetTheme( )));
      ...
      protected void S122( )
      {
         ...
         {
            AV12GridState.FromXml(new GeneXus.Programs.wwpbaseobjects.loadgridstate(context).executeUdp(  AV59Pgmname+"GridState"), null, "WWPGridState", "DataAnalysisPlatform");
         }
         else
         {
            AV12GridState.FromXml(AV16Session.Get(AV59Pgmname+"GridState"), null, "WWPGridState", "DataAnalysisPlatform");
         }
         ...
         {
            AV13GridStateFilterValue = ((GeneXus.Programs.wwpbaseobjects.SdtWWPGridState_FilterValue)AV12GridState.gxTpr_Filtervalues.Item(AV60GXV1));
      ...
      protected void S152( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.savegridstate(context ).execute(  AV59Pgmname+"GridState",  AV12GridState.ToXml(false, true, "WWPGridState", "DataAnalysisPlatform")) ;
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202022711545273", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("br_encountercheckbr_diagnosiswc.js", "?202022711545274", false);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/DropDownOptions/BootstrapDropDownOptionsRender.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
      ...
      protected void sendrow_122( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_12_idx <= subGrid_Recordsperpage( ) * 1 ) )
         {
            ...
            StyleString = "";
            AV43Display_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV43Display))&&String.IsNullOrEmpty(StringUtil.RTrim( AV58Display_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV43Display)));
            sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV43Display)) ? AV58Display_GXI : context.PathToRelativeUrl( AV43Display));
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("DDO_BR_DIAGNOSIS_DXDESCRIPTION.ONOPTIONCLICKED","{handler:'E14402',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV53TFBR_Diagnosis_No',fld:'vTFBR_DIAGNOSIS_NO',pic:'ZZZZZZZZZZ'},{av:'AV54TFBR_Diagnosis_No_To',fld:'vTFBR_DIAGNOSIS_NO_TO',pic:'ZZZZZZZZZZ'},{av:'AV8BR_EncounterID',fld:'vBR_ENCOUNTERID',pic:'ZZZZZZZZZZZZZZZZZZ'},{av:'AV55ddo_BR_Diagnosis_NoTitleControlIdToReplace',fld:'vDDO_BR_DIAGNOSIS_NOTITLECONTROLIDTOREPLACE',pic:''},{av:'AV28ddo_BR_Diagnosis_DXDescriptionTitleControlIdToReplace',fld:'vDDO_BR_DIAGNOSIS_DXDESCRIPTIONTITLECONTROLIDTOREPLACE',pic:''},{av:'AV26ddo_BR_Diagnosis_DXTsourceTitleControlIdToReplace',fld:'vDDO_BR_DIAGNOSIS_DXTSOURCETITLECONTROLIDTOREPLACE',pic:''},{av:'AV20ddo_BR_Diagnosis_DXIDTitleControlIdToReplace',fld:'vDDO_BR_DIAGNOSIS_DXIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV22ddo_BR_Diagnosis_DXCodeTitleControlIdToReplace',fld:'vDDO_BR_DIAGNOSIS_DXCODETITLECONTROLIDTOREPLACE',pic:''},{av:'AV24ddo_BR_Diagnosis_DXTypeTitleControlIdToReplace',fld:'vDDO_BR_DIAGNOSIS_DXTYPETITLECONTROLIDTOREPLACE',pic:''},{av:'AV59Pgmname',fld:'vPGMNAME',pic:''},{av:'AV45IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:''},{av:'sPrefix'},{av:'Ddo_br_diagnosis_dxdescription_Activeeventkey',ctrl:'DDO_BR_DIAGNOSIS_DXDESCRIPTION',prop:'ActiveEventKey'}]");
         ...
         setEventMetadata("DDO_BR_DIAGNOSIS_DXTSOURCE.ONOPTIONCLICKED","{handler:'E15402',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV53TFBR_Diagnosis_No',fld:'vTFBR_DIAGNOSIS_NO',pic:'ZZZZZZZZZZ'},{av:'AV54TFBR_Diagnosis_No_To',fld:'vTFBR_DIAGNOSIS_NO_TO',pic:'ZZZZZZZZZZ'},{av:'AV8BR_EncounterID',fld:'vBR_ENCOUNTERID',pic:'ZZZZZZZZZZZZZZZZZZ'},{av:'AV55ddo_BR_Diagnosis_NoTitleControlIdToReplace',fld:'vDDO_BR_DIAGNOSIS_NOTITLECONTROLIDTOREPLACE',pic:''},{av:'AV28ddo_BR_Diagnosis_DXDescriptionTitleControlIdToReplace',fld:'vDDO_BR_DIAGNOSIS_DXDESCRIPTIONTITLECONTROLIDTOREPLACE',pic:''},{av:'AV26ddo_BR_Diagnosis_DXTsourceTitleControlIdToReplace',fld:'vDDO_BR_DIAGNOSIS_DXTSOURCETITLECONTROLIDTOREPLACE',pic:''},{av:'AV20ddo_BR_Diagnosis_DXIDTitleControlIdToReplace',fld:'vDDO_BR_DIAGNOSIS_DXIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV22ddo_BR_Diagnosis_DXCodeTitleControlIdToReplace',fld:'vDDO_BR_DIAGNOSIS_DXCODETITLECONTROLIDTOREPLACE',pic:''},{av:'AV24ddo_BR_Diagnosis_DXTypeTitleControlIdToReplace',fld:'vDDO_BR_DIAGNOSIS_DXTYPETITLECONTROLIDTOREPLACE',pic:''},{av:'AV59Pgmname',fld:'vPGMNAME',pic:''},{av:'AV45IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:''},{av:'sPrefix'},{av:'Ddo_br_diagnosis_dxtsource_Activeeventkey',ctrl:'DDO_BR_DIAGNOSIS_DXTSOURCE',prop:'ActiveEventKey'}]");
         ...
         setEventMetadata("DDO_BR_DIAGNOSIS_DXCODE.ONOPTIONCLICKED","{handler:'E17402',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV53TFBR_Diagnosis_No',fld:'vTFBR_DIAGNOSIS_NO',pic:'ZZZZZZZZZZ'},{av:'AV54TFBR_Diagnosis_No_To',fld:'vTFBR_DIAGNOSIS_NO_TO',pic:'ZZZZZZZZZZ'},{av:'AV8BR_EncounterID',fld:'vBR_ENCOUNTERID',pic:'ZZZZZZZZZZZZZZZZZZ'},{av:'AV55ddo_BR_Diagnosis_NoTitleControlIdToReplace',fld:'vDDO_BR_DIAGNOSIS_NOTITLECONTROLIDTOREPLACE',pic:''},{av:'AV28ddo_BR_Diagnosis_DXDescriptionTitleControlIdToReplace',fld:'vDDO_BR_DIAGNOSIS_DXDESCRIPTIONTITLECONTROLIDTOREPLACE',pic:''},{av:'AV26ddo_BR_Diagnosis_DXTsourceTitleControlIdToReplace',fld:'vDDO_BR_DIAGNOSIS_DXTSOURCETITLECONTROLIDTOREPLACE',pic:''},{av:'AV20ddo_BR_Diagnosis_DXIDTitleControlIdToReplace',fld:'vDDO_BR_DIAGNOSIS_DXIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV22ddo_BR_Diagnosis_DXCodeTitleControlIdToReplace',fld:'vDDO_BR_DIAGNOSIS_DXCODETITLECONTROLIDTOREPLACE',pic:''},{av:'AV24ddo_BR_Diagnosis_DXTypeTitleControlIdToReplace',fld:'vDDO_BR_DIAGNOSIS_DXTYPETITLECONTROLIDTOREPLACE',pic:''},{av:'AV59Pgmname',fld:'vPGMNAME',pic:''},{av:'AV45IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:''},{av:'sPrefix'},{av:'Ddo_br_diagnosis_dxcode_Activeeventkey',ctrl:'DDO_BR_DIAGNOSIS_DXCODE',prop:'ActiveEventKey'}]");
         ...
         setEventMetadata("DDO_BR_DIAGNOSIS_DXTYPE.ONOPTIONCLICKED","{handler:'E18402',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV53TFBR_Diagnosis_No',fld:'vTFBR_DIAGNOSIS_NO',pic:'ZZZZZZZZZZ'},{av:'AV54TFBR_Diagnosis_No_To',fld:'vTFBR_DIAGNOSIS_NO_TO',pic:'ZZZZZZZZZZ'},{av:'AV8BR_EncounterID',fld:'vBR_ENCOUNTERID',pic:'ZZZZZZZZZZZZZZZZZZ'},{av:'AV55ddo_BR_Diagnosis_NoTitleControlIdToReplace',fld:'vDDO_BR_DIAGNOSIS_NOTITLECONTROLIDTOREPLACE',pic:''},{av:'AV28ddo_BR_Diagnosis_DXDescriptionTitleControlIdToReplace',fld:'vDDO_BR_DIAGNOSIS_DXDESCRIPTIONTITLECONTROLIDTOREPLACE',pic:''},{av:'AV26ddo_BR_Diagnosis_DXTsourceTitleControlIdToReplace',fld:'vDDO_BR_DIAGNOSIS_DXTSOURCETITLECONTROLIDTOREPLACE',pic:''},{av:'AV20ddo_BR_Diagnosis_DXIDTitleControlIdToReplace',fld:'vDDO_BR_DIAGNOSIS_DXIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV22ddo_BR_Diagnosis_DXCodeTitleControlIdToReplace',fld:'vDDO_BR_DIAGNOSIS_DXCODETITLECONTROLIDTOREPLACE',pic:''},{av:'AV24ddo_BR_Diagnosis_DXTypeTitleControlIdToReplace',fld:'vDDO_BR_DIAGNOSIS_DXTYPETITLECONTROLIDTOREPLACE',pic:''},{av:'AV59Pgmname',fld:'vPGMNAME',pic:''},{av:'AV45IsAuthorized_Display',fld:'vISAUTHORIZED_DISPLAY',pic:''},{av:'sPrefix'},{av:'Ddo_br_diagnosis_dxtype_Activeeventkey',ctrl:'DDO_BR_DIAGNOSIS_DXTYPE',prop:'ActiveEventKey'}]");
