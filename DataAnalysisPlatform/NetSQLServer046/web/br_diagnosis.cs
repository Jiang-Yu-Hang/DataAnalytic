/*
       ...
       Generated on: 2/27/2020 11:55:54.12
   ...
   public class br_diagnosis : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void Draw( )
      {
         ...
         if ( ! GxWebStd.gx_redirect( context) )
         {
            ...
            GxWebStd.gx_single_line_edit( context, edtBR_EncounterID_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A19BR_EncounterID), 18, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(A19BR_EncounterID), "ZZZZZZZZZZZZZZZZZZ")), TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,111);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtBR_EncounterID_Jsonclick, 0, "Attribute", "", "", "", "", edtBR_EncounterID_Visible, edtBR_EncounterID_Enabled, 1, "number", "1", 18, "chr", 1, "row", 18, 0, 0, 0, 1, -1, 0, true, "ID", "right", false, "HLP_BR_Diagnosis.htm");
            /* Single line edit */
      ...
      protected void standaloneStartupServer( )
      {
         ...
         if ( AnyError == 0 )
         {
            if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
            {
               ...
               n504BR_Diagnosis_MetastasesDX_Code = (String.IsNullOrEmpty(StringUtil.RTrim( A504BR_Diagnosis_MetastasesDX_Code)) ? true : false);
               A569BR_Diagnosis_TumorStageClinical = cgiGet( "Z569BR_Diagnosis_TumorStageClinical");
               ...
               A569BR_Diagnosis_TumorStageClinical = cgiGet( "BR_DIAGNOSIS_TUMORSTAGECLINICAL");
               n569BR_Diagnosis_TumorStageClinical = (String.IsNullOrEmpty(StringUtil.RTrim( A569BR_Diagnosis_TumorStageClinical)) ? true : false);
               ...
               forbiddenHiddens = forbiddenHiddens + StringUtil.RTrim( context.localUtil.Format( A569BR_Diagnosis_TumorStageClinical, ""));
               hsh = cgiGet( "hsh");
               if ( ( ! ( ( A64BR_DiagnosisID != Z64BR_DiagnosisID ) ) || ( StringUtil.StrCmp(Gx_mode, "INS") == 0 ) ) && ! GXUtil.CheckEncryptedHash( forbiddenHiddens, hsh, GXKey) )
               {
                  ...
                  GXUtil.WriteLog("br_diagnosis:[SecurityCheckFailed value for]"+"BR_Diagnosis_TumorStageClinical:"+StringUtil.RTrim( context.localUtil.Format( A569BR_Diagnosis_TumorStageClinical, "")));
                  GxWebError = 1;
      ...
      protected void CheckExtendedTable0C13( )
      {
         ...
         {
            GX_msglist.addItem("域���������������������超界", "OutOfRange", 1, "BR_DIAGNOSIS_INITIALDX");
            AnyError = 1;
         ...
         {
            GX_msglist.addItem("域���������������������超界", "OutOfRange", 1, "BR_DIAGNOSIS_METASTASESDX");
            AnyError = 1;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202022711555931", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         GXUtil.WriteLog("br_diagnosis:[SendSecurityCheck value for]"+"BR_Diagnosis_TumorStageClinical:"+StringUtil.RTrim( context.localUtil.Format( A569BR_Diagnosis_TumorStageClinical, "")));
      }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "BR_DIAGNOSIS_TUMORSTAGECLINICAL", A569BR_Diagnosis_TumorStageClinical);
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202022711555982", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("br_diagnosis.js", "?202022711555983", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'Gx_mode',fld:'vMODE',pic:'@!',hsh:true},{av:'AV12BR_DiagnosisID',fld:'vBR_DIAGNOSISID',pic:'ZZZZZZZZZZZZZZZZZZ',hsh:true},{av:'A64BR_DiagnosisID',fld:'BR_DIAGNOSISID',pic:'ZZZZZZZZZZZZZZZZZZ'},{av:'AV15tCurrentCode',fld:'vTCURRENTCODE',pic:''},{av:'AV10Insert_BR_EncounterID',fld:'vINSERT_BR_ENCOUNTERID',pic:'ZZZZZZZZZZZZZZZZZZ'},{av:'A569BR_Diagnosis_TumorStageClinical',fld:'BR_DIAGNOSIS_TUMORSTAGECLINICAL',pic:''}]");
