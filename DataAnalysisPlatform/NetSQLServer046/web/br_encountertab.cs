/*
       ...
       Generated on: 2/27/2020 11:55:59.33
...
namespace GeneXus.Programs {
   public class br_encountertab : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
         ...
         if ( StringUtil.Len( (String)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
               {
                  ...
                  AV30ddo_BR_Encounter_DepartmentTitleControlIdToReplace = GetNextPar( );
                  ...
                  gxgrGrid_refresh( subGrid_Rows, AV76BR_EncounterID, AV14OrderedBy, AV15OrderedDsc, AV8BR_Information_ID, AV56ddo_BR_EncounterIDTitleControlIdToReplace, AV20ddo_BR_Encounter_EncIDTitleControlIdToReplace, AV30ddo_BR_Encounter_DepartmentTitleControlIdToReplace, AV61ddo_BR_Encounter_ENCTypeTitleControlIdToReplace, AV26ddo_BR_Encounter_AdmitDateTitleControlIdToReplace, AV74ddo_BR_Encounter_StatusTitleControlIdToReplace, AV82Pgmname, sPrefix) ;
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202022711555964", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"vGRIDRECORDCOUNT", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV46GridRecordCount), 10, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"vGRIDPAGESIZE", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV45GridPageSize), 10, 0, ".", "")));
         if ( context.isAjaxRequest( ) )
         {
         ...
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri(sPrefix, false, sPrefix+"vBR_ENCOUNTER_DEPARTMENTTITLEFILTERDATA", AV27BR_Encounter_DepartmentTitleFilterData);
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt(sPrefix+"vBR_ENCOUNTER_DEPARTMENTTITLEFILTERDATA", AV27BR_Encounter_DepartmentTitleFilterData);
         }
         if ( context.isAjaxRequest( ) )
         {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"DDO_BR_ENCOUNTER_DEPARTMENT_Caption", StringUtil.RTrim( Ddo_br_encounter_department_Caption));
         GxWebStd.gx_hidden_field( context, sPrefix+"DDO_BR_ENCOUNTER_DEPARTMENT_Tooltip", StringUtil.RTrim( Ddo_br_encounter_department_Tooltip));
         GxWebStd.gx_hidden_field( context, sPrefix+"DDO_BR_ENCOUNTER_DEPARTMENT_Cls", StringUtil.RTrim( Ddo_br_encounter_department_Cls));
         GxWebStd.gx_hidden_field( context, sPrefix+"DDO_BR_ENCOUNTER_DEPARTMENT_Dropdownoptionstype", StringUtil.RTrim( Ddo_br_encounter_department_Dropdownoptionstype));
         GxWebStd.gx_hidden_field( context, sPrefix+"DDO_BR_ENCOUNTER_DEPARTMENT_Titlecontrolidtoreplace", StringUtil.RTrim( Ddo_br_encounter_department_Titlecontrolidtoreplace));
         GxWebStd.gx_hidden_field( context, sPrefix+"DDO_BR_ENCOUNTER_DEPARTMENT_Includesortasc", StringUtil.BoolToStr( Ddo_br_encounter_department_Includesortasc));
         GxWebStd.gx_hidden_field( context, sPrefix+"DDO_BR_ENCOUNTER_DEPARTMENT_Includesortdsc", StringUtil.BoolToStr( Ddo_br_encounter_department_Includesortdsc));
         GxWebStd.gx_hidden_field( context, sPrefix+"DDO_BR_ENCOUNTER_DEPARTMENT_Sortedstatus", StringUtil.RTrim( Ddo_br_encounter_department_Sortedstatus));
         GxWebStd.gx_hidden_field( context, sPrefix+"DDO_BR_ENCOUNTER_DEPARTMENT_Includefilter", StringUtil.BoolToStr( Ddo_br_encounter_department_Includefilter));
         GxWebStd.gx_hidden_field( context, sPrefix+"DDO_BR_ENCOUNTER_DEPARTMENT_Includedatalist", StringUtil.BoolToStr( Ddo_br_encounter_department_Includedatalist));
         GxWebStd.gx_hidden_field( context, sPrefix+"DDO_BR_ENCOUNTER_DEPARTMENT_Sortasc", StringUtil.RTrim( Ddo_br_encounter_department_Sortasc));
         GxWebStd.gx_hidden_field( context, sPrefix+"DDO_BR_ENCOUNTER_DEPARTMENT_Sortdsc", StringUtil.RTrim( Ddo_br_encounter_department_Sortdsc));
         GxWebStd.gx_hidden_field( context, sPrefix+"DDO_BR_ENCOUNTER_DEPARTMENT_Searchbuttontext", StringUtil.RTrim( Ddo_br_encounter_department_Searchbuttontext));
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"DDO_BR_ENCOUNTER_DEPARTMENT_Activeeventkey", StringUtil.RTrim( Ddo_br_encounter_department_Activeeventkey));
      ...
      protected void RenderHtmlCloseForm4B2( )
      {
         ...
         {
            context.AddJavascriptSource("br_encountertab.js", "?20202271156371", false);
         }
      ...
      protected void WB4B0( )
      {
         ...
         if ( wbEnd == 27 )
         {
            ...
            ucGridpaginationbar.SetProperty("RecordCount", AV46GridRecordCount);
            ucGridpaginationbar.SetProperty("Page", AV45GridPageSize);
            ...
            /* Multiple line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 44,'" + sPrefix + "',false,'" + sGXsfl_27_idx + "',0)\"";
            ClassString = "Attribute";
            StyleString = "";
            ClassString = "Attribute";
            StyleString = "";
            GxWebStd.gx_html_textarea( context, edtavDdo_br_encounteridtitlecontrolidtoreplace_Internalname, AV56ddo_BR_EncounterIDTitleControlIdToReplace, "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,44);\"", 0, edtavDdo_br_encounteridtitlecontrolidtoreplace_Visible, 1, 0, 80, "chr", 4, "row", StyleString, ClassString, "", "", "300", -1, 0, "", "", -1, true, "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", 0, "HLP_BR_EncounterTab.htm");
            /* User Defined Control */
            ...
            /* Multiple line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 46,'" + sPrefix + "',false,'" + sGXsfl_27_idx + "',0)\"";
            ClassString = "Attribute";
            StyleString = "";
            ClassString = "Attribute";
            StyleString = "";
            GxWebStd.gx_html_textarea( context, edtavDdo_br_encounter_encidtitlecontrolidtoreplace_Internalname, AV20ddo_BR_Encounter_EncIDTitleControlIdToReplace, "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,46);\"", 0, edtavDdo_br_encounter_encidtitlecontrolidtoreplace_Visible, 1, 0, 80, "chr", 4, "row", StyleString, ClassString, "", "", "300", -1, 0, "", "", -1, true, "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", 0, "HLP_BR_EncounterTab.htm");
            /* User Defined Control */
            ...
            ucDdo_br_encounter_department.SetProperty("DropDownOptionsTitleSettingsIcons", AV41DDO_TitleSettingsIcons);
            ucDdo_br_encounter_department.SetProperty("DropDownOptionsData", AV27BR_Encounter_DepartmentTitleFilterData);
            ucDdo_br_encounter_department.Render(context, "dvelop.gxbootstrap.dropdownoptions", Ddo_br_encounter_department_Internalname, sPrefix+"DDO_BR_ENCOUNTER_DEPARTMENTContainer");
            /* Multiple line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 48,'" + sPrefix + "',false,'" + sGXsfl_27_idx + "',0)\"";
            ClassString = "Attribute";
            StyleString = "";
            ClassString = "Attribute";
            StyleString = "";
            GxWebStd.gx_html_textarea( context, edtavDdo_br_encounter_departmenttitlecontrolidtoreplace_Internalname, AV30ddo_BR_Encounter_DepartmentTitleControlIdToReplace, "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,48);\"", 0, edtavDdo_br_encounter_departmenttitlecontrolidtoreplace_Visible, 1, 0, 80, "chr", 4, "row", StyleString, ClassString, "", "", "300", -1, 0, "", "", -1, true, "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", 0, "HLP_BR_EncounterTab.htm");
            /* User Defined Control */
            ...
            /* Multiple line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 50,'" + sPrefix + "',false,'" + sGXsfl_27_idx + "',0)\"";
            ClassString = "Attribute";
            StyleString = "";
            ClassString = "Attribute";
            StyleString = "";
            GxWebStd.gx_html_textarea( context, edtavDdo_br_encounter_enctypetitlecontrolidtoreplace_Internalname, AV61ddo_BR_Encounter_ENCTypeTitleControlIdToReplace, "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,50);\"", 0, edtavDdo_br_encounter_enctypetitlecontrolidtoreplace_Visible, 1, 0, 80, "chr", 4, "row", StyleString, ClassString, "", "", "300", -1, 0, "", "", -1, true, "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", 0, "HLP_BR_EncounterTab.htm");
            /* User Defined Control */
            ...
            /* Multiple line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 52,'" + sPrefix + "',false,'" + sGXsfl_27_idx + "',0)\"";
            ClassString = "Attribute";
            StyleString = "";
            ClassString = "Attribute";
            StyleString = "";
            GxWebStd.gx_html_textarea( context, edtavDdo_br_encounter_admitdatetitlecontrolidtoreplace_Internalname, AV26ddo_BR_Encounter_AdmitDateTitleControlIdToReplace, "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,52);\"", 0, edtavDdo_br_encounter_admitdatetitlecontrolidtoreplace_Visible, 1, 0, 80, "chr", 4, "row", StyleString, ClassString, "", "", "300", -1, 0, "", "", -1, true, "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", 0, "HLP_BR_EncounterTab.htm");
            /* User Defined Control */
            ...
            /* Multiple line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 54,'" + sPrefix + "',false,'" + sGXsfl_27_idx + "',0)\"";
            ClassString = "Attribute";
            StyleString = "";
            ClassString = "Attribute";
            StyleString = "";
            GxWebStd.gx_html_textarea( context, edtavDdo_br_encounter_statustitlecontrolidtoreplace_Internalname, AV74ddo_BR_Encounter_StatusTitleControlIdToReplace, "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,54);\"", 0, edtavDdo_br_encounter_statustitlecontrolidtoreplace_Visible, 1, 0, 80, "chr", 4, "row", StyleString, ClassString, "", "", "300", -1, 0, "", "", -1, true, "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", 0, "HLP_BR_EncounterTab.htm");
            /* Single line edit */
            ...
            GxWebStd.gx_single_line_edit( context, edtavOrderedby_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV14OrderedBy), 4, 0, ".", "")), StringUtil.LTrim( context.localUtil.Format( (decimal)(AV14OrderedBy), "ZZZ9")), TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,57);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavOrderedby_Jsonclick, 0, "Attribute", "", "", "", "", edtavOrderedby_Visible, 1, 0, "number", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_BR_EncounterTab.htm");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 58,'" + sPrefix + "',false,'" + sGXsfl_27_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavOrdereddsc_Internalname, StringUtil.BoolToStr( AV15OrderedDsc), StringUtil.BoolToStr( AV15OrderedDsc), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,58);\"", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavOrdereddsc_Jsonclick, 0, "Attribute", "", "", "", "", edtavOrdereddsc_Visible, 1, 0, "text", "", 4, "chr", 1, "row", 4, 0, 0, 0, 1, 0, 0, true, "", "right", false, "HLP_BR_EncounterTab.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void gxgrGrid_refresh( int subGrid_Rows ,
                                       ...
                                       String AV30ddo_BR_Encounter_DepartmentTitleControlIdToReplace ,
      ...
      protected void RF4B2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            pr_default.dynParam(0, new Object[]{ new Object[]{
                                                 ...
                                                 AV77tCurrentCode } ,
                                                 new int[]{
                                                 TypeConstants.STRING, TypeConstants.LONG, TypeConstants.SHORT, TypeConstants.BOOLEAN, TypeConstants.LONG, TypeConstants.BOOLEAN, TypeConstants.LONG, TypeConstants.STRING, TypeConstants.BOOLEAN, TypeConstants.STRING
                                                 }
            } ) ;
            lV76BR_EncounterID = StringUtil.Concat( StringUtil.RTrim( AV76BR_EncounterID), "%", "");
            /* Using cursor H004B2 */
            pr_default.execute(0, new Object[] {AV8BR_Information_ID, AV77tCurrentCode, lV76BR_EncounterID, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_27_idx = 1;
            sGXsfl_27_idx = StringUtil.PadL( StringUtil.LTrim( StringUtil.Str( (decimal)(nGXsfl_27_idx), 4, 0)), 4, "0");
            SubsflControlProps_272( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_Recordsperpage( ) ) ) ) )
            {
               ...
               A84BR_Encounter_Department = H004B2_A84BR_Encounter_Department[0];
               n84BR_Encounter_Department = H004B2_n84BR_Encounter_Department[0];
      ...
      protected int subGrid_Recordcount( )
      {
         ...
         lV76BR_EncounterID = StringUtil.Concat( StringUtil.RTrim( AV76BR_EncounterID), "%", "");
         /* Using cursor H004B3 */
         pr_default.execute(1, new Object[] {AV8BR_Information_ID, AV77tCurrentCode, lV76BR_EncounterID});
      ...
      protected void STRUP4B0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            ajax_req_read_hidden_sdt(cgiGet( sPrefix+"vBR_ENCOUNTER_DEPARTMENTTITLEFILTERDATA"), AV27BR_Encounter_DepartmentTitleFilterData);
            ...
            AV30ddo_BR_Encounter_DepartmentTitleControlIdToReplace = cgiGet( edtavDdo_br_encounter_departmenttitlecontrolidtoreplace_Internalname);
            context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "AV30ddo_BR_Encounter_DepartmentTitleControlIdToReplace", AV30ddo_BR_Encounter_DepartmentTitleControlIdToReplace);
            ...
            AV46GridRecordCount = (long)(context.localUtil.CToN( cgiGet( sPrefix+"vGRIDRECORDCOUNT"), ".", ","));
            AV45GridPageSize = (long)(context.localUtil.CToN( cgiGet( sPrefix+"vGRIDPAGESIZE"), ".", ","));
            ...
            Ddo_br_encounter_department_Caption = cgiGet( sPrefix+"DDO_BR_ENCOUNTER_DEPARTMENT_Caption");
            Ddo_br_encounter_department_Tooltip = cgiGet( sPrefix+"DDO_BR_ENCOUNTER_DEPARTMENT_Tooltip");
            Ddo_br_encounter_department_Cls = cgiGet( sPrefix+"DDO_BR_ENCOUNTER_DEPARTMENT_Cls");
            Ddo_br_encounter_department_Dropdownoptionstype = cgiGet( sPrefix+"DDO_BR_ENCOUNTER_DEPARTMENT_Dropdownoptionstype");
            Ddo_br_encounter_department_Titlecontrolidtoreplace = cgiGet( sPrefix+"DDO_BR_ENCOUNTER_DEPARTMENT_Titlecontrolidtoreplace");
            Ddo_br_encounter_department_Includesortasc = StringUtil.StrToBool( cgiGet( sPrefix+"DDO_BR_ENCOUNTER_DEPARTMENT_Includesortasc"));
            Ddo_br_encounter_department_Includesortdsc = StringUtil.StrToBool( cgiGet( sPrefix+"DDO_BR_ENCOUNTER_DEPARTMENT_Includesortdsc"));
            Ddo_br_encounter_department_Sortedstatus = cgiGet( sPrefix+"DDO_BR_ENCOUNTER_DEPARTMENT_Sortedstatus");
            Ddo_br_encounter_department_Includefilter = StringUtil.StrToBool( cgiGet( sPrefix+"DDO_BR_ENCOUNTER_DEPARTMENT_Includefilter"));
            Ddo_br_encounter_department_Includedatalist = StringUtil.StrToBool( cgiGet( sPrefix+"DDO_BR_ENCOUNTER_DEPARTMENT_Includedatalist"));
            Ddo_br_encounter_department_Sortasc = cgiGet( sPrefix+"DDO_BR_ENCOUNTER_DEPARTMENT_Sortasc");
            Ddo_br_encounter_department_Sortdsc = cgiGet( sPrefix+"DDO_BR_ENCOUNTER_DEPARTMENT_Sortdsc");
            Ddo_br_encounter_department_Searchbuttontext = cgiGet( sPrefix+"DDO_BR_ENCOUNTER_DEPARTMENT_Searchbuttontext");
            ...
            Ddo_br_encounter_department_Activeeventkey = cgiGet( sPrefix+"DDO_BR_ENCOUNTER_DEPARTMENT_Activeeventkey");
      ...
      protected void E214B2( )
      {
         ...
         ucDdo_br_encounter_department.SendProperty(context, sPrefix, false, Ddo_br_encounter_department_Internalname, "TitleControlIdToReplace", Ddo_br_encounter_department_Titlecontrolidtoreplace);
         AV30ddo_BR_Encounter_DepartmentTitleControlIdToReplace = Ddo_br_encounter_department_Titlecontrolidtoreplace;
         context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "AV30ddo_BR_Encounter_DepartmentTitleControlIdToReplace", AV30ddo_BR_Encounter_DepartmentTitleControlIdToReplace);
         edtavDdo_br_encounter_departmenttitlecontrolidtoreplace_Visible = 0;
         context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtavDdo_br_encounter_departmenttitlecontrolidtoreplace_Internalname, "Visible", StringUtil.LTrim( StringUtil.Str( (decimal)(edtavDdo_br_encounter_departmenttitlecontrolidtoreplace_Visible), 5, 0)), true);
      ...
      protected void E224B2( )
      {
         ...
         AV27BR_Encounter_DepartmentTitleFilterData = new GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTDropDownOptionsData_Item>( context, "Item", "");
         ...
         edtBR_Encounter_Department_Title = StringUtil.Format( "<div class='ColumnSettingsContainer''><span>%1</span><div id='%2'></div>", "就诊科室", AV30ddo_BR_Encounter_DepartmentTitleControlIdToReplace, "", "", "", "", "", "", "");
         context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtBR_Encounter_Department_Internalname, "Title", edtBR_Encounter_Department_Title, !bGXsfl_27_Refreshing);
         ...
         AV45GridPageSize = subGrid_Rows;
         context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "AV45GridPageSize", StringUtil.LTrim( StringUtil.Str( (decimal)(AV45GridPageSize), 10, 0)));
         AV46GridRecordCount = subGrid_Recordcount( );
         context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "AV46GridRecordCount", StringUtil.LTrim( StringUtil.Str( (decimal)(AV46GridRecordCount), 10, 0)));
         ...
         context.httpAjaxContext.ajax_rsp_assign_sdt_attri(sPrefix, false, "AV27BR_Encounter_DepartmentTitleFilterData", AV27BR_Encounter_DepartmentTitleFilterData);
      ...
      protected void E154B2( )
      {
         ...
         if ( StringUtil.StrCmp(Ddo_br_encounter_department_Activeeventkey, "<#OrderASC#>") == 0 )
         {
            ...
            ucDdo_br_encounter_department.SendProperty(context, sPrefix, false, Ddo_br_encounter_department_Internalname, "SortedStatus", Ddo_br_encounter_department_Sortedstatus);
            subgrid_firstpage( ) ;
            context.DoAjaxRefreshCmp(sPrefix);
         }
      ...
      protected void S122( )
      {
         ...
         {
            AV12GridState.FromXml(new GeneXus.Programs.wwpbaseobjects.loadgridstate(context).executeUdp(  AV82Pgmname+"GridState"), null, "WWPGridState", "DataAnalysisPlatform");
         }
         else
         {
            AV12GridState.FromXml(AV16Session.Get(AV82Pgmname+"GridState"), null, "WWPGridState", "DataAnalysisPlatform");
         }
         ...
         context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "AV15OrderedDsc", AV15OrderedDsc);
         AV83GXV1 = 1;
         while ( AV83GXV1 <= AV12GridState.gxTpr_Filtervalues.Count )
         {
            AV13GridStateFilterValue = ((GeneXus.Programs.wwpbaseobjects.SdtWWPGridState_FilterValue)AV12GridState.gxTpr_Filtervalues.Item(AV83GXV1));
      ...
      protected void S142( )
      {
         ...
         new GeneXus.Programs.wwpbaseobjects.savegridstate(context ).execute(  AV82Pgmname+"GridState",  AV12GridState.ToXml(false, true, "WWPGridState", "DataAnalysisPlatform")) ;
      }
      ...
      protected void S112( )
      {
         ...
         AV10TrnContext.gxTpr_Callerobject = AV82Pgmname;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202022711562118", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("br_encountertab.js", "?202022711562118", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Panel/BootstrapPanelRender.js", "", false);
         context.AddJavascriptSource("DVelop/DVPaginationBar/DVPaginationBarRender.js", "", false);
         context.AddJavascriptSource("DVelop/Bootstrap/Shared/DVelopBootstrap.js", "", false);
      ...
      protected void SubsflControlProps_272( )
      {
         ...
         edtBR_Encounter_Department_Internalname = sPrefix+"BR_ENCOUNTER_DEPARTMENT_"+sGXsfl_27_idx;
      ...
      protected void SubsflControlProps_fel_272( )
      {
         ...
         edtBR_Encounter_Department_Internalname = sPrefix+"BR_ENCOUNTER_DEPARTMENT_"+sGXsfl_27_fel_idx;
      ...
      protected void init_default_properties( )
      {
         ...
         Ddo_br_encounter_department_Internalname = sPrefix+"DDO_BR_ENCOUNTER_DEPARTMENT";
         edtavDdo_br_encounter_departmenttitlecontrolidtoreplace_Internalname = sPrefix+"vDDO_BR_ENCOUNTER_DEPARTMENTTITLECONTROLIDTOREPLACE";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("DDO_BR_ENCOUNTER_ENCID.ONOPTIONCLICKED","{handler:'E144B2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV76BR_EncounterID',fld:'vBR_ENCOUNTERID',pic:''},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV8BR_Information_ID',fld:'vBR_INFORMATION_ID',pic:'ZZZZZZZZZZZZZZZZZZ'},{av:'AV56ddo_BR_EncounterIDTitleControlIdToReplace',fld:'vDDO_BR_ENCOUNTERIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV20ddo_BR_Encounter_EncIDTitleControlIdToReplace',fld:'vDDO_BR_ENCOUNTER_ENCIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV30ddo_BR_Encounter_DepartmentTitleControlIdToReplace',fld:'vDDO_BR_ENCOUNTER_DEPARTMENTTITLECONTROLIDTOREPLACE',pic:''},{av:'AV61ddo_BR_Encounter_ENCTypeTitleControlIdToReplace',fld:'vDDO_BR_ENCOUNTER_ENCTYPETITLECONTROLIDTOREPLACE',pic:''},{av:'AV26ddo_BR_Encounter_AdmitDateTitleControlIdToReplace',fld:'vDDO_BR_ENCOUNTER_ADMITDATETITLECONTROLIDTOREPLACE',pic:''},{av:'AV74ddo_BR_Encounter_StatusTitleControlIdToReplace',fld:'vDDO_BR_ENCOUNTER_STATUSTITLECONTROLIDTOREPLACE',pic:''},{av:'AV82Pgmname',fld:'vPGMNAME',pic:''},{av:'sPrefix'},{av:'Ddo_br_encounter_encid_Activeeventkey',ctrl:'DDO_BR_ENCOUNTER_ENCID',prop:'ActiveEventKey'}]");
         ...
         setEventMetadata("DDO_BR_ENCOUNTER_DEPARTMENT.ONOPTIONCLICKED","{handler:'E154B2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV76BR_EncounterID',fld:'vBR_ENCOUNTERID',pic:''},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV8BR_Information_ID',fld:'vBR_INFORMATION_ID',pic:'ZZZZZZZZZZZZZZZZZZ'},{av:'AV56ddo_BR_EncounterIDTitleControlIdToReplace',fld:'vDDO_BR_ENCOUNTERIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV20ddo_BR_Encounter_EncIDTitleControlIdToReplace',fld:'vDDO_BR_ENCOUNTER_ENCIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV30ddo_BR_Encounter_DepartmentTitleControlIdToReplace',fld:'vDDO_BR_ENCOUNTER_DEPARTMENTTITLECONTROLIDTOREPLACE',pic:''},{av:'AV61ddo_BR_Encounter_ENCTypeTitleControlIdToReplace',fld:'vDDO_BR_ENCOUNTER_ENCTYPETITLECONTROLIDTOREPLACE',pic:''},{av:'AV26ddo_BR_Encounter_AdmitDateTitleControlIdToReplace',fld:'vDDO_BR_ENCOUNTER_ADMITDATETITLECONTROLIDTOREPLACE',pic:''},{av:'AV74ddo_BR_Encounter_StatusTitleControlIdToReplace',fld:'vDDO_BR_ENCOUNTER_STATUSTITLECONTROLIDTOREPLACE',pic:''},{av:'AV82Pgmname',fld:'vPGMNAME',pic:''},{av:'sPrefix'},{av:'Ddo_br_encounter_department_Activeeventkey',ctrl:'DDO_BR_ENCOUNTER_DEPARTMENT',prop:'ActiveEventKey'}]");
         setEventMetadata("DDO_BR_ENCOUNTER_DEPARTMENT.ONOPTIONCLICKED",",oparms:[{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'Ddo_br_encounter_department_Sortedstatus',ctrl:'DDO_BR_ENCOUNTER_DEPARTMENT',prop:'SortedStatus'},{av:'AV77tCurrentCode',fld:'vTCURRENTCODE',pic:''},{av:'AV53BR_EncounterIDTitleFilterData',fld:'vBR_ENCOUNTERIDTITLEFILTERDATA',pic:''},{av:'AV17BR_Encounter_EncIDTitleFilterData',fld:'vBR_ENCOUNTER_ENCIDTITLEFILTERDATA',pic:''},{av:'AV27BR_Encounter_DepartmentTitleFilterData',fld:'vBR_ENCOUNTER_DEPARTMENTTITLEFILTERDATA',pic:''},{av:'AV58BR_Encounter_ENCTypeTitleFilterData',fld:'vBR_ENCOUNTER_ENCTYPETITLEFILTERDATA',pic:''},{av:'AV21BR_Encounter_AdmitDateTitleFilterData',fld:'vBR_ENCOUNTER_ADMITDATETITLEFILTERDATA',pic:''},{av:'AV71BR_Encounter_StatusTitleFilterData',fld:'vBR_ENCOUNTER_STATUSTITLEFILTERDATA',pic:''},{av:'edtBR_EncounterID_Titleformat',ctrl:'BR_ENCOUNTERID',prop:'Titleformat'},{av:'edtBR_EncounterID_Title',ctrl:'BR_ENCOUNTERID',prop:'Title'},{av:'edtBR_Encounter_EncID_Titleformat',ctrl:'BR_ENCOUNTER_ENCID',prop:'Titleformat'},{av:'edtBR_Encounter_EncID_Title',ctrl:'BR_ENCOUNTER_ENCID',prop:'Title'},{av:'edtBR_Encounter_Department_Titleformat',ctrl:'BR_ENCOUNTER_DEPARTMENT',prop:'Titleformat'},{av:'edtBR_Encounter_Department_Title',ctrl:'BR_ENCOUNTER_DEPARTMENT',prop:'Title'},{av:'edtBR_Encounter_ENCType_Titleformat',ctrl:'BR_ENCOUNTER_ENCTYPE',prop:'Titleformat'},{av:'edtBR_Encounter_ENCType_Title',ctrl:'BR_ENCOUNTER_ENCTYPE',prop:'Title'},{av:'edtBR_Encounter_AdmitDate_Titleformat',ctrl:'BR_ENCOUNTER_ADMITDATE',prop:'Titleformat'},{av:'edtBR_Encounter_AdmitDate_Title',ctrl:'BR_ENCOUNTER_ADMITDATE',prop:'Title'},{av:'cmbBR_Encounter_Status'},{av:'AV44GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV45GridPageSize',fld:'vGRIDPAGESIZE',pic:'ZZZZZZZZZ9'},{av:'AV46GridRecordCount',fld:'vGRIDRECORDCOUNT',pic:'ZZZZZZZZZ9'},{ctrl:'BTNINSERT',prop:'Visible'}]}");
         setEventMetadata("DDO_BR_ENCOUNTER_ENCTYPE.ONOPTIONCLICKED","{handler:'E164B2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV76BR_EncounterID',fld:'vBR_ENCOUNTERID',pic:''},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV8BR_Information_ID',fld:'vBR_INFORMATION_ID',pic:'ZZZZZZZZZZZZZZZZZZ'},{av:'AV56ddo_BR_EncounterIDTitleControlIdToReplace',fld:'vDDO_BR_ENCOUNTERIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV20ddo_BR_Encounter_EncIDTitleControlIdToReplace',fld:'vDDO_BR_ENCOUNTER_ENCIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV30ddo_BR_Encounter_DepartmentTitleControlIdToReplace',fld:'vDDO_BR_ENCOUNTER_DEPARTMENTTITLECONTROLIDTOREPLACE',pic:''},{av:'AV61ddo_BR_Encounter_ENCTypeTitleControlIdToReplace',fld:'vDDO_BR_ENCOUNTER_ENCTYPETITLECONTROLIDTOREPLACE',pic:''},{av:'AV26ddo_BR_Encounter_AdmitDateTitleControlIdToReplace',fld:'vDDO_BR_ENCOUNTER_ADMITDATETITLECONTROLIDTOREPLACE',pic:''},{av:'AV74ddo_BR_Encounter_StatusTitleControlIdToReplace',fld:'vDDO_BR_ENCOUNTER_STATUSTITLECONTROLIDTOREPLACE',pic:''},{av:'AV82Pgmname',fld:'vPGMNAME',pic:''},{av:'sPrefix'},{av:'Ddo_br_encounter_enctype_Activeeventkey',ctrl:'DDO_BR_ENCOUNTER_ENCTYPE',prop:'ActiveEventKey'}]");
         setEventMetadata("DDO_BR_ENCOUNTER_ENCTYPE.ONOPTIONCLICKED",",oparms:[{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'Ddo_br_encounter_enctype_Sortedstatus',ctrl:'DDO_BR_ENCOUNTER_ENCTYPE',prop:'SortedStatus'},{av:'AV77tCurrentCode',fld:'vTCURRENTCODE',pic:''},{av:'AV53BR_EncounterIDTitleFilterData',fld:'vBR_ENCOUNTERIDTITLEFILTERDATA',pic:''},{av:'AV17BR_Encounter_EncIDTitleFilterData',fld:'vBR_ENCOUNTER_ENCIDTITLEFILTERDATA',pic:''},{av:'AV27BR_Encounter_DepartmentTitleFilterData',fld:'vBR_ENCOUNTER_DEPARTMENTTITLEFILTERDATA',pic:''},{av:'AV58BR_Encounter_ENCTypeTitleFilterData',fld:'vBR_ENCOUNTER_ENCTYPETITLEFILTERDATA',pic:''},{av:'AV21BR_Encounter_AdmitDateTitleFilterData',fld:'vBR_ENCOUNTER_ADMITDATETITLEFILTERDATA',pic:''},{av:'AV71BR_Encounter_StatusTitleFilterData',fld:'vBR_ENCOUNTER_STATUSTITLEFILTERDATA',pic:''},{av:'edtBR_EncounterID_Titleformat',ctrl:'BR_ENCOUNTERID',prop:'Titleformat'},{av:'edtBR_EncounterID_Title',ctrl:'BR_ENCOUNTERID',prop:'Title'},{av:'edtBR_Encounter_EncID_Titleformat',ctrl:'BR_ENCOUNTER_ENCID',prop:'Titleformat'},{av:'edtBR_Encounter_EncID_Title',ctrl:'BR_ENCOUNTER_ENCID',prop:'Title'},{av:'edtBR_Encounter_Department_Titleformat',ctrl:'BR_ENCOUNTER_DEPARTMENT',prop:'Titleformat'},{av:'edtBR_Encounter_Department_Title',ctrl:'BR_ENCOUNTER_DEPARTMENT',prop:'Title'},{av:'edtBR_Encounter_ENCType_Titleformat',ctrl:'BR_ENCOUNTER_ENCTYPE',prop:'Titleformat'},{av:'edtBR_Encounter_ENCType_Title',ctrl:'BR_ENCOUNTER_ENCTYPE',prop:'Title'},{av:'edtBR_Encounter_AdmitDate_Titleformat',ctrl:'BR_ENCOUNTER_ADMITDATE',prop:'Titleformat'},{av:'edtBR_Encounter_AdmitDate_Title',ctrl:'BR_ENCOUNTER_ADMITDATE',prop:'Title'},{av:'cmbBR_Encounter_Status'},{av:'AV44GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV45GridPageSize',fld:'vGRIDPAGESIZE',pic:'ZZZZZZZZZ9'},{av:'AV46GridRecordCount',fld:'vGRIDRECORDCOUNT',pic:'ZZZZZZZZZ9'},{ctrl:'BTNINSERT',prop:'Visible'}]}");
         setEventMetadata("DDO_BR_ENCOUNTER_ADMITDATE.ONOPTIONCLICKED","{handler:'E174B2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV76BR_EncounterID',fld:'vBR_ENCOUNTERID',pic:''},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV8BR_Information_ID',fld:'vBR_INFORMATION_ID',pic:'ZZZZZZZZZZZZZZZZZZ'},{av:'AV56ddo_BR_EncounterIDTitleControlIdToReplace',fld:'vDDO_BR_ENCOUNTERIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV20ddo_BR_Encounter_EncIDTitleControlIdToReplace',fld:'vDDO_BR_ENCOUNTER_ENCIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV30ddo_BR_Encounter_DepartmentTitleControlIdToReplace',fld:'vDDO_BR_ENCOUNTER_DEPARTMENTTITLECONTROLIDTOREPLACE',pic:''},{av:'AV61ddo_BR_Encounter_ENCTypeTitleControlIdToReplace',fld:'vDDO_BR_ENCOUNTER_ENCTYPETITLECONTROLIDTOREPLACE',pic:''},{av:'AV26ddo_BR_Encounter_AdmitDateTitleControlIdToReplace',fld:'vDDO_BR_ENCOUNTER_ADMITDATETITLECONTROLIDTOREPLACE',pic:''},{av:'AV74ddo_BR_Encounter_StatusTitleControlIdToReplace',fld:'vDDO_BR_ENCOUNTER_STATUSTITLECONTROLIDTOREPLACE',pic:''},{av:'AV82Pgmname',fld:'vPGMNAME',pic:''},{av:'sPrefix'},{av:'Ddo_br_encounter_admitdate_Activeeventkey',ctrl:'DDO_BR_ENCOUNTER_ADMITDATE',prop:'ActiveEventKey'}]");
         setEventMetadata("DDO_BR_ENCOUNTER_ADMITDATE.ONOPTIONCLICKED",",oparms:[{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'Ddo_br_encounter_admitdate_Sortedstatus',ctrl:'DDO_BR_ENCOUNTER_ADMITDATE',prop:'SortedStatus'},{av:'AV77tCurrentCode',fld:'vTCURRENTCODE',pic:''},{av:'AV53BR_EncounterIDTitleFilterData',fld:'vBR_ENCOUNTERIDTITLEFILTERDATA',pic:''},{av:'AV17BR_Encounter_EncIDTitleFilterData',fld:'vBR_ENCOUNTER_ENCIDTITLEFILTERDATA',pic:''},{av:'AV27BR_Encounter_DepartmentTitleFilterData',fld:'vBR_ENCOUNTER_DEPARTMENTTITLEFILTERDATA',pic:''},{av:'AV58BR_Encounter_ENCTypeTitleFilterData',fld:'vBR_ENCOUNTER_ENCTYPETITLEFILTERDATA',pic:''},{av:'AV21BR_Encounter_AdmitDateTitleFilterData',fld:'vBR_ENCOUNTER_ADMITDATETITLEFILTERDATA',pic:''},{av:'AV71BR_Encounter_StatusTitleFilterData',fld:'vBR_ENCOUNTER_STATUSTITLEFILTERDATA',pic:''},{av:'edtBR_EncounterID_Titleformat',ctrl:'BR_ENCOUNTERID',prop:'Titleformat'},{av:'edtBR_EncounterID_Title',ctrl:'BR_ENCOUNTERID',prop:'Title'},{av:'edtBR_Encounter_EncID_Titleformat',ctrl:'BR_ENCOUNTER_ENCID',prop:'Titleformat'},{av:'edtBR_Encounter_EncID_Title',ctrl:'BR_ENCOUNTER_ENCID',prop:'Title'},{av:'edtBR_Encounter_Department_Titleformat',ctrl:'BR_ENCOUNTER_DEPARTMENT',prop:'Titleformat'},{av:'edtBR_Encounter_Department_Title',ctrl:'BR_ENCOUNTER_DEPARTMENT',prop:'Title'},{av:'edtBR_Encounter_ENCType_Titleformat',ctrl:'BR_ENCOUNTER_ENCTYPE',prop:'Titleformat'},{av:'edtBR_Encounter_ENCType_Title',ctrl:'BR_ENCOUNTER_ENCTYPE',prop:'Title'},{av:'edtBR_Encounter_AdmitDate_Titleformat',ctrl:'BR_ENCOUNTER_ADMITDATE',prop:'Titleformat'},{av:'edtBR_Encounter_AdmitDate_Title',ctrl:'BR_ENCOUNTER_ADMITDATE',prop:'Title'},{av:'cmbBR_Encounter_Status'},{av:'AV44GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV45GridPageSize',fld:'vGRIDPAGESIZE',pic:'ZZZZZZZZZ9'},{av:'AV46GridRecordCount',fld:'vGRIDRECORDCOUNT',pic:'ZZZZZZZZZ9'},{ctrl:'BTNINSERT',prop:'Visible'}]}");
         setEventMetadata("DDO_BR_ENCOUNTER_STATUS.ONOPTIONCLICKED","{handler:'E184B2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV76BR_EncounterID',fld:'vBR_ENCOUNTERID',pic:''},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV8BR_Information_ID',fld:'vBR_INFORMATION_ID',pic:'ZZZZZZZZZZZZZZZZZZ'},{av:'AV56ddo_BR_EncounterIDTitleControlIdToReplace',fld:'vDDO_BR_ENCOUNTERIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV20ddo_BR_Encounter_EncIDTitleControlIdToReplace',fld:'vDDO_BR_ENCOUNTER_ENCIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV30ddo_BR_Encounter_DepartmentTitleControlIdToReplace',fld:'vDDO_BR_ENCOUNTER_DEPARTMENTTITLECONTROLIDTOREPLACE',pic:''},{av:'AV61ddo_BR_Encounter_ENCTypeTitleControlIdToReplace',fld:'vDDO_BR_ENCOUNTER_ENCTYPETITLECONTROLIDTOREPLACE',pic:''},{av:'AV26ddo_BR_Encounter_AdmitDateTitleControlIdToReplace',fld:'vDDO_BR_ENCOUNTER_ADMITDATETITLECONTROLIDTOREPLACE',pic:''},{av:'AV74ddo_BR_Encounter_StatusTitleControlIdToReplace',fld:'vDDO_BR_ENCOUNTER_STATUSTITLECONTROLIDTOREPLACE',pic:''},{av:'AV82Pgmname',fld:'vPGMNAME',pic:''},{av:'sPrefix'},{av:'Ddo_br_encounter_status_Activeeventkey',ctrl:'DDO_BR_ENCOUNTER_STATUS',prop:'ActiveEventKey'}]");
         setEventMetadata("DDO_BR_ENCOUNTER_STATUS.ONOPTIONCLICKED",",oparms:[{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'Ddo_br_encounter_status_Sortedstatus',ctrl:'DDO_BR_ENCOUNTER_STATUS',prop:'SortedStatus'},{av:'AV77tCurrentCode',fld:'vTCURRENTCODE',pic:''},{av:'AV53BR_EncounterIDTitleFilterData',fld:'vBR_ENCOUNTERIDTITLEFILTERDATA',pic:''},{av:'AV17BR_Encounter_EncIDTitleFilterData',fld:'vBR_ENCOUNTER_ENCIDTITLEFILTERDATA',pic:''},{av:'AV27BR_Encounter_DepartmentTitleFilterData',fld:'vBR_ENCOUNTER_DEPARTMENTTITLEFILTERDATA',pic:''},{av:'AV58BR_Encounter_ENCTypeTitleFilterData',fld:'vBR_ENCOUNTER_ENCTYPETITLEFILTERDATA',pic:''},{av:'AV21BR_Encounter_AdmitDateTitleFilterData',fld:'vBR_ENCOUNTER_ADMITDATETITLEFILTERDATA',pic:''},{av:'AV71BR_Encounter_StatusTitleFilterData',fld:'vBR_ENCOUNTER_STATUSTITLEFILTERDATA',pic:''},{av:'edtBR_EncounterID_Titleformat',ctrl:'BR_ENCOUNTERID',prop:'Titleformat'},{av:'edtBR_EncounterID_Title',ctrl:'BR_ENCOUNTERID',prop:'Title'},{av:'edtBR_Encounter_EncID_Titleformat',ctrl:'BR_ENCOUNTER_ENCID',prop:'Titleformat'},{av:'edtBR_Encounter_EncID_Title',ctrl:'BR_ENCOUNTER_ENCID',prop:'Title'},{av:'edtBR_Encounter_Department_Titleformat',ctrl:'BR_ENCOUNTER_DEPARTMENT',prop:'Titleformat'},{av:'edtBR_Encounter_Department_Title',ctrl:'BR_ENCOUNTER_DEPARTMENT',prop:'Title'},{av:'edtBR_Encounter_ENCType_Titleformat',ctrl:'BR_ENCOUNTER_ENCTYPE',prop:'Titleformat'},{av:'edtBR_Encounter_ENCType_Title',ctrl:'BR_ENCOUNTER_ENCTYPE',prop:'Title'},{av:'edtBR_Encounter_AdmitDate_Titleformat',ctrl:'BR_ENCOUNTER_ADMITDATE',prop:'Titleformat'},{av:'edtBR_Encounter_AdmitDate_Title',ctrl:'BR_ENCOUNTER_ADMITDATE',prop:'Title'},{av:'cmbBR_Encounter_Status'},{av:'AV44GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV45GridPageSize',fld:'vGRIDPAGESIZE',pic:'ZZZZZZZZZ9'},{av:'AV46GridRecordCount',fld:'vGRIDRECORDCOUNT',pic:'ZZZZZZZZZ9'},{ctrl:'BTNINSERT',prop:'Visible'}]}");
         setEventMetadata("GRID.LOAD","{handler:'E234B2',iparms:[]");
         setEventMetadata("GRID.LOAD",",oparms:[]}");
         setEventMetadata("'DOINSERT'","{handler:'E194B2',iparms:[{av:'A19BR_EncounterID',fld:'BR_ENCOUNTERID',pic:'ZZZZZZZZZZZZZZZZZZ',hsh:true},{av:'AV8BR_Information_ID',fld:'vBR_INFORMATION_ID',pic:'ZZZZZZZZZZZZZZZZZZ'}]");
         setEventMetadata("'DOINSERT'",",oparms:[]}");
         setEventMetadata("VBR_ENCOUNTERID.CONTROLVALUECHANGING","{handler:'E204B2',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV76BR_EncounterID',fld:'vBR_ENCOUNTERID',pic:''},{av:'AV14OrderedBy',fld:'vORDEREDBY',pic:'ZZZ9'},{av:'AV15OrderedDsc',fld:'vORDEREDDSC',pic:''},{av:'AV8BR_Information_ID',fld:'vBR_INFORMATION_ID',pic:'ZZZZZZZZZZZZZZZZZZ'},{av:'AV56ddo_BR_EncounterIDTitleControlIdToReplace',fld:'vDDO_BR_ENCOUNTERIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV20ddo_BR_Encounter_EncIDTitleControlIdToReplace',fld:'vDDO_BR_ENCOUNTER_ENCIDTITLECONTROLIDTOREPLACE',pic:''},{av:'AV30ddo_BR_Encounter_DepartmentTitleControlIdToReplace',fld:'vDDO_BR_ENCOUNTER_DEPARTMENTTITLECONTROLIDTOREPLACE',pic:''},{av:'AV61ddo_BR_Encounter_ENCTypeTitleControlIdToReplace',fld:'vDDO_BR_ENCOUNTER_ENCTYPETITLECONTROLIDTOREPLACE',pic:''},{av:'AV26ddo_BR_Encounter_AdmitDateTitleControlIdToReplace',fld:'vDDO_BR_ENCOUNTER_ADMITDATETITLECONTROLIDTOREPLACE',pic:''},{av:'AV74ddo_BR_Encounter_StatusTitleControlIdToReplace',fld:'vDDO_BR_ENCOUNTER_STATUSTITLECONTROLIDTOREPLACE',pic:''},{av:'AV82Pgmname',fld:'vPGMNAME',pic:''},{av:'sPrefix'}]");
         setEventMetadata("VBR_ENCOUNTERID.CONTROLVALUECHANGING",",oparms:[{av:'AV77tCurrentCode',fld:'vTCURRENTCODE',pic:''},{av:'AV53BR_EncounterIDTitleFilterData',fld:'vBR_ENCOUNTERIDTITLEFILTERDATA',pic:''},{av:'AV17BR_Encounter_EncIDTitleFilterData',fld:'vBR_ENCOUNTER_ENCIDTITLEFILTERDATA',pic:''},{av:'AV27BR_Encounter_DepartmentTitleFilterData',fld:'vBR_ENCOUNTER_DEPARTMENTTITLEFILTERDATA',pic:''},{av:'AV58BR_Encounter_ENCTypeTitleFilterData',fld:'vBR_ENCOUNTER_ENCTYPETITLEFILTERDATA',pic:''},{av:'AV21BR_Encounter_AdmitDateTitleFilterData',fld:'vBR_ENCOUNTER_ADMITDATETITLEFILTERDATA',pic:''},{av:'AV71BR_Encounter_StatusTitleFilterData',fld:'vBR_ENCOUNTER_STATUSTITLEFILTERDATA',pic:''},{av:'edtBR_EncounterID_Titleformat',ctrl:'BR_ENCOUNTERID',prop:'Titleformat'},{av:'edtBR_EncounterID_Title',ctrl:'BR_ENCOUNTERID',prop:'Title'},{av:'edtBR_Encounter_EncID_Titleformat',ctrl:'BR_ENCOUNTER_ENCID',prop:'Titleformat'},{av:'edtBR_Encounter_EncID_Title',ctrl:'BR_ENCOUNTER_ENCID',prop:'Title'},{av:'edtBR_Encounter_Department_Titleformat',ctrl:'BR_ENCOUNTER_DEPARTMENT',prop:'Titleformat'},{av:'edtBR_Encounter_Department_Title',ctrl:'BR_ENCOUNTER_DEPARTMENT',prop:'Title'},{av:'edtBR_Encounter_ENCType_Titleformat',ctrl:'BR_ENCOUNTER_ENCTYPE',prop:'Titleformat'},{av:'edtBR_Encounter_ENCType_Title',ctrl:'BR_ENCOUNTER_ENCTYPE',prop:'Title'},{av:'edtBR_Encounter_AdmitDate_Titleformat',ctrl:'BR_ENCOUNTER_ADMITDATE',prop:'Titleformat'},{av:'edtBR_Encounter_AdmitDate_Title',ctrl:'BR_ENCOUNTER_ADMITDATE',prop:'Title'},{av:'cmbBR_Encounter_Status'},{av:'AV44GridCurrentPage',fld:'vGRIDCURRENTPAGE',pic:'ZZZZZZZZZ9'},{av:'AV45GridPageSize',fld:'vGRIDPAGESIZE',pic:'ZZZZZZZZZ9'},{av:'AV46GridRecordCount',fld:'vGRIDRECORDCOUNT',pic:'ZZZZZZZZZ9'},{ctrl:'BTNINSERT',prop:'Visible'}]}");
         setEventMetadata("BR_ENCOUNTERID.CLICK","{handler:'E244B2',iparms:[{av:'cmbBR_Encounter_Status'},{av:'A172BR_Encounter_Status',fld:'BR_ENCOUNTER_STATUS',pic:'ZZZ9',hsh:true},{av:'A19BR_EncounterID',fld:'BR_ENCOUNTERID',pic:'ZZZZZZZZZZZZZZZZZZ',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         H004B2_A84BR_Encounter_Department = new String[] {""} ;
         H004B2_n84BR_Encounter_Department = new bool[] {false} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.br_encountertab__default(),
            new Object[][] {
               ...
               H004B2_A90BR_Encounter_ENCType, H004B2_n90BR_Encounter_ENCType, H004B2_A84BR_Encounter_Department, H004B2_n84BR_Encounter_Department, H004B2_A35BR_Encounter_EncID, H004B2_n35BR_Encounter_EncID, H004B2_A19BR_EncounterID
               }
               , new Object[] {
      ...
      private long AV46GridRecordCount ;
      private long AV45GridPageSize ;
      ...
      private String AV30ddo_BR_Encounter_DepartmentTitleControlIdToReplace ;
      ...
      private String[] H004B2_A84BR_Encounter_Department ;
      private bool[] H004B2_n84BR_Encounter_Department ;
      ...
      private GXBaseCollection<GeneXus.Programs.wwpbaseobjects.SdtDVB_SDTDropDownOptionsData_Item> AV27BR_Encounter_DepartmentTitleFilterData ;
   ...
   public class br_encountertab__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             String AV77tCurrentCode )
      {
         ...
         String sFromString ;
         String sOrderString ;
         sSelectString = " [BR_Information_ID], [BAS_TenantTenantCode], [BR_Encounter_Status], [BR_Encounter_AdmitSource], [BR_Encounter_AdmitDate], [BR_Encounter_ENCType], [BR_Encounter_Department], [BR_Encounter_EncID], [BR_EncounterID]";
         ...
         {
            sOrderString = sOrderString + " ORDER BY [BR_Information_ID], [BR_Encounter_Department]";
         }
         else if ( ( AV14OrderedBy == 3 ) && ( AV15OrderedDsc ) )
         {
            sOrderString = sOrderString + " ORDER BY [BR_Information_ID] DESC, [BR_Encounter_Department] DESC";
         }
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H004B2(context, (String)dynConstraints[0] , (long)dynConstraints[1] , (short)dynConstraints[2] , (bool)dynConstraints[3] , (long)dynConstraints[4] , (long)dynConstraints[5] , (String)dynConstraints[6] , (String)dynConstraints[7] );
               case 1 :
                     return conditional_H004B3(context, (String)dynConstraints[0] , (long)dynConstraints[1] , (short)dynConstraints[2] , (bool)dynConstraints[3] , (long)dynConstraints[4] , (long)dynConstraints[5] , (String)dynConstraints[6] , (String)dynConstraints[7] );
         }
